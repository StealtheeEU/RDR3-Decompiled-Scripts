...
bool func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, GET_HASH_KEY("P_CS_ROPE03BX"), 0f, 0f, 0f, "p_cs_rope03x", 0, 0, 1);
	func_152(uParam0, 0.3002f, -4.1348f, 0.9471f, 122.283f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_KIECNV4"), GET_HASH_KEY("PLAYER_KIECNV4"));
	iLocal_16 = func_162(uParam0, -2.6375f, -2.2877f, 1f, 0f, 0f, 0f, 4f, 9.9f, 5f, "TRIGGER", GET_HASH_KEY("VOLBOX"));
	func_163(uParam0, 1);
