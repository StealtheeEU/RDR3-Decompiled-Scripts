...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.6375f, -0.725f, 0.85f, 9f, 1.1f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 0.75f, 6.2625f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_151(uParam0, 0.0375f, -0.125f, 0.85f, 0f, 1.1f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, 0.447176f, -0.766282f, 1.00854f, 0f, 0.7f, 0.7f, 3.2075f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK1", 0, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.67941f, -0.624629f, 0.00875473f, 0, 1, 0, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_21, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_19, "p_cs_sock01x_PH_L_HAND", 0, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), 1, 0, 0);
	return true;
}
...
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), false))
	{
		return false;
	}
	return true;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_388(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
