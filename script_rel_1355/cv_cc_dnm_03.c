...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0326f, -1.1852f, 0.5177f, 0f, 2.5f, 2.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -9.0601f, -8.936f, 1.029f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CIGAR01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (!func_153(15))
	{
	...
	func_156(uParam0, GET_HASH_KEY("COMP_DNMCNV3"), GET_HASH_KEY("PLAYER_DNMCNV3"));
	func_157(uParam0, iLocal_17, -1, 0.89f);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_CIGAR"), "PROP_HUMAN_SEAT_CHAIR_CIGAR_MALE_D", -1, 0);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_CIGAR"), "PROP_HUMAN_SEAT_CHAIR_CIGAR_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
