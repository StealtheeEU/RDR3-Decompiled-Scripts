...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_151(uParam0, 17.59f, 0.12f, 0.9632f, 20.88f, 6.5f, 3.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 1.015f, 0.616f, 0.9977f, 23.04f, 2f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLEJD", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER", 0, 1, 1);
	if (!func_153(15))
	{
	...
	func_156(uParam0, GET_HASH_KEY("COMP_KARPARCNV2"), GET_HASH_KEY("PLAYER_KARPARCNV2"));
	func_157(uParam0, iLocal_16, -1, 0.55f);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	func_161(uParam0, iLocal_14);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
...
{
	func_259(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
