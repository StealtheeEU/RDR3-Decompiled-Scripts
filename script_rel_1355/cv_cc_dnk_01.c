...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1f, -0.7f, 0.9f, 0f, 4f, 2f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -3.7358f, 3.0285f, 0.9857f, 0f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_152(uParam0, -0.524f, -0.544f, 1.0089f, 0f, 0.8f, 0.8f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_41 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_41, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, iLocal_15, "GREET_MICAH_DNKCNV1", 60000, 1);
	func_159(uParam0, GET_HASH_KEY("COMP_DNKCNV1"), GET_HASH_KEY("PLAYER_DNKCNV1"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_335(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_416(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
