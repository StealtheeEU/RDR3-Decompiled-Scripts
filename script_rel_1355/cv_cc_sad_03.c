...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.5375f, -9.325f, 1.4875f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_SADCNV3"), GET_HASH_KEY("PLAYER_SADCNV3"));
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
