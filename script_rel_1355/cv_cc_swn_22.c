...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -1.156f, -1.6725f, 0f, -40f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_150(uParam0, 1.055f, -1.8675f, 0f, 37.75f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	iLocal_14 = func_151(uParam0, 22, 0);
	iLocal_15 = func_151(uParam0, 21, 0);
	iLocal_25 = func_152(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), -1.1669f, -1.683f, -0.0234985f, 0, 1, 0, 1);
	iLocal_26 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.19761f, -1.86883f, -0.0285263f, 0, 1, 0, 1);
	iLocal_23 = func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 1, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON_1", 0, 1, 1);
	iLocal_24 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 1, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL_1", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("COMP_SWNCNV22"), GET_HASH_KEY("PLAYER_SWNCNV22"));
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_B", iLocal_26, 0);
	func_155(uParam0, iLocal_15, 1, -1);
	func_156(uParam0, iLocal_15, 1, 6, 0, 0, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_B", iLocal_26, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", iLocal_25, 0);
	func_156(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", iLocal_25, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
