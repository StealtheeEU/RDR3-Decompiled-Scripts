...
bool func_77(var uParam0)
{
	...
	func_164(uParam0, -0.96f, -3.36f, 0f, -111.15f, 5f, 5f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_165(uParam0, -2.23f, -4.41f, 0f, 0f, 3.5f, 3.5f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_165(uParam0, 0.16f, -0.4f, 0f, -109.8f, 3.5f, 3.5f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_166(uParam0, GET_HASH_KEY("P_CS_BILLSINGLE01BX"), 0f, 0f, 0f, "BILL01", 0, 1, 1);
	func_166(uParam0, GET_HASH_KEY("P_CS_BILLSINGLE01BX"), 0f, 0f, 0f, "BILL02", 0, 1, 1);
	func_166(uParam0, GET_HASH_KEY("P_CS_BILLSINGLE01BX"), 0f, 0f, 0f, "BILL03", 0, 1, 1);
...
bool func_98(var uParam0)
{
	...
	if (func_216(uParam0, iLocal_21))
	{
		...
		func_220(0);
		if (func_221(GET_HASH_KEY("CSTAG_PLAYER_DIRTY"), 1))
		{
			func_222(GET_HASH_KEY("CSTAG_PLAYER_DIRTY"), 1, 0);
		}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			else if (!uParam0->f_107[iVar0 /*113*/].f_8.f_22)
			{
				if (iVar1 < 0)
				{
					uParam0->f_107[iVar0 /*113*/].f_8.f_23 = TASK::CREATE_SCENARIO_POINT_HASH(uParam0->f_107[iVar0 /*113*/].f_8.f_1, vVar2, fVar5, 0f, 0f, 0);
...
bool func_217(var uParam0)
{
	...
	if (func_343(*uParam0, GET_HASH_KEY("HATS"), 0))
	{
		return true;
	}
	return false;
...
void func_218()
{
	func_344(GET_HASH_KEY("MPC_HIDE_ACTION_HAT"), Global_35, 0, 1);
}
...
void func_223()
{
	func_347(Global_35, GET_HASH_KEY("MPC_HIDE_ACTION_HAT"), 1);
}
...
int func_277()
{
	...
	if (func_221(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_278()
{
	...
	if (func_221(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_355(int iParam0)
{
	...
	Var0 = { func_433(GET_HASH_KEY("CAREER_CASH")) };
...
void func_356(int iParam0, char* sParam1, int iParam2)
{
	...
	func_434(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 1, GET_HASH_KEY("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_393(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_460(iParam1))
		{
			func_461(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_407(var uParam0, var uParam1)
{
	...
	if (!func_413(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_468("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_492(var uParam0, int iParam1)
{
	...
	else
	{
		...
		uParam0->f_107[iParam1 /*113*/].f_32.f_21 = TASK::CREATE_SCENARIO_POINT_HASH(Var1.f_2, Var1.f_5, Var1.f_8, 0f, 0f, 0);
	}
...
void func_513(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_576(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_576(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_221(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_500(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_576(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_612(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_626(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_641(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_630(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_630(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_630(GET_HASH_KEY("CHARACTER"), func_653(), -1591664384, bParam0);
}
