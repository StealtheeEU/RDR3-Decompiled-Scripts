...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.2019f, -1.1267f, 0.5f, 0f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 1.1076f, -0.54f, 0.5f, 0f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, "SEAT_JAVIER", 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0.000679016f, "SEAT_MICAH", 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_GLASS01X"), 0f, 0f, 0f, "GLASS_MICAH", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_GLASS01X"), 0f, 0f, 0f, "GLASS_JAVIER", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_PASSED_OUT_TABLE"), "PROP_HUMAN_PASSED_OUT_TABLE_MALE_C", -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(70f, 120f), 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, 4, 5, 0, 0, 0);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_VOMIT"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_14), GET_HASH_KEY("WEAPON_UNARMED"), true, 0, false, false);
	WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_15), GET_HASH_KEY("WEAPON_UNARMED"), true, 0, false, false);
	if (func_148(uParam0) == 3)
	{
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_373(iParam1))
		{
			func_374(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
