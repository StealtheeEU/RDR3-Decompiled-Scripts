...
void func_1(var uParam0, var uParam1)
{
	...
	if (UIAPPS::IS_UIAPP_RUNNING_BY_HASH(GET_HASH_KEY("TRANSLATION_OVERLAY")))
	{
		UIAPPS::_CLOSE_UIAPP_BY_HASH(GET_HASH_KEY("TRANSLATION_OVERLAY"));
	}
	if (uParam0->f_141)
	{
...
int func_4(var uParam0, var uParam1)
{
	...
	{
		case 0:
			uParam0->f_127 = TASK::_0x05A0100EA714DB68(Global_35, GET_HASH_KEY("PRIMARYITEM"));
...
void func_8(var uParam0, var uParam1)
{
	...
	switch ((*uParam1)[0 /*9*/])
	{
		...
		case GET_HASH_KEY("DOCUMENT_GUNSLINGER_5_NOTE"):
			if (*uParam1)[0 /*9*/] == GET_HASH_KEY("DOCUMENT_GUNSLINGER_1_NOTE")
			{
				iVar0 = 84;
			}
			else if (*uParam1)[0 /*9*/] == GET_HASH_KEY("DOCUMENT_GUNSLINGER_2_NOTE")
			{
				iVar0 = 86;
			}
			else if (*uParam1)[0 /*9*/] == GET_HASH_KEY("DOCUMENT_GUNSLINGER_3_NOTE")
			{
				iVar0 = 87;
			}
			else if (*uParam1)[0 /*9*/] == GET_HASH_KEY("DOCUMENT_GUNSLINGER_5_NOTE")
			{
				iVar0 = 88;
			}
...
void func_10(var uParam0, var uParam1)
{
	...
	switch ((*uParam1)[0 /*9*/])
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_INVITE"):
			...
			break;
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_INVITE2A"):
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_INVITE2B"):
...
bool func_18(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_SERIAL_KILLER_CLUE2"):
		case -904734609: /* GXTEntry: "Goodbye Letter from Mary" */
		case -595619260: /* GXTEntry: "Goodbye Letter from Mary" */
		case GET_HASH_KEY("DOCUMENT_RE_FROZEN_DEATH_MAP"):
		case GET_HASH_KEY("DOCUMENT_SERIAL_KILLER_CLUE3"):
		case 1760651454: /* GXTEntry: "Goodbye Letter from Mary" */
		case GET_HASH_KEY("DOCUMENT_SERIAL_KILLER_CLUE1"):
			return true;
	}
	return false;
}
...
bool func_24(int iParam0, int iParam1)
{
	switch (func_69(iParam0, -949239683))
	{
		...
		case 1894156335:
			...
			break;
		case 871191033:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@PAPER_D2_H32_ROLLED_BASE"))
			{
				return true;
			}
			break;
		case -1273369295:
			...
			break;
		case 82200319:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@NEWSPAPER_BASE"))
			{
				return true;
			}
			break;
...
void func_25(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_LS_HORSECHASE"):
			func_77(Global_1392626[7 /*32*/].f_3, 1);
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_05"):
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_06"):
			func_49(129, 1);
			break;
		case GET_HASH_KEY("DOCUMENT_LETTER_GAVIN_FRIEND"):
...
int func_26(var uParam0, var uParam1, bool bParam2)
{
	if (!uParam0->f_146)
	{
		...
		if (*uParam1)[0 /*9*/] == GET_HASH_KEY("DOCUMENT_BANKROB_NEWSCLIP")
		{
			Global_36636 = 1;
		}
		Global_36621 = 1;
	...
	if (uParam0->f_142)
	{
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_INSPECT_ZOOM"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_DOCUMENT_PAGE_NEXT"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_DOCUMENT_PAGE_PREV"), false);
		...
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_INSPECT_OPEN_SATCHEL"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_INSPECT_OPEN_SATCHEL"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_TAB_RIGHT"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_TAB_LEFT"), false);
	}
	return 1;
}
...
bool func_30(int iParam0, int iParam1)
{
	switch (func_69(iParam0, -949239683))
	{
		...
		case 1894156335:
			...
			break;
		case 871191033:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@PAPER_D2_H32_ROLLED_OUTRO") || iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@PAPER_D2_H32_ROLLED_FLIP_TO_FRONT_OUTRO"))
			{
				return true;
			}
			break;
		case -1273369295:
			...
			break;
		case 82200319:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@NEWSPAPER_OUTRO") || iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@NEWSPAPER_FLIP_TO_FRONT_OUTRO"))
			{
				return true;
			}
			break;
...
void func_33(var uParam0, int iParam1)
{
	...
	{
		if (UIAPPS::LAUNCH_UIAPP_BY_HASH_WITH_ENTRY(GET_HASH_KEY("TRANSLATION_OVERLAY"), GET_HASH_KEY("NEWSPAPER")) == 0)
		{
			uParam0->f_5.f_1 = 1;
			AUDIO::PLAY_SOUND_FRONTEND("READ", "HUD_SHOP_SOUNDSET", true, 0);
	...
	else if (UIAPPS::LAUNCH_UIAPP_BY_HASH_WITH_ENTRY(GET_HASH_KEY("TRANSLATION_OVERLAY"), GET_HASH_KEY("GENERIC")) == 0)
	{
		uParam0->f_5.f_1 = 1;
		AUDIO::PLAY_SOUND_FRONTEND("READ", "HUD_SHOP_SOUNDSET", true, 0);
		func_94(uParam0, iParam1);
...
int func_35(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_115(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_115(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_115(iParam0) == GET_HASH_KEY("AMMO") && func_128(iParam0))
		{
		...
		{
			func_133(func_132(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_133(func_134(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_31(iParam0, 589988438))
		{
			if (func_137())
			{
				func_138(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_150(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_151(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_150(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_157(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_158(499813453, 0);
				func_159(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_157(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_158(499813453, 0);
				func_159(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_157(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_158(499813453, 0);
				func_159(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_157(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_158(666607663, 0);
				func_160(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_157(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_158(666607663, 0);
				func_160(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_157(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_158(666607663, 0);
				func_160(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_157(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_158(-220219788, 0);
				func_161(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_157(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_158(-220219788, 0);
				func_161(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_157(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_158(-220219788, 0);
				func_161(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_157(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_158(218622660, 0);
				func_162(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_157(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_158(218622660, 0);
				func_162(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_157(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_158(390004462, 0);
				func_163(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_157(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_158(390004462, 0);
				func_163(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_157(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_158(390004462, 0);
				func_163(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_157(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_158(6410548, 0);
				func_164(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_157(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_158(6410548, 0);
				func_164(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_157(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_158(6410548, 0);
				func_164(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_157(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_158(6410548, 0);
				func_164(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_166(242, func_165(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_166(240, func_165(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_166(241, func_165(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
...
int func_39(var uParam0, int iParam1)
{
	...
	else if (func_185(*uParam0, &iVar0, GET_HASH_KEY("INVENTORY"), GET_HASH_KEY("UI_ITEMVIEWER"), 0, 0))
	{
...
int func_46(int iParam0)
{
	switch (func_69(iParam0, -949239683))
	{
		...
		case 1894156335:
			return 2067181640;
		case 871191033:
			return GET_HASH_KEY("DOCUMENT_INSPECT@PAPER_D2_H32_ROLLED_OUTRO");
		case -1273369295:
			return 1434623772;
		case 82200319:
			return GET_HASH_KEY("DOCUMENT_INSPECT@NEWSPAPER_OUTRO");
		case -873135685:
			return 486187924;
		case 24248412:
			return -1079287506;
...
{
	return (func_31(iParam0, 566155764) && !UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(GET_HASH_KEY("MAP")));
}
...
int func_71(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_01"):
			if (func_200(func_199(3)) == 0)
			{
				return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_01");
			}
			else
			{
				return -2100835330;
			...
			break;
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_02"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_02");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_03"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_03");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_04"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_04");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_05"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_05");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_06"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_06");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_07"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_07");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_08"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_08");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_09"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_09");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_10"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_10");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_11"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_11");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_12"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_12");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_13"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_13");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_14"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_BL_14");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_01_NH"):
			if (func_200(func_199(3)) == 0)
			{
				return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_01");
			}
			else
			{
				return 1264044047;
			...
			break;
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_02_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_02");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_03_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_03");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_04_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_04");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_05_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_05");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_06_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_06");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_07_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_07");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_08_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_08");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_09_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_09");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_10_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_10");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_11_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_11");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_12_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_12");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_13_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_13");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_14_NH"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_NH_14");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_01_SD"):
			if (func_200(func_199(3)) == 0)
			{
				return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_01");
			}
			else
			{
				return -2099454688;
			...
			break;
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_02_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_02");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_03_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_03");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_04_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_04");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_05_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_05");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_06_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_06");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_07_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_07");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_08_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_08");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_09_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_09");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_10_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_10");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_11_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_11");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_12_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_12");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_13_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_13");
		case GET_HASH_KEY("DOCUMENT_NEWSPAPER_ED_14_SD"):
			return GET_HASH_KEY("NEWSPAPERS/NEWSPAPER_SD_14");
	}
	return -1;
}
...
void func_80(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_01"):
			Global_40.f_9146.f_94[4] = 1;
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_02"):
			Global_40.f_9146.f_94[5] = 1;
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_03"):
			Global_40.f_9146.f_94[6] = 1;
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_04"):
		...
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_06"):
			...
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_07"):
			Global_40.f_9146.f_94[0] = 1;
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_08"):
			Global_40.f_9146.f_94[1] = 1;
			break;
		case GET_HASH_KEY("DOCUMENT_COACH_ROBBERY_NOTE_09"):
...
void func_82(int iParam0)
{
	...
	if (func_31(iParam0, 566155764))
	{
		...
		UIAPPS::LAUNCH_UIAPP_BY_HASH(GET_HASH_KEY("MAP"));
	}
}
...
bool func_86(int iParam0, int iParam1)
{
	switch (func_69(iParam0, -949239683))
	{
		...
		case 1894156335:
			...
			break;
		case 871191033:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@PAPER_D2_H32_ROLLED_FLIPPED_BASE"))
			{
				return true;
			}
			break;
		case -1273369295:
			...
			break;
		case 82200319:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@NEWSPAPER_FLIPPED_BASE"))
			{
				return true;
			}
			break;
...
bool func_90(int iParam0, int iParam1)
{
	switch (func_69(iParam0, -949239683))
	{
		...
		case 1894156335:
			...
			break;
		case 871191033:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@PAPER_D2_H32_ROLLED_FLIP_TO_BACK"))
			{
				return true;
			}
			break;
		case -1273369295:
			...
			break;
		case 82200319:
			if (iParam1 == GET_HASH_KEY("DOCUMENT_INSPECT@NEWSPAPER_FLIP_TO_BACK"))
			{
				return true;
			}
			break;
...
void func_92(var uParam0, var uParam1, int iParam2)
{
	...
	if (UIAPPS::IS_UIAPP_RUNNING_BY_HASH(GET_HASH_KEY("TRANSLATION_OVERLAY")))
	{
		...
		if (bVar2)
		{
			...
			{
				uParam1->f_1 = func_217("NEWS_PREV_ARTICLE", GET_HASH_KEY("INPUT_DOCUMENT_PAGE_PREV"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			}
		...
		if (bVar1)
		{
			if (!func_42(*uParam1))
			{
				*uParam1 = func_217("NEWS_NEXT_ARTICLE", GET_HASH_KEY("INPUT_DOCUMENT_PAGE_NEXT"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			}
...
void func_94(var uParam0, int iParam1)
{
	...
	else if (func_69(iParam1, 1224357681) == GET_HASH_KEY("CI_TAG_FOLDER_BOUNTY_POSTERS"))
	{
...
void func_114(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_259(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_259(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_127(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_238(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_277())
				{
					return false;
				}
...
bool func_129(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_61(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_130(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_281()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_137()
{
	if (((((func_290(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_290(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_290(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_290(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_290(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_290(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_139(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_114(51, 0, 0, 0, 0, -1, 0);
			func_294(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_114(51, 0, 0, 0, 0, -1, 0);
			func_294(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_112(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_298(1), 0, -1, 0);
			func_299(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_112(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_298(2), 0, -1, 0);
			func_299(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_112(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_298(4), 0, -1, 0);
			func_299(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_112(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_298(8), 0, -1, 0);
			func_299(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_112(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_298(16), 0, -1, 0);
			func_299(16);
			break;
	}
}
...
void func_142(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_105(437, 0);
			func_105(440, 0);
			func_302(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_114(51, 0, 0, sVar0, func_251(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_294(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_302(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_114(51, 0, 0, sVar0, func_251(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_294(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_302(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_114(51, 0, 0, sVar0, func_251(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_294(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_302(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_114(51, 0, 0, sVar0, func_251(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_294(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_105(438, 0);
			func_302(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_112(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_114(51, 0, 0, sVar0, func_251(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_294(32768);
			break;
		default:
			func_105(439, 0);
...
void func_144(int iParam0, int iParam1)
{
	...
	if (func_122() == -1)
	{
		...
		{
			func_304(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_305() == 0)
			{
				func_245(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_304(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_305() == 1)
			{
				func_245(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_307(iParam0) < func_308(iParam0))
					{
						func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_304(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_305() == 2)
			{
				func_245(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_309(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_310(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_244(48);
					}
					if (func_307(iParam0) < func_308(iParam0))
					{
						func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_304(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_305() == 3)
			{
				func_245(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_307(iParam0) < func_308(iParam0))
					{
						func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_304(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_305() == 4)
			{
				func_245(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_307(iParam0) < func_308(iParam0))
					{
						func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_147(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_138(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_138(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_138(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_138(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_138(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_138(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_138(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_138(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_138(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_138(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_138(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_138(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_314())
			{
				func_138(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_138(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_138(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_138(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_138(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_138(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_138(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_138(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_138(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_138(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_138(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_138(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_138(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_138(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_148(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_245(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_315(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_316(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_317(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_158(int iParam0, bool bParam1)
{
	...
	func_259(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_172(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_337(81053684, 0) <= 0)
			{
	...
	{
		if (!func_344(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_150(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_118(24);
		if (func_151(&iVar2, 0))
		{
...
int func_174(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_346(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_175(int iParam0)
{
	...
	if (func_31(iParam0, -305066475))
	{
		if (func_122() == -1)
		{
			...
			{
				return func_348(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_348(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_31(iParam0, -537818634))
	{
		return func_348(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_31(iParam0, 2084895747))
	{
		return func_348(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_177(int iParam0, char* sParam1)
{
	...
	func_352(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_351(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_178(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_356(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_31(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
{
	if ((!func_31(iParam1, 747873593) && !func_31(iParam1, GET_HASH_KEY("CI_TAG_FOLDER_LETTERS"))) && !func_31(iParam1, GET_HASH_KEY("CI_TAG_FOLDER_NOTES")))
	{
		return;
	}
...
int func_195(int iParam0, bool bParam1)
{
	...
	{
		return GET_HASH_KEY("BLIP_SCM_DORKINS");
	}
	else if (iParam0 == 26)
	{
		return GET_HASH_KEY("BLIP_RC_CALLOWAY");
	}
	else if ((iParam0 == 30 || iParam0 == 33) || iParam0 == 36)
	{
		return GET_HASH_KEY("BLIP_RC_CHAIN_GANG");
	}
	else if (iParam0 == 53 || iParam0 == 55)
	{
		return GET_HASH_KEY("BLIP_RC_CRACKPOT");
	}
	else if (iParam0 == 58)
	{
	...
	{
		return GET_HASH_KEY("BLIP_SCM_STRAUSS");
	}
	else if ((iParam0 == 71 || iParam0 == 74) || iParam0 == 75)
	{
		return GET_HASH_KEY("BLIP_SCM_EVELYN");
	}
	else if (iParam0 == 77)
	{
		return GET_HASH_KEY("BLIP_RC_ART");
	}
	else if (iParam0 == 82 || iParam0 == 83)
	{
		return GET_HASH_KEY("BLIP_AMBIENT_GANG_LEADER");
	}
	else if (iParam0 == 89)
	{
		return GET_HASH_KEY("BLIP_RC_KITTY");
	}
	else if (iParam0 == 101)
	{
		return GET_HASH_KEY("BLIP_RC_ALBERT");
	}
	else if (iParam0 == 115)
	{
		return GET_HASH_KEY("BLIP_SCM_EAGLE_FLIES");
	}
	else if ((iParam0 == 117 || iParam0 == 118) || iParam0 == 119)
	{
		return GET_HASH_KEY("BLIP_RC_OH_BROTHER");
	}
	else if (iParam0 == 121)
	{
		if (bParam1 || func_135(Global_1347702[iParam0 /*49*/].f_15, 1))
		{
			return GET_HASH_KEY("BLIP_RC_OBEDIAH_HINTON");
		}
	}
	else if (iParam0 == 127)
	{
		return GET_HASH_KEY("BLIP_RC_LIGHTNING");
	}
	else if (iParam0 == 136)
	{
		return GET_HASH_KEY("BLIP_RC_SLAVE_CATCHER");
	}
	else if (iParam0 == 143)
	{
		return GET_HASH_KEY("BLIP_RC_ODD_FELLOWS");
	}
	else if (iParam0 == 147)
	{
		if (bParam1 || func_135(Global_1347702[iParam0 /*49*/].f_15, 1))
		{
			return GET_HASH_KEY("BLIP_RC_WAR_VETERAN");
		}
	}
	if (iParam0 == 151)
	{
		return GET_HASH_KEY("BLIP_RC_HERBALIST");
	}
...
bool func_205(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (iParam1 == 0)
	{
		...
		while (iVar49 < iVar1)
		{
			...
			{
				if (Var2.f_2 == GET_HASH_KEY("COST_TYPE_CRAFT") && func_375(iParam0, Var2, 1))
				{
...
void func_226(var uParam0, int iParam1)
{
	...
	while (iVar1 < uParam0->f_131)
	{
		...
		while (iVar0 < uParam0->f_5.f_2[iVar1 /*5*/].f_1)
		{
			...
			switch (iParam1)
			{
				case GET_HASH_KEY("DOCUMENT_NOTE_STRAUSS_2"):
				case GET_HASH_KEY("DOCUMENT_NOTE_STRAUSS_1"):
				case GET_HASH_KEY("DOCUMENT_NOTE_STRAUSS_6"):
				case GET_HASH_KEY("DOCUMENT_NOTE_STRAUSS_5"):
				case GET_HASH_KEY("DOCUMENT_NOTE_STRAUSS_4"):
				case GET_HASH_KEY("DOCUMENT_NOTE_STRAUSS_3"):
					switch (uParam0->f_5.f_2[iVar1 /*5*/])
					{
						case 1410847083:
	...
	while (iVar2 < 15)
	{
		...
		if (iVar2 < uParam0->f_5.f_2[iVar0 /*5*/].f_1)
		{
			...
			else
			{
				...
				bVar4 = true;
				if (iVar3 == GET_HASH_KEY("NONE") || iVar3 == 0)
				{
					bVar4 = false;
				}
...
{
	return func_115(iParam0) == GET_HASH_KEY("WEAPON");
}
...
void func_232(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_115(iParam0) != GET_HASH_KEY("WEAPON"))
	{
		return;
	}
	iVar0 = func_121(iParam0, 0);
...
struct<5> func_234(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_115(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_272(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_272(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_244(int iParam0)
{
	...
	func_352(MISC::VAR_STRING(6, func_406(iParam0), fVar1), "itemtype_textures", func_407(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_265(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_122() == -1)
			{
				if (!func_344(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_442(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_277())
					{
					...
					func_150(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
bool func_282(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_115(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_122() != -1;
	...
	if (func_31(iParam1, 866047851))
	{
		...
		if (func_451(&(Global_1946804.f_1497)) >= 2 && Global_1946804.f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
	...
	switch (iVar4)
	{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_453(Global_1946804.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_454(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_291(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_61(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_292(int iParam0, char* sParam1, int iParam2)
{
	...
	func_352(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_293(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_352(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_352(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_133(func_348(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_300()
{
	...
	while (iVar1 < 30)
	{
		if (func_462(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_321(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_31(iParam0, 866047851) && func_451(&(Global_1946804.f_1378)) >= 2)
	{
		return false;
	}
	...
	{
		func_477(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_477(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	func_478(&(Global_1946804.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946804.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_479(iParam0, iParam2, iParam1, func_122() != -1);
	if (bParam4)
	{
		func_480(&(Global_1946804.f_1378), 1, 3);
	}
	else
	{
		func_480(&(Global_1946804.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_481(func_472(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_482(&(Global_1946804.f_2589), bParam0, bParam1, bParam2);
}
...
void func_325()
{
	func_485(&(Global_1946804.f_2776));
	func_486(32768);
...
int func_351(int iParam0)
{
	...
	if (!func_185(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
bool func_358(var uParam0, int iParam1, bool bParam2)
{
	...
	if (Global_1935689.f_10190 == 0 && !func_521())
	{
...
void func_382(var uParam0)
{
	...
	{
		bVar2 = true;
		if ((*uParam0)[iVar1] == GET_HASH_KEY("NONE") || (*uParam0)[iVar1] == 0)
		{
			bVar2 = false;
		}
...
{
	return func_272(GET_HASH_KEY("CHARACTER"), func_561(), -1591664384, bParam0);
}
...
{
	if (func_562(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_397(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
struct<14> func_398(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
int func_417()
{
	...
	while (iVar1 < 30)
	{
		if (func_574(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_443()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_123(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_171(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_123(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_171(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_461(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_459())
	{
		func_352(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_352(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_593(&(Global_1946804.f_2589), iParam0);
}

void func_476(int iParam0, int iParam1)
{
	func_594(&(Global_1946804.f_2589), iParam0, iParam1);
}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_454(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_119(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_454(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_31(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_480(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_600(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_482(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_122() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_603(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_505(0))
		{
			if (Global_40.f_7157[Global_40.f_7729 /*3*/] & 512 != 0)
			{
				...
				Global_1946804.f_1497 = func_505(Global_40.f_7729);
				Global_1946804.f_1378 = func_505(Global_40.f_7729);
...
void func_488(struct<4> Param0)
{
	...
	if (func_606(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_606(20))
			{
				return;
			}
			iVar0++;
...
{
	func_346(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_346(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_346(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}

void func_514(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
bool func_518(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		if ((!func_83(iParam0, 0) || iParam0 == GET_HASH_KEY("CUSTOM_SATCHEL")) || iParam0 == GET_HASH_KEY("KIT_WARDROBE"))
		{
			return false;
		}
	}
	...
	switch (iParam1)
	{
		...
		case -2074770370:
			...
			else if (func_69(iParam0, -949239683) == -1337515701 && iParam0 != GET_HASH_KEY("KIT_PLAYER_POCKETWATCH"))
			{
				return true;
			}
			else
...
bool func_519(int iParam0)
{
	...
	if (func_115(iParam0) == GET_HASH_KEY("UPGRADE") && !(func_31(iParam0, -1540973036) || func_31(iParam0, 1192444843)))
	{
		return false;
	}
	return true;
...
void func_570(int iParam0, int iParam1, int iParam2)
{
	...
	func_259(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_659(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_578()
{
	...
	func_663(0);
	func_664(7);
	func_665(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_341() == 1160113249)
	{
		func_665(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
...
void func_591(int iParam0)
{
	...
	Var0 = { func_348(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_602(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_122() == -1)
	{
		func_679(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_680(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_617()
{
	...
	func_171(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_404(1);
	func_570(1, iVar0, 0);
}
...
void func_619()
{
	...
	func_171(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_404(2);
	func_570(2, iVar0, 0);
}
...
void func_620()
{
	...
	func_171(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_404(0);
	func_570(0, iVar0, 0);
}
...
int func_624(int iParam0, int iParam1)
{
	...
	switch (Global_1935689.f_17)
	{
		case 1:
			...
			{
				if ((func_31(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")) || func_31(iParam0, -839724752)) || func_31(iParam0, -136654233))
				{
					return 1;
				}
			}
		...
		case 2:
			if (iParam1 == -2074770370)
			{
				if ((((((((func_31(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")) || func_31(iParam0, -839724752)) || func_31(iParam0, -136654233)) || func_31(iParam0, 554195525)) || func_31(iParam0, -1238310989)) || func_31(iParam0, 2127114599)) || func_31(iParam0, -1864584831)) || func_31(iParam0, 1068498601)) || func_31(iParam0, 1967571132))
				{
					return 1;
				}
			}
...
bool func_626(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_116(iParam0, 8388608))
		{
			...
			{
				if (func_61(GET_HASH_KEY("DOCUMENT_RARE_ORCHID_ORDER_1"), 1, 0))
				{
					if (!func_48(48))
					{
						return false;
...
int func_652(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_241(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_241(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_241(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}
...
void func_664(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		{
			func_719(&(Global_1946804.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_720(iVar2, 0))
		{
			func_721(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_665(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_723(iParam0, &(Global_1946804.f_2657.f_21), Global_1946804.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_723(iParam0, &(Global_1946804.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_723(iParam0, &(Global_1946804.f_2657.f_20), Global_1946804.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_723(iParam0, &(Global_1946804.f_2657.f_22), Global_1946804.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_723(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_723(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
...
void func_717(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_747(iParam0, &(Global_1946804.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_747(iParam0, &(Global_1946804.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_747(iParam0, &(Global_1946804.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_747(iParam0, &(Global_1946804.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_747(iParam0, &(Global_1946804.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_747(iParam0, &(Global_1946804.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
int func_723(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		func_719(&(Global_1946804.f_2657.f_26.f_26), iParam0, Global_1946804.f_2657.f_19);
	}
...
int func_747(int iParam0, var uParam1)
{
	...
	if (Global_1946804.f_2657.f_19 == 1)
	{
		...
		*uParam1 = 0;
		if (func_119(iParam0) != -999503751)
		{
			func_762(&(Global_1946804.f_2657.f_26), 0, Global_1946804.f_2657.f_19);
		}
	...
	*uParam1 = (*uParam1 - 1);
	...
	if (func_119(iParam0) != -999503751)
	{
		func_762(&(Global_1946804.f_2657.f_26), iVar0, Global_1946804.f_2657.f_19);
	}
	func_720(iParam0, 1);
	return 1;
}
...
int func_759(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar31 = func_767(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar31) && func_768(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar31), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_330(&Var17, iVar2, iVar0, iVar1))
			{
				if (iParam0 == Var17.f_4)
				{
					...
					{
						iVar32 = 1;
						func_769(&iVar31, iParam0, &iVar32, 1, -142743235);
					}
					func_9(iVar0);
					return 1;
				}
			...
			if (func_31(iParam0, 412399755))
			{
				...
				if (func_305() == 0)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_307(iParam0) < func_308(iParam0))
						{
							func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, 709057512))
			{
				...
				if (func_305() == 1)
				{
					...
					if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_307(iParam0) < func_308(iParam0))
						{
							func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, -1478961327))
			{
				...
				if (func_305() == 2)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_ACUNAS_STAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CIGAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_307(iParam0) < func_308(iParam0))
						{
							func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, -1238404098))
			{
				...
				if (func_305() == 3)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_307(iParam0) < func_308(iParam0))
						{
							func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, 1160548794))
			{
				...
				if (func_305() == 4)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_307(iParam0) < func_308(iParam0))
						{
							func_112(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
struct<4> func_786(int iParam0, int iParam1)
{
	struct<5> Var0;
...
struct<5> func_795(int iParam0)
{
	struct<5> Var0;

	Var0 = { func_796(iParam0, GET_HASH_KEY("CHARACTER"), func_561(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_796(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
{
	if ((func_31(iParam0, -839724752) || func_31(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL"))) || func_31(iParam0, 1286414894))
	{
		return true;
	}
	return false;
