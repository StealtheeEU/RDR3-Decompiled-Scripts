...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 1.1315f, -1.743f, 0f, -56f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_150(uParam0, -0.4685f, 1.932f, 0f, -56f, 1.0625f, 1.0275f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	...
	func_152(uParam0, GET_HASH_KEY("P_BRUSHDISH01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_BENCH_LOG07X"), -1.35271f, 1.61457f, -0.0227356f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS"), "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", -1, 0);
	func_154(uParam0, iLocal_15, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_15, 1, 120);
	func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_14, 1, 120);
	func_157(uParam0, GET_HASH_KEY("COMP_JAVCNV11"), GET_HASH_KEY("PLAYER_JAVCNV11"));
