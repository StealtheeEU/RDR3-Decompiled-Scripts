...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 4.8939f, -0.71f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	func_152(uParam0, 3.7439f, -4.0725f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG1", 0, 0, 1);
	...
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, 25f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, iLocal_19, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_159(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	return func_167(uParam0, vLocal_20, GET_HASH_KEY("WORLD_HUMAN_FIRE_COFFEE_KETTLE"), &iLocal_24, "p_boiler02x_PH_L_HAND", 0);
}
...
int func_167(var uParam0, vector3 vParam1, int iParam4, int iParam5, char* sParam6, bool bParam7)
{
	...
	{
		*iParam5 = TASK::FIND_SCENARIO_OF_TYPE_HASH(vParam1, iParam4, 1f, 0, false);
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
