...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.375f, -2.275f, 0.807f, 89f, 1f, 1f, 3.1425f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.8625f, -3.225f, 0.807f, 89f, 2.13f, 2.1625f, 3.1425f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_UNCCNV6"), GET_HASH_KEY("PLAYER_UNCCNV6"));
	func_156(uParam0, iLocal_16, -1, 0.91f);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_PEE"), "WORLD_HUMAN_PEE_MALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
