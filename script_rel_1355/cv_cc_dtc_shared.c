...
bool func_72(var uParam0)
{
	...
	iLocal_25 = func_151(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_24 = func_151(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_152(uParam0, 0f, -1.75f, 0.9f, 0f, 4f, 3f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	switch (func_19(uParam0))
	{
		case 103:
			...
			if (func_158(GET_HASH_KEY("CSTAG_FLOW_FIRST_VISIT_MUD1_POST"), 1))
			{
				uParam0->f_14 = 1;
			}
			break;
		...
		case 107:
			...
			func_160(uParam0, GET_HASH_KEY("COMP_DTCCNV11"), GET_HASH_KEY("PLAYER_DTCCNV11"));
			func_159(uParam0, iLocal_14, 1, 3, 0, 0, 0);
		...
		case 108:
			...
			func_160(uParam0, GET_HASH_KEY("COMP_DTCCNV12"), GET_HASH_KEY("PLAYER_DTCCNV12"));
			func_159(uParam0, iLocal_14, 1, 3, 0, 0, 0);
			func_156(uParam0, iLocal_14, 1, -1);
		...
		case 109:
			...
			func_160(uParam0, GET_HASH_KEY("COMP_DTCCNV13"), GET_HASH_KEY("PLAYER_DTCCNV13"));
			func_159(uParam0, iLocal_14, 1, 3, 0, 0, 0);
			func_156(uParam0, iLocal_14, 1, -1);
			break;
		case 115:
	...
	func_162(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_24, 0);
	func_163(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_254()
{
	...
	if (func_158(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_255()
{
	...
	if (func_158(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_158(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_400(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
