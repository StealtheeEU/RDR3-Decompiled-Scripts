...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1.2112f, -0.373f, 1.0018f, 70.397f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, -0.5889f, -1.3602f, 0.6039f, -53.7594f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, 0.5611f, 1.2023f, 0.6039f, -25.2594f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 4.0922f, -2.2747f, 1.0018f, 41.6379f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON01", 0, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL01", 0, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_ABICNV16"), GET_HASH_KEY("PLAYER_ABICNV16"));
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_14, 1, 6, 0, 0, 0);
	if (func_148(uParam0) == 2)
	{
		func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 100f, 0f, 0);
		func_160(uParam0, iLocal_14, 3, 0);
		func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_POKE_GROUND_STICK"), 0, -1, 0, 96f, 0f, 0);
...
int func_206(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_317("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_318(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_317("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
int func_253()
{
	...
	if (func_341(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_254()
{
	...
	if (func_341(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_353(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_403(iParam1))
		{
			func_404(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_341(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_423(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_477(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_494(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_506(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_524(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_506(GET_HASH_KEY("CHARACTER"), func_528(), -1591664384, bParam0);
}
