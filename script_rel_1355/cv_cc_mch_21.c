...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0128f, 0.9238f, 0.531f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.0934f, -0.9858f, 0.6002f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	func_153(uParam0, iLocal_14, GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_MICAH"), "REVOLVER");
	func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0305557f, "Chair", 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0306778f, "Stool", 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
