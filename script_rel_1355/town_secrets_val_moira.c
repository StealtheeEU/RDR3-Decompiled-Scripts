				...
				switch (Local_0.f_1)
				{
					case 0:
						if (func_25(&(Local_0.f_7), func_24(func_23(0)), 0, -1, 0, 0))
						{
							...
							func_27(GET_HASH_KEY("CSTAG_SP_TRELAWNY_FAMILY"), 1017034651, 1120952528, -1, 1, 1, 0);
...
void func_7(var uParam0)
{
	...
	{
		iVar1 = iVar2;
		if (VOLUME::DOES_VOLUME_EXIST(Local_0.f_5[iVar1]))
		{
...
int func_39(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			return GET_HASH_KEY("A_F_M_VALPROSTITUTE_01");
		default:
			break;
	}
	return GET_HASH_KEY("A_M_M_VALTOWNFOLK_01");
