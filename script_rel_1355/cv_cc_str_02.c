...
bool func_73(var uParam0)
{
	...
	iLocal_15 = func_152(uParam0, GET_HASH_KEY("CS_EDITHDOWN"), "EdithDown");
	iLocal_16 = func_152(uParam0, func_153(GET_HASH_KEY("HORSE_CLASS_RIDING"), 1), "Horse");
	func_154(uParam0, -8.7436f, 6.0821f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_154(uParam0, -0.15f, -0.1125f, 0f, 0f, 3.335f, 2.7475f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	iLocal_17 = func_155(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.274352f, -1.19492f, -0.00502014f, "p_chairfolding02x", 1, 0, 1);
	iLocal_18 = func_155(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "p_cs_ledger01x", 0, 1, 1);
	func_155(uParam0, GET_HASH_KEY("P_FOLDEDBILLS01X"), 0f, 0f, 0f, "P_FOLDEDBILLS01X", 0, 1, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_STRCNV2"), GET_HASH_KEY("PLAYER_STRCNV2"));
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_87(var uParam0)
{
	...
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(func_8(uParam0, iLocal_15), GET_HASH_KEY("REL_PLAYER_ALLY"));
	func_9(iVar0, 1);
	TASK::TASK_START_SCENARIO_AT_POSITION(iVar0, GET_HASH_KEY("WORLD_ANIMAL_HORSE_GRAZING"), -104.9883f, -18.30921f, 94.85979f, -48.94f, 0, false, true, 0, -1f, false);
	return true;
}
