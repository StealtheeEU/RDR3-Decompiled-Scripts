...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 8.8704f, -0.2134f, 1f, -41.42f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_150(uParam0, -5.4171f, -4.8134f, 1f, -41.42f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_150(uParam0, 0f, 0f, 1f, -179.5f, 3.6475f, 3.215f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "cigarette", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_MAP03X"), 0f, 0f, 0f, "MAP", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_23 = func_151(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 8.86017f, -0.297117f, 0.180412f, 0, 1, 0, 1);
	iLocal_24 = func_151(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.210525f, -1.25166f, 0.00876617f, 0, 1, 0, 1);
	func_152(uParam0, iLocal_15, GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_MICAH_DUALWIELD"), "Gun");
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DNKCNV4"), GET_HASH_KEY("PLAYER_DNKCNV4"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS"), "PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS_MALE_B", iLocal_23, 0);
	func_157(uParam0, iLocal_16, 1, -1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL"), "PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL_MALE_A", iLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
