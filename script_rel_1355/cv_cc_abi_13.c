...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, 0.64f, -0.72f, 0f, 31.68f, 3f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, -0.3586f, 2.5571f, 0.9955f, 76.6025f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_ABICNV13"), GET_HASH_KEY("PLAYER_ABICNV13"));
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), 1, 0, 0);
	Local_22 = { func_160(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7f, 0.629f, 0.5f) };
	iLocal_32 = func_161(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", GET_HASH_KEY("VOLCYLINDER"));
	return true;
}
