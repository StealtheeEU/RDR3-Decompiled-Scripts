...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_55 = GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -2.3021f, -3.5906f, 0f, 0f, 1.3f, 1.3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_150(uParam0, 0.1375f, 0.2f, 0.6f, 2f, 3.7175f, 3.495f, 2.685f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_151(uParam0, -0.32f, -1.6f, 1.0028f, 0f, 1.3f, 1.3f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_14 = func_152(uParam0, 6, 0);
	iLocal_15 = func_152(uParam0, 2, 0);
	func_153(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584473f, -1.37158f, -0.00269318f, "CHAIRBARREL", 1, 0, 1);
	iLocal_30 = func_153(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	iLocal_29 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42041f, -0.462646f, -0.00141144f, 0, 1, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_29, 0);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_29, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_164(uParam0, GET_HASH_KEY("COMP_JAVCNV8"), GET_HASH_KEY("PLAYER_JAVCNV8"));
	return true;
}
...
bool func_87(var uParam0)
{
	...
	{
		WEAPON::GIVE_WEAPON_TO_PED(func_48(uParam0, iLocal_14), iLocal_55, 1, true, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
	}
	else
	{
...
int func_208(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_315("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_316(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_315("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
void func_352(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_402(iParam1))
		{
			func_403(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_435(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_476(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_476(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_341(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_422(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_476(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_493(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_501(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_513(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_505(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_505(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_505(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_523(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_505(GET_HASH_KEY("CHARACTER"), func_527(), -1591664384, bParam0);
}
