...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, 0f, 0f, -19.75f, 3f, 3f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_152(uParam0, vLocal_59, -19.75f, 3f, 3f, 3f, GET_HASH_KEY("VOLCYLINDER"), 0);
	func_153(uParam0, 1.0375f, -0.475f, 0f, -26.5f, 2.635f, 3f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, 4.9187f, -2.087f, 0f, 164.4f, 1.1f, 1.1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	...
	func_153(uParam0, vVar0, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 0, 1, 1);
	func_153(uParam0, vVar3, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_FOLDEDBILLS01X"), 0f, 0f, 0f, "BILLS", 0, 1, 1);
	iLocal_19 = func_154(uParam0, GET_HASH_KEY("S_LOOTABLECAMPCASE"), 0f, 0f, 0f, "CASE", 1, 0, 1);
	func_154(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE1", 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEBEER01A"), 0f, 0f, 0f, "BOTTLE2", 0, 1, 1);
	...
	iLocal_17 = func_154(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), vVar9, 0, 1, 0, 1);
	iLocal_18 = func_154(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), vVar6, 0, 1, 0, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_BLLWRKCNV2"), GET_HASH_KEY("PLAYER_BLLWRKCNV2"));
	func_159(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", iLocal_17, 0, 85f, 1065353216 /* Float: 1f */, 1);
	func_161(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_162(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", iLocal_18, 0, 100f, 1065353216 /* Float: 1f */, 1);
...
{
	iLocal_65 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_172(uParam0, iLocal_17), GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
	iLocal_66 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_172(uParam0, iLocal_18), GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
...
bool func_93(var uParam0)
{
	...
	if (func_202(uParam0, iLocal_20))
	{
		...
		{
			TASK::TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_14), iLocal_65, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, true, false, 0, true, -1f, false);
		}
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_66))
		{
			TASK::TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_15), iLocal_66, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, true, false, 0, true, -1f, false);
		}
...
void func_343(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_386(iParam1))
		{
			func_387(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_402(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_456(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_473(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_481(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_493(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_485(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_485(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_485(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_503(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_485(GET_HASH_KEY("CHARACTER"), func_507(), -1591664384, bParam0);
}
