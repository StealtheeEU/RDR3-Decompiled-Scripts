...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.625f, 0.4125f, 0f, 0f, 2.4425f, 3.0175f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, -0.3f, 0.1f, 0f, -27f, 1.03f, 0.7f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "S_INV_WHISKEY01X", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "P_BOTTLEBEER01X", 0, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.434831f, 1.30266f, -0.00206757f, 0, 1, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_BCCCNUCNV2"), GET_HASH_KEY("PLAYER_BCCCNUCNV2"));
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_17, 0);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
