...
bool func_72(var uParam0)
{
	...
	{
		func_155(uParam0, 1.9376f, -0.875f, 1.4875f, 0f, 2.1625f, 2.2275f, 3.2075f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	}
	iLocal_17 = func_156(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottlebeer01x", 0, 0, 1);
	iLocal_18 = func_156(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "p_bottleJD01x", 0, 0, 1);
	if (!func_152(14))
	{
	...
	func_159(uParam0, GET_HASH_KEY("COMP_SNKPARCNV1"), GET_HASH_KEY("PLAYER_SNKPARCNV1"));
	func_160(uParam0, iLocal_16, -1, 0.87f);
	if (!func_152(14))
	{
		func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_WALL_LEFT"), "WORLD_HUMAN_LEAN_WALL_LEFT_DRINKING_MALE_A", -1, 1);
	}
	func_162(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_163(uParam0, iLocal_14, 1, -1);
	func_164(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	if (!func_152(14))
	{
		func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 1);
	}
	...
	if (func_152(14))
	{
		...
		func_161(uParam0, iLocal_14, 4, GET_HASH_KEY("WORLD_HUMAN_LEAN_WALL_LEFT"), "WORLD_HUMAN_LEAN_WALL_LEFT_DRINKING_MALE_A", -1, 0);
		...
		func_161(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_HUMAN_LEAN_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
