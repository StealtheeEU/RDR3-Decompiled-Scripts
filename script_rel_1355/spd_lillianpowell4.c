	...
	while (true)
	{
		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_253) && !ENTITY::IS_ENTITY_DEAD(iLocal_253)) && iLocal_14 != 84) && VOLUME::DOES_VOLUME_EXIST(iLocal_266)) && func_28(Global_35, iLocal_266, 1, 0))
				{
				...
				switch (iLocal_14)
				{
					...
					case 76:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_151()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_154(76))
						{
							func_102(0);
							func_152();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 77:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_155()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_154(77))
						{
							func_102(0);
							func_152();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 79:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_156()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_154(79))
						{
							func_102(0);
							func_152();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
...
void func_1()
{
	...
	func_172(&iLocal_253, &uLocal_273, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
...
bool func_409(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_179(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
