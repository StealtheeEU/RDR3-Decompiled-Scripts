...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.7703f, 0.8061f, 0.5545f, 56f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 8.5246f, 2.6798f, 1.0747f, 53f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_CHARLES"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_HAMMER02X"), 0f, 0f, 0f, "HAMMER", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, GET_HASH_KEY("COMP_MCHCNV12"), GET_HASH_KEY("PLAYER_MCHCNV12"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_422(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
