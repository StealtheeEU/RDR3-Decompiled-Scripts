...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.125f, -0.4001f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_15 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "Chair", 1, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DTCCNV34"), GET_HASH_KEY("PLAYER_DTCCNV34"));
	func_156(uParam0, iLocal_16, -1, 0.78f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", iLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
