...
bool func_76(var uParam0)
{
	...
	func_156(uParam0, 1.1615f, -1.954f, 0f, 86.75f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_16 = func_157(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	iLocal_15 = func_158(uParam0, "script@vignette@itm@pearson_item_1@action", 0, 0, 1, 1);
	func_159(uParam0, "CPRI1AU");
	func_160(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_RESTING_MALE_D", -1, 1);
	func_161(uParam0, iLocal_14, vLocal_32, 0, 1, 0);
	func_162(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_RESTING_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_27)
	{
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_8(uParam0, iLocal_14), "", 6f, 0f, 0, 0f, 0f, 0, false, -1);
		bLocal_27 = true;
	}
	iLocal_29 = 0;
	...
	{
		iLocal_28 = func_201("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_211(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			func_327(iVar0, 1);
			func_328();
			func_330(func_329(GET_HASH_KEY("CAMP_REQUESTS_STARTED")), 1);
			return 1;
		}
		iVar0++;
	}
...
int func_261()
{
	...
	if (func_354(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_262()
{
	...
	if (func_354(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_377(GET_HASH_KEY("CONSUMABLE_MEDICINE"));
...
void func_322(int iParam0)
{
	...
	{
		case 9:
			if (func_378(GET_HASH_KEY("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_379();
				func_380(GET_HASH_KEY("REWARD_PED_SMALL"), 0.68f);
				func_380(GET_HASH_KEY("REWARD_PED_MEDIUM"), 0.68f);
				func_380(GET_HASH_KEY("REWARD_PED_LARGE"), 0.68f);
			}
			break;
	}
}
...
void func_323(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			func_386(1, GET_HASH_KEY("CONSUMABLE_WHISKEY"), 0);
			func_386(2, GET_HASH_KEY("CONSUMABLE_PEPPERMINT"), 0);
			func_386(3, GET_HASH_KEY("CONSUMABLE_HERB_MILKWEED"), 0);
			func_386(4, GET_HASH_KEY("CONSUMABLE_HAIR_GREASE"), 0);
			func_386(5, 0, GET_HASH_KEY("AT_SKUNK"));
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_326(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_392(&uVar4, GET_HASH_KEY("COLOR_PURE_WHITE"));
...
void func_366(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_419(iParam1))
		{
			func_420(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_387(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_430("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_383(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_392(char* sParam0, int iParam1)
{
	...
	return func_437(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
char* func_393(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_354(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
int func_427(int iParam0, bool bParam1)
{
	...
	if (!func_478(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_479(iVar14);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_354(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_438(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
{
	return func_520(GET_HASH_KEY("CHARACTER"), func_543(), -1591664384, bParam0);
}
...
struct<4> func_520(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_428(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
