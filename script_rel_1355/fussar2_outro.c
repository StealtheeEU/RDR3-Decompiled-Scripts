...
int func_72(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(bVar0, 0))
	{
		if (func_32(PED::_GET_RIDER_OF_MOUNT(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_69(iParam0)) || func_70(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_89(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
float func_89(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1835011[iParam0 /*74*/].f_27))
	{
		...
		if (func_132(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_133(&(Global_1835011[iParam0 /*74*/]), 2))
			{
				if (func_95(iParam0))
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_96(iParam0));
					bVar2 = true;
				}
				else
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_75(iParam0));
				}
			}
			...
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_RADIUS(1673015813, func_136(iParam0), func_137(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_95(iParam0))
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_104(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_96(iParam0));
		...
		else if (func_103(iParam0))
		{
			if (iParam0 == 7)
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(-1337945352, func_75(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_75(iParam0));
...
bool func_110(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar1 < 27)
	{
		...
		{
			bVar2 = func_65(func_154(iParam0));
