...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 10.8f, 6.13f, 0f, 19.44f, 1.2f, 1.75f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 10.3375f, 6.425f, 0.95f, 108.7394f, 2.71f, 1.9675f, 1.38f, GET_HASH_KEY("VOLCYLINDER"), 1);
	if (!func_153(15))
	{
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_FEMALE_C", -1, 0);
	func_157(uParam0, iLocal_14, 3, -1);
	if (!func_153(15))
	{
		func_158(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	}
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_MALE_D", -1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
