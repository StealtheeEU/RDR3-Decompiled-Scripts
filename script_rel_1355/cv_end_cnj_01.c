...
bool func_72(var uParam0)
{
	...
	iLocal_20 = func_151(uParam0, GET_HASH_KEY("P_WOLFPOOP03X"), 9.191689f, 38.85237f, 1.644012f, "Poop", 0, 0, 1);
	func_152(uParam0, 8.9325f, 38.97f, 0.2375f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_BCCNJCNV1"), GET_HASH_KEY("PLAYER_BCCNJCNV1"));
