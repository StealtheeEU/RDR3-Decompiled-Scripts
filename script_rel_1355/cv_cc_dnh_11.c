...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1188f, -1.318f, 1f, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -2.1437f, -0.9055f, 1f, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 1.685f, 0.1375f, 0f, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CHAIR24X"), 1.61377f, -0.530518f, -0.0831604f, "p_chair02x", 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR24X"), -2.06982f, -0.913086f, -0.0831604f, "p_chair02x^1", 1, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "p_cs_book04x", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CIGAR02X"), 0f, 0f, 0f, "p_cigar02x", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DNHCNV11"), GET_HASH_KEY("PLAYER_DNHCNV11"));
	func_156(uParam0, iLocal_19, -1, 0.7f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_MALE_B", iLocal_16, 0);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 0f, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), 1, 0, 0);
	return true;
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
