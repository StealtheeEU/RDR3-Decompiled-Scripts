...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_PIGEON");
	fLocal_43 = 6f;
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 114:
			...
			{
				fLocal_43 = 0.5f;
				iLocal_9 = GET_HASH_KEY("A_C_BAT_01");
			}
			else
			{
				fLocal_43 = 6f;
				iLocal_9 = GET_HASH_KEY("A_C_CROW_01");
			}
			break;
		case 115:
			iLocal_9 = GET_HASH_KEY("A_C_PIGEON");
	...
	func_47(uParam0, 0, "BLS_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 12f), (0f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "BLS_BIRD_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, 1f, 12f), (135f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "BLS_BIRD_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, 1f, 12f), (-45f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "BLS_BIRD_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, 0f, 12f), (45f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "BLS_BIRD_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 12f), (-100f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 5, "BLS_BIRD_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.75f, -1f, 12f), (-135f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "BLS_BIRD_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, -0.25f, 12f), (-145f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 7, "BLS_BIRD_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, -1f, 12f), (-15f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 8, "BLS_BIRD_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, -0.5f, 15f), (-45f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 9, "BLS_BIRD_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.75f, 15f), (50f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 10, "BLS_BIRD_11", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, 15f), (0f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 11, "BLS_BIRD_12", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.5f, 1f, 15f), (35f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
}
...
void func_91(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_124(iParam1))
		{
			func_125(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_180(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_197(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_195(int iParam0, int iParam1)
{
	...
	if (func_222(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
