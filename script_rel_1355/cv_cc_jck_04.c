...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 0f, 0f, 1.3625f, 80f, 5f, 5f, 1.5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_154(uParam0, 3.1875f, -0.3125f, 0.782f, 80f, 5.8675f, 4.0925f, 2.505f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_154(uParam0, -4.325f, 5.45f, 0.782f, 80f, 1.1f, 1f, 2.505f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, 1);
	iLocal_18 = func_156(uParam0, GET_HASH_KEY("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	iLocal_19 = func_156(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "COFFEEMUG", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("S_SKIPPINGSTONE01X"), 0f, 0f, 0f, "STONE", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("S_SKIPPINGSTONE01X"), 0f, 0f, 0f, "STONE01", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("S_SKIPPINGSTONE01X"), 0f, 0f, 0f, "STONE02", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("S_SKIPPINGSTONE01X"), 0f, 0f, 0f, "STONE03", 0, 1, 1);
	...
	func_160(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 50f, 1065353216 /* Float: 1f */, 1);
	func_161(uParam0, iLocal_16, iLocal_18, "p_brushHorse01x_PH_R_HAND", 0, 0);
	func_162(uParam0, iLocal_16, 2, 2, 0, 0, 0);
	func_163(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_164(uParam0, iLocal_14, 3, 0);
	func_161(uParam0, iLocal_14, iLocal_19, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_163(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL"), "WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL", -1, 1);
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL"), "WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_164(uParam0, iLocal_15, 3, 0);
	func_165(uParam0, iLocal_15, 1, -1);
	func_166(uParam0, GET_HASH_KEY("COMP_JCKCNV4"), GET_HASH_KEY("PLAYER_JCKCNV4"));
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		iLocal_21 = TASK::FIND_SCENARIO_OF_TYPE_HASH(-113.32f, -15.6f, 94.89f, GET_HASH_KEY("PROP_HITCHINGPOST"), 0.25f, 0, false);
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_21))
		{
			TASK::TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_17), iLocal_21, 0, 0, false, true, 0, false, -1f, false);
...
int func_251()
{
	...
	if (func_330(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_252()
{
	...
	if (func_330(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_343(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_374(iParam1))
		{
			func_375(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_407(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_452(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_452(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_452(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_471(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_483(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_501(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_483(GET_HASH_KEY("CHARACTER"), func_505(), -1591664384, bParam0);
}
