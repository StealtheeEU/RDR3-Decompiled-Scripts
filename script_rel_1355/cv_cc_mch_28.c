...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -0.15f, -0.25f, 1f, 0f, 4f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.171797f, -1.1855f, 0.00361633f, 0, 1, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 1.37471f, -0.0501516f, -0.011795f, 0, 1, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "Knife", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_SHARPENINGSTONE01X"), 0f, 0f, 0f, "Sharpenningstone", 0, 1, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BottleBeer", 0, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BottleJD", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_CAMP_JAVIER_KNIFE"), "WORLD_CAMP_JAVIER_KNIFE", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_MCHCNV28"), GET_HASH_KEY("PLAYER_MCHCNV28"));
...
void func_204()
{
	...
	iVar0 = GET_HASH_KEY("DISCOVERABLE_NAME_CLEET_GOON");
	iVar1 = GET_HASH_KEY("DISCOVERABLE_NAME_JOE_GOON");
...
int func_206(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_313("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_314(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_313("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
void func_351(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_401(iParam1))
		{
			func_402(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_434(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_475(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_475(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_421(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_475(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_492(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_500(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_512(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_504(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_504(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_504(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_522(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_504(GET_HASH_KEY("CHARACTER"), func_526(), -1591664384, bParam0);
}
