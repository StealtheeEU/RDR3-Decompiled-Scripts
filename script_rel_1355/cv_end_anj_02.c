...
bool func_75(var uParam0)
{
	...
	func_155(uParam0, 6.1551f, 11.532f, -1.7f, -2.75f, 0.75f, 0.75f, 2.265f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_156(uParam0, GET_HASH_KEY("P_BROOM02X"), 0f, 0f, 0f, "BROOM", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 1.17084f, -0.0235534f, 0.7491f, "BOOK", 0, 0, 1);
	...
	func_159(uParam0, GET_HASH_KEY("COMP_BCANJCNV2"), GET_HASH_KEY("PLAYER_BCANJCNV2"));
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_BROOM"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1);
	func_161(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 0);
	func_161(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640f, 0f, 1);
...
bool func_86(var uParam0)
{
	if (!bLocal_31)
	{
		uLocal_32 = STREAMING::_0xB223249B7798EEED(func_51(uParam0, iLocal_15), GET_HASH_KEY("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), 1, GET_HASH_KEY("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A"));
		bLocal_31 = true;
		return false;
	}
...
void func_130(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_239(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_241(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_419(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_460(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_460(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_336(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_406(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
