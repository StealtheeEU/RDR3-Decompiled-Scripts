...
bool func_76(var uParam0)
{
	...
	func_158(uParam0, 0.2865f, 1.346f, 0f, 0f, 2.8125f, 3.0925f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_159(uParam0, GET_HASH_KEY("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	iLocal_19 = func_159(uParam0, GET_HASH_KEY("SCRIPTEDBALL"), 1.077087f, 1.077087f, 1.232589f, 0, 0, 1, 1);
	func_160(uParam0, iLocal_15, 2, GET_HASH_KEY("STAND"), 0, -1, 1);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1);
	func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 18f, 1065353216 /* Float: 1f */, 1);
...
bool func_97(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_9(uParam0, iLocal_15), GET_HASH_KEY("STAND"), 25000, false, 0, -1f, false);
	}
	return true;
}
...
int func_200(var uParam0)
{
	...
	{
		iLocal_32 = func_309("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_209(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			func_325(iVar0, 1);
			func_326();
			func_328(func_327(GET_HASH_KEY("CAMP_REQUESTS_STARTED")), 1);
			return 1;
		}
		iVar0++;
	}
...
int func_260()
{
	...
	if (func_352(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_261()
{
	...
	if (func_352(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_373(GET_HASH_KEY("CONSUMABLE_MEDICINE"));
...
void func_320(int iParam0)
{
	...
	{
		case 9:
			if (func_374(GET_HASH_KEY("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_375();
				func_376(GET_HASH_KEY("REWARD_PED_SMALL"), 0.68f);
				func_376(GET_HASH_KEY("REWARD_PED_MEDIUM"), 0.68f);
				func_376(GET_HASH_KEY("REWARD_PED_LARGE"), 0.68f);
			}
			break;
	}
}
...
void func_321(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			func_382(1, GET_HASH_KEY("CONSUMABLE_WHISKEY"), 0);
			func_382(2, GET_HASH_KEY("CONSUMABLE_PEPPERMINT"), 0);
			func_382(3, GET_HASH_KEY("CONSUMABLE_HERB_MILKWEED"), 0);
			func_382(4, GET_HASH_KEY("CONSUMABLE_HAIR_GREASE"), 0);
			func_382(5, 0, GET_HASH_KEY("AT_SKUNK"));
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_324(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_388(&uVar4, GET_HASH_KEY("COLOR_PURE_WHITE"));
		sVar2 = func_389(uParam0->f_3, 0);
		func_383(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, MISC::VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_383(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, HUD::GET_STRING_FROM_HASH_KEY(iVar0), 0, bParam1, 0);
	}
}
...
void func_364(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_415(iParam1))
		{
			func_416(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_383(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_431("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_379(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_389(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_352(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
int func_428(int iParam0, bool bParam1)
{
	...
	if (!func_479(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_480(iVar14);
...
void func_468(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_519(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_519(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_352(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_439(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
{
	return func_521(GET_HASH_KEY("CHARACTER"), func_542(), -1591664384, bParam0);
}
...
struct<5> func_547(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_426(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_521(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_521(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
