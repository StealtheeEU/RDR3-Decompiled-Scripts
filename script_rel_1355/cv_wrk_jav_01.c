...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_27 = GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY");
	iLocal_28 = GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_73(var uParam0)
{
	...
	iLocal_16 = func_154(uParam0, GET_HASH_KEY("P_GUITAR01X"), 0f, 0f, 0f, "GUITAR", 0, 0, 1);
	iLocal_17 = func_154(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE_BEER", 0, 1, 1);
	iLocal_21 = func_154(uParam0, GET_HASH_KEY("S_LOOTABLECAMPCASE"), 0f, 0f, 0f, "CASE", 1, 0, 1);
	iLocal_18 = func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_JD", 0, 0, 1);
	...
	func_156(uParam0, vVar0, fVar6, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 0, 1, 1);
	func_156(uParam0, vVar3, fVar7, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 0, 1, 1);
	func_156(uParam0, 0.5f, 0f, 0f, 0f, 4f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_157(uParam0, vLocal_37, 0f, 4f, 4f, 3f, GET_HASH_KEY("VOLCYLINDER"), 0);
	...
	func_159(uParam0, iLocal_20, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_20, iLocal_17, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_161(uParam0, iLocal_20, 1);
	func_159(uParam0, iLocal_19, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_GUITAR"), "PROP_HUMAN_SEAT_CHAIR_GUITAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_19, iLocal_16, "p_guitar01x_PH_R_HAND", 0, 0);
	func_162(uParam0, iLocal_19, 1);
	func_161(uParam0, iLocal_19, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_27, 15, 0, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D"));
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_28, 15, 0, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A"));
	return true;
}
...
bool func_87(var uParam0)
{
	...
	iLocal_44 = TASK::CREATE_SCENARIO_POINT_HASH(iLocal_28, vLocal_33, fLocal_36, 0, 0, 0);
	iLocal_43 = TASK::CREATE_SCENARIO_POINT_HASH(iLocal_27, vLocal_29, fLocal_32, 0, 0, 0);
...
bool func_94(var uParam0)
{
	if (func_201(uParam0, iLocal_14))
	{
		...
		{
			TASK::TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_19), iLocal_43, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, true, false, 0, true, -1f, false);
		...
		if ((!bLocal_23 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20))) && TASK::DOES_SCENARIO_POINT_EXIST(iLocal_44))
		{
			...
			{
				TASK::TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_20), iLocal_44, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, true, false, 0, true, -1f, false);
				bLocal_23 = true;
			}
		}
	}
...
void func_193(var uParam0)
{
	...
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_15], vLocal_37, vLocal_40, 2);
	if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(uParam0->f_1984[iLocal_15], "GUITAR", &Var0, false, 0, 2))
	{
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_380(iParam1))
		{
			func_381(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_409(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_450(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_450(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_396(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
