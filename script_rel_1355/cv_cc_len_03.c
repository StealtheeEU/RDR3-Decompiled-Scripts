...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 102.24f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	...
	func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1);
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_87(var uParam0)
{
	...
	if (!bLocal_15)
	{
		...
		{
			WEAPON::SET_CURRENT_PED_WEAPON(iVar0, GET_HASH_KEY("WEAPON_SNIPERRIFLE_ROLLINGBLOCK_LENNY"), true, 0, false, false);
			bLocal_15 = true;
		}
	}
