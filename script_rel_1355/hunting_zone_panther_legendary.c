...
bool func_4()
{
	return !UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_CHAL_LEGENDARY_PANTHER"));
}
...
bool func_42(var uParam0)
{
	*uParam0 = 13;
	...
	uParam0->f_9 = 80f;
	uParam0->f_10 = 180f;
	uParam0->f_572[0] = GET_HASH_KEY("P_PANTHESCAT01X");
	uParam0->f_572[1] = GET_HASH_KEY("P_PANTHERBLOOD01X");
	uParam0->f_572[2] = GET_HASH_KEY("A_C_SHEEP_01");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 3;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_PANTHER_01");
	StringCopy(&(uParam0->f_605), "PD_Med_aged_carcass_Hvy_Hot", 64);
	uParam0->f_12.f_5 = 1;
	uParam0->f_623 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("PANTHER_LEGENDARY");
	return true;
}
