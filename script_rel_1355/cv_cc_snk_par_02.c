...
void func_8(bool bParam0, bool bParam1)
{
	...
	if (((func_49() && STREAMING::IS_LOAD_SCENE_ACTIVE() == 0) && func_61(0) == Global_1835011[4 /*74*/].f_1 == 0) && func_62())
	{
		...
		if (func_67(10, 0) > 1)
		{
			if (func_68(GET_HASH_KEY("CSTAG_DUTCH_TENT_LOW_LEVEL"), 0))
			{
				func_69(GET_HASH_KEY("CSTAG_DUTCH_TENT_LOW_LEVEL"), 1, 0);
			}
		}
		else if (!func_68(GET_HASH_KEY("CSTAG_DUTCH_TENT_LOW_LEVEL"), 1))
		{
			func_70(GET_HASH_KEY("CSTAG_DUTCH_TENT_LOW_LEVEL"), 1017034651, 1120952528, -1, 1, 1, 0);
		}
...
bool func_52()
{
	if (func_68(GET_HASH_KEY("CSTAG_EVENT_HSO_PARTY_NIGHT"), 1) || func_68(GET_HASH_KEY("CSTAG_EVENT_SDB_PARTY_NIGHT"), 1))
	{
		if ((PED::IS_PED_USING_SCENARIO_HASH(func_130(0), GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW_LEFT")) && TASK::IS_PED_ACTIVE_IN_SCENARIO(func_130(0), 1)) && func_131(func_130(0), Global_1357549.f_1663[0], 1, 0))
		{
			return true;
		}
		else
...
bool func_56()
{
	if (ENTITY::DOES_ENTITY_EXIST(func_130(1)))
	{
		if (VOLUME::DOES_VOLUME_EXIST(Global_1357549.f_1663[1]))
		{
			...
			{
				if ((PED::IS_PED_USING_SCENARIO_HASH(func_130(1), GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW")) || PED::IS_PED_USING_SCENARIO_HASH(func_130(1), GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"))) || PED::IS_PED_USING_SCENARIO_HASH(func_130(1), GET_HASH_KEY("WORLD_HUMAN_SLEEP_GROUND_ARM")))
				{
					return true;
				}
			}
...
bool func_62()
{
	if (func_25() == 2 || func_25() == 3)
	{
		if (func_67(13, 0) > 1)
		{
			STREAMING::REQUEST_MODEL(GET_HASH_KEY("PIROGUE"), false);
			if (STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("PIROGUE")))
			{
				return true;
			}
			return false;
...
bool func_103(var uParam0)
{
	...
	{
		func_218(uParam0, -3.0514f, -2.3227f, 1.1367f, -29f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
		func_218(uParam0, -3.3319f, -5.0237f, 1f, 0f, 1.5f, 2.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
		func_218(uParam0, -4.2938f, -13.7708f, 1f, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	}
	iLocal_19 = func_219(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "bottle_0", 0, 1, 1);
	iLocal_20 = func_219(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "bottle_1", 0, 1, 1);
	bVar0 = false;
	if (ENTITY::DOES_ENTITY_EXIST(Global_1327590.f_19752) && ENTITY::GET_ENTITY_MODEL(Global_1327590.f_19752) == GET_HASH_KEY("P_CS_CAMPTENT01X"))
	{
		bVar0 = true;
	}
	iLocal_21 = func_219(uParam0, GET_HASH_KEY("P_CS_CAMPTENT01X"), 0f, 0f, 0f, "p_cs_campTent01x", bVar0, 0, 1);
	if (bVar0)
	{
	...
	func_222(uParam0, iLocal_14, 4, GET_HASH_KEY("WORLD_HUMAN_DRINKING_DRUNK"), "WORLD_HUMAN_DRINKING_DRUNK_MALE_A", -1, 1);
	func_223(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_222(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_B", -1, 1);
			...
			if (Var0[iVar87 /*5*/][iVar86] != func_292())
			{
				if ((iVar86 + 1 == func_67(iVar87, 1) && iParam0 == 1) && bParam2)
				{
					if (!STREAMING::IS_IPL_ACTIVE_HASH(Var0[iVar87 /*5*/][iVar86]))
					{
						...
						func_299(Var0[iVar87 /*5*/][iVar86], 1, uParam1);
					}
				}
				else if ((Var0[iVar87 /*5*/][(func_67(iVar87, 1) - 1)] != Var0[iVar87 /*5*/][iVar86] || iParam0 != 1) || bParam2 == 0)
				{
					if (STREAMING::IS_IPL_ACTIVE_HASH(Var0[iVar87 /*5*/][iVar86]))
					{
						...
						func_299(Var0[iVar87 /*5*/][iVar86], 0, uParam1);
					}
				}
			}
			iVar86++;
		...
		while (iVar52 < 3)
		{
			...
			while (iVar51 < 4)
			{
				if (Var1[iVar53 /*16*/][iVar52 /*5*/][iVar51] != func_292())
				{
					...
					{
						if (STREAMING::IS_IPL_ACTIVE_HASH(Var1[iVar53 /*16*/][iVar52 /*5*/][iVar51]))
						{
							iVar50++;
						}
					}
...
int func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_185(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_312(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
void func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_130(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_329(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_256(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_352(uParam0, uParam0->f_1976.f_1), 1, func_353(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
bool func_275(var uParam0)
{
	...
	if (!bLocal_42)
	{
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_79(uParam0, iLocal_14), "", 7f, 7f, 132, 0f, 0f, 0, false, -1);
		bLocal_42 = true;
	}
	iLocal_44 = 0;
	...
	{
		iLocal_43 = func_414("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_79(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
{
	return AUDIO::_0xF01C570E0A0A1E67(uParam0);
}
...
void func_299(int iParam0, bool bParam1, var uParam2)
{
	switch (iParam0)
	{
		case -2000080725:
			if (bParam1)
			{
				*uParam2 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(701.0167f, -1247.185f, 43.9899f, 3f, 2, -1, 0);
			}
			else
			{
				GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(uParam2, 0);
			}
			break;
	}
	switch (iParam0)
...
int func_346()
{
	...
	if (func_68(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_347()
{
	...
	if (func_68(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_414(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_483(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_484(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
{
	return func_436(GET_HASH_KEY("CHARACTER"), func_494(), -1591664384, bParam0);
}
...
int func_441(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_437(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_469(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_521(iParam1))
		{
			func_522(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_500(int iParam0, bool bParam1)
{
	...
	if (!func_549(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_499(iVar14);
...
void func_564(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_597(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_597(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_577(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_602(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_68(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_488(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
