...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -5.57f, -1.6425f, 0f, 0f, 1.265f, 1.325f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_150(uParam0, -1.081f, -0.2975f, 0f, -5.25f, 1.805f, 1.47f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	iLocal_14 = func_151(uParam0, 0, "IG_Dutch 1");
	iLocal_15 = func_151(uParam0, 21, "IG_RevSwanson 1");
	func_152(uParam0, GET_HASH_KEY("P_CAMP_CUP_01X"), 0f, 0f, 0f, "p_camp_cup_01x", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 2, -1);
	func_158(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	func_159(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return true;
}
