...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0126f, -0.5499f, 1.4875f, 0f, 3.75f, 2.04f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -5.0251f, 12.5376f, 1.4875f, -14.25f, 0.9f, 0.9f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_152(uParam0, "script@vignette@karen_13@base", 1, 1, 0, 0);
	iLocal_18 = func_152(uParam0, "script@vignette@karen_13@Action", 0, 0, 1, 0);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.171797f, -1.1855f, 0.00361633f, 0, 1, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), -1.5083f, -0.0606212f, 0.00151825f, 0, 1, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE_BEER", 0, 0, 1);
	iLocal_23 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE_BEER01", 0, 0, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_JD", 0, 0, 1);
	iLocal_24 = func_153(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "Knife", 0, 0, 1);
	func_154(uParam0, GET_HASH_KEY("COMP_KARCNV13"), GET_HASH_KEY("PLAYER_KARCNV13"));
	...
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_15, iLocal_22, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", iLocal_19, 0);
	func_156(uParam0, iLocal_14, 1, -1);
	func_162(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, iLocal_17, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS"), "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_PLAY_MALE_A", -1, 0);
	func_159(uParam0, iLocal_17, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS"), "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_PLAY_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_17, iLocal_24, "p_Javierknife_temp_PH_R_Hand", 0, 0);
	func_161(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_20, 0);
	func_159(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_202(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_311("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_312(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_311("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
int func_250()
{
	...
	if (func_338(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_251()
{
	...
	if (func_338(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_350(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_398(iParam1))
		{
			func_399(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_431(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_472(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_472(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_338(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_418(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_472(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_489(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_497(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_509(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_501(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_501(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_501(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_519(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_501(GET_HASH_KEY("CHARACTER"), func_523(), -1591664384, bParam0);
}
