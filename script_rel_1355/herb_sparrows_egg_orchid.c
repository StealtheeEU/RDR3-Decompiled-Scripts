...
void func_12(var uParam0)
{
	...
	bVar0 = false;
	if (((SCRIPTS::_GET_GLOBAL_BLOCK_CAN_BE_ACCESSED(4) && func_55()) && func_56(PLAYER::PLAYER_ID(), 1, 0)) && func_57(0) == GET_HASH_KEY("HERBALIST"))
	{
		bVar0 = true;
	}
...
bool func_90(int iParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4)
{
	...
	if (func_24(iParam0, vParam4, &iVar0, &iVar1, 0))
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iParam1) && !ENTITY::IS_ENTITY_DEAD(iParam1)) && iParam1 == Global_35)
		{
			...
			func_143(func_142(GET_HASH_KEY("PICK"), iVar2), iParam3);
			func_143(func_144(GET_HASH_KEY("HERBS_PICKED_TOTAL")), iParam3);
			if (func_145(iParam0))
			{
				func_143(func_144(GET_HASH_KEY("HERBS_PICKED_MUSHROOMS")), iParam3);
			}
		}
		func_29(iVar0);
		func_30(iVar0, iVar1);
...
void func_93(int iParam0, bool bParam1)
{
	...
	if (func_153(iParam0) == GET_HASH_KEY("CONSUMABLE"))
	{
		...
		{
			func_143(func_167(GET_HASH_KEY("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_152(iParam0, -1457797660))
		{
			func_143(func_167(GET_HASH_KEY("PROVISION_ITEMS_USED")), 1);
		}
		if (bVar40)
		{
			func_143(func_167(GET_HASH_KEY("DEADEYE_ITEMS_USED")), 1);
		}
...
void func_94(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	else if (!func_173(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_152(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_95(int iParam0, int iParam1)
{
	...
	Var0 = { func_142(GET_HASH_KEY("EATEN"), func_138(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_143(func_144(GET_HASH_KEY("HERBS_EATEN")), iParam1);
}
...
int func_104(int iParam0)
{
	...
	{
		case 2:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ALASKAN_GINSENG_ROOT_DEF");
		case 3:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_AMERICAN_GINSENG_ROOT_DEF");
		case 4:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_BAY_BOLETE_DEF");
		case 5:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_BLACK_BERRY_DEF");
		case 6:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_BLACK_CURRANT_DEF");
		case 7:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_BURDOCK_ROOT_DEF");
		case 8:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_CHANTERELLES_DEF");
		case 11:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_COMMON_BULRUSH_DEF");
		case 12:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_CREEPING_THYME_DEF");
		case 13:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_DESERT_SAGE_DEF");
		case 15:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ENGLISH_MACE_DEF");
		case 16:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_EVERGREEN_HUCKLEBERRY_DEF");
		case 18:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_GOLDEN_CURRANT_DEF");
		case 19:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_HUMMINGBIRD_SAGE_DEF");
		case 20:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_INDIAN_TOBACCO_DEF");
		case 23:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_MILKWEED_DEF");
		case 26:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_OLEANDER_SAGE_DEF");
		case 27:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_OREGANO_DEF");
		case 28:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_PARASOL_MUSHROOM_DEF");
		case 29:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_PRAIRIE_POPPY_DEF");
		case 31:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_RAMS_HEAD_DEF");
		case 33:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_RED_RASPBERRY_DEF");
		case 34:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_RED_SAGE_DEF");
		case 37:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_VANILLA_DEF");
		case 38:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_VIOLET_SNOWDROP_DEF");
		case 39:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_WILD_CARROT_DEF");
		case 40:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_WILD_FEVERFEW_DEF");
		case 41:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_WILD_MINT_DEF");
		case 42:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_WINTERGREEN_BERRY_DEF");
		case 43:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_YARROW_DEF");
		case 1:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_ACUNA_STAR_DEF");
		case 9:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_CIGAR_DEF");
		case 10:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_CLAM_SHELL_DEF");
		case 14:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_DRAGONS_DEF");
		case 17:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_GHOST_DEF");
		case 21:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_LADY_NIGHT_DEF");
		case 22:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_LADY_SLIPPER_DEF");
		case 24:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_MOCCASIN_DEF");
		case 25:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_NIGHT_SCENTED_DEF");
		case 30:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_QUEENS_DEF");
		case 32:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_RAT_TAIL_DEF");
		case 35:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_SPARROWS_DEF");
		case 36:
			return GET_HASH_KEY("COMPOSITE_LOOTABLE_ORCHID_SPIDER_DEF");
		default:
			break;
	}
	return 0;
...
void func_199(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 1:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_ACUNAS_STAR_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_ACUNAS_STAR_ORCHID_JN"), 0);
			}
			break;
		case 2:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_ALASKAN_GINSENG_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_ALASKAN_GINSENG_JN"), 0);
			}
			break;
		case 3:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_AMERICAN_GINSENG_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_AMERICAN_GINSENG_JN"), 0);
			}
			break;
		case 4:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BAY_BOLETE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BAY_BOLETE_JN"), 0);
			}
			break;
		case 5:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BLACKBERRY_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BLACKBERRY_JN"), 0);
			}
			break;
		case 6:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BLACK_CURRANT_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BLACK_CURRANT_JN"), 0);
			}
			break;
		case 11:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BULRUSH_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BULRUSH_JN"), 0);
			}
			break;
		case 7:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BURDOCK_ROOT_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_BURDOCK_ROOT_JN"), 0);
			}
			break;
		case 39:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CARROT_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CARROT_JN"), 0);
			}
			break;
		case 8:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CHANTERELLE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CHANTERELLE_JN"), 0);
			}
			break;
		case 9:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CIGAR_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CIGAR_ORCHID_JN"), 0);
			}
			break;
		case 10:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CLAMSHELL_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CLAMSHELL_ORCHID_JN"), 0);
			}
			break;
		case 12:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CREEPING_THYME_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_CREEPING_THYME_JN"), 0);
			}
			break;
		case 13:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_DESERT_SAGE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_DESERT_SAGE_JN"), 0);
			}
			break;
		case 14:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_DRAGONS_MOUTH_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_DRAGONS_MOUTH_ORCHID_JN"), 0);
			}
			break;
		case 15:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_ENGLISH_MACE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_ENGLISH_MACE_JN"), 0);
			}
			break;
		case 40:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_FEVERFEW_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_FEVERFEW_JN"), 0);
			}
			break;
		case 17:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_GHOST_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_GHOST_ORCHID_JN"), 0);
			}
			break;
		case 18:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_GOLDEN_CURRANT_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_GOLDEN_CURRANT_JN"), 0);
			}
			break;
		case 16:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_HUCKLEBERRY_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_HUCKLEBERRY_JN"), 0);
			}
			break;
		case 19:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_HUMMINGBIRD_SAGE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_HUMMINGBIRD_SAGE_JN"), 0);
			}
			break;
		case 20:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_INDIAN_TOBACCO_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_INDIAN_TOBACCO_JN"), 0);
			}
			break;
		case 21:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_LADY_OF_THE_NIGHT_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_LADY_OF_THE_NIGHT_ORCHID_JN"), 0);
			}
			break;
		case 22:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_LADY_SLIPPER_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_LADY_SLIPPER_ORCHID_JN"), 0);
			}
			break;
		case 23:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_MILKWEED_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_MILKWEED_JN"), 0);
			}
			break;
		case 41:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_MINT_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_MINT_JN"), 0);
			}
			break;
		case 24:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_MOCCASIN_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_MOCCASIN_ORCHID_JN"), 0);
			}
			break;
		case 25:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_NIGHT_SCENTED_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_NIGHT_SCENTED_ORCHID_JN"), 0);
			}
			break;
		case 26:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_OLEANDER_SAGE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_OLEANDER_SAGE_JN"), 0);
			}
			break;
		case 27:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_OREGANO_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_OREGANO_JN"), 0);
			}
			break;
		case 28:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_PARASOL_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_PARASOL_JN"), 0);
			}
			break;
		case 29:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_PRAIRIE_POPPY_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_PRAIRIE_POPPY_JN"), 0);
			}
			break;
		case 30:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_QUEENS_ORCHIDS_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_QUEENS_ORCHIDS_JN"), 0);
			}
			break;
		case 31:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RAMSHEAD_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RAMSHEAD_ORCHID_JN"), 0);
			}
			break;
		case 33:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RASPBERRY_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RASPBERRY_JN"), 0);
			}
			break;
		case 32:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RAT_TAIL_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RAT_TAIL_ORCHID_JN"), 0);
			}
			break;
		case 34:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RED_SAGE_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_RED_SAGE_JN"), 0);
			}
			break;
		case 35:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_SPARROWS_EGG_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_SPARROWS_EGG_ORCHID_JN"), 0);
			}
			break;
		case 36:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_SPIDER_ORCHID_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_SPIDER_ORCHID_JN"), 0);
			}
			break;
		case 37:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_VANILLA_FLOWER_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_VANILLA_FLOWER_JN"), 0);
			}
			break;
		case 38:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_VIOLET_SNOWDROP_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_VIOLET_SNOWDROP_JN"), 0);
			}
			break;
		case 42:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_WINTERBERRY_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_WINTERBERRY_JN"), 0);
			}
			break;
		case 43:
			if (iParam1 == 1)
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_YARROW_AR"), 0);
			}
			else
			{
				func_232(GET_HASH_KEY("JOURNAL_HERB_YARROW_JN"), 0);
			}
			break;
		default:
			break;
