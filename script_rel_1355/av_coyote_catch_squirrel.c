...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_37 = GET_HASH_KEY("A_C_COYOTE_01");
	iLocal_38 = GET_HASH_KEY("A_C_SQUIRREL_01");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "COYOTE", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "SQUIRREL", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_72(uParam0, 1.5f, 40f, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_68(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], GET_HASH_KEY("ENDSINRUN")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], GET_HASH_KEY("MOTIONSTATE_SPRINT"), false, 0, false);
...
void func_93(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_131(iParam1))
		{
			func_132(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_202(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_200(int iParam0, int iParam1)
{
	...
	if (func_227(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
