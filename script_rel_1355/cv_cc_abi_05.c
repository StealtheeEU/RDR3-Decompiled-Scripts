...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			iLocal_37 = GET_HASH_KEY("WORLD_CAMP_JACK_TOY_PLAY");
			break;
		case 2:
			func_149(uParam0, 73, 0, 0, 0);
			iLocal_37 = GET_HASH_KEY("WORLD_CAMP_JACK_THROWS_ROCKS_LEDGE");
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, -0.95f, -1.85f, 0f, 0f, 5f, 8f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_25 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 0, 0, 1);
	iLocal_26 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0.77388f, 0.119436f, 0.00186157f, 0, 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_ABICNV5"), GET_HASH_KEY("PLAYER_ABICNV5"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_396(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
