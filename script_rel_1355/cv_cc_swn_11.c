...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0061f, -1.935f, 0f, -2.5f, 3.205f, 1.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	func_151(uParam0, 4.1189f, 2.365f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.198f, -1.869f, 0.472f, "CHAIR", 1, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), -1.167f, -1.683f, 0.477f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "Knife", 0, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_WOODWHITTLE01X"), 0f, 0f, 0f, "Whittle", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_BOOK_TABLE_PUTDOWN"), "WORLD_HUMAN_BOOK_TABLE_PUTDOWN_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_C", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
