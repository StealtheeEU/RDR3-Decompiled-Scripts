...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.6875f, 1.2375f, 0f, -26f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -0.6f, -1.2125f, 0f, -26f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_151(uParam0, -3.59344f, 10.879f, 0.830566f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -14.461f, -2.763f, -0.136f, 84.35f, 1.5f, 1.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -1.25f, 0.7875f, 0f, -26f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	vVar0 = { -14.345f, -2.16691f, 0.826759f };
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("S_LOOTABLECAMPCASE"), vVar0, "LOOTBOX", 1, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, 0, 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLEJD", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_MONEYSTACK01X"), 0f, 0f, 0f, "MONEYSTACK", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_MONEYSTACK01X"), 0f, 0f, 0f, "MONEYSTACK^1", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	...
	func_155(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_A", iLocal_19, 0);
	func_156(uParam0, iLocal_16, 1, 0, 30, 0, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_20)
	{
		if (func_197(uParam0, iLocal_14))
		{
			...
			TASK::TASK_START_SCENARIO_AT_POSITION(func_48(uParam0, iLocal_14), GET_HASH_KEY("STAND"), vVar1, fVar0, 0, true, false, 0, -1f, false);
			bLocal_20 = true;
		}
	}
