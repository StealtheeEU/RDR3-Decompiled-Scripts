...
{
	iLocal_14 = func_43(GET_HASH_KEY("CS_RAINSFALL"), 1584.673f, 1460.016f, 145.623f, 240.1411f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_14, GET_HASH_KEY("REL_GANG_DUTCHS"));
