...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.3384f, -3.0037f, 1.156f, 17.0847f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -0.7301f, 0.5311f, 0.5295f, -0.2848f, 2.2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, -1.0257f, 0.9388f, 1.0341f, 0f, 0.72f, 0.72f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0306778f, 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), "REVOLVER");
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL"), "PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL_MALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (func_198(uParam0, iLocal_17))
	{
		if (func_199(uParam0, Local_23, 1, 0))
		{
			...
			func_201(uParam0, GET_HASH_KEY("COMP_HSHCNV12"), GET_HASH_KEY("PLAYER_HSHCNV12"));
...
bool func_96(var uParam0)
{
	...
	{
		PED::_SET_PED_SHOULD_PLAY_DIRECTED_SCENARIO_EXIT(func_48(uParam0, iLocal_14), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(func_48(uParam0, iLocal_14), 1f, 0f, 0f));
		bLocal_20 = true;
	}
	return true;
}
