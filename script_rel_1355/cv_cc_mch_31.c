...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.175f, 0.3875f, 0.8695f, 109.25f, 6f, 2.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 0.3708f, 1.3727f, 1.06f, 101.2207f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_51 = func_152(uParam0, -2.8292f, -0.1273f, 1.06f, 120.24f, 2.5f, 1.5f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
...
bool func_93(var uParam0)
{
	if (!bLocal_53)
	{
		...
		{
			iLocal_52 = func_152(uParam0, -3.4692f, 1.9827f, 1.06f, 91.44f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
