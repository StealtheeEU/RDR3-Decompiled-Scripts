...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -10.5949f, 2.2941f, 1.1367f, -29f, 4.5f, 4.5f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_MLLCNV7"), GET_HASH_KEY("PLAYER_MLLCNV7"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 1);
...
bool func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_15))
	{
		...
		{
			func_200(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
			func_201(uParam0);
		}
	}
	if (!bLocal_39)
	...
	{
		PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_14), GET_HASH_KEY("MOTIONSTATE_RUN"), false, 0, false);
		TASK::TASK_FLEE_COORD(func_48(uParam0, iLocal_14), 1907.99f, -1817.852f, 40.86853f, 2, 256, 100f, -1, 0);
