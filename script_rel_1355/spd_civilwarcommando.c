...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_14 = GET_HASH_KEY("U_M_O_CMRCIVILWARCOMMANDO_01");
	iLocal_15 = GET_HASH_KEY("P_CS_RAG01X");
	iLocal_16 = GET_HASH_KEY("P_CHAIR02X");
	...
	while (true)
	{
		...
		func_4();
		func_5();
		func_6(7, iLocal_244, &iLocal_240, &uLocal_248, &uLocal_187, 0, 1097859072 /* Float: 15f */, 0);
		func_7(iLocal_240, &iLocal_183, 524288, 7, 0);
		iVar0 = 0;
		iLocal_185 = func_9(&iLocal_240, &iLocal_123, 20f, &Local_144, &iVar0, 0f, 2, 0, 0, func_8(iLocal_239, 0, 0), 0, 0, 2, 1, -1082130432 /* Float: -1f */, 0);
		switch (iLocal_179)
		{
			case 0:
				func_10();
			...
			case 2:
				...
				break;
			case 3:
				vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_240, true, false) - ENTITY::GET_ENTITY_COORDS(Global_35, true, false) };
				...
				if (!func_14(iLocal_183, 16))
				{
					...
					{
						iLocal_184 = MISC::GET_GAME_TIMER() + 700;
				...
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_182, sVar6);
					iLocal_180 = iVar5;
				}
				if (((func_17(iLocal_240, Global_35, 0, 15f, 0) || (func_14(iLocal_183, 16) && MISC::GET_GAME_TIMER() >= iLocal_184)) || func_14(iLocal_183, 16384)) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_182, sVar6))
				{
					ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(iLocal_182, sVar6, true);
					func_11(4);
				}
				break;
			case 4:
				if (!func_14(iLocal_183, 16384))
				{
					...
					{
						if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_182) >= 0.15f)
						{
					...
					else
					{
						...
						{
							if (AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_240))
							{
				...
				if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(iLocal_182, "U_M_O_CmrCivilwarcommando_01"))
				{
					if (!func_14(iLocal_183, 16384))
					{
						func_11(5);
			...
			case 5:
				...
				if (!func_14(iLocal_183, 64))
				{
					bVar7 = AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_240);
				...
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_182, true, false) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_182, sLocal_181))
					{
						func_11(6);
					}
				}
				else if (func_14(iLocal_183, 256))
				{
					...
					else if (!func_14(iLocal_183, 2048))
					{
						if (!func_26())
						{
							if (AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_240) && AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE(func_18(4)) == 1)
							{
						...
						else if (!func_14(iLocal_183, 4096))
						{
							if (!AUDIO::_0xA2CAC9DEF0195E6F(1))
							{
								...
								{
									iLocal_184 = MISC::GET_GAME_TIMER() + 1200;
					...
					else if (MISC::GET_GAME_TIMER() >= iLocal_184 && !AUDIO::_0x54B187F111D9C6F8(iLocal_240, 0))
					{
				...
				else if (MISC::GET_GAME_TIMER() >= iLocal_184)
				{
					if (!func_14(iLocal_183, 2))
					{
						if (func_19(func_18(1)))
						{
							...
							iLocal_184 = (6500 + MISC::GET_GAME_TIMER());
						}
					}
					else if (!func_14(iLocal_183, 4))
					{
						if (func_19(func_18(2)))
						{
							...
							iLocal_184 = (5500 + MISC::GET_GAME_TIMER());
						}
					}
			...
			case 6:
				...
				func_28();
				sLocal_181 = func_16(func_25());
				if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_182) && !ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_182, false)) && !ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_182, false))
				{
					ANIMSCENE::START_ANIM_SCENE(iLocal_182);
				}
				if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_182, false))
				{
					func_11(7);
				}
				break;
			case 8:
				if (!MAP::DOES_BLIP_EXIST(iLocal_243))
				{
					...
					{
						iLocal_243 = MAP::BLIP_ADD_FOR_ENTITY(GET_HASH_KEY("BLIP_STYLE_ENEMY"), iLocal_240);
					}
				}
				if (!PED::IS_PED_IN_COMBAT(iLocal_240, 0))
				{
					PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_240, 46, true);
					PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_240, 5, true);
					TASK::TASK_COMBAT_PED(iLocal_240, Global_35, 0, 0);
				}
				func_30(iLocal_17[6]);
				break;
			case 7:
				if (MISC::GET_GAME_TIMER() >= iLocal_184)
				{
					...
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_240, Global_35, 1000, -1f, -1f, -1f);
					}
					else
					{
						TASK::TASK_TURN_PED_TO_FACE_COORD(iLocal_240, 2022.659f, 618.8069f, 156.3129f, 1000);
					}
...
void func_1()
{
	...
	func_34(&iLocal_240, &uLocal_186, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_188, false);
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_240))
	{
		PED::_0x39A2FC5AF55A52B1(iLocal_240, -1);
...
void func_3()
{
	...
	if (func_29(iLocal_240, 0))
	{
		if (func_31(Global_35, iLocal_17[5], 0, 1))
		{
			if (((iLocal_179 == 4 || iLocal_179 == 5) || iLocal_179 == 6) || iLocal_179 == 7)
			{
				...
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_240, Global_35, -1, 0, 51, 0);
	...
	if (bVar0)
	{
		if (func_14(iLocal_183, 1048576))
		{
			TASK::TASK_CLEAR_LOOK_AT(iLocal_240);
...
void func_4()
{
	if (iLocal_179 == 6)
	{
		if (!PED::IS_PED_HEADTRACKING_ENTITY(Global_35, iLocal_240))
		{
			TASK::TASK_LOOK_AT_ENTITY(Global_35, iLocal_240, -1, 0, 51, 0);
		}
	}
	else if (PED::IS_PED_HEADTRACKING_ENTITY(Global_35, iLocal_240))
	{
...
void func_5()
{
	...
	else
	{
		if (!func_14(iLocal_183, 8388608))
		{
			...
			{
				AUDIO::STOP_CURRENT_PLAYING_SPEECH(iLocal_240, 0);
				AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iLocal_240, 0);
...
{
	func_62();
	HUD::TEXT_BLOCK_REQUEST("SPCWCAU");
	HUD::TEXT_BLOCK_REQUEST("SPCW");
...
void func_11(int iParam0)
{
	...
	switch (iParam0)
	{
		case 5:
			...
			TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_240, Global_35, -1, false, 1);
			...
			break;
		case 6:
			PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), iLocal_240, "COMMANDO_INTERACT_FOCUS", 0f, 0f, 0f, 0, "CommandoConvo");
			func_80(iLocal_240);
			func_45(&(Local_144[0 /*17*/]), 1);
			func_45(&(Local_144[1 /*17*/]), 1);
			iLocal_184 = MISC::GET_GAME_TIMER() + 5000;
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(Global_35, iLocal_240, 2000, -1f, -1f, -1f);
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0, false);
			TASK::CLEAR_PED_TASKS(iLocal_240, true, false);
			if (func_81())
			{
			...
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "U_M_O_CmrCivilwarcommando_01", iLocal_240, 0);
		...
		case 8:
			func_50(7);
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_240, ENTITY::GET_ENTITY_COORDS(iLocal_240, true, false), 6f, 0, false, 0);
...
bool func_12()
{
	if (!HUD::TEXT_BLOCK_IS_LOADED("SPCWCAU") || !HUD::TEXT_BLOCK_IS_LOADED("SPCW"))
	{
		return false;
	}
	...
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_182, true, false))
	{
		return false;
	}
...
bool func_13()
{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_240, GET_HASH_KEY("REL_NO_RELATIONSHIP"));
		...
		func_90(&iLocal_240, &uLocal_186, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
		func_91();
		if (func_81())
		{
			if (iLocal_244 == 0 || iLocal_244 == 2)
		...
		PED::_0x7C00CFC48A782DC0(iLocal_17[6], iLocal_240, 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "U_M_O_CmrCivilwarcommando_01", iLocal_240, 0);
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "p_cs_rag01x", iLocal_241, 0);
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_102(func_101(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_103(func_101(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
int func_58(int iParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		fVar8 = func_155(fParam12 >= 0f, fParam12, BUILTIN::VDIST(Global_36, ENTITY::GET_ENTITY_COORDS(*iParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_161(iParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
...
void func_59(int* iParam0, var uParam1, int iParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_173(Global_35, *iParam2, sVar1, "", -1082130432 /* Float: -1f */, uVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
void func_64()
{
	...
	iLocal_17[6] = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), 2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17[5], 2023.958f, 617.214f, 158.8349f, 0f, 0f, -30f, 23f, 35f, 15f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17[5], 2025.146f, 631.483f, 158f, 0f, 0f, -30f, 35f, 18f, 16f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17[5], 2016.196f, 625.6975f, 158.8349f, 0f, 0f, -30f, 4f, 3f, 15f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17[5], 2007.084f, 613.6472f, 158.8349f, 0f, 0f, -30f, 6f, 12f, 15f);
}
...
void func_91()
{
	...
	func_194(&(Local_144[0 /*17*/]), "INTERACT_GREET", func_193(), GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, 1, 0);
	func_194(&(Local_144[1 /*17*/]), "INTERACT_INSULT", sVar0, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 1, iVar1);
	func_195(iLocal_240, &Local_144, 20f, 2, 0, 0, 0, 0, 0);
	func_20(&(Local_144[0 /*17*/]), 1, 0);
	func_20(&(Local_144[1 /*17*/]), 1, 0);
	iLocal_239 = 3;
	func_23(&iLocal_123, 0);
	PED::SET_PED_CONFIG_FLAG(iLocal_240, 297, true);
}
...
bool func_157(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*iParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_57(iParam4, 268435456))
			{
				iVar8 = func_254(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
bool func_164(int iParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((PED::IS_PED_CARRYING_SOMETHING(Global_35) || func_258(Global_35)) || func_259(Global_35)) || func_260(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		func_261(*iParam0, uParam4[iVar0 /*17*/], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (MISC::IS_BIT_SET((*uParam4)[iVar0 /*17*/], 20))
		{
			bVar3 = true;
		}
		if (func_262(*iParam0, iParam1, uParam4[iVar0 /*17*/], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
...
void func_195(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_285(iParam0, uParam1[iVar0 /*17*/], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
bool func_220(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_238(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_296(iVar0, 0)))
		{
...
bool func_224(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_296(iVar0, 0)))
		{
			if (func_298(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_236(int iParam0, int iParam1)
{
	...
	if (func_301(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
int func_252(int iParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	...
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		...
		func_285(iParam0, uParam2[iVar0 /*17*/], fParam3, 3, 0, 6, bParam4, 0);
...
int func_272(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, var uParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_320(func_319(iParam0, sParam2, iParam11, iParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, uParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_282(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_321(iParam1))
		{
			func_322(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_285(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_97(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_267(iParam1))
		{
			...
			iParam1->f_6 = func_330(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_97(iParam1->f_6))
			{
				if (!bParam6)
				{
...
bool func_297(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_298(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
int func_330(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_333(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_343(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
