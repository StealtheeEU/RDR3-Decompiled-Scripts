...
bool func_72(var uParam0)
{
	...
	func_154(uParam0, 0.8755f, 1.4219f, 0.9428f, 0f, 2.5f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_155(uParam0, 1);
	func_156(uParam0, GET_HASH_KEY("P_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_15), GET_HASH_KEY("STAND"), 25000, false, 0, -1f, false);
	}
	return true;
}
