...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.625f, -0.875f, 0.6695f, 168.75f, 2f, 2f, 2.015f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -0.775f, -5.5626f, 1.182f, 85.5f, 1.1f, 1.1f, 2.365f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -3.87134f, -1.09542f, 1.00508f, 0f, 1f, 1f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR24X"), -4.62596f, -1.37365f, -0.000255585f, "Chair", 1, 0, 1);
	...
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 1, -1);
	iLocal_17 = func_159(uParam0, 3.3625f, 1.3387f, 2.4264f, 0f, 0f, 174.515f, 16.4725f, 16.24f, 5f, "Start_Trigger", GET_HASH_KEY("VOLBOX"));
	func_160(uParam0, GET_HASH_KEY("COMP_KARCNV10"), GET_HASH_KEY("PLAYER_KARCNV10"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
