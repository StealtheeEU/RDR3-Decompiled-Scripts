...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.4375f, -0.4375f, 0.993f, -46.8f, 3f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, -2.8108f, -2.6885f, 0.9931f, 134.1287f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	Local_21 = { func_152(uParam0, -0.925f, -0.76f, 1.07f, -32.5f, 6.5f, 0.4725f, 0.96f) };
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584473f, -1.37158f, 0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_17, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_19, 0);
	func_157(uParam0, iLocal_17, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_JAVCNV7"), GET_HASH_KEY("PLAYER_JAVCNV7"));
