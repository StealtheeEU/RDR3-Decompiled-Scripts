...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_38 = GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS");
...
bool func_76(var uParam0)
{
	...
	func_156(uParam0, -1.1125f, 2.7375f, 0f, 80f, 3f, 3f, 1.5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_157(uParam0, -1.2625f, 2.3375f, 0.5445f, 80f, 2f, 2f, 1.5f, GET_HASH_KEY("VOLCYLINDER"), -1, 1, 1, 1);
	...
	iLocal_27[0] = GET_HASH_KEY("P_CHAIR06X");
	iLocal_27[1] = GET_HASH_KEY("P_BOTTLEJD01X");
	iLocal_27[2] = GET_HASH_KEY("P_BOTTLE03X");
	iLocal_27[3] = GET_HASH_KEY("P_CS_MOLOTOV_CLOTH");
	sLocal_32[0] = "CHAIR";
...
bool func_79(var uParam0)
{
	...
	if (!bLocal_16)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_18, 1.4f))
		{
			...
			iLocal_21 = PROPSET::_CREATE_PROP_SET_2(GET_HASH_KEY("PG_SCENARIO_MOLOTOVMAKE"), vVar0, 0, fVar3, 1200f, false, true);
			bLocal_16 = true;
		}
	}
	return bLocal_16;
...
bool func_88(var uParam0)
{
	if (func_180(uParam0))
	{
		...
		iLocal_37 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(iLocal_22[0], iLocal_38, 0f, -0.07f, 0.5f, -180f, 0, 0, 0);
...
bool func_90(var uParam0)
{
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_37) && ENTITY::DOES_ENTITY_EXIST(func_9(uParam0, iLocal_15)))
	{
		...
		{
			PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_15), iLocal_22[1], "p_bottleJD01x_ph_r_hand", iLocal_38, 0, 1);
		}
		TASK::TASK_USE_SCENARIO_POINT(func_9(uParam0, iLocal_15), iLocal_37, sLocal_39, 0, false, true, 0, false, -1f, false);
	}
	return true;
}
...
bool func_91(var uParam0)
{
	...
	if (!bLocal_53)
	{
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_9(uParam0, iLocal_15), "", 6f, 0f, 0, 0f, 0f, 0, false, -1);
		bLocal_53 = true;
	}
	iLocal_41 = 0;
	...
	{
		iLocal_40 = func_199("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_15), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
bool func_97(var uParam0)
{
	...
	{
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_15), iLocal_22[1], "p_bottleJD01x_ph_r_hand", iLocal_38, sLocal_39, 1);
		TASK::TASK_USE_SCENARIO_POINT(func_9(uParam0, iLocal_15), iLocal_37, sLocal_39, 0, false, true, 0, false, -1f, false);
...
bool func_172()
{
	...
	if (!PROPSET::_HAS_PROP_SET_LOADED_2(GET_HASH_KEY("PG_SCENARIO_MOLOTOVMAKE")))
	{
		PROPSET::_REQUEST_PROP_SET_2(GET_HASH_KEY("PG_SCENARIO_MOLOTOVMAKE"));
		return false;
	}
...
int func_211(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			func_319(iVar0, 1);
			func_320();
			func_322(func_321(GET_HASH_KEY("CAMP_REQUESTS_STARTED")), 1);
			return 1;
		}
		iVar0++;
	}
...
int func_260()
{
	...
	if (func_346(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_261()
{
	...
	if (func_346(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_287(int iParam0, var uParam1, int iParam2)
{
	...
	iVar1 = PROPSET::_GET_ENTITIES_FROM_PROP_SET(iParam0, iVar0, uParam1, false, false);
	if (iVar1 == 0)
	{
...
void func_356(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_410(iParam1))
		{
			func_411(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_377(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_421("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_373(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_382(char* sParam0, int iParam1)
{
	...
	return func_428(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
char* func_383(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_346(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
int func_418(int iParam0, bool bParam1)
{
	...
	if (!func_469(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_470(iVar14);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_346(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_429(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_509(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_530(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_511(GET_HASH_KEY("CHARACTER"), func_534(), -1591664384, bParam0);
}
