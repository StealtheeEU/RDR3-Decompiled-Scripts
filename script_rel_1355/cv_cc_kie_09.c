...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, GET_HASH_KEY("P_CS_ROPE03X"), 0f, 0f, 0f, "ROPE", 0, 1, 1);
	...
	if (func_162(GET_HASH_KEY("CSTAG_FLOW_FIRST_VISIT_MUD1_POST"), 1))
	{
		uParam0->f_14 = 1;
	}
	return true;
...
int func_251()
{
	...
	if (func_162(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_252()
{
	...
	if (func_162(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_162(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
