...
void func_25()
{
	...
	if (!func_52(1, 1))
	{
		func_53(799);
		func_54(1);
		func_55(GET_HASH_KEY("DOOR_ROC_HOUSE_INT_2"), 1, 0f, 0, 0, 0, 0, 0);
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(750713851, false);
	}
	else
	{
		func_56(6, 1, GET_HASH_KEY("DOOR_ROC_HOUSE_INT_2"));
...
{
	func_55(GET_HASH_KEY("DOOR_ROC_HOUSE_INT_1"), bParam0, 0, 0, 0, 0, 0, 0);
	if (bParam0)
	{
		OBJECT::_0xC07B91B996C1DE89(GET_HASH_KEY("DOOR_ROC_HOUSE_INT_1"), 0);
	}
}
...
void func_64()
{
	...
	if (func_100(6, 16384))
	{
		func_128(GET_HASH_KEY("ROC_01_GARDEN01_DIE"));
		func_128(-786579336);
		func_129(GET_HASH_KEY("ROC_01_GARDEN01_NICE"));
		func_129(-1305545118);
	}
	else
	{
		func_128(GET_HASH_KEY("ROC_01_GARDEN01_NICE"));
		func_128(-1305545118);
		func_129(GET_HASH_KEY("ROC_01_GARDEN01_DIE"));
		func_129(-786579336);
	}
	func_130(6, 64);
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_149(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_149(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_149(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_149(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_155(func_154(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_131()
{
	...
	{
		case 0:
			STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_FIREPLACELOGS02X"), false);
			func_189(1);
			break;
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_FIREPLACELOGS02X")))
			{
				return;
			}
			if (!func_190(&iLocal_16, GET_HASH_KEY("P_FIREPLACELOGS02X"), &uLocal_17, 2992.59f, 2194.709f, 165.788f, 4, 0))
			{
				return;
			}
			func_189(2);
