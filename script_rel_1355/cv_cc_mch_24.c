...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_17 = GET_HASH_KEY("W_REPEATER_CARBINE01");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 3.6829f, -3.9259f, 1f, -88.92f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 0.0376f, -0.1f, 1f, -88.92f, 3.2f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_RAG01X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(GET_HASH_KEY("WEAPON_REPEATER_CARBINE"), 1, uParam0->f_23, true, 1f);
	return true;
}
...
int func_241()
{
	...
	if (func_315(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_242()
{
	...
	if (func_315(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_326(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_359(iParam1))
		{
			func_360(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_392(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_437(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_437(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_315(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_379(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_437(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_456(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_468(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_486(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_468(GET_HASH_KEY("CHARACTER"), func_490(), -1591664384, bParam0);
}
