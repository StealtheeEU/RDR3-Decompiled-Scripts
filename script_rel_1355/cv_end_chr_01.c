...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_PITCHFORK01X"), 0f, 0f, 0f, "PITCHFORK", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_WHEELBARROW01X"), 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_HAYPILE02X"), 0f, 0f, 0f, "HAYPILE", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP01X"), 0f, 0f, 0f, "HORSEPOOP01", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^1", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^2", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^3", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^4", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP03X"), 0f, 0f, 0f, "HORSEPOOP03", 0, 0, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_BCCHRCNV1"), GET_HASH_KEY("PLAYER_BCCHRCNV1"));
	func_155(uParam0, iLocal_14, 1, -1);
	iLocal_18 = func_156(uParam0, 0f, 5.38f, 1.95f, 0f, 0f, -1f, 8.64f, 8.12f, 4f, "volTriggerBeecherCharles1", GET_HASH_KEY("VOLBOX"));
	func_157(uParam0, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_319(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_385(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
