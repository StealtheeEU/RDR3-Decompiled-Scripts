...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 12.3f, 4.5f, 1.612f, 123.25f, 2f, 3.1425f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, -1.1475f, -1.4025f, 1.4875f, -44f, 1.0975f, 1.145f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), -1.16311f, -1.68532f, -0.0235901f, 0, 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "p_cs_rag02x", 0, 1, 1);
	func_153(uParam0, iLocal_14, GET_HASH_KEY("WEAPON_REPEATER_CARBINE"), "w_repeater_carbine01");
	func_153(uParam0, iLocal_15, GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION"), "w_revolver_cattleman01");
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 3, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_16, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return true;
}
