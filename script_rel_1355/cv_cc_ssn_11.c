...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	func_152(uParam0, -9.05752f, -6.47742f, 1.62065f, 0f, 3f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -17.3338f, -7.27841f, 1.59476f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_STRAUSS"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SSNCNV11"), GET_HASH_KEY("PLAYER_SSNCNV11"));
	func_156(uParam0, iLocal_16, -1, 0.93f);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_WAITING_IMPATIENT"), "WORLD_HUMAN_WAITING_IMPATIENT_MALE_A", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
