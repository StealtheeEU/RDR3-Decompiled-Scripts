...
void __EntryFunction__()
{
	...
	iLocal_10 = GET_HASH_KEY("A_C_EGRET_01");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 1, "EGRET", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (func_63(uParam0, 0.5f, 40f, 4, GET_HASH_KEY("ACTION"), 1))
				{
...
void func_85(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_121(iParam1))
		{
			func_122(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
