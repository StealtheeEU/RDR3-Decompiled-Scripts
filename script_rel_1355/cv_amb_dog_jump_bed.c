...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0.3015f, 0.0164f, 1.0827f, -76.75f, 1.9375f, 1.5675f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	switch (func_19(uParam0))
	{
		case 3:
			func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_ANIMAL_DOG_RESTING"), "WORLD_ANIMAL_DOG_RESTING", -1, 0);
