...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.531f, -0.618f, 0f, 0f, 0.9f, 0.9f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, -1.531f, -1.018f, 0f, -19.5f, 0.945f, 0.7625f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette01x", 0, 0, 1);
	if ((func_153(0) || func_153(1)) || func_153(2))
	{
		iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), -3.58517f, -0.34693f, -0.001983f, 0, 1, 0, 1);
		iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), -1.360719f, -1.095244f, -0.002578f, 0, 1, 0, 1);
	}
	else
	{
		iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), -3.58517f, -0.34693f, -0.001983f, "chair02x", 1, 0, 1);
		iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), -1.360719f, -1.095244f, -0.002578f, "p_chair02x^1", 1, 0, 1);
	}
	...
	func_156(uParam0, GET_HASH_KEY("COMP_SSNCNV13"), GET_HASH_KEY("PLAYER_SSNCNV13"));
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", iLocal_16, 0);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", iLocal_16, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, iLocal_18, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_160(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_17, 0);
	func_158(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_17, 0, -1f, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_54 = func_162(uParam0, -2.825f, -2.7501f, 0f, 0f, 0f, 90.75f, 5.1925f, 9.9075f, 3f, "TRIGGER", GET_HASH_KEY("VOLBOX"));
	func_163(uParam0, 1);
	if (func_164())
	{
		func_165(uParam0);
...
int func_256()
{
	...
	if (func_333(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_257()
{
	...
	if (func_333(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_344(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_378(iParam1))
		{
			func_379(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_456(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_475(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_483(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_495(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_487(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_487(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_487(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_505(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_487(GET_HASH_KEY("CHARACTER"), func_509(), -1591664384, bParam0);
}
