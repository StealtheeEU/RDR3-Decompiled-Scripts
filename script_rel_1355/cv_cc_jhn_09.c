...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			func_150(uParam0, -25.83f, 9.2525f, 0.8f, 0.91f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
			vLocal_54 = { -164.36f, -18.27f, 95.31f };
			fLocal_57 = 97.254f;
			break;
		case 2:
			func_149(uParam0, 85, 0, 0, 0);
			func_150(uParam0, -2.4475f, 27.1875f, 0.8f, 18.72f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "Cigarette", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_SHOTGLASS01X"), 0f, 0f, 0f, "SHOTGLASS", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_SHOTGLASS01X"), 0f, 0f, 0f, "SHOTGLASS1", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	func_150(uParam0, 0.5029f, 1.1772f, 0.5011f, -22.51f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_150(uParam0, -2.9603f, -3.482f, 0.8f, 0.91f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), 0, -1, 0);
	func_156(uParam0, iLocal_16, vLocal_54, fLocal_57, 1, 0);
	func_157(uParam0, iLocal_16);
	func_158(uParam0, iLocal_16, 1);
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE_NERVOUS_STRESSED"), "WORLD_HUMAN_SMOKE_NERVOUS_STRESSED_MALE_B", -1, 1);
	func_159(uParam0, iLocal_14, 0.625f);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0);
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	func_160(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_452(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_469(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_477(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_489(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_481(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_481(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_481(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_499(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_481(GET_HASH_KEY("CHARACTER"), func_503(), -1591664384, bParam0);
}
