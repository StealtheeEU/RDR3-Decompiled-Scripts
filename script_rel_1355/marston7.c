...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_17 = GET_HASH_KEY("CS_ALBERTCAKEESQUIRE");
	iLocal_18 = GET_HASH_KEY("CS_MRDEVON");
	iLocal_19 = GET_HASH_KEY("CS_MRWAYNE");
	iLocal_20 = GET_HASH_KEY("A_M_M_BLWLABORER_01");
	iLocal_21 = GET_HASH_KEY("A_M_M_BLWLABORER_02");
	iLocal_22 = GET_HASH_KEY("CS_NILS");
	iLocal_23 = GET_HASH_KEY("G_M_M_UNIMOUNTAINMEN_01");
	iLocal_24 = GET_HASH_KEY("A_C_HORSE_MORGAN_FLAXENCHESTNUT");
	iLocal_25 = GET_HASH_KEY("P_PEN01X");
	iLocal_26 = GET_HASH_KEY("P_AMB_CLIPBOARD_01");
	iLocal_27 = GET_HASH_KEY("P_CS_BOOK03X");
	iLocal_28 = GET_HASH_KEY("P_CS_CATALOGUE01X");
	iLocal_29 = GET_HASH_KEY("P_CS_LETTER03X");
	iLocal_30 = GET_HASH_KEY("P_CIGARBOX01X");
	iLocal_31 = GET_HASH_KEY("P_AXE02X");
	iLocal_32 = GET_HASH_KEY("P_BENCHWORK01X");
	iLocal_33 = GET_HASH_KEY("P_CS_BUCKET01BX");
	iLocal_34 = GET_HASH_KEY("P_GRINDINGWHEEL01X");
	iLocal_35 = GET_HASH_KEY("P_HAMMER01X");
	iLocal_36 = GET_HASH_KEY("P_MALLET01X");
	iLocal_37 = GET_HASH_KEY("P_SAWHAND01X");
	iLocal_38 = GET_HASH_KEY("P_CRATE01X");
	iLocal_39 = GET_HASH_KEY("P_VEH_LUMBER03X");
	iLocal_40 = GET_HASH_KEY("P_VEH_LUMBER02X");
	iLocal_41 = GET_HASH_KEY("P_VEH_LUMBER01X");
	iLocal_42 = GET_HASH_KEY("P_LUMBER09_PIECE01X");
	iLocal_43 = GET_HASH_KEY("P_WOODPLANK03X");
	iLocal_44 = GET_HASH_KEY("P_VEH_WAGON04X_ROPEANCHOR01X");
	iLocal_45 = GET_HASH_KEY("P_VEH_WAGON04X_ROPELUMBER02X");
	iLocal_46 = GET_HASH_KEY("P_VEH_WAGON04X_ROPELUMBER01X");
	iLocal_47 = GET_HASH_KEY("W_SP_BOWARROW_ARROW");
	iLocal_48 = GET_HASH_KEY("WAGON02X");
	iLocal_49 = GET_HASH_KEY("WAGON02X");
	iLocal_50 = GET_HASH_KEY("P_TOOLBOX01X");
	iLocal_51 = GET_HASH_KEY("S_WAGONWRECKED01X");
	iLocal_52 = GET_HASH_KEY("P_CS_WAGON02XBROKEN");
	iLocal_53 = GET_HASH_KEY("P_WAGON01X");
	iLocal_54 = GET_HASH_KEY("PG_MISSION_MARSTON7_LUMBER03X_DONELOADING");
	iLocal_55 = GET_HASH_KEY("PG_MISSION_MARSTON7_LUMBER02X");
	iLocal_56 = GET_HASH_KEY("PG_MISSION_MARSTON7_LUMBER01X");
	...
	{
		func_1(&uLocal_1729, 1073741824 /* Float: 2f */);
...
void func_25(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_204(uParam1[iVar0 /*16*/], 1048576))
		{
			switch (iParam0)
			{
				case 0:
...
void func_37(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_204(uParam0[iVar0 /*16*/], 1048576) && (uParam0[iVar0 /*16*/])->f_9 == 9)
		{
			func_214(uParam0[iVar0 /*16*/]);
		}
		iVar0++;
	}
}
...
void func_56(var uParam0)
{
	...
	{
		if (func_241(&(uParam0->f_5423[iVar0 /*65*/])))
		{
...
void func_58(var uParam0, bool bParam1)
{
	...
	bVar3 = false;
	if (SCRIPTS::IS_THREAD_ACTIVE(iVar2, false) && func_249(iVar1) == iVar2)
	{
		bVar3 = true;
	}
	if (bVar3)
...
void func_68(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_204(uParam1[iVar0 /*16*/], 1048576) && (uParam1[iVar0 /*16*/])->f_9 == 9)
		{
			func_205(uParam1[iVar0 /*16*/], 1);
		}
		iVar0++;
...
void func_75(var uParam0)
{
	...
	func_270(iVar0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, 752097756);
}
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (bParam1 && func_181(iParam0) != 0)
				{
					if (iVar0 == 1)
					{
						...
						{
							STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1835011[func_259(iParam0) /*74*/].f_8), true);
						}
					}
					else if ((func_259(iParam0) != 95 && func_259(iParam0) != 82) && !func_288(Global_1347702[func_259(iParam0) /*49*/].f_12, 512))
					{
						STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1347702[func_259(iParam0) /*49*/].f_3), true);
					}
				}
			}
			else
	...
	if (!Global_1879534 && !Global_1879534.f_1)
	{
		switch (iVar0)
		{
			...
			case 8:
				...
				{
					func_301(14, 0, 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
				}
				Global_1899528.f_217 = 1;
				break;
			case 9:
	...
	if (bParam1)
	{
		...
		switch (iVar0)
		{
			...
			case 11:
				...
				break;
			case 8:
				if (func_260(func_259(iParam0)) && func_288(Global_1347702[func_259(iParam0) /*49*/].f_12, 4))
				{
					Global_1898438 = MISC::GET_GAME_TIMER();
				}
				else
	...
	if (bVar13)
	{
			...
			case 1:
				switch (func_259(iParam0))
				{
					...
					case 1:
						...
						break;
					case 4:
						func_305(GET_HASH_KEY("CONSUMABLE_HERB_SAGE"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("CONSUMABLE_HERB_GINSENG"), 4, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("CONSUMABLE_HERB_INDIAN_TOBACCO"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("CONSUMABLE_HERB_YARROW"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("PROVISION_GRITTY_FISH_MEAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("PROVISION_STRINGY_MEAT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("PROVISION_ANIMAL_FAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("PROVISION_BIRD_FEATHER_FLIGHT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("CONSUMABLE_COFFEE_GNDS_REG"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"));
						func_305(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_306(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"));
						func_305(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("KIT_CAMP"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(-1448210800 /* GXTEntry: "Crafting Tools" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_305(GET_HASH_KEY("CLOTHING_ITEM_PZ_LOADOUT_BANDOLIER_01"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307();
						func_308(GET_HASH_KEY("CLOTHING_SP_COAT_WINTER01_VARIATION_01"));
						func_309();
						func_310();
						break;
					case 5:
					...
					case 14:
						...
						break;
					case 2:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY(func_311(10, 0)));
						break;
					case 8:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, 621714131 /* GXTEntry: "Jamie Gillis" */);
						break;
					case 15:
						func_305(GET_HASH_KEY("DOCUMENT_MAP_LEGENDARY_ANIMALS"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					...
					case 18:
						...
						if (!func_314(Global_1347702[21 /*49*/].f_15, 1))
						{
					...
					case 26:
						...
						break;
					case 17:
						func_317(Global_35, GET_HASH_KEY("CLOTHING_ITEM_BADGE_PZERO_000"), 0, -358215195, 1, 1);
						if (func_318())
						{
							func_319(GET_HASH_KEY("WEAPON_REPEATER_EVANS"));
						}
						break;
					case 19:
						...
						break;
					case 33:
						if (!func_320(GET_HASH_KEY("TP_RMAY_LETTER_1"), -1))
						{
							iVar15 = func_272();
							func_321(&iVar15, 0, 0, 0, 2, 0, 0, 0);
							func_322(GET_HASH_KEY("TP_RMAY_LETTER_1"), iVar15, 0);
						}
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY("DISCOVERABLE_NAME_EVELYN_MILLER"));
						if (func_318())
						{
							func_319(GET_HASH_KEY("WEAPON_REVOLVER_LEMAT"));
						}
						break;
					case 34:
						if (func_318())
						{
							func_319(GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_GAMBLER"));
						}
						break;
					case 28:
					...
					case 43:
						...
						break;
					case 44:
						if (!func_314(Global_1347702[82 /*49*/].f_15, 1))
						{
						...
						if (!func_314(Global_1347702[83 /*49*/].f_15, 1))
						{
					...
					case 67:
						...
						if (!func_332(GET_HASH_KEY("TAXIDERMY_ORDER_05")))
						{
							if (func_332(GET_HASH_KEY("TAXIDERMY_ORDER_04")))
							{
								iVar16 = func_272();
								func_321(&iVar16, 0, 0, 6, 0, 0, 0, 0);
								func_322(GET_HASH_KEY("TP_TAXIDERMY_REWARD_04_ES"), iVar16, 1);
							}
						}
						if (func_333(4))
						{
							if (!func_334(GET_HASH_KEY("DOCUMENT_NOTE_RARE_FISH"), 1, 0))
							{
								iVar17 = func_272();
								func_321(&iVar17, 0, 0, 6, 0, 0, 0, 0);
								func_322(GET_HASH_KEY("TP_RF_INVITATION_01"), iVar17, 1);
							}
						}
					...
					case 76:
						...
						break;
					case 69:
						if (func_314(Global_1347702[9 /*49*/].f_15, 1))
						{
							func_335(-6000);
						}
						break;
			...
			case 8:
				switch (func_259(iParam0))
				{
					...
					case 67:
						...
						if (func_318())
						{
							func_319(GET_HASH_KEY("WEAPON_PISTOL_M1899"));
						}
						break;
					case 68:
					...
					case 147:
						...
						break;
					case 9:
						if (func_314(Global_1835011[69 /*74*/].f_1, 1))
						{
							func_344(0);
							func_335(40500);
						}
		...
		switch (iVar0)
		{
			case 1:
				...
				{
					case 4:
						func_347(iParam0, 1000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 61:
					case 62:
					case 63:
						func_347(iParam0, 300, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 25:
					...
					case 34:
						...
						if (!func_334(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0))
						{
							func_305(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						break;
					case 29:
					...
					case 57:
						...
						break;
					case 76:
						func_347(iParam0, 2042100, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 72:
						if (func_348(iParam0) == 0)
						{
							func_347(iParam0, 20000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						else
						{
							func_347(iParam0, 15000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						break;
				}
				break;
			case 8:
				if (func_288(Global_1347702[func_259(iParam0) /*49*/].f_12, 536870912))
				{
					func_349(11, 1);
				}
				switch (func_259(iParam0))
				{
					case 109:
						func_347(iParam0, 1500, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 55:
						func_349(8, 1);
						break;
				...
				break;
			case 11:
				if (iParam0 == func_350(0, 10, 11, GET_HASH_KEY("CABR01")))
				{
					func_347(iParam0, func_348(iParam0), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_350(0, 7, 11, GET_HASH_KEY("CACR02")))
				{
					func_347(iParam0, func_351(9), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_350(0, 8, 11, GET_HASH_KEY("CACR03")))
				{
					func_347(iParam0, func_351(10), 1, 0.5f, 2, 0, 0, 1);
				}
				else if (iParam0 == func_350(0, 11, 11, GET_HASH_KEY("CACR01")))
				{
					func_347(iParam0, func_351(8), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_350(0, 12, 11, GET_HASH_KEY("CACR04")))
				{
			...
			if (bParam2)
			{
				switch (iVar0)
				{
					...
					case 2:
						...
						break;
					case 8:
						if (func_260(func_259(iParam0)) && func_288(Global_1347702[func_259(iParam0) /*49*/].f_12, 1))
						{
							iVar20 = 3;
						}
						else
...
void func_84(int iParam0, bool bParam1)
{
	...
	if (STATS::STATSTRACKER_IS_INITIALIZED(func_180(iParam0)))
	{
		...
		if (func_82(32768))
		{
			...
			if ((iVar1 == 1 || iVar1 == 8) || (iVar1 == 11 && iParam0 == func_350(0, 10, 11, GET_HASH_KEY("CABR01"))))
			{
				Global_1898438 = MISC::GET_GAME_TIMER();
				Global_1879514.f_1 = iParam0;
...
void func_100(var uParam0)
{
	...
	while (iVar0 < Global_43619)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_43619[iVar0 /*12*/]))
		{
			...
			func_366(&(uParam0->f_10792), Global_43619[iVar0 /*12*/], &(Global_43619[iVar0 /*12*/].f_1), 0);
		}
		iVar0++;
	}
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_43800))
...
void func_108(var uParam0, var uParam1)
{
	uParam0->f_607 = -1;
	func_370(uParam0);
	uParam0->f_634[0] = 56269;
	uParam0->f_634[1] = 56269;
	uParam0->f_637 = 0;
...
{
	return func_378(uParam0->f_1[func_132(iParam1) /*22*/].f_11, iParam2);
}
...
bool func_129()
{
	...
	if (!func_314(Global_1835011[1 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_314(Global_1835011[2 /*74*/].f_1, 1) && func_314(Global_1347702[120 /*49*/].f_15, 1)) && !func_314(Global_1835011[4 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_314(Global_1835011[37 /*74*/].f_1, 1) && !func_314(Global_1835011[39 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_314(Global_1835011[57 /*74*/].f_1, 1) && !func_314(Global_1835011[60 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_314(Global_1835011[26 /*74*/].f_1, 1) && !func_314(Global_1347702[67 /*49*/].f_15, 1))
	{
		return true;
	}
	if ((func_314(Global_1835011[62 /*74*/].f_1, 1) && func_314(Global_1835011[63 /*74*/].f_1, 1)) && !func_314(Global_1835011[64 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_314(Global_1835011[75 /*74*/].f_1, 1) && !func_314(Global_1347702[1 /*49*/].f_15, 1))
	{
		return true;
	}
	if (func_314(Global_1835011[76 /*74*/].f_1, 1) && !func_314(Global_1835011[77 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_314(Global_1835011[40 /*74*/].f_1, 1) && func_314(Global_1835011[41 /*74*/].f_1, 1)) && !func_314(Global_1835011[44 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_314(Global_1835011[62 /*74*/].f_1, 1) && func_314(Global_1835011[63 /*74*/].f_1, 1)) && !func_314(Global_1835011[64 /*74*/].f_1, 1))
	...
	if ((func_314(Global_1835011[65 /*74*/].f_1, 1) && func_314(Global_1835011[66 /*74*/].f_1, 1)) && !func_314(Global_1835011[67 /*74*/].f_1, 1))
	{
		return true;
	}
	return false;
...
int func_139(var uParam0)
{
	...
	func_401(uParam0, sLocal_59, 48, 2, -1);
	...
	func_403(uParam0, "script@story@mar7@ig@ig1_up_tree@ig1_up_tree", &(Local_1026[0 /*18*/].f_14), 48, 0, 0, 0, 1);
	func_403(uParam0, "script@story@mar7@ig@ig1_up_tree@ig1_up_tree", &(Local_1026[1 /*18*/].f_14), 48, 0, 0, 0, 1);
...
{
	func_405(&(uParam0->f_1[func_132(iParam1) /*22*/].f_11), iParam2);
}
...
void func_164()
{
	if (func_426(Global_35, 0))
	{
		...
		PED::SET_PED_CONFIG_FLAG(Global_35, 43, false);
		PED::SET_LOOTING_FLAG(Global_35, 2, true);
...
void func_166()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_230))
	{
		POPULATION::_0x74C2B3DC0B294102(iLocal_230);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_223))
	{
...
bool func_184(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_259(Global_1898164.f_1[0 /*5*/]);
		if (func_260(iVar0) && func_288(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
int func_186(int iParam0)
{
	...
	switch (func_182(iParam0))
	{
		...
		case 8:
			...
			if (func_288(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
...
int func_188()
{
	if (!func_314(Global_1835011[4 /*74*/].f_1, 1))
	{
		return 0;
	}
	else if (!func_314(Global_1347702[66 /*49*/].f_15, 1))
	{
		return 1;
	}
	else if (!func_314(Global_1347702[67 /*49*/].f_15, 1))
	{
		return 2;
	}
	else if (!func_314(Global_1835011[38 /*74*/].f_1, 1))
	{
		return 3;
	}
	else if (!func_314(Global_1347702[68 /*49*/].f_15, 1))
	{
		return 4;
	}
	else if (!func_314(Global_1835011[59 /*74*/].f_1, 1))
	{
		return 5;
	}
	else if (!func_314(Global_1835011[67 /*74*/].f_1, 1))
	{
		return 7;
	}
	else
...
int func_203(int iParam0, int iParam1)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_466(iParam0, &(Global_40.f_11206[iParam0 /*26*/][iVar0 /*5*/]));
		}
		iVar0++;
	}
	return 1;
...
int func_208(var uParam0)
{
	...
	return (func_470() - BUILTIN::ROUND((uParam0->f_1 * 1000f)));
}
...
bool func_221()
{
	return func_479(SCRIPTS::GET_ID_OF_THIS_THREAD());
}
...
bool func_233(int iParam0, int iParam1)
{
	...
	{
		return func_483(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	func_490(iParam1);
	func_491(iParam1, 0);
	func_492(iParam1, 0, bParam4, bParam5, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	if (bParam5)
	{
	}
}
...
void func_262(int iParam0, bool bParam1)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(iVar0, func_505(iParam0)))
	{
		UILOG::_UILOG_REMOVE_ENTRY(iVar0, func_505(iParam0));
	}
	if (bParam1)
	{
		if (iVar0 == 1)
		{
			if (UILOG::_UILOG_IS_ENTRY_REGISTERED(2, func_505(iParam0)))
			{
				UILOG::_UILOG_REMOVE_ENTRY(2, func_505(iParam0));
			}
		}
	}
	func_506(iParam0, 4);
...
void func_264(int iParam0, bool bParam1)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(func_504(iParam0), func_505(iParam0)))
	{
		return;
	}
	if (bParam1)
	{
		UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_504(iParam0), func_505(iParam0), 2, "");
		func_507(iParam0, 16);
	}
	else
	{
		...
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_504(iParam0), func_505(iParam0), 1, "");
		}
		else
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_504(iParam0), func_505(iParam0), 0, "");
		}
		func_506(iParam0, 16);
	}
}
...
void func_282(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_522(iParam0, bParam3, BUILTIN::ROUND((fVar0 * fParam2)), BUILTIN::ROUND((fVar1 * fParam2)), BUILTIN::ROUND((fVar2 * fParam2)), BUILTIN::ROUND((fVar3 * fParam2)), bParam4, 1);
}
...
void func_286()
{
	...
	if (func_525(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1))
	{
		func_526(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1, 0);
	}
}
...
void func_287(int iParam0)
{
	...
	func_528(iParam0, (func_527(iParam0) + BUILTIN::SHIFT_LEFT(1, 16)));
}
...
void func_290(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		case 67:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_ABIGAIL2X1_1"), iParam1);
			break;
		case 18:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_4"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_1"), iParam1);
			break;
		case 20:
			func_530(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_2"), iParam1);
			break;
		case 2:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_4"), iParam1);
			break;
		case 23:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_3"), iParam1);
			func_531(1);
			break;
		case 16:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_2_TXT"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_3_TXT"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_4"), iParam1);
			break;
		case 59:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_2"), iParam1);
			if (func_532(146))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_TREASURE2_JN"), iParam1);
			}
			func_531(1);
			break;
		case 76:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_FINALE2_1"), iParam1);
			if (func_533() == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9A"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_10B"), iParam1);
			}
			break;
		case 44:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4B"), iParam1);
			break;
		case 46:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_4"), iParam1);
			break;
		case 17:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_3"), iParam1);
			break;
		case 19:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_GT_GRAYS_2"), iParam1);
			break;
		case 21:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_2"), iParam1);
			func_531(0);
			break;
		case 15:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1B"), iParam1);
			break;
		case 33:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_4"), iParam1);
			break;
		case 34:
			func_530(GET_HASH_KEY("JOURNAL_GT_INDUSTRY_3"), iParam1);
			break;
		case 64:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_LARAMIE1_1"), iParam1);
			break;
		case 60:
			func_530(GET_HASH_KEY("JOURNAL_CHAP8_PRONGHORN"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_MARSTON1_2"), iParam1);
			break;
		case 73:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON6_1"), iParam1);
			break;
		case 74:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON7_1"), iParam1);
			if (func_533() == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_4A"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_5B"), iParam1);
			}
			break;
		case 8:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_3"), iParam1);
			break;
		case 36:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2"), iParam1);
			if (Global_1357515 == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2B"), iParam1);
			}
			break;
		case 27:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_4"), iParam1);
			break;
		case 28:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_4"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_GT_MOB_2"), iParam1);
			break;
		case 29:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_GT_MOB_3"), iParam1);
			break;
		case 31:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_4"), iParam1);
			break;
		case 4:
			func_530(GET_HASH_KEY("JOURNAL_CHAP2_HORSESHOE"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_5"), iParam1);
			func_531(0);
			break;
		case 6:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2"), iParam1);
			if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_A"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_B"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_C"), iParam1);
			}
			break;
		case 25:
			func_530(GET_HASH_KEY("JOURNAL_GT_MUDTOWN_3B"), iParam1);
			break;
		case 24:
			if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_5000"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_7500"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_10000"), iParam1);
			}
			break;
		case 48:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2A"), iParam1);
			}
			if (func_534(51))
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2B"), iParam1);
			}
			break;
		case 49:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_1"), iParam1);
			if (Global_1357515 == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2B"), iParam1);
			}
			else if (Global_1357515 == 2)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2C"), iParam1);
			}
			break;
		case 58:
			func_530(GET_HASH_KEY("JOURNAL_GT_NATIVE_3"), iParam1);
			break;
		case 50:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON1_1"), iParam1);
			break;
		case 52:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2B"), iParam1);
			if (bParam2 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A2"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3B"), iParam1);
			}
			break;
		case 32:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_ODRISCOLL4_1"), iParam1);
			break;
		case 47:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MARY4_1"), iParam1);
			break;
		case 69:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE2_1"), iParam1);
			if (func_314(Global_1347702[9 /*49*/].f_15, 1))
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_2B"), iParam1);
			}
			break;
		case 70:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE3"), iParam1);
			if (func_533() == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_7A"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8B"), iParam1);
			}
			break;
		case 71:
			if (func_533() == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8A"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9B"), iParam1);
			}
			break;
		case 37:
			func_530(GET_HASH_KEY("JOURNAL_GT_SAINT_DENIS_1"), iParam1);
			break;
		case 9:
			if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1B"), iParam1);
			}
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_2"), iParam1);
			break;
		case 13:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_3"), iParam1);
			break;
		case 53:
			func_530(GET_HASH_KEY("JOURNAL_GT_CORNWALL_1"), iParam1);
			break;
		case 54:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY1_1"), iParam1);
			break;
		case 56:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_3"), iParam1);
			break;
		case 57:
			func_530(GET_HASH_KEY("JOURNAL_GT_TRAIN_ROBBERY_4"), iParam1);
			break;
		case 22:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_2"), iParam1);
			break;
		case 12:
			func_530(GET_HASH_KEY("JOURNAL_GT_UTOPIA_2"), iParam1);
			break;
		case 0:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_5"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_6"), iParam1);
			break;
		case 1:
			func_531(1);
			break;
		case 3:
			if (func_325())
			{
				...
				{
					func_530(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE"), iParam1);
				}
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE")))
			{
				func_530(GET_HASH_KEY("JOURNAL_GT_WINTER_4"), iParam1);
			}
			break;
		default:
			break;
...
void func_292(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	{
		case 0:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_4"), iParam1);
			break;
		case 1:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL2X2_1"), iParam1);
			break;
		case 2:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL3_1"), iParam1);
			break;
		case 9:
			func_530(GET_HASH_KEY("JOURNAL_CHAP9_BEECHERSHOPE"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_BEECHERS1X3_1"), iParam1);
			if (func_314(Global_1835011[69 /*74*/].f_1, 1))
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1A"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1B"), iParam1);
			}
			break;
		case 22:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_CALDERON1X1_1"), iParam1);
			break;
		case 26:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_JN"), iParam1);
			}
			break;
		case 29:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_2_AR"), iParam1);
			}
			else if (func_532(26))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B1"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B2"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_A"), iParam1);
			}
			break;
		case 32:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_AR"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_AR"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_AR"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_AR"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_AR"), iParam1);
				}
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2_JN"), iParam1);
				if (Global_1357515 == -1)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_JN"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_JN"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_JN"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_JN"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_JN"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_JN"), iParam1);
				}
			}
			break;
		case 35:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_JN"), iParam1);
			}
			break;
		case 36:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_JN"), iParam1);
			}
			break;
		case 37:
			func_530(GET_HASH_KEY("JOURNAL_GT_COACH_ROB_RSC"), iParam1);
			break;
		case 53:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT1_2_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN_B"), iParam1);
			}
			break;
		case 54:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_JN"), iParam1);
			}
			break;
		case 55:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1_AR"), iParam1);
			}
			else if (func_532(54))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1A_JN"), iParam1);
			}
			break;
		case 38:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CIG1_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_CIG1_1_JN"), iParam1);
			}
			break;
		case 39:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_DINO1_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_DINO1_1_JN"), iParam1);
			}
			break;
		case 40:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_DINO2_1_AR"), iParam1);
			}
			else if (func_532(39))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_DINO2_1_B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_DINO2_1_A_JN"), iParam1);
			}
			break;
		case 43:
			if (bParam3 == 1)
			{
				if (func_348(Global_1835011[33 /*74*/].f_1) == 1)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1B_AR_A"), iParam1);
				}
				else
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1A_AR_A"), iParam1);
				}
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1_JN"), iParam1);
			}
			break;
		case 45:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_AR_A"), iParam1);
			}
			else if (func_532(43))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_B"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_A"), iParam1);
			}
			break;
		case 41:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FISH1_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FISH1_1_JN"), iParam1);
			}
			break;
		case 42:
			if (func_532(41))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_B"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_A"), iParam1);
			}
			break;
		case 49:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_JN"), iParam1);
			}
			break;
		case 50:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_AR"), iParam1);
			}
			else if (func_532(49))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B2"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_A"), iParam1);
			}
			break;
		case 51:
			func_530(GET_HASH_KEY("JOURNAL_RC_TAX1_1_JN"), iParam1);
			break;
		case 58:
			if (func_314(Global_1347702[23 /*49*/].f_15, 1))
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1B"), iParam1);
			}
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_3"), iParam1);
			break;
		case 59:
			func_530(GET_HASH_KEY("JOURNAL_CHAP2_DOWNES1_1"), iParam1);
			break;
		case 62:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DOWNES2_1"), iParam1);
			break;
		case 63:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ODRISCOLL2_2B"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_GT_ODRISCOLL_2"), iParam1);
			break;
		case 65:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_3"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_4"), iParam1);
			break;
		case 66:
			func_530(GET_HASH_KEY("JOURNAL_CHAP3_CLEMENS"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_3"), iParam1);
			func_531(1);
			break;
		case 67:
			func_530(GET_HASH_KEY("JOURNAL_CHAP4_SHADYBELLE"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_2"), iParam1);
			break;
		case 68:
			func_530(GET_HASH_KEY("JOURNAL_CHAP6_BEAVERHOLLOW"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2B"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_3"), iParam1);
			func_531(0);
			break;
		case 70:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_EDITHDOWNE2_1"), iParam1);
			break;
		case 71:
			func_530(GET_HASH_KEY("JOURNAL_RC_MILLER1_JN"), iParam1);
			break;
		case 73:
			func_530(GET_HASH_KEY("JOURNAL_RC_MILLER3_JN"), iParam1);
			break;
		case 75:
			func_530(GET_HASH_KEY("JOURNAL_RC_MILLER4_JN"), iParam1);
			break;
		case 77:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA1_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA1_1_JN"), iParam1);
			}
			break;
		case 79:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA3_1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA3_2_AR"), iParam1);
			}
			else if (func_532(78))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA3_2_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA3_1_JN"), iParam1);
			}
			break;
		case 80:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA4_1_AR"), iParam1);
			}
			else if (func_532(79))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA4_2_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_FMA4_1_JN"), iParam1);
			}
			break;
		case 85:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_JN"), iParam1);
			}
			break;
		case 86:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_JN"), iParam1);
			}
			break;
		case 87:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_JN"), iParam1);
			}
			break;
		case 88:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_JN"), iParam1);
			}
			break;
		case 89:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK1_JN"), iParam1);
			}
			break;
		case 92:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK4_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK4B_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK4_A_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK4_A2_JN"), iParam1);
			}
			break;
		case 93:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK5_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_HKK5_JN"), iParam1);
			}
			break;
		case 94:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2A"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2B"), iParam1);
			}
			func_530(GET_HASH_KEY("JOURNAL_GT_HOME_ROB"), iParam1);
			break;
		case 99:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3X1_1"), iParam1);
			break;
		case 101:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON1_1_AR"), iParam1);
				if (Global_1357515 == -1)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_B"), iParam1);
				}
				else
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_A"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON1_1B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON1_1A_JN"), iParam1);
			}
			break;
		case 102:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON2_1_AR"), iParam1);
			}
			else if (func_532(101))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON2_1B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON2_1A_JN"), iParam1);
			}
			break;
		case 103:
			func_530(GET_HASH_KEY("JOURNAL_RC_MASON3_1_AR"), iParam1);
			break;
		case 104:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON4_1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON4_2_AR"), iParam1);
			}
			else if (func_532(103))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON4_1B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON4_1A_JN"), iParam1);
			}
			break;
		case 105:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON5_1_AR"), iParam1);
			}
			else if (func_532(104))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON5_1B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MASON5_1A_JN"), iParam1);
			}
			break;
		case 108:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MONROE_1"), iParam1);
			break;
		case 109:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR_B"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR1_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR1B_JN"), iParam1);
			}
			break;
		case 110:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR2_AR"), iParam1);
			}
			else if (func_532(109))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR2B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR2A_JN"), iParam1);
			}
			break;
		case 111:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 0)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_AR"), iParam1);
				}
				else
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_AR"), iParam1);
				}
			}
			else if (func_532(110))
			{
				if (Global_1357515 == 0)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3C_JN"), iParam1);
				}
				else
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_JN"), iParam1);
					func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_2_JN"), iParam1);
				}
			}
			else if (Global_1357515 == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_2_JN"), iParam1);
			}
			break;
		case 115:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_1"), iParam1);
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_2"), iParam1);
			break;
		case 143:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ODDF1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ODDF1_JN"), iParam1);
			}
			break;
		case 144:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ODDF2_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_ODDF2_JN"), iParam1);
			}
			break;
		case 117:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO1_2_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_JN"), iParam1);
			}
			break;
		case 118:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1_AR"), iParam1);
			}
			else if (func_532(117))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1A_JN"), iParam1);
			}
			break;
		case 119:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO3_1_AR"), iParam1);
			}
			else if (func_532(118))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2A_JN"), iParam1);
			}
			break;
		case 121:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW1_JN"), iParam1);
			}
			break;
		case 122:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW3_AR"), iParam1);
			}
			else if (func_532(121))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW3B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW3A_JN"), iParam1);
			}
			break;
		case 124:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW4_AR"), iParam1);
			}
			else if (func_532(122))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW4B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW4A_JN"), iParam1);
			}
			break;
		case 125:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW5_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_PW5B_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_PW5_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_PW5B_JN"), iParam1);
			}
			break;
		case 127:
			func_530(GET_HASH_KEY("JOURNAL_RC_RTL1_AR"), iParam1);
			break;
		case 129:
			func_530(GET_HASH_KEY("JOURNAL_RC_RTL3_AR"), iParam1);
			break;
		case 131:
			func_530(GET_HASH_KEY("JOURNAL_RC_RTL5_AR"), iParam1);
			break;
		case 133:
			func_530(GET_HASH_KEY("JOURNAL_RC_RTL7_AR"), iParam1);
			break;
		case 134:
			func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_SADIE1_1"), iParam1);
			break;
		case 135:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_KILLER4A_AR"), iParam1);
				}
				else
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_KILLER4B_AR"), iParam1);
				}
			}
			else if ((HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER1_AR")) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER2_AR"))) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER3_AR")))
			{
				if (Global_1357515 == -1)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_KILLER4A_JN"), iParam1);
				}
				else
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_KILLER4B_JN"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_KILLER4C_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_KILLER4D_JN"), iParam1);
			}
			break;
		case 136:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC1_JN"), iParam1);
			}
			break;
		case 137:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC2_AR"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC3A_AR"), iParam1);
			}
			else if (func_532(136))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC2B_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC3C_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC2A_JN"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_RC_SLVC3A_JN"), iParam1);
			}
			break;
		case 142:
			if (bParam2 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3A"), iParam1);
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3B"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3C"), iParam1);
			}
			break;
		case 146:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 1)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_530(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_AR"), iParam1);
				}
			}
			else if (Global_1357515 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_JN"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_JN"), iParam1);
			}
			break;
		case 147:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET1_AR"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET1_JN"), iParam1);
			}
			break;
		case 148:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET2_AR"), iParam1);
			}
			else if (func_532(147))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET2B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET2A_JN"), iParam1);
			}
			break;
		case 149:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET3_AR"), iParam1);
			}
			else if (func_532(148))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET3B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET3A_JN"), iParam1);
			}
			break;
		case 150:
			if (bParam3 == 1)
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET4_AR"), iParam1);
			}
			else if (func_532(149))
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET4B_JN"), iParam1);
			}
			else
			{
				func_530(GET_HASH_KEY("JOURNAL_RC_WARVET4A_JN"), iParam1);
			}
			break;
		default:
			break;
	...
	switch (iVar0)
	{
		case 1:
			...
			switch (iVar1)
			{
				...
				case 9:
					if (func_348(Global_1835011[9 /*74*/].f_1) == 0)
					{
		...
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == 176656832)
		{
			...
			if (func_538(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_539(&(Global_40.f_4283.f_6[iVar4 /*5*/]), 1, 0);
					}
					iVar4++;
				}
			}
...
bool func_305(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
		...
		if (func_554(iParam0))
		{
			...
			if (func_382() && func_562(4))
			{
				if (!Global_1914319.f_17376)
				{
					if (func_382() && (func_563(38) || func_559(38)))
					{
						func_567(38, COLLECTION::_0x13AAECDA43318BFE(-2076669067, iVar6), COLLECTION::_0xD52D20B0C76BB26D(-2076669067, iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
						func_567(38, MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_COLLECTABLE_CIGCARD"), iVar7, 12, 0, iVar6);
					}
				}
			}
		}
	}
	if (func_568(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_568(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_568(iParam0) == GET_HASH_KEY("AMMO") && func_581(iParam0))
		{
		...
		{
			func_95(func_585(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_95(func_586(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_569(iParam0, 589988438))
		{
			if (func_588())
			{
				func_589(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		else if (func_569(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_334(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_334(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_334(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_601(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_602(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_601(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_608(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_609(499813453, 0);
				func_610(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_608(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_609(499813453, 0);
				func_610(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_608(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_609(499813453, 0);
				func_610(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_608(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_609(666607663, 0);
				func_611(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_608(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_609(666607663, 0);
				func_611(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_608(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_609(666607663, 0);
				func_611(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_608(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_609(-220219788, 0);
				func_612(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_608(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_609(-220219788, 0);
				func_612(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_608(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_609(-220219788, 0);
				func_612(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_608(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_609(218622660, 0);
				func_613(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_608(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_609(218622660, 0);
				func_613(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_608(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_609(390004462, 0);
				func_614(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_608(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_609(390004462, 0);
				func_614(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_608(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_609(390004462, 0);
				func_614(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_608(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_609(6410548, 0);
				func_615(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_608(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_609(6410548, 0);
				func_615(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_608(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_609(6410548, 0);
				func_615(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_608(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_609(6410548, 0);
				func_615(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_617(242, func_616(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_617(240, func_616(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_617(241, func_616(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
				...
				{
					func_618(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_618(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_618(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_618(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_618(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_618(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
void func_308(int iParam0)
{
	...
	func_649(GET_HASH_KEY("MPC_SP_DEFAULT_INTER_OUTFIT_TYPES"));
	iVar1 = 0;
	while (iVar1 < 39)
	{
	...
	Global_1946804.f_1616.f_1[8 /*3*/] = { func_652(8, 0) };
	Global_1946804.f_1616.f_1[9 /*3*/] = { func_652(9, 0) };
	Global_1946804.f_1616.f_1[0 /*3*/] = { func_652(0, 0) };
	Global_1946804.f_1616.f_1[2 /*3*/] = { func_652(2, 0) };
	Global_1946804.f_1616.f_1[3 /*3*/] = { func_652(3, 0) };
	Global_1946804.f_1616.f_1[1 /*3*/] = { func_652(1, 0) };
	Global_1946804.f_1616.f_1[5 /*3*/] = { func_652(5, 0) };
	Global_1946804.f_1616.f_1[6 /*3*/] = { func_652(6, 0) };
	Global_1946804.f_1616.f_1[7 /*3*/] = { func_652(7, 0) };
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (bVar7)
		{
			...
			while (iVar8 < 39)
			{
				...
				{
					func_654(&(Global_1946804.f_1616.f_1[iVar8 /*3*/]), iVar8, iVar0);
				}
				else
				{
					iVar8++;
...
char* func_311(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_314(Global_1835011[59 /*74*/].f_1, 1) || func_314(Global_1347702[1 /*49*/].f_15, 1)) || func_178(Global_1347702[1 /*49*/].f_15))
			{
				return "COMP_RUFUS";
			}
			else if (func_525(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
void func_313(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_658(&(Global_1946804.f_1497.f_1[iVar0 /*3*/]), 2, 6);
	func_658(&(Global_1946804.f_1378.f_1[iVar0 /*3*/]), 2, 6);
	if (bParam1)
	{
	...
	if (func_20() == -1)
	{
		...
		while (iVar1 < 5)
		{
			func_658(&(Global_26796.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
	...
	else
	{
		...
		while (iVar1 < 5)
		{
			func_658(&(Global_36638.f_45.f_350.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
...
bool func_320(int iParam0, int iParam1)
{
	...
	return func_666(&(Global_40.f_9910[iParam1 /*6*/]), 4);
}
...
void func_322(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		func_677(&(Global_40.f_9910[iVar0 /*6*/]), 2);
	}
...
void func_335(int iParam0)
{
	...
	if (iParam0 < 0)
	{
		func_679(MISC::VAR_STRING(2, "MISSION_COMPLETE_BANK_FEED", MISC::ABSI(iParam0)), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
		Global_1879514.f_14 = 1;
		Global_1879514.f_15 = 0;
	}
	else
	{
		func_679(MISC::VAR_STRING(2, "MISSION_COMPLETE_LOAN_FEED", iParam0), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Negative", 0, 1);
...
void func_345(int iParam0)
{
	...
	{
		case 1:
			func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
			iVar0 = func_259(iParam0);
			func_95(func_94(GET_HASH_KEY("MISSIONS_PROGRESSED")), 1);
			switch (func_451(iVar0))
			{
				case 0:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP1")), 1);
					break;
				case 1:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP2")), 1);
					break;
				case 2:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP3")), 1);
					break;
				case 3:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP4")), 1);
					break;
				case 4:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP5")), 1);
					break;
				case 5:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP6")), 1);
					break;
				case 6:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP7")), 1);
					break;
				case 7:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP8")), 1);
					break;
				case 8:
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP9")), 1);
					break;
				default:
					iVar2 = 0;
					break;
			...
			if (iVar0 == 7)
			{
				func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
			}
			if (iVar2 && MISSIONDATA::MISSIONDATA_IS_REQUIRED_STORY_MISSION(MISC::GET_HASH_KEY(&(Global_1835011[iVar0 /*74*/].f_8))))
			{
				func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("REQUIRED_MISSIONS")), 1);
			}
			break;
		case 8:
			iVar1 = func_259(iParam0);
			...
			if (func_288(Global_1347702[iVar1 /*49*/].f_12, 4) || iVar1 == 59)
			{
				if (func_288(Global_1347702[iVar1 /*49*/].f_12, 1))
				{
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
				...
				{
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC")), 1);
				}
			}
			if (func_288(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
			...
			else if (func_288(Global_1347702[iVar1 /*49*/].f_12, 4))
			{
				if (func_288(Global_1347702[iVar1 /*49*/].f_12, 4194304))
				{
				}
				else if (!func_288(Global_1347702[iVar1 /*49*/].f_12, 512))
				{
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS")), 1);
				}
				else
				{
					func_95(func_586(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
...
void func_346()
{
	...
	if (iVar1 == 1)
	{
		func_686(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_SINGLE", 1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	else if (iVar1 > 1)
	{
		func_686(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_PLURAL", iVar1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	if (iVar3 > 0)
	{
		func_687(iVar3, 0, 0);
...
int func_351(int iParam0)
{
	...
	{
		case 0:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 1:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 2:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 2;
		case 4:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 5:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		...
		case 12:
			return 75000;
		case 8:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 9:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 10:
			return func_697(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
...
char[] func_352(int iParam0)
{
	...
	{
		case 1:
			cVar0 = Global_1835011[func_473(iParam0) /*74*/].f_8;
			break;
		case 8:
			cVar0 = Global_1347702[func_259(iParam0) /*49*/].f_3;
			break;
		case 11:
			if (iParam0 == func_350(0, 10, 11, GET_HASH_KEY("CABR01")))
			{
...
void func_353(char[4] cParam0)
{
	...
	if (!Global_1879514.f_11)
	{
		...
		if (MISSIONDATA::MISSIONDATA_GET_RATING(iVar1) != 5 && iVar0 == 5)
		{
			...
			else if (func_182(Global_1879514.f_1) == 8 && (func_288(Global_1347702[func_259(Global_1879514.f_1) /*49*/].f_12, 1) || func_288(Global_1347702[func_259(Global_1879514.f_1) /*49*/].f_12, 33554432)))
			{
				func_349(5, 1);
			}
		}
...
void func_361(struct<16> Param0, int iParam16)
{
	...
	{
		if (SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&(Param0.f_10))) > 0 || func_707(&(Param0.f_10)))
		{
			return;
		}
	}
...
void func_365(bool bParam0)
{
	...
	func_363(&(Global_1347343.f_11), 1073741824 /* Float: 2f */);
	if (bParam0)
	{
...
{
	func_730(uParam0, 0, 1, 104078, 104097, 104234, 104351, 104549, "MAR7_INT", 514, -1);
	func_730(uParam0, 1, 2, 104700, 104793, 104871, 104965, 105394, "", 512, -1);
	func_730(uParam0, 2, 3, 105464, 105542, 105802, 105962, 106221, "MAR7_MCS1", 2, -1);
	func_730(uParam0, 3, 4, 106280, 106454, 107159, 107483, 107822, "MAR7_MCS2", 66, -1);
	func_730(uParam0, 4, 5, 107971, 108121, 108409, 108567, 108851, "MAR7_MCS3", 66, -1);
	func_730(uParam0, 5, 6, 108885, 109134, 109232, 109392, 109851, "", 66, -1);
	func_730(uParam0, 6, 7, 109917, 110071, 110236, 110524, 110624, "", 64, -1);
	func_730(uParam0, 7, 8, 110706, 110823, 111124, 111275, 112059, "", 576, -1);
	func_730(uParam0, 8, 25, 112110, 112202, 112235, 112358, 112617, "", 512, -1);
	func_730(uParam0, 25, 26, 112655, 112725, 112890, 112925, 112962, "MAR7_EXT", 66, -1);
}
...
void func_403(var uParam0, char[4] cParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, bool bParam7)
{
	...
	uParam0->f_1126[iVar0 /*67*/].f_1 = *iParam2;
	...
	if (!bParam7)
	{
		func_818(&(uParam0->f_1126[iVar0 /*67*/].f_2), 4);
	}
}
...
void func_407(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_821(uParam0[iVar0 /*3*/]))
		{
			if (func_815((uParam0[iVar0 /*3*/])->f_2, iParam12))
			{
				func_822(uParam0[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam1)
	{
		if (func_823(uParam1[iVar0 /*5*/]))
		{
			if (func_815((uParam1[iVar0 /*5*/])->f_4, iParam12))
			{
				func_824(uParam1[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_825(uParam2[iVar0 /*3*/]))
		{
			if (func_815((uParam2[iVar0 /*3*/])->f_2, iParam12))
			{
				func_826(uParam2[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_827(uParam3[iVar0 /*3*/]))
		{
			if (func_815((uParam3[iVar0 /*3*/])->f_2, iParam12))
			{
				func_828(uParam3[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_830(uParam5[iVar0 /*67*/]))
		{
			if (func_815((uParam5[iVar0 /*67*/])->f_3, iParam12))
			{
				func_831(uParam5[iVar0 /*67*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_830(uParam5[iVar0 /*67*/]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_832(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/])))
				{
					if (func_815((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/].f_2, iParam12))
					{
						func_833(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/]), (uParam5[iVar0 /*67*/])->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_834(uParam6[iVar0 /*4*/]))
		{
			if (func_815((uParam6[iVar0 /*4*/])->f_3, iParam12))
			{
				func_835(uParam6[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_836(uParam7[iVar0 /*5*/]))
		{
			if (func_815((uParam7[iVar0 /*5*/])->f_4, iParam12))
			{
				func_837(uParam7[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_838(uParam8[iVar0 /*3*/]))
		{
			if (func_815((uParam8[iVar0 /*3*/])->f_2, iParam12))
			{
				func_839(uParam8[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_840(uParam9[iVar0 /*3*/]))
		{
			if (func_815((uParam9[iVar0 /*3*/])->f_2, iParam12))
			{
				func_841(uParam9[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_842(uParam10[iVar0 /*4*/]))
		{
			if (func_815((uParam10[iVar0 /*4*/])->f_3, iParam12))
			{
				func_843(uParam10[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_844(uParam11[iVar0 /*3*/]))
		{
			if (func_815((uParam11[iVar0 /*3*/])->f_2, iParam12))
			{
				func_845(uParam11[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
...
bool func_414(var uParam0, int iParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_830(uParam0[iVar0 /*67*/]))
		{
			if (func_815((uParam0[iVar0 /*67*/])->f_3, iParam1))
			{
				if ((uParam0[iVar0 /*67*/])->f_65 > 0f || func_852((uParam0[iVar0 /*67*/])->f_2, 4))
				{
					if (!func_853(uParam0[iVar0 /*67*/]))
					{
						iVar1 = 0;
					}
				}
...
bool func_425(var uParam0)
{
	...
	switch (iVar2)
	{
		case 0:
			...
			{
				if (func_897(uParam0, func_33(uParam0)) != -1 && PED::_0x62DE46F061CAA468() < func_897(uParam0, func_33(uParam0)))
				{
					PED::_0xF008E0BA1FE1D644((func_897(uParam0, func_33(uParam0)) - PED::_0x62DE46F061CAA468()));
				}
		...
		case 5:
			...
			else
			{
				...
				if ((func_917(PLAYER::GET_PLAYER_INDEX(), 0, 0, 1) && !func_120(uParam0, 8192)) && !func_121(uParam0, func_33(uParam0), 8))
				{
					func_47(1, 0);
...
void func_430()
{
	if (TXD::DOES_STREAMED_TEXTURE_DICT_EXIST(sLocal_83))
	{
...
void func_437()
{
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_221))
	{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_222))
	{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_220))
	{
		PATHFIND::_0xD17672447692478E(iLocal_220, 0);
		VOLUME::_DELETE_VOLUME(iLocal_220);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_218))
	{
...
void func_442(bool bParam0)
{
	...
	{
		if (bParam0 || func_426(Local_1026[iVar0 /*18*/], 0))
		{
			Local_1026[iVar0 /*18*/].f_16 = 0;
			func_927(&(Local_1026[iVar0 /*18*/].f_2));
			func_440(&(Local_1026[iVar0 /*18*/].f_4));
			func_439(&(Local_1026[iVar0 /*18*/]));
		}
		iVar0++;
	}
}
...
void func_445(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	func_933();
	func_934();
	func_935((BUILTIN::TO_FLOAT(200) / 3f));
	if (iParam0 != 8)
	{
		...
		func_281(BUILTIN::TO_FLOAT(iVar0), 1, 0);
	}
	else
	{
		func_281((BUILTIN::TO_FLOAT(200) / 3f), 1, 0);
	}
}
...
void func_476(int iParam0, bool bParam1)
{
	...
	if (func_82(32768))
	{
		Global_2621440[iParam0 /*12066*/].f_9.f_14 = func_272();
	}
}
...
void func_477(int iParam0, vector3 vParam1, var uParam4)
{
	...
	Global_2621440[iParam0 /*12066*/].f_9.f_15 = func_359(vParam1, 1);
}
...
void func_488(var uParam0, int iParam1)
{
	...
	if (ENTITY::IS_ENTITY_AN_OBJECT(iParam1) && func_958(uParam0, ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(iParam1)))
	{
...
void func_491(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_961(&(Global_1360165[iParam0 /*1157*/].f_12), 1))
		{
...
void func_492(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_426(Global_1360165[iParam0 /*1157*/], 0);
	...
	if (bParam3)
	{
		...
		func_967(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
	...
	else
	{
		...
		{
			func_524(&(Global_1360165[iParam0 /*1157*/].f_130));
		}
		if (bParam9)
		{
...
void func_502(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()) && bVar3)
		{
			if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_27))
			{
				...
				func_978(&(Global_1900383[iParam0 /*45*/].f_27));
			}
		}
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		...
		Global_1900383[iParam0 /*45*/].f_25 = 0;
		func_980(&(Global_1900383[iParam0 /*45*/].f_26), bVar6);
	}
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_984(Global_1900383[iParam0 /*45*/].f_26);
		func_985(Global_1900383[iParam0 /*45*/].f_26);
...
void func_510(int iParam0, char* sParam1, int iParam2)
{
	...
	func_679(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_511(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_679(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_679(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_526(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 60)
	{
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == iParam0)
		{
			func_539(&(Global_40.f_4283.f_6[iVar0 /*5*/]), bParam1, bParam2);
			return 1;
		}
		iVar0++;
	}
...
int func_533()
{
	...
	iVar0 = func_995(Global_1347702[9 /*49*/].f_15);
	iVar1 = func_995(Global_1835011[69 /*74*/].f_1);
...
bool func_534(int iParam0)
{
	...
	return func_314(Global_1835011[iParam0 /*74*/].f_1, 1);
}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_679(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_679(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_679(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_679(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_559(int iParam0)
{
	...
	return func_314(Global_1347702[iParam0 /*49*/].f_15, 1);
}
...
void func_567(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1033(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1033(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_686(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, func_1034(func_561(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1033(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
bool func_580(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_1018(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_1005())
				{
					return false;
				}
				...
				{
					func_578(iVar0, WEAPON::GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
bool func_582(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_334(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
	...
	if (iVar2 == (iVar3 + iVar0))
	{
		if (func_20() == -1)
		{
			if (func_314(Global_1835011[14 /*74*/].f_1, 1))
			{
				func_312(416, 0);
			}
		}
...
void func_583(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_325()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
		if (func_1051(Global_35, iParam0, &uVar0))
		{
			func_601(PLAYER::PLAYER_PED_ID(), iParam0, 0, -358215195, 1, 1, 1, 0, 1, 1);
		}
	}
	switch (iParam0)
	{
...
bool func_588()
{
	if (((((func_1058(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_1058(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_1058(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_1058(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_1058(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_1058(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_590(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_567(51, 0, 0, 0, 0, -1, 0);
			func_1059(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_567(51, 0, 0, 0, 0, -1, 0);
			func_1059(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_565(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_1063(1), 0, -1, 0);
			func_1064(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_565(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_1063(2), 0, -1, 0);
			func_1064(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_565(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_1063(4), 0, -1, 0);
			func_1064(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_565(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_1063(8), 0, -1, 0);
			func_1064(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_565(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_1063(16), 0, -1, 0);
			func_1064(16);
			break;
	}
}
...
void func_593(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_312(437, 0);
			func_312(440, 0);
			func_1067(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_567(51, 0, 0, sVar0, func_1025(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_1059(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_1067(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_567(51, 0, 0, sVar0, func_1025(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_1059(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_1067(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_567(51, 0, 0, sVar0, func_1025(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_1059(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_1067(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_567(51, 0, 0, sVar0, func_1025(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_1059(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_312(438, 0);
			func_1067(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_565(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_567(51, 0, 0, sVar0, func_1025(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_1059(32768);
			break;
		default:
			func_312(439, 0);
...
void func_595(int iParam0, int iParam1)
{
	...
	if (func_20() == -1)
	{
		...
		{
			func_1069(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_1070() == 0)
			{
				func_354(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_565(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_1069(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_1070() == 1)
			{
				func_354(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_1072(iParam0) < func_1073(iParam0))
					{
						func_565(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_1069(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_1070() == 2)
			{
				func_354(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_1074(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_1075(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_1023(48);
					}
					if (func_1072(iParam0) < func_1073(iParam0))
					{
						func_565(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_1069(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_1070() == 3)
			{
				func_354(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_1072(iParam0) < func_1073(iParam0))
					{
						func_565(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_1069(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_1070() == 4)
			{
				func_354(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_1072(iParam0) < func_1073(iParam0))
					{
						func_565(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_598(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_20() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_589(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_589(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_589(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_589(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_589(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_589(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_589(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_589(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_589(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_589(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_589(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_589(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_589(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_1079())
			{
				func_589(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_589(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_589(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_589(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_589(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_589(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_589(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_589(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_589(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_589(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_589(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_589(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_589(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_589(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_599(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_354(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_1080(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_1081(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_1082(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
int func_601(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946804.f_57[func_648(iParam3, 1) /*11*/])
			{
				func_659(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_1086(32768) && iParam1 != Global_1946804.f_57[func_648(iParam3, 1) /*11*/])
			{
				func_1087();
...
bool func_602(int iParam0, bool bParam1)
{
	...
	bVar17 = false;
	*iParam0 = 0;
	iVar18 = func_1049(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 2, 1, 0);
	iVar19 = func_1049(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 3, 1, 0);
...
void func_609(int iParam0, bool bParam1)
{
	...
	func_1033(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_620()
{
	...
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, func_1021());
	return func_1022(COLLECTION::_0x126CBEBBA46693CF(iVar0, -2076669067, 0));
}
