...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, -0.0328f, 1.2303f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_156(uParam0, GET_HASH_KEY("S_INV_GINSENG01X"), 0f, 0f, 0f, "s_inv_ginseng01x", 0, 1, 1);
	iLocal_15 = func_157(uParam0, "script@vignette@itm@hosea_1@action", 0, 0, 0, 1);
	func_158(uParam0, "chsi1au");
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE"), "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", -1, 0);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE"), "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_90(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(func_196(uParam0, iLocal_15), "s_inv_ginseng01x", &Var1, false, 0, 2))
		{
...
bool func_97(var uParam0)
{
	...
	{
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), iLocal_30, "p_mortarPestle02x_PH_L_HAND", GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE"), "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", 1);
	}
	return true;
}
...
bool func_197(var uParam0)
{
	...
	{
		iLocal_28 = func_304("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
