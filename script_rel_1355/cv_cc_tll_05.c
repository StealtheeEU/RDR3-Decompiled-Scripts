...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.505f, 7.6925f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 8.1249f, 2.6499f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_TLLCNV5"), GET_HASH_KEY("PLAYER_TLLCNV5"));
	func_156(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_156(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 0, 50f, 1065353216 /* Float: 1f */, 1);
