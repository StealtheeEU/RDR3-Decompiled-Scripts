...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.0725f, 0.6225f, 1.1875f, -36f, 1.1f, 1.0875f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -0.485f, -1.1775f, 1.1875f, -36f, 1.1f, 1.0875f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 1.19f, -0.4525f, 1.1875f, -19.25f, 1.305f, 1.0875f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE0", 0, 0, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE1", 0, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE2", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), -1.2888f, 0.763619f, -0.00258636f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42062f, -0.462748f, 0.00315094f, 0, 1, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584697f, -1.37147f, -0.0016098f, 0, 1, 0, 1);
	...
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_155(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_DRINK_PUT_DOWN_TABLE"), "WORLD_HUMAN_DRINK_PUT_DOWN_TABLE_WHISKEY_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_243()
{
	...
	if (func_321(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_244()
{
	...
	if (func_321(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
