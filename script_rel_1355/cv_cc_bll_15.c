...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -12.86f, 5.75f, 0.93f, 0f, 0.8f, 0.8f, 1f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -1.03f, -1.85f, 0.93f, -30f, 1.5f, 1f, 1f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BLLCNV15"), GET_HASH_KEY("PLAYER_BLLCNV15"));
	func_156(uParam0, iLocal_16, -1, 0.6f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_CHAIR"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", -1, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), 0, -1, 0);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
