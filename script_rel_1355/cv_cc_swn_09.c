...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_19 = GET_HASH_KEY("W_MELEE_KNIFE02");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.36f, -0.02f, 0.5f, 0f, 1.4f, 1.4f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.2379f, -1.0318f, 0.5f, 0f, 1.4f, 1.4f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SWNCNV9"), GET_HASH_KEY("PLAYER_SWNCNV9"));
	func_156(uParam0, iLocal_16, -1, 0.92f);
	func_157(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_158(uParam0, iLocal_15, 2, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(GET_HASH_KEY("WEAPON_MELEE_KNIFE"), 1, uParam0->f_23, true, 1f);
...
void func_192(var uParam0, int iParam1, char* sParam2)
{
	int iVar0;
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		{
			func_289(iParam1, uParam0->f_1984[iVar0], sParam2);
		}
		iVar0++;
	}
}
...
int func_201(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_306("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_307(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_306("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_412(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
