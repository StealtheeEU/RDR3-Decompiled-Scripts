...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.0491f, -1.0785f, 0f, 0f, 3.5f, 3.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -6.4407f, 3.7614f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_152(uParam0, -1.4875f, -0.0252f, 1.15f, 38.56f, 1.6425f, 1.335f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 1);
...
bool func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_17))
	{
		...
		{
			func_200(uParam0, GET_HASH_KEY("COMP_DNHCNV4"), GET_HASH_KEY("PLAYER_DNHCNV4"));
