...
void func_8(var uParam0)
{
	...
	TASK::TASK_MOVE_IN_TRAFFIC_TO_DESTINATION(0, -228.4251f, 633.0844f, 112.218f, 1073741824 /* Float: 2f */, func_51(1.25f, 1.75f, 0.4f), 0, 0);
...
void func_55(var uParam0, var uParam1)
{
	...
	if (func_112(iVar0, GET_HASH_KEY("SCRIPT_TASK_FOLLOW_AND_CONVERSE_WITH_PED")))
	{
...
bool func_81(var uParam0)
{
	...
	func_166(uParam0, 3.6852f, -4.1639f, 0.9639f, 8.4934f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_166(uParam0, 3.99f, 18.41f, 1.3566f, 137.0659f, 12.96f, 14.92f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_167(uParam0, iLocal_92, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0);
	...
	iLocal_97 = 7;
	uParam0->f_106 += 4;
	iLocal_125 = GET_HASH_KEY("A_M_M_VALTOWNFOLK_01");
	iLocal_126 = GET_HASH_KEY("A_M_M_VALTOWNFOLK_01");
	iLocal_127 = GET_HASH_KEY("A_C_HORSE_MORGAN_FLAXENCHESTNUT");
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("A_M_M_VALTOWNFOLK_01"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("A_M_M_VALTOWNFOLK_01"), false);
	...
	func_171(uParam0, GET_HASH_KEY("COMP_HSHCNV14"), GET_HASH_KEY("PLAYER_HSHCNV14"));
	func_172(uParam0, iLocal_106, -1, 0.85f);
	func_173(uParam0, iLocal_93, 1, -1);
	func_174(uParam0, iLocal_92, 1);
	iLocal_107 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), -96.7767f, -15.1897f, 95.8847f, 0f, 0f, 0f, 3.5f, 3.5f, 2.5f);
...
bool func_95(var uParam0)
{
	...
	iLocal_124 = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), -104.84f, -11.56f, 94.51f, -106.129f, 0, 0, 0);
...
bool func_98(var uParam0)
{
	if (!bLocal_123)
	{
		...
		{
			TASK::TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_92), iLocal_124, 0, -1, true, false, 0, false, -1f, false);
			return true;
		}
...
bool func_102(var uParam0)
{
	...
	if (func_230(uParam0, iLocal_106, 0.95f) && !bLocal_121)
	{
		...
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_107))
		{
			func_10(iLocal_107);
		}
		bLocal_121 = true;
...
bool func_226()
{
	...
	func_355(&iVar0, &iVar1, &uVar2, &uVar3, GET_HASH_KEY("INPUT_SCRIPT_LEFT_AXIS_X"), GET_HASH_KEY("INPUT_SCRIPT_LEFT_AXIS_Y"), GET_HASH_KEY("INPUT_SCRIPT_RIGHT_AXIS_X"), GET_HASH_KEY("INPUT_SCRIPT_RIGHT_AXIS_Y"), 2);
	if (iVar0 != 0 || iVar1 != 0)
	{
		return true;
	}
...
int func_284()
{
	...
	if (func_377(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_285()
{
	...
	if (func_377(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_315(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_387(iParam1))
		{
			func_388(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_378(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
bool func_407(var uParam0, var uParam1)
{
	...
	if (!func_412(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_457("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_492(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_537(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_537(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_377(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_479(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_537(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_555(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_563(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_575(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_567(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_567(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_567(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_585(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
void func_571(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_588(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_567(GET_HASH_KEY("CHARACTER"), func_589(), -1591664384, bParam0);
}
...
bool func_581(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_585(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
