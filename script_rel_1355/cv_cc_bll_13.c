...
bool func_1(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		ENTITY::_UNPIN_MAP_ENTITY(uLocal_28[iVar0]);
		iVar0++;
	}
	return true;
}
...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.4266f, -0.9593f, 0.5026f, -22.5144f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -1.1439f, 0.6703f, 0.5028f, -125.6407f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, 0.5733f, 1.1645f, 0.4966f, 155.6634f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, 0, 1, 0, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), -1.28888f, 0.763515f, -0.000335693f, 0, 1, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	iLocal_23 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE^2", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE^1", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BLLCNV13"), GET_HASH_KEY("PLAYER_BLLCNV13"));
	func_156(uParam0, iLocal_18, -1, 0.97f);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_19, 0);
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_20, 0);
	func_157(uParam0, iLocal_17, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_21, 0);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_16, iLocal_23, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_161(uParam0, iLocal_17, 1, -1);
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), 1, 0, 0);
	return true;
}
...
bool func_75(var uParam0)
{
	...
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), false);
}
...
bool func_169(int iParam0)
{
	...
	switch (iLocal_14)
	{
		case 0:
			...
			iLocal_32[0] = GET_HASH_KEY("P_CHAIR_CRATE15X");
			iLocal_32[1] = GET_HASH_KEY("S_CRATESEAT03X");
			iLocal_32[2] = GET_HASH_KEY("P_CHAIR_BARREL04B");
			iVar0 = 0;
			while (iVar0 < 3)
			{
		...
		case 1:
			...
			while (iVar0 < 3)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_24[iVar0]))
				{
					...
					{
						uLocal_28[iVar0] = ENTITY::PIN_CLOSEST_MAP_ENTITY(iLocal_32[iVar0], vLocal_36[iVar0 /*3*/], 15);
					}
					else if (ENTITY::IS_MAP_ENTITY_PINNED(uLocal_28[iVar0]))
					{
...
int func_246()
{
	...
	if (func_322(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_247()
{
	...
	if (func_322(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_334(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_366(iParam1))
		{
			func_367(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_399(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_444(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_444(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_444(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_463(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_471(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_483(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_475(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_475(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_475(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_493(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_475(GET_HASH_KEY("CHARACTER"), func_497(), -1591664384, bParam0);
}
