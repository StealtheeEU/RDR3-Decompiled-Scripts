...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "BUCK1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "BUCK2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[6])
			{
				if (func_72(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_68(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
			{
				if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
				{
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], GET_HASH_KEY("ENDSINRUN")))
							{
								ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, uParam0->f_20[0 /*14*/]);
								PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], GET_HASH_KEY("MOTIONSTATE_RUN"), false, 0, false);
								PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
								PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 288, false);
								TASK::TASK_FLEE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_483, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
						...
						if (!uParam0->f_469[5])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], GET_HASH_KEY("ENDSINRUN")))
							{
								ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1, uParam0->f_20[1 /*14*/]);
								PED::FORCE_PED_MOTION_STATE(uParam0->f_20[1 /*14*/], GET_HASH_KEY("MOTIONSTATE_RUN"), false, 0, false);
								PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
								PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 288, false);
								TASK::TASK_FLEE_COORD(uParam0->f_20[1 /*14*/], uParam0->f_483, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
