		...
		case 10:
			...
			if (*uParam0 == 221420861)
			{
				...
				if (VOLUME::DOES_VOLUME_EXIST(iLocal_14) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14, true, 0))
				{
					...
					{
						MISC::SET_WEATHER_TYPE(GET_HASH_KEY("FOG"), false, true, true, 15f, false);
						fLocal_22 = 0.1f;
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_53(*uParam0))
			{
				uParam0->f_6.f_8 = func_113("DISCO_FOCUS", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_113("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_113("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_113("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
		}
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_125() == (5 - 1))
				{
					if (func_121())
					{
						func_124(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR"), 0);
						iVar0 = GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR");
					}
					else
					{
						func_124(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_JN"), 0);
...
bool func_64(var uParam0)
{
	if (*uParam0 == -1761578407 || *uParam0 == 404434344)
	{
		if (*uParam0 == 404434344)
		{
			...
			{
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_40.f_1[0], GET_HASH_KEY("REL_PLAYER_ALLY"));
			}
		}
		else if (uParam0->f_4 == 6)
		{
			uLocal_64 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(func_76(uParam0, 0), 1f, 1, -1, 0);
		}
	}
	else if (*uParam0 == 1464664327)
	{
	...
	{
		uLocal_64 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(func_76(uParam0, 0), 9f, 1, -1, 0);
	}
	else if (*uParam0 == -1614148516)
	{
	...
	if (*uParam0 == 404434344 && func_139())
	{
		...
		{
			if (!PED::IS_PED_READY_TO_RENDER(Local_40.f_1[0]))
			{
				return false;
			}
...
bool func_72(var uParam0)
{
	...
	switch (iLocal_65)
	{
		...
		case 2:
			...
			{
				iLocal_63 = func_113("GENERIC_USE", GET_HASH_KEY("INPUT_CONTEXT_X"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
				func_115(iLocal_63);
				func_178(3, 1);
			}
			break;
		...
		case 5:
			if (func_67(&uLocal_66) >= 1f)
			{
				if (!CAM::DOES_CAM_EXIST(iLocal_16[0]))
				{
					iLocal_16[0] = CAM::CREATE_CAMERA_WITH_PARAMS(GET_HASH_KEY("DEFAULT_SCRIPTED_CAMERA"), -2333.38f, 102.69f, 223.21f, -6.197f, -0.63f, 55.514f, 65f, false, 2);
					CAM::SET_CAM_FOV(iLocal_16[0], 37.84929f);
				}
				if (!CAM::DOES_CAM_EXIST(iLocal_16[1]))
				{
					iLocal_16[1] = CAM::CREATE_CAMERA_WITH_PARAMS(GET_HASH_KEY("DEFAULT_SCRIPTED_CAMERA"), -2334.52f, 104.21f, 223.47f, -7.584f, -0.74f, 59.195f, 65f, false, 2);
...
void func_74(int iParam0)
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_184(iParam0))
		{
			func_186(func_185(GET_HASH_KEY("DISCOVERABLE_FOUND")), 1);
		}
	}
}
		...
		case 2:
			...
			if (((!uParam0->f_4 == 7 && !uParam0->f_4 == 8) && !uParam0->f_4 == 9) && !uParam0->f_4 == 10)
			{
				if (func_188(Global_35, func_13(uParam0, uParam0->f_4), (func_187(uParam0, uParam0->f_4) + 55f), 1065353216 /* Float: 1f */))
				{
					...
					if (func_20(uParam0))
					{
						iLocal_63 = func_189("DISCO_PUSH", GET_HASH_KEY("INPUT_CONTEXT_Y"), func_13(uParam0, uParam0->f_4), 2f, 2, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					}
					func_178(4, 1);
				}
				else
...
bool func_81(var uParam0)
{
	...
	switch (iLocal_65)
	{
		...
		case 6:
			...
			if (PAD::IS_DISABLED_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_CONTEXT_Y")))
			{
...
void func_87(char* sParam0)
{
	...
	func_208(MISC::VAR_STRING(2, "DISCO_DREAM"), sParam0, GET_HASH_KEY("HUD_TOASTS"), GET_HASH_KEY("TOAST_DREAMCATCHER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, "COL_CTX_PLAYER_LOG"), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_97(var uParam0)
{
	...
	{
		GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&uLocal_64, 0);
	}
}
...
bool func_126()
{
	...
	if (!func_238(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
void func_135(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_186(func_185(GET_HASH_KEY("HONOR_POSITIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_186(func_185(GET_HASH_KEY("HONOR_NEGATIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_185(GET_HASH_KEY("HONOR_CURRENT")) };
...
void func_155(var uParam0)
{
	...
	{
		case 2000209669:
			uLocal_28.f_6[0] = GET_HASH_KEY("S_PICKUP_GOLDBAR01X");
			uLocal_28.f_6[1] = GET_HASH_KEY("S_PICKUP_GOLDBAR01X");
			uLocal_28.f_6[2] = GET_HASH_KEY("S_PICKUP_GOLDBAR01X");
			break;
		case -321841939:
			uLocal_28.f_6[0] = GET_HASH_KEY("P_DISDREAMCATCHERWIND01X");
			uLocal_28.f_6[1] = GET_HASH_KEY("P_DISDREAMCATCHERWIND02X");
			uLocal_28.f_6[2] = GET_HASH_KEY("P_DISDREAMCATCHERWIND03X");
			uLocal_28.f_6[3] = GET_HASH_KEY("P_DISDREAMCATCHERWIND04X");
			uLocal_28.f_6[4] = GET_HASH_KEY("P_DISDREAMCATCHERWIND05X");
			break;
		case 1347913620:
			uLocal_28.f_6[0] = GET_HASH_KEY("P_CS_RT_ENVELOPE01X");
			break;
		case -1308658310:
			uLocal_28.f_6[0] = GET_HASH_KEY("P_CS_DETONATOR01X");
			break;
		case -1614148516:
			uLocal_28.f_6[0] = GET_HASH_KEY("P_PHONOGRAPH01X");
			break;
		case -161804536:
			uLocal_28.f_6[0] = GET_HASH_KEY("P_HUMANSKULL02X");
			uLocal_28.f_6[1] = GET_HASH_KEY("S_COMBVIKINGANCIENT01X");
			break;
		case 404434344:
			if (uParam0->f_4 == 0)
			{
				if (func_138())
				{
					Local_40.f_12[0] = GET_HASH_KEY("A_C_EAGLE_01");
				}
				else if (func_139())
				{
					Local_40.f_12[0] = GET_HASH_KEY("A_C_COYOTE_01");
				}
			}
			break;
		default:
...
int func_173(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case 404434344:
			...
			{
				case 0:
					return GET_HASH_KEY("META_OUTFIT_ANIMAL_SPIRIT_COYOTE_A");
				default:
					break;
			}
			break;
...
{
	if (STATS::CHAL_IS_GOAL_ACTIVE(GET_HASH_KEY("SP_ACHIEVEMENTS"), GET_HASH_KEY("ACH_RESPECT")))
	{
			...
			if (func_308(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_296(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_242() <= -160;
...
int func_271(var uParam0)
{
	...
	{
		case 404434344:
			return GET_HASH_KEY("ACH_RESPECT_ARTHUR");
		case -1761578407:
			if (uParam0->f_4 == 0)
			{
				return GET_HASH_KEY("ACH_RESPECT_ARTHUR");
			...
			{
				return GET_HASH_KEY("ACH_RESPECT_JENNY");
			}
			else if (uParam0->f_4 == 2)
			{
				return GET_HASH_KEY("ACH_RESPECT_HORSEA");
			}
			else if (uParam0->f_4 == 3)
			{
				return GET_HASH_KEY("ACH_RESPECT_LENNY");
			}
			else if (uParam0->f_4 == 4)
			{
				return GET_HASH_KEY("ACH_RESPECT_SEAN");
			}
			else if (uParam0->f_4 == 5)
			{
				return GET_HASH_KEY("ACH_RESPECT_DAVEY");
			}
			else if (uParam0->f_4 == 6)
			{
				return GET_HASH_KEY("ACH_RESPECT_KIERAN");
			}
			else if (uParam0->f_4 == 7)
			{
				return GET_HASH_KEY("ACH_RESPECT_SUSAN");
			}
			else if (uParam0->f_4 == 8)
			{
				return GET_HASH_KEY("ACH_RESPECT_EAGLE_FLIES");
			}
			break;
		default:
			break;
...
void func_314(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_375(iParam1))
		{
			func_174(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
struct<6> func_339()
{
	...
	if (func_413(GET_HASH_KEY("SLOTID_HORSE_BEDROLL"), &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_413(GET_HASH_KEY("SLOTID_HORSE_BLANKET"), &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_413(GET_HASH_KEY("SLOTID_HORSE_HORN"), &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_413(GET_HASH_KEY("SLOTID_HORSE_SADDLEBAG"), &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_413(GET_HASH_KEY("SLOTID_HORSE_STIRRUP"), &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_413(GET_HASH_KEY("SLOTID_HORSE_SADDLE"), &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
int func_372(int iParam0, bool bParam1)
{
	...
	if (!func_430(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_371(iVar14);
...
bool func_411(int iParam0, var uParam1)
{
	...
	*uParam1 = func_467(Var0, GET_HASH_KEY("SLOTID_HORSE_MANE"), 0);
...
bool func_412(int iParam0, var uParam1)
{
	...
	*uParam1 = func_467(Var0, GET_HASH_KEY("SLOTID_HORSE_TAIL"), 0);
	if (!func_295(*uParam1, 0))
	{
		return false;
	}
...
bool func_436(int iParam0, int iParam1)
{
	...
	Var29 = { func_479(iParam1, Var0, GET_HASH_KEY("SLOTID_HORSE_MANE"), 0) };
...
bool func_437(int iParam0, int iParam1)
{
	...
	Var29 = { func_479(iParam1, Var0, GET_HASH_KEY("SLOTID_HORSE_TAIL"), 0) };
	return func_480(Var29, 1);
}
...
{
	return func_479(GET_HASH_KEY("CHARACTER"), func_503(), -1591664384, bParam0);
}
...
struct<4> func_479(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_240(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_485(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar33 = func_508(1168099063, &Var16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_488(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		...
		{
			if (func_509(iVar62, 1168099063, &Var28) && func_509(iVar62, 1168099063, &Var45))
			{
	...
	{
		iVar62 = func_508(1168099063, &Var28, 0);
		iVar62 = func_508(1168099063, &Var45, 0);
	}
	return iVar62;
}
...
void func_490(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_512(func_511(255), GET_HASH_KEY("COLOR_PURE_WHITE")));
	}
	else if (func_121())
	{
...
int func_504(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	{
		Var16 = { func_515(Param0, 1) };
		Var16.f_10 = iParam4;
		iVar0 = func_516(GET_HASH_KEY("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var45 = { func_517(Param0, 1) };
		Var45.f_10 = iParam4;
		iVar0 = func_518(GET_HASH_KEY("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_507(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_508(GET_HASH_KEY("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<17> func_507(var uParam0)
{
	struct<17> Var0;
...
struct<29> func_515(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> Var0;
	struct<29> Var29;
	...
	Var29.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_240(bParam4), &uParam0, &Var29, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_507(&Var29) };
...
struct<18> func_517(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> Var0;
	struct<15> Var18;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_240(bParam4), &uParam0, &Var18, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_507(&Var18) };
...
bool func_520(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_524(&(Global_1109400.f_4), iVar0, 5);
	}
	if (iParam1 == func_525())
	{
		return func_524(&(Global_1109400.f_4), iVar0, 5);
	...
	{
		return func_524(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
