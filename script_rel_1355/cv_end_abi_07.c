...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 3.25f, 6.55f, 1.1379f, 11.6f, 1.28f, 2.22f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, 1.22f, -0.5099f, 1.0675f, -167.4f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottlebeer01x", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), 0f, 0f, 0f, "p_chair02x^1", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), 0f, 0f, 0f, "p_chair02x", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BCABICNV7"), GET_HASH_KEY("PLAYER_BCABICNV7"));
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
