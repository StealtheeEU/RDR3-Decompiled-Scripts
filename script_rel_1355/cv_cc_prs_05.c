...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CS_RABBITHEADLESS"), 0f, 0f, 0f, "MEATBIT", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 4, GET_HASH_KEY("WORLD_HUMAN_BUTCHER_RABBIT"), "WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	uLocal_30 = STREAMING::_0xB223249B7798EEED(func_48(uParam0, iLocal_14), GET_HASH_KEY("WORLD_HUMAN_BUTCHER_RABBIT"), 262145, GET_HASH_KEY("WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP"));
	return true;
}
