...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 5.5054f, 2.453f, 0.9827f, 18.5f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 0.45f, 0.3f, 0.983f, 0f, 2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, GET_HASH_KEY("COMP_JAVCNV2"), GET_HASH_KEY("PLAYER_JAVCNV2"));
	return true;
}
