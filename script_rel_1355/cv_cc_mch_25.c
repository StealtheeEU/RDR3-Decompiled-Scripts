...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5643f, -1.2972f, 0.5073f, -19.8f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 0.5259f, 1.1492f, 0.5633f, -23.04f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.585f, -1.372f, -0.001f, 0, 1, 0, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0.636f, 1.325f, -0.004f, 0, 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCH", 0, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	...
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, GET_HASH_KEY("COMP_MCHCNV25"), GET_HASH_KEY("PLAYER_MCHCNV25"));
	return true;
}
