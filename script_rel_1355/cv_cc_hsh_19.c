...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.4325f, 2.2591f, 1.0716f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -0.0125f, -1.7999f, 1.072f, 0f, 2.755f, 1.8f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, -0.896063f, -1.52353f, 1.00637f, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_FILLETKNIFE01X"), 0f, 0f, 0f, "p_filletKnife01x", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_KNIFESHARPENER01X"), 0f, 0f, 0f, "p_knifesharpener01x", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_MATCHSTICK01X"), 0f, 0f, 0f, "p_matchstick01x", 0, 1, 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_HSHCNV19"), GET_HASH_KEY("PLAYER_HSHCNV19"));
	func_158(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1, 45f, 1065353216 /* Float: 1f */, 1);
	return true;
}
