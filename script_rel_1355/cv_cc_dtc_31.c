...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "Chair", 0, 0, 1);
	func_152(uParam0, 0.0501f, -2.8875f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STERNGUY_IDLES"), 0, -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(30f, 50f), 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	if (!func_108(&uLocal_26))
	{
		if (func_200(uParam0, iLocal_15) || func_201(uParam0, iLocal_14))
		{
			...
			PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_14), GET_HASH_KEY("MOTIONSTATE_WALK"), false, 0, false);
		}
	}
