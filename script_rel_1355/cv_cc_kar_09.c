...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -7.00118f, 1.43711f, 1.36878f, -22f, 1.1f, 1.1f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -1.707f, -0.7557f, 1f, 0f, 1.1f, 1.1f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 1.127f, -1.80836f, 0.57637f, -22f, 1.1f, 1.1f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	...
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), -1.86282f, -0.829392f, -0.0207748f, 0, 1, 0, 1);
	func_154(uParam0, GET_HASH_KEY("COMP_KARCNV9"), GET_HASH_KEY("PLAYER_KARCNV9"));
	func_155(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", -1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
