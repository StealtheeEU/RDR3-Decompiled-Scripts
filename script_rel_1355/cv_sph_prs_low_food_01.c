...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.7063f, 0.0071f, 0f, 1.5f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CRATE22X_SMALL"), 0f, 0f, 0f, "CRATE", iVar0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_PRSSPEECHLOWFOODCNV1"), GET_HASH_KEY("PLAYER_PRSSPEECHLOWFOODCNV1"));
