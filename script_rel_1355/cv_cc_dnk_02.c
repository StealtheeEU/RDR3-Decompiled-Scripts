...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0.5494f, -2.8561f, 0.6563f, -89.64f, 2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, -3.5423f, -1.2882f, 1.0731f, -85f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARTHIN01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, iLocal_17, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, GET_HASH_KEY("COMP_DNKCNV2"), GET_HASH_KEY("PLAYER_DNKCNV2"));
