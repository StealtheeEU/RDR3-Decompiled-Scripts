...
bool func_72(var uParam0)
{
	...
	func_154(uParam0, -0.105f, 1.0775f, 0.85f, -78.25f, 4.325f, 4.3875f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_154(uParam0, -4.5875f, 6.7625f, 0.85f, -65.75f, 1.5f, 1.5f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_155(uParam0, 1);
	func_156(uParam0, GET_HASH_KEY("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	...
	func_158(uParam0, iLocal_16, 3, GET_HASH_KEY("STAND"), 0, -1, 1);
	func_159(uParam0, iLocal_16, 2, GET_HASH_KEY("STAND"), 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 2f, 1065353216 /* Float: 1f */, 1);
	...
	func_162(uParam0, GET_HASH_KEY("COMP_KIECNV11"), GET_HASH_KEY("PLAYER_KIECNV11"));
...
bool func_93(var uParam0)
{
	...
	if (func_203(uParam0, iLocal_17))
	{
		...
		else if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iVar0) > 0.23f)
		{
			if (!bLocal_18)
			{
				iLocal_20 = func_205(uParam0, 1.075f, 1.014f, 0.6f, 0f, 2f, 2f, 2.5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_16), GET_HASH_KEY("STAND"), 45000, false, 0, 1f, false);
	}
	return true;
}
