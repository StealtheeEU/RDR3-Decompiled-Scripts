...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4f, 0f, 0f, -155f, 4f, 4f, 2.5f, GET_HASH_KEY("VOLCYLINDER"), -1, 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_SHEEPSHEERS01X"), 0f, 0f, 0f, "SHEERS", 0, 1, 1);
	iLocal_14 = func_153(uParam0, GET_HASH_KEY("A_C_SHEEP_01"), "SHEEP");
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BCUNCCNV1"), GET_HASH_KEY("PLAYER_BCUNCCNV1"));
...
bool func_93(var uParam0)
{
	...
	if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_1984[iLocal_18], "SHEEP"))
	{
		...
		TASK::TASK_START_SCENARIO_AT_POSITION(0, GET_HASH_KEY("WORLD_ANIMAL_SHEEP_EATING_GROUND"), -1608.52f, -1419.41f, 80.95f, 44.308f, 30000, true, false, 0, -1f, false);
...
bool func_95(var uParam0)
{
	...
	if (PED::IS_PED_USING_SCENARIO_HASH(func_8(uParam0, iLocal_14), GET_HASH_KEY("WORLD_ANIMAL_SHEEP_EATING_GROUND")) && TASK::IS_PED_ACTIVE_IN_SCENARIO(func_8(uParam0, iLocal_14), 0))
	{
