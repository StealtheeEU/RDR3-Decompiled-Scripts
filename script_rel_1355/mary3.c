...
void __EntryFunction__()
{
	...
	iLocal_22 = 6;
	iLocal_23 = 25;
	iLocal_473 = GET_HASH_KEY("CS_MARYLINTON");
	iLocal_474 = GET_HASH_KEY("MSP_MARY3_MALES_01");
	iLocal_475 = GET_HASH_KEY("CS_ASHTON");
	iLocal_476 = GET_HASH_KEY("A_M_M_BIVWORKER_01");
	iLocal_477 = GET_HASH_KEY("CS_MRLINTON");
	iLocal_478 = GET_HASH_KEY("A_M_M_NBXDOCKWORKERS_01");
	iLocal_479 = GET_HASH_KEY("S_M_M_GENCONDUCTOR_01");
	iLocal_480 = GET_HASH_KEY("A_C_HORSE_MORGAN_FLAXENCHESTNUT");
	iLocal_481 = GET_HASH_KEY("ROWBOATSWAMP");
	iLocal_489 = -1;
	iLocal_490 = -1;
	...
	{
		func_1(&uLocal_1402, 1073741824 /* Float: 2f */);
...
bool func_9(char[4] cParam0)
{
	...
	ENTITY::REMOVE_MODEL_HIDE(2627.006f, -1379.284f, 46.15857f, 5f, GET_HASH_KEY("P_BAT_LUMBER04X"), 0);
	func_168(GET_HASH_KEY("PROVISION_MARYS_BROOCH"), 1, 1, -142743235, 0);
	...
	func_171(&(Local_709[1 /*18*/].f_1));
	iVar0 = 0;
	while (iVar0 < 15)
	{
		func_172(&(Local_709[iVar0 /*18*/]));
		iVar0++;
	}
	func_172(&(Local_530[0 /*178*/]));
	func_172(&(iLocal_1204[0]));
	func_172(&(iLocal_1204[1]));
	iVar0 = 0;
	while (iVar0 < 6)
	{
		func_172(&(Local_980[iVar0 /*18*/]));
		iVar0++;
	}
	...
	if (func_10(iLocal_1320))
	{
		func_11(&iLocal_1320, 1, 1);
	}
	if (func_10(iLocal_1319))
	{
	...
	GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&uLocal_1381, 1);
	GRAPHICS::REMOVE_VEG_MODIFIER_SPHERE(&uLocal_1382, 1);
	PED::_0xDE7B2B4144906CDF(GET_HASH_KEY("INTIMIDATED_ON_KNEES"), Local_709[1 /*18*/]);
...
void func_13(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_186(iParam0) == 3 || (func_186(iParam0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_185(iParam0))))
	{
...
void func_25(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_209(uParam1[iVar0 /*16*/], 1048576))
		{
			switch (iParam0)
			{
				case 0:
...
void func_37(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_209(uParam0[iVar0 /*16*/], 1048576) && (uParam0[iVar0 /*16*/])->f_9 == 9)
		{
...
void func_68(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_209(uParam1[iVar0 /*16*/], 1048576) && (uParam1[iVar0 /*16*/])->f_9 == 9)
		{
			func_210(uParam1[iVar0 /*16*/], 1);
		}
		iVar0++;
	...
	if (bVar13)
	{
		...
		if (bParam1)
		{
			if (!func_186(iParam0) == 0)
			{
				...
				else if (STATS::STATSTRACKER_IS_INITIALIZED(func_185(iParam0)))
				{
					iVar19 = 0;
					if (bParam3)
					{
...
void func_84(int iParam0, bool bParam1)
{
	...
	if (STATS::STATSTRACKER_IS_INITIALIZED(func_185(iParam0)))
	{
		iVar0 = 0;
		if (bParam1)
		{
...
void func_108(var uParam0, var uParam1)
{
	uParam0->f_607 = -1;
	func_374(uParam0);
	uParam0->f_634[0] = 57785;
	uParam0->f_634[1] = 57785;
	uParam0->f_637 = 0;
...
void func_109(char[4] cParam0)
{
	...
	if (!func_378(65536))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_207(7)))
		{
			func_379(func_207(7), func_215(12, 0), 2, 1073741824 /* Float: 2f */);
			func_380(65536);
		}
	}
	iVar0 = 0;
	...
	{
		if (func_382(func_381(cParam0, GET_HASH_KEY("MSP_MARY3_MALES_01"), 0), 0))
		{
			iLocal_1204[iVar0] = func_381(cParam0, GET_HASH_KEY("MSP_MARY3_MALES_01"), 1);
		}
		iVar0++;
	}
	if (func_271(cParam0) == 0)
	{
		...
		if (func_33(cParam0) == 0)
		{
			if (!VOLUME::DOES_VOLUME_EXIST(iLocal_1223[0]))
			{
				iLocal_1223[0] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MARY3_VOL_INT_CLEAR_AREA");
				VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_1223[0], 2713.793f, -1242.869f, 53.02395f, 0f, 0f, 25.01506f, 19.03873f, 14.94918f, 12.5923f);
				VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_1223[0], 2674.628f, -1265.024f, 55.92817f, 0f, 0f, 25.01506f, 19.03873f, 14.94918f, 12.5923f);
				PATHFIND::SET_ROADS_IN_VOLUME(iLocal_1223[0], false, false, false);
				uLocal_1291 = func_383(iLocal_1223[0], 0, 0, 10208);
				func_384(iLocal_1223[0], 0, 0, 1, 1, 0);
				PATHFIND::_0x19C7567D2F2287D6(iLocal_1223[0], 7);
			}
			if (!VOLUME::DOES_VOLUME_EXIST(iLocal_1223[1]))
			{
				iLocal_1223[1] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MARY3_VOL_INT_CLEAR_VEHICLES");
				VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_1223[1], 2634.974f, -1280.685f, 53.00139f, 0f, 0f, 25.01507f, 66.12298f, 14.94918f, 12.5923f);
				VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_1223[1], 2702.059f, -1250.474f, 53.00139f, 0f, 0f, 25.01507f, 43.57701f, 14.94918f, 12.5923f);
...
{
	return func_386(cParam0->f_1[func_132(iParam1) /*22*/].f_11, iParam2);
}
...
{
	func_406(cParam0, iLocal_473, 67108863);
	func_406(cParam0, iLocal_476, 56);
	func_406(cParam0, iLocal_477, 31);
	func_406(cParam0, iLocal_478, 31);
	func_406(cParam0, iLocal_474, 67108863);
	func_406(cParam0, iLocal_475, 62);
	func_406(cParam0, iLocal_480, 24);
	func_406(cParam0, GET_HASH_KEY("COACH2"), 62);
	func_406(cParam0, GET_HASH_KEY("TROLLEY01X"), 524384);
	func_406(cParam0, iLocal_481, 24);
	func_406(cParam0, GET_HASH_KEY("P_BROOM04X"), 3);
	func_406(cParam0, GET_HASH_KEY("P_BROOM02X"), 3);
	func_406(cParam0, iLocal_479, 524384);
	...
	func_408(cParam0, sLocal_527, 32);
	func_410(cParam0, "script@story@mry3@leadin@mcs1@leadin_p1", &(Local_38[4 /*31*/]), 1, 0, func_409(19), 0, 1);
	func_410(cParam0, "script@story@mry3@leadin@mcs1@leadin_p2", &(Local_38[5 /*31*/]), 1, 2, func_409(20), 0, 1);
	func_410(cParam0, "script@story@mry3@leadout@mcs1@mary_lets_follow", &(Local_38[6 /*31*/]), 2, 0, func_409(22), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig1_beckon@ig_1_beckon", &(Local_38[1 /*31*/]), 2, 0, func_409(4), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig2_bump@ig2_bump", &(Local_38[3 /*31*/]), 2, 0, func_409(18), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig3_argue@ig3_argue", &(Local_38[0 /*31*/]), 24, 0, func_409(0), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig4_buyer_runs@ig_4_buyer_runs_player", &(Local_38[8 /*31*/]), 8, 0, func_409(26), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig4_buyer_runs@ig_4_buyer_runs_buyer", &(Local_38[9 /*31*/]), 8, 0, func_409(28), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig6_cower@ig6_cower", &(Local_38[2 /*31*/]), 56, 0, func_409(7), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig7_panic@ig7_panic", &(Local_38[10 /*31*/]), 48, 0, func_409(30), 0, 0);
	func_410(cParam0, "script@story@mry3@ig@ig8_scramble@ig8_scramble", &(Local_38[11 /*31*/]), 32, 0, func_409(41), 0, 0);
	func_410(cParam0, "script@story@mry3@ig@ig9_broach@ig9_broach", &(Local_38[12 /*31*/]), 32, 0, func_409(43), 0, 0);
	func_410(cParam0, "script@story@mry3@ig@ig10_drunk_stop@ig10_drunk_stop", &(Local_38[7 /*31*/]), 2, 0, func_409(23), 0, 1);
	func_410(cParam0, "script@story@mry3@ig@ig10_theater@ig10_theater", &(Local_38[13 /*31*/]), 64, 0, func_409(48), 0, 1);
	func_411(cParam0, Local_38[5 /*31*/], func_409(21), 1);
	func_411(cParam0, Local_38[1 /*31*/], func_409(5), 2);
	func_411(cParam0, Local_38[1 /*31*/], func_409(6), 2);
	func_411(cParam0, Local_38[2 /*31*/], func_409(10), 24);
	func_411(cParam0, Local_38[2 /*31*/], func_409(11), 24);
	func_411(cParam0, Local_38[8 /*31*/], func_409(24), 8);
	func_411(cParam0, Local_38[9 /*31*/], func_409(29), 8);
	func_411(cParam0, Local_38[8 /*31*/], func_409(25), 8);
	func_411(cParam0, Local_38[8 /*31*/], func_409(27), 8);
	func_411(cParam0, Local_38[12 /*31*/], func_409(45), 32);
	func_411(cParam0, Local_38[12 /*31*/], func_409(47), 32);
	func_411(cParam0, Local_38[13 /*31*/], func_409(67), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(49), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(66), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(50), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(51), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(52), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(53), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(54), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(55), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(56), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(57), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(58), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(59), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(60), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(61), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(62), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(63), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(64), 64);
	func_411(cParam0, Local_38[13 /*31*/], func_409(65), 64);
}

void func_140(char[4] cParam0, int iParam1, int iParam2)
{
	func_163(&(cParam0->f_1[func_132(iParam1) /*22*/].f_11), iParam2);
}
...
bool func_168(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (func_449(iParam0) == GET_HASH_KEY("WEAPON"))
	{
...
void func_174(int iParam0, int iParam1)
{
	...
	while (iVar0 <= iParam1)
	{
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_1223[iVar0]))
		{
...
bool func_205()
{
	return func_478(UIFEED::UI_FEED_GET_CURRENT_MESSAGE(3));
}
...
int func_208(int iParam0, int iParam1)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_480(iParam0, &(Global_40.f_11206[iParam0 /*26*/][iVar0 /*5*/]));
		}
		iVar0++;
	}
	return 1;
...
int func_213(var uParam0)
{
	...
	return (func_484() - BUILTIN::ROUND((uParam0->f_1 * 1000f)));
}
...
void func_251(char[4] cParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	func_504(iParam1);
	func_505(iParam1, 0);
	func_506(iParam1, 0, bParam4, bParam5, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	if (bParam5)
	{
	}
}
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(iVar0, func_519(iParam0)))
	{
		UILOG::_UILOG_REMOVE_ENTRY(iVar0, func_519(iParam0));
	}
	if (bParam1)
	{
		if (iVar0 == 1)
		{
			if (UILOG::_UILOG_IS_ENTRY_REGISTERED(2, func_519(iParam0)))
			{
				UILOG::_UILOG_REMOVE_ENTRY(2, func_519(iParam0));
			}
		}
	}
	func_520(iParam0, 4);
...
void func_269(int iParam0, bool bParam1)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(func_518(iParam0), func_519(iParam0)))
	{
		return;
	}
	if (bParam1)
	{
		UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_518(iParam0), func_519(iParam0), 2, "");
		func_521(iParam0, 16);
	}
	else
	{
		...
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_518(iParam0), func_519(iParam0), 1, "");
		}
		else
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_518(iParam0), func_519(iParam0), 0, "");
		}
		func_520(iParam0, 16);
	}
}
...
void func_285(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_531(Global_1310750[iVar0 /*111*/], iParam0))
		{
			if (!func_532(iVar0))
			{
				iVar1 = 1;
...
void func_287(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_536(iParam0, bParam3, BUILTIN::ROUND((fVar0 * fParam2)), BUILTIN::ROUND((fVar1 * fParam2)), BUILTIN::ROUND((fVar2 * fParam2)), BUILTIN::ROUND((fVar3 * fParam2)), bParam4, 1);
}
...
void func_291()
{
	...
	if (func_539(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1))
	{
		func_540(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1, 0);
	}
}
...
void func_292(int iParam0)
{
	...
	func_542(iParam0, (func_541(iParam0) + BUILTIN::SHIFT_LEFT(1, 16)));
}
...
void func_295(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		case 67:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_ABIGAIL2X1_1"), iParam1);
			break;
		case 18:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_4"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_1"), iParam1);
			break;
		case 20:
			func_544(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_2"), iParam1);
			break;
		case 2:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_4"), iParam1);
			break;
		case 23:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_3"), iParam1);
			func_545(1);
			break;
		case 16:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_2_TXT"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_3_TXT"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_4"), iParam1);
			break;
		case 59:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_2"), iParam1);
			if (func_546(146))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_TREASURE2_JN"), iParam1);
			}
			func_545(1);
			break;
		case 76:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_FINALE2_1"), iParam1);
			if (func_547() == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9A"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_10B"), iParam1);
			}
			break;
		case 44:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4B"), iParam1);
			break;
		case 46:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_4"), iParam1);
			break;
		case 17:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_3"), iParam1);
			break;
		case 19:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_GT_GRAYS_2"), iParam1);
			break;
		case 21:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_2"), iParam1);
			func_545(0);
			break;
		case 15:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1B"), iParam1);
			break;
		case 33:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_4"), iParam1);
			break;
		case 34:
			func_544(GET_HASH_KEY("JOURNAL_GT_INDUSTRY_3"), iParam1);
			break;
		case 64:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_LARAMIE1_1"), iParam1);
			break;
		case 60:
			func_544(GET_HASH_KEY("JOURNAL_CHAP8_PRONGHORN"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_MARSTON1_2"), iParam1);
			break;
		case 73:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON6_1"), iParam1);
			break;
		case 74:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON7_1"), iParam1);
			if (func_547() == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_4A"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_5B"), iParam1);
			}
			break;
		case 8:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_3"), iParam1);
			break;
		case 36:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2"), iParam1);
			if (Global_1357515 == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2B"), iParam1);
			}
			break;
		case 27:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_4"), iParam1);
			break;
		case 28:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_4"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_GT_MOB_2"), iParam1);
			break;
		case 29:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_GT_MOB_3"), iParam1);
			break;
		case 31:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_4"), iParam1);
			break;
		case 4:
			func_544(GET_HASH_KEY("JOURNAL_CHAP2_HORSESHOE"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_5"), iParam1);
			func_545(0);
			break;
		case 6:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2"), iParam1);
			if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_A"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_B"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_C"), iParam1);
			}
			break;
		case 25:
			func_544(GET_HASH_KEY("JOURNAL_GT_MUDTOWN_3B"), iParam1);
			break;
		case 24:
			if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_5000"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_7500"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_10000"), iParam1);
			}
			break;
		case 48:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2A"), iParam1);
			}
			if (func_548(51))
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2B"), iParam1);
			}
			break;
		case 49:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_1"), iParam1);
			if (Global_1357515 == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2B"), iParam1);
			}
			else if (Global_1357515 == 2)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2C"), iParam1);
			}
			break;
		case 58:
			func_544(GET_HASH_KEY("JOURNAL_GT_NATIVE_3"), iParam1);
			break;
		case 50:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON1_1"), iParam1);
			break;
		case 52:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2B"), iParam1);
			if (bParam2 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A2"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3B"), iParam1);
			}
			break;
		case 32:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_ODRISCOLL4_1"), iParam1);
			break;
		case 47:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MARY4_1"), iParam1);
			break;
		case 69:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE2_1"), iParam1);
			if (func_319(Global_1347702[9 /*49*/].f_15, 1))
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_2B"), iParam1);
			}
			break;
		case 70:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE3"), iParam1);
			if (func_547() == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_7A"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8B"), iParam1);
			}
			break;
		case 71:
			if (func_547() == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8A"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9B"), iParam1);
			}
			break;
		case 37:
			func_544(GET_HASH_KEY("JOURNAL_GT_SAINT_DENIS_1"), iParam1);
			break;
		case 9:
			if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1B"), iParam1);
			}
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_2"), iParam1);
			break;
		case 13:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_3"), iParam1);
			break;
		case 53:
			func_544(GET_HASH_KEY("JOURNAL_GT_CORNWALL_1"), iParam1);
			break;
		case 54:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY1_1"), iParam1);
			break;
		case 56:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_3"), iParam1);
			break;
		case 57:
			func_544(GET_HASH_KEY("JOURNAL_GT_TRAIN_ROBBERY_4"), iParam1);
			break;
		case 22:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_2"), iParam1);
			break;
		case 12:
			func_544(GET_HASH_KEY("JOURNAL_GT_UTOPIA_2"), iParam1);
			break;
		case 0:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_5"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_6"), iParam1);
			break;
		case 1:
			func_545(1);
			break;
		case 3:
			if (func_330())
			{
				...
				{
					func_544(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE"), iParam1);
				}
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE")))
			{
				func_544(GET_HASH_KEY("JOURNAL_GT_WINTER_4"), iParam1);
			}
			break;
		default:
			break;
...
void func_297(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	{
		case 0:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_4"), iParam1);
			break;
		case 1:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL2X2_1"), iParam1);
			break;
		case 2:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL3_1"), iParam1);
			break;
		case 9:
			func_544(GET_HASH_KEY("JOURNAL_CHAP9_BEECHERSHOPE"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_BEECHERS1X3_1"), iParam1);
			if (func_319(Global_1835011[69 /*74*/].f_1, 1))
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1A"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1B"), iParam1);
			}
			break;
		case 22:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_CALDERON1X1_1"), iParam1);
			break;
		case 26:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_JN"), iParam1);
			}
			break;
		case 29:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_2_AR"), iParam1);
			}
			else if (func_546(26))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B1"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B2"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_A"), iParam1);
			}
			break;
		case 32:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_AR"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_AR"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_AR"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_AR"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_AR"), iParam1);
				}
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2_JN"), iParam1);
				if (Global_1357515 == -1)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_JN"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_JN"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_JN"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_JN"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_JN"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_JN"), iParam1);
				}
			}
			break;
		case 35:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_JN"), iParam1);
			}
			break;
		case 36:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_JN"), iParam1);
			}
			break;
		case 37:
			func_544(GET_HASH_KEY("JOURNAL_GT_COACH_ROB_RSC"), iParam1);
			break;
		case 53:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT1_2_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN_B"), iParam1);
			}
			break;
		case 54:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_JN"), iParam1);
			}
			break;
		case 55:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1_AR"), iParam1);
			}
			else if (func_546(54))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1A_JN"), iParam1);
			}
			break;
		case 38:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CIG1_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_CIG1_1_JN"), iParam1);
			}
			break;
		case 39:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_DINO1_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_DINO1_1_JN"), iParam1);
			}
			break;
		case 40:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_DINO2_1_AR"), iParam1);
			}
			else if (func_546(39))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_DINO2_1_B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_DINO2_1_A_JN"), iParam1);
			}
			break;
		case 43:
			if (bParam3 == 1)
			{
				...
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1B_AR_A"), iParam1);
				}
				else
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1A_AR_A"), iParam1);
				}
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1_JN"), iParam1);
			}
			break;
		case 45:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_AR_A"), iParam1);
			}
			else if (func_546(43))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_B"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_A"), iParam1);
			}
			break;
		case 41:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FISH1_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FISH1_1_JN"), iParam1);
			}
			break;
		case 42:
			if (func_546(41))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_B"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_A"), iParam1);
			}
			break;
		case 49:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_JN"), iParam1);
			}
			break;
		case 50:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_AR"), iParam1);
			}
			else if (func_546(49))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B2"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_A"), iParam1);
			}
			break;
		case 51:
			func_544(GET_HASH_KEY("JOURNAL_RC_TAX1_1_JN"), iParam1);
			break;
		case 58:
			if (func_319(Global_1347702[23 /*49*/].f_15, 1))
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1B"), iParam1);
			}
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_3"), iParam1);
			break;
		case 59:
			func_544(GET_HASH_KEY("JOURNAL_CHAP2_DOWNES1_1"), iParam1);
			break;
		case 62:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DOWNES2_1"), iParam1);
			break;
		case 63:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ODRISCOLL2_2B"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_GT_ODRISCOLL_2"), iParam1);
			break;
		case 65:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_3"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_4"), iParam1);
			break;
		case 66:
			func_544(GET_HASH_KEY("JOURNAL_CHAP3_CLEMENS"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_3"), iParam1);
			func_545(1);
			break;
		case 67:
			func_544(GET_HASH_KEY("JOURNAL_CHAP4_SHADYBELLE"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_2"), iParam1);
			break;
		case 68:
			func_544(GET_HASH_KEY("JOURNAL_CHAP6_BEAVERHOLLOW"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2B"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_3"), iParam1);
			func_545(0);
			break;
		case 70:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_EDITHDOWNE2_1"), iParam1);
			break;
		case 71:
			func_544(GET_HASH_KEY("JOURNAL_RC_MILLER1_JN"), iParam1);
			break;
		case 73:
			func_544(GET_HASH_KEY("JOURNAL_RC_MILLER3_JN"), iParam1);
			break;
		case 75:
			func_544(GET_HASH_KEY("JOURNAL_RC_MILLER4_JN"), iParam1);
			break;
		case 77:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA1_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA1_1_JN"), iParam1);
			}
			break;
		case 79:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA3_1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA3_2_AR"), iParam1);
			}
			else if (func_546(78))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA3_2_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA3_1_JN"), iParam1);
			}
			break;
		case 80:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA4_1_AR"), iParam1);
			}
			else if (func_546(79))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA4_2_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_FMA4_1_JN"), iParam1);
			}
			break;
		case 85:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_JN"), iParam1);
			}
			break;
		case 86:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_JN"), iParam1);
			}
			break;
		case 87:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_JN"), iParam1);
			}
			break;
		case 88:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_JN"), iParam1);
			}
			break;
		case 89:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK1_JN"), iParam1);
			}
			break;
		case 92:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK4_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK4B_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK4_A_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK4_A2_JN"), iParam1);
			}
			break;
		case 93:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK5_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_HKK5_JN"), iParam1);
			}
			break;
		case 94:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2A"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2B"), iParam1);
			}
			func_544(GET_HASH_KEY("JOURNAL_GT_HOME_ROB"), iParam1);
			break;
		case 99:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3X1_1"), iParam1);
			break;
		case 101:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON1_1_AR"), iParam1);
				if (Global_1357515 == -1)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_B"), iParam1);
				}
				else
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_A"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON1_1B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON1_1A_JN"), iParam1);
			}
			break;
		case 102:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON2_1_AR"), iParam1);
			}
			else if (func_546(101))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON2_1B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON2_1A_JN"), iParam1);
			}
			break;
		case 103:
			func_544(GET_HASH_KEY("JOURNAL_RC_MASON3_1_AR"), iParam1);
			break;
		case 104:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON4_1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON4_2_AR"), iParam1);
			}
			else if (func_546(103))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON4_1B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON4_1A_JN"), iParam1);
			}
			break;
		case 105:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON5_1_AR"), iParam1);
			}
			else if (func_546(104))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON5_1B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MASON5_1A_JN"), iParam1);
			}
			break;
		case 108:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MONROE_1"), iParam1);
			break;
		case 109:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR_B"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR1_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR1B_JN"), iParam1);
			}
			break;
		case 110:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR2_AR"), iParam1);
			}
			else if (func_546(109))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR2B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR2A_JN"), iParam1);
			}
			break;
		case 111:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 0)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_AR"), iParam1);
				}
				else
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_AR"), iParam1);
				}
			}
			else if (func_546(110))
			{
				if (Global_1357515 == 0)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3C_JN"), iParam1);
				}
				else
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_JN"), iParam1);
					func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_2_JN"), iParam1);
				}
			}
			else if (Global_1357515 == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_2_JN"), iParam1);
			}
			break;
		case 115:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_1"), iParam1);
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_2"), iParam1);
			break;
		case 143:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ODDF1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ODDF1_JN"), iParam1);
			}
			break;
		case 144:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ODDF2_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_ODDF2_JN"), iParam1);
			}
			break;
		case 117:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO1_2_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_JN"), iParam1);
			}
			break;
		case 118:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1_AR"), iParam1);
			}
			else if (func_546(117))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1A_JN"), iParam1);
			}
			break;
		case 119:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO3_1_AR"), iParam1);
			}
			else if (func_546(118))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2A_JN"), iParam1);
			}
			break;
		case 121:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW1_JN"), iParam1);
			}
			break;
		case 122:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW3_AR"), iParam1);
			}
			else if (func_546(121))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW3B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW3A_JN"), iParam1);
			}
			break;
		case 124:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW4_AR"), iParam1);
			}
			else if (func_546(122))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW4B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW4A_JN"), iParam1);
			}
			break;
		case 125:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW5_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_PW5B_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_PW5_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_PW5B_JN"), iParam1);
			}
			break;
		case 127:
			func_544(GET_HASH_KEY("JOURNAL_RC_RTL1_AR"), iParam1);
			break;
		case 129:
			func_544(GET_HASH_KEY("JOURNAL_RC_RTL3_AR"), iParam1);
			break;
		case 131:
			func_544(GET_HASH_KEY("JOURNAL_RC_RTL5_AR"), iParam1);
			break;
		case 133:
			func_544(GET_HASH_KEY("JOURNAL_RC_RTL7_AR"), iParam1);
			break;
		case 134:
			func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_SADIE1_1"), iParam1);
			break;
		case 135:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_KILLER4A_AR"), iParam1);
				}
				else
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_KILLER4B_AR"), iParam1);
				}
			}
			else if ((HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER1_AR")) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER2_AR"))) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER3_AR")))
			{
				if (Global_1357515 == -1)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_KILLER4A_JN"), iParam1);
				}
				else
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_KILLER4B_JN"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_KILLER4C_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_KILLER4D_JN"), iParam1);
			}
			break;
		case 136:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC1_JN"), iParam1);
			}
			break;
		case 137:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC2_AR"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC3A_AR"), iParam1);
			}
			else if (func_546(136))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC2B_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC3C_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC2A_JN"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_RC_SLVC3A_JN"), iParam1);
			}
			break;
		case 142:
			if (bParam2 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3A"), iParam1);
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3B"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3C"), iParam1);
			}
			break;
		case 146:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 1)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_544(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_AR"), iParam1);
				}
			}
			else if (Global_1357515 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_JN"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_JN"), iParam1);
			}
			break;
		case 147:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET1_AR"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET1_JN"), iParam1);
			}
			break;
		case 148:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET2_AR"), iParam1);
			}
			else if (func_546(147))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET2B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET2A_JN"), iParam1);
			}
			break;
		case 149:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET3_AR"), iParam1);
			}
			else if (func_546(148))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET3B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET3A_JN"), iParam1);
			}
			break;
		case 150:
			if (bParam3 == 1)
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET4_AR"), iParam1);
			}
			else if (func_546(149))
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET4B_JN"), iParam1);
			}
			else
			{
				func_544(GET_HASH_KEY("JOURNAL_RC_WARVET4A_JN"), iParam1);
			}
			break;
		default:
			break;
		...
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == 176656832)
		{
			...
			if (func_552(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_553(&(Global_40.f_4283.f_6[iVar4 /*5*/]), 1, 0);
					}
					iVar4++;
				}
			}
...
bool func_310(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
		...
		if (func_566(iParam0))
		{
			...
			if (func_390() && func_574(4))
			{
				if (!Global_1914319.f_17376)
				{
					if (func_390() && (func_575(38) || func_571(38)))
					{
						func_579(38, COLLECTION::_0x13AAECDA43318BFE(-2076669067, iVar6), COLLECTION::_0xD52D20B0C76BB26D(-2076669067, iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
						func_579(38, MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_COLLECTABLE_CIGCARD"), iVar7, 12, 0, iVar6);
					}
				}
			}
		}
	}
	if (func_449(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_449(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_449(iParam0) == GET_HASH_KEY("AMMO") && func_591(iParam0))
		{
		...
		{
			func_95(func_595(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_95(func_596(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_580(iParam0, 589988438))
		{
			if (func_598())
			{
				func_599(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_611(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_612(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_611(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_618(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_619(499813453, 0);
				func_620(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_618(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_619(499813453, 0);
				func_620(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_618(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_619(499813453, 0);
				func_620(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_618(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_619(666607663, 0);
				func_621(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_618(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_619(666607663, 0);
				func_621(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_618(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_619(666607663, 0);
				func_621(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_618(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_619(-220219788, 0);
				func_622(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_618(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_619(-220219788, 0);
				func_622(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_618(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_619(-220219788, 0);
				func_622(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_618(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_619(218622660, 0);
				func_623(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_618(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_619(218622660, 0);
				func_623(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_618(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_619(390004462, 0);
				func_624(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_618(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_619(390004462, 0);
				func_624(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_618(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_619(390004462, 0);
				func_624(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_618(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_619(6410548, 0);
				func_625(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_618(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_619(6410548, 0);
				func_625(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_618(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_619(6410548, 0);
				func_625(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_618(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_619(6410548, 0);
				func_625(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_627(242, func_626(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_627(240, func_626(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_627(241, func_626(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
				...
				{
					func_628(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_628(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_628(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_628(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_628(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_628(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
void func_313(int iParam0)
{
	...
	func_656(GET_HASH_KEY("MPC_SP_DEFAULT_INTER_OUTFIT_TYPES"));
	iVar1 = 0;
	while (iVar1 < 39)
	{
	...
	Global_1946804.f_1616.f_1[8 /*3*/] = { func_659(8, 0) };
	Global_1946804.f_1616.f_1[9 /*3*/] = { func_659(9, 0) };
	Global_1946804.f_1616.f_1[0 /*3*/] = { func_659(0, 0) };
	Global_1946804.f_1616.f_1[2 /*3*/] = { func_659(2, 0) };
	Global_1946804.f_1616.f_1[3 /*3*/] = { func_659(3, 0) };
	Global_1946804.f_1616.f_1[1 /*3*/] = { func_659(1, 0) };
	Global_1946804.f_1616.f_1[5 /*3*/] = { func_659(5, 0) };
	Global_1946804.f_1616.f_1[6 /*3*/] = { func_659(6, 0) };
	Global_1946804.f_1616.f_1[7 /*3*/] = { func_659(7, 0) };
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (bVar7)
		{
			...
			while (iVar8 < 39)
			{
				...
				{
					func_661(&(Global_1946804.f_1616.f_1[iVar8 /*3*/]), iVar8, iVar0);
				}
				else
				{
					iVar8++;
...
char* func_316(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_319(Global_1835011[59 /*74*/].f_1, 1) || func_319(Global_1347702[1 /*49*/].f_15, 1)) || func_183(Global_1347702[1 /*49*/].f_15))
			{
				return "COMP_RUFUS";
			}
			else if (func_539(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
void func_318(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_665(&(Global_1946804.f_1497.f_1[iVar0 /*3*/]), 2, 6);
	func_665(&(Global_1946804.f_1378.f_1[iVar0 /*3*/]), 2, 6);
	if (bParam1)
	{
	...
	if (func_20() == -1)
	{
		...
		while (iVar1 < 5)
		{
			func_665(&(Global_26796.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
	...
	else
	{
		...
		while (iVar1 < 5)
		{
			func_665(&(Global_36638.f_45.f_350.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
...
bool func_325(int iParam0, int iParam1)
{
	...
	return func_673(&(Global_40.f_9910[iParam1 /*6*/]), 4);
}
...
void func_327(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		func_684(&(Global_40.f_9910[iVar0 /*6*/]), 2);
	}
...
void func_340(int iParam0)
{
	...
	if (iParam0 < 0)
	{
		func_686(MISC::VAR_STRING(2, "MISSION_COMPLETE_BANK_FEED", MISC::ABSI(iParam0)), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
		Global_1879514.f_14 = 1;
		Global_1879514.f_15 = 0;
	}
	else
	{
		func_686(MISC::VAR_STRING(2, "MISSION_COMPLETE_LOAN_FEED", iParam0), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Negative", 0, 1);
...
void func_349(int iParam0)
{
	...
	{
		case 1:
			func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
			iVar0 = func_264(iParam0);
			func_95(func_94(GET_HASH_KEY("MISSIONS_PROGRESSED")), 1);
			switch (func_465(iVar0))
			{
				case 0:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP1")), 1);
					break;
				case 1:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP2")), 1);
					break;
				case 2:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP3")), 1);
					break;
				case 3:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP4")), 1);
					break;
				case 4:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP5")), 1);
					break;
				case 5:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP6")), 1);
					break;
				case 6:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP7")), 1);
					break;
				case 7:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP8")), 1);
					break;
				case 8:
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP9")), 1);
					break;
				default:
					iVar2 = 0;
					break;
			...
			if (iVar0 == 7)
			{
				func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
			}
			if (iVar2 && MISSIONDATA::MISSIONDATA_IS_REQUIRED_STORY_MISSION(MISC::GET_HASH_KEY(&(Global_1835011[iVar0 /*74*/].f_8))))
			{
				func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("REQUIRED_MISSIONS")), 1);
			}
			break;
		case 8:
			iVar1 = func_264(iParam0);
			...
			if (func_293(Global_1347702[iVar1 /*49*/].f_12, 4) || iVar1 == 59)
			{
				...
				{
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC")), 1);
				}
			}
			if (func_293(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
			...
			else if (func_293(Global_1347702[iVar1 /*49*/].f_12, 4))
			{
				...
				{
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS")), 1);
				}
				else
				{
					func_95(func_596(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
...
void func_350()
{
	...
	if (iVar1 == 1)
	{
		func_692(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_SINGLE", 1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	else if (iVar1 > 1)
	{
		func_692(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_PLURAL", iVar1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	if (iVar3 > 0)
	{
		func_693(iVar3, 0, 0);
...
int func_355(int iParam0)
{
	...
	{
		case 0:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 1:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 2:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 2;
		case 4:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 5:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		...
		case 12:
			return 75000;
		case 8:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 9:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 10:
			return func_703(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
...
void func_357(char[4] cParam0)
{
	...
	if (!Global_1879514.f_11)
	{
		...
		if (MISSIONDATA::MISSIONDATA_GET_RATING(iVar1) != 5 && iVar0 == 5)
		{
			...
			else if (func_187(Global_1879514.f_1) == 8 && (func_293(Global_1347702[func_264(Global_1879514.f_1) /*49*/].f_12, 1) || func_293(Global_1347702[func_264(Global_1879514.f_1) /*49*/].f_12, 33554432)))
			{
				func_353(5, 1);
			}
		}
...
Vector3 func_360(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	vVar0 = { func_707(vParam0, iParam3, iParam4, iParam5, iParam6, 1, iParam7, bParam8, bParam9, bParam10, -1, 1103626240 /* Float: 25f */) };
	if (func_391(vVar0))
	{
		vVar0 = { func_707(vParam0, iParam3, iParam4, 0, 1, 1, iParam7, bParam8, 0, 0, -1, 1103626240 /* Float: 25f */) };
	}
	return vVar0;
}
...
void func_365(struct<16> Param0, int iParam16)
{
	...
	{
		if (SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&(Param0.f_10))) > 0 || func_713(&(Param0.f_10)))
		{
			return;
		}
	}
...
{
	func_736(uParam0, iLocal_16, iLocal_17, 108142, 108236, 108434, 108965, 109629, "MRY3_INT", 10, -1);
	func_736(uParam0, iLocal_17, iLocal_18, 110124, 110328, 110707, 111379, 112458, "MRY3_MCS1", 10, -1);
	func_736(uParam0, iLocal_18, iLocal_19, 112607, 112923, 113017, 113444, 114070, "", 264, -1);
	func_736(uParam0, iLocal_19, iLocal_20, 114371, 114727, 114854, 115359, 115797, "MRY3_MCS2", 10, -1);
	func_736(uParam0, iLocal_20, iLocal_21, 115867, 116420, 116519, 116811, 118359, "", 8, -1);
	func_736(uParam0, iLocal_21, iLocal_22, 118585, 118860, 118879, 119360, 124319, "", 8, -1);
	func_736(uParam0, iLocal_22, iLocal_23, 124396, 124538, 124761, 124889, 125056, "MRY3_EXT", 16777282, -1);
	func_736(uParam0, iLocal_23, 26, 125156, 125208, 125519, 125553, 125602, "MRY3_EXT", 66, -1);
}

bool func_378(int iParam0)
{
	return func_386(iLocal_483, iParam0);
}
...
void func_410(char[4] cParam0, char[4] cParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		func_812(&(cParam0->f_1126[iVar0 /*67*/].f_2), 4);
	}
}
...
void func_412(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		{
			if (func_809((uParam0[iVar0 /*3*/])->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_816(uParam1[iVar0 /*5*/]))
		{
			if (func_809((uParam1[iVar0 /*5*/])->f_4, iParam12))
			{
				func_817(uParam1[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_818(uParam2[iVar0 /*3*/]))
		{
			if (func_809((uParam2[iVar0 /*3*/])->f_2, iParam12))
			{
				func_819(uParam2[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_820(uParam3[iVar0 /*3*/]))
		{
			if (func_809((uParam3[iVar0 /*3*/])->f_2, iParam12))
			{
				func_821(uParam3[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_823(uParam5[iVar0 /*67*/]))
		{
			if (func_809((uParam5[iVar0 /*67*/])->f_3, iParam12))
			{
				func_824(uParam5[iVar0 /*67*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_823(uParam5[iVar0 /*67*/]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_825(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/])))
				{
					if (func_809((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/].f_2, iParam12))
					{
						func_826(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/]), (uParam5[iVar0 /*67*/])->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_827(uParam6[iVar0 /*4*/]))
		{
			if (func_809((uParam6[iVar0 /*4*/])->f_3, iParam12))
			{
				func_828(uParam6[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_829(uParam7[iVar0 /*5*/]))
		{
			if (func_809((uParam7[iVar0 /*5*/])->f_4, iParam12))
			{
				func_830(uParam7[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_831(uParam8[iVar0 /*3*/]))
		{
			if (func_809((uParam8[iVar0 /*3*/])->f_2, iParam12))
			{
				func_832(uParam8[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_833(uParam9[iVar0 /*3*/]))
		{
			if (func_809((uParam9[iVar0 /*3*/])->f_2, iParam12))
			{
				func_834(uParam9[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_835(uParam10[iVar0 /*4*/]))
		{
			if (func_809((uParam10[iVar0 /*4*/])->f_3, iParam12))
			{
				func_836(uParam10[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_837(uParam11[iVar0 /*3*/]))
		{
			if (func_809((uParam11[iVar0 /*3*/])->f_2, iParam12))
			{
				func_838(uParam11[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
...
bool func_419(var uParam0, int iParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_823(uParam0[iVar0 /*67*/]))
		{
			if (func_809((uParam0[iVar0 /*67*/])->f_3, iParam1))
			{
				if ((uParam0[iVar0 /*67*/])->f_65 > 0f || func_845((uParam0[iVar0 /*67*/])->f_2, 4))
				{
					if (!func_846(uParam0[iVar0 /*67*/]))
					{
						iVar1 = 0;
					}
				}
...
bool func_428(char[4] cParam0)
{
	if (func_867(cParam0))
	{
		func_145(cParam0, Local_530[0 /*178*/], "MARYLINT", 0);
	}
	else
	{
		return false;
	}
	if (!func_382(iLocal_1202, 0))
	{
	...
	else if (func_33(cParam0) >= iLocal_17)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1202))
		{
			...
			if (!func_871(iLocal_1202, -982327190))
			{
	...
	{
		if (!func_382(Local_709[5 /*18*/], 0))
		{
			Local_709[5 /*18*/] = func_872(iLocal_474, vLocal_516, 344.88f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			PED::SET_PED_CAN_BE_TARGETTED(Local_709[5 /*18*/], false);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_709[5 /*18*/], GET_HASH_KEY("REL_PLAYER_ALLY"));
		...
		else if (!func_871(Local_709[5 /*18*/], -1098463898))
		{
			TASK::TASK_START_SCENARIO_AT_POSITION(Local_709[5 /*18*/], GET_HASH_KEY("WORLD_HUMAN_BROOM_WORKING"), vLocal_516, 344.88f, -1, false, true, "WORLD_HUMAN_BROOM_WORKING_MALE_B", -1f, false);
		}
	}
	...
	func_887(9);
	ENTITY::CREATE_MODEL_HIDE(2627.006f, -1379.284f, 46.15857f, 5f, GET_HASH_KEY("P_BAT_LUMBER04X"), false);
	func_888(-2084311522);
	...
	{
		MISC::SET_WEATHER_TYPE(GET_HASH_KEY("FOG"), false, true, true, 60f, false);
	}
	func_166(9, 1, 0);
	func_167(44, 0);
	...
	func_889(GET_HASH_KEY("SD_CARRIAGE_ENTR_01_L"), 1, 0f, 0, 0, 0, 1, 0);
	func_889(GET_HASH_KEY("SD_CARRIAGE_ENTR_01_R"), 1, 0f, 0, 0, 0, 1, 0);
	func_866(0, 0);
...
bool func_430(char[4] cParam0)
{
	...
	switch (iVar2)
	{
		case 0:
			...
			{
				if (func_901(cParam0, func_33(cParam0)) != -1 && PED::_0x62DE46F061CAA468() < func_901(cParam0, func_33(cParam0)))
				{
					PED::_0xF008E0BA1FE1D644((func_901(cParam0, func_33(cParam0)) - PED::_0x62DE46F061CAA468()));
				}
		...
		case 5:
			...
			else
			{
				...
				if ((func_921(PLAYER::GET_PLAYER_INDEX(), 0, 0, 1) && !func_120(cParam0, 8192)) && !func_121(cParam0, func_33(cParam0), 8))
				{
					func_47(1, 0);
...
{
	func_926(&(Global_1914319.f_3[iParam0 /*446*/].f_6), iParam1);
}
...
{
	func_927(&(Global_1914319.f_3[iParam0 /*446*/].f_6), iParam1);
}
...
void func_446(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_934(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	sVar15 = func_935(MISC::VAR_STRING(10, &cVar2, MISC::VAR_STRING(0, func_626(iParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_580(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
		sVar15 = MISC::VAR_STRING(0, func_626(iParam0));
	}
	func_686(sVar15, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
int func_448(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_937(bParam2), iParam0, 0);
	return iVar2;
}
...
bool func_452(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_937(bParam0));
}
...
void func_485(bool bParam0)
{
	...
	if (func_963(GET_HASH_KEY("CAMERA_ITEM")))
	{
	}
...
void func_502(char[4] cParam0, int iParam1)
{
	...
	if (ENTITY::IS_ENTITY_AN_OBJECT(iParam1) && func_968(cParam0, ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(iParam1)))
	{
...
void func_506(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_382(Global_1360165[iParam0 /*1157*/], 0);
	...
	if (bParam3)
	{
		...
		func_977(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
	...
	else
	{
		...
		{
			func_538(&(Global_1360165[iParam0 /*1157*/].f_130));
		}
		if (bParam9)
		{
...
void func_516(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()) && bVar3)
		{
			if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_27))
			{
				...
				func_988(&(Global_1900383[iParam0 /*45*/].f_27));
			}
		}
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		...
		Global_1900383[iParam0 /*45*/].f_25 = 0;
		func_990(&(Global_1900383[iParam0 /*45*/].f_26), bVar6);
	}
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		return;
...
void func_524(int iParam0, char* sParam1, int iParam2)
{
	...
	func_686(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_525(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_686(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_686(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_540(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 60)
	{
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == iParam0)
		{
			func_553(&(Global_40.f_4283.f_6[iVar0 /*5*/]), bParam1, bParam2);
			return 1;
		}
		iVar0++;
	}
...
int func_547()
{
	...
	iVar0 = func_1005(Global_1347702[9 /*49*/].f_15);
	iVar1 = func_1005(Global_1835011[69 /*74*/].f_1);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_686(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_686(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_686(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_686(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
void func_579(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1041(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1041(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_692(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, func_1042(func_573(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1041(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
bool func_590(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_1028(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_1015())
				{
					return false;
				}
				...
				{
					func_588(iVar0, WEAPON::GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
void func_600(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_579(51, 0, 0, 0, 0, -1, 0);
			func_1065(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_579(51, 0, 0, 0, 0, -1, 0);
			func_1065(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_577(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_1069(1), 0, -1, 0);
			func_1070(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_577(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_1069(2), 0, -1, 0);
			func_1070(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_577(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_1069(4), 0, -1, 0);
			func_1070(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_577(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_1069(8), 0, -1, 0);
			func_1070(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_577(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_1069(16), 0, -1, 0);
			func_1070(16);
			break;
	}
}
...
void func_603(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_579(51, 0, 0, sVar0, func_1033(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_1065(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_579(51, 0, 0, sVar0, func_1033(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_1065(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			...
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_579(51, 0, 0, sVar0, func_1033(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_1065(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			...
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_579(51, 0, 0, sVar0, func_1033(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_1065(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			...
			func_577(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_579(51, 0, 0, sVar0, func_1033(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_1065(32768);
			break;
		default:
			func_317(439, 0);
		...
		else if (func_580(iParam0, 412399755))
		{
			...
			if (func_1076() == 0)
			{
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_577(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		else if (func_580(iParam0, 709057512))
		{
			...
			if (func_1076() == 1)
			{
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_577(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		else if (func_580(iParam0, -1478961327))
		{
			...
			if (func_1076() == 2)
			{
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					...
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_577(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		else if (func_580(iParam0, -1238404098))
		{
			...
			if (func_1076() == 3)
			{
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_577(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		else if (func_580(iParam0, 1160548794))
		{
			...
			if (func_1076() == 4)
			{
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_577(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_608(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_20() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_599(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_599(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_599(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_599(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_599(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_599(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_599(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_599(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_599(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_599(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_599(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_599(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_599(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_1085())
			{
				func_599(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_599(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_599(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_599(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_599(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_599(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_599(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_599(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_599(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_599(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_599(GET_HASH_KEY("RE