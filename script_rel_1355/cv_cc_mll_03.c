...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.5205f, 0.2751f, 0.8299f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	func_151(uParam0, -0.0006f, -0.0029f, 0.5041f, 0f, 1.5f, 2.02f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_POCKETMIRROR01X"), 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_PILLOW01X"), 0f, 0f, 0f, "PILLOW", 0, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("S_CARAVANCOT01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_MLLCNV3"), GET_HASH_KEY("PLAYER_MLLCNV3"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_POCKET_MIRROR"), "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_77(var uParam0)
{
	if (!bLocal_31)
	{
		uLocal_30 = STREAMING::_0xB223249B7798EEED(func_48(uParam0, iLocal_15), GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), 5, GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B"));
		bLocal_31 = true;
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
