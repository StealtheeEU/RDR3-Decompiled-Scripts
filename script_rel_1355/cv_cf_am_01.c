...
void func_65(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_125(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_127(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_90(var uParam0)
{
	...
	iLocal_19 = func_164(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.2f, -1.868f, -0.0285f, 0, 1, 0, 1);
	iLocal_21 = func_164(uParam0, GET_HASH_KEY("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	iLocal_20 = func_164(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), -1.859f, -0.832f, -0.021f, 0, 1, 0, 1);
	...
	func_166(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0);
	func_167(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_166(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_G", iLocal_20, 0);
	func_167(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_G", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_168(uParam0, iLocal_15, "START_SEATED_MALE_G_TO_SEAT_BENCH_MALE_B");
	if (!func_8(4))
	{
		func_166(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_CAMP_FIRE_SIT_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 0);
		func_167(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_CAMP_FIRE_SIT_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_166(uParam0, iLocal_17, 2, GET_HASH_KEY("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_B", -1, 0);
		func_167(uParam0, iLocal_17, 2, GET_HASH_KEY("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_166(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_A", iLocal_19, 0);
		func_167(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	if (func_8(4))
	{
		func_166(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), 0, iLocal_21, 0);
...
bool func_104(var uParam0)
{
	...
	{
		iLocal_29 = func_207("VIG_JOIN_CONVERSATION", GET_HASH_KEY("INPUT_CONTEXT_Y"), vLocal_32, 5f, 3, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	if (!MAP::DOES_BLIP_EXIST(iLocal_30))
	{
		iLocal_30 = MAP::BLIP_ADD_FOR_COORDS(-678244495, vLocal_32);
		MAP::SET_BLIP_SPRITE(iLocal_30, GET_HASH_KEY("BLIP_AMBIENT_SECRET"), true);
	}
	return true;
}
...
int func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_58(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_235(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
int func_263()
{
	...
	if (func_340(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_264()
{
	...
	if (func_340(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_406(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_464(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_483(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_495(GET_HASH_KEY("CHARACTER"), func_517(), -1591664384, bParam0);
}
