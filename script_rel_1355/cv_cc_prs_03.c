...
bool func_73(var uParam0)
{
	...
	func_153(uParam0, 1f, 0.8f, 0f, 0f, 3f, 6f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_CS_DEERCARCASS"), 0f, 0f, 0f, "CARCASS", 0, 0, 1);
	iLocal_20 = func_154(uParam0, GET_HASH_KEY("P_CS_DEERCARCASSARM"), 0f, 0f, 0f, "LEG", 0, 1, 1);
	iLocal_21 = func_154(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_SAWMEAT01X"), 0f, 0f, 0f, "SAW", 0, 0, 1);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	...
	func_157(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_BUTCHER_DEER"), "PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_SLICE", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	uLocal_42 = STREAMING::_0xB223249B7798EEED(func_8(uParam0, iLocal_14), GET_HASH_KEY("PROP_HUMAN_BUTCHER_DEER"), 262145, GET_HASH_KEY("PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_SLICE"));
	return true;
}
...
void func_342(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_376(iParam1))
		{
			func_377(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_396(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
