...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0875f, 0.1625f, 1.4875f, 0f, 3.345f, 3.06f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -2.2875f, -5.8625f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), -1.28962f, 0.762005f, -0.0126915f, 0, 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_SADDLE02X"), 0f, 0f, 0f, "p_cs_saddle02x", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_ABICNV23"), GET_HASH_KEY("PLAYER_ABICNV23"));
	func_156(uParam0, iLocal_18, -1, 0.95f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", iLocal_17, 0, 0.1f, 1.75f, 0);
	...
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), 0, -1, 1, 55f, 1065353216 /* Float: 1f */, 1);
