...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.4768f, 3.8112f, 0.9695f, 94.25f, 1f, 1f, 1.96f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -0.1018f, 0.3987f, 0.5445f, 94.25f, 1f, 2.6f, 1.96f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE^1", 0, 0, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE^2", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_WALL_LEFT"), "WORLD_HUMAN_LEAN_WALL_LEFT_DRINKING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	func_158(uParam0, iLocal_14, iLocal_16, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_MALE_B", -1, 1);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_B", -1, 1, 10f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, iLocal_17, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("WORLD_HUMAN_DRINKING"), 1, 0, 0);
...
int func_248()
{
	...
	if (func_329(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_249()
{
	...
	if (func_329(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_412(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_455(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_455(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_399(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_480(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_492(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_484(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_484(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_484(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_502(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_484(GET_HASH_KEY("CHARACTER"), func_506(), -1591664384, bParam0);
}
