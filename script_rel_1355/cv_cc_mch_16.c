...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_20 = GET_HASH_KEY("WEAPON_REPEATER_CARBINE");
	iLocal_21 = GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_MICAH");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CS_RAG01X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	...
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_LENNY_GUARD_CROUCH_TRACKS"), "WORLD_CAMP_LENNY_GUARD_CROUCH_TRACKS_MALE_A", -1, 1);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, 0);
	func_157(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_LEAN_CHECK_PISTOL"), "WORLD_HUMAN_LEAN_CHECK_PISTOL_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_14, "GREET_MICAH_MCHCNV16", 60000, 1);
	func_160(uParam0, GET_HASH_KEY("COMP_MCHCNV16"), GET_HASH_KEY("PLAYER_MCHCNV16"));
...
int func_175(var uParam0, int iParam1, int iParam2)
{
	if (!ENTITY::IS_ENTITY_DEAD(func_48(uParam0, iParam1)))
	{
		...
		{
			func_286(func_48(uParam0, iParam1), iParam2, 1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
		}
		else
		{
...
int func_204(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_314("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_315(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_314("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
int func_353(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_405(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
bool func_435(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_478(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_442(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_353(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_353(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
struct<5> func_444(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_493(iParam0))
	{
		...
		case GET_HASH_KEY("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_446(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_446(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_447(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_464(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_508(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_429(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_490(int iParam0)
{
	...
	func_521(iParam0, 1073741824 /* Float: 2f */);
}
...
{
	return func_448(GET_HASH_KEY("CHARACTER"), func_522(), -1591664384, bParam0);
}
