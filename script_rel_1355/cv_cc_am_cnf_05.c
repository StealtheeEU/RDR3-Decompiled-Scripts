...
bool func_79(var uParam0)
{
	...
	func_159(uParam0, -0.45f, -0.92f, 0f, -96.48f, 3.955f, 4.8675f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	Local_39 = { func_160(uParam0, 0.2457f, 0.4014f, 1f, 180f, 6f, 0.792f, 0.858f) };
	iLocal_38 = func_161(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0.8f, 0.491f, -0.004f, "crate02", 0, 0, 1);
	iLocal_37 = func_161(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 1.314f, 1.778f, -0.062f, "crate15", 0, 0, 1);
	...
	func_165(uParam0, iLocal_18, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
	func_166(uParam0, iLocal_18, 3, -1);
	func_167(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
	func_168(uParam0, iLocal_18, 1);
	func_169(uParam0, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), 1, 0, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A"));
	func_170(uParam0, 1);
...
int func_82(var uParam0)
{
	...
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), false))
	{
		return 0;
	}
...
bool func_94(var uParam0)
{
	...
	if (!MAP::DOES_BLIP_EXIST(iLocal_50))
	{
		...
		{
			iLocal_50 = MAP::BLIP_ADD_FOR_COORDS(-678244495, ENTITY::GET_ENTITY_COORDS(func_8(uParam0, iLocal_18), true, false));
			MAP::SET_BLIP_SPRITE(iLocal_50, GET_HASH_KEY("BLIP_AMBIENT_SECRET"), true);
		}
	}
	if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_94))
	{
		...
		{
			iLocal_94 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_50(uParam0, iLocal_38), GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_GENERIC"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_224(&uLocal_98))
		{
			...
			else
			{
				...
				func_167(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
			}
			func_226(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_215(9);
			return false;
		...
		if ((bParam1 || !func_113(iParam0)) || func_58(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_213(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_247(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_248(iParam0, 0));
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_289(uParam0->f_33[iVar0], 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_305(uParam0->f_107[iVar12 /*113*/].f_1));
				}
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_246(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
void func_210(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_51(*iParam0))
	{
		*iParam0 = func_327("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		func_328(*iParam0, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_51(*iParam1))
	{
		*iParam1 = func_327("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_228()
{
	TASK::TASK_USE_SCENARIO_POINT(Global_35, iLocal_94, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, true, false, 0, false, -1f, false);
}
...
void func_233(var uParam0)
{
	...
	{
		iLocal_53 = func_327("VIG_LEAVE_CONVERSATION", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
	}
...
int func_282()
{
	...
	if (func_382(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_283()
{
	...
	if (func_382(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_327(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_243(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_397(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_395(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_444(iParam1))
		{
			func_445(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_410(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_453(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
bool func_436(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_278(iParam0, 1073741824 /* Float: 2f */))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_246(iParam0, 1), &uVar4);
				}
...
bool func_485(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_246(iParam0, 1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_382(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_460(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_512(int iParam0)
{
	...
	func_529(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_514(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_531(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_539(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_551(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_543(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_543(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_543(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_561(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_543(GET_HASH_KEY("CHARACTER"), func_565(), -1591664384, bParam0);
}
