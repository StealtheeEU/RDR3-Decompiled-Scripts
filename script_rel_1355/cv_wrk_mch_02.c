...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_FOLDEDBILLS01X"), 0f, 0f, 0f, "MONEY", 0, 1, 1);
	iLocal_15 = func_151(uParam0, GET_HASH_KEY("S_LOOTABLECAMPCASE"), 0.158f, -0.064f, 0.979f, "CASE", 1, 0, 1);
	func_152(uParam0, 0f, 0f, 0f, 0f, 5f, 5f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, 1f, 0f, 0f, 0f, 3f, 3f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_MCHWRKCNV2"), GET_HASH_KEY("PLAYER_MCHWRKCNV2"));
...
void func_406(int iParam0)
{
	...
	Var0 = { func_444(GET_HASH_KEY("CAMP_FUNDS_CASH")) };
...
void func_438(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_485(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_485(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_335(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_425(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<4> func_514(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_532(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_514(GET_HASH_KEY("CHARACTER"), func_536(), -1591664384, bParam0);
}
