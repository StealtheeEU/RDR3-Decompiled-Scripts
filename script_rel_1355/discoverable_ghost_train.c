...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 4:
			...
			while (iVar0 <= 3)
			{
				...
				else
				{
					...
					AITRANSPORT::_SET_TRANSPORT_CONFIG_FLAG(Local_14.f_2[iVar0], 4, true);
					AITRANSPORT::_SET_TRANSPORT_CONFIG_FLAG(Local_14.f_2[iVar0], 5, true);
					AITRANSPORT::_SET_TRANSPORT_CONFIG_FLAG(Local_14.f_2[iVar0], 6, true);
				}
				iVar0++;
			}
			func_49(&Local_14, 5);
		...
		case 5:
			...
			AITRANSPORT::_SET_TRANSPORT_CONFIG_FLAG(Local_14.f_1, 4, true);
			AITRANSPORT::_SET_TRANSPORT_CONFIG_FLAG(Local_14.f_2[iVar0], 5, true);
			AITRANSPORT::_SET_TRANSPORT_CONFIG_FLAG(Local_14.f_2[iVar0], 6, true);
			func_49(&Local_14, 6);
			break;
		...
		case 7:
			...
			if (ENTITY::IS_ENTITY_ON_SCREEN(Local_14.f_1))
			{
				...
				Var2.f_13 = 3;
				Var2.f_7 = 500;
				IK::_0x66F9EB44342BB4C5(Global_35, &Var2);
				if (!func_51(func_50()))
				{
					func_63(func_50());
				}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_51(*uParam0))
			{
				uParam0->f_6.f_8 = func_83("DISCO_FOCUS", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
		}
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_98() == (5 - 1))
				{
					if (func_94())
					{
						func_97(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR"), 0);
						iVar0 = GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR");
					}
					else
					{
						func_97(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_JN"), 0);
...
int func_59(int iParam0)
{
	...
	{
		case 0:
			return GET_HASH_KEY("GHOSTTRAINSTEAMER");
		case 1:
			return GET_HASH_KEY("GHOSTTRAINCOALCAR");
		case 2:
			return GET_HASH_KEY("GHOSTTRAINPASSENGER");
		case 3:
			return GET_HASH_KEY("GHOSTTRAINCABOOSE");
		default:
			break;
	}
	return 0;
...
bool func_99()
{
	...
	if (!func_141(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
void func_108(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_155(func_154(GET_HASH_KEY("HONOR_POSITIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_157(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_157(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_155(func_154(GET_HASH_KEY("HONOR_NEGATIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_157(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_157(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_154(GET_HASH_KEY("HONOR_CURRENT")) };
...
void func_118(int iParam0)
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_161(iParam0))
		{
			func_155(func_154(GET_HASH_KEY("DISCOVERABLE_FOUND")), 1);
		}
	}
}
			...
			if (func_189(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_177(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_145() <= -160;
...
int func_205(int iParam0, bool bParam1)
{
	...
	if (!func_214(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_204(iVar14);
...
{
	return func_218(GET_HASH_KEY("CHARACTER"), func_219(), -1591664384, bParam0);
}
...
struct<4> func_218(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_143(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
