...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.8071f, -1.7113f, 1.0105f, -85f, 3f, 3f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_LEAN_POST_LEFT_HAND_PLANTED"), "WORLD_HUMAN_LEAN_POST_LEFT_HAND_PLANTED_MALE_B", -1, 0);
	func_155(uParam0, iLocal_14, 1, 3, 0, 0, 0);
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	if (func_201(uParam0, iLocal_15))
	{
		...
		{
			func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_LEAN_POST_LEFT_HAND_PLANTED"), "WORLD_HUMAN_LEAN_POST_LEFT_HAND_PLANTED_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
