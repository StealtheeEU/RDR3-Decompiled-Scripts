...
void func_218()
{
	...
	vVar19.f_1 = "SG_HDNG";
	vVar19.f_2 = func_330();
	Global_1572887.f_164.f_82 = UISTICKYFEED::_0x9F2CC2439A04E7BA(&Var0, &vVar19, 1);
	func_328(2);
	func_331(0);
}
...
void func_219()
{
	...
	if (UISTICKYFEED::_0xF8806EC3FF840FDC())
	{
...
void func_220()
{
	...
	{
		UISTICKYFEED::_UI_STICKY_FEED_CLEAR_MESSAGE(Global_1572887.f_164.f_82);
	}
	Global_1572887.f_164.f_82 = 0;
...
int func_224()
{
	...
	iVar17 = NETWORK::NETWORK_GET_DISPLAYNAMES_FROM_HANDLES(Global_1572887.f_164.f_80, &Var0, 2);
	if (iVar17 == -1)
	{
		return 2;
	}
...
void func_227()
{
	...
	switch (Global_1572887.f_164.f_1)
	{
		...
		case 0:
			Var0 = { func_343() };
			NETWORK::NETWORK_ACCEPT_RS_INVITE(NETWORK::_0x27B1AE4D8C652F08(Var0.f_15));
			break;
		case 1:
			if (NETWORK::NETWORK_REQUEST_JOIN(&(Global_1572887.f_164.f_27)) == -1)
			{
				func_249(17);
				return;
			}
...
void func_237()
{
	...
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(iVar54))
	{
		return;
	}
	func_358(iVar54);
	...
	else if (func_48() != -1)
	{
		...
		if (iVar68 != -1)
		{
			...
			if (iVar69 == -504335712)
			{
				...
				Var24.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar70 = MISC::VAR_STRING(2, func_398(Global_265238.f_4[iVar68 /*62*/].f_44));
			}
			else if (iVar69 == 395262693)
			{
				Var24.f_25.f_3 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE_DEATHMATCH");
				Var24.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar70 = MISC::VAR_STRING(2, func_399(Global_265238.f_4[iVar68 /*62*/].f_44));
			}
			else if (iVar69 == -933924539)
			{
				Var24.f_25.f_3 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE_RACE");
				Var24.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar70 = MISC::VAR_STRING(2, func_400(Global_265238.f_4[iVar68 /*62*/].f_44));
			}
			Var24.f_11 = MISC::VAR_STRING(10, "NT_INV_RCV_BODY_INFO", sVar70);
		}
	}
	else
	{
...
bool func_327()
{
	...
	if (Global_1572887.f_164.f_83 > 2)
	{
		...
		Var8 = { func_379(GANG::NETWORK_GET_GANG_LEADER(Global_1225639.f_14)) };
...
bool func_367(int iParam0, bool bParam1)
{
	...
	if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(Global_262777[iVar0 /*74*/].f_1) && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_262777[iVar0 /*74*/].f_1))
	{
		return false;
	}
