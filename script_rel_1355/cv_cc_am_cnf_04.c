...
bool func_79(var uParam0)
{
	...
	func_159(uParam0, -0.73f, -0.92f, 0f, -96.48f, 3.955f, 4.8675f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	...
	func_166(uParam0, iLocal_18, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_A", -1, 0);
	func_167(uParam0, iLocal_18, 3, -1);
	func_168(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_225(&uLocal_98))
		{
			...
			else
			{
				...
				func_168(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
			}
			func_227(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_216(9);
			return false;
...
int func_165(int iParam0, int iParam1, int iParam2)
{
	...
	iVar12 = 0;
	Var16 = { func_289(GET_HASH_KEY("NUM_PEDS_HURT")) };
	STATS::STAT_ID_GET_INT(&Var16, &iVar13);
	Var16 = { func_290(GET_HASH_KEY("KILLS"), GET_HASH_KEY("HUMAN")) };
	STATS::STAT_ID_GET_INT(&Var16, &iVar14);
	Var16 = { func_289(GET_HASH_KEY("HOLD_UPS")) };
...
void func_211(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_51(*iParam0))
	{
		*iParam0 = func_330("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		func_331(*iParam0, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_51(*iParam1))
	{
		*iParam1 = func_330("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_230(var uParam0)
{
	...
	if (bLocal_60)
	{
		if (func_351(Global_35, 0, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED") || func_351(Global_35, 1, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED"))
		{
...
void func_234(var uParam0)
{
	...
	{
		iLocal_53 = func_330("VIG_LEAVE_CONVERSATION", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
	}
...
int func_283()
{
	...
	if (func_385(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_284()
{
	...
	if (func_385(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_398(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_447(iParam1))
		{
			func_448(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_385(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_463(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_542(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_554(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_546(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_546(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_546(GET_HASH_KEY("CHARACTER"), func_568(), -1591664384, bParam0);
}
