...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7125f, -2.1875f, 0.5445f, 80f, 4.7f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_CHARLES"), 1, 1, 1);
	func_151(uParam0, -0.55f, 5.525f, 0.5445f, 80f, 2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, 1.3873f, -2.8002f, 1.15f, -6.94f, 0.955f, 1.4525f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_HAMMER02X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_CHRCNV5"), GET_HASH_KEY("PLAYER_CHRCNV5"));
	func_157(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 1);
	...
	func_160(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_161(uParam0, iLocal_14, 4, 1);
	func_162(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
