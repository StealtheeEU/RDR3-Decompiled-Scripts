...
int func_31(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		bLocal_40 = ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(uParam0->f_20[0 /*14*/], -1);
	}
	if (!uParam0->f_469[0])
	{
		if (!bLocal_38)
	...
	if (!uParam0->f_469[0] && !bLocal_38)
	{
		...
		if (uParam0->f_469[1])
		{
			if (!uParam0->f_469[3])
			{
				if (func_70(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_65(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[3] = 1;
				}
...
void func_90(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_127(iParam1))
		{
			func_128(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
