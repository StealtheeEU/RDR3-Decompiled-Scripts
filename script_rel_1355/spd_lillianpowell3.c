...
void __EntryFunction__()
{
	...
	fLocal_8 = 1f;
	iLocal_16 = 1;
	iLocal_249 = GET_HASH_KEY("CS_LILLIANPOWELL");
	iLocal_250 = GET_HASH_KEY("P_CIGARETTEHOLDER01X");
	iLocal_251 = GET_HASH_KEY("P_CS_LILLIANBOOK01X");
	iLocal_252 = GET_HASH_KEY("P_GLASS06X");
	fLocal_258 = 2f;
	iLocal_307 = -1;
	...
	while (true)
	{
		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_253) && !ENTITY::IS_ENTITY_DEAD(iLocal_253)) && iLocal_14 != 82) && VOLUME::DOES_VOLUME_EXIST(iLocal_266)) && func_28(Global_35, iLocal_266, 1, 0))
				{
				...
				switch (iLocal_14)
				{
					...
					case 1:
						...
						if (((((((HUD::TEXT_BLOCK_IS_LOADED("SPDEF") && HUD::TEXT_BLOCK_IS_LOADED("SPLPAUD")) && HUD::TEXT_BLOCK_IS_LOADED("STDRGAU")) && STREAMING::HAS_MODEL_LOADED(iLocal_249)) && STREAMING::HAS_MODEL_LOADED(iLocal_251)) && STREAMING::HAS_MODEL_LOADED(iLocal_250)) && STREAMING::HAS_MODEL_LOADED(iLocal_252)) && PED::_0x5C16855277819BBF() == 1)
						{
							func_10(2);
						}
					...
					case 2:
						if (((func_66(&iLocal_253, iLocal_249, 2636.429f, -1229.537f, 52.3795f, 358.7895f, 2, bLocal_385, !bLocal_385) && func_67(&iLocal_256, iLocal_251, 2636.611f, -1230.318f, 52.8894f)) && func_67(&iLocal_257, iLocal_252, 2637.884f, -1230.344f, 53.1922f)) && func_67(&iLocal_255, iLocal_250, 2637.932f, -1230.235f, 53.2323f))
						{
							if (func_4(iLocal_253, 0))
							{
								...
								PED::_0x24C82EF607105FAA(iLocal_253, GET_HASH_KEY("TIMID"));
								AUDIO::STOP_PED_SPEAKING(iLocal_253, true);
								func_70(&iLocal_253, &uLocal_273, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
								...
								iLocal_265 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), 2636.429f, -1229.537f, 52.3795f, 0f, 0f, 0f, 1f, 1f, 1.3f);
								...
								func_72(0);
								func_73(0, 0, "SPD_UC_GRT", "", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0);
								func_73(0, 1, "SPD_UC_ANT", "", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0);
					...
					case 75:
						...
						{
							func_151(16, 3);
							PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(iLocal_253, &uVar1));
							func_152(16);
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_153()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_155(75))
						{
							func_124(0);
							func_154();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 76:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_156()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_155(76))
						{
							func_124(0);
							func_154();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
...
void func_1()
{
	...
	func_171(&iLocal_253, &uLocal_273, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
...
bool func_7(float fParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (bVar0)
	{
		if ((((((((((PED::IS_PED_INJURED(iLocal_253) || PED::IS_PED_RAGDOLL(iLocal_253)) || TASK::IS_PED_GETTING_UP(iLocal_253)) || PED::IS_PED_LASSOED(iLocal_253)) || PED::IS_PED_BEING_STEALTH_KILLED(iLocal_253)) || PED::IS_PED_BEING_DRAGGED(iLocal_253)) || PED::IS_PED_BEING_STUNNED(iLocal_253, 0)) || PED::IS_PED_FALLING_OVER(iLocal_253)) || PED::IS_PED_HOGTIED(iLocal_253)) || TASK::IS_PED_IN_HIT_REACT(iLocal_253)) || PED::IS_PED_PRONE(iLocal_253))
		{
			*bParam2 = 0;
		}
		else
...
void func_29()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_266))
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_266, 2637.194f, -1230.109f, 53.81625f, 0f, 0f, 0f, 4.827326f, 3.346102f, 3.082269f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_266, 2636.479f, -1228.052f, 53.87238f, 0f, 0f, 0f, 3.766305f, 1f, 3.082421f);
	}
}
...
void func_161(vector3 vParam0, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7)
{
	...
	if (func_5(iLocal_272, 16777216) && func_5(iLocal_272, -2147483648))
	{
		...
		PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(iLocal_253, &uVar0));
		func_10(iParam3);
	}
}
...
int func_179(var uParam0, int iParam1, int iParam2, var uParam3, float fParam4)
{
	...
	switch (*uParam3)
	{
		...
		case 2:
			*uParam3++;
			if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(GET_HASH_KEY("EVENT_SHOCKING_EXPLOSION"), ENTITY::GET_ENTITY_COORDS(*iParam2, false, true), fParam4))
			{
				*iParam1 = 16;
				return 1;
			}
		...
		case 3:
			*uParam3++;
			if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(GET_HASH_KEY("EVENT_SHOCKING_FIRE"), ENTITY::GET_ENTITY_COORDS(*iParam2, false, true), fParam4))
			{
				*iParam1 = 16;
				return 1;
			}
		...
		case 4:
			*uParam3 = 0;
			if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(GET_HASH_KEY("EVENT_SHOCKING_POTENTIAL_BLAST"), ENTITY::GET_ENTITY_COORDS(*iParam2, false, true), fParam4))
			{
				*iParam1 = 16;
				return 1;
			}
...
bool func_331()
{
	if (((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630.f_12) && VOLUME::DOES_VOLUME_EXIST(iLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_260, true, 0)) && func_177(Global_35, iLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_316)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_316) >= func_454(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_253)) || func_455())) && iLocal_14 != 80) && iLocal_14 != 6) && !func_5(iLocal_272, 2)) && !func_456())
	{
		func_457(0, 1);
		return true;
	}
...
void func_333(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_459(func_458(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_460(func_458(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
bool func_425(int iParam0, int iParam1)
{
	...
	if (func_503(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
bool func_442(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*iParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_328(iParam4, 268435456))
			{
				iVar8 = func_508(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
void func_535(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_338(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_522(iParam1))
		{
			...
			iParam1->f_6 = func_548(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_338(iParam1->f_6))
			{
				if (!bParam6)
				{
