...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.2375f, -0.6f, 1.15f, -42.44f, 4.4f, 2f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -1.1621f, 0.6703f, 0.6545f, -130.68f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE_BILL", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_PEARSON", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, "BARREL", 1, 0, 1);
	if (!func_153(15))
	{
	...
	func_156(uParam0, GET_HASH_KEY("COMP_BLLCNV9"), GET_HASH_KEY("PLAYER_BLLCNV9"));
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", -1, 0);
	func_158(uParam0, iLocal_14, 2, 3, 0, "Default_Angry", 0);
	func_159(uParam0, iLocal_14, 1, -1);
	if (!func_153(15))
	{
		func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", -1, 0);
	}
	func_160(uParam0, iLocal_15, 1061142135 /* Float: 0.749f */);
	func_159(uParam0, iLocal_15, 1, -1);
	if (func_148(uParam0) == 1)
	{
		func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_BACK_EXHAUSTED"), "WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A", -1, 0, 100f, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_335(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_402(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_460(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_479(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_487(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_499(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_491(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_491(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_491(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_509(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_491(GET_HASH_KEY("CHARACTER"), func_513(), -1591664384, bParam0);
}
