...
bool func_73(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("A_C_CROW_01"), "");
	func_153(uParam0, 1.625f, -0.675f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_153(uParam0, 0.6125f, -2.2125f, 0.85f, -8.5f, 1.6325f, 1.1875f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_153(uParam0, -3.7875f, -0.8125f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TRELAWNY"), 1, 1, 1);
	func_154(uParam0, 1.05f, -1.65f, 0f, -30f, 1f, 1.54f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_155(uParam0, GET_HASH_KEY("P_PIPE01X"), 0f, 0f, 0f, "PIPE", 0, 0, 1);
	iLocal_21 = func_155(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "LEDGER", 0, 0, 1);
	iLocal_19 = func_155(uParam0, GET_HASH_KEY("P_CS_KNITTING01X"), 0f, 0f, 0f, "KNITTING", 0, 0, 1);
	iLocal_20 = func_155(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.67941f, -0.624629f, 0.00875473f, 0, 1, 0, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_TRLCNV1"), GET_HASH_KEY("PLAYER_TRLCNV1"));
	func_159(uParam0, iLocal_18, -1, 0.88f);
	func_160(uParam0, iLocal_15, 4, 2, 0, 0, 0);
	func_161(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_B", -1, 1);
	func_162(uParam0, iLocal_16, 1, -1);
	func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_163(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_164(uParam0, iLocal_15, iLocal_21, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	func_162(uParam0, iLocal_15, 1, -1);
	func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_20, 0);
	func_163(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_250()
{
	...
	if (func_325(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_251()
{
	...
	if (func_325(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_389(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
