...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 1.0585f, -0.4757f, 0.5633f, 0f, 1.1f, 1.1f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_150(uParam0, 8.6959f, -2.0924f, 0.8267f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_20 = func_151(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42062f, -0.462748f, 0.00315094f, "CRATE", 1, 0, 1);
	iLocal_21 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_BRUSHHORSE02X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_CS_SADDLE02X"), 0f, 0f, 0f, "SADDLE", 0, 1, 1);
	...
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_84(var uParam0)
{
	...
	if (TASK::_DOES_SCENARIO_GROUP_EXIST_HASH(GET_HASH_KEY("PLAYER_CAMP_CHORES_WOOD_CHOP")))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(GET_HASH_KEY("PLAYER_CAMP_CHORES_WOOD_CHOP"), false);
	}
