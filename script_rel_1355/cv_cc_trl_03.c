...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("A_C_CROW_01"), "CROW");
	func_153(uParam0, 1.6f, 0.7f, 0.85f, -12.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_153(uParam0, -4.875f, -1.1375f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_153(uParam0, 0.25f, 0.6f, 0.8875f, 74.5f, 2.68f, 1.705f, 3.2075f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, 1.7375f, -3.5f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TRELAWNY"), 1, 1, 1);
	iLocal_18 = func_154(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_155(uParam0, GET_HASH_KEY("COMP_TRLCNV3"), GET_HASH_KEY("PLAYER_TRLCNV3"));
	func_156(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1);
	func_157(uParam0, iLocal_16, 1, -1);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_18, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
