...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.0564f, -1.585f, 0f, -46.75f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.6186f, 2.04f, 0f, 39.5f, 1.55f, 1.11f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 0.24f, 2.24f, 0.9775f, 16.2f, 1f, 0.76f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_KNIFE02X"), 0f, 0f, 0f, "Knife", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_WOODWHITTLE01X"), 0f, 0f, 0f, "Woodwhittle", 0, 1, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.2f, -1.868f, -0.0285f, 0, 1, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	func_154(uParam0, "script@vignette@dog_5@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@dog_5@action", 0, 0, 1, 0);
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_ANIMAL_DOG_RESTING"), "WORLD_ANIMAL_DOG_RESTING", -1, 1);
	func_156(uParam0, iLocal_14, 1);
	func_155(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0);
	func_157(uParam0, iLocal_16, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_A", iLocal_18, 0);
	return true;
}
...
void func_400(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_441(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_441(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_441(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_458(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_470(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_488(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_470(GET_HASH_KEY("CHARACTER"), func_492(), -1591664384, bParam0);
}
