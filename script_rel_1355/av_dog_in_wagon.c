...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "DIWP_MAN", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -3f, -2f, 0f), (94f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "DIWP_DOG", GET_HASH_KEY("A_C_DOGBLUETICKCOONHOUND_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -5f, -2f, 0f), (-85f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 2, "DIWP_HORSE_1", 0, vParam1, vParam4.z, 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 3, "DIWP_HORSE_2", 0, vParam1, vParam4.z, 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, "WAGON", GET_HASH_KEY("WAGON02X"), vParam1, vParam4.z, 0, 0, 0, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				func_70(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WORLD_HUMAN_CROUCH_INSPECT"), 0, 0, 0, -1082130432 /* Float: -1f */);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				func_70(uParam0->f_20[1 /*14*/], GET_HASH_KEY("WORLD_ANIMAL_DOG_SITTING"), 0, 0, 0, -1082130432 /* Float: -1f */);
...
bool func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_207(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_205(int iParam0, int iParam1)
{
	...
	if (func_232(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
