...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.04f, -1.28f, 0.4194f, 0f, 3f, 3.84f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, -4.56f, -7.31f, 0.1523f, 0f, 1.2f, 1.2f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, -1.3883f, 0.7683f, 0.9968f, 0f, 0.84f, 0.84f, 4f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), -0.0196864f, -0.0395289f, -0.00128174f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE_CIGAR"), 0, -1, 1, 60f, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	func_158(uParam0, iLocal_14, 2, 24, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_MALE_A", iLocal_16, 0, 10f, 0f, 1);
	func_158(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	func_159(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, GET_HASH_KEY("COMP_DNJCNV6"), GET_HASH_KEY("PLAYER_DNJCNV6"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
