...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -7.7064f, -0.6208f, 0f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_150(uParam0, -1f, -1f, 0f, 0f, 3f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, -1.10969f, -0.976567f, 1.03409f, 0f, 1.3f, 1.3f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_152(uParam0, 5, 0);
	func_152(uParam0, 9, 0);
	func_153(uParam0, GET_HASH_KEY("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.258f, -1.197f, 0.032f, "CHAIR", 1, 0, 1);
