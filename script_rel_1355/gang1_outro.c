...
int func_21(var uParam0)
{
	...
	func_53(0, 0);
	func_54(1);
	if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_16, true, false) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_16, "PBL_1"))
	{
...
void func_63(int iParam0, int iParam1)
{
	...
	{
		func_151(Global_35, GET_HASH_KEY("CLOTHING_ITEM_NECKWEAR_NONE"), 0, 1742327865, 0, 1, 0, 0, 1, 0);
		func_152(GET_HASH_KEY("KIT_BANDANA"), 0);
	}
...
int func_87(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_33(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_161(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_163(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_164(iParam0, 0));
...
void func_92()
{
	...
	if (func_167(iVar0))
	{
		...
		{
			func_171(Global_35, iVar0, 1, 0, 9, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
		}
		else
		{
			WEAPON::SET_CURRENT_PED_WEAPON(Global_35, iVar0, true, 9, false, false);
	...
	if (func_186(iParam0, 1, 0))
	{
		if (func_187(iParam0))
		{
			...
			if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if ((bParam1 || !func_188(func_80(iParam0), 1116471296 /* Float: 70f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */)) || CAM::IS_SCREEN_FADED_OUT())
				{
...
struct<6> func_129()
{
	...
	if (func_223(GET_HASH_KEY("SLOTID_HORSE_BEDROLL"), &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_223(GET_HASH_KEY("SLOTID_HORSE_BLANKET"), &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_223(GET_HASH_KEY("SLOTID_HORSE_HORN"), &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_223(GET_HASH_KEY("SLOTID_HORSE_SADDLEBAG"), &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_223(GET_HASH_KEY("SLOTID_HORSE_STIRRUP"), &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_223(GET_HASH_KEY("SLOTID_HORSE_SADDLE"), &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
void func_136(int iParam0, int iParam1, int iParam2)
{
	...
	iVar3 = 0;
	bVar2 = func_75() != -1;
	if (func_232() == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_FEMALE"))
	{
		iVar3 = 1;
	}
	...
	if (iVar0 != 0)
	{
		...
		{
			Global_1946804.f_1378.f_1[iVar1 /*3*/].f_1 = GET_HASH_KEY("BASE");
			Global_1946804.f_2653 = iParam0;
		}
		else
		{
...
bool func_146(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam4 && !func_261(Global_1347702[iParam0 /*49*/].f_13, 8192))
	{
...
int func_151(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946804.f_57[func_271(iParam3, 1) /*11*/])
			{
				func_274(31, 0, 0, 0, 0);
			}
			break;
...
int func_171(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_299(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
void func_189(int iParam0, bool bParam1)
{
	...
	if (PERSCHAR::_0xA8120EBEAF290C7A(func_34(iParam0, 0)))
	{
		...
		if (iVar0 != Global_1360165[iParam0 /*1157*/].f_47 || bParam1)
		{
			...
			StringCopy(&(Global_1360165[iParam0 /*1157*/].f_48), PERSCHAR::_0x9C7F95946E304778(func_34(iParam0, 0), Global_1360165[iParam0 /*1157*/].f_47), 64);
...
bool func_221(int iParam0, var uParam1)
{
	...
	*uParam1 = func_343(Var0, GET_HASH_KEY("SLOTID_HORSE_MANE"), 0);
...
bool func_222(int iParam0, var uParam1)
{
	...
	*uParam1 = func_343(Var0, GET_HASH_KEY("SLOTID_HORSE_TAIL"), 0);
	if (!func_230(*uParam1, 0))
	{
		return false;
	}
...
int func_229(int iParam0)
{
	switch (iParam0)
	{
		...
		case 2:
			return GET_HASH_KEY("AMMO_ARROW_FIRE");
		case 3:
			return GET_HASH_KEY("AMMO_ARROW_POISON");
		case 4:
			return GET_HASH_KEY("AMMO_ARROW_SMALL_GAME");
		case 43:
			return GET_HASH_KEY("AMMO_ARROW_IMPROVED");
		case 5:
			return GET_HASH_KEY("AMMO_DYNAMITE");
		case 6:
			return GET_HASH_KEY("AMMO_DYNAMITE_VOLATILE");
		case 7:
			return GET_HASH_KEY("AMMO_HATCHET");
		case 8:
			return GET_HASH_KEY("AMMO_HATCHET_HUNTER");
		case 9:
			return GET_HASH_KEY("AMMO_LASSO");
		case 10:
			return GET_HASH_KEY("AMMO_MOLOTOV");
		case 11:
			return GET_HASH_KEY("AMMO_MOLOTOV_VOLATILE");
		case 12:
			return GET_HASH_KEY("AMMO_PISTOL");
		case 13:
			return GET_HASH_KEY("AMMO_PISTOL_EXPRESS");
		case 14:
			return GET_HASH_KEY("AMMO_PISTOL_EXPRESS_EXPLOSIVE");
		case 15:
			return GET_HASH_KEY("AMMO_PISTOL_HIGH_VELOCITY");
		case 16:
			return GET_HASH_KEY("AMMO_PISTOL_SPLIT_POINT");
		case 17:
			return GET_HASH_KEY("AMMO_REPEATER");
		case 18:
			return GET_HASH_KEY("AMMO_REPEATER_EXPRESS");
		case 19:
			return GET_HASH_KEY("AMMO_REPEATER_EXPRESS_EXPLOSIVE");
		case 20:
			return GET_HASH_KEY("AMMO_REPEATER_HIGH_VELOCITY");
		case 21:
			return GET_HASH_KEY("AMMO_REPEATER_SPLIT_POINT");
		case 22:
			return GET_HASH_KEY("AMMO_REVOLVER");
		case 23:
			return GET_HASH_KEY("AMMO_REVOLVER_EXPRESS");
		case 24:
			return GET_HASH_KEY("AMMO_REVOLVER_EXPRESS_EXPLOSIVE");
		case 25:
			return GET_HASH_KEY("AMMO_REVOLVER_HIGH_VELOCITY");
		case 26:
			return GET_HASH_KEY("AMMO_REVOLVER_SPLIT_POINT");
		case 27:
			return GET_HASH_KEY("AMMO_RIFLE");
		case 28:
			return GET_HASH_KEY("AMMO_RIFLE_EXPRESS");
		case 29:
			return GET_HASH_KEY("AMMO_RIFLE_EXPRESS_EXPLOSIVE");
		case 30:
			return GET_HASH_KEY("AMMO_RIFLE_HIGH_VELOCITY");
		case 31:
			return GET_HASH_KEY("AMMO_RIFLE_SPLIT_POINT");
		case 32:
			return GET_HASH_KEY("AMMO_SHOTGUN");
		case 33:
			return GET_HASH_KEY("AMMO_SHOTGUN_BUCKSHOT_INCENDIARY");
		case 34:
			return GET_HASH_KEY("AMMO_SHOTGUN_SLUG");
		case 35:
			return GET_HASH_KEY("AMMO_SHOTGUN_SLUG_EXPLOSIVE");
		case 36:
			return GET_HASH_KEY("AMMO_THROWING_KNIVES");
		case 37:
			return GET_HASH_KEY("AMMO_THROWING_KNIVES_IMPROVED");
		case 38:
			return GET_HASH_KEY("AMMO_THROWING_KNIVES_POISON");
		case 39:
			return GET_HASH_KEY("AMMO_TOMAHAWK");
		case 40:
			return GET_HASH_KEY("AMMO_TOMAHAWK_ANCIENT");
		case 41:
			return GET_HASH_KEY("AMMO_TOMAHAWK_HOMING");
		case 42:
			return GET_HASH_KEY("AMMO_TOMAHAWK_IMPROVED");
		case 44:
			return GET_HASH_KEY("AMMO_22");
		default:
			break;
	}
	return 0;
...
int func_235(int iParam0)
{
	...
	{
		case 0:
			return GET_HASH_KEY("CLOTHING_ITEM_BEARD_SINGLE");
		case 1:
			return GET_HASH_KEY("CLOTHING_ITEM_CHOPS_NORMAL");
		case 2:
			return GET_HASH_KEY("CLOTHING_ITEM_STACHE_NORMAL");
		default:
			break;
	}
	return 0;
...
struct<5> func_269(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_383(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_280(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_386(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_386(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_387(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_280(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_280(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_282(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_303(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_424("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_423(iParam1, 512) && func_426(Var4.f_4, &uVar19, &Var23, 1728382685 /* GXTEntry: "Right" */)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || WEAPON::IS_PED_CARRYING_WEAPON(Global_35, Var4.f_4))
			{
				if ((((((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) || func_427(Var4.f_4)) && (!WEAPON::IS_WEAPON_SHOTGUN(Var4.f_4) || func_423(iParam1, 16))) && (!WEAPON::_IS_WEAPON_SNIPER(Var4.f_4) || func_423(iParam1, 4))) && (!func_427(Var4.f_4) || func_423(iParam1, 8))) && (!WEAPON::IS_WEAPON_REPEATER(Var4.f_4) || !func_423(iParam1, 8388608))) && (!WEAPON::IS_WEAPON_RIFLE(Var4.f_4) || !func_423(iParam1, 1048576)))
				{
...
void func_304(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		sVar2 = func_429(fParam1 < 0f, "rpg_cold", "rpg_hot");
...
bool func_314(int iParam0, int iParam1)
{
	...
	Var29 = { func_280(iParam1, Var0, GET_HASH_KEY("SLOTID_HORSE_MANE"), 0) };
...
bool func_315(int iParam0, int iParam1)
{
	...
	Var29 = { func_280(iParam1, Var0, GET_HASH_KEY("SLOTID_HORSE_TAIL"), 0) };
	return func_436(Var29, 1);
}
...
{
	return func_280(GET_HASH_KEY("CHARACTER"), func_476(), -1591664384, bParam0);
}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_481(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_389(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_481(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_393(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_409(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_494(func_493(255), GET_HASH_KEY("COLOR_PURE_WHITE")));
	}
	else if (func_177())
	{
...
int func_440(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar33 = func_506(1168099063, &Var16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_442(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		...
		{
			if (func_507(iVar62, 1168099063, &Var28) && func_507(iVar62, 1168099063, &Var45))
			{
	...
	{
		iVar62 = func_506(1168099063, &Var28, 0);
		iVar62 = func_506(1168099063, &Var45, 0);
	}
	return iVar62;
}
...
void func_486(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_75() == -1)
	{
		func_352(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_353(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_524(&(Global_1946804.f_1378), iParam0);
...
int func_503(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	{
		Var16 = { func_538(Param0, 1) };
		Var16.f_10 = iParam4;
		iVar0 = func_539(GET_HASH_KEY("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var45 = { func_540(Param0, 1) };
		Var45.f_10 = iParam4;
		iVar0 = func_541(GET_HASH_KEY("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_505(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_506(GET_HASH_KEY("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<17> func_505(var uParam0)
{
	struct<17> Var0;
...
bool func_526(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_549(&(Global_1109400.f_4), iVar0, 5);
	}
	if (iParam1 == func_550())
	{
		return func_549(&(Global_1109400.f_4), iVar0, 5);
	...
	{
		return func_549(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
struct<29> func_538(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> Var0;
	struct<29> Var29;
	...
	Var29.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_282(bParam4), &uParam0, &Var29, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_505(&Var29) };
...
struct<18> func_540(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> Var0;
	struct<15> Var18;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_282(bParam4), &uParam0, &Var18, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_505(&Var18) };
