...
bool func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if ((SCRIPTS::IS_THREAD_EXIT_REQUESTED() && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("HUNTING1")) == 0) && !func_34(15))
		{
			bVar0 = true;
		}
...
bool func_42(var uParam0)
{
	*uParam0 = 0;
	...
	uParam0->f_572[1] = GET_HASH_KEY("P_BEARSCAT01X");
	uParam0->f_580[0] = 4;
	uParam0->f_580[1] = 0;
	uParam0->f_588[0] = 0;
	uParam0->f_588[1] = 0;
	uParam0->f_596[0] = 1;
	uParam0->f_596[1] = 1;
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_BEAR_01");
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("BEAR_LEGENDARY");
	return true;
}
...
bool func_197(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_229(0) };
			Var4.f_9 = -1591664384;
			if (!func_230(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_231(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_232(iParam0, 1))
			{
				if (!func_230(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_231(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
bool func_233(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar29 < 4)
	{
		...
		if (func_230(iParam0, &Var0, iVar5, 0))
		{
			bVar28 = func_231(iParam0, &Var6, iVar5);
...
int func_234(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
bool func_246(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_133(0);
	*uParam1 = { func_132(iParam0, func_229(0), iParam3, 0) };
...
struct<5> func_248(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_245(iParam0))
	{
		...
		case GET_HASH_KEY("WEAPON"):
			...
			if (bParam2 && func_232(iParam0, 1))
			{
				...
				else if (!func_230(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_231(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, -833319691))
			{
				...
				if (!func_254(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
