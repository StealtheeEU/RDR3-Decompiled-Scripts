	...
	if (func_51(&uLocal_3) > 3f)
	{
		...
		if (func_52(iVar0) && func_53(iVar1, 128))
		{
			...
			if (func_55())
			{
				...
				if (!bLocal_6)
				{
					bLocal_6 = func_56(GET_HASH_KEY("CSTAG_FLOW_FUS1_POST"), GET_HASH_KEY("CSTP_PERSIST_ACROSS_STATES"), -469960592, -1, 1, 1, 0);
				}
				MISC::CLEAR_BIT(&(Global_1956580.f_1), 5);
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1835011[iParam0 /*74*/].f_27))
	{
		...
		if (func_153(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_154(&(Global_1835011[iParam0 /*74*/]), 2))
			{
				...
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_74(iParam0));
				}
			}
			...
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_RADIUS(1673015813, func_157(iParam0), func_158(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_103(iParam0))
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_112(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_104(iParam0));
		...
		else if (func_111(iParam0))
		{
			if (iParam0 == 7)
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(-1337945352, func_74(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_74(iParam0));
