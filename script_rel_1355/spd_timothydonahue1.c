...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_166 = GET_HASH_KEY("CS_TIMOTHYDONAHUE");
	iLocal_167 = GET_HASH_KEY("S_BOOKCART01X");
	iLocal_168 = GET_HASH_KEY("P_CS_GETRICH_BOOK01X");
	iLocal_169 = GET_HASH_KEY("P_CS_BILLSINGLE01X");
	...
	while (true)
	{
		...
		else
		{
			...
			{
				case 0:
					if (func_27(GET_HASH_KEY("DOCUMENT_GET_RICH_BOOK"), 1, 0))
					{
						func_28(27, 12);
						func_1(1, 0);
					}
				...
				case 2:
					if ((((func_62(&(uLocal_171[0]), iLocal_166, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_63(&iLocal_173, iLocal_168, 2644.251f, -1208.702f, 53.5354f)) && func_63(&iLocal_174, iLocal_168, 2643.541f, -1208.416f, 53.1764f)) && func_63(&iLocal_175, iLocal_169, 2644.625f, -1208.099f, -108.1324f)) && func_63(&iLocal_176, iLocal_167, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(uLocal_171[0], 0))
						{
							...
							func_65(&(uLocal_171[0]), &uLocal_15, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INTERESTING_NEW"), 5f, 3600f);
							if (func_39())
							{
								func_66(uLocal_171[0], 1689938120);
							}
							func_67(uLocal_171[0], GET_HASH_KEY("DOCUMENT_GET_RICH_BOOK"), 1, 0);
				...
				case 32:
					...
					if (ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_79()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_189) > 0.95f)
					{
						func_61(34);
					}
					else if ((ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_79()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_189) > 0.65f) && !func_18(iLocal_190, 256))
					{
						...
						if (!func_27(GET_HASH_KEY("DOCUMENT_GET_RICH_BOOK"), 1, 0))
						{
							func_113(GET_HASH_KEY("DOCUMENT_GET_RICH_BOOK"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						func_28(27, 1);
						func_114(27);
				...
				case 33:
					...
					if (ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_115()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_189) > 0.9f)
					{
						ANIMSCENE::RESET_ANIM_SCENE(iLocal_188, func_4());
						func_111(1);
...
{
	PLAYER::_0xC67A4910425F11F1(PLAYER::GET_PLAYER_INDEX(), "TimothyBubble");
	func_118(&(uLocal_171[0]), &uLocal_15, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INTERESTING_NEW"), 5f, 1);
...
void func_17()
{
	...
	if (bLocal_18)
	{
		...
		TASK::TASK_FLEE_PED(uLocal_171[0], Global_35, 3, 0, -1f, -1, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_171[0], 17, true);
		PED::SET_PED_KEEP_TASK(uLocal_171[0], true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_171[0], false);
		IK::_0x0EABF182FBB63D72(uLocal_171[0], 6, 0);
		func_156(iLocal_183);
		func_61(37);
	}
}
...
void func_31()
{
	...
	{
		iLocal_183 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
...
int func_113(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_174(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_174(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_174(iParam0) == GET_HASH_KEY("AMMO") && func_255(iParam0))
		{
...
void func_166(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_358(func_357(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_260(func_357(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
		...
		if (iVar0 > uParam0->f_9)
		{
				...
				if (!HUD::_UIPROMPT_HAS_HOLD_AUTO_FILL_MODE(Global_1945938[uParam0->f_5 /*18*/].f_3))
				{
					...
					if ((fVar2 == 0f || fVar2 < uParam0->f_16) && (fVar3 == 0f || fVar3 < uParam0->f_17))
					{
						...
						if (uParam0->f_12 > 0)
						{
							...
							uParam0->f_5 = func_390(uParam0->f_7, GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 6, 600, iVar1, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 1);
						}
						else
						{
							uParam0->f_5 = func_390(uParam0->f_7, GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 6, 600, 10000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 1);
						}
						func_211(&(uParam0->f_6), 1, 1);
						uParam0->f_6 = func_390(uParam0->f_8, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			...
			else if (!HUD::_UIPROMPT_HAS_HOLD_AUTO_FILL_MODE(Global_1945938[uParam0->f_6 /*18*/].f_3))
			{
				...
				if ((fVar2 == 0f || fVar2 < uParam0->f_16) && (fVar3 == 0f || fVar3 < uParam0->f_17))
				{
					...
					{
						iVar1 = ((uParam0->f_11 + uParam0->f_12) - iVar0 + 20);
						uParam0->f_6 = func_390(uParam0->f_8, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 6, 600, iVar1, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 1);
					}
					else
					{
						uParam0->f_6 = func_390(uParam0->f_8, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 6, 600, 10000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 1);
					}
					func_211(&(uParam0->f_5), 1, 1);
					uParam0->f_5 = func_390(uParam0->f_7, GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					if (uParam0->f_14 < uParam0->f_13)
					{
						func_391(uParam0->f_5, 1);
					}
...
bool func_216(int iParam0, int iParam1)
{
	...
	{
		iVar0 = func_195(iParam0);
		return func_196(iParam0, GET_HASH_KEY("CURRENCY_CASH"), iParam1, iVar0);
	}
...
void func_220(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, char* sParam7, int iParam8)
{
	if (!uParam0->f_3)
	{
		...
		uParam0->f_8 = sParam2;
		uParam0->f_5 = func_390(uParam0->f_7, GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
		uParam0->f_6 = func_390(uParam0->f_8, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
		if (uParam0->f_14 < uParam0->f_13)
		{
			func_391(uParam0->f_5, 1);
		}
...
void func_222(int iParam0)
{
	...
	Var0 = { func_357(GET_HASH_KEY("CAREER_CASH")) };
...
void func_223(int iParam0, char* sParam1, int iParam2)
{
	...
	func_394(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 1, GET_HASH_KEY("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_421(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_421(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_254(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_403(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_39())
				{
					return false;
				}
...
bool func_256(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_27(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_257(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_441()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_264()
{
	if (((((func_450(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_450(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_450(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_450(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_450(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_450(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_266(int iParam0)
{
	switch (iParam0)
	{
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_240(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_458(1), 0, -1, 0);
			func_459(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_240(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_458(2), 0, -1, 0);
			func_459(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_240(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_458(4), 0, -1, 0);
			func_459(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_240(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_458(8), 0, -1, 0);
			func_459(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_240(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_458(16), 0, -1, 0);
			func_459(16);
			break;
	}
}
...
void func_269(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_233(437, 0);
			func_233(440, 0);
			func_462(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_240(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_242(51, 0, 0, sVar0, func_413(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_454(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_462(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_240(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_242(51, 0, 0, sVar0, func_413(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_454(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_462(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_240(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_242(51, 0, 0, sVar0, func_413(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_454(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_462(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_240(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_242(51, 0, 0, sVar0, func_413(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_454(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_233(438, 0);
			func_462(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_240(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_242(51, 0, 0, sVar0, func_413(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_454(32768);
			break;
		default:
			func_233(439, 0);
...
void func_271(int iParam0, int iParam1)
{
	...
	if (func_184() == -1)
	{
		...
		{
			func_464(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_465() == 0)
			{
				func_310(0, 10);
		...
		{
			func_464(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_465() == 1)
			{
				func_310(0, 10);
		...
		{
			func_464(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_465() == 2)
			{
				func_310(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_469(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_470(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_407(48);
					}
					if (func_467(iParam0) < func_468(iParam0))
					{
		...
		{
			func_464(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_465() == 3)
			{
				func_310(0, 10);
		...
		{
			func_464(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_465() == 4)
			{
				func_310(0, 10);
...
void func_275(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_310(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_475(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_476(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_477(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_285(int iParam0, bool bParam1)
{
	...
	func_421(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_299(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_495(81053684, 0) <= 0)
			{
	...
	{
		if (!func_502(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
...
int func_301(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_504(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_302(int iParam0)
{
	...
	if (func_243(iParam0, -305066475))
	{
		if (func_184() == -1)
		{
			...
			{
				return func_357(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_357(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_243(iParam0, -537818634))
	{
		return func_357(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_243(iParam0, 2084895747))
	{
		return func_357(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_304(int iParam0, char* sParam1)
{
	...
	func_394(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_508(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_305(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	sVar15 = func_513(MISC::VAR_STRING(10, &cVar2, MISC::VAR_STRING(0, func_292(iParam0)), iVar1), iVar12);
...
int func_368(int iParam0, bool bParam1)
{
	...
	if (!func_592(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_367(iVar14);
...
void func_378(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_596(iParam1))
		{
			func_66(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
{
	return func_174(iParam0) == GET_HASH_KEY("WEAPON");
}
...
void func_397(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_174(iParam0) != GET_HASH_KEY("WEAPON"))
	{
		return;
	}
	iVar0 = func_249(iParam0, 0);
...
bool func_403(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_395(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		...
		else if (!func_615(iParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	...
	if (bParam3 || !func_613(iParam0))
	{
		iVar28 = func_616(iParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
...
void func_407(int iParam0)
{
	...
	func_394(MISC::VAR_STRING(6, func_622(iParam0), fVar1), "itemtype_textures", func_623(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_409(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_492(iParam0, 1)) || func_627(32768))
	{
...
bool func_418(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			{
				bVar1 = (func_27(iVar2, 1, 0) || func_637(func_636(iVar2)));
			}
			if (iParam5 == 8)
			{
				bVar1 = true;
		...
		{
			iVar2 = func_471(iParam3, func_639(iVar0));
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			else if (bParam9)
			{
				if (iParam4 == iVar2)
				{
					bVar1 = (func_467(iVar2) - iParam7) >= func_413(iParam3, func_640(iVar0));
				}
				else
				{
					bVar1 = func_467(iVar2) >= func_413(iParam3, func_640(iVar0));
				}
			}
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_641(iVar2)), func_641(iVar2), bVar1, true, false);
		}
		if (iParam2 == 1995362678)
		{
			if (func_642(COLLECTION::_0x126CBEBBA46693CF(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_643(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_643(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
		...
		if (iParam2 == GET_HASH_KEY("TAXIDERMY"))
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_646(iVar2)), func_646(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
void func_427(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_423("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_423("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_423("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_423("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_184() == -1)
			{
				if (!func_502(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_656(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_39())
					{
					...
					func_277(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
{
	return func_616(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
struct<4> func_433(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_369(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_442(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_174(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_184() != -1;
	...
	if (func_243(iParam1, 866047851))
	{
		...
		if (func_664(&(Global_1946804.f_1497)) >= 2 && Global_1946804.f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
	...
	switch (iVar4)
	{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar10 = func_666(iVar8, iVar4, iVar2, bVar1);
				iVar9 = func_666(Global_1946804.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_667(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_451(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_27(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_452(int iParam0, char* sParam1, int iParam2)
{
	...
	func_394(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_453(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_394(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_394(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_260(func_357(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_460()
{
	...
	while (iVar1 < 30)
	{
		if (func_674(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_462(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if (iParam0 == GET_HASH_KEY("TAXIDERMY_ORDER_02"))
	{
		...
		if (func_645(iVar0) && func_645(iVar1))
		{
			return true;
		}
	}
	else if (iParam0 == GET_HASH_KEY("TAXIDERMY_ORDER_03"))
	{
		...
		if ((func_645(iVar0) && func_645(iVar1)) && func_645(iVar2))
		{
			return true;
		}
	}
	else
	{
		...
		if (((func_645(iVar0) && func_645(iVar1)) && func_645(iVar2)) && func_645(iVar3))
		{
			return true;
		}
	}
...
int func_465()
{
	...
	while (iVar1 < 5)
	{
		if (func_680(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_481(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_243(iParam0, 866047851) && func_664(&(Global_1946804.f_1378)) >= 2)
	{
		return false;
	}
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_691(iParam0, iParam2, iParam1, func_184() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_693(func_684(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_485()
{
	func_697(&(Global_1946804.f_2776));
	func_698(32768);
	func_693(1108822547, 8, 6);
}
...
void func_498(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_721(MISC::VAR_STRING(10, "OUT_JOURN_DONE", MISC::VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_722(iParam0, 6);
	if (bParam2)
	{
...
int func_508(int iParam0)
{
	...
	if (!func_728(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
bool func_530(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_548(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_546(int iParam0, int iParam1)
{
	...
	if (func_741(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
bool func_564(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_313(iParam4, 268435456))
			{
				iVar8 = func_748(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
{
	return func_433(GET_HASH_KEY("CHARACTER"), func_773(), -1591664384, bParam0);
}
...
{
	if (func_774(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_616(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
void func_621(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_777(iParam0) && func_778(iParam0))
	{
		if (!bParam2)
		{
			...
			if (fParam1 > IntToFloat(func_780(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
...
int func_631()
{
	...
	while (iVar1 < 12)
	{
		...
		if (func_27(iVar2, 1, 0) || func_637(func_636(iVar2)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_633()
{
	...
	while (iVar1 < 14)
	{
		if (func_642(COLLECTION::_0x126CBEBBA46693CF(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_787(iParam0) && func_27(iParam0, 1, 0))
	{
		return true;
	}
	else if (func_788(iParam0) && func_789(iParam0))
	{
		return true;
	}
	return false;
...
char* func_646(int iParam0)
{
	...
	return HUD::GET_STRING_FROM_HASH_KEY(func_292(iParam0));
}
...
void func_657()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_250(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_298(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_250(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_298(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_673(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_671())
	{
		func_394(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_394(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_803(&(Global_1946804.f_2589), iParam0);
}

void func_688(int iParam0, int iParam1)
{
	func_804(&(Global_1946804.f_2589), iParam0, iParam1);
}
...
void func_690(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_805(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	if (func_502(-1586649372) && func_805(iParam2, 524288))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_667(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_247(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_667(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_243(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
int func_691(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_809(iParam0, func_684(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_692(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_810(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
				iVar4 = func_666(uParam0->f_1[iVar0 /*3*/], iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_694(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_184() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_813(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_717(0))
		{
...
bool func_720(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_411(iVar0) && func_825(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
var func_721(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar15;
...
{
	func_504(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_504(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_504(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}

void func_727(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
void func_782(int iParam0, int iParam1, int iParam2)
{
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_860(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_421(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_861(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_789(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_862(&iVar0, 0, iVar95, &Var1) && !func_862(&iVar0, 1, iVar95, &Var1))
		{
		}
...
void func_790()
{
	...
	func_865(0);
	func_866(7);
	func_867(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_499() == 1160113249)
	{
		func_867(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_867(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
void func_801(int iParam0)
{
	...
	Var0 = { func_357(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_812(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_184() == -1)
	{
		func_880(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_881(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_882(&(Global_1946804.f_1378), iParam0);
...
void func_830()
{
	...
	func_298(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_620(1);
	func_782(1, iVar0, 0);
}
...
void func_832()
{
	...
	func_298(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_620(2);
	func_782(2, iVar0, 0);
}
...
void func_833()
{
	...
	func_298(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_620(0);
	func_782(0, iVar0, 0);
}
...
void func_837(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_210(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_761(iParam1))
		{
			...
			iParam1->f_6 = func_892(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_210(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_854(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_369(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_369(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_369(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}

struct<4> func_855(int iParam0, int iParam1)
{
	char cVar0[32];
...
void func_866(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		{
			func_904(&(Global_1946804.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_905(iVar2, 0))
		{
			func_906(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_867(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_908(iParam0, &(Global_1946804.f_2657.f_21), Global_1946804.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_908(iParam0, &(Global_1946804.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_908(iParam0, &(Global_1946804.f_2657.f_20), Global_1946804.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_908(iParam0, &(Global_1946804.f_2657.f_22), Global_1946804.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_908(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_908(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_909(0))
	{
		func_910(iParam0, 1);
		if (func_499() == 1160113249)
		{
			func_910(func_909(-2125499975), 0);
		}
		else
		{
			func_910(func_909(1160113249), 0);
		}
	}
	func_911();
	if (func_912(iVar0))
...
int func_892(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
...
void func_902(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_927(iParam0, &(Global_1946804.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_927(iParam0, &(Global_1946804.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_927(iParam0, &(Global_1946804.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_927(iParam0, &(Global_1946804.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_927(iParam0, &(Global_1946804.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_927(iParam0, &(Global_1946804.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_904(var uParam0, int iParam1, int iParam2)
{
	...
	func_929(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
bool func_905(int iParam0, int iParam1)
{
	...
	Var5 = { func_433(iParam0, Var0, Var0.f_4, 0) };
	if (func_616(iParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return false;
	}
...
int func_908(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	...
	if (func_930(iVar1, &uVar0))
	{
		return 0;
	}
	if (bParam3 && !func_905(iParam0, 0))
	{
		return 0;
	}
	...
	{
		func_904(&(Global_1946804.f_2657.f_26.f_26), iParam0, Global_1946804.f_2657.f_19);
	}
...
int func_927(int iParam0, var uParam1)
{
	...
	if (Global_1946804.f_2657.f_19 == 1)
	{
		...
		*uParam1 = 0;
		if (func_247(iParam0) != -999503751)
		{
			func_933(&(Global_1946804.f_2657.f_26), 0, Global_1946804.f_2657.f_19);
		}
	...
	*uParam1 = (*uParam1 - 1);
	...
	if (func_247(iParam0) != -999503751)
	{
		func_933(&(Global_1946804.f_2657.f_26), iVar0, Global_1946804.f_2657.f_19);
	}
	func_905(iParam0, 1);
	return 1;
}
...
void func_929(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (iParam2 == -1)
	{
		uParam0->f_1 = func_480(func_663(iParam1), 1);
		if (uParam0->f_1 == -1)
		{
		}
	}
