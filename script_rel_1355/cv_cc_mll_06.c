...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_151(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_CAMP_CUP_01X"), 0f, 0f, 0f, "CUP", 0, 1, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_MLLCNV6"), GET_HASH_KEY("PLAYER_MLLCNV6"));
	func_155(uParam0, iLocal_16, -1, 0.88f);
	func_156(uParam0, iLocal_14, 2, 4, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, 180);
	func_158(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
