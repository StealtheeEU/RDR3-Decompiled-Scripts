...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.1875f, 0.1875f, 1f, 0f, 1.5f, 2f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 0, 1);
