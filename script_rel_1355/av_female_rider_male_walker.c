...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_51 = func_1(GET_HASH_KEY("HORSE_CLASS_RIDING"), 1);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar1 = func_1(GET_HASH_KEY("HORSE_CLASS_RACE"), 1);
	if (*uParam0 == 62)
	{
	...
	{
		iLocal_53 = func_50(func_49(), 1, 1, 0, 1, 0, 1);
		iLocal_52 = GET_HASH_KEY("A_C_DOGCOLLIE_01");
		iLocal_51 = func_1(GET_HASH_KEY("HORSE_CLASS_RIDING"), 1);
		uParam0->f_19 = 4;
	}
	else
	...
	if (*uParam0 == 42)
	{
		func_52(uParam0, 0, "FRMWP_LEADER", iLocal_53, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
		func_52(uParam0, 1, "FRMWP_FOLLOWER", iLocal_52, vParam1, fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	}
	else
	{
		func_52(uParam0, 0, "FRMWP_LEADER", iLocal_53, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, fVar0, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
		func_52(uParam0, 1, "FRMWP_FOLLOWER", iLocal_52, vParam1, fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	}
	if (*uParam0 == 42)
	{
		func_52(uParam0, 2, "FRMWP_HORSE_FOLLOW", iLocal_51, vParam1, fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	}
	else if (*uParam0 == 62)
	{
		func_52(uParam0, 2, "FRMWP_HORSE_FOLLOW", iVar1, vParam1, fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
		func_52(uParam0, 3, "FRMWP_HORSE_LEAD", iLocal_51, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, fVar0, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	}
	else if (*uParam0 == 56)
	{
		func_52(uParam0, 3, "FRMWP_HORSE_LEAD", iLocal_51, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, fVar0, -2f, 0f, 0f), fVar0, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN"), 500, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				if (*uParam0 == 42)
				{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (*uParam0 != 56)
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN"), 500, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				...
				if (*uParam0 == 62)
				{
					TASK::TASK_MOVE_BE_IN_FORMATION(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 2.5f, 0f, 0f, -1082130432 /* Float: -1f */, 0);
				}
				else if (*uParam0 == 63)
				{
				...
				{
					TASK::TASK_MOVE_BE_IN_FORMATION(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 2f, 0f, 0f, -1082130432 /* Float: -1f */, 1);
				}
...
int func_51(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	iVar0 = GET_HASH_KEY("A_F_M_ROUGHTRAVELLERS_01");
	if (bParam3)
	{
		switch (iParam0)
		{
			case 0:
			case 2:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_ROUGHTRAVELLERS_01");
				iVar5++;
				break;
			case 1:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_ROUGHTRAVELLERS_01");
	...
	if (bParam2)
	{
		switch (iParam0)
		{
			case 0:
			case 2:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_BYNFANCYTRAVELLERS_01");
				iVar5++;
				break;
			case 1:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_BIVFANCYTRAVELLERS_01");
				iVar5++;
				break;
			case 3:
			case 4:
			case 9:
			case 12:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_HTLFANCYTRAVELLERS_01");
				iVar5++;
				break;
			case 6:
			case 7:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_GRIFANCYTRAVELLERS_01");
				iVar5++;
				break;
			case 10:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_RKRFANCYTRAVELLERS_01");
				iVar5++;
				break;
			case 11:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_SCLFANCYTRAVELLERS_01");
				iVar5++;
				break;
		}
	}
	if (bParam1)
	{
		switch (iParam0)
		{
			...
			case 7:
			case 12:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_FAMILYTRAVELERS_COOL_01");
				iVar5++;
				break;
			default:
				iVar1[iVar5] = GET_HASH_KEY("A_F_M_FAMILYTRAVELERS_WARM_01");
				iVar5++;
				break;
		}
	}
...
bool func_207(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_224(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_222(int iParam0, int iParam1)
{
	...
	if (func_254(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
