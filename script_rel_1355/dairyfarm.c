...
bool func_11()
{
	...
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 1446.658f, -888.688f, 61.14607f, 0f, 0f, -30.46523f, 38.831f, 28.399f, 35.021f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 1407.375f, -859.71f, 59.085f, 0f, 0f, -90.621f, 63.166f, 105.945f, 86.732f);
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Dairy Farm - m_volThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1372.365f, -874.1071f, 60.63414f, 0f, 0f, 105.3542f, 13.90285f, 14.67721f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1379.527f, -839.9418f, 70.09288f, 0f, 0f, 28.55685f, 26.50747f, 16.5324f, 20.06959f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1389.031f, -831.3408f, 67.95767f, 0f, 0f, 17.35302f, 5.587527f, 9.447437f, 11.73771f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1366.106f, -845.9993f, 67.95767f, 0f, 0f, 17.35302f, 4.930151f, 14.78831f, 11.73771f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1368.879f, -851.3331f, 70.96919f, 0f, 0f, 0f, 3.971671f, 2.768736f, 7.919377f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1448.137f, -909.5335f, 58.70924f, 0f, 0f, 52.91796f, 9.811359f, 48.19019f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1464.168f, -883.314f, 59.08516f, 0f, 0f, 106.2223f, 38.17617f, 16.57248f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1451.656f, -880.889f, 59.08516f, 0f, 0f, 0f, 30.79945f, 37.44294f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1459.521f, -904.4871f, 58.70924f, 0f, 0f, 75.93813f, 23.5689f, 29.93386f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1414.417f, -868.4174f, 60.63414f, 0f, 0f, -160.2662f, 13.42301f, 10.60738f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1406.751f, -874.8239f, 60.63414f, 0f, 0f, 100.2132f, 11.28151f, 7.901964f, 37.7322f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1427.325f, -884.8317f, 49.45563f, 0f, 0f, 1.967795f, 16.6387f, 14.40915f, 35.02085f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1426.821f, -870.1688f, 49.45563f, 0f, 0f, 1.967794f, 16.6387f, 8.68586f, 35.02085f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1446.194f, -836.771f, 59.08516f, 0f, 0f, -74.26128f, 27.16599f, 24.853f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1428.484f, -833.5745f, 59.08516f, 0f, 0f, -90.62106f, 27.16599f, 39.94446f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1450.635f, -849.8392f, 59.08516f, 0f, 0f, -87.62164f, 4.481297f, 24.853f, 37.7322f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1423.217f, -846.8712f, 59.08516f, 0f, 0f, -90.62106f, 10.00643f, 39.94446f, 37.7322f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1408.666f, -831.0827f, 49.45563f, 0f, 0f, 1.967795f, 9.140027f, 9.551268f, 35.02085f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1405.983f, -843.9208f, 70.19928f, 0f, 0f, 0f, 5.74873f, 11.05348f, 20.80677f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 1374.823f, -866.7698f, 49.45563f, 0f, 0f, -89.62331f, 28.03277f, 26.98123f, 35.02085f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1445.876f, -840.8851f, 61.14609f, 0f, 0f, -94.3453f, 25.51381f, 23.81601f, 17.87893f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1461.857f, -868.7903f, 61.14607f, 0f, 0f, -82.23228f, 39.60072f, 15.04517f, 35.021f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1458.823f, -903.0386f, 61.14607f, 0f, 0f, -94.3453f, 29.6741f, 23.81601f, 35.021f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1410.49f, -862.8301f, 61.14607f, 0f, 0f, -84.98452f, 45.42525f, 64.49104f, 35.021f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1446.658f, -888.688f, 61.14607f, 0f, 0f, -30.46523f, 38.831f, 28.399f, 35.021f);
...
void func_14(int iParam0)
{
	...
	if (func_20() == -1)
	{
		func_46(&uLocal_19, 936, 0, "", GET_HASH_KEY("WAGONDAIRY01X"), 1363.079f, -834.7169f, 70.945f, 114.51f, GET_HASH_KEY("PG_DELIVERY_DAIRY01X"), 0);
		func_46(&uLocal_39, 937, 2, "", GET_HASH_KEY("WAGONDAIRY01X"), 1398.492f, -851.074f, 65.6284f, -171.36f, GET_HASH_KEY("PG_DELIVERY_DAIRY01X"), 0);
	}
}
...
void func_51()
{
	ENTITY::CREATE_MODEL_HIDE(1399.447f, -844.6359f, 64.8634f, 5f, GET_HASH_KEY("P_RUSSLINGGATELOCK02X"), true);
	ENTITY::CREATE_MODEL_HIDE(1399.883f, -847.0065f, 65.6747f, 1f, GET_HASH_KEY("P_CS_CHAINLINK01X"), true);
}
...
void func_57()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(GET_HASH_KEY("DAI_RANCHER"));
	iVar1 = PERSCHAR::_0x112DDF56300BC6E5(GET_HASH_KEY("DAI_RANCH_HAND"));
	iVar2 = 936;
	iVar3 = 937;
	iVar4 = func_93(iVar2);
	iVar5 = func_93(iVar3);
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar0) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
			return;
		}
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar1) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
		}
		else if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar1) && !TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
		{
...
void func_65(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_120(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_120(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_120(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_120(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_67(int iParam0, bool bParam1)
{
	...
	func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_126(func_125(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_136()
{
	ENTITY::REMOVE_MODEL_HIDE(1399.447f, -844.6359f, 64.8634f, 5f, GET_HASH_KEY("P_RUSSLINGGATELOCK02X"), 0);
	ENTITY::REMOVE_MODEL_HIDE(1399.883f, -847.0065f, 65.6747f, 1f, GET_HASH_KEY("P_CS_CHAINLINK01X"), 0);
}
