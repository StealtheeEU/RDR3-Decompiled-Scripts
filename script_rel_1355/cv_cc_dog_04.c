...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 0, 1);
	func_153(uParam0, 5.3689f, 1.39f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_153(uParam0, -1.2936f, 1.19f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_154(uParam0, -0.311109f, 1.6829f, 1.13478f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_ANIMAL_DOG_RESTING"), "WORLD_ANIMAL_DOG_RESTING", -1, 1);
	func_159(uParam0, iLocal_14, 1);
	func_160(uParam0, iLocal_14, 0, 0, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	func_161(uParam0, iLocal_15, 1, -1);
	func_162(uParam0, GET_HASH_KEY("COMP_DOGCNV4"), GET_HASH_KEY("PLAYER_DOGCNV4"));
