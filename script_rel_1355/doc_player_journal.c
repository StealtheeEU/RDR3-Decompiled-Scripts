...
void func_67(var uParam0, int iParam1)
{
	...
	while (iVar2 < 16)
	{
		...
		uVar11 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, &cVar3);
		...
		StringIntConCat(&cVar3, iVar2, 64);
		uVar11 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, &cVar3);
		uParam0->f_635[iVar2] = DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar11, "isVisible", false);
		iVar2++;
	}
}
...
void func_98(var uParam0, int iParam1)
{
	...
	while (iVar6 < 20)
	{
		...
		uVar8 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, &cVar0);
...
{
	*uParam0 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(uParam1, "Visible", false);
...
void func_123(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 < 5)
	{
		...
		uVar4 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, &cVar1);
