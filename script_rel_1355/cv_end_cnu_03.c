...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_AXE01X"), 0f, 0f, 0f, "AXE", 0, 0, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_SHARPENINGSTONE01X"), 0f, 0f, 0f, "STONE", 0, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "CRATE", 0, 0, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.434831f, 1.30266f, -0.00206757f, 0, 1, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BCCNUCNV3"), GET_HASH_KEY("PLAYER_BCCNUCNV3"));
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SHARPEN_AXE"), "PROP_HUMAN_SEAT_CHAIR_SHARPEN_AXE_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_C", iLocal_20, 0);
	func_156(uParam0, iLocal_15, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_C", iLocal_20, 0, 15f, 1065353216 /* Float: 1f */, 1);
