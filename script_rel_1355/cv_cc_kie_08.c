...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.1503f, -0.2019f, 0.9451f, 0f, 1.5f, 1.5f, 2f, GET_HASH_KEY("VOLCYLINDER"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CS_ROPE03BX"), 0f, 0f, 0f, "ROPE", 0, 1, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_400(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
