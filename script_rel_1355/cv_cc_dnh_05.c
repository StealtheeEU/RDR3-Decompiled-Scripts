...
bool func_72(var uParam0)
{
	...
	{
		func_154(uParam0, 8.88f, 3.18f, 1.2f, 7.068f, 1.5f, 1.5f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
		func_154(uParam0, 0.6f, -0.8f, 1f, 2f, 1.75f, 2.5f, 2f, GET_HASH_KEY("VOLBOX"), 2076113919, 1, 1, 1);
		func_155(uParam0, 0.625f, -0.0377f, 1.15f, 38.56f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 1);
	}
	iLocal_17 = func_156(uParam0, GET_HASH_KEY("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 0, 1);
	func_156(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.20486f, -1.61288f, 0.00105286f, "CHAIR", 1, 0, 1);
	iLocal_16 = func_156(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	if (!func_151(14))
	{
	...
	func_159(uParam0, GET_HASH_KEY("COMP_DNHCNV5"), GET_HASH_KEY("PLAYER_DNHCNV5"));
	func_160(uParam0, iLocal_24, -1, 0.81f);
	func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_162(uParam0, iLocal_14, 1, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_163(uParam0, iLocal_14, iLocal_17, "p_cigar02x_PH_R_HAND", 0, 0);
	func_164(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_16, 0);
	func_162(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_400(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
{
	return func_489(GET_HASH_KEY("CHARACTER"), func_511(), -1591664384, bParam0);
}
