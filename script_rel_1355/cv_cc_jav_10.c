...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -11.581f, 7.1445f, 0f, -68.75f, 1.0625f, 1.0275f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 1.1315f, -1.743f, 0f, -56f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, -0.4685f, 1.932f, 0f, -56f, 1.0625f, 1.0275f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_BRUSHDISH01X"), 0f, 0f, 0f, "BRUSH", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.19747f, -1.86925f, -0.0285034f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -11.5514f, 7.15822f, 0.346359f, 0, 1, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_BENCH_LOG07X"), -1.35271f, 1.61457f, -0.0227356f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0);
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 0f, 1);
	func_155(uParam0, iLocal_15, 2, 4, 0, 0, 0);
	func_156(uParam0, iLocal_15, 1);
	func_153(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS"), "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0);
	func_154(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS"), "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_16, iLocal_20, "p_cs_rag02x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_16, 1, 1, 0, 0, 0);
	func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0);
	func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 0f, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_444(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_461(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_473(GET_HASH_KEY("CHARACTER"), func_495(), -1591664384, bParam0);
}
