...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, 1.95f, 0f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_STOOL02X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_BUCKET01X"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BCJCKCNV5"), GET_HASH_KEY("PLAYER_BCJCKCNV5"));
	func_156(uParam0, iLocal_15, -1, 0.88f);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_17, 2, GET_HASH_KEY("STAND"), 0, -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, "BJCK5AU");
	iLocal_18 = func_160(uParam0, 0f, 5f, 0f, 0f, 0f, 0f, 8f, 7f, 5f, "volTrigger", GET_HASH_KEY("VOLBOX"));
	func_161(uParam0, 1);
