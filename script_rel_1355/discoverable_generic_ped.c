	...
	switch (Local_51)
	{
		...
		case 10:
						...
						if (func_33(iLocal_48[0]))
						{
							...
							if (func_78(iLocal_48[0], 1))
							{
								...
								if (func_16(59))
								{
									...
									{
										iLocal_47 = CAM::CREATE_CAMERA_WITH_PARAMS(GET_HASH_KEY("DEFAULT_SCRIPTED_CAMERA"), 895.2926f, -1968.114f, 45.0332f, 0f, 0f, 0f, 65f, false, 2);
			...
			else if (*uParam0 == -35775921)
			{
				...
				else if (ENTITY::_IS_ENTITY_FULLY_LOOTED(Local_63.f_1[0]))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_157[0]))
					{
						ENTITY::DETACH_ENTITY(Local_157[0], true, true);
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_53(*uParam0))
			{
				uParam0->f_6.f_8 = func_102("DISCO_FOCUS", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_102("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_102("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		else if (*uParam0 == -415839138)
		{
		...
		{
			uParam0->f_6.f_8 = func_102("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
		}
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_115() == (5 - 1))
				{
					if (func_111())
					{
						func_114(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR"), 0);
						iVar0 = GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR");
					}
					else
					{
						func_114(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_JN"), 0);
...
bool func_59(var uParam0)
{
	...
	if ((*uParam0 == 1861313914 || *uParam0 == -415839138) || *uParam0 == -35775921)
	{
		...
		while (iVar0 <= (10 - 1))
		{
			if (!ENTITY::IS_ENTITY_DEAD(Local_63.f_1[iVar0]))
			{
				if (!PED::IS_PED_READY_TO_RENDER(Local_63.f_1[iVar0]))
				{
					return false;
				}
			}
	...
	else if (*uParam0 == -2008558277)
	{
		...
		while (iVar0 <= (10 - 1))
		{
			if (!ENTITY::IS_ENTITY_DEAD(Local_63.f_1[iVar0]))
			{
				...
				PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_63.f_1[iVar0]);
			}
			iVar0++;
		}
	}
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uLocal_31[0]) && ANIMSCENE::IS_ANIM_SCENE_LOADED(uLocal_31[0], true, false))
				{
					if (ANIMSCENE::_0xA9016536015DE29D(uLocal_31[0], &cLocal_25) && ANIMSCENE::_0x1F0E401031E20146(uLocal_31[0], &cLocal_25))
					{
						if (!iLocal_14[3])
						{
							...
							{
								iLocal_14[3] = 1;
								iLocal_36 = EVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(GET_HASH_KEY("EVENT_SHOCKING_SEEN_MELEE_ACTION"), Local_63.f_1[0], -1f, -1f, -1f, -1f, -1f, 180f, false, false, -1, -1);
							}
						}
	...
	if (!ENTITY::IS_ENTITY_DEAD(Local_63.f_1[0]))
	{
		...
		switch (Local_87[0 /*4*/])
		{
			...
			case 13:
				...
				{
					MISC::REGISTER_INTERACTION_LOCKON_PROMPT(Local_63.f_1[0], "", 6f, 0f, 0, 0f, 0f, 0, false, -1);
					if (iLocal_38 == 0)
					{
						func_174(&(uLocal_31[0]), "pbl_ba_lvl_2_l");
						func_174(&(uLocal_31[0]), "pbl_ba_lvl_2_r");
			...
			switch (Local_87[iVar0 /*4*/])
			{
				case 0:
					...
					if (*uParam0 == -654238687 || *uParam0 == -35775921)
					{
						...
						if (VOLUME::DOES_VOLUME_EXIST(iLocal_42))
						{
							TASK::TASK_WANDER_IN_VOLUME(Local_63.f_1[iVar0], iLocal_42, 3f, 6f, 0);
						}
				...
				case 1:
					if (func_72(Global_35, func_131(uParam0, 0), 90f, 1, 1))
					{
						...
						else
						{
							...
							TASK::TASK_USE_SCENARIO_POINT(0, iLocal_45, func_187(uParam0), -1, true, false, func_156(uParam0, 0), false, -1f, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_44);
						...
						if (*uParam0 == -2008558277)
						{
							if (!PED::IS_PED_USING_ANY_SCENARIO(Local_63.f_1[iVar0]))
							{
								...
								if (!iLocal_14[2])
								{
									...
									if (iVar0 == 5 || iVar0 == 6)
									{
										iLocal_36 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(GET_HASH_KEY("EVENT_SHOCKING_BEAT_ALARMING_NEW"), func_188(0), -1f, -1f, -1f, -1f, -1f, 3, 1);
									}
									else
									{
										iLocal_36 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(GET_HASH_KEY("EVENT_SHOCKING_BEAT_ALARMING_NEW"), func_188(1), -1f, -1f, -1f, -1f, -1f, 3, 1);
									}
...
void func_66(int iParam0)
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_192(iParam0))
		{
			func_194(func_193(GET_HASH_KEY("DISCOVERABLE_FOUND")), 1);
		}
	}
}
...
int func_83(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_221(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_221(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_221(iParam0) == GET_HASH_KEY("AMMO") && func_234(iParam0))
		{
		...
		{
			func_194(func_238(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_194(func_239(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_222(iParam0, 589988438))
		{
			if (func_241())
			{
				func_242(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_255(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_256(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_255(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_262(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_263(499813453, 0);
				func_264(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_262(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_263(499813453, 0);
				func_264(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_262(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_263(499813453, 0);
				func_264(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_262(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_263(666607663, 0);
				func_265(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_262(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_263(666607663, 0);
				func_265(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_262(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_263(666607663, 0);
				func_265(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_262(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_263(-220219788, 0);
				func_266(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_262(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_263(-220219788, 0);
				func_266(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_262(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_263(-220219788, 0);
				func_266(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_262(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_263(218622660, 0);
				func_267(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_262(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_263(218622660, 0);
				func_267(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_262(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_263(390004462, 0);
				func_268(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_262(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_263(390004462, 0);
				func_268(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_262(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_263(390004462, 0);
				func_268(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_262(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_263(6410548, 0);
				func_269(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_262(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_263(6410548, 0);
				func_269(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_262(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_263(6410548, 0);
				func_269(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_262(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_263(6410548, 0);
				func_269(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_271(242, func_270(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_271(240, func_270(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_271(241, func_270(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
...
bool func_116()
{
	...
	if (!func_252(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
void func_125(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_194(func_193(GET_HASH_KEY("HONOR_POSITIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_318(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_318(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_194(func_193(GET_HASH_KEY("HONOR_NEGATIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_318(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_318(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_193(GET_HASH_KEY("HONOR_CURRENT")) };
...
void func_138(var uParam0)
{
	...
	{
		case -654238687:
			Local_63.f_12[0] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[1] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[2] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[3] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[4] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[5] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[6] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[7] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[8] = GET_HASH_KEY("A_C_RAT_01");
			Local_63.f_12[9] = GET_HASH_KEY("A_C_RAT_01");
			Local_157.f_6[0] = GET_HASH_KEY("S_FERTILITYSTATUE01X");
			break;
		case -415839138:
			Local_63.f_12[0] = GET_HASH_KEY("CS_MEDITATINGMONK");
			break;
		case -2008558277:
			Local_63.f_12[0] = GET_HASH_KEY("A_C_BAT_01");
			Local_63.f_12[1] = GET_HASH_KEY("A_C_BAT_01");
			Local_63.f_12[2] = GET_HASH_KEY("A_C_BAT_01");
			Local_63.f_12[3] = GET_HASH_KEY("A_C_BAT_01");
			Local_63.f_12[4] = GET_HASH_KEY("A_C_BAT_01");
			Local_63.f_12[5] = GET_HASH_KEY("A_C_BAT_01");
			Local_63.f_12[6] = GET_HASH_KEY("A_C_BAT_01");
			break;
		case 1861313914:
			Local_63.f_12[0] = GET_HASH_KEY("U_F_Y_BRAITHWAITESSECRET_01");
			break;
		case -35775921:
			Local_63.f_12[0] = GET_HASH_KEY("A_C_SHEEP_01");
			Local_157.f_6[0] = GET_HASH_KEY("S_INV_RING02X");
			break;
		default:
			break;
	}
	...
	if (*uParam0 == 1861313914)
	{
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_41))
		{
			if (!func_33(iLocal_48[0]))
			{
				if (func_16(59))
				{
					iLocal_48[0] = func_334("PEEK_DOOR", GET_HASH_KEY("INPUT_CONTEXT_LT"), iLocal_42, 2, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				}
				else
				{
					iLocal_48[0] = func_334("PEEK_DOOR", GET_HASH_KEY("INPUT_CONTEXT_LT"), iLocal_41, 2, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				}
			}
		}
	}
	else if (*uParam0 == -415839138)
	{
		...
		while (iVar0 <= (2 - 1))
		{
			if (!func_33(iLocal_48[iVar0]))
			{
				if (iVar0 == 0)
				{
					iLocal_48[iVar0] = func_102("INTERACT_GREET", GET_HASH_KEY("INPUT_CONTEXT_X"), Global_35, 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
					func_336(iLocal_48[iVar0], Local_63.f_1[0], func_335(uParam0));
				}
				else if (iVar0 == 1)
				{
					iLocal_48[iVar0] = func_102("INTERACT_INSULT", GET_HASH_KEY("INPUT_CONTEXT_B"), Global_35, 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
					func_336(iLocal_48[iVar0], Local_63.f_1[0], func_335(uParam0));
				}
			}
			iVar0++;
...
void func_220(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_407(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_407(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_235(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_252(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_236(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_428()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_241()
{
	if (((((func_436(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_436(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_436(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_436(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_436(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_436(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_243(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_220(51, 0, 0, 0, 0, -1, 0);
			func_440(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_220(51, 0, 0, 0, 0, -1, 0);
			func_440(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_218(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_444(1), 0, -1, 0);
			func_445(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_218(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_444(2), 0, -1, 0);
			func_445(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_218(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_444(4), 0, -1, 0);
			func_445(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_218(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_444(8), 0, -1, 0);
			func_445(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_218(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_444(16), 0, -1, 0);
			func_445(16);
			break;
	}
}
...
void func_246(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_212(437, 0);
			func_212(440, 0);
			func_448(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_220(51, 0, 0, sVar0, func_399(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_440(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_448(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_220(51, 0, 0, sVar0, func_399(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_440(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_448(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_220(51, 0, 0, sVar0, func_399(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_440(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_448(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_220(51, 0, 0, sVar0, func_399(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_440(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_212(438, 0);
			func_448(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_218(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_220(51, 0, 0, sVar0, func_399(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_440(32768);
			break;
		default:
			func_212(439, 0);
...
void func_248(int iParam0, int iParam1)
{
	...
	if (func_92() == -1)
	{
		...
		{
			func_450(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_451() == 0)
			{
				func_37(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_218(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_450(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_451() == 1)
			{
				func_37(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_453(iParam0) < func_454(iParam0))
					{
						func_218(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_450(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_451() == 2)
			{
				func_37(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_455(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_456(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_394(48);
					}
					if (func_453(iParam0) < func_454(iParam0))
					{
						func_218(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_450(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_451() == 3)
			{
				func_37(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_453(iParam0) < func_454(iParam0))
					{
						func_218(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_450(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_451() == 4)
			{
				func_37(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_453(iParam0) < func_454(iParam0))
					{
						func_218(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_251(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_242(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_242(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_242(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_242(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_242(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_242(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_242(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_242(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_242(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_242(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_242(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_242(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_460())
			{
				func_242(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_242(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_242(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_242(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_242(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_242(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_242(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_242(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_242(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_242(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_242(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_242(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_242(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_242(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_253(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_37(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_462(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_463(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_464(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_263(int iParam0, bool bParam1)
{
	...
	func_407(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_277(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_485(81053684, 0) <= 0)
			{
	...
	{
		if (!func_492(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_255(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_225(24);
		if (func_256(&iVar2, 0))
		{
...
int func_279(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_494(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_280(int iParam0)
{
	...
	if (func_222(iParam0, -305066475))
	{
		if (func_92() == -1)
		{
			...
			{
				return func_193(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_193(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_222(iParam0, -537818634))
	{
		return func_193(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_222(iParam0, 2084895747))
	{
		return func_193(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_282(int iParam0, char* sParam1)
{
	...
	func_318(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_498(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_283(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_502(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_222(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
			...
			if (func_520(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_221(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_309() <= -160;
...
int func_335(var uParam0)
{
	...
	{
		case -415839138:
			return GET_HASH_KEY("DISCO_MONK");
		default:
			break;
	}
	return GET_HASH_KEY("DISCO_UNKNOWN");
}
...
{
	return func_221(iParam0) == GET_HASH_KEY("WEAPON");
}
...
void func_382(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_221(iParam0) != GET_HASH_KEY("WEAPON"))
	{
		return;
	}
	iVar0 = func_228(iParam0, 0);
...
struct<5> func_384(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_221(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_420(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_420(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
int func_391(int iParam0, bool bParam1)
{
	...
	Var0 = { func_580(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_581(&Var0, func_571(0));
	}
	if (!func_582(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_478(iVar14);
...
void func_394(int iParam0)
{
	...
	func_318(MISC::VAR_STRING(6, func_588(iParam0), fVar1), "itemtype_textures", func_589(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_404(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_608(COLLECTION::_0x126CBEBBA46693CF(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_609(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_609(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
...
void func_413(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_409("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_409("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_409("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_409("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_92() == -1)
			{
				if (!func_492(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_623(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_15())
					{
					...
					func_255(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
struct<4> func_420(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_307(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_429(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_221(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_92() != -1;
	...
	switch (iVar4)
	{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_633(Global_1946804.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_634(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_437(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_252(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_438(int iParam0, char* sParam1, int iParam2)
{
	...
	func_318(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_439(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_318(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_318(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_194(func_193(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_446()
{
	...
	while (iVar1 < 30)
	{
		if (func_641(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_451()
{
	...
	while (iVar1 < 5)
	{
		if (func_646(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_468(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_222(iParam0, 866047851) && func_631(&(Global_1946804.f_1378)) >= 2)
	{
		return false;
	}
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_657(iParam0, iParam2, iParam1, func_92() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_659(func_650(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_660(&(Global_1946804.f_2589), bParam0, bParam1, bParam2);
}
...
void func_472()
{
	func_663(&(Global_1946804.f_2776));
	func_664(32768);
...
int func_498(int iParam0)
{
	...
	if (!func_693(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
void func_527(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_699(iParam1))
		{
			func_153(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_540(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_558(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_556(int iParam0, int iParam1)
{
	...
	if (func_712(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
{
	return func_420(GET_HASH_KEY("CHARACTER"), func_713(), -1591664384, bParam0);
}
...
{
	if (func_714(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_579(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
struct<14> func_580(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
void func_581(var uParam0, struct<4> Param1)
{
...
void func_587(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_717(iParam0) && func_718(iParam0))
	{
		if (!bParam2)
		{
			...
			if (fParam1 > IntToFloat(func_720(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
...
int func_598()
{
	...
	while (iVar1 < 30)
	{
		if (func_726(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_599()
{
	...
	while (iVar1 < 14)
	{
		if (func_608(COLLECTION::_0x126CBEBBA46693CF(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_624()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_229(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_276(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_229(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_276(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_640(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_638())
	{
		func_318(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_318(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
void func_656(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_744(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_634(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_226(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_634(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_222(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_660(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_92() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_752(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_683(0))
		{
			if (Global_40.f_7157[Global_40.f_7729 /*3*/] & 512 != 0)
			{
				...
				Global_1946804.f_1497 = func_683(Global_40.f_7729);
				Global_1946804.f_1378 = func_683(Global_40.f_7729);
...
void func_666(struct<4> Param0)
{
	...
	if (func_755(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_755(20))
			{
				return;
			}
			iVar0++;
...
bool func_686(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_321(iVar0) && func_764(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
{
	func_494(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_494(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_494(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}

void func_692(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
void func_722(int iParam0, int iParam1, int iParam2)
{
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_785(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_407(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_786(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_730()
{
	...
	func_790(0);
	func_791(7);
	func_792(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_489() == 1160113249)
	{
		func_792(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_792(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_793(Global_35, &uVar0);
}
...
void func_741(int iParam0)
{
	...
	Var0 = { func_193(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_751(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_92() == -1)
	{
		func_806(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_807(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_769()
{
	...
	func_276(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_586(1);
	func_722(1, iVar0, 0);
}
...
void func_771()
{
	...
	func_276(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_586(2);
	func_722(2, iVar0, 0);
}
...
void func_772()
{
	...
	func_276(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_586(0);
	func_722(0, iVar0, 0);
}
...
int func_779(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_307(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_307(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_307(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}

struct<4> func_780(int iParam0, int iParam1)
{
	char cVar0[32];
...
void func_791(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		{
			func_828(&(Global_1946804.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_829(iVar2, 0))
		{
			func_830(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_792(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_832(iParam0, &(Global_1946804.f_2657.f_21), Global_1946804.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_832(iParam0, &(Global_1946804.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_832(iParam0, &(Global_1946804.f_2657.f_20), Global_1946804.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_832(iParam0, &(Global_1946804.f_2657.f_22), Global_1946804.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_832(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_832(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_833(0))
	{
		...
		if (func_489() == 1160113249)
		{
			func_834(func_833(-2125499975), 0);
		}
		else
		{
			func_834(func_833(1160113249), 0);
		}
	}
	func_835();
	if (func_836(iVar0))
...
bool func_825(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_826(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_851(iParam0, &(Global_1946804.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_851(iParam0, &(Global_1946804.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_851(iParam0, &(Global_1946804.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_851(iParam0, &(Global_1946804.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_851(iParam0, &(Global_1946804.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_851(iParam0, &(Global_1946804.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_827(int iParam0)
{
	...
	Var2.f_8 = -1;
	Var2.f_13 = -1;
	Var2 = { func_580(0, -1591664384, -1591664384, -1591664384, 0, iParam0) };
	if (func_582(&Var2, &iVar0, &iVar1, 0))
	{
		if (iVar1 > 0)
		{
			switch (iParam0)
...
bool func_829(int iParam0, int iParam1)
{
	...
	Var5 = { func_420(iParam0, Var0, Var0.f_4, 0) };
	if (func_579(iParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return false;
	}
...
int func_832(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		func_828(&(Global_1946804.f_2657.f_26.f_26), iParam0, Global_1946804.f_2657.f_19);
	}
...
int func_851(int iParam0, var uParam1)
{
	...
	if (Global_1946804.f_2657.f_19 == 1)
	{
		...
		*uParam1 = 0;
		if (func_226(iParam0) != -999503751)
		{
			func_857(&(Global_1946804.f_2657.f_26), 0, Global_1946804.f_2657.f_19);
		}
	...
	*uParam1 = (*uParam1 - 1);
	...
	if (func_226(iParam0) != -999503751)
	{
		func_857(&(Global_1946804.f_2657.f_26), iVar0, Global_1946804.f_2657.f_19);
	}
	func_829(iParam0, 1);
	return 1;
}
