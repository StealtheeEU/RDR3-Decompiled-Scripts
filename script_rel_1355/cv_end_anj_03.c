...
bool func_75(var uParam0)
{
	...
	func_155(uParam0, 36.4401f, -18.1472f, -0.0375f, -33.25f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_155(uParam0, 34.2901f, -18.2597f, -0.0375f, -33.25f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, 32.8901f, -19.1347f, -0.0375f, -31.75f, 2.59f, 1.0825f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	iLocal_18 = func_156(uParam0, GET_HASH_KEY("P_CS_KNITTING01X"), 3f, 3f, 0f, "Knitting", 0, 0, 1);
	func_156(uParam0, GET_HASH_KEY("P_CS_BOOK03X"), 1.17084f, -0.0235534f, 0.7491f, "BOOK", 0, 0, 1);
	...
	func_159(uParam0, GET_HASH_KEY("COMP_BCANJCNV3"), GET_HASH_KEY("PLAYER_BCANJCNV3"));
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0);
	func_161(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 2f, 1);
	...
	func_161(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640f, 1065353216 /* Float: 1f */, 1);
...
{
	uLocal_20 = STREAMING::_0xB223249B7798EEED(func_51(uParam0, iLocal_15), GET_HASH_KEY("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), 17, GET_HASH_KEY("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A"));
	return true;
}
