	...
	switch (Local_14)
	{
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(Global_35))
			{
				...
				{
					if (VOLUME::DOES_VOLUME_EXIST(Local_14.f_4[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_14.f_4[0], true, 0))
					{
						func_68(*uParam0);
					}
				}
...
void func_68(int iParam0)
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_132(iParam0))
		{
			func_134(func_133(GET_HASH_KEY("DISCOVERABLE_FOUND")), 1);
		}
	}
}
...
int func_91(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_157(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_158(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_107()
{
	...
	if (!func_162(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
void func_116(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_134(func_133(GET_HASH_KEY("HONOR_POSITIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_134(func_133(GET_HASH_KEY("HONOR_NEGATIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_175(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_133(GET_HASH_KEY("HONOR_CURRENT")) };
...
int func_135()
{
	return GET_HASH_KEY("CS_MYSTERIOUSSTRANGER");
}
			...
			if (func_212(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_203(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_166() <= -160;
...
void func_220(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_234(iParam1))
		{
			func_235(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_231(int iParam0, bool bParam1)
{
	...
	if (!func_245(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_230(iVar14);
...
{
	return func_253(GET_HASH_KEY("CHARACTER"), func_254(), -1591664384, bParam0);
}
...
struct<4> func_253(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_164(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
