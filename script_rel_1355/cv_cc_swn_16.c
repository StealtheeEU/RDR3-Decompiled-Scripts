...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -3.615f, -1.3125f, 0f, -164.45f, 4.3f, 1.4f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, -7.5311f, -5.3054f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_SWNCNV16"), GET_HASH_KEY("PLAYER_SWNCNV16"));
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_158(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_BACK_EXHAUSTED"), "WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A", -1, 1);
...
{
	func_191(func_48(uParam0, iLocal_15), GET_HASH_KEY("META_OUTFIT_WARM_WEATHER_CASUAL"));
	return true;
}
...
void func_338(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_373(iParam1))
		{
			func_191(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
