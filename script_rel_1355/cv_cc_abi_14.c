...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, 1.1566f, -0.516f, 0f, 31.68f, 2f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	if (iVar0 == 1)
	{
		iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_BEDROLLOPEN03X"), 1.62618f, 0.481654f, -0.0400009f, 0, 1, 0, 1);
		func_153(uParam0, GET_HASH_KEY("P_PILLOW01X"), 2.21605f, 0.897485f, 0.107033f, "Pillow", 1, 0, 1);
	}
	else
	{
		func_153(uParam0, GET_HASH_KEY("P_PILLOW01X"), 0f, 0f, 0f, "Pillow", 0, 0, 1);
	}
	...
	func_156(uParam0, GET_HASH_KEY("COMP_ABICNV14"), GET_HASH_KEY("PLAYER_ABICNV14"));
	func_157(uParam0, iLocal_27, -1, 0.67f);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_14, 1, 12, 0, 0, 0);
	func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_SLEEP"), "WORLD_CAMP_JACK_SLEEP", -1, 1);
	func_158(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_CAMP_JACK_SLEEP"), "WORLD_CAMP_JACK_SLEEP", -1, 1, 240f, 1065353216 /* Float: 1f */, 1);
	func_162(uParam0, 1);
	...
	iLocal_29 = func_165(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", GET_HASH_KEY("VOLCYLINDER"));
	func_166(uParam0, 1);
	return true;
}
...
int func_253()
{
	...
	if (func_328(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_254()
{
	...
	if (func_328(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
