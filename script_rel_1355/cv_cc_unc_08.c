...
bool func_72(var uParam0)
{
	...
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	func_154(uParam0, vLocal_23 + Vector(1f, 0f, 0f), -23.19f, 5f, 5f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 0);
	func_154(uParam0, 0.85f, -1.825f, 1.15f, -23.19f, 5f, 5f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_155(uParam0, 0.85f, -1.825f, 1.15f, 1.81f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_155(uParam0, vLocal_23 + Vector(1f, 0f, 0f), -23.19f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 0, 1, 1);
	...
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1);
	func_159(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_15, iLocal_20, "p_cs_rag02x_PH_R_HAND", 0, 0);
	func_161(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", -1, 0);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 0f, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), 1, 0, 0);
...
bool func_78(var uParam0)
{
	...
	ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(func_170(uParam0, iLocal_18), uParam0->f_107[iLocal_15 /*113*/].f_4, &Var0, false, 0, 2);
	uParam0->f_107[iLocal_15 /*113*/].f_96 = { Var0 };
	uParam0->f_107[iLocal_15 /*113*/].f_99 = Var0.f_3.f_2;
	ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(func_170(uParam0, iLocal_16), uParam0->f_107[iLocal_14 /*113*/].f_4, &Var0, false, 0, 2);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_385(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
