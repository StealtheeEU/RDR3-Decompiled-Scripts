...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.925f, -4.5625f, 0f, -35f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -0.125f, -0.4125f, 0f, -35f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_151(uParam0, -6.55f, 2.7375f, 0f, -35f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, -4.45f, -4.475f, 0f, -35f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -0.325f, -0.736f, 0.6f, -35f, 1f, 1f, 2.5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_BUCKET06X"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	...
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_CS_ROPE03BX"), 0f, 0f, 0f, "ROPE", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_161(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_D", -1, 1);
	return true;
}
...
void func_404(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_445(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_445(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
