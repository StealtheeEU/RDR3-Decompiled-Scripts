...
bool func_72(var uParam0)
{
	...
	if (func_148(uParam0) != 6)
	{
		func_151(uParam0, -0.0311f, 3.79f, 0f, 18.25f, 0.7775f, 0.73f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
		func_151(uParam0, 0.7189f, 0.4275f, 0f, 4.75f, 1.3f, 0.8775f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	}
	else
	{
		func_151(uParam0, 0.7114f, 0.5001f, 0f, 4.75f, 1.3f, 1.105f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	}
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	if (func_148(uParam0) == 6)
	{
		iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0.766328f, 0.213268f, -0.0161057f, 0, 1, 0, 1);
	}
	if (func_148(uParam0) == 6)
	{
	...
	if (func_148(uParam0) != 6)
	{
		func_155(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0);
		func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_157(uParam0, iLocal_14, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	else if (func_148(uParam0) == 6)
	{
		func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0);
		func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_157(uParam0, iLocal_14, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	if (func_148(uParam0) != 6)
	{
		func_155(uParam0, iLocal_15, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
		func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	if (!func_158() && func_148(uParam0) != 6)
	{
		iLocal_16 = func_150(uParam0, 22, 0);
		func_151(uParam0, 0.6564f, 3.9775f, 0f, 18.25f, 0.7775f, 0.73f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
		func_155(uParam0, iLocal_16, 3, GET_HASH_KEY("GENERIC_SEAT_BENCH_SCENARIO"), "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0);
		func_156(uParam0, iLocal_16, 3, GET_HASH_KEY("GENERIC_SEAT_BENCH_SCENARIO"), "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1.2f, 1);
	}
	if (func_158())
	{
		func_159(uParam0);
...
void func_333(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_365(iParam1))
		{
			func_366(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_398(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_443(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_443(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_385(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_443(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_462(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_474(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_492(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_474(GET_HASH_KEY("CHARACTER"), func_496(), -1591664384, bParam0);
}
