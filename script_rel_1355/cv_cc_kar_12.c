...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.5445f, 80f, 2f, 2f, 2.7825f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 0f, 0.8f, 0f, 0f, 2f, 5f, 3f, GET_HASH_KEY("VOLBOX"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK0", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_CHAIR_CRATE15X"), false);
...
bool func_75(var uParam0)
{
	...
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_CHAIR_CRATE15X")))
	{
		return false;
	}
	return true;
...
{
	iLocal_15 = OBJECT::CREATE_OBJECT_NO_OFFSET(GET_HASH_KEY("P_CHAIR_CRATE15X"), 1881.71f, -1833.58f, 42.25f, true, true, false, true);
	ENTITY::SET_ENTITY_HEADING(iLocal_15, 65f);
	iLocal_16 = OBJECT::CREATE_OBJECT_NO_OFFSET(GET_HASH_KEY("P_CHAIR_CRATE15X"), 1881.5f, -1834.79f, 42.25f, true, true, false, true);
