...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, 0.4f, -1.0625f, 1.15f, 6.81f, 3.48f, 2.08f, 2.685f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_SHARPENINGSTONE01X"), 0f, 0f, 0f, "STONE", 0, 1, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.585f, -1.372f, 0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS"), "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_SHARPEN_MALE_B", iLocal_16, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS"), "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_SHARPEN_MALE_B", iLocal_16, 0, 30f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	if (func_149(uParam0) == 1)
	{
		func_157(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_HUMAN_GLASS_PUT_DOWN_CRATE_TABLE"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_158(uParam0, iLocal_15, 4, 0);
		func_159(uParam0, iLocal_15, iLocal_17, "p_mugCoffee01x_ph_r_hand", 0, 0);
	}
	iLocal_18 = func_160(uParam0, -0.0625f, -1.25f, 0f, 0f, 0f, 0f, 1.67f, 1.2775f, 6f, "GRIEF", GET_HASH_KEY("VOLBOX"));
	return true;
}
