...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.5206f, -3.032f, 0.4558f, 10.44f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, 1.0272f, -3.2717f, 0.5389f, 10.68f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_152(uParam0, 1.75f, -3.35f, 0.5f, 12f, 1f, 0.56f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR05X"), 0f, 0f, 0f, "CHAIR_0", 0, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CHAIR05X"), 0f, 0f, 0f, "CHAIR_1", 0, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_BCANUCNV1"), GET_HASH_KEY("PLAYER_BCANUCNV1"));
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_MALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
