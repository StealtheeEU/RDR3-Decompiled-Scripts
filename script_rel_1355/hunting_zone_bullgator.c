...
bool func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if ((SCRIPTS::IS_THREAD_EXIT_REQUESTED() && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("HUNTING1")) == 0) && !func_37(15))
		{
			bVar0 = true;
		}
		...
		if (bVar0)
		{
			if (uParam0->f_622)
			{
				...
				if (!bVar1)
				{
					func_42(Global_35, "HUNTING_LOST_TRAIL", GET_HASH_KEY("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
				}
...
bool func_6(var uParam0)
{
	switch (uParam0->f_11)
	{
		...
		case 7:
			...
			break;
		case 8:
			if (func_54(func_26(GET_HASH_KEY("KILLED"), func_24(*uParam0))) < 1)
			{
				func_27(func_26(GET_HASH_KEY("KILLED"), func_24(*uParam0)), 1);
			}
			if (func_55(uParam0))
...
bool func_35()
{
	return (func_36(Global_1935630, 4096) || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("RESPAWN_DUMP_BODY")) > 0);
}
...
bool func_40(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
bool func_43(var uParam0)
{
	...
	*uParam0 = 7;
	uParam0->f_1 = 3;
	uParam0->f_572[0] = GET_HASH_KEY("BROKENSTICKS_AB");
	uParam0->f_572[1] = GET_HASH_KEY("P_GATORKILLREMAIN01X");
	uParam0->f_572[2] = GET_HASH_KEY("P_GATORKILLREMAIN01X");
	uParam0->f_580[0] = 4;
	uParam0->f_580[1] = 2;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_ALLIGATOR_02");
	uParam0->f_12.f_4 = 1f;
	return true;
}
...
bool func_50(var uParam0)
{
	...
	if (uParam0->f_12.f_1 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		{
			if (uParam0->f_12.f_5)
			{
				uParam0->f_12 = PED::_0xEAF682A14F8E5F53(uParam0->f_12.f_9, uParam0->f_12.f_10, 0, true, true, 0, 0);
			}
			else
			{
		...
		if (uParam0->f_31[iVar0 /*36*/].f_4 != 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1) && uParam0->f_31[iVar0 /*36*/].f_28 < 3)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1))
				{
					...
					{
						uParam0->f_31[iVar0 /*36*/] = MAP::BLIP_ADD_FOR_COORDS(1538154804, uParam0->f_31[iVar0 /*36*/].f_17);
					}
...
void func_51(var uParam0)
{
	...
	while (iVar2 < func_30())
	{
		...
		if (uParam0->f_31[iVar2 /*36*/].f_13)
		{
			...
			{
				MAP::BLIP_ADD_MODIFIER(uParam0->f_31[iVar2 /*36*/], -1186550032);
			}
	...
	MAP::BLIP_REMOVE_MODIFIER(uParam0->f_31[iVar1 /*36*/], -1186550032);
	if (bVar3)
	{
		MAP::BLIP_ADD_MODIFIER(uParam0->f_31[iVar1 /*36*/], 1641478980);
	}
	else
	{
		MAP::BLIP_REMOVE_MODIFIER(uParam0->f_31[iVar1 /*36*/], 1641478980);
	}
}
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1))
			{
				...
				if ((uParam0->f_31[iVar0 /*36*/].f_13 && fVar8 < 2500f) && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_31[iVar0 /*36*/].f_1))
				{
					...
					if ((fVar8 < 6.25f && !func_112()) && !bVar6)
					{
						...
						{
							uParam0->f_31[iVar0 /*36*/].f_16 = func_113("INSPECT_GENERIC", GET_HASH_KEY("INPUT_CONTEXT_Y"), uParam0->f_31[iVar0 /*36*/].f_1, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0, 0);
						...
						if (func_116(uParam0->f_31[iVar0 /*36*/].f_16, 1))
						{
							...
							if (uParam0->f_614 == 0)
							{
								func_42(Global_35, "HUNTING_START", GET_HASH_KEY("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
							}
...
void func_118(var uParam0, var uParam1)
{
	...
	if (uParam0->f_614 == 0)
	{
		...
		if (!MAP::DOES_BLIP_EXIST(uParam0->f_6))
		{
			uParam0->f_6 = MAP::BLIP_ADD_FOR_RADIUS(-108658760, uParam0->f_627, uParam0->f_9);
...
void func_120(int iParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		if (iParam0 == 0)
		{
			func_42(Global_35, "HUNTING_MEDIUM", GET_HASH_KEY("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
		}
		else if (iParam0 == 1)
		{
			func_42(Global_35, "HUNTING_NEAR", GET_HASH_KEY("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
		}
	}
	else if (iParam0 == 0)
	{
		func_42(Global_35, "HUNTING_FAR", GET_HASH_KEY("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
	}
	else if (iParam0 == 1)
	{
		func_42(Global_35, "HUNTING_MEDIUM", GET_HASH_KEY("SPEECH_PARAMS_STANDARD"), 0, 0, 0, 0, 1);
...
int func_121(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
...
{
	return func_135(GET_HASH_KEY("CHARACTER"), func_191(), -1591664384, bParam0);
}
...
struct<4> func_135(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_136(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_142(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (func_198(iParam0, uParam2, iParam3, bParam5, 0))
	{
		return false;
	}
	if (!func_194(0))
...
Vector3 func_159(int iParam0, int iParam1)
{
	...
	{
		case 0:
			vVar0 = { func_204(1, iParam1) };
			break;
		case 1:
			vVar0 = { func_204(2, iParam1) };
			break;
		case 2:
			vVar0 = { func_204(3, iParam1) };
			break;
	}
	return vVar0;
}
...
void func_171(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_208(iParam1))
		{
			func_209(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
{
	return (func_213(iParam0, 4) || func_213(iParam0, 5));
}
...
void func_184(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_216(iVar1) && !func_217(iVar1, iParam2)) && (!bParam3 || !func_218(iVar1))) && (!bParam4 || !func_219(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_220(iVar0);
...
void func_187(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_223(iParam0))
	{
		if (func_224(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
...
int func_189(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == iParam2)
	{
		...
		{
			iVar0 = func_56(func_226(), iParam0, (iParam1 - 1));
		}
	}
	return iVar0;
}
...
{
	if (func_227(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
bool func_198(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> Var0;
	struct<10> Var4;
	var uVar26;
	...
	if (func_229(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_230(0) };
			Var4.f_9 = -1591664384;
			if (!func_231(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_232(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_233(iParam0, 1))
			{
				if (!func_231(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_232(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
		}
		else if (!func_234(iParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	...
	{
		iVar28 = func_235(iParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
...
{
	return func_246(iParam0) == GET_HASH_KEY("WEAPON");
}
...
bool func_231(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_235(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
bool func_232(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_247(iParam0, &uVar0, uParam1, iParam2))
	{
...
bool func_234(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	while (iVar29 < 4)
	{
		iVar5 = func_250((398 + iVar29), 1);
		if (func_231(iParam0, &Var0, iVar5, 0))
		{
			bVar28 = func_232(iParam0, &Var6, iVar5);
...
int func_235(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
bool func_247(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_136(0);
	*uParam1 = { func_135(iParam0, func_230(0), iParam3, 0) };
...
struct<5> func_249(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_246(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_135(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("WEAPON"):
			...
			if (bParam2 && func_233(iParam0, 1))
			{
				...
				else if (!func_231(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_232(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case GET_HASH_KEY("UPGRADE"):
			if (func_254(iParam0, -1823706425))
			{
				Var0 = { func_135(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, GET_HASH_KEY("KIT_CAMP"));
			}
			else if (func_254(iParam0, -1483207246))
			{
				Var0 = { func_135(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, GET_HASH_KEY("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, -833319691))
			{
				...
				if (!func_255(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
bool func_255(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam0))
	{
		return false;
	}
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_136(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
