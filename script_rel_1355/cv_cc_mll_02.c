...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -8.4183f, -1.1202f, 0.8f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	func_151(uParam0, 0.72f, -1.1f, 0.8f, 32.76f, 2.3f, 2.68f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), 0f, 0f, 0f, "CHAIR", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_MLLCNV2"), GET_HASH_KEY("PLAYER_MLLCNV2"));
	func_156(uParam0, iLocal_20, -1, 0.86f);
	func_157(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_158(uParam0, iLocal_14, 3, -1);
	func_159(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
