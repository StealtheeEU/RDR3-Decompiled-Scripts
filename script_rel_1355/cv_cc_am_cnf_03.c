...
bool func_79(var uParam0)
{
	...
	func_159(uParam0, -0.45f, -0.92f, 0f, -96.48f, 3.955f, 4.8675f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	Local_40 = { func_160(uParam0, 0.0157f, 0.3739f, 1f, -180f, 6f, 0.967f, 0.939f) };
	iLocal_39 = func_161(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0.8f, 0.491f, -0.004f, "crate02", 0, 0, 1);
	iLocal_38 = func_161(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 1.314f, 1.778f, -0.062f, "crate15", 0, 0, 1);
	...
	func_167(uParam0, iLocal_18, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
	func_168(uParam0, iLocal_18, 3, -1);
	func_169(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_38, 0, 110f, 1065353216 /* Float: 1f */, 1);
...
bool func_94(var uParam0)
{
	...
	if (!MAP::DOES_BLIP_EXIST(iLocal_51))
	{
		...
		{
			iLocal_51 = MAP::BLIP_ADD_FOR_COORDS(-678244495, ENTITY::GET_ENTITY_COORDS(func_8(uParam0, iLocal_18), true, false));
			MAP::SET_BLIP_SPRITE(iLocal_51, GET_HASH_KEY("BLIP_AMBIENT_SECRET"), true);
		}
	}
	if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_95))
	{
		...
		{
			iLocal_95 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_50(uParam0, iLocal_39), GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_GENERIC"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
	...
	if (iLocal_50 >= 3 && iLocal_50 < 6)
	{
		...
		if (func_226(&uLocal_99))
		{
			...
			else
			{
				...
				func_169(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_38, 0, 110f, 1065353216 /* Float: 1f */, 1);
			}
			func_228(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_217(9);
			return false;
...
bool func_165(int iParam0)
{
	...
	iVar0 = func_290(GET_HASH_KEY("STREAK"), GET_HASH_KEY("KILLS"));
...
bool func_166(int iParam0)
{
	...
	iVar0 = func_291();
	iVar1 = func_292(GET_HASH_KEY("KILLS"));
	if (iVar1 == 0)
	{
		return false;
	}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_310(uParam0->f_107[iVar12 /*113*/].f_1));
				}
...
void func_212(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_51(*iParam0))
	{
		*iParam0 = func_332("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		func_333(*iParam0, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_51(*iParam1))
	{
		*iParam1 = func_332("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_230()
{
	TASK::TASK_USE_SCENARIO_POINT(Global_35, iLocal_95, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, true, false, 0, false, -1f, false);
}
...
void func_231(var uParam0)
{
	...
	if (bLocal_61)
	{
		if (func_353(Global_35, 0, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED") || func_353(Global_35, 1, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED"))
		{
...
void func_235(var uParam0)
{
	...
	{
		iLocal_54 = func_332("VIG_LEAVE_CONVERSATION", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
	}
...
int func_284()
{
	...
	if (func_387(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_285()
{
	...
	if (func_387(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_332(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_245(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_404(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_402(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_451(iParam1))
		{
			func_452(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_417(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_460(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
bool func_473(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_507(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_110(iParam0, 44, 1);
			}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_387(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_467(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_521(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_538(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_550(GET_HASH_KEY("CHARACTER"), func_572(), -1591664384, bParam0);
}
