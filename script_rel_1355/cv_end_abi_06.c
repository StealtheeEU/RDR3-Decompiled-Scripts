...
bool func_76(var uParam0)
{
	...
	func_156(uParam0, 0.4036f, -11.4034f, 0.5303f, 42.05f, 8f, 8f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_157(uParam0, 0.5439f, -4.9805f, 0f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_157(uParam0, 5.7064f, -14.868f, 0f, 0f, 3.155f, 2.9725f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	...
	func_160(uParam0, GET_HASH_KEY("COMP_BCABICNV6"), GET_HASH_KEY("PLAYER_BCABICNV6"));
	func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_162(uParam0, iLocal_14, 0.582842f, -5.248039f, 1.03964f, -118.28f, 1, 1);
	func_163(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 0.8f, 1);
...
bool func_97(var uParam0)
{
	switch (iLocal_110)
	{
		case 0:
			...
			{
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_52(uParam0, iLocal_14), GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), 0, false, 0, 0.6f, true);
				iLocal_110 = 1;
		...
		case 2:
			...
			break;
		case 3:
			fLocal_108 = PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_LR"));
			fLocal_109 = PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_UD"));
...
bool func_212(var uParam0)
{
	...
	{
		iLocal_32 = func_321("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_52(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
bool func_214()
{
	...
	{
		iLocal_33 = func_325("SHOP_EXIT", GET_HASH_KEY("INPUT_CONTEXT_A"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_348(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_421(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
