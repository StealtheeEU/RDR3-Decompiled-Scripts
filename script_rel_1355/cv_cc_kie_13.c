...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.172701f, 4.05512f, 1.00882f, 0f, 1f, 1f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_151(uParam0, 1.16504f, -2.50478f, 1.1337f, 14f, 1f, 1f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_151(uParam0, 0.88f, -1.44f, 0f, 65f, 2.765f, 1.745f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, 1.272f, -1.52794f, 1.10083f, -7f, 1f, 1.6f, 4f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0.07143f, -1.04836f, 0.151794f, "CRATE", 1, 0, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_155(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_243()
{
	...
	if (func_319(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_244()
{
	...
	if (func_319(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_331(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_363(iParam1))
		{
			func_364(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_319(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_383(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_441(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_460(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_472(GET_HASH_KEY("CHARACTER"), func_494(), -1591664384, bParam0);
}
