...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -0.4f, 2.4001f, 0f, 0f, 6.56f, 2.88f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 2.6001f, 3.31f, 0f, 7.56f, 2f, 8.57f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_ABICNV15"), GET_HASH_KEY("PLAYER_ABICNV15"));
	func_156(uParam0, iLocal_14, 4, GET_HASH_KEY("WORLD_HUMAN_WASHBOARD_BASIN"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 4, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_30 = func_161(uParam0, -1.1f, -4.25f, 0f, 0f, 0f, 0f, 7.29f, 3.9275f, 7f, "TENT_VOLUME", GET_HASH_KEY("VOLBOX"));
	iLocal_31 = func_162(uParam0, 0.2501f, 3.1374f, 0.95f, 0f, 0f, 95.9894f, 1.3275f, 1.745f, 1.38f, "Grief", GET_HASH_KEY("VOLCYLINDER"));
	return true;
}
...
void func_342(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_385(iParam1))
		{
			func_386(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_401(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
