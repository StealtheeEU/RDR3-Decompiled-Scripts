...
bool func_79(var uParam0)
{
	...
	func_159(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_159(uParam0, GET_HASH_KEY("P_PHONOGRAPH01X"), 0f, 0f, 0f, "PHONOGRAPH", 0, 1, 1);
	...
	func_163(uParam0, GET_HASH_KEY("COMP_DTCCNV33"), GET_HASH_KEY("PLAYER_DTCCNV33"));
	func_164(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_164(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	...
	func_169(uParam0, iLocal_14, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_97(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(iLocal_54))
	{
		iLocal_54 = MAP::BLIP_ADD_FOR_COORDS(-678244495, func_171(uParam0, vLocal_45));
		MAP::SET_BLIP_SPRITE(iLocal_54, GET_HASH_KEY("BLIP_AMBIENT_SECRET"), true);
	}
...
void func_212(var uParam0)
{
	...
	MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_8(uParam0, iLocal_16), "", 6f, 0f, 0, 0f, 0f, 0, false, -1);
	bLocal_53 = true;
	if (!func_49(iLocal_41))
	{
		iLocal_41 = func_323("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
	...
	{
		iLocal_42 = func_323("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_213(var uParam0)
{
	...
	if (func_329(iLocal_41, 1))
	{
		...
		TASK::TASK_ENTER_ANIM_SCENE(Global_35, func_330(uParam0, iLocal_21), "ARTHUR", "PL_DanceAccept", 1069379748 /* Float: 1.48f */, 0, 0, 20000, -1082130432 /* Float: -1f */);
...
void func_215(var uParam0)
{
	...
	{
		iLocal_43 = func_323("VIG_FLARE", GET_HASH_KEY("INPUT_CONTEXT_X"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		func_333(iLocal_43, 6f, 1);
		func_325(iLocal_43, 0, 1);
	}
	if (!func_49(iLocal_44))
	{
		iLocal_44 = func_323("LEAVE", GET_HASH_KEY("INPUT_CONTEXT_B"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_266()
{
	...
	if (func_361(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_267()
{
	...
	if (func_361(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_323(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_227(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_386(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_335(var uParam0)
{
	...
	fVar0 = PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_LR"));
	if (fVar0 > 0.1f)
	{
		iLocal_30 = iLocal_23;
		return;
...
int func_337(var uParam0, int iParam1)
{
	...
	ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iVar5, &Var1);
	return 1;
}
...
void func_373(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_423(iParam1))
		{
			func_424(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
				...
				case 0:
					...
					switch (iParam0)
					{
						...
						case 14:
							...
							break;
						case 4:
							if (func_361(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_447(Global_1347702[1 /*49*/].f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
...
void func_502(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4096 > 0 && func_462(iParam1, 879715242))
	{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 512 > 0 && func_462(iParam1, 1064646155))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1024 > 0 && func_462(iParam1, -536694793))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2048 > 0 && func_462(iParam1, -1304053509))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & -2147483648 > 0 && func_462(iParam1, 718939204))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 65536 > 0 && func_462(iParam1, -972364774))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16384 > 0 && func_462(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 262144 > 0 && func_462(iParam1, 1153596794))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 524288 > 0 && func_462(iParam1, 1016389820))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1048576 > 0 && func_462(iParam1, -726966617))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2097152 > 0 && func_462(iParam1, 1365901568))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 32768 > 0 && func_462(iParam1, -1658942149))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 131072 > 0 && func_462(iParam1, -1980913856))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4194304 > 0 && func_462(iParam1, 491764525))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8388608 > 0 && func_462(iParam1, -76015264))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16777216 > 0 && func_462(iParam1, 622113465))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 33554432 > 0 && func_462(iParam1, 781533162))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 67108864 > 0 && func_462(iParam1, -271415321))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 134217728 > 0 && func_462(iParam1, -1683207356))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 268435456 > 0 && func_462(iParam1, -254794762))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 536870912 > 0 && func_462(iParam1, 609066278))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1073741824 > 0 && func_462(iParam1, -1712783565))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8192 > 0 && func_462(iParam1, 1544915253))
	{
...
int func_505(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_524(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_532(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_544(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_536(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_536(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_536(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_554(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_536(GET_HASH_KEY("CHARACTER"), func_558(), -1591664384, bParam0);
}
