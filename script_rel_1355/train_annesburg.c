...
bool func_2()
{
	...
	switch (iLocal_0)
	{
		...
		case 1:
			...
			{
				if (VEHICLE::_0x86AFC343CF7F0B34(GET_HASH_KEY("TRAINS_INTERSECTION1_ANN"), 2940.988f, 1374.5f, 43.1838f, &iVar1))
				{
					VEHICLE::_0x3ABFA128F5BF5A70(GET_HASH_KEY("TRAINS_INTERSECTION1_ANN"), iVar1, 1);
				}
