...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0202455f, 1.08015f, 0.533295f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_14 = func_152(uParam0, 19, 0);
	func_153(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0.011f, 1.022f, 0.031f, 0, 1, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_SSNCNV5"), GET_HASH_KEY("PLAYER_SSNCNV5"));
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", iLocal_22, 0);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
