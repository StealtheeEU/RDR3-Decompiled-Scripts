...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_10 = GET_HASH_KEY("DEAD_CARRIABLE_DEER");
	iLocal_68 = GET_HASH_KEY("META_OUTFIT_DEFAULT");
	iLocal_69 = GET_HASH_KEY("A_C_DEER_01");
	iLocal_70 = func_1(GET_HASH_KEY("HORSE_CLASS_RIDING"), 1);
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		...
		case 68:
			sLocal_71 = "PD_Deer_Shot";
			iLocal_10 = GET_HASH_KEY("DEAD_CARRIABLE_GOAT");
			iLocal_69 = GET_HASH_KEY("A_C_GOAT_01");
			break;
		case 69:
			sLocal_71 = "PD_Deer_Shot";
			iLocal_10 = GET_HASH_KEY("DEAD_CARRIABLE_PRONGHORN");
			iLocal_69 = GET_HASH_KEY("A_C_PRONGHORN_01");
			if (uParam0->f_489 == 1)
			{
				iVar1 = 0;
				if (func_50())
				{
					iLocal_68 = GET_HASH_KEY("META_ANIMAL_OUTFIT_PRONGHORNSONOM_001");
				}
				else
				{
					iLocal_68 = GET_HASH_KEY("META_ANIMAL_OUTFIT_PRONGHORNBAJAM_001");
				}
			}
			break;
		case 70:
			sLocal_71 = "PD_Ram_Shot";
			iLocal_10 = GET_HASH_KEY("DEAD_CARRIABLE_BIGHORNRAM");
			iLocal_69 = GET_HASH_KEY("A_C_BIGHORNRAM_01");
			if (uParam0->f_489 == 1)
			{
				iVar1 = 0;
				iLocal_68 = GET_HASH_KEY("META_ANIMAL_OUTFIT_BIGHORNRAMDESERT_001");
			}
			break;
		case 46:
			sLocal_71 = "PD_Deer_Shot";
		...
		case 53:
			...
			{
				iLocal_68 = GET_HASH_KEY("META_ANIMAL_OUTFIT_BIGHORNRAMROCKY");
			}
			break;
	}
	func_51(uParam0, 0, "MPDHP_HORSE", iLocal_70, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MPDHP_MAN", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 != 71)
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					if (*uParam0 == 71)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						{
							PED::_SET_PED_BODY_COMPONENT(uParam0->f_20[0 /*14*/], iLocal_67);
					...
					{
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 0, 3f, 3f, 160, 2f, -2.5f, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */);
					}
					PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
				}
				WEAPON::REMOVE_ALL_PED_WEAPONS(uParam0->f_20[1 /*14*/], true, true);
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], GET_HASH_KEY("WEAPON_REPEATER_CARBINE"), 999, bLocal_72, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				if (*uParam0 == 53 || *uParam0 == 46)
				{
					WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[1 /*14*/], GET_HASH_KEY("WEAPON_UNARMED"), true, 0, false, false);
				}
				func_74(&uLocal_11, uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0);
				...
				func_78(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 34, 1073741824 /* Float: 2f */);
...
bool func_88(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_102(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_172(iParam1))
		{
			func_173(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_188(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_205(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_203(int iParam0, int iParam1)
{
	...
	if (func_249(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
struct<5> func_222(int iParam0)
{
	...
	Var0 = { func_223(iParam0, GET_HASH_KEY("CHARACTER"), func_253(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
...
void func_227(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_258(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_255(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_256(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_257(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
