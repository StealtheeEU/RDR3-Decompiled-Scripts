...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 3.6852f, -4.1639f, 0.9639f, 8.4934f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -1.3171f, -1.1901f, 0.5566f, 137.0659f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 1.04f, -1.68f, 1.0005f, 4.32f, 2.24f, 1.1f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_BARREL010X"), 0f, 0f, 0f, "BARREL_HOSEA", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, "BARREL_BILL", 1, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	...
	func_159(uParam0, GET_HASH_KEY("COMP_HSHCNV13"), GET_HASH_KEY("PLAYER_HSHCNV13"));
	func_160(uParam0, 1);
	return true;
}
