...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.8f, -0.9125f, 0f, -14.75f, 2.5f, 2.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 4.0517f, -7.6652f, 0.9548f, -14.75f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 1.25383f, -1.02793f, 1.00041f, 0f, 1.5f, 1.5f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0f, 0, 1, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_JAVIER_KNIFE"), "WORLD_CAMP_JAVIER_KNIFE", iLocal_20, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_JAVIER_KNIFE"), "WORLD_CAMP_JAVIER_KNIFE", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_JAVCNV3"), GET_HASH_KEY("PLAYER_JAVCNV3"));
...
bool func_93(var uParam0)
{
	...
	if (func_203(uParam0, iLocal_19))
	{
		...
		else if (func_204(uParam0, iLocal_19, fLocal_33))
		{
			if (!bLocal_32)
			{
				iLocal_35 = func_152(uParam0, 3.52364f, 0.804585f, 1.00197f, 0f, 1.5f, 1.5f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_392(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
