...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.3f, 0.8f, 0.4f, -12f, 3.75f, 2.5f, 2f, GET_HASH_KEY("VOLBOX"), 1);
	func_152(uParam0, -0.95f, -1.85f, 0f, 0f, 3.8f, 7f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", -1, 0);
...
bool func_93(var uParam0)
{
	...
	if (func_200(uParam0, iLocal_17))
	{
		...
		if (func_201(uParam0, Local_22, 1, 0) && (fVar0 < 0.8f && fVar1 < 0.8f))
		{
			...
			func_202(uParam0, GET_HASH_KEY("COMP_ABICNV7"), GET_HASH_KEY("PLAYER_ABICNV7"));
