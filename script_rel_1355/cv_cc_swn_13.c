...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.4436f, 1.4525f, 0f, 129f, 1.3475f, 2.5425f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	func_151(uParam0, -1.6811f, -0.8475f, 0f, 103.5f, 1.1f, 1.1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 4.3064f, 2.9775f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SWNCNV13"), GET_HASH_KEY("PLAYER_SWNCNV13"));
	func_156(uParam0, iLocal_17, -1, 0.87f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_DRUNK_BAR_SLUMPED"), "WORLD_HUMAN_DRUNK_BAR_SLUMPED_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 0.625f);
	func_159(uParam0, iLocal_14, 3, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH_PORCH"), "PROP_HUMAN_SEAT_BENCH_PORCH_SMOKING_MALE_A", -1, 0);
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_160(uParam0, iLocal_16, 1, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
