...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.3f, -0.4f, 0f, -14.04f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, -0.2f, -1.35f, 0f, -11.88f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -1.96f, 3.59f, 0f, -11.88f, 1.4f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	iLocal_14 = func_152(uParam0, 1, 0);
	iLocal_15 = func_152(uParam0, 3, 0);
	iLocal_16 = func_152(uParam0, 13, 0);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BEER_JOHN", 0, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BEER_BILL", 0, 0, 1);
	if (!func_154(14))
	{
	...
	if (func_154(14))
	{
		func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_18, 0);
		func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_17, 0);
		func_160(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
...
void func_149(var uParam0)
{
	...
	if (!func_154(14))
	{
		func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0.000679016f, "SEAT_JOHN", 1, 0, 1);
		func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, "SEAT_BILL", 1, 0, 1);
	}
}
...
void func_150(var uParam0)
{
	...
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 1.40122f, -0.443811f, -0.00283051f, "SEAT_JOHN", 1, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), -0.258479f, -1.47156f, 0.00315094f, "SEAT_BILL", 1, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_BARREL06X"), -2.02149f, 4.18722f, -0.0580559f, "", 0, 0, 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_405(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_459(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_476(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_488(GET_HASH_KEY("CHARACTER"), func_510(), -1591664384, bParam0);
}
