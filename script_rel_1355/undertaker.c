...
{
	if (ENTITY::IS_ENTITY_ON_SCREEN(iParam0) && func_58(Global_35, iParam0, 0, fParam1, bParam2))
	{
		return true;
	}
	return false;
...
bool func_83(var uParam0, int iParam1)
{
	...
	if (func_75(uParam0->f_23, 512) || (iVar0 == GET_HASH_KEY("WEAPON_UNARMED") && iVar1 == GET_HASH_KEY("WEAPON_UNARMED")))
	{
		return true;
	}
	return false;
...
int func_122(int iParam0, var uParam1)
{
	...
	{
		return func_176(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
bool func_148(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_44(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_196(iVar0, 0)))
		{
...
bool func_164(int iParam0, int iParam1)
{
	...
	if (func_201(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
bool func_229(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
