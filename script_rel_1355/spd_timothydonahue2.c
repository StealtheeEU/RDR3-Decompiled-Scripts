...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_169 = GET_HASH_KEY("CS_TIMOTHYDONAHUE");
	iLocal_170 = GET_HASH_KEY("S_BOOKCART01X");
	iLocal_171 = GET_HASH_KEY("P_CS_GETRICH_BOOK01X");
				...
				case 2:
					if (((func_61(&(uLocal_173[0]), iLocal_169, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_62(&iLocal_175, iLocal_171, 2644.251f, -1208.702f, 53.5354f)) && func_62(&iLocal_176, iLocal_171, 2643.541f, -1208.416f, 53.1764f)) && func_62(&iLocal_177, iLocal_170, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(uLocal_173[0], 0))
						{
							...
							func_64(&(uLocal_173[0]), &uLocal_15, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INTERESTING_NEW"), 5f, 3600f);
				...
				case 33:
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_173[0]) && !ENTITY::IS_ENTITY_DEAD(Global_35))
					{
						...
						else
						{
							...
							{
								TASK::TASK_FLEE_PED(uLocal_173[0], Global_35, 3, 0, -1f, -1, 0);
								PED::SET_PED_KEEP_TASK(uLocal_173[0], true);
								PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_173[0], 17, true);
								IK::_0x0EABF182FBB63D72(uLocal_173[0], 6, 0);
							}
							func_81(iLocal_184);
							func_60(36);
						}
...
{
	PLAYER::_0xC67A4910425F11F1(PLAYER::GET_PLAYER_INDEX(), "TimothyBubble");
	func_111(&(uLocal_173[0]), &uLocal_15, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INTERESTING_NEW"), 5f, 1);
...
void func_30()
{
	...
	{
		iLocal_184 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
...
bool func_108(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_202(iParam0, GET_HASH_KEY("CURRENCY_CASH"), iParam1, iVar0);
	}
...
void func_155(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_254(func_253(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_255(func_253(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
void func_268(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_360(iParam1))
		{
			func_65(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_294(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_312(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_329(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_209(iParam4, 268435456))
			{
				iVar8 = func_389(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
void func_423(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_199(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_403(iParam1))
		{
			...
			iParam1->f_6 = func_438(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_199(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_438(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_324(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_442(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
