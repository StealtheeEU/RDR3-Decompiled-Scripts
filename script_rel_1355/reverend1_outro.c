...
bool func_6(var uParam0)
{
	...
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("WORLD_HUMAN_SLEEP_GROUND_PILLOW"), false))
	{
		return false;
	}
	return true;
...
void func_19(var uParam0)
{
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("WORLD_HUMAN_SLEEP_GROUND_PILLOW"), 15, 0, 0);
}
...
bool func_24(var uParam0)
{
	switch (iLocal_19)
	{
		case 0:
			...
			TASK::TASK_START_SCENARIO_AT_POSITION(iLocal_15[0], GET_HASH_KEY("WORLD_HUMAN_SLEEP_GROUND_PILLOW"), -145.23f, -40.6f, 94.65f, -89.92f, 0, false, true, 0, -1f, false);
			func_47(1);
			break;
		case 1:
			break;
...
void func_76(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_111(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_111(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_121(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_119(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_111(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_139(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_148(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_159(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_152(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_152(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_152(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_169(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
void func_156(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_172(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_152(GET_HASH_KEY("CHARACTER"), func_174(), -1591664384, bParam0);
}
