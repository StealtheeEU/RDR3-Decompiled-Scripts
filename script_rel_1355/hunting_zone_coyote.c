...
bool func_42(var uParam0)
{
	*uParam0 = 9;
	uParam0->f_9 = 80f;
	uParam0->f_10 = 180f;
	uParam0->f_572[0] = GET_HASH_KEY("P_COYOTESCAT01X");
	uParam0->f_572[1] = GET_HASH_KEY("P_COYOTETUFTSFUR_01X");
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_COYOTE_01");
	StringCopy(&(uParam0->f_605), "PD_Med_aged_carcass_Hvy_Hot", 64);
	uParam0->f_12.f_5 = 1;
	uParam0->f_623 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("COYOTE_LEGENDARY");
	return true;
}
