...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.4625f, 1.1049f, 1.0409f, 32.76f, 2.02f, 1.21f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 1.2062f, -1.9135f, 0.4965f, 34.92f, 1f, 1f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 0f, 0f, 0.4965f, 0f, 1.75f, 1.75f, 2.5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_154(uParam0, GET_HASH_KEY("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCH", 0, 1, 1);
	iLocal_20 = func_154(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "POKER", 0, 1, 1);
	iLocal_21 = func_154(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.20082f, -1.86806f, -0.0284729f, 0, 1, 0, 1);
	...
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_B", iLocal_21, 0);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_20, "p_stickFirePoker01x_PH_R_HAND", 0, 0);
	func_157(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, GET_HASH_KEY("COMP_MCHCNV5"), GET_HASH_KEY("PLAYER_MCHCNV5"));
