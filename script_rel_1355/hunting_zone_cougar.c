...
bool func_42(var uParam0)
{
	*uParam0 = 8;
	uParam0->f_1 = 2;
	uParam0->f_572[0] = GET_HASH_KEY("P_COUGARSCAT01X");
	uParam0->f_572[1] = GET_HASH_KEY("P_COUGARBLOODPOOLS01X");
	uParam0->f_572[2] = GET_HASH_KEY("P_COUGARKILLREMAINS01X");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 3;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_COUGAR_01");
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("COUGAR_LEGENDARY");
	return true;
}
...
{
	return func_132(GET_HASH_KEY("CHARACTER"), func_189(), -1591664384, bParam0);
}
