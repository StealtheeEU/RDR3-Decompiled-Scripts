...
bool func_77(var uParam0)
{
	...
	func_162(uParam0, -0.8881f, -2.4326f, 1.0273f, 119.8977f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_162(uParam0, -0.7068f, -3.5707f, 1.0109f, 68.9204f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_94 = func_163(uParam0, GET_HASH_KEY("P_CHAIR24X"), -1.049f, -2.811f, 0.018f, "CHAIR^1", 1, 0, 1);
	func_163(uParam0, GET_HASH_KEY("P_CHAIR24X"), 0f, 0f, 0f, "Chair", 0, 0, 1);
	...
	func_166(uParam0, GET_HASH_KEY("COMP_DNHCNV8"), GET_HASH_KEY("PLAYER_DNHCNV8"));
	func_167(uParam0, iLocal_92, 1);
	func_168(uParam0, iLocal_92, 1, -1);
	func_169(uParam0, iLocal_93, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_I", iLocal_94, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_174(uParam0, iLocal_92, 0.6f);
	func_175(uParam0, -1351.705f, 2439.949f, 307.5807f, -20f, 1.1f, 1.1f, 1f, GET_HASH_KEY("VOLCYLINDER"), 0);
	if (func_176(0))
	{
...
int func_283()
{
	...
	if (func_375(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_284()
{
	...
	if (func_375(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_416(var uParam0, var uParam1)
{
	...
	if (!func_421(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_460("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_489(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_538(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_538(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_375(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_476(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_538(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_556(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_564(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_576(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_568(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_568(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_568(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_586(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_568(GET_HASH_KEY("CHARACTER"), func_590(), -1591664384, bParam0);
}
