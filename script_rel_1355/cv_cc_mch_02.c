...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	func_152(uParam0, 0.0072f, 0.1499f, 0.577f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, -0.2f, -0.35f, 0.6f, -35f, 1f, 1f, 2.5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	if (!func_154(10))
	{
	...
	if (func_154(10))
	{
		func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	}
	else
	{
		func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_14, "GREET_MICAH_MCHCNV2", 60000, 1);
	func_161(uParam0, GET_HASH_KEY("COMP_MCHCNV2"), GET_HASH_KEY("PLAYER_MCHCNV2"));
	func_162(uParam0, 0f, 1103626240 /* Float: 25f */);
	func_163(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	if (func_154(10))
	{
		func_164(uParam0);
		func_165(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0);
...
bool func_86(var uParam0)
{
	...
	{
		if (WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iLocal_14), GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_MICAH"), 0, false))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_14), GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_MICAH"), true, 0, false, false);
		}
	}
	return true;
}
