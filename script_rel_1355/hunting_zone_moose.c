...
bool func_42(var uParam0)
{
	*uParam0 = 12;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = GET_HASH_KEY("EAG_EYE_TRCK_MOOSE_AA");
	uParam0->f_572[1] = GET_HASH_KEY("P_MOOSESCAT01X");
	uParam0->f_572[2] = GET_HASH_KEY("P_MOOSETUFTSFUR01X");
	uParam0->f_580[0] = 5;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 5;
	...
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_MOOSE_01");
	uParam0->f_12.f_3 = 1.35f;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("META_OUTFIT_ANIMAL_ALBINO_MOOSE");
	return true;
}
