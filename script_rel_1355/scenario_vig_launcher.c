...
void func_6()
{
	switch (iLocal_5)
	{
		case 0:
			...
			if (func_14(bLocal_8, 0) && !PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(PERSCHAR::_0x32A1E3B83D501096(bLocal_8)))
			{
				iLocal_5 = 6;
				return;
			}
...
bool func_15()
{
	...
	if (!PED::IS_PED_USING_THIS_SCENARIO(bLocal_8, iLocal_3))
	{
		return true;
	}
