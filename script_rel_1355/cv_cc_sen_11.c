...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_152(uParam0, 2.24f, 1.65f, 1f, 0f, 2f, 7f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_152(uParam0, 0.05f, -0.45f, 1f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SENCNV11"), GET_HASH_KEY("PLAYER_SENCNV11"));
	func_156(uParam0, iLocal_16, -1, 0.8f);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_158(uParam0, iLocal_14, 4, 2, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_160(uParam0, iLocal_15, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return true;
}
