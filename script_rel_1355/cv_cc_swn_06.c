...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -8.5033f, 0.7498f, 0.8457f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SWANSON"), 1, 1, 1);
	func_150(uParam0, 0.4922f, -0.8577f, 1.0179f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 21, 0);
	iLocal_14 = func_151(uParam0, 2, 0);
	func_152(uParam0, GET_HASH_KEY("P_CS_BIBLE01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_317(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_383(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
