...
bool func_72(var uParam0)
{
	...
	func_151(uParam0);
	func_152(uParam0);
	iLocal_28 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CRATE03C"), -0.605405f, -0.129152f, 0.435166f, "CRATE", 1, 0, 1);
	...
	iLocal_29 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, 0, 0, 0, 1);
	func_156(uParam0, iLocal_19, 0, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_62)
	{
		...
		{
			iLocal_67 = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), -145.589f, -32.978f, 94.615f, 30.935f, 0, 0, 0);
			...
			{
				TASK::TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_21), iLocal_67, "WORLD_HUMAN_STAND_WAITING_MALE_A", 0, true, false, 0, false, -1f, false);
			}
			bLocal_62 = true;
		}
	}
	if (!bLocal_63)
	{
		...
		{
			iLocal_68 = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_HUMAN_DRINKING"), -141.786f, -30.653f, 94.884f, 64.46f, 0, 0, 0);
			...
			{
				TASK::TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_27), iLocal_68, "WORLD_HUMAN_STAND_DRINK_FEMALE_A", 0, true, false, 0, false, -1f, false);
			}
			bLocal_63 = true;
		}
	}
