...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_M_M_VALFARMER_01");
	iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_HORSE_GRAZING_DOMESTIC");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 43:
			iVar0 = func_49(GET_HASH_KEY("HORSE_CLASS_RIDING"), 1);
			func_50(uParam0, 1, "FRP_HORSE", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -5f, -2f, 0f), (35f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
			if (uParam0->f_489 == 1)
			{
				iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_HORSE_DRINK_GROUND_DOMESTIC");
			}
			else
			{
				iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_HORSE_GRAZING_DOMESTIC");
			...
			break;
		case 44:
			iVar0 = GET_HASH_KEY("A_C_DOGCHESBAYRETRIEVER_01");
			func_50(uParam0, 1, "FRP_DOG", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, -1.35f, 0f), (-18f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
			break;
	}
	func_50(uParam0, 0, "FRP_FISHERMAN", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	if (uParam0->f_20[0 /*14*/].f_8 < 0f)
	{
		uParam0->f_20[0 /*14*/].f_8 = (uParam0->f_20[0 /*14*/].f_8 + 360f);
	}
	func_50(uParam0, 2, "FRP_FISH", GET_HASH_KEY("A_C_FISHBLUEGIL_01_SM"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 33f, -0.5f), vParam4.z, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WEAPON_FISHINGROD"), 1, true, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				...
				WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WEAPON_FISHINGROD"), true, 0, false, false);
				MISC::REGISTER_INTERACTION_LOCKON_PROMPT(uParam0->f_20[0 /*14*/], "", 35f, 35f, 8, 0f, 0f, 0, false, -1);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (*uParam0 == 43)
				{
					...
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], iLocal_11, 0, false, 0, -1f, false);
				}
				if (*uParam0 == 44)
				{
					PED::_0xB8B6430EAD2D2437(uParam0->f_20[1 /*14*/], GET_HASH_KEY("GUARD_DOG"));
					PED::_0x24C82EF607105FAA(uParam0->f_20[1 /*14*/], GET_HASH_KEY("TIMIDGUARDDOG"));
					...
					PED::SET_PED_OWNS_ANIMAL(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], false);
					MISC::REGISTER_INTERACTION_LOCKON_PROMPT(uParam0->f_20[1 /*14*/], "", 2f, 2f, 8, 0f, 0f, 0, false, -1);
		...
		case 1:
			...
			{
				if (func_81(uParam0, 8f, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 0))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WEAPON_UNARMED"), false, 0, false, false);
...
void func_67(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN"), true, 0, true, false);
	}
}
...
bool func_79(var uParam0)
{
	switch (Local_42)
	{
		case 1:
			...
			Local_42.f_1 = 30f;
			func_77(&uLocal_72);
			if (!func_123(uParam0->f_20[0 /*14*/], GET_HASH_KEY("SCRIPT_TASK_WEAPON")))
			{
...
void func_101(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_147(iParam1))
		{
			func_148(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_207(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_76(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
