...
bool func_72(var uParam0)
{
	...
	{
		func_154(uParam0, 1.66677f, -0.70263f, 1f, 80f, 2f, 2f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
		func_154(uParam0, -0.07f, -5.018f, 1.0999f, 0f, 2.4f, 2.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	}
	iLocal_16 = func_155(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER0", 0, 0, 1);
	iLocal_18 = func_155(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER1", 0, 0, 1);
	iLocal_17 = func_155(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), -3.42434f, -0.222129f, 0.0428772f, 0, 1, 0, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_KARITMCNV1"), GET_HASH_KEY("PLAYER_KARITMCNV1"));
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_A", -1, 1);
	func_160(uParam0, iLocal_15, 1061142135 /* Float: 0.749f */);
	func_161(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_B", -1, 1);
	func_162(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_DRINKING_FEMALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
