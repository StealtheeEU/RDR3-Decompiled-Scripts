...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5266f, -1.2093f, 0.5026f, -22.5144f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_CHARLES"), 1, 1, 1);
	func_151(uParam0, 0.5733f, 1.1645f, 0.4966f, 155.6634f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.585f, -1.372f, -0.001f, 0, 1, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0.636f, 0.636f, -0.004f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "CHARLES_BOWL", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "CHARLES_SPOON", 0, 1, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "LENNY_BOWL", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "LENNY_SPOON", 0, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_RESTING_LAZY_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_17, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_RESTING_LAZY_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), 1, 0, 0);
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), 1, 0, 0);
	return true;
}
