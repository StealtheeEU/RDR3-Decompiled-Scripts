...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, 2.2f, 0f, -35f, 5f, 4f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ADLERS"), 1, 1, 1);
	func_151(uParam0, -1f, 8.5f, 0f, 0f, 3.5f, 3.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_STEWPLATE01X"), 0f, 0f, 0f, "PLATE", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_STEWPLATE02X"), 0f, 0f, 0f, "PLATE_EMPTY", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CS_ROPE03BX"), 0f, 0f, 0f, "ROPE", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_KIECNV7"), GET_HASH_KEY("PLAYER_KIECNV7"));
	if (func_162(10))
	{
		func_163(uParam0);
		func_164(uParam0, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_405(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
