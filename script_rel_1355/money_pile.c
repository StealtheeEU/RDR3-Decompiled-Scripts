...
void func_6()
{
	...
	if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, GET_HASH_KEY("OBJECTEXCHANGE")) && !bLocal_5)
	{
		fVar0 = 1f;
		fVar1 = 1f;
		bVar2 = false;
		bLocal_5 = true;
		func_13(BUILTIN::FLOOR((fVar0 * BUILTIN::TO_FLOAT(func_12(GET_HASH_KEY("SCENARIOS_MONEY_PILE"))))), bVar2, fVar1, 1, 0, 0, 1, 752097756);
	}
