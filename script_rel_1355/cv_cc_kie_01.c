...
bool func_77(var uParam0)
{
	...
	func_162(uParam0, 0.0875f, 0.1625f, 1.4875f, 0f, 3.345f, 3.06f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_162(uParam0, 2.6625f, -5.6f, 1.1875f, 47.5f, 1.95f, 1.7025f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_162(uParam0, -0.375f, -7.25f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_163(uParam0, GET_HASH_KEY("P_BUCKET02X"), 0f, 0f, 0f, "p_bucket02x", 0, 1, 1);
	iLocal_95 = func_163(uParam0, GET_HASH_KEY("P_CS_ROPE03BX"), 0f, 0f, 0f, "p_cs_rope03x", 0, 0, 1);
	iLocal_96 = func_163(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "p_cuptin01x", 0, 0, 1);
	...
	func_166(uParam0, iLocal_93, 2, GET_HASH_KEY("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
	func_167(uParam0, iLocal_93, iLocal_95, "p_cs_rope03bx_PH_R_HAND", 0, 0);
	func_168(uParam0, iLocal_93, 1);
	func_169(uParam0, iLocal_93);
	func_170(uParam0, iLocal_92, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_166(uParam0, iLocal_92, 1, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_363(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_422(iParam1))
		{
			func_423(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_390(var uParam0, var uParam1)
{
	...
	if (!func_395(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_436("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
struct<5> func_540(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_552(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_544(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_544(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_544(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_562(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_544(GET_HASH_KEY("CHARACTER"), func_566(), -1591664384, bParam0);
}
