...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.025f, -0.0376f, 1.15f, 11.06f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, 1.85f, 2.5249f, 1.15f, 19.31f, 1.165f, 1.03f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -5.025f, 5.9499f, 1.15f, 11.06f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 1.0625f, 1.0873f, 1.15f, 38.56f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, iLocal_14, 1f);
	func_153(uParam0, iLocal_16, 1f);
	iLocal_18 = func_154(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_19 = func_154(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 1.78505f, 2.41607f, 0.00650024f, 0, 1, 0, 1);
	iLocal_23 = func_154(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_22 = func_154(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "Bowl_01", 0, 0, 1);
	func_154(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_21 = func_154(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	iLocal_20 = func_154(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON_01", 0, 0, 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_BLLCNV14"), GET_HASH_KEY("PLAYER_BLLCNV14"));
	func_158(uParam0, iLocal_17, -1, 0.88f);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", iLocal_18, 0);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", iLocal_19, 0);
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), 1, 0, 0);
	return true;
}
...
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), false);
}
...
int func_249()
{
	...
	if (func_324(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_250()
{
	...
	if (func_324(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_336(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_368(iParam1))
		{
			func_369(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_401(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_446(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_446(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_388(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_446(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_465(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_477(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_495(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_477(GET_HASH_KEY("CHARACTER"), func_499(), -1591664384, bParam0);
}
