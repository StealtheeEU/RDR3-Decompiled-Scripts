...
bool func_73(var uParam0)
{
	...
	iLocal_14 = func_152(uParam0, GET_HASH_KEY("A_C_DEER_01"), "DEER");
	func_153(uParam0, 0f, -0.5f, 1f, 0f, 2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "p_knife03x", 0, 1, 1);
	iLocal_17 = func_154(uParam0, GET_HASH_KEY("P_CS_MEATHANGER01X"), 0f, 0f, 0f, "HANGER", 0, 0, 1);
