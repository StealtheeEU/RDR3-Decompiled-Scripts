...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.4509f, -1.5456f, 1f, 0f, 4.2f, 2.365f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.3814f, -5.9283f, 1f, 0f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	iLocal_23 = func_152(uParam0, GET_HASH_KEY("P_KNIFE02X"), 0f, 0f, 0f, "Knife", 0, 0, 1);
	iLocal_24 = func_152(uParam0, GET_HASH_KEY("P_WOODWHITTLE01X"), 0f, 0f, 0f, "WOOD", 0, 0, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), vLocal_45, "Chair", 1, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), vLocal_48, 0, 1, 0, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_316(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_382(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
