...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.84f, -2.72f, 0f, -43.56f, 4f, 9f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "P_STICKFIREPOKER01X", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "P_STICKFIREPOKER01X^1", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "P_CIGARETTE_CS02X", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_MATCHSTICK01X"), 0f, 0f, 0f, "P_MATCHSTICK01X", 0, 1, 1);
	...
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_15, 3, 0);
	func_155(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, GET_HASH_KEY("COMP_JCKCNV3"), GET_HASH_KEY("PLAYER_JCKCNV3"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_JACK_POKE_GROUND"), "WORLD_CAMP_JACK_POKE_GROUND_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
