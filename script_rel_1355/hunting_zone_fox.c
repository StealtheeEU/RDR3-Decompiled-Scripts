...
bool func_42(var uParam0)
{
	*uParam0 = 11;
	uParam0->f_9 = 80f;
	uParam0->f_10 = 180f;
	uParam0->f_572[0] = GET_HASH_KEY("P_FOXSCAT01X");
	uParam0->f_572[1] = GET_HASH_KEY("BROKENSTICKS_AB");
	uParam0->f_572[2] = GET_HASH_KEY("P_FOXTUFTSFUR01X");
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 4;
	uParam0->f_580[2] = 1;
	uParam0->f_588[0] = 0;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_FOX_01");
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("META_OUTFIT_ANIMAL_ALBINO_FOX");
	return true;
}
