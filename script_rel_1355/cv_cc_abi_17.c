...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -0.792594f, -0.612121f, 0.981384f, 3f, 0.9f, 0.9f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_150(uParam0, -0.0645018f, -0.121576f, 0.728058f, 3f, 0.8f, 2f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_14 = func_151(uParam0, 13, 0);
	iLocal_15 = func_151(uParam0, 1, 0);
	iLocal_16 = func_152(uParam0, -1.95f, -0.0001f, 1.03f, 0f, 0f, 0f, 5.5f, 5.94f, 2f, "CCABI_17_CABIN", GET_HASH_KEY("VOLBOX"));
	if (!func_153(1) && !func_153(2))
	{
		func_154(uParam0, GET_HASH_KEY("P_CHAIR02X"), -0.756408f, -0.138455f, 0.0149841f, "CHAIR", 0, 0, 1);
	}
	if (!func_153(1) && !func_153(2))
	{
	...
	func_157(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	func_158(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
...
bool func_96(var uParam0)
{
	...
	{
		PED::_SET_PED_SHOULD_PLAY_DIRECTED_SCENARIO_EXIT(func_48(uParam0, iLocal_14), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(func_48(uParam0, iLocal_14), -1f, -1f, 0f));
	}
	return true;
}
...
void func_341(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_375(iParam1))
		{
			func_376(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_395(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_453(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_472(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
