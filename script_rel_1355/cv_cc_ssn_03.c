...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 5.1653f, 3.3586f, 0f, -10f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.6339f, -2.4567f, 0f, 3.7983f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	...
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, "SEAT", 0, 1, 1);
	func_153(uParam0, iLocal_14, 2, 0, 30, "Default_Angry", 0);
	func_154(uParam0, iLocal_14, 2, -1);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
...
bool func_93(var uParam0)
{
	...
	{
		PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_15), GET_HASH_KEY("MOTIONSTATE_RUN"), false, 0, false);
