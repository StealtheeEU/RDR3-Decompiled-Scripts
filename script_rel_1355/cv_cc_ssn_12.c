...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2125f, 1.65f, 1.4875f, 0f, 0.8675f, 0.8925f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 0.2875f, 5.2875f, 1.4875f, 0f, 1.125f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_SSNCNV12"), GET_HASH_KEY("PLAYER_SSNCNV12"));
