...
{
	func_55(9, 804, iLocal_229, iParam0, 0, 0, 2, -1082130432 /* Float: -1f */, 0, 0);
	func_56(9, 1);
	func_56(9, 16384);
	func_57(9, 1);
...
void func_47()
{
	...
	Local_183[0 /*45*/].f_43 = 10136;
	Local_183[0 /*45*/].f_44 = 10231;
...
int func_50(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(func_96(iParam3)))
	{
		return 0;
	}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_164(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_164(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_164(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_164(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_170(func_169(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_140(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_145(iParam0)))
	{
		return false;
	}
...
char* func_164(char* sParam0, int iParam1)
{
	...
	return func_251(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_229(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319.f_17371 || func_302(func_145(*uParam0), 1, 1, 1, 0)) || PED::IS_PED_HOGTIED(func_145(*uParam0)))
	{
		func_298(uParam0);
		return uParam0->f_30;
	}
	if ((((func_101(PLAYER::PLAYER_ID(), 1, 0, 1) || func_303()) || LAW::_0xF46108C50A22B029()) || LAW::ARE_WITNESSES_ACTIVE(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return false;
	}
...
bool func_231(int iParam0)
{
	...
	return func_221(iParam0, 1073741824 /* Float: 2f */);
}

void func_232(int iParam0)
{
	func_291(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_302(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_336(iVar0, 0)))
		{
