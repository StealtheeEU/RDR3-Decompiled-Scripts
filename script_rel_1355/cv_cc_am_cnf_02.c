...
bool func_79(var uParam0)
{
	...
	func_159(uParam0, -0.45f, -0.92f, 0f, -96.48f, 3.955f, 4.8675f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
...
void func_229(var uParam0)
{
	...
	if (bLocal_61)
	{
		if (func_352(Global_35, 0, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED") || func_352(Global_35, 1, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED"))
		{
...
int func_283()
{
	...
	if (func_386(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_284()
{
	...
	if (func_386(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_289(int iParam0)
{
	...
	Var7 = { func_387(GET_HASH_KEY("KILLS"), GET_HASH_KEY("ANIMAL")) };
	STATS::STAT_ID_GET_INT(&Var7, &iVar0);
	Var7 = { func_388(GET_HASH_KEY("ANIMALS_LONG_LOOTED")) };
...
bool func_290(int iParam0)
{
	...
	iVar0 = func_389(GET_HASH_KEY("NUM_INNOCENT_PEDS_PUNCHED"));
	if (iVar0 == 0)
	{
		return false;
	}
...
bool func_291(int iParam0)
{
	...
	iVar0 = func_389(GET_HASH_KEY("NUM_PEDS_ANTAGONIZED"));
	if (iVar0 == 0)
	{
		return false;
	}
...
bool func_292(int iParam0)
{
	...
	Var2 = { func_388(GET_HASH_KEY("NUM_WOMEN_HURT")) };
	STATS::STAT_ID_GET_INT(&Var2, &iVar0);
	Var2 = { func_387(GET_HASH_KEY("KILLS"), GET_HASH_KEY("HUMAN")) };
...
void func_402(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_452(iParam1))
		{
			func_453(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_386(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_468(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_547(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_559(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_551(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_551(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_551(GET_HASH_KEY("CHARACTER"), func_573(), -1591664384, bParam0);
}
