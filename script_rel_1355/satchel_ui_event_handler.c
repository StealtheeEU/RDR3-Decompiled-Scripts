...
int func_7()
{
	...
	switch (iVar0)
	{
		...
		case 2:
			...
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_10206, MISC::VAR_STRING(10, "SHOP_ITEM_VALUE", func_80(MISC::_GET_STRING_FROM_FLOAT(fVar3, 2), GET_HASH_KEY("COLOR_PURE_WHITE"))));
...
bool func_25(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_119(iParam0) == GET_HASH_KEY("EMOTE"))
	{
		Var0.f_3 = 0;
		Var0.f_1 = iParam0;
		Var0.f_2 = 0;
	...
	else if (func_119(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
		...
		else
		{
			switch (func_121(iParam0))
			{
				...
				case -1719060085:
					...
					{
						func_130(Global_35, GET_HASH_KEY("CLOTHING_ITEM_GLOVES_NONE"), 0, -358215195, 1, 1, 1, 0, 1, 0);
				...
				else
				{
					...
					else
					{
						...
						if (!func_133(Global_1392040.f_1, 1) || func_133(Global_1392040.f_1, 512))
						{
							...
							else if (func_122(GET_HASH_KEY("KIT_CAMP")))
							{
								if (func_139(1))
								{
									func_140(2);
						...
						if (func_143(Global_35, 1, 0, 0) != GET_HASH_KEY("WEAPON_KIT_BINOCULARS"))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_KIT_BINOCULARS"), true, 0, false, false);
						}
						return true;
						Jump @2534; //curOff = 2241
						if (func_143(Global_35, 1, 0, 0) != GET_HASH_KEY("WEAPON_KIT_CAMERA"))
						{
						...
						func_149(iParam0, 1, 0, 562618531, 0);
						func_152(GET_HASH_KEY("PROVISION_BEAUS_GIFT_2"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
...
void func_28()
{
	...
	if (func_119(Global_1935689.f_10190) == GET_HASH_KEY("CONSUMABLE"))
	{
	...
	if (func_121(Global_1935689.f_10190) == -854348463)
	{
		...
		{
			func_157(func_156(0), 0, GET_HASH_KEY("CI_TAG_FOLDER_KIT_WATCHES"));
		}
		else
		{
...
void func_31(int iParam0)
{
	...
	if (Global_1900073.f_17 && func_143(Global_35, 1, 0, 0) == GET_HASH_KEY("WEAPON_FISHINGROD"))
	{
...
void func_63()
{
	func_204(GET_HASH_KEY("SATCHEL_ELEMENTS"), &(Global_1935689.f_10225), 600, -1, 0, 0);
	func_205();
}
...
int func_64(var uParam0)
{
	...
	*uParam0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER_FROM_PATH("", "Satchel");
	...
	Global_1935689.f_10216 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, "PromptHoldSelectLabel", GET_HASH_KEY("SATCHEL_PROMPT_BREAKDOWN"));
	...
	Global_1935689.f_10221 = DATABINDING::_DATABINDING_ADD_DATA_STRING(*uParam0, "PromptDiscardAllLabel", HUD::GET_STRING_FROM_HASH_KEY(GET_HASH_KEY("SATCHEL_PROMPT_DISCARD_ALL")));
	...
	iVar5 = GET_HASH_KEY("SATCHEL_TITLE");
	if (func_209(GET_HASH_KEY("CLOTHING_HL_PLAYER_SATCHEL_008_1")))
	{
		iVar5 = -1401261769;
	}
...
int func_66(int iParam0)
{
	switch (iParam0)
	{
		...
		case -182626652:
			...
			{
				return GET_HASH_KEY("SHOP_PEARSON_DONATE");
			}
			else
			{
				return -161395681;
...
void func_95()
{
	switch (Global_1935689.f_10189)
	{
		case -156634416:
			...
			break;
		case 1561961676:
			if (func_257(GET_HASH_KEY("MONEY_LOANSHARK_GWEN_DEBT"), 1, 0))
			{
				func_258(GET_HASH_KEY("MONEY_LOANSHARK_GWEN_DEBT"), 0);
			}
			break;
	}
}
...
void func_100(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_161(iParam0, 0))
	{
		...
		if (func_27(0) || func_68())
		{
			...
			{
				DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_10206, MISC::VAR_STRING(10, "SEND_ITEM_VALUE", func_80(MISC::_GET_STRING_FROM_FLOAT(fVar8, 2), GET_HASH_KEY("COLOR_PURE_WHITE"))));
			}
			else if (Global_1914319.f_16855 == 19)
			{
				if (uParam2->f_1)
			...
			{
				DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_10206, MISC::VAR_STRING(10, "SHOP_ITEM_VALUE", func_80(MISC::_GET_STRING_FROM_FLOAT(fVar8, 2), GET_HASH_KEY("COLOR_PURE_WHITE"))));
			}
...
{
	if ((!func_111(iParam1, 747873593) && !func_111(iParam1, GET_HASH_KEY("CI_TAG_FOLDER_LETTERS"))) && !func_111(iParam1, GET_HASH_KEY("CI_TAG_FOLDER_NOTES")))
	{
		return;
	}
...
void func_104(int iParam0)
{
	...
	{
		if (PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_GAME_MENU_OPTION")))
		{
			PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_OPTION"), false);
		}
		if (PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_GAME_MENU_EXTRA_OPTION")))
		{
			PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_EXTRA_OPTION"), false);
		}
		Global_1935689.f_19.f_203 = 0;
...
{
	if (func_119(iParam0) == GET_HASH_KEY("EMOTE"))
	{
		return false;
	}
...
void func_112(int iParam0, struct<11> Param1, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, struct<2> Param17, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, int iParam27, bool bParam28, int iParam29)
{
	switch (iParam0)
	{
		...
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_REWARD2"):
			if (func_276())
			{
				func_277(GET_HASH_KEY("JOURNAL_RC_MAYOR4_AR"), 0);
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_MAYOR4_AR")))
			{
				func_277(GET_HASH_KEY("JOURNAL_RC_MAYOR4B_JN"), 0);
			}
			break;
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_REWARD2_JN"):
			func_277(GET_HASH_KEY("JOURNAL_RC_MAYOR4A_JN"), 0);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_RCM_FMA_LETTER"):
			...
			if (func_276() == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_RC_FMA5_1_AR"), 0);
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_FMA5_1_AR")))
			{
				if (func_279(77))
				{
					func_277(GET_HASH_KEY("JOURNAL_RC_FMA5_2_JN"), 0);
				}
				else
				{
					func_277(GET_HASH_KEY("JOURNAL_RC_FMA5_1_JN"), 0);
				}
			}
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			if ((func_280() && !func_281(51)) && !func_282(1048576))
			{
				...
				func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 2, 0);
				func_286(1048576);
			}
			break;
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			if ((func_280() && !func_281(51)) && !func_282(16384))
			{
				func_283(1);
				func_284(51, 0, 0, 0, 0, -1, 0);
				func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 5, 0);
				func_286(16384);
			}
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_ROCK_CARVINGS"):
			if ((func_280() && !func_281(50)) && !func_293(32))
			{
				...
				if (!func_296(Global_1347702[50 /*49*/].f_15, 1))
				{
					if (func_276() == 1)
					{
						func_277(GET_HASH_KEY("JOURNAL_RC_ROCKCARV15_AR"), 0);
					}
					else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_ROCKCARV15_AR")))
					{
						func_277(GET_HASH_KEY("JOURNAL_RC_ROCKCARV15_JN"), 0);
					}
				}
			}
			break;
...
bool func_122(int iParam0)
{
	...
	if (func_119(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
		if (func_121(iParam0) == -999503751)
		{
...
void func_129(int iParam0)
{
	...
	if (iVar1 == iParam0)
	{
		...
		func_130(Global_35, GET_HASH_KEY("CLOTHING_ITEM_HAT_NONE"), 0, -358215195, 1, 1, 1, 0, 1, 0);
		func_131(iParam0, 0);
		return;
	}
...
bool func_149(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (func_119(iParam0) == GET_HASH_KEY("WEAPON"))
	{
...
int func_152(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_119(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_119(iParam0) == GET_HASH_KEY("AMMO") && func_393(iParam0))
		{
		...
		{
			func_398(func_397(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_398(func_399(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_111(iParam0, 589988438))
		{
			if (func_401())
			{
				func_402(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_130(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_414(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_130(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_420(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_421(499813453, 0);
				func_422(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_420(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_421(499813453, 0);
				func_422(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_420(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_421(499813453, 0);
				func_422(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_420(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_421(666607663, 0);
				func_423(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_420(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_421(666607663, 0);
				func_423(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_420(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_421(666607663, 0);
				func_423(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_420(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_421(-220219788, 0);
				func_424(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_420(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_421(-220219788, 0);
				func_424(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_420(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_421(-220219788, 0);
				func_424(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_420(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_421(218622660, 0);
				func_425(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_420(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_421(218622660, 0);
				func_425(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_420(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_421(390004462, 0);
				func_426(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_420(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_421(390004462, 0);
				func_426(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_420(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_421(390004462, 0);
				func_426(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_420(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_421(6410548, 0);
				func_427(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_420(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_421(6410548, 0);
				func_427(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_420(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_421(6410548, 0);
				func_427(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_420(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_421(6410548, 0);
				func_427(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_428(242, func_266(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_428(240, func_266(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_428(241, func_266(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
...
struct<5> func_153(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_119(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_154(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_154(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	if (iParam0 == GET_HASH_KEY("PROVISION_ROTTEN_MEAT") || iParam0 == GET_HASH_KEY("CONSUMABLE_CORNEDBEEF_CAN"))
	{
		return false;
	}
	if (func_111(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")) || func_111(iParam0, -839724752))
	{
		if (bParam2)
		{
...
bool func_162(int iParam0)
{
	...
	else if ((func_257(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 1, 0) && func_25(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 0, 0, 0, 1, 0, 0)) || (func_257(GET_HASH_KEY("KIT_CAMP"), 1, 0) && func_25(GET_HASH_KEY("KIT_CAMP"), 0, 0, 0, 1, 0, 0)))
	{
...
bool func_173(bool bParam0, bool bParam1)
{
	...
	if (func_469(GET_HASH_KEY("SIMPLE_CRAFTING")) || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("SIMPLE_CRAFTING")) > 0)
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_ACTIVITY", 10000, 0, 0, 0, 1);
		...
		while (iVar3 <= iVar32)
		{
			if (func_233(&Var4, iVar3, iVar1, iVar2))
			{
				...
				else
				{
					...
					else if (Var4.f_4 != GET_HASH_KEY("CUSTOM_SATCHEL"))
					{
...
{
	func_491(iParam0, GET_HASH_KEY("WEAPON_KIT_BINOCULARS"), func_32(32));
	func_491(iParam0, GET_HASH_KEY("WEAPON_KIT_CAMERA"), func_32(64));
	func_491(iParam0, GET_HASH_KEY("KIT_HORSE_BRUSH"), func_32(1024));
...
void func_208(var uParam0)
{
	...
	func_504(uParam0, 0, "All", GET_HASH_KEY("SATCHEL_NAV_ALL"));
	func_504(uParam0, -1666604090, "Provisions", GET_HASH_KEY("SATCHEL_NAV_PROVISIONS"));
	func_504(uParam0, -96974025, "Remedies", GET_HASH_KEY("SATCHEL_NAV_REMEDIES"));
	func_504(uParam0, -1268291907, "Ingredients", GET_HASH_KEY("SATCHEL_NAV_INGREDIENTS"));
	func_504(uParam0, -1559802791, "Materials", GET_HASH_KEY("SATCHEL_NAV_MATERIALS"));
	func_504(uParam0, -156634416, "Kit", GET_HASH_KEY("SATCHEL_NAV_KIT"));
	func_504(uParam0, 1561961676, "Valuables", GET_HASH_KEY("SATCHEL_NAV_VALUABLES"));
	func_504(uParam0, 1061777683, "Documents", GET_HASH_KEY("SATCHEL_NAV_DOCUMENTS"));
	func_505(uParam0);
	func_506(uParam0);
	if (func_27(0))
	{
...
{
	if ((func_111(iParam0, -839724752) || func_111(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL"))) || func_111(iParam0, 1286414894))
	{
		return true;
	}
	return false;
...
void func_236(struct<11> Param0, var uParam11, var uParam12, var uParam13, int iParam14)
{
	...
	if (func_161(Param0.f_4, 0))
	{
		...
		DATABINDING::_DATABINDING_WRITE_DATA_SCRIPT_VARIABLES(0, uVar2, iVar0, iVar4, Param0.f_10, bVar3, GET_HASH_KEY("COLOR_PURE_WHITE"));
...
bool func_249(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_HIGH_QUALITY"):
			return false;
	}
	...
	if (func_119(iParam0) == GET_HASH_KEY("UPGRADE") && !(func_111(iParam0, -1540973036) || func_111(iParam0, 1192444843)))
	{
		return false;
	}
	return true;
...
void func_255(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14)
{
	...
	if (func_161(Param0.f_4, 0))
	{
		...
		if (func_68())
		{
			if (!bVar0 || Param0.f_4 == GET_HASH_KEY("PROVISION_OLD_BRASS_COMPASS"))
			{
				return;
			}
		}
		...
		func_541(GET_HASH_KEY("INVENTORY_ITEM"), iVar1, &vVar3, bVar0, iVar7, bVar2, iVar6, GET_HASH_KEY("COLOR_PURE_WHITE"));
...
void func_256()
{
	if (func_251() != 2)
	{
		if (func_257(GET_HASH_KEY("WEAPON_KIT_BINOCULARS"), 1, 0))
		{
			func_258(GET_HASH_KEY("WEAPON_KIT_BINOCULARS"), 0);
		}
		if (func_257(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 1, 0))
		{
			func_258(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 0);
		}
		func_542();
		if (func_257(GET_HASH_KEY("KIT_CAMP"), 1, 0))
		{
			func_258(GET_HASH_KEY("KIT_CAMP"), 0);
		}
		else if (func_257(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 1, 0))
		{
			func_258(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 0);
		}
		func_543();
	}
}
...
{
	func_547(0);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(func_548(), GET_HASH_KEY("SATCHEL_PROMPT_OPEN"));
...
void func_284(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_570(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_570(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_300(var uParam0)
{
	...
	if (func_585(*uParam0, GET_HASH_KEY("HATS"), 0))
	{
		return true;
	}
	return false;
...
{
	return func_630(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, GET_HASH_KEY("VOLCYLINDER"), iParam0, iParam1);
}
...
void func_360(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_636(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_111(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
struct<2> func_361(int iParam0)
{
	...
	if (func_111(iParam0, -305066475))
	{
		if (func_62() == -1)
		{
			...
			{
				return func_638(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_638(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_111(iParam0, -537818634))
	{
		return func_638(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_111(iParam0, 2084895747))
	{
		return func_638(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
bool func_392(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_653(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_670())
				{
					return false;
				}
...
bool func_394(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_257(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_395(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_674()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_401()
{
	if (((((func_682(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_682(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_682(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_682(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_682(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_682(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_403(int iParam0)
{
	...
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_284(51, 0, 0, 0, 0, -1, 0);
			func_286(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_284(51, 0, 0, 0, 0, -1, 0);
			func_286(524288);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_DINO_BONES"):
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_285(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_686(1), 0, -1, 0);
			func_687(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_285(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_686(2), 0, -1, 0);
			func_687(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_285(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_686(4), 0, -1, 0);
			func_687(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_285(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_686(8), 0, -1, 0);
			func_687(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_285(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_686(16), 0, -1, 0);
			func_687(16);
			break;
	}
}
...
void func_406(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_150(437, 0);
			func_150(440, 0);
			func_690(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_573(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_286(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_690(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_573(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_286(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_690(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_573(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_286(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_690(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_573(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_286(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_150(438, 0);
			func_690(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_285(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_573(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_286(32768);
			break;
		default:
			func_150(439, 0);
...
void func_408(int iParam0, int iParam1)
{
	...
	if (func_62() == -1)
	{
		...
		{
			func_692(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_693() == 0)
			{
				func_657(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_692(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_693() == 1)
			{
				func_657(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_695(iParam0) < func_696(iParam0))
					{
						func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_692(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_693() == 2)
			{
				func_657(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_697(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_698(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_656(48);
					}
					if (func_695(iParam0) < func_696(iParam0))
					{
						func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_692(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_693() == 3)
			{
				func_657(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_695(iParam0) < func_696(iParam0))
					{
						func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_692(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_693() == 4)
			{
				func_657(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_695(iParam0) < func_696(iParam0))
					{
						func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_411(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_402(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_402(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_402(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_402(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_402(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_402(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_402(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_402(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_402(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_402(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_402(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_402(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_702())
			{
				func_402(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_402(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_402(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_402(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_402(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_402(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_402(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_402(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_402(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_402(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_402(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_402(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_402(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_402(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_412(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_657(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_703(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_704(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_705(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_421(int iParam0, bool bParam1)
{
	...
	func_570(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_434(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_605(81053684, 0) <= 0)
			{
	...
	{
		if (!func_713(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_130(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_386(24);
		if (func_414(&iVar2, 0))
		{
...
int func_436(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_715(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
void func_438(int iParam0, char* sParam1)
{
	...
	func_637(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_719(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}

struct<4> func_439(bool bParam0)
{
	return func_154(GET_HASH_KEY("CHARACTER"), func_720(), -1591664384, bParam0);
}
...
int func_447(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == GET_HASH_KEY("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_723(GET_HASH_KEY("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == GET_HASH_KEY("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_725(GET_HASH_KEY("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_726(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_727(GET_HASH_KEY("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
bool func_490(int iParam0)
{
	...
	iVar0 = func_119(iParam0);
	if ((iVar0 == GET_HASH_KEY("WEAPON") && iParam0 != GET_HASH_KEY("WEAPON_KIT_BINOCULARS")) && iParam0 != GET_HASH_KEY("WEAPON_KIT_CAMERA"))
	{
		return false;
	}
	if (iVar0 == GET_HASH_KEY("MONEY") && iParam0 != GET_HASH_KEY("MONEY_LOANSHARK_GWEN_DEBT"))
	{
		return false;
	}
	switch (iVar0)
	{
		case GET_HASH_KEY("HORSE_EQUIPMENT"):
		case GET_HASH_KEY("COUPON"):
		case GET_HASH_KEY("HORSE"):
		case GET_HASH_KEY("EMOTE"):
		case GET_HASH_KEY("WEAPON_MOD"):
		case GET_HASH_KEY("FEE"):
		case GET_HASH_KEY("ACTIVE_CARD"):
		case GET_HASH_KEY("AMMO"):
		case GET_HASH_KEY("WEAPON_DECORATION"):
		case GET_HASH_KEY("ABILITY_CARD"):
		case GET_HASH_KEY("GOLD"):
		case GET_HASH_KEY("COMPONENT"):
		case GET_HASH_KEY("MINIGAME"):
		case GET_HASH_KEY("ADVERT"):
		case GET_HASH_KEY("CORE_ITEM"):
		case GET_HASH_KEY("PASSIVE_CARD"):
			return false;
		case GET_HASH_KEY("CLOTHING"):
			switch (func_121(iParam0))
			{
				case -525676072:
					if (iParam0 == GET_HASH_KEY("KIT_MASK_GREY_CLOTH"))
					{
						return true;
					}
					else
...
void func_505(var uParam0)
{
	if (func_84())
	{
		func_504(uParam0, -283002878, "Horse", GET_HASH_KEY("SATCHEL_NAV_HORSE"));
	}
}
...
void func_506(var uParam0)
{
	if (func_27(0))
	{
		if (func_251() == 2)
		{
			func_504(uParam0, -693134279, "Send", GET_HASH_KEY("SATCHEL_NAV_SEND"));
		}
		else
		{
			func_504(uParam0, -182626652, "Sell", GET_HASH_KEY("SATCHEL_NAV_SELL"));
		}
	}
	else if (func_68())
	{
		func_504(uParam0, -2074770370, "Donations", GET_HASH_KEY("SATCHEL_NAV_DONATE"));
	}
}
...
bool func_519(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		if ((!func_161(iParam0, 0) || iParam0 == GET_HASH_KEY("CUSTOM_SATCHEL")) || iParam0 == GET_HASH_KEY("KIT_WARDROBE"))
		{
			return false;
		}
	}
	...
	switch (iParam1)
	{
		...
		case -2074770370:
			...
			else if (func_259(iParam0, -949239683) == -1337515701 && iParam0 != GET_HASH_KEY("KIT_PLAYER_POCKETWATCH"))
			{
				return true;
			}
			else
...
bool func_520(int iParam0)
{
	...
	else if (func_24())
	{
		...
		if (((!func_111(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")) && !func_111(iParam0, -839724752)) && !func_111(iParam0, -1457797660)) && !func_111(iParam0, 1286414894))
		{
			return false;
		}
	...
	if (func_111(iParam0, 949916894) || iParam0 == GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"))
	{
		if (!func_492(iParam0))
		{
			return false;
...
int func_531(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_384(iParam0, 8388608))
		{
			...
			{
				if (func_257(GET_HASH_KEY("DOCUMENT_RARE_ORCHID_ORDER_1"), 1, 0))
				{
					if (!func_772(48))
					{
						return 0;
			...
			else if (iParam0 == GET_HASH_KEY("DOCUMENT_RARE_ORCHID_ORDER_1"))
			{
				return 0;
			}
			else
...
void func_535(int iParam0, var uParam1, bool bParam2)
{
	...
	if (func_782(iVar17, &Var0, &iVar14, &iVar15))
	{
		...
		while (iVar16 < iVar15)
		{
			...
			{
				if (func_161(Var18.f_4, 0) && Var18.f_4 != GET_HASH_KEY("CUSTOM_SATCHEL"))
				{
					*uParam1++;
...
Vector3 func_539(int iParam0)
{
	...
	if (!func_789(iParam0, &vVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		vVar0.f_1 = GET_HASH_KEY("INVENTORY_ITEMS");
		vVar0.x = GET_HASH_KEY("_PLACEHOLDER");
	}
	return vVar0;
}
...
void func_542()
{
	...
	if (func_257(GET_HASH_KEY("KIT_CAMP"), 1, 0))
	{
		...
		{
			iVar0 = func_199(0);
			bVar1 = INVENTORY::_0x3D10D7179D7034AF(iVar0, GET_HASH_KEY("KIT_CAMP"), func_27(0));
			func_149(GET_HASH_KEY("KIT_CAMP"), 1, 1, -142743235, 0);
			func_152(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
			Global_1935496.f_125 = 0;
			Global_1935496.f_126 = 1;
			if (bVar1)
			{
				INVENTORY::_0x766315A564594401(iVar0, GET_HASH_KEY("KIT_CAMP_SIMPLE"), 0);
			}
			else
			{
				INVENTORY::_0x6A564540FAC12211(iVar0, GET_HASH_KEY("KIT_CAMP_SIMPLE"));
			}
		}
	}
	else if (func_257(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 1, 0))
	{
		...
		{
			iVar2 = func_199(0);
			bVar3 = INVENTORY::_0x3D10D7179D7034AF(iVar2, GET_HASH_KEY("KIT_CAMP_SIMPLE"), func_27(0));
			func_149(GET_HASH_KEY("KIT_CAMP_SIMPLE"), 1, 1, -142743235, 0);
			func_152(GET_HASH_KEY("KIT_CAMP"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
			Global_1935496.f_125 = 1;
			Global_1935496.f_126 = 0;
			if (bVar3)
			{
				INVENTORY::_0x766315A564594401(iVar2, GET_HASH_KEY("KIT_CAMP"), 0);
			}
			else
			{
				INVENTORY::_0x6A564540FAC12211(iVar2, GET_HASH_KEY("KIT_CAMP"));
			}
		}
	}
}
...
void func_549(int iParam0)
{
	...
	{
		if (iParam0 == GET_HASH_KEY("PROVISION_RCM_POCKET_WATCH"))
		{
			func_792();
		}
		else
	...
	else if (func_259(iParam0, 1224357681) == GET_HASH_KEY("CI_TAG_FOLDER_KIT_KEEPSAKES"))
	{
		switch (iParam0)
		{
			case GET_HASH_KEY("PROVISION_PEARSONS_NAVAL_COMPASS"):
			case GET_HASH_KEY("PROVISION_MOLLYS_POCKET_MIRROR"):
			case GET_HASH_KEY("PROVISION_BEAUS_GIFT_1"):
				func_547(0);
				break;
			default:
				func_792();
	...
	else if ((((((((((((func_111(iParam0, 1101678925) || func_111(iParam0, 1686880204)) || func_111(iParam0, 173360570)) || func_111(iParam0, -121341956)) || func_111(iParam0, 2000026003)) || func_111(iParam0, -1540973036)) || func_111(iParam0, 1192444843)) || func_111(iParam0, -1242251796)) || func_111(iParam0, 2084895747)) || func_259(iParam0, 1224357681) == GET_HASH_KEY("CI_TAG_FOLDER_KIT_KEYCHAIN")) || (func_220(iParam0) && !func_111(iParam0, 316290104))) || iParam0 == GET_HASH_KEY("CONSUMABLE_COFFEE_GNDS_REG")) || iParam0 == GET_HASH_KEY("KIT_GUN_OIL"))
	{
		func_792();
	}
	else if ((func_121(iParam0) == 1802292908 && func_259(iParam0, -949239683) == 0) && !iParam0 == GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"))
	{
		func_792();
	}
...
int func_550(int iParam0)
{
	if (DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1935689.f_10218))
	{
		if (func_111(iParam0, 316290104))
		{
			return GET_HASH_KEY("SATCHEL_PROMPT_BREAKDOWN");
		}
	...
	else if (func_259(iParam0, 1224357681) == GET_HASH_KEY("CI_TAG_FOLDER_KIT_WATCHES"))
	{
		return -1948542959;
	}
	return -31549930;
...
void func_551(int iParam0, var uParam1)
{
	...
	switch (func_121(iParam0))
	{
		...
		case 320213863:
			...
			break;
		case -1691255343:
			if (iParam0 == GET_HASH_KEY("PROVISION_LIGHTNING_CONDUCTOR") || iParam0 == GET_HASH_KEY("KIT_GUN_OIL"))
			{
				bVar0 = false;
			}
			break;
	}
	if (func_119(iParam0) == GET_HASH_KEY("MONEY"))
	{
		bVar0 = false;
	}
...
int func_582()
{
	...
	if (iVar1 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		...
		else if ((WEAPON::IS_WEAPON_VALID(iVar0) && func_822(iVar0)) || iVar0 == GET_HASH_KEY("WEAPON_LASSO"))
		{
			return 1;
		}
		else
...
void func_584(int iParam0, bool bParam1)
{
	...
	if (func_119(iParam0) == GET_HASH_KEY("CONSUMABLE"))
	{
		...
		{
			func_398(func_638(GET_HASH_KEY("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_111(iParam0, -1457797660))
		{
			func_398(func_638(GET_HASH_KEY("PROVISION_ITEMS_USED")), 1);
		}
		if (bVar40)
		{
			func_398(func_638(GET_HASH_KEY("DEADEYE_ITEMS_USED")), 1);
		}
			...
			if (func_111(iParam0, 412399755))
			{
				...
				if (func_693() == 0)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_695(iParam0) < func_696(iParam0))
						{
							func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(iParam0, 709057512))
			{
				...
				if (func_693() == 1)
				{
					...
					if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_695(iParam0) < func_696(iParam0))
						{
							func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(iParam0, -1478961327))
			{
				...
				if (func_693() == 2)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_ACUNAS_STAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CIGAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_695(iParam0) < func_696(iParam0))
						{
							func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(iParam0, -1238404098))
			{
				...
				if (func_693() == 3)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_695(iParam0) < func_696(iParam0))
						{
							func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(iParam0, 1160548794))
			{
				...
				if (func_693() == 4)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_695(iParam0) < func_696(iParam0))
						{
							func_285(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
{
	return func_119(iParam0) == GET_HASH_KEY("WEAPON");
}
...
void func_656(int iParam0)
{
	...
	func_637(MISC::VAR_STRING(6, func_881(iParam0), fVar1), "itemtype_textures", func_882(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_662(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_62() == -1)
			{
				if (!func_713(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_892(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_670())
					{
					...
					func_130(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
bool func_675(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_119(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_62() != -1;
...
int func_683(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_257(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_684(int iParam0, char* sParam1, int iParam2)
{
	...
	func_637(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_685(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_637(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_637(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_398(func_638(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_719(int iParam0)
{
	...
	if (!func_789(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
bool func_748(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1779021115:
			if (func_161(iParam1, 0))
			{
				if (iParam1 == GET_HASH_KEY("WEAPON_KIT_CAMERA"))
				{
					return func_187(64);
				}
			}
...
int func_759(int iParam0, int iParam1)
{
	...
	switch (Global_1935689.f_17)
	{
		case 1:
			...
			{
				if ((func_111(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")) || func_111(iParam0, -839724752)) || func_111(iParam0, -136654233))
				{
					return 1;
				}
			}
		...
		case 2:
			if (iParam1 == -2074770370)
			{
				if ((((((((func_111(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")) || func_111(iParam0, -839724752)) || func_111(iParam0, -136654233)) || func_111(iParam0, 554195525)) || func_111(iParam0, -1238310989)) || func_111(iParam0, 2127114599)) || func_111(iParam0, -1864584831)) || func_111(iParam0, 1068498601)) || func_111(iParam0, 1967571132))
				{
					return 1;
				}
			}
...
void func_766(int iParam0)
{
	...
	Var1 = func_960(iVar0);
	func_541(-1715238242, iParam0, &Var1, func_961(iParam0), 1, 0, 0, GET_HASH_KEY("COLOR_PURE_WHITE"));
	Global_1935689.f_19.f_203++;
...
int func_769(int iParam0)
{
	...
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			return GET_HASH_KEY("TAXIDERMY_ORDER_01");
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			return GET_HASH_KEY("TAXIDERMY_ORDER_02");
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			return GET_HASH_KEY("TAXIDERMY_ORDER_03");
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			return GET_HASH_KEY("TAXIDERMY_ORDER_04");
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			return GET_HASH_KEY("TAXIDERMY_ORDER_05");
		default:
			break;
	}
	return 0;
...
int func_771(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_01"):
			return GET_HASH_KEY("BONE_00");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_02"):
			return GET_HASH_KEY("BONE_01");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_03"):
			return GET_HASH_KEY("BONE_02");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_04"):
			return GET_HASH_KEY("BONE_03");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_05"):
			return GET_HASH_KEY("BONE_04");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_06"):
			return GET_HASH_KEY("BONE_05");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_07"):
			return GET_HASH_KEY("BONE_06");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_08"):
			return GET_HASH_KEY("BONE_07");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_09"):
			return GET_HASH_KEY("BONE_08");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_10"):
			return GET_HASH_KEY("BONE_09");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_11"):
			return GET_HASH_KEY("BONE_10");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_12"):
			return GET_HASH_KEY("BONE_11");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_13"):
			return GET_HASH_KEY("BONE_12");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_14"):
			return GET_HASH_KEY("BONE_13");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_15"):
			return GET_HASH_KEY("BONE_14");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_16"):
			return GET_HASH_KEY("BONE_15");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_17"):
			return GET_HASH_KEY("BONE_16");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_18"):
			return GET_HASH_KEY("BONE_17");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_19"):
			return GET_HASH_KEY("BONE_18");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_20"):
			return GET_HASH_KEY("BONE_19");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_21"):
			return GET_HASH_KEY("BONE_20");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_22"):
			return GET_HASH_KEY("BONE_21");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_23"):
			return GET_HASH_KEY("BONE_22");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_24"):
			return GET_HASH_KEY("BONE_23");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_25"):
			return GET_HASH_KEY("BONE_24");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_26"):
			return GET_HASH_KEY("BONE_25");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_27"):
			return GET_HASH_KEY("BONE_26");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_28"):
			return GET_HASH_KEY("BONE_27");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_29"):
			return GET_HASH_KEY("BONE_28");
		case GET_HASH_KEY("DOCUMENT_DINO_BONES_MAILER_LETTER_30"):
			return GET_HASH_KEY("BONE_29");
		default:
			break;
	}
	return 0;
...
int func_773(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_01"):
			return GET_HASH_KEY("ROCK_00_GRZ");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_02"):
			return GET_HASH_KEY("ROCK_01_GRZ");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_03"):
			return GET_HASH_KEY("ROCK_02_CML");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_04"):
			return GET_HASH_KEY("ROCK_03_CML");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_05"):
			return GET_HASH_KEY("ROCK_04_BGV");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_06"):
			return GET_HASH_KEY("ROCK_05_BGV");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_07"):
			return GET_HASH_KEY("ROCK_06_HRT");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_08"):
			return GET_HASH_KEY("ROCK_07_HRT");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_09"):
			return GET_HASH_KEY("ROCK_08_ROA");
		case GET_HASH_KEY("DOCUMENT_ROCK_CARVINGS_MAILER_LETTER_10"):
			return GET_HASH_KEY("ROCK_09_ROA");
		default:
			break;
	}
	return 0;
...
int func_775(int iParam0)
{
	...
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			return GET_HASH_KEY("LEGENDARY_FISH_01");
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			return GET_HASH_KEY("LEGENDARY_FISH_02");
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
		...
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			return GET_HASH_KEY("LEGENDARY_FISH_07");
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			return GET_HASH_KEY("LEGENDARY_FISH_08");
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			return GET_HASH_KEY("LEGENDARY_FISH_09");
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
		...
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			return GET_HASH_KEY("LEGENDARY_FISH_13");
		default:
			break;
	}
	return 0;
...
int func_776(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((((((((((((((((((((iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RAT_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_WOODPECKER_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ORIOLE_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ROBIN_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SPARROW_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TOAD_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CROW_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BAT_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BLUEJAY_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BULLFROG_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"))
	{
		if (func_257(iVar0, 1, 0))
		{
			if (bParam2)
	...
	else if ((((((((((iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SKUNK_PERFECT") || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BEAVER_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_OPOSSUM_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RABBIT_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"))
	{
...
void func_780(int iParam0, var uParam1)
{
	...
	if (func_782(iVar18, &Var1, &iVar15, &iVar16))
	{
		...
		while (iVar17 < iVar16)
		{
			...
			{
				if (func_161(Var19.f_4, 0) && Var19.f_4 != GET_HASH_KEY("CUSTOM_SATCHEL"))
				{
...
bool func_794()
{
	...
	if (func_368(8388608))
	{
		iVar0 = TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_35);
		iVar1 = iVar0;
		if (((iVar1 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL1") || iVar1 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL2")) || iVar1 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL3")) || iVar1 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL4"))
		{
			return true;
		}
		return false;
...
{
	if (func_967(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_804()
{
	...
	while (iVar1 < 30)
	{
		if (func_975(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_893()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_389(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_433(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_389(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_433(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_903(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_901())
	{
		func_637(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_637(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_715(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_715(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_715(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}
...
struct<5> func_947(int iParam0)
{
	...
	Var0 = { func_948(iParam0, GET_HASH_KEY("CHARACTER"), func_720(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
...
int func_971(int iParam0)
{
	...
	{
		case 0:
			return GET_HASH_KEY("ST_DOCTOR");
		case 3:
			return GET_HASH_KEY("ST_GENERAL");
		case 4:
			return GET_HASH_KEY("ST_FENCE");
		case 6:
			return GET_HASH_KEY("ST_GUNSMITH");
		case 7:
			return GET_HASH_KEY("ST_TAILOR");
		case 8:
			return GET_HASH_KEY("ST_BARBER");
		case 1:
			return GET_HASH_KEY("ST_TRAIN_STATION");
		case 2:
			return GET_HASH_KEY("ST_POST_OFFICE");
		case 9:
			return GET_HASH_KEY("ST_HORSE_SHOP");
		case 10:
			return GET_HASH_KEY("ST_BUTCHER");
		case 11:
			return GET_HASH_KEY("ST_DYNAMIC");
		case 26:
			return GET_HASH_KEY("ST_QUARTERMASTER");
		case 27:
			return GET_HASH_KEY("ST_HORSE_TRAINER");
		case 28:
			return GET_HASH_KEY("ST_BLACKSMITH");
		case 29:
			return GET_HASH_KEY("ST_BOUNTYHUNTING_MP_RETURN");
		case 30:
			return GET_HASH_KEY("ST_COACH");
		case 31:
			return -732027686;
		case 5:
			return GET_HASH_KEY("ST_HORSE_FENCE");
		case 15:
			return GET_HASH_KEY("ST_BANK");
		case 17:
			return GET_HASH_KEY("ST_BAIT");
		case 33:
			return GET_HASH_KEY("ST_BARTENDER");
		case 12:
			return GET_HASH_KEY("ST_MARKET");
		case 13:
			return GET_HASH_KEY("ST_FRENCH_MARKET");
		case 14:
			return -1227686818;
		case 18:
			return GET_HASH_KEY("ST_TRAPPER");
		case 19:
			return GET_HASH_KEY("ST_PEARSON");
		case 22:
			return GET_HASH_KEY("ST_NEWSPAPER_BOY");
		case 20:
			return GET_HASH_KEY("ST_HOTEL");
		case 32:
			return GET_HASH_KEY("ST_WILDERNESS_SUPPLIES");
		case 34:
			return GET_HASH_KEY("ST_HANDHELD");
		case 23:
			return GET_HASH_KEY("ST_WEAPON_MOD_STORE");
		case 24:
			return GET_HASH_KEY("ST_CLOTHING");
		case 25:
			return GET_HASH_KEY("ST_CAMP_SHAVING");
		case 21:
			return GET_HASH_KEY("ST_PHOTO_STUDIO");
		default:
			break;
	}
	return 0;
...
void func_1002(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 1:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_ACUNAS_STAR_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_ACUNAS_STAR_ORCHID_JN"), 0);
			}
			break;
		case 2:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_ALASKAN_GINSENG_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_ALASKAN_GINSENG_JN"), 0);
			}
			break;
		case 3:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_AMERICAN_GINSENG_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_AMERICAN_GINSENG_JN"), 0);
			}
			break;
		case 4:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BAY_BOLETE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BAY_BOLETE_JN"), 0);
			}
			break;
		case 5:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BLACKBERRY_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BLACKBERRY_JN"), 0);
			}
			break;
		case 6:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BLACK_CURRANT_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BLACK_CURRANT_JN"), 0);
			}
			break;
		case 11:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BULRUSH_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BULRUSH_JN"), 0);
			}
			break;
		case 7:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BURDOCK_ROOT_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_BURDOCK_ROOT_JN"), 0);
			}
			break;
		case 39:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CARROT_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CARROT_JN"), 0);
			}
			break;
		case 8:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CHANTERELLE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CHANTERELLE_JN"), 0);
			}
			break;
		case 9:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CIGAR_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CIGAR_ORCHID_JN"), 0);
			}
			break;
		case 10:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CLAMSHELL_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CLAMSHELL_ORCHID_JN"), 0);
			}
			break;
		case 12:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CREEPING_THYME_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_CREEPING_THYME_JN"), 0);
			}
			break;
		case 13:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_DESERT_SAGE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_DESERT_SAGE_JN"), 0);
			}
			break;
		case 14:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_DRAGONS_MOUTH_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_DRAGONS_MOUTH_ORCHID_JN"), 0);
			}
			break;
		case 15:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_ENGLISH_MACE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_ENGLISH_MACE_JN"), 0);
			}
			break;
		case 40:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_FEVERFEW_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_FEVERFEW_JN"), 0);
			}
			break;
		case 17:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_GHOST_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_GHOST_ORCHID_JN"), 0);
			}
			break;
		case 18:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_GOLDEN_CURRANT_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_GOLDEN_CURRANT_JN"), 0);
			}
			break;
		case 16:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_HUCKLEBERRY_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_HUCKLEBERRY_JN"), 0);
			}
			break;
		case 19:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_HUMMINGBIRD_SAGE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_HUMMINGBIRD_SAGE_JN"), 0);
			}
			break;
		case 20:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_INDIAN_TOBACCO_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_INDIAN_TOBACCO_JN"), 0);
			}
			break;
		case 21:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_LADY_OF_THE_NIGHT_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_LADY_OF_THE_NIGHT_ORCHID_JN"), 0);
			}
			break;
		case 22:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_LADY_SLIPPER_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_LADY_SLIPPER_ORCHID_JN"), 0);
			}
			break;
		case 23:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_MILKWEED_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_MILKWEED_JN"), 0);
			}
			break;
		case 41:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_MINT_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_MINT_JN"), 0);
			}
			break;
		case 24:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_MOCCASIN_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_MOCCASIN_ORCHID_JN"), 0);
			}
			break;
		case 25:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_NIGHT_SCENTED_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_NIGHT_SCENTED_ORCHID_JN"), 0);
			}
			break;
		case 26:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_OLEANDER_SAGE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_OLEANDER_SAGE_JN"), 0);
			}
			break;
		case 27:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_OREGANO_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_OREGANO_JN"), 0);
			}
			break;
		case 28:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_PARASOL_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_PARASOL_JN"), 0);
			}
			break;
		case 29:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_PRAIRIE_POPPY_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_PRAIRIE_POPPY_JN"), 0);
			}
			break;
		case 30:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_QUEENS_ORCHIDS_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_QUEENS_ORCHIDS_JN"), 0);
			}
			break;
		case 31:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RAMSHEAD_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RAMSHEAD_ORCHID_JN"), 0);
			}
			break;
		case 33:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RASPBERRY_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RASPBERRY_JN"), 0);
			}
			break;
		case 32:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RAT_TAIL_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RAT_TAIL_ORCHID_JN"), 0);
			}
			break;
		case 34:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RED_SAGE_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_RED_SAGE_JN"), 0);
			}
			break;
		case 35:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_SPARROWS_EGG_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_SPARROWS_EGG_ORCHID_JN"), 0);
			}
			break;
		case 36:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_SPIDER_ORCHID_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_SPIDER_ORCHID_JN"), 0);
			}
			break;
		case 37:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_VANILLA_FLOWER_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_VANILLA_FLOWER_JN"), 0);
			}
			break;
		case 38:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_VIOLET_SNOWDROP_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_VIOLET_SNOWDROP_JN"), 0);
			}
			break;
		case 42:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_WINTERBERRY_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_WINTERBERRY_JN"), 0);
			}
			break;
		case 43:
			if (bParam1 == 1)
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_YARROW_AR"), 0);
			}
			else
			{
				func_277(GET_HASH_KEY("JOURNAL_HERB_YARROW_JN"), 0);
			}
			break;
		default:
			break;
...
void func_1026(int iParam0, int iParam1, int iParam2)
{
	...
	func_570(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_1110(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_1027()
{
	...
	func_1112(0);
	func_1113(7);
	func_330(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_610() == 1160113249)
	{
		func_330(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
...
void func_1034(int iParam0)
{
	...
	Var0 = { func_638(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_1042()
{
	...
	func_433(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_879(1);
	func_1026(1, iVar0, 0);
}
...
void func_1044()
{
	...
	func_433(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_879(2);
	func_1026(2, iVar0, 0);
}
...
void func_1045()
{
	...
	func_433(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_879(0);
	func_1026(0, iVar0, 0);
}
...
bool func_1061(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("CI_TAG_FOLDER_TAXIDERMIST_ORDERS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_LETTERS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_TREASURE_MAPS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_PHOTOGRAPHS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_RECIPE_PAMPHLETS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_NEWSPAPER_SCRAPS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_BUSINESS_CARDS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_NEWSPAPERS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_DINOSAUR_NOTES"):
		case GET_HASH_KEY("CI_TAG_FOLDER_ROCK_CARVING_NOTES"):
		case GET_HASH_KEY("CI_TAG_FOLDER_BOOKS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_DRAWINGS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_BOUNTY_POSTERS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_MAPS"):
		case GET_HASH_KEY("CI_TAG_FOLDER_NOTES"):
			return true;
	}
...
bool func_1062(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("CI_TAG_FOLDER_KIT_WATCHES"):
			return true;
	}
	return false;
}
...
bool func_1064(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("CI_TAG_FOLDER_GAMEY_BIRD"):
		case GET_HASH_KEY("CI_TAG_FOLDER_BIG_GAME"):
		case GET_HASH_KEY("CI_TAG_FOLDER_GRISTLY_MUTTON"):
		case GET_HASH_KEY("CI_TAG_FOLDER_HERPTILE_MEAT"):
		case GET_HASH_KEY("CI_TAG_FOLDER_SUCCULENT_FISH"):
		case GET_HASH_KEY("CI_TAG_FOLDER_STRINGY_MEAT"):
		case GET_HASH_KEY("CI_TAG_FOLDER_MATURE_VENISON"):
		case GET_HASH_KEY("CI_TAG_FOLDER_GAME"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CRUSTACEAN"):
		case GET_HASH_KEY("CI_TAG_FOLDER_FLAKEY_FISH"):
		case GET_HASH_KEY("CI_TAG_FOLDER_PLUMP_BIRD"):
		case GET_HASH_KEY("CI_TAG_FOLDER_PRIME_BEEF"):
		case GET_HASH_KEY("CI_TAG_FOLDER_GRITTY_FISH"):
		case GET_HASH_KEY("CI_TAG_FOLDER_TENDER_PORK"):
		case GET_HASH_KEY("CI_TAG_FOLDER_EXOTIC_BIRD"):
			return true;
	}
	return false;
}
...
int func_1103(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_199(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_199(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_199(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}
...
bool func_1127(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_SPT_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_AML_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_GUN_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_GRL_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_LND_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_ACT_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_PLT_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_INV_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_ART_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_PAM_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_HOR_SET"):
		case GET_HASH_KEY("CI_TAG_FOLDER_CIG_CARD_VEH_SET"):
			return true;
	}
	return false;
}
