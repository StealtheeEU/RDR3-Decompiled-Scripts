...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.35f, 4.3625f, 0.8945f, 80f, 1f, 1f, 2.2325f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.2875f, -0.625f, 0.832f, 92.5f, 2f, 5.8325f, 2.135f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SSNUNCCNV1"), GET_HASH_KEY("PLAYER_SSNUNCCNV1"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	...
	func_160(uParam0, iLocal_14, 1, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_161(uParam0, iLocal_14, iLocal_20, "p_mugCoffee01x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_B", -1, 1);
