...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "cigarette", 0, 1, 1);
	iLocal_17 = func_151(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_152(uParam0, 1.2529f, -0.4228f, 0.5011f, -23.76f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 2.8772f, -5.432f, 0.8f, -6.84f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_C", iLocal_17, 0);
	func_156(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_C", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 1);
