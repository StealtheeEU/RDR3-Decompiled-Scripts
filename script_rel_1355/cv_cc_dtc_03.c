...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.1689f, -0.7804f, 0f, 14f, 1.155f, 1.0825f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DTCCNV3"), GET_HASH_KEY("PLAYER_DTCCNV3"));
