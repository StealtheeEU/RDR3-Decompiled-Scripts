...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0125f, -0.325f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_151(uParam0, -5.025f, -0.8375f, 0f, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "CRATE", 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_BASKET06X"), 0f, 0f, 0f, "BASKET", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_KNITTINGNEEDLE01X"), 0f, 0f, 0f, "Nittingneedle", 0, 0, 1);
	func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_17, 0);
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_SSNSPEECHLOWFOODCNV1"), GET_HASH_KEY("PLAYER_SSNSPEECHLOWFOODCNV1"));
