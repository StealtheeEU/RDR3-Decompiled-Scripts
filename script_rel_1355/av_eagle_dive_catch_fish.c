...
void __EntryFunction__()
{
	...
	iLocal_10 = GET_HASH_KEY("A_C_FISHROCKBASS_01_MS");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_72(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
...
void func_93(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_130(iParam1))
		{
			func_131(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
