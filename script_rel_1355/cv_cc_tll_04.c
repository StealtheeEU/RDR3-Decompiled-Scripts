...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.75f, 2.9675f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_151(uParam0, 0.0625f, -0.275f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 1.3125f, -0.8375f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, 0.75f, -0.5f, 0f, -18f, 1.53f, 0.8f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_KNITTINGNEEDLE01X"), 0f, 0f, 0f, "KNITTINGNEEDLE1", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_KNITTINGNEEDLE01X"), 0f, 0f, 0f, "KNITTINGNEEDLE2", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK1", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK2", 0, 1, 1);
	iLocal_24 = func_153(uParam0, GET_HASH_KEY("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_153(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.67941f, -0.624629f, 0.00875473f, 0, 1, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_TLLCNV4"), GET_HASH_KEY("PLAYER_TLLCNV4"));
	func_156(uParam0, "CTLL4AU");
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_21, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_22, 0);
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
