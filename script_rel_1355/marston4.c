...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_72 = GET_HASH_KEY("G_M_M_UNIRANCHERS_01");
	iLocal_73 = GET_HASH_KEY("A_C_COW");
	iLocal_74 = GET_HASH_KEY("A_C_HORSE_MORGAN_BAY");
	iLocal_76 = 1;
	iLocal_77 = 2;
	iLocal_78 = 3;
	iLocal_79 = 4;
	...
	{
		func_1(&uLocal_2282, 1073741824 /* Float: 2f */);
...
bool func_9(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_164(Local_133[iVar0 /*53*/]);
		func_165(uParam0, Local_133[iVar0 /*53*/], 1);
		func_167(func_166(Local_133[iVar0 /*53*/]), 0);
		iVar0++;
	}
	...
	func_180(&Local_453);
	func_181(&Local_1779);
	ENTITY::REMOVE_MODEL_HIDE(-2231.037f, 704.4076f, 121.0931f, 1f, GET_HASH_KEY("P_VAL_AUCGATE1M01X"), 0);
	ENTITY::REMOVE_MODEL_HIDE(-2222.913f, 695.5297f, 121.013f, 1f, GET_HASH_KEY("P_VAL_GATE2M03X"), 0);
	func_182(0);
	iLocal_2103 = PERSCHAR::_0x112DDF56300BC6E5(GET_HASH_KEY("PHR_HORSES_1"));
	...
	func_183(712);
	func_183(713);
	func_184(GET_HASH_KEY("PHR_ABE"));
	func_184(GET_HASH_KEY("PHR_TOM_DICKENS"));
	func_184(GET_HASH_KEY("PHR_MRS_GEDDES"));
	func_184(GET_HASH_KEY("PHR_DAVID_GEDDES"));
	func_184(GET_HASH_KEY("PHR_ANGUS_GEDDES"));
	func_184(GET_HASH_KEY("PHR_DUNCAN_GEDDES"));
	func_184(GET_HASH_KEY("PHR_RANCH_HAND1"));
	func_184(GET_HASH_KEY("PHR_RANCH_HAND2"));
	func_184(GET_HASH_KEY("PHR_RANCH_HAND3"));
	func_184(GET_HASH_KEY("PHR_RANCH_HAND4"));
	func_184(GET_HASH_KEY("PHR_RANCH_HAND5"));
	func_185(719);
	func_185(720);
	func_185(721);
	func_185(722);
	func_185(723);
	func_186(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
	WEAPON::REMOVE_WEAPON_FROM_PED(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, -142743235);
	func_186(GET_HASH_KEY("WEAPON_REPEATER_WINCHESTER"));
	WEAPON::REMOVE_WEAPON_FROM_PED(Global_35, GET_HASH_KEY("WEAPON_REPEATER_WINCHESTER"), true, -142743235);
	func_186(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
	WEAPON::REMOVE_WEAPON_FROM_PED(Global_35, GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), true, -142743235);
	func_186(GET_HASH_KEY("WEAPON_SHOTGUN_REPEATING"));
	WEAPON::REMOVE_WEAPON_FROM_PED(Global_35, GET_HASH_KEY("WEAPON_SHOTGUN_REPEATING"), true, -142743235);
	func_186(GET_HASH_KEY("WEAPON_REVOLVER_SCHOFIELD"));
	WEAPON::REMOVE_WEAPON_FROM_PED(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_SCHOFIELD"), true, -142743235);
	if (func_187())
	{
		func_188(1);
	}
	...
	while (iVar1 < 5)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_2051[iVar1]))
		{
			TASK::_DELETE_SCENARIO_POINT(iLocal_2051[iVar1]);
		}
		iVar1++;
	}
	iVar1 = 0;
	...
	{
		func_190(Global_35, GET_HASH_KEY("WEAPON_LASSO"), 0, 1, 0, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
	}
	PLAYER::_0x19B2C7A6C34FAD54(PLAYER::PLAYER_ID(), 1f);
	func_48(6);
	func_191(1535511805, 0, 0);
	func_191(-1899662469, 0, 0);
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_2273))
	{
		VOLUME::_DELETE_VOLUME(iLocal_2273);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_2274))
	{
		VOLUME::_DELETE_VOLUME(iLocal_2274);
	}
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_2109))
	{
...
void func_75(var uParam0)
{
	...
	func_287(iVar0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, 752097756);
}
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (bParam1 && func_199(iParam0) != 0)
				{
					if (iVar0 == 1)
					{
						...
						{
							STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1835011[func_276(iParam0) /*74*/].f_8), true);
						}
					}
					else if ((func_276(iParam0) != 95 && func_276(iParam0) != 82) && !func_305(Global_1347702[func_276(iParam0) /*49*/].f_12, 512))
					{
						STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1347702[func_276(iParam0) /*49*/].f_3), true);
					}
				}
			}
			else
	...
	if (!Global_1879534 && !Global_1879534.f_1)
	{
		switch (iVar0)
		{
			...
			case 8:
				...
				{
					func_318(14, 0, 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
				}
				Global_1899528.f_217 = 1;
				break;
			case 9:
	...
	if (bParam1)
	{
		...
		switch (iVar0)
		{
			...
			case 11:
				...
				break;
			case 8:
				if (func_277(func_276(iParam0)) && func_305(Global_1347702[func_276(iParam0) /*49*/].f_12, 4))
				{
					Global_1898438 = MISC::GET_GAME_TIMER();
				}
				else
	...
	if (bVar13)
	{
			...
			case 1:
				switch (func_276(iParam0))
				{
					...
					case 1:
						...
						break;
					case 4:
						func_322(GET_HASH_KEY("CONSUMABLE_HERB_SAGE"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("CONSUMABLE_HERB_GINSENG"), 4, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("CONSUMABLE_HERB_INDIAN_TOBACCO"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("CONSUMABLE_HERB_YARROW"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("PROVISION_GRITTY_FISH_MEAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("PROVISION_STRINGY_MEAT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("PROVISION_ANIMAL_FAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("PROVISION_BIRD_FEATHER_FLIGHT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("CONSUMABLE_COFFEE_GNDS_REG"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"));
						func_322(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_323(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"));
						func_322(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("KIT_CAMP"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(-1448210800 /* GXTEntry: "Crafting Tools" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_322(GET_HASH_KEY("CLOTHING_ITEM_PZ_LOADOUT_BANDOLIER_01"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_324();
						func_325(GET_HASH_KEY("CLOTHING_SP_COAT_WINTER01_VARIATION_01"));
						func_326();
						func_327();
						break;
					case 5:
					...
					case 14:
						...
						break;
					case 2:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY(func_328(10, 0)));
						break;
					case 8:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, 621714131 /* GXTEntry: "Jamie Gillis" */);
						break;
					case 15:
						func_322(GET_HASH_KEY("DOCUMENT_MAP_LEGENDARY_ANIMALS"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					...
					case 18:
						...
						if (!func_331(Global_1347702[21 /*49*/].f_15, 1))
						{
					...
					case 26:
						...
						break;
					case 17:
						func_334(Global_35, GET_HASH_KEY("CLOTHING_ITEM_BADGE_PZERO_000"), 0, -358215195, 1, 1);
						if (func_335())
						{
							func_336(GET_HASH_KEY("WEAPON_REPEATER_EVANS"));
						}
						break;
					case 19:
						...
						break;
					case 33:
						if (!func_337(GET_HASH_KEY("TP_RMAY_LETTER_1"), -1))
						{
							iVar15 = func_289();
							func_338(&iVar15, 0, 0, 0, 2, 0, 0, 0);
							func_339(GET_HASH_KEY("TP_RMAY_LETTER_1"), iVar15, 0);
						}
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY("DISCOVERABLE_NAME_EVELYN_MILLER"));
						if (func_335())
						{
							func_336(GET_HASH_KEY("WEAPON_REVOLVER_LEMAT"));
						}
						break;
					case 34:
						if (func_335())
						{
							func_336(GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_GAMBLER"));
						}
						break;
					case 28:
					...
					case 43:
						...
						break;
					case 44:
						if (!func_331(Global_1347702[82 /*49*/].f_15, 1))
						{
						...
						if (!func_331(Global_1347702[83 /*49*/].f_15, 1))
						{
					...
					case 67:
						...
						if (!func_349(GET_HASH_KEY("TAXIDERMY_ORDER_05")))
						{
							if (func_349(GET_HASH_KEY("TAXIDERMY_ORDER_04")))
							{
								iVar16 = func_289();
								func_338(&iVar16, 0, 0, 6, 0, 0, 0, 0);
								func_339(GET_HASH_KEY("TP_TAXIDERMY_REWARD_04_ES"), iVar16, 1);
							}
						}
						if (func_350(4))
						{
							if (!func_351(GET_HASH_KEY("DOCUMENT_NOTE_RARE_FISH"), 1, 0))
							{
								iVar17 = func_289();
								func_338(&iVar17, 0, 0, 6, 0, 0, 0, 0);
								func_339(GET_HASH_KEY("TP_RF_INVITATION_01"), iVar17, 1);
							}
						}
					...
					case 76:
						...
						break;
					case 69:
						if (func_331(Global_1347702[9 /*49*/].f_15, 1))
						{
							func_352(-6000);
						}
						break;
			...
			case 8:
				switch (func_276(iParam0))
				{
					...
					case 67:
						...
						if (func_335())
						{
							func_336(GET_HASH_KEY("WEAPON_PISTOL_M1899"));
						}
						break;
					case 68:
					...
					case 147:
						...
						break;
					case 9:
						if (func_331(Global_1835011[69 /*74*/].f_1, 1))
						{
							func_361(0);
							func_352(40500);
						}
		...
		switch (iVar0)
		{
			case 1:
				...
				{
					case 4:
						func_364(iParam0, 1000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 61:
					case 62:
					case 63:
						func_364(iParam0, 300, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 25:
					...
					case 34:
						...
						if (!func_351(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0))
						{
							func_322(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						break;
					case 29:
					...
					case 57:
						...
						break;
					case 76:
						func_364(iParam0, 2042100, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 72:
						if (func_365(iParam0) == 0)
						{
							func_364(iParam0, 20000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						else
						{
							func_364(iParam0, 15000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						break;
				}
				break;
			case 8:
				if (func_305(Global_1347702[func_276(iParam0) /*49*/].f_12, 536870912))
				{
					func_366(11, 1);
				}
				switch (func_276(iParam0))
				{
					case 109:
						func_364(iParam0, 1500, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 55:
						func_366(8, 1);
						break;
				...
				break;
			case 11:
				if (iParam0 == func_367(0, 10, 11, GET_HASH_KEY("CABR01")))
				{
					func_364(iParam0, func_365(iParam0), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_367(0, 7, 11, GET_HASH_KEY("CACR02")))
				{
					func_364(iParam0, func_368(9), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_367(0, 8, 11, GET_HASH_KEY("CACR03")))
				{
					func_364(iParam0, func_368(10), 1, 0.5f, 2, 0, 0, 1);
				}
				else if (iParam0 == func_367(0, 11, 11, GET_HASH_KEY("CACR01")))
				{
					func_364(iParam0, func_368(8), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_367(0, 12, 11, GET_HASH_KEY("CACR04")))
				{
			...
			if (bParam2)
			{
				switch (iVar0)
				{
					...
					case 2:
						...
						break;
					case 8:
						if (func_277(func_276(iParam0)) && func_305(Global_1347702[func_276(iParam0) /*49*/].f_12, 1))
						{
							iVar20 = 3;
						}
						else
...
void func_84(int iParam0, bool bParam1)
{
	...
	if (STATS::STATSTRACKER_IS_INITIALIZED(func_198(iParam0)))
	{
		...
		if (func_82(32768))
		{
			...
			if ((iVar1 == 1 || iVar1 == 8) || (iVar1 == 11 && iParam0 == func_367(0, 10, 11, GET_HASH_KEY("CABR01"))))
			{
				Global_1898438 = MISC::GET_GAME_TIMER();
				Global_1879514.f_1 = iParam0;
...
void func_108(var uParam0, var uParam1)
{
	uParam0->f_607 = -1;
	func_387(uParam0);
	uParam0->f_634[0] = 57942;
	uParam0->f_634[1] = 57942;
	uParam0->f_637 = 0;
...
{
	return func_395(uParam0->f_1[func_132(iParam1) /*22*/].f_11, iParam2);
}
...
bool func_129()
{
	...
	if (!func_331(Global_1835011[1 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_331(Global_1835011[2 /*74*/].f_1, 1) && func_331(Global_1347702[120 /*49*/].f_15, 1)) && !func_331(Global_1835011[4 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_331(Global_1835011[37 /*74*/].f_1, 1) && !func_331(Global_1835011[39 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_331(Global_1835011[57 /*74*/].f_1, 1) && !func_331(Global_1835011[60 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_331(Global_1835011[26 /*74*/].f_1, 1) && !func_331(Global_1347702[67 /*49*/].f_15, 1))
	{
		return true;
	}
	if ((func_331(Global_1835011[62 /*74*/].f_1, 1) && func_331(Global_1835011[63 /*74*/].f_1, 1)) && !func_331(Global_1835011[64 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_331(Global_1835011[75 /*74*/].f_1, 1) && !func_331(Global_1347702[1 /*49*/].f_15, 1))
	{
		return true;
	}
	if (func_331(Global_1835011[76 /*74*/].f_1, 1) && !func_331(Global_1835011[77 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_331(Global_1835011[40 /*74*/].f_1, 1) && func_331(Global_1835011[41 /*74*/].f_1, 1)) && !func_331(Global_1835011[44 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_331(Global_1835011[62 /*74*/].f_1, 1) && func_331(Global_1835011[63 /*74*/].f_1, 1)) && !func_331(Global_1835011[64 /*74*/].f_1, 1))
	...
	if ((func_331(Global_1835011[65 /*74*/].f_1, 1) && func_331(Global_1835011[66 /*74*/].f_1, 1)) && !func_331(Global_1835011[67 /*74*/].f_1, 1))
	{
		return true;
	}
	return false;
...
void func_138(var uParam0)
{
	...
	func_415(uParam0, GET_HASH_KEY("P_BAT_CRATESTACK01X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_CRATECOVER06X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALESTACK01X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALESTACK03X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_CRATESTACK01X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_CRATECOVER04X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALE03X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALESTACK02X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALE01X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("A_M_M_RANCHER_01"), 67108863);
	func_415(uParam0, GET_HASH_KEY("A_C_HORSE_AMERICANSTANDARDBRED_BLACK"), 67108863);
	func_415(uParam0, GET_HASH_KEY("A_C_HORSE_AMERICANSTANDARDBRED_BUCKSKIN"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_BAT_CRATESTACK01X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_CRATECOVER06X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALESTACK01X"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_HAYBALESTACK03X"), 67108863);
...
void func_139(var uParam0)
{
	...
	func_415(uParam0, GET_HASH_KEY("CS_LARAMIE"), 24);
	func_415(uParam0, iLocal_73, 67108863);
	func_415(uParam0, iLocal_74, 67108863);
	func_415(uParam0, GET_HASH_KEY("A_M_M_RANCHER_01"), 67108863);
	func_415(uParam0, GET_HASH_KEY("P_CS_MARSTONLOCKER01X"), 3);
	func_415(uParam0, GET_HASH_KEY("P_CS_GUN_STRAP"), 3);
	func_415(uParam0, GET_HASH_KEY("P_CS_MARSTONHAT01X"), 3);
	func_415(uParam0, GET_HASH_KEY("P_CS_ARTHURHAT01X"), 2);
	func_415(uParam0, GET_HASH_KEY("P_BINOCULARS01X"), 4);
...
{
	func_417(&(uParam0->f_1[func_132(iParam1) /*22*/].f_11), iParam2);
}
...
void func_165(var uParam0, bool bParam1, bool bParam2)
{
	...
	bVar0 = (ENTITY::IS_ENTITY_A_PED(bParam1) && func_437(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam1)));
	if (bVar0)
	{
		iVar1 = func_438(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam1));
	}
	if (ENTITY::IS_ENTITY_A_PED(bParam1))
	{
		...
		else if (func_440(uParam0, bParam1) && MAP::DOES_BLIP_EXIST(MAP::GET_BLIP_FROM_ENTITY(bParam1)))
		{
	...
	{
		func_442(uParam0, bParam1, 1024);
		if (bParam2)
		{
			func_443(uParam0, bParam1, 128);
		}
		else
		{
			func_442(uParam0, bParam1, 128);
		}
		if (func_444(uParam0, bParam1, &iVar3))
		{
			func_445(&(uParam0->f_5423[iVar3 /*65*/]));
		}
	}
	if (bVar0)
	{
...
void func_167(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_448(&(Global_1360165[iParam0 /*1157*/].f_12), 16))
		{
...
void func_168(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (!func_450(iParam1))
	{
		return;
	...
	func_439(iParam1);
	func_453(iParam1, 0);
	func_454(iParam1, 0, bParam4, bParam5, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	if (bParam5)
	{
	}
}
...
void func_171()
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(Local_96[0 /*5*/]))
	{
...
bool func_183(int iParam0)
{
	...
	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_470(iParam0)))
	{
		return false;
	}
	if (NETWORK::NETWORK_IS_IN_SESSION())
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PERSCHAR::_0x31C70A716CAE1FEE(func_470(iParam0))))
		{
			return true;
		}
	}
	bVar0 = PERSCHAR::_0x31C70A716CAE1FEE(func_470(iParam0));
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
	...
	PERSCHAR::_0x7B204F88F6C3D287(func_470(iParam0));
	return true;
}
...
int func_185(int iParam0)
{
	...
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_470(iParam0));
	return 1;
}
...
int func_190(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_122(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
bool func_202(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_276(Global_1898164.f_1[0 /*5*/]);
		if (func_277(iVar0) && func_305(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
int func_204(int iParam0)
{
	...
	switch (func_200(iParam0))
	{
		...
		case 8:
			...
			if (func_305(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
...
int func_206()
{
	if (!func_331(Global_1835011[4 /*74*/].f_1, 1))
	{
		return 0;
	}
	else if (!func_331(Global_1347702[66 /*49*/].f_15, 1))
	{
		return 1;
	}
	else if (!func_331(Global_1347702[67 /*49*/].f_15, 1))
	{
		return 2;
	}
	else if (!func_331(Global_1835011[38 /*74*/].f_1, 1))
	{
		return 3;
	}
	else if (!func_331(Global_1347702[68 /*49*/].f_15, 1))
	{
		return 4;
	}
	else if (!func_331(Global_1835011[59 /*74*/].f_1, 1))
	{
		return 5;
	}
	else if (!func_331(Global_1835011[67 /*74*/].f_1, 1))
	{
		return 7;
	}
	else
...
bool func_240()
{
	return func_513(SCRIPTS::GET_ID_OF_THIS_THREAD());
}
...
bool func_252(int iParam0, int iParam1)
{
	...
	{
		return func_517(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
void func_279(int iParam0, bool bParam1)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(iVar0, func_530(iParam0)))
	{
		UILOG::_UILOG_REMOVE_ENTRY(iVar0, func_530(iParam0));
	}
	if (bParam1)
	{
		if (iVar0 == 1)
		{
			if (UILOG::_UILOG_IS_ENTRY_REGISTERED(2, func_530(iParam0)))
			{
				UILOG::_UILOG_REMOVE_ENTRY(2, func_530(iParam0));
			}
		}
	}
	func_531(iParam0, 4);
...
void func_281(int iParam0, bool bParam1)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(func_529(iParam0), func_530(iParam0)))
	{
		return;
	}
	if (bParam1)
	{
		UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_529(iParam0), func_530(iParam0), 2, "");
		func_532(iParam0, 16);
	}
	else
	{
		...
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_529(iParam0), func_530(iParam0), 1, "");
		}
		else
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_529(iParam0), func_530(iParam0), 0, "");
		}
		func_531(iParam0, 16);
	}
}
...
void func_297(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_542(Global_1310750[iVar0 /*111*/], iParam0))
		{
			if (!func_543(iVar0))
			{
				iVar1 = 1;
...
void func_299(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_547(iParam0, bParam3, BUILTIN::ROUND((fVar0 * fParam2)), BUILTIN::ROUND((fVar1 * fParam2)), BUILTIN::ROUND((fVar2 * fParam2)), BUILTIN::ROUND((fVar3 * fParam2)), bParam4, 1);
}
...
void func_303()
{
	...
	if (func_550(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1))
	{
		func_551(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1, 0);
	}
}
...
void func_304(int iParam0)
{
	...
	func_553(iParam0, (func_552(iParam0) + BUILTIN::SHIFT_LEFT(1, 16)));
}
...
void func_307(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		case 67:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_ABIGAIL2X1_1"), iParam1);
			break;
		case 18:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_4"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_1"), iParam1);
			break;
		case 20:
			func_555(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_2"), iParam1);
			break;
		case 2:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_4"), iParam1);
			break;
		case 23:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_3"), iParam1);
			func_556(1);
			break;
		case 16:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_2_TXT"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_3_TXT"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_4"), iParam1);
			break;
		case 59:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_2"), iParam1);
			if (func_557(146))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_TREASURE2_JN"), iParam1);
			}
			func_556(1);
			break;
		case 76:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_FINALE2_1"), iParam1);
			if (func_558() == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9A"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_10B"), iParam1);
			}
			break;
		case 44:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4B"), iParam1);
			break;
		case 46:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_4"), iParam1);
			break;
		case 17:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_3"), iParam1);
			break;
		case 19:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_GT_GRAYS_2"), iParam1);
			break;
		case 21:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_2"), iParam1);
			func_556(0);
			break;
		case 15:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1B"), iParam1);
			break;
		case 33:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_4"), iParam1);
			break;
		case 34:
			func_555(GET_HASH_KEY("JOURNAL_GT_INDUSTRY_3"), iParam1);
			break;
		case 64:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_LARAMIE1_1"), iParam1);
			break;
		case 60:
			func_555(GET_HASH_KEY("JOURNAL_CHAP8_PRONGHORN"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_MARSTON1_2"), iParam1);
			break;
		case 73:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON6_1"), iParam1);
			break;
		case 74:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON7_1"), iParam1);
			if (func_558() == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_4A"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_5B"), iParam1);
			}
			break;
		case 8:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_3"), iParam1);
			break;
		case 36:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2"), iParam1);
			if (Global_1357515 == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2B"), iParam1);
			}
			break;
		case 27:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_4"), iParam1);
			break;
		case 28:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_4"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_GT_MOB_2"), iParam1);
			break;
		case 29:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_GT_MOB_3"), iParam1);
			break;
		case 31:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_4"), iParam1);
			break;
		case 4:
			func_555(GET_HASH_KEY("JOURNAL_CHAP2_HORSESHOE"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_5"), iParam1);
			func_556(0);
			break;
		case 6:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2"), iParam1);
			if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_A"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_B"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_C"), iParam1);
			}
			break;
		case 25:
			func_555(GET_HASH_KEY("JOURNAL_GT_MUDTOWN_3B"), iParam1);
			break;
		case 24:
			if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_5000"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_7500"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_10000"), iParam1);
			}
			break;
		case 48:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2A"), iParam1);
			}
			if (func_559(51))
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2B"), iParam1);
			}
			break;
		case 49:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_1"), iParam1);
			if (Global_1357515 == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2B"), iParam1);
			}
			else if (Global_1357515 == 2)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2C"), iParam1);
			}
			break;
		case 58:
			func_555(GET_HASH_KEY("JOURNAL_GT_NATIVE_3"), iParam1);
			break;
		case 50:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON1_1"), iParam1);
			break;
		case 52:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2B"), iParam1);
			if (bParam2 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A2"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3B"), iParam1);
			}
			break;
		case 32:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_ODRISCOLL4_1"), iParam1);
			break;
		case 47:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MARY4_1"), iParam1);
			break;
		case 69:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE2_1"), iParam1);
			if (func_331(Global_1347702[9 /*49*/].f_15, 1))
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_2B"), iParam1);
			}
			break;
		case 70:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE3"), iParam1);
			if (func_558() == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_7A"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8B"), iParam1);
			}
			break;
		case 71:
			if (func_558() == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8A"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9B"), iParam1);
			}
			break;
		case 37:
			func_555(GET_HASH_KEY("JOURNAL_GT_SAINT_DENIS_1"), iParam1);
			break;
		case 9:
			if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1B"), iParam1);
			}
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_2"), iParam1);
			break;
		case 13:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_3"), iParam1);
			break;
		case 53:
			func_555(GET_HASH_KEY("JOURNAL_GT_CORNWALL_1"), iParam1);
			break;
		case 54:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY1_1"), iParam1);
			break;
		case 56:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_3"), iParam1);
			break;
		case 57:
			func_555(GET_HASH_KEY("JOURNAL_GT_TRAIN_ROBBERY_4"), iParam1);
			break;
		case 22:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_2"), iParam1);
			break;
		case 12:
			func_555(GET_HASH_KEY("JOURNAL_GT_UTOPIA_2"), iParam1);
			break;
		case 0:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_5"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_6"), iParam1);
			break;
		case 1:
			func_556(1);
			break;
		case 3:
			if (func_342())
			{
				...
				{
					func_555(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE"), iParam1);
				}
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE")))
			{
				func_555(GET_HASH_KEY("JOURNAL_GT_WINTER_4"), iParam1);
			}
			break;
		default:
			break;
...
void func_309(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	{
		case 0:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_4"), iParam1);
			break;
		case 1:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL2X2_1"), iParam1);
			break;
		case 2:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL3_1"), iParam1);
			break;
		case 9:
			func_555(GET_HASH_KEY("JOURNAL_CHAP9_BEECHERSHOPE"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_BEECHERS1X3_1"), iParam1);
			if (func_331(Global_1835011[69 /*74*/].f_1, 1))
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1A"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1B"), iParam1);
			}
			break;
		case 22:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_CALDERON1X1_1"), iParam1);
			break;
		case 26:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_JN"), iParam1);
			}
			break;
		case 29:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_2_AR"), iParam1);
			}
			else if (func_557(26))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B1"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B2"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_A"), iParam1);
			}
			break;
		case 32:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_AR"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_AR"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_AR"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_AR"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_AR"), iParam1);
				}
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2_JN"), iParam1);
				if (Global_1357515 == -1)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_JN"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_JN"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_JN"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_JN"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_JN"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_JN"), iParam1);
				}
			}
			break;
		case 35:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_JN"), iParam1);
			}
			break;
		case 36:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_JN"), iParam1);
			}
			break;
		case 37:
			func_555(GET_HASH_KEY("JOURNAL_GT_COACH_ROB_RSC"), iParam1);
			break;
		case 53:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT1_2_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN_B"), iParam1);
			}
			break;
		case 54:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_JN"), iParam1);
			}
			break;
		case 55:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1_AR"), iParam1);
			}
			else if (func_557(54))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1A_JN"), iParam1);
			}
			break;
		case 38:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CIG1_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_CIG1_1_JN"), iParam1);
			}
			break;
		case 39:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_DINO1_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_DINO1_1_JN"), iParam1);
			}
			break;
		case 40:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_DINO2_1_AR"), iParam1);
			}
			else if (func_557(39))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_DINO2_1_B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_DINO2_1_A_JN"), iParam1);
			}
			break;
		case 43:
			if (bParam3 == 1)
			{
				if (func_365(Global_1835011[33 /*74*/].f_1) == 1)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1B_AR_A"), iParam1);
				}
				else
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1A_AR_A"), iParam1);
				}
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1_JN"), iParam1);
			}
			break;
		case 45:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_AR_A"), iParam1);
			}
			else if (func_557(43))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_B"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_A"), iParam1);
			}
			break;
		case 41:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FISH1_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FISH1_1_JN"), iParam1);
			}
			break;
		case 42:
			if (func_557(41))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_B"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_A"), iParam1);
			}
			break;
		case 49:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_JN"), iParam1);
			}
			break;
		case 50:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_AR"), iParam1);
			}
			else if (func_557(49))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B2"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_A"), iParam1);
			}
			break;
		case 51:
			func_555(GET_HASH_KEY("JOURNAL_RC_TAX1_1_JN"), iParam1);
			break;
		case 58:
			if (func_331(Global_1347702[23 /*49*/].f_15, 1))
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1B"), iParam1);
			}
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_3"), iParam1);
			break;
		case 59:
			func_555(GET_HASH_KEY("JOURNAL_CHAP2_DOWNES1_1"), iParam1);
			break;
		case 62:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DOWNES2_1"), iParam1);
			break;
		case 63:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ODRISCOLL2_2B"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_GT_ODRISCOLL_2"), iParam1);
			break;
		case 65:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_3"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_4"), iParam1);
			break;
		case 66:
			func_555(GET_HASH_KEY("JOURNAL_CHAP3_CLEMENS"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_3"), iParam1);
			func_556(1);
			break;
		case 67:
			func_555(GET_HASH_KEY("JOURNAL_CHAP4_SHADYBELLE"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_2"), iParam1);
			break;
		case 68:
			func_555(GET_HASH_KEY("JOURNAL_CHAP6_BEAVERHOLLOW"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2B"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_3"), iParam1);
			func_556(0);
			break;
		case 70:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_EDITHDOWNE2_1"), iParam1);
			break;
		case 71:
			func_555(GET_HASH_KEY("JOURNAL_RC_MILLER1_JN"), iParam1);
			break;
		case 73:
			func_555(GET_HASH_KEY("JOURNAL_RC_MILLER3_JN"), iParam1);
			break;
		case 75:
			func_555(GET_HASH_KEY("JOURNAL_RC_MILLER4_JN"), iParam1);
			break;
		case 77:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA1_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA1_1_JN"), iParam1);
			}
			break;
		case 79:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA3_1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA3_2_AR"), iParam1);
			}
			else if (func_557(78))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA3_2_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA3_1_JN"), iParam1);
			}
			break;
		case 80:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA4_1_AR"), iParam1);
			}
			else if (func_557(79))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA4_2_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_FMA4_1_JN"), iParam1);
			}
			break;
		case 85:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_JN"), iParam1);
			}
			break;
		case 86:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_JN"), iParam1);
			}
			break;
		case 87:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_JN"), iParam1);
			}
			break;
		case 88:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_JN"), iParam1);
			}
			break;
		case 89:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK1_JN"), iParam1);
			}
			break;
		case 92:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK4_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK4B_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK4_A_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK4_A2_JN"), iParam1);
			}
			break;
		case 93:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK5_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_HKK5_JN"), iParam1);
			}
			break;
		case 94:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2A"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2B"), iParam1);
			}
			func_555(GET_HASH_KEY("JOURNAL_GT_HOME_ROB"), iParam1);
			break;
		case 99:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3X1_1"), iParam1);
			break;
		case 101:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON1_1_AR"), iParam1);
				if (Global_1357515 == -1)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_B"), iParam1);
				}
				else
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_A"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON1_1B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON1_1A_JN"), iParam1);
			}
			break;
		case 102:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON2_1_AR"), iParam1);
			}
			else if (func_557(101))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON2_1B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON2_1A_JN"), iParam1);
			}
			break;
		case 103:
			func_555(GET_HASH_KEY("JOURNAL_RC_MASON3_1_AR"), iParam1);
			break;
		case 104:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON4_1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON4_2_AR"), iParam1);
			}
			else if (func_557(103))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON4_1B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON4_1A_JN"), iParam1);
			}
			break;
		case 105:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON5_1_AR"), iParam1);
			}
			else if (func_557(104))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON5_1B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MASON5_1A_JN"), iParam1);
			}
			break;
		case 108:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MONROE_1"), iParam1);
			break;
		case 109:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR_B"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR1_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR1B_JN"), iParam1);
			}
			break;
		case 110:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR2_AR"), iParam1);
			}
			else if (func_557(109))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR2B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR2A_JN"), iParam1);
			}
			break;
		case 111:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 0)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_AR"), iParam1);
				}
				else
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_AR"), iParam1);
				}
			}
			else if (func_557(110))
			{
				if (Global_1357515 == 0)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3C_JN"), iParam1);
				}
				else
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_JN"), iParam1);
					func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_2_JN"), iParam1);
				}
			}
			else if (Global_1357515 == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_2_JN"), iParam1);
			}
			break;
		case 115:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_1"), iParam1);
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_2"), iParam1);
			break;
		case 143:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ODDF1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ODDF1_JN"), iParam1);
			}
			break;
		case 144:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ODDF2_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_ODDF2_JN"), iParam1);
			}
			break;
		case 117:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO1_2_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_JN"), iParam1);
			}
			break;
		case 118:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1_AR"), iParam1);
			}
			else if (func_557(117))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1A_JN"), iParam1);
			}
			break;
		case 119:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO3_1_AR"), iParam1);
			}
			else if (func_557(118))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2A_JN"), iParam1);
			}
			break;
		case 121:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW1_JN"), iParam1);
			}
			break;
		case 122:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW3_AR"), iParam1);
			}
			else if (func_557(121))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW3B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW3A_JN"), iParam1);
			}
			break;
		case 124:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW4_AR"), iParam1);
			}
			else if (func_557(122))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW4B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW4A_JN"), iParam1);
			}
			break;
		case 125:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW5_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_PW5B_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_PW5_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_PW5B_JN"), iParam1);
			}
			break;
		case 127:
			func_555(GET_HASH_KEY("JOURNAL_RC_RTL1_AR"), iParam1);
			break;
		case 129:
			func_555(GET_HASH_KEY("JOURNAL_RC_RTL3_AR"), iParam1);
			break;
		case 131:
			func_555(GET_HASH_KEY("JOURNAL_RC_RTL5_AR"), iParam1);
			break;
		case 133:
			func_555(GET_HASH_KEY("JOURNAL_RC_RTL7_AR"), iParam1);
			break;
		case 134:
			func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_SADIE1_1"), iParam1);
			break;
		case 135:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_KILLER4A_AR"), iParam1);
				}
				else
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_KILLER4B_AR"), iParam1);
				}
			}
			else if ((HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER1_AR")) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER2_AR"))) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER3_AR")))
			{
				if (Global_1357515 == -1)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_KILLER4A_JN"), iParam1);
				}
				else
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_KILLER4B_JN"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_KILLER4C_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_KILLER4D_JN"), iParam1);
			}
			break;
		case 136:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC1_JN"), iParam1);
			}
			break;
		case 137:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC2_AR"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC3A_AR"), iParam1);
			}
			else if (func_557(136))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC2B_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC3C_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC2A_JN"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_RC_SLVC3A_JN"), iParam1);
			}
			break;
		case 142:
			if (bParam2 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3A"), iParam1);
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3B"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3C"), iParam1);
			}
			break;
		case 146:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 1)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_555(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_AR"), iParam1);
				}
			}
			else if (Global_1357515 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_JN"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_JN"), iParam1);
			}
			break;
		case 147:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET1_AR"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET1_JN"), iParam1);
			}
			break;
		case 148:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET2_AR"), iParam1);
			}
			else if (func_557(147))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET2B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET2A_JN"), iParam1);
			}
			break;
		case 149:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET3_AR"), iParam1);
			}
			else if (func_557(148))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET3B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET3A_JN"), iParam1);
			}
			break;
		case 150:
			if (bParam3 == 1)
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET4_AR"), iParam1);
			}
			else if (func_557(149))
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET4B_JN"), iParam1);
			}
			else
			{
				func_555(GET_HASH_KEY("JOURNAL_RC_WARVET4A_JN"), iParam1);
			}
			break;
		default:
			break;
	...
	switch (iVar0)
	{
		case 1:
			...
			switch (iVar1)
			{
				...
				case 9:
					if (func_365(Global_1835011[9 /*74*/].f_1) == 0)
					{
		...
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == 176656832)
		{
			...
			if (func_563(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_564(&(Global_40.f_4283.f_6[iVar4 /*5*/]), 1, 0);
					}
					iVar4++;
				}
			}
...
bool func_322(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
		...
		if (func_579(iParam0))
		{
			...
			if (func_399() && func_587(4))
			{
				if (!Global_1914319.f_17376)
				{
					if (func_399() && (func_588(38) || func_584(38)))
					{
						func_592(38, COLLECTION::_0x13AAECDA43318BFE(-2076669067, iVar6), COLLECTION::_0xD52D20B0C76BB26D(-2076669067, iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
						func_592(38, MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_COLLECTABLE_CIGCARD"), iVar7, 12, 0, iVar6);
					}
				}
			}
		}
	}
	if (func_593(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_593(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_593(iParam0) == GET_HASH_KEY("AMMO") && func_604(iParam0))
		{
		...
		{
			func_95(func_608(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_95(func_609(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_594(iParam0, 589988438))
		{
			if (func_611())
			{
				func_612(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		else if (func_594(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_351(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_351(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_351(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_624(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_625(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_624(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_631(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_632(499813453, 0);
				func_633(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_631(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_632(499813453, 0);
				func_633(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_631(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_632(499813453, 0);
				func_633(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_631(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_632(666607663, 0);
				func_634(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_631(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_632(666607663, 0);
				func_634(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_631(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_632(666607663, 0);
				func_634(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_631(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_632(-220219788, 0);
				func_635(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_631(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_632(-220219788, 0);
				func_635(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_631(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_632(-220219788, 0);
				func_635(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_631(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_632(218622660, 0);
				func_636(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_631(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_632(218622660, 0);
				func_636(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_631(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_632(390004462, 0);
				func_637(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_631(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_632(390004462, 0);
				func_637(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_631(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_632(390004462, 0);
				func_637(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_631(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_632(6410548, 0);
				func_638(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_631(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_632(6410548, 0);
				func_638(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_631(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_632(6410548, 0);
				func_638(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_631(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_632(6410548, 0);
				func_638(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_640(242, func_639(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_640(240, func_639(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_640(241, func_639(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
				...
				{
					func_641(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_641(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_641(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_641(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_641(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_641(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
void func_325(int iParam0)
{
	...
	func_672(GET_HASH_KEY("MPC_SP_DEFAULT_INTER_OUTFIT_TYPES"));
	iVar1 = 0;
	while (iVar1 < 39)
	{
	...
	Global_1946804.f_1616.f_1[8 /*3*/] = { func_675(8, 0) };
	Global_1946804.f_1616.f_1[9 /*3*/] = { func_675(9, 0) };
	Global_1946804.f_1616.f_1[0 /*3*/] = { func_675(0, 0) };
	Global_1946804.f_1616.f_1[2 /*3*/] = { func_675(2, 0) };
	Global_1946804.f_1616.f_1[3 /*3*/] = { func_675(3, 0) };
	Global_1946804.f_1616.f_1[1 /*3*/] = { func_675(1, 0) };
	Global_1946804.f_1616.f_1[5 /*3*/] = { func_675(5, 0) };
	Global_1946804.f_1616.f_1[6 /*3*/] = { func_675(6, 0) };
	Global_1946804.f_1616.f_1[7 /*3*/] = { func_675(7, 0) };
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (bVar7)
		{
			...
			while (iVar8 < 39)
			{
				...
				{
					func_677(&(Global_1946804.f_1616.f_1[iVar8 /*3*/]), iVar8, iVar0);
				}
				else
				{
					iVar8++;
...
char* func_328(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_331(Global_1835011[59 /*74*/].f_1, 1) || func_331(Global_1347702[1 /*49*/].f_15, 1)) || func_196(Global_1347702[1 /*49*/].f_15))
			{
				return "COMP_RUFUS";
			}
			else if (func_550(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
void func_330(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_681(&(Global_1946804.f_1497.f_1[iVar0 /*3*/]), 2, 6);
	func_681(&(Global_1946804.f_1378.f_1[iVar0 /*3*/]), 2, 6);
	if (bParam1)
	{
	...
	if (func_20() == -1)
	{
		...
		while (iVar1 < 5)
		{
			func_681(&(Global_26796.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
	...
	else
	{
		...
		while (iVar1 < 5)
		{
			func_681(&(Global_36638.f_45.f_350.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
...
bool func_337(int iParam0, int iParam1)
{
	...
	return func_688(&(Global_40.f_9910[iParam1 /*6*/]), 4);
}
...
void func_339(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		func_699(&(Global_40.f_9910[iVar0 /*6*/]), 2);
	}
...
void func_352(int iParam0)
{
	...
	if (iParam0 < 0)
	{
		func_701(MISC::VAR_STRING(2, "MISSION_COMPLETE_BANK_FEED", MISC::ABSI(iParam0)), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
		Global_1879514.f_14 = 1;
		Global_1879514.f_15 = 0;
	}
	else
	{
		func_701(MISC::VAR_STRING(2, "MISSION_COMPLETE_LOAN_FEED", iParam0), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Negative", 0, 1);
...
void func_362(int iParam0)
{
	...
	{
		case 1:
			func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
			iVar0 = func_276(iParam0);
			func_95(func_94(GET_HASH_KEY("MISSIONS_PROGRESSED")), 1);
			switch (func_483(iVar0))
			{
				case 0:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP1")), 1);
					break;
				case 1:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP2")), 1);
					break;
				case 2:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP3")), 1);
					break;
				case 3:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP4")), 1);
					break;
				case 4:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP5")), 1);
					break;
				case 5:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP6")), 1);
					break;
				case 6:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP7")), 1);
					break;
				case 7:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP8")), 1);
					break;
				case 8:
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP9")), 1);
					break;
				default:
					iVar2 = 0;
					break;
			...
			if (iVar0 == 7)
			{
				func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
			}
			if (iVar2 && MISSIONDATA::MISSIONDATA_IS_REQUIRED_STORY_MISSION(MISC::GET_HASH_KEY(&(Global_1835011[iVar0 /*74*/].f_8))))
			{
				func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("REQUIRED_MISSIONS")), 1);
			}
			break;
		case 8:
			iVar1 = func_276(iParam0);
			...
			if (func_305(Global_1347702[iVar1 /*49*/].f_12, 4) || iVar1 == 59)
			{
				if (func_305(Global_1347702[iVar1 /*49*/].f_12, 1))
				{
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
				...
				{
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC")), 1);
				}
			}
			if (func_305(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
			...
			else if (func_305(Global_1347702[iVar1 /*49*/].f_12, 4))
			{
				if (func_305(Global_1347702[iVar1 /*49*/].f_12, 4194304))
				{
				}
				else if (!func_305(Global_1347702[iVar1 /*49*/].f_12, 512))
				{
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS")), 1);
				}
				else
				{
					func_95(func_609(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
...
void func_363()
{
	...
	if (iVar1 == 1)
	{
		func_708(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_SINGLE", 1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	else if (iVar1 > 1)
	{
		func_708(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_PLURAL", iVar1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	if (iVar3 > 0)
	{
		func_709(iVar3, 0, 0);
...
int func_368(int iParam0)
{
	...
	{
		case 0:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 1:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 2:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 2;
		case 4:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 5:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		...
		case 12:
			return 75000;
		case 8:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 9:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 10:
			return func_719(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
...
char[] func_369(int iParam0)
{
	...
	switch (func_200(iParam0))
	{
		case 1:
			...
			break;
		case 8:
			cVar0 = Global_1347702[func_276(iParam0) /*49*/].f_3;
			break;
		case 11:
			if (iParam0 == func_367(0, 10, 11, GET_HASH_KEY("CABR01")))
			{
...
void func_370(char[4] cParam0)
{
	...
	if (!Global_1879514.f_11)
	{
		...
		if (MISSIONDATA::MISSIONDATA_GET_RATING(iVar1) != 5 && iVar0 == 5)
		{
			...
			else if (func_200(Global_1879514.f_1) == 8 && (func_305(Global_1347702[func_276(Global_1879514.f_1) /*49*/].f_12, 1) || func_305(Global_1347702[func_276(Global_1879514.f_1) /*49*/].f_12, 33554432)))
			{
				func_366(5, 1);
			}
		}
...
void func_382(bool bParam0)
{
	...
	func_380(&(Global_1347343.f_11), 1073741824 /* Float: 2f */);
	if (bParam0)
	{
...
{
	func_752(uParam0, iLocal_75, iLocal_76, 117936, 118523, 118794, 119088, 119260, "mar4_int", 66, -1);
	func_752(uParam0, iLocal_76, iLocal_77, 119540, 120099, 120378, 120819, 121211, "mar4_mcs1", 66, -1);
	func_752(uParam0, iLocal_77, iLocal_78, 121397, 121904, 122145, 122978, 124952, "mar4_mcs2", 1577027, -1);
	func_752(uParam0, iLocal_78, iLocal_79, 125121, 125564, 125627, 125833, 127936, "", 524353, -1);
	func_752(uParam0, iLocal_79, iLocal_80, 128074, 128699, 129213, 129635, 131265, "mar4_mcs4", 66, -1);
	func_752(uParam0, iLocal_80, 26, 131328, 131830, 132248, 132312, 132343, "mar4_ext", 66, -1);
}
...
void func_392(var uParam0)
{
	...
	while (iVar0 < ITEMSET::GET_ITEMSET_SIZE(Global_43616))
	{
		...
		else
		{
			...
			DECORATOR::DECOR_REMOVE(iVar2, func_779());
		}
		iVar0++;
	}
...
void func_418(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_814(uParam0[iVar0 /*3*/]))
		{
			if (func_815((uParam0[iVar0 /*3*/])->f_2, iParam12))
			{
				func_816(uParam0[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam1)
	{
		if (func_817(uParam1[iVar0 /*5*/]))
		{
			if (func_815((uParam1[iVar0 /*5*/])->f_4, iParam12))
			{
				func_818(uParam1[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_819(uParam2[iVar0 /*3*/]))
		{
			if (func_815((uParam2[iVar0 /*3*/])->f_2, iParam12))
			{
				func_820(uParam2[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_821(uParam3[iVar0 /*3*/]))
		{
			if (func_815((uParam3[iVar0 /*3*/])->f_2, iParam12))
			{
				func_822(uParam3[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_824(uParam5[iVar0 /*67*/]))
		{
			if (func_815((uParam5[iVar0 /*67*/])->f_3, iParam12))
			{
				func_825(uParam5[iVar0 /*67*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_824(uParam5[iVar0 /*67*/]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_826(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/])))
				{
					if (func_815((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/].f_2, iParam12))
					{
						func_827(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/]), (uParam5[iVar0 /*67*/])->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_828(uParam6[iVar0 /*4*/]))
		{
			if (func_815((uParam6[iVar0 /*4*/])->f_3, iParam12))
			{
				func_829(uParam6[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_830(uParam7[iVar0 /*5*/]))
		{
			if (func_815((uParam7[iVar0 /*5*/])->f_4, iParam12))
			{
				func_831(uParam7[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_832(uParam8[iVar0 /*3*/]))
		{
			if (func_815((uParam8[iVar0 /*3*/])->f_2, iParam12))
			{
				func_833(uParam8[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_834(uParam9[iVar0 /*3*/]))
		{
			if (func_815((uParam9[iVar0 /*3*/])->f_2, iParam12))
			{
				func_835(uParam9[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_836(uParam10[iVar0 /*4*/]))
		{
			if (func_815((uParam10[iVar0 /*4*/])->f_3, iParam12))
			{
				func_837(uParam10[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_838(uParam11[iVar0 /*3*/]))
		{
			if (func_815((uParam11[iVar0 /*3*/])->f_2, iParam12))
			{
				func_839(uParam11[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
...
bool func_425(var uParam0, int iParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_824(uParam0[iVar0 /*67*/]))
		{
			if (func_815((uParam0[iVar0 /*67*/])->f_3, iParam1))
			{
				if ((uParam0[iVar0 /*67*/])->f_65 > 0f || func_846((uParam0[iVar0 /*67*/])->f_2, 4))
				{
					if (!func_847(uParam0[iVar0 /*67*/]))
					{
						iVar1 = 0;
					}
				}
			...
			else
			{
				...
				if (iVar11 != 0)
				{
					...
					if (iVar11 == 2 && !ENTITY::IS_ENTITY_DEAD(bVar12))
					{
						...
						else if (func_852(bVar12, uParam0->f_5411, 5f, 1))
						{
							if (func_853(bVar12))
							{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar13))
	{
		...
		if (!func_120(uParam0, 256))
		{
			if (!func_120(uParam0, 32768))
			{
				...
				vVar14.f_1 = uParam3;
				vVar14.f_2 = uParam4;
				if ((!func_853(bVar13) || func_856(Global_35, bVar13, 1, 1) > 200f) && !func_400(vVar14))
				{
					if (!func_29())
					{
						ENTITY::FREEZE_ENTITY_POSITION(bVar13, false);
						func_857(bVar13, vVar14, fParam5, 2, 1073741824 /* Float: 2f */);
					}
				}
			}
		}
...
bool func_434(var uParam0)
{
	...
	switch (iVar0)
	{
		...
		case 25:
			...
			{
				PED::REMOVE_TAG_FROM_META_PED(Local_133[1 /*53*/], GET_HASH_KEY("HATS"), 1);
	...
	func_182(1);
	func_393(22);
	if (!ENTITY::DOES_ENTITY_EXIST(bLocal_2008))
	{
		bLocal_2008 = func_870(-2595.867f, 471.7623f, 145.1132f, 0f, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_2008, true);
		return false;
	}
	func_871(-1, 1);
	...
	func_145(uParam0, Local_133[0 /*53*/], "ABIGAIL", 0);
	func_145(uParam0, Local_133[1 /*53*/], "TEEN_JACK", 0);
	func_874(uParam0, 148474);
	func_876(uParam0, 148865);
	func_878(uParam0, 150819);
	func_879(6);
	func_880(16, 0, 0);
	func_177(16, 1, 0);
...
bool func_436(var uParam0)
{
	...
	switch (iVar2)
	{
		case 0:
			...
			{
				if (func_894(uParam0, func_33(uParam0)) != -1 && PED::_0x62DE46F061CAA468() < func_894(uParam0, func_33(uParam0)))
				{
					PED::_0xF008E0BA1FE1D644((func_894(uParam0, func_33(uParam0)) - PED::_0x62DE46F061CAA468()));
				}
		...
		case 5:
			...
			else
			{
				...
				if ((func_914(PLAYER::GET_PLAYER_INDEX(), 0, 0, 1) && !func_120(uParam0, 8192)) && !func_121(uParam0, func_33(uParam0), 8))
				{
					func_47(1, 0);
...
bool func_440(var uParam0, bool bParam1)
{
	...
	return func_444(uParam0, bParam1, &uVar0);
}
...
void func_442(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	...
	if (!func_444(uParam0, bParam1, &iVar0))
	{
		return;
	}
	func_919(&(uParam0->f_5423[iVar0 /*65*/]), iParam2);
}

void func_443(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	...
	func_920(&(uParam0->f_5423[iVar0 /*65*/]), iParam2);
}

bool func_444(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
void func_445(var uParam0)
{
	...
	if (func_519(uParam0, 128) || bVar0)
	{
		...
		else if ((MAP::DOES_BLIP_EXIST(MAP::GET_BLIP_FROM_ENTITY(*uParam0)) && uParam0->f_8 != MAP::GET_BLIP_FROM_ENTITY(*uParam0)) || !func_852(Global_35, *uParam0, 150f, 1))
		{
...
void func_446(int iParam0)
{
	...
	if (Global_1360165[iParam0 /*1157*/].f_12 != Global_1360165[iParam0 /*1157*/].f_13 || func_922(iParam0, 36, 1))
	{
		func_923(iParam0, 36, 1);
		Global_1360165[iParam0 /*1157*/].f_12 = Global_1360165[iParam0 /*1157*/].f_13;
		func_924(iParam0, &(Global_1360165[iParam0 /*1157*/].f_2));
	}
}
...
void func_449(int iParam0, int iParam1, bool bParam2)
{
	...
	func_925(&(Global_1360165[iParam0 /*1157*/].f_13), iParam1, bParam2);
}
...
void func_451(var uParam0, bool bParam1)
{
	...
	if (ENTITY::IS_ENTITY_AN_OBJECT(bParam1) && func_926(uParam0, ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(bParam1)))
	{
...
void func_453(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_448(&(Global_1360165[iParam0 /*1157*/].f_12), 1))
		{
...
void func_454(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_929(Global_1360165[iParam0 /*1157*/], 0);
	...
	if (bParam3)
	{
		...
		func_931(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
	...
	else
	{
		...
		{
			func_549(&(Global_1360165[iParam0 /*1157*/].f_130));
		}
		if (bParam9)
		{
...
void func_456(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (bVar0 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()) && bVar3)
		{
			if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_27))
			{
				...
				func_939(&(Global_1900383[iParam0 /*45*/].f_27));
			}
		}
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		...
		func_941(&(Global_1900383[iParam0 /*45*/].f_26), bVar6);
	}
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_945(Global_1900383[iParam0 /*45*/].f_26);
...
void func_462(int iParam0, float fParam1, int iParam2)
{
	...
	iVar0 = func_948(BUILTIN::CEIL(Global_40.f_11095[iParam0]));
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(Global_35, func_949(iParam0), iVar0);
	func_951(func_950(iParam0), (100f * (BUILTIN::TO_FLOAT(iVar0) / 100f)), 0);
	if (((fParam1 <= func_952(15) && iParam0 == 1) && PED::IS_PED_ON_FOOT(Global_35)) && !PED::IS_PED_SWIMMING(Global_35))
	{
		func_329(84, 1);
	}
	if (fParam1 <= -99.999f)
		...
		while (iVar28 < 4)
		{
			...
			if (func_959(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_601(0))
				{
					...
					func_602(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
void func_510(int iParam0, bool bParam1)
{
	...
	if (func_82(32768))
	{
		Global_2621440[iParam0 /*12066*/].f_9.f_14 = func_289();
	}
}
...
void func_511(int iParam0, vector3 vParam1, var uParam4)
{
	...
	Global_2621440[iParam0 /*12066*/].f_9.f_15 = func_376(vParam1, 1);
}
...
void func_535(int iParam0, char* sParam1, int iParam2)
{
	...
	func_701(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_536(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_701(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_701(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_551(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 60)
	{
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == iParam0)
		{
			func_564(&(Global_40.f_4283.f_6[iVar0 /*5*/]), bParam1, bParam2);
			return 1;
		}
		iVar0++;
	}
...
int func_558()
{
	...
	iVar0 = func_993(Global_1347702[9 /*49*/].f_15);
	iVar1 = func_993(Global_1835011[69 /*74*/].f_1);
...
bool func_559(int iParam0)
{
	...
	return func_331(Global_1835011[iParam0 /*74*/].f_1, 1);
}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_701(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_701(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_701(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_701(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
int func_578(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_969(bParam2), iParam0, 0);
	return iVar2;
}
...
bool func_584(int iParam0)
{
	...
	return func_331(Global_1347702[iParam0 /*49*/].f_15, 1);
}
...
void func_592(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1031(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1031(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_708(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, func_1032(func_586(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1031(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
bool func_601(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_969(bParam0));
}
...
bool func_603(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_1016(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_1003())
				{
					return false;
				}
				...
				{
					func_475(iVar0, WEAPON::GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
bool func_605(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_351(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
	...
	if (iVar2 == (iVar3 + iVar0))
	{
		if (func_20() == -1)
		{
			if (func_331(Global_1835011[14 /*74*/].f_1, 1))
			{
				func_329(416, 0);
			}
		}
