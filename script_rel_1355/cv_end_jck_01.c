...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, 0.65f, 1.1f, 0f, -120f, 0.5f, 0.35f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_HAYBALE03X"), 0f, 0f, 0f, "HAYBALE", 0, 0, 1);
	func_154(uParam0, GET_HASH_KEY("A_C_HORSE_MORGAN_FLAXENCHESTNUT"), "HORSE");
	...
	func_157(uParam0, GET_HASH_KEY("COMP_BCJCKCNV1"), GET_HASH_KEY("PLAYER_BCJCKCNV1"));
	func_158(uParam0, iLocal_17, -1, 0.61f);
	func_159(uParam0, iLocal_14, 1, -1);
	iLocal_18 = func_160(uParam0, -0.07f, -0.35f, 1f, 0f, 0f, -27f, 9.84f, 10.52f, 5f, "volTrigger", GET_HASH_KEY("VOLBOX"));
	func_161(uParam0, 1);
