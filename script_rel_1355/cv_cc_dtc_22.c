...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.5f, -2.6333f, 1f, 0f, 6f, 5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, iLocal_21, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_155(uParam0, iLocal_15, 1, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, iLocal_22, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKING_FEMALE_B", -1, 1);
