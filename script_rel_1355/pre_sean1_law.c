...
bool func_3()
{
	return GET_HASH_KEY("S_M_M_PINLAW_01");
}

int func_4()
{
	return GET_HASH_KEY("A_C_HORSE_AMERICANSTANDARDBRED_BLACK");
}

int func_5()
{
	return GET_HASH_KEY("A_C_HORSE_APPALOOSA_BLANKET");
}
...
bool func_6()
{
	...
	while (iVar0 < 4)
	{
		...
		else if (!ENTITY::DOES_ENTITY_EXIST(bLocal_0[iVar0]) && bVar5)
		{
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_0[iVar0], GET_HASH_KEY("REL_PINKERTONS"));
			...
			iLocal_16[iVar0] = MAP::BLIP_ADD_FOR_ENTITY(GET_HASH_KEY("BLIP_STYLE_COP"), bLocal_0[iVar0]);
...
void func_28(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_69(bParam1))
		{
			func_70(bParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_101(bool bParam0, bool bParam1)
{
	...
	if (func_137(bParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
