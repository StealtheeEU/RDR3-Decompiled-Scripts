...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5225f, -0.0596f, 1f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, -0.2943f, 7.2323f, 1f, -19f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG0", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG1", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SNKPARCNV3"), GET_HASH_KEY("PLAYER_SNKPARCNV3"));
	func_156(uParam0, iLocal_16, -1, 0.67f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_WALL_DRINKING_MALE_B", -1, 1);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_WALL_DRINKING_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
