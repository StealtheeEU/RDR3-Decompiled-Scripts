...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -13.0561f, 9.7196f, 0f, 53f, 2.49f, 2.2825f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_151(uParam0, -17.3311f, 17.0071f, 0f, 53f, 1.1f, 1.1f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "p_mugCoffee01x", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SWNCNV17"), GET_HASH_KEY("PLAYER_SWNCNV17"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
