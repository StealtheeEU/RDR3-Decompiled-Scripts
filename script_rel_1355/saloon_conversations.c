...
bool func_20(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 6:
			...
			else if (!func_47(GET_HASH_KEY("WEAPON_SHOTGUN_DOUBLEBARREL")))
			{
				return false;
			}
			return true;
		...
		case 84:
			...
			if (func_60(func_59(76), GET_HASH_KEY("TSTAG_LOCKDOWN_SALOON"), 1))
			{
				return false;
			}
		...
		case 16:
			...
			if (!func_62(GET_HASH_KEY("CONSUMABLE_WHISKEY"), 1, 0))
			{
				return false;
			}
			return true;
		...
		case 66:
			...
			if (func_62(GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"), 1, 0))
			{
				return false;
			}
			return true;
...
bool func_58(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_60(iVar0, GET_HASH_KEY("TSTAG_LOCKDOWN"), 1))
	{
		return true;
	}
	if (bParam1)
	{
		switch (iParam2)
		{
			case 0:
			case 2:
				if (func_60(iVar0, GET_HASH_KEY("TSTAG_LOCKDOWN_SALOON"), 1) || func_60(iVar0, GET_HASH_KEY("TSTAG_LOCKDOWN_PARTIAL"), 1))
				{
					return true;
				}
				break;
			case 1:
				if (func_60(iVar0, GET_HASH_KEY("TSTAG_LOCKDOWN_SALOON_SLUMS"), 1) || func_60(iVar0, GET_HASH_KEY("TSTAG_LOCKDOWN_PARTIAL"), 1))
				{
					return true;
				}
				break;
...
float func_78(bool bParam0, vector3 vParam1, bool bParam4)
{
...
bool func_93(int iParam0, int iParam1)
{
	...
	{
		if ((func_189(iParam0, iParam1) == GET_HASH_KEY("CS_JOHNMARSTON") || iParam1 == 0) || iParam1 == 8)
		{
			return true;
		}
	}
	else if (func_189(iParam0, iParam1) != GET_HASH_KEY("CS_JOHNMARSTON"))
	{
		return true;
	}
	return false;
...
bool func_173(bool bParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_253(bParam0, uParam2, *uParam3);
				return true;
			}
		}
		if (Global_1935630.f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_255(bParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_253(bParam0, uParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_25)
		{
			if (func_257(uParam2, 1065353216 /* Float: 1f */))
			{
				...
				{
					if (func_259(Global_35, bParam0, uParam2))
					{
						*uParam3 = 256;
						func_253(bParam0, uParam2, *uParam3);
						return true;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_260(Global_35, bParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_253(bParam0, uParam2, *uParam3);
					return true;
			...
			else if (func_260(Global_35, bParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_253(bParam0, uParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_264(bParam0, Global_1935630.f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_265(uParam2, bParam0)) && func_266(uParam2, bParam0))
					{
						*uParam3 = 2;
						func_253(bParam0, uParam2, *uParam3);
						return true;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_264(bParam0, Global_1935630.f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_265(uParam2, bParam0)) && func_266(uParam2, bParam0))
				{
					*uParam3 = 2;
					func_253(bParam0, uParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_267(bParam0, Global_1935630.f_41))
							{
								func_268();
								*uParam3 = 2;
								func_253(bParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_269(uParam2, bParam0) || (uParam2->f_9 > 0 && (func_270() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_271())
					{
						if (func_267(bParam0, Global_1935630.f_42))
						{
							func_268();
							*uParam3 = 2;
							func_253(bParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_273(bParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_253(bParam0, uParam2, *uParam3);
					return true;
...
int func_237(int iParam0, bool bParam1)
{
	...
	if (!func_313(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_236(iVar14);
...
int func_240(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_234("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_ONE_HANDED(Var4.f_4) && (!WEAPON::IS_WEAPON_SHOTGUN(Var4.f_4) || func_315(iParam1, 32))) && (!WEAPON::IS_WEAPON_PISTOL(Var4.f_4) || !func_315(iParam1, 16777216))) && (!WEAPON::IS_WEAPON_REVOLVER(Var4.f_4) || !func_315(iParam1, 33554432)))
				{
...
bool func_248(int iParam0)
{
	...
	while (iVar48 < iVar0)
	{
		...
		{
			if (Var1.f_2 == GET_HASH_KEY("COST_TYPE_CRAFT") && !func_320(iParam0, Var1, 1))
			{
				return true;
			}
		}
...
bool func_252(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case GET_HASH_KEY("EVENT_DEAD_PED_FOUND"):
			...
			if (!func_328(bParam0, uParam1, iVar2))
			{
				return false;
			}
			if (func_329(bParam0, iVar2) <= func_330(uParam1))
			{
				return true;
			}
			break;
...
void func_253(bool bParam0, var uParam1, int iParam2)
{
	if (iParam2 != 16384)
	{
...
bool func_254(bool bParam0, var uParam1)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	{
		if (func_334(bParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			if (func_336(uParam1, bParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
bool func_255(bool bParam0, int iParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	...
	if (func_338(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_336(uParam2, bParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
...
bool func_256(bool bParam0, var uParam1)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_328(bParam0, uParam1, bVar1))
	{
		if (uParam1->f_3 == 0)
		{
...
bool func_258(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_259(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_260(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(GET_HASH_KEY("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_342(bParam1, vVar0, vVar4))
					{
						func_332(uParam2, 1);
						return true;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(GET_HASH_KEY("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_342(bParam1, vVar0, vVar7))
					{
						func_332(uParam2, 1);
						return true;
					}
...
bool func_261(bool bParam0, var uParam1)
{
	...
	{
		if (!func_328(bParam0, uParam1, Global_1935630.f_34[iVar0]) || bParam0 == Global_1935630.f_34[iVar0])
		{
		}
		else
		{
			...
			if (func_345(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				vVar2[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[iVar0], false, false) };
				vVar2[1 /*3*/] = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_346(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				vVar2[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[iVar0], false, false) };
				vVar2[1 /*3*/] = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_347(uParam1, bParam0, fVar1, iVar0))
			{
				vVar2[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[iVar0], false, false) };
				vVar2[1 /*3*/] = { vVar9 };
				uParam1->f_10 = bParam0;
...
bool func_262(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_264(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_267(bool bParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_351(bParam0, iParam1, 1, 1) < 4f)
		{
...
bool func_269(var uParam0, bool bParam1)
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_352(iVar0, bParam1, vVar1))
		{
...
int func_273(bool bParam0, int iParam1, var uParam2)
{
	...
	return func_356(bParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case GET_HASH_KEY("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::_0x06087579E7AA85A9(bParam0, bVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_358(uParam1, bParam0))
					{
						if (func_78(bVar4, Global_36, 1) < 7f)
						{
							return true;
						}
					}
...
bool func_277(bool bParam0, var uParam1)
{
...
bool func_279(var uParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
bool func_320(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((bParam2 && func_133() == 0) && !UNLOCK::UNLOCK_IS_VISIBLE(iParam0))
	{
		return false;
	}
	if (!func_387(iParam0, iParam1, &uVar0, &iVar11) || iVar11 < 1)
	{
		return false;
	}
	iVar12 = 0;
...
bool func_328(bool bParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_329(bool bParam0, int iParam1)
{
	return func_351(bParam0, iParam1, 1, 1);
}
...
bool func_334(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_351(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_393(bVar0, 0)))
		{
			if (func_394(bParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_336(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_342(bool bParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_396(bParam0, vParam4, 0.5f))
	{
...
bool func_345(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_346(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_347(var uParam0, bool bParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_349(int iParam0, bool bParam1)
{
	...
	if (func_399(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
float func_351(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
bool func_352(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_78(bParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_356(bool bParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_351(bParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_351(bParam0, Global_1935630.f_40, 0, 1) < 2.5f)
		{
...
bool func_357(bool bParam0, var uParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;

	func_390(1, &bVar0, &bVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		if (bVar0 != bParam0)
		{
			if (PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
				{
					if (!bParam2 || !func_358(uParam1, bVar0))
					{
						return true;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar1))
	{
		if (bVar1 != bParam0)
		{
			...
			{
				if (!bParam2 || !func_358(uParam1, bVar1))
				{
					if (func_78(bVar1, Global_36, 1) < 5f)
					{
						return true;
					}
				}
...
{
	return func_386(GET_HASH_KEY("CHARACTER"), func_404(), -1591664384, bParam0);
}
...
struct<4> func_386(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_238(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

bool func_387(int iParam0, int iParam1, var uParam2, int iParam3)
{
	struct<37> Var0;
	int iVar47;
...
var func_393(bool bParam0, int iParam1)
{
	var uVar0;
...
bool func_394(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_395(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return true;
		}
	}
...
bool func_396(bool bParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
