...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -0.9083f, 7.1176f, 1f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	func_152(uParam0, 1.5425f, 2.3927f, 1f, 67.68f, 3f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_153(uParam0, 1.5425f, 2.3927f, 1f, 67.68f, 3f, 2f, 3f, GET_HASH_KEY("VOLBOX"), 1);
	iLocal_24 = func_154(uParam0, GET_HASH_KEY("P_POCKETMIRROR01X"), 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	iLocal_21 = func_154(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = func_154(uParam0, GET_HASH_KEY("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_154(uParam0, GET_HASH_KEY("P_BASINWATER01X"), 2.00448f, 2.79416f, 0.00851059f, 0, 1, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_POCKET_MIRROR"), "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216 /* Float: 1f */, 1);
