...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3766f, -1.0093f, 1.0122f, -22.5144f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -3.4501f, 4.1917f, 1.0412f, -108f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, 0.9f, -0.6f, 0f, 0f, 1f, 1f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.482346f, -1.0508f, -0.000579834f, "BARREL", 1, 0, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGAR01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (!func_154(14))
	{
	...
	if (func_154(14))
	{
		func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_MALE_D", -1, 0);
		func_159(uParam0, iLocal_15, -142.259f, -23.514f, 95.088f, 159.922f, 0, 0);
		func_158(uParam0, iLocal_14, 0, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", -1, 0);
	...
	{
		func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_19, 0);
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
