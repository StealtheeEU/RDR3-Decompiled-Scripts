...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 7.4f, 32.62f, -1.5769f, -22.68f, 6f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, 6.1972f, 33.3594f, -1.56593f, 0f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_FISHINGPOLE02X"), 0f, 0f, 0f, "FISHINGPOLE", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_STAND_FISHING"), "WORLD_HUMAN_STAND_FISHING_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, GET_HASH_KEY("COMP_DNVCNV2"), GET_HASH_KEY("PLAYER_DNVCNV2"));
	return true;
}
