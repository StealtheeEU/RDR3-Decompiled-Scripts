...
void func_8(var uParam0)
{
	...
	{
		if (!VOLUME::DOES_VOLUME_EXIST(Local_24.f_12[0]))
		{
			return;
		}
		if (!VOLUME::DOES_VOLUME_EXIST(Local_24.f_12[1]))
		{
			return;
		}
		if (VOLUME::DOES_VOLUME_EXIST(Local_24.f_12[2]))
		{
		...
		{
			if (VOLUME::DOES_VOLUME_EXIST(Local_24.f_12[3]))
			{
	...
	switch (Local_24)
	{
		case 0:
			...
			if (Local_24.f_1 == GET_HASH_KEY("THUNDERSTORM"))
			{
				Local_24.f_1 = GET_HASH_KEY("SUNNY");
			}
		...
		case 2:
			...
			break;
		case 7:
			MISC::SET_WEATHER_TYPE(Local_24.f_1, false, false, true, 60f, false);
		...
		case 5:
			...
			MISC::SET_WEATHER_TYPE(GET_HASH_KEY("THUNDERSTORM"), false, true, true, 60f, false);
			func_25(&(Local_24.f_2));
			func_25(&uLocal_21);
			func_49(&Local_24, 6);
			break;
...
bool func_50(var uParam0)
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			uParam0->f_12[iVar1] = VOLUME::_CREATE_VOLUME_BY_HASH_WITH_CUSTOM_NAME(Var2.f_10, Var2, Var2.f_3, Var2.f_6, Var2.f_9);
		}
		iVar0++;
	}
	return true;
			...
			if (func_172(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_160(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_129() <= -160;
...
{
	return func_202(GET_HASH_KEY("CHARACTER"), func_203(), -1591664384, bParam0);
}
