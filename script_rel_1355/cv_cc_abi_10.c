...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.85f, 1.2125f, 0f, -2.75f, 4.14f, 6.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, "CRATE 1", 0, 0, 1);
	iLocal_31 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "CRATE 2", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_31, 0, 20f, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_15, 1, 12, 0, 0, 0);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
