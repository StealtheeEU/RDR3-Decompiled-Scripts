...
void func_247(var uParam0, int iParam1, int iParam2, char* sParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(uParam0->f_968[iParam1 /*29*/].f_1, sParam3, &Var0, false, 0, 2))
		{
...
bool func_273(int iParam0)
{
	...
	if (PED::GET_PED_IS_GRAPPLING(iParam0) || PED::GET_PED_IS_GRAPPLED(iParam0))
	{
		return true;
	}
