...
bool func_72(var uParam0)
{
	...
	iLocal_21 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottleJD01x", 0, 0, 1);
	iLocal_18 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottleJD01x^1", 0, 0, 1);
	iLocal_20 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "p_bottleJD01x^2", 0, 0, 1);
	iLocal_19 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottleJD01x^3", 0, 0, 1);
	iLocal_22 = func_151(uParam0, GET_HASH_KEY("P_BOTTLECRATE02X"), 0f, 0f, 0f, "p_bottlecrate02x", 0, 0, 1);
	iLocal_23 = func_151(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), 0f, 0f, 0f, "p_chair_barrel04b", 1, 0, 1);
	iLocal_24 = func_151(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, "p_chair_crate02x", 1, 0, 1);
	iLocal_25 = func_151(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "p_chair_crate15x", 1, 0, 1);
	iLocal_26 = func_151(uParam0, GET_HASH_KEY("S_CRATESEAT03X"), 0f, 0f, 0f, "s_crateseat03x", 1, 0, 1);
	func_152(uParam0, -0.0375f, 0f, 0.8695f, 90.75f, 3.1375f, 3.5075f, 2.045f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_HSHWRKCNV2"), GET_HASH_KEY("PLAYER_HSHWRKCNV2"));
	func_156(uParam0, iLocal_31, -1, 0.93f);
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_24, 0, 25f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_16, iLocal_20, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_159(uParam0, iLocal_16, 4, 2, 0, 0, 0);
	func_157(uParam0, iLocal_17, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_23, 0, 47f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_17, iLocal_21, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_17, 4, 2, 0, 0, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", iLocal_25, 0, 38f, 1065353216 /* Float: 1f */, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_HSHWRKCNV2"), GET_HASH_KEY("PLAYER_HSHWRKCNV2"));
	func_161(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_FEMALE_A", iLocal_26, 0, 55f, 1065353216 /* Float: 1f */, 1);
...
{
	return (STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), false) && STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), false));
}
...
int func_249()
{
	...
	if (func_326(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_250()
{
	...
	if (func_326(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_338(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_371(iParam1))
		{
			func_372(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_404(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_449(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_449(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_449(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_468(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_480(GET_HASH_KEY("CHARACTER"), func_502(), -1591664384, bParam0);
}
