...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.2548f, -4.3769f, 1.2774f, 137.8534f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 0.72f, -0.97f, 1f, 90f, 3f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_PLATE03X"), 0f, 0f, 0f, "PLATE", 0, 1, 1);
	...
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
