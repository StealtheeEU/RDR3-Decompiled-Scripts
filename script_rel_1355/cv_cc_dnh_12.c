...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -1.1351f, 0.0301f, 1f, 0f, 1.2f, 1f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_150(uParam0, -0.2921f, -0.706f, 1f, 0f, 1f, 1.2f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("P_CHAIR11X"), -1.28541f, -0.0281395f, 0.0136185f, "Chair", 1, 0, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_DNHCNV12"), GET_HASH_KEY("PLAYER_DNHCNV12"));
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
