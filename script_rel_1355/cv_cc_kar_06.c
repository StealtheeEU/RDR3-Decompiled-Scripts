...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0858085f, 4.47941f, 1f, 0f, 1f, 1f, 1f, GET_HASH_KEY("VOLCYLINDER"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.6f, -0.5f, 0.99f, 0f, 1.5f, 1.5f, 1f, GET_HASH_KEY("VOLCYLINDER"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_152(uParam0, 0.6f, -0.5f, 0.99f, 0f, 1.5f, 1.5f, 1f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "KAREN_BOWL", 0, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "KAREN_SPOON", 0, 0, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "SUSAN_BOWL", 0, 0, 1);
	iLocal_23 = func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SUSAN_SPOON", 0, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.67993f, -0.624575f, 0.00882721f, 0, 1, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, 1, -1);
	func_155(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", -1, 0, 120f, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, GET_HASH_KEY("COMP_KARCNV6"), GET_HASH_KEY("PLAYER_KARCNV6"));
...
void func_416(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_457(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_457(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_403(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_457(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_474(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_482(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_494(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_486(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_486(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_486(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_504(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_486(GET_HASH_KEY("CHARACTER"), func_508(), -1591664384, bParam0);
}
