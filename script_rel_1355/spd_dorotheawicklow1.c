...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if ((iLocal_14 != 45 && VOLUME::DOES_VOLUME_EXIST(iLocal_174)) && func_3(Global_35, iLocal_174, 1, 0))
			{
			...
			else
			{
				...
				switch (iLocal_14)
				{
					...
					case 1:
						...
						if (!HUD::TEXT_BLOCK_IS_LOADED("SPDWAU"))
						{
						}
					...
					case 3:
						...
						if (((func_68(&iLocal_168, iLocal_159, 2547.9f, -1215.18f, 52.3135f) && func_71(&(uLocal_164[0]), iLocal_160, &iVar0, func_69(0), func_70(0), 2, 0, 1)) && func_71(&(uLocal_164[1]), iLocal_161, &iVar0, func_69(1), func_70(1), 1, 0, 1)) && func_71(&(uLocal_164[2]), iLocal_162, &iVar0, func_69(2), func_70(2), 2, 0, 1))
						{
							if (((func_5(iLocal_163, 0) && func_5(uLocal_164[0], 0)) && func_5(uLocal_164[1], 0)) && func_5(uLocal_164[2], 0))
							{
								...
								func_79(&iLocal_163, &uLocal_183, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
								if (func_64())
								{
					...
					case 38:
						...
						if (((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_181) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_181, true, false)) && ANIMSCENE::_0x1F0E401031E20146(iLocal_181, func_120())) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_181) >= func_122(38))
						{
							func_85(0);
							func_121();
							func_9(&iLocal_182, 2097152);
					...
					case 39:
						...
						if (((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_181) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_181, true, false)) && ANIMSCENE::_0x1F0E401031E20146(iLocal_181, func_120())) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_181) >= func_122(39))
						{
							func_85(0);
							func_121();
							func_9(&iLocal_182, 2097152);
...
void func_1()
{
	...
	func_125(&uLocal_219);
	func_85(0);
	func_126(&iLocal_163, &uLocal_183, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
	func_127();
	func_128(8);
	...
	switch (iLocal_245)
	{
		...
		case 10:
			if (iLocal_243 != -1)
			{
				...
				else if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_243) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_243, true, false))
				{
...
bool func_174()
{
	if (((((func_19(iLocal_182, 262144) && func_19(iLocal_182, 524288)) && iLocal_14 >= 31) && iLocal_14 <= 36) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_253)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_253) >= 0.1f)
	{
		func_80(&iLocal_182, 524288);
		bLocal_242 = true;
		return true;
...
bool func_279(int iParam0, vector3 vParam1, float fParam4)
{
...
bool func_287()
{
	if (((((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630.f_12) && VOLUME::DOES_VOLUME_EXIST(iLocal_170)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_170, true, 0)) && func_404(Global_35, iLocal_163, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_245 >= 11 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_253)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_253) >= 0.8f) && iLocal_14 != 44) || (iLocal_14 >= 31 && iLocal_14 <= 36))) && !func_19(iLocal_182, 2)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, true)) && !PED::IS_PED_ON_MOUNT(Global_35)) && !func_162(&iLocal_163, &iLocal_324, 1071644672 /* Float: 1.75f */, 1074790400 /* Float: 2.25f */)) && !func_405(&iLocal_163, &iLocal_325, 1071644672 /* Float: 1.75f */, 1074790400 /* Float: 2.25f */)) && !func_406())
	{
		if (func_407(0) != 1)
		{
			func_408(0, 1, 1);
...
void func_289(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_411(func_410(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_412(func_410(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
bool func_359(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_295(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_392(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*iParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_283(iParam4, 268435456))
			{
				iVar8 = func_455(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
bool func_398(int iParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((PED::IS_PED_CARRYING_SOMETHING(Global_35) || func_460(Global_35)) || func_461(Global_35)) || func_462(Global_35));
	fVar12 = -1f;
...
void func_483(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_293(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_469(iParam1))
		{
			...
			iParam1->f_6 = func_499(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_293(iParam1->f_6))
			{
				if (!bParam6)
				{
