...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.0616f, -0.3636f, 0.5329f, -19.8f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, 0.4272f, 1.0817f, 0.5567f, -23.76f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_0", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_1", 0, 1, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0.000679016f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, GET_HASH_KEY("WEAPON_REPEATER_CARBINE"), "RIFLE");
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
