...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -5.8f, 6.8f, 0f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 0f, 1f, 0f, 0f, 1.5f, 1.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	vLocal_53 = { func_153(uParam0, -0.039f, 1.165f, 0.0346f) };
	func_154(uParam0, GET_HASH_KEY("P_BARREL05X"), 0f, 0f, 0f, "BARREL", 0, 0, 1);
	iLocal_21 = func_154(uParam0, GET_HASH_KEY("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	iLocal_22 = func_154(uParam0, GET_HASH_KEY("P_CS_LEDGER01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	iLocal_20 = func_154(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), -0.039f, 1.165f, 0.0346f, 0, 1, 0, 1);
	func_155(uParam0, iLocal_15, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_HOSEA_DUALWIELD"), "GUN");
	...
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
