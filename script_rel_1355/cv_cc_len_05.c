...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.71f, -1.86f, 1f, 89.64f, 2.75f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -1.4879f, -0.1481f, 0.7299f, 89.64f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, 117f, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_LENCNV5"), GET_HASH_KEY("PLAYER_LENCNV5"));
	return true;
}
