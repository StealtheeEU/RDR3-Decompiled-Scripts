...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_10 = GET_HASH_KEY("WORLD_ANIMAL_DEER_GRAZING");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 10767, 10933, 12080);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BADP_BUCK_1", GET_HASH_KEY("A_C_BUCK_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (-180f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "BADP_DOE_1", GET_HASH_KEY("A_C_DEER_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -4f, 0f), (75f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], iLocal_10, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1f, false);
		...
		case 2:
			...
			{
				IK::_0x66F9EB44342BB4C5(uParam0->f_20[1 /*14*/], &Local_45);
		...
		case 5:
			...
			{
				IK::_0x66F9EB44342BB4C5(uParam0->f_20[1 /*14*/], &Local_45);
				IK::_0x66F9EB44342BB4C5(uParam0->f_20[0 /*14*/], &Local_70);
		...
		case 6:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], -2f, -4f, 0f, 1.5f, -1, 1036831949 /* Float: 0.1f */, 1, 1, 0, 0, 1, 0);
					func_69(&uLocal_14);
					iLocal_9 = 7;
				}
			}
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_11[iVar0]))
		{
			TASK::_DELETE_SCENARIO_POINT(uLocal_11[iVar0]);
		}
		iVar0++;
	}
	return 1;
...
void func_64(var uParam0)
{
	...
	while (iVar0 <= 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[iVar0 /*14*/], Global_36, 0);
...
bool func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_63(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
