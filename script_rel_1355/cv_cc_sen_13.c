...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.115f, 2.36f, 1.1875f, -44f, 1.0975f, 1.145f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, -0.0675f, 2.0425f, 1.1875f, 16f, 3.4425f, 1.2525f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SENCNV13"), GET_HASH_KEY("PLAYER_SENCNV13"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
