...
bool func_78(var uParam0)
{
	...
	iLocal_15 = func_158(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_16 = func_158(uParam0, GET_HASH_KEY("S_CHAIR04X"), 3.388f, -3.688f, 0f, "CHAIR", 1, 0, 1);
	func_159(uParam0, 1.575f, -2.975f, 1.15f, 43.56f, 5.738f, 4f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_160(uParam0, 2.7376f, -2.875f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, GET_HASH_KEY("VOLBOX"), 1);
	...
	func_163(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0);
	func_164(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_53 = func_167(uParam0, 2.7376f, -2.875f, 0f, 0f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, "GRIEF", GET_HASH_KEY("VOLBOX"));
	return true;
}
...
bool func_99(var uParam0)
{
	...
	if (func_208(uParam0, iLocal_18))
	{
		if (func_209(uParam0, Local_23, 1, 1))
		{
			...
			func_210(uParam0, GET_HASH_KEY("COMP_DTCCNV23"), GET_HASH_KEY("PLAYER_DTCCNV23"));
