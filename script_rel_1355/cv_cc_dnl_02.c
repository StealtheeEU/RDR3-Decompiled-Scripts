...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.9875f, 0.2625f, 0.832f, 87.12f, 2f, 4.45f, 2.135f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -3.775f, -1.1375f, 0.8945f, 80f, 1f, 1f, 2.2325f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	func_152(uParam0, -1.04f, 0.88f, 0.9787f, 0f, 0.8f, 0.8f, 2.2325f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0.167566f, 1.04268f, -0.0225601f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, GET_HASH_KEY("COMP_DNLCNV2"), GET_HASH_KEY("PLAYER_DNLCNV2"));
	return true;
}
