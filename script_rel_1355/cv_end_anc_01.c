...
bool func_74(var uParam0)
{
	...
	func_153(uParam0, 0.1f, -0.35f, 0.5f, 0f, 3.36f, 3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_154(uParam0, 0.65f, -0.5f, 0.5f, 0f, 0.4f, 0.4f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_20 = func_155(uParam0, GET_HASH_KEY("P_BROOM02X"), 0f, 0f, 0f, "BROOM", 0, 0, 1);
	func_155(uParam0, GET_HASH_KEY("P_CHAIR05X"), 0.878931f, 0.51915f, 0.000312805f, "CHAIR", 1, 0, 1);
	func_156(uParam0, iLocal_14, GET_HASH_KEY("WEAPON_REPEATER_WINCHESTER"), "REPEATER");
	...
	func_159(uParam0, GET_HASH_KEY("COMP_BCANCCNV1"), GET_HASH_KEY("PLAYER_BCANCCNV1"));
	func_160(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_162(uParam0, iLocal_14, 4, 0);
	func_163(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_BROOM"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1);
	func_161(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_BROOM"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_345(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_379(iParam1))
		{
			func_380(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_399(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
