...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_FOX_01");
	iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_FOX_SITTING");
	iLocal_12 = GET_HASH_KEY("META_OUTFIT_DEFAULT");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 130:
			iLocal_9 = GET_HASH_KEY("A_C_CALIFORNIACONDOR_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_VULTURE_ON_PERCH");
			break;
		case 172:
			iLocal_9 = GET_HASH_KEY("A_C_FOX_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_FOX_SITTING");
			break;
		case 187:
			iLocal_9 = GET_HASH_KEY("A_C_OWL_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_EAGLE_ON_PERCH");
			break;
		case 168:
			iLocal_9 = GET_HASH_KEY("A_C_EAGLE_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_EAGLE_ON_PERCH");
			break;
		case 176:
			iLocal_9 = GET_HASH_KEY("A_C_HAWK_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_EAGLE_ON_PERCH");
			break;
		case 200:
			iLocal_9 = GET_HASH_KEY("A_C_RAVEN_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_CROW_ON_PERCH");
			break;
		case 124:
			iLocal_9 = GET_HASH_KEY("A_C_BLUEJAY_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_BIRD_ON_PERCH");
			break;
		case 132:
			iLocal_9 = GET_HASH_KEY("A_C_CARDINAL_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_BIRD_ON_PERCH");
			break;
		case 144:
			...
			break;
		case 189:
			iLocal_9 = GET_HASH_KEY("A_C_PELICAN_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_PELICAN_ON_PERCH");
			break;
		case 201:
			iLocal_9 = GET_HASH_KEY("A_C_REDFOOTEDBOOBY_01");
			iLocal_11 = GET_HASH_KEY("STAND");
			break;
		case 232:
			iLocal_9 = GET_HASH_KEY("A_C_VULTURE_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_VULTURE_ON_PERCH");
			if ((((iVar1 == 0 || iVar1 == 2) || iVar1 == 10) || iVar1 == 11) || iVar1 == 9)
			{
				iVar0 = 0;
				iLocal_12 = GET_HASH_KEY("META_OUTFIT_ANIMAL_VULTUREEAST");
			}
			break;
		case 131:
			...
			else if (func_48(1))
			{
				...
				{
					iLocal_9 = GET_HASH_KEY("A_C_SPARROW_01");
				}
				else if (iVar2 == 3)
				{
				...
				{
					iLocal_9 = GET_HASH_KEY("A_C_ORIOLE_01");
				}
				iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_BIRD_ON_PERCH");
			}
			else
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_17, 1))
		{
			...
			func_67(uParam0);
			TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
		...
		case 1:
			if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || func_72(&uLocal_13, 20f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					if (*uParam0 != 172)
					{
						TASK::TASK_FLEE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
					}
					else
					{
			...
			else if (*uParam0 == 172)
			{
				...
				{
					IK::_0x66F9EB44342BB4C5(uParam0->f_20[0 /*14*/], &Local_45);
				}
			}
			break;
		case 2:
...
void func_93(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_126(iParam1))
		{
			func_127(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_184(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_201(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_199(int iParam0, int iParam1)
{
	...
	if (func_226(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
