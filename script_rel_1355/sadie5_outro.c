...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_16 = GET_HASH_KEY("MES_SADIE5_MALES_01");
...
int func_21(var uParam0)
{
	...
	if (func_45(Global_1835011[72 /*74*/].f_1) == 0)
	{
		...
		PED::_SET_PED_PROMPT_NAME_FROM_GXT_ENTRY(iLocal_15, GET_HASH_KEY("SAD5_FINLEY"));
	}
	return 1;
}
...
bool func_23(var uParam0)
{
	...
	if (!func_51(uLocal_18, 1))
	{
		if (func_52(Global_35, iLocal_14, 0, 0) > 150f || !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_14, 0))
		{
			...
			func_15(11, 1, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
			func_53(&uLocal_18, 1);
		}
	}
	return false;
...
bool func_47(int iParam0)
{
	...
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PERSCHAR::_0x31C70A716CAE1FEE(func_90(iParam0))))
		{
			return true;
		}
	}
	iVar0 = PERSCHAR::_0x31C70A716CAE1FEE(func_90(iParam0));
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
	...
	PERSCHAR::_0x7B204F88F6C3D287(func_90(iParam0));
	return true;
}
	...
	switch (iLocal_120)
	{
		case 0:
			...
			if (func_99(PLAYER::PLAYER_ID(), iLocal_15))
			{
				...
				{
					iLocal_117[0] = func_101("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					func_102(iLocal_117[0], iLocal_15, 0, 0, 1);
				}
				if (!func_100(iLocal_117[1]))
				{
					iLocal_117[1] = func_101("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
void func_82(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_140(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_140(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_86(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_141(iParam1))
		{
			func_142(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_162(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_160(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_138(int iParam0)
{
	...
	func_177(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_140(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_180(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
		...
		while (iVar28 < 4)
		{
			...
			if (func_194(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_198(0))
				{
					...
					func_199(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
void func_200(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_216(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_196(GET_HASH_KEY("CHARACTER"), func_218(), -1591664384, bParam0);
}
