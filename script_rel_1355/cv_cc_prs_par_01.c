...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 1f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BEER", 0, 1, 1);
	if (!func_153(15))
	{
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING_DRUNK"), "WORLD_HUMAN_DRINKING_DRUNK_MALE_B", -1, 1);
