...
bool func_79(var uParam0)
{
	...
	func_159(uParam0);
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SLEEP_BED_PILLOW"), "PROP_HUMAN_SLEEP_BED_PILLOW_FEMALE_A", -1, 0);
...
{
	if ((!bLocal_20 && !CAM::IS_SPHERE_VISIBLE(vLocal_24, 1f)) && func_9(Global_35, vLocal_24, 1) > 4f)
	{
		bLocal_20 = true;
		func_10(1);
	}
...
{
	if (!bLocal_16 && !func_195(func_55(uParam0, iLocal_15), 0))
	{
...
bool func_102(var uParam0)
{
	...
	{
		PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0, false);
		PERSCHAR::_0xD4B614179BCD0654(func_129(13, 0));
...
int func_198(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if ((bParam3 && func_312(iParam1, 4096)) && Global_1946804.f_1497 == iParam4)
	{
		return 1;
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_337(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_334(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_257()
{
	...
	if (func_337(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_258()
{
	...
	if (func_337(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_263(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_356(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_309(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
bool func_313(int iParam0, int iParam1)
{
	...
	func_381(&(Global_1946804.f_964), iVar0, iParam0, -897569541, 1, iParam1);
...
void func_316()
{
	...
	TASK::TASK_PLAY_ANIM(Global_35, func_382(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_370(1);
...
bool func_338(int iParam0, int iParam1)
{
	...
	bVar0 = func_404(iParam0, iParam1);
	return bVar0;
}
...
int func_356(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_366(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_428(iParam1))
		{
			func_196(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_376(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;

	if (!func_433(uParam0, iParam3, iParam2) && !func_434(uParam0, iParam2, bParam1, 0, bParam4, 0, 0))
	{
		return false;
	}
	iVar0 = 10;
...
void func_385(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if (func_233() == -1)
	{
		...
		if ((bParam4 && iVar0 > 5) && func_439(Global_1946804.f_1497))
		{
...
void func_388(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_433(var uParam0, int iParam1, int iParam2)
{
	if (iParam1 == -1)
	{
		return false;
...
bool func_434(var uParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_456(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_502(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_468(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_507(iParam0) && func_508(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489.f_12)
			{
				...
				if (!func_510(iParam0, vVar0, iParam6, iParam10))
				{
					return func_509();
				}
				if (func_128(Global_1360165[iParam0 /*1157*/].f_124, 0))
...
bool func_476(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_522(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_110(iParam0, 44, 1);
			}
...
void func_481(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_535(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_535(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_539(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_536(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && func_540(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711))
				{
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_539(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_540(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
			...
			switch (func_536(iParam1))
			{
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_536(uParam0->f_1[iVar1 /*3*/]) || func_540(uParam0->f_1[iVar1 /*3*/], 866047851))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
{
	func_541(&(Global_1946804.f_2589), iParam0, iParam1);
}
...
bool func_508(int iParam0, char* sParam1)
{
...
bool func_510(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_511(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_547(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_512(int iParam0, int iParam1)
{
	...
	func_431(iParam0, func_548(iParam1));
	...
	func_470(iParam1, func_546(iParam1, 8192), func_546(iParam1, 16384), 1);
}
...
void func_514(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_531(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_555(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_555(1237718549, iParam1);
			return func_556(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_533(int iParam0)
{
	...
	func_557(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_535(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_559(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
float func_549(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
struct<5> func_567(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_579(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_571(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			if (func_583(iParam0, -1823706425))
			{
				Var0 = { func_571(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, GET_HASH_KEY("KIT_CAMP"));
			}
			else if (func_583(iParam0, -1483207246))
			{
				Var0 = { func_571(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, GET_HASH_KEY("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, -833319691))
			{
				...
				if (!func_584(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
{
	return func_585(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
bool func_570(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_586(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_571(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_587(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_572(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	Var0.f_9 = -1591664384;
	if (!func_584(*uParam1, &Var0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_587(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_575(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_590(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_571(GET_HASH_KEY("CHARACTER"), func_591(), -1591664384, bParam0);
}
...
struct<4> func_580(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_571(923904168, func_578(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_571(923904168, func_578(bParam0), -740156546, 0) };
		}
		return Global_1224223;
	}
	return func_571(923904168, func_578(bParam0), -740156546, 0);
}
...
struct<4> func_582(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_571(271701509, func_578(bParam0), 12999093, 0) };
		}
		return Global_1224219;
	}
	return func_571(271701509, func_578(bParam0), 12999093, 0);
}
...
bool func_584(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam0))
	{
		return false;
	}
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_587(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_585(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_587(bParam6), &Var0, 0);
	return uVar4;
}

bool func_586(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_587(0);
	*uParam1 = { func_571(iParam0, func_580(0), iParam3, 0) };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
