...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_130(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_130(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_130(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_130(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_68(int iParam0, bool bParam1)
{
	...
	func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_136(func_135(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_84()
{
	...
	Local_117[0 /*45*/].f_43 = 25396;
	Local_117[0 /*45*/].f_44 = 25572;
...
int func_90(int iParam0, bool bParam1)
{
	...
	if (func_149(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_112(iParam0));
...
int func_150(int iParam0, bool bParam1)
{
	...
	func_211(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_112(iParam0));
	func_156(iParam0, 0);
	return 1;
}
...
bool func_236(int iParam0)
{
	...
	return func_177(iParam0, 1073741824 /* Float: 2f */);
}
