...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.45f, -0.15f, 1.007f, 85.5f, 2.5575f, 1.875f, 2.365f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -3.575f, -0.7f, 1.0195f, 87.75f, 2f, 2f, 2.335f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -3.87134f, -1.09542f, 1.00508f, 0f, 1f, 1f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR24X"), -4.62596f, -1.37365f, -0.000255585f, "p_chair24x", 1, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARETTE01X"), 0f, 0f, 0f, "p_cigarette01x", 0, 1, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "p_cs_book03x", 0, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", -1, 0);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_29 = func_161(uParam0, 3.3625f, 1.3387f, 2.4264f, 0f, 0f, 174.515f, 16.4725f, 16.24f, 5f, "Start_Trigger", GET_HASH_KEY("VOLBOX"));
	func_162(uParam0, 1);
	return true;
}
