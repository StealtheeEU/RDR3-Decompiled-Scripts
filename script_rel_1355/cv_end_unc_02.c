...
bool func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, GET_HASH_KEY("A_C_COW"), "COW");
	func_152(uParam0, 0f, 1.65f, 0f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_160(uParam0, iLocal_15, 2, GET_HASH_KEY("STAND"), 0, -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	return true;
}
