...
bool func_72(var uParam0)
{
	...
	iLocal_15 = func_154(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "p_cs_newspaper_03x", 0, 0, 1);
	func_155(uParam0, 0f, 0f, 0f, 2f, 1.7725f, 1.54f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_156(uParam0, "script@vignette@uncle_5@base", 1, 1, 0, 0);
	func_156(uParam0, "script@vignette@uncle_5@action", 0, 0, 1, 0);
	func_157(uParam0, GET_HASH_KEY("COMP_UNCCNV5"), GET_HASH_KEY("PLAYER_UNCCNV5"));
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READ_NEWSPAPER"), "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READ_NEWSPAPER"), "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1, 100f, 1065353216 /* Float: 1f */, 1);
