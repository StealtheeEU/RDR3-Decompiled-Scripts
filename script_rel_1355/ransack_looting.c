...
void func_6()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_19.f_5))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_19.f_5))
		{
			...
			OBJECT::CREATE_OBJECT_SKELETON(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(Local_19.f_5));
		}
	}
	switch (iLocal_202)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(Local_19.f_5) && OBJECT::CREATE_OBJECT_SKELETON(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(Local_19.f_5)))
			{
				...
				else
				{
					...
					while (iLocal_206 < 10)
					{
						...
						else
						{
							...
							Jump @776; //curOff = 734
							if (!TASK::DOES_SCENARIO_POINT_EXIST(Local_19.f_6) || !PED::IS_PED_USING_THIS_SCENARIO(Global_35, Local_19.f_6))
							{
								iLocal_0 = 0;
								return;
							}
...
void func_20(int iParam0)
{
	...
	while (iVar23 < iParam0->f_2)
	{
		...
		else
		{
			...
			{
				iParam0->f_12[iVar23] = GET_HASH_KEY("SCRIPTEDBALL");
			}
			else
			{
...
void func_24(int iParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			{
				if (*iParam1 == GET_HASH_KEY("P_DRESSINGLCMHAY01X"))
				{
...
void func_26(int iParam0)
{
	...
	{
		func_52(func_51(GET_HASH_KEY("CHESTS_LOOTED")), 1);
	}
	else
	{
		func_52(func_51(GET_HASH_KEY("CHESTS_SEARCHED")), 1);
	}
}
...
void func_30(int iParam0)
{
	switch (iParam0->f_7)
	{
		case GET_HASH_KEY("RANSACK_PROP_CHEST_MEDIUM_OPEN"):
			iParam0->f_8 = 0;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CHEST_LARGE_OPEN"):
			iParam0->f_8 = 1;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_HIGH_OPEN_B"):
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_HIGH_OPEN_A"):
			if (ENTITY::GET_ENTITY_MODEL(iParam0->f_5) == GET_HASH_KEY("P_MEDICINECHEST01X"))
			{
				iParam0->f_8 = 2;
			}
			else
			...
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_MID_OPEN"):
			iParam0->f_8 = 5;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_LOW_OPEN_B"):
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_LOW_OPEN_A"):
			iParam0->f_8 = 6;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_WIDE_HIGH_OPEN"):
			iParam0->f_8 = 4;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_WIDE_MID_OPEN"):
			iParam0->f_8 = 9;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_WIDE_LOW_OPEN"):
			iParam0->f_8 = 10;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_LOW_LEFT_OPEN"):
			iParam0->f_8 = 7;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_NARROW_LOW_RIGHT_OPEN"):
			iParam0->f_8 = 8;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_SINGLE_1_OPEN"):
			iParam0->f_8 = 16;
			iParam0->f_154 = func_54(iParam0, 0);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_SINGLE_2_OPEN"):
			iParam0->f_8 = 16;
			iParam0->f_154 = func_54(iParam0, 1);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_SINGLE_3_OPEN"):
			iParam0->f_8 = 16;
			iParam0->f_154 = func_54(iParam0, 2);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_SINGLE_4_OPEN"):
			iParam0->f_8 = 16;
			iParam0->f_154 = func_54(iParam0, 3);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_ATTACHED_DS_12"):
		case GET_HASH_KEY("RANSACK_ATTACHED_DS_234"):
		case GET_HASH_KEY("RANSACK_ATTACHED_DS_23"):
		case GET_HASH_KEY("RANSACK_ATTACHED_DS_123"):
			iParam0->f_8 = 16;
			iParam0->f_154 = func_54(iParam0, 0);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_DOUBLE_1_OPEN"):
			iParam0->f_8 = 17;
			iParam0->f_154 = func_54(iParam0, 4);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_DOUBLE_2_OPEN"):
			iParam0->f_8 = 17;
			iParam0->f_154 = func_54(iParam0, 5);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_DOUBLE_3_OPEN"):
			iParam0->f_8 = 17;
			iParam0->f_154 = func_54(iParam0, 6);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_DRAWER_DOUBLE_4_OPEN"):
			iParam0->f_8 = 17;
			iParam0->f_154 = func_54(iParam0, 7);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_ATTACHED_DD_123"):
		case GET_HASH_KEY("RANSACK_ATTACHED_DD_234"):
		case GET_HASH_KEY("RANSACK_ATTACHED_DD_1234"):
		case GET_HASH_KEY("RANSACK_ATTACHED_DD_34"):
			iParam0->f_8 = 17;
			iParam0->f_154 = func_54(iParam0, 4);
			iParam0->f_4 = 1;
			break;
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_TIGHT_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENUNLOCKED_1M05"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_TIGHT_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENUNLOCKED_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_TIGHT_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_TIGHT_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENUNLOCKED_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_1M05"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENUNLOCKED_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENUNLOCKED_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_LRG_OPENLOCKED_0M0"):
			iParam0->f_8 = 13;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_TIGHT_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENUNLOCKED_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_TIGHT_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENUNLOCKED_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENUNLOCKED_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENUNLOCKED_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_TIGHT_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_TIGHT_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENLOCKED_1M05"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_MED_OPENUNLOCKED_1M05"):
			iParam0->f_8 = 14;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENUNLOCKED_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_1M05"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENUNLOCKED_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENUNLOCKED_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_TIGHT_0M60"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_TIGHT_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_0M80"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENUNLOCKED_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_TIGHT_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_0M45"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENUNLOCKED_1M05"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_TIGHT_0M0"):
		case GET_HASH_KEY("RANSACK_PROP_LOCKBOX_SML_OPENLOCKED_0M60"):
			iParam0->f_8 = 15;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_WIDE_LOW_LEFT_OPEN"):
			iParam0->f_8 = 11;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		case GET_HASH_KEY("RANSACK_PROP_CUPBOARD_WIDE_LOW_RIGHT_OPEN"):
			iParam0->f_8 = 12;
			iParam0->f_154 = func_54(iParam0, -1);
			break;
		default:
...
int func_38()
{
	return GET_HASH_KEY("P_DRESSINGLCMHAY01X");
}
...
int func_39()
{
	...
	{
		case 0:
			iVar1 = GET_HASH_KEY("S_LOOTABLEBEDCHEST_A");
			break;
		case 1:
			iVar1 = GET_HASH_KEY("S_LOOTABLEBEDCHEST_B");
			break;
		case 2:
			iVar1 = GET_HASH_KEY("S_LOOTABLEBEDCHEST_C");
			break;
		case 3:
			iVar1 = GET_HASH_KEY("S_LOOTABLEBEDCHEST_D");
			break;
	}
	return 0;
}
...
int func_40()
{
	...
	if (func_35(0))
	{
		iVar0 = GET_HASH_KEY("P_ADL_DRWSNG01X");
	}
	return iVar0;
}
...
int func_41(int iParam0)
{
	...
	iVar0 = 0;
	if (func_35(3) && ENTITY::GET_ENTITY_MODEL(iParam0->f_5) == GET_HASH_KEY("P_DESK09BX"))
	{
		iVar0 = GET_HASH_KEY("P_WNT4_DRWDRESSING01X");
	}
	return iVar0;
}
