...
bool func_3(var uParam0)
{
	...
	{
		ENTITY::REMOVE_MODEL_HIDE(1877.69f, -1861.21f, 42.3149f, 0.5f, GET_HASH_KEY("P_PACKAGE06X"), 1);
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	func_151(uParam0, -0.139043f, 4.19721f, 0.936508f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, -3.04281f, 2.53789f, 0.945671f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_152(uParam0, -1.22049f, 3.99844f, 0.991776f, 0f, 1.1f, 1.1f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	bVar0 = func_22(uParam0) != 2;
	func_153(uParam0, GET_HASH_KEY("P_CRATE15X"), -2.528f, 1.918f, 0.142f, "CRATE", bVar0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_LEDGER01X"), 0f, 0f, 0f, "LEDGER", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	if (func_22(uParam0) == 2)
	{
		iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_CRATEBRAND03X"), -0.407827f, 3.55382f, -0.0014267f, 0, 1, 0, 1);
		iLocal_23 = func_153(uParam0, GET_HASH_KEY("P_CRATE03X"), -0.4062f, 3.5481f, 0.519173f, 0, 0, 0, 1);
	}
	if (func_22(uParam0) == 3)
	{
		iLocal_23 = func_153(uParam0, GET_HASH_KEY("P_CRATE03X"), -0.4062f, 3.5481f, 0.519173f, 0, 0, 0, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_LENCNV1"), GET_HASH_KEY("PLAYER_LENCNV1"));
...
bool func_87(var uParam0)
{
	...
	if (func_22(uParam0) == 3)
	{
		ENTITY::CREATE_MODEL_HIDE(1877.69f, -1861.21f, 42.3149f, 0.5f, GET_HASH_KEY("P_PACKAGE06X"), false);
	}
	return true;
}
