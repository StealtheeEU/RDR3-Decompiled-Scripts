...
bool func_72(var uParam0)
{
	...
	func_154(uParam0, GET_HASH_KEY("COMP_BCANJCNV4"), GET_HASH_KEY("PLAYER_BCANJCNV4"));
	...
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_MALE_C", -1, 1, 1f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 1, -1);
	func_155(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_ANIMAL_DOG_SLEEPING"), "WORLD_ANIMAL_DOG_SLEEPING", -1, 1);
	func_157(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_ANIMAL_DOG_SLEEPING"), "WORLD_ANIMAL_DOG_SLEEPING", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
