...
void __EntryFunction__()
{
	...
	fLocal_155 = 3f;
	fLocal_156 = 1E+08f;
	iLocal_158 = GET_HASH_KEY("CS_DOROETHEAWICKLOW");
	iLocal_159 = GET_HASH_KEY("P_SANDWICHBOARDWOMEN01X");
	iLocal_160 = GET_HASH_KEY("A_F_M_NBXUPPERCLASS_01");
	iLocal_161 = GET_HASH_KEY("A_M_M_NBXUPPERCLASS_01");
	iLocal_162 = GET_HASH_KEY("A_F_O_SDUPPERCLASS_01");
	iLocal_179 = (2 - 1);
	iLocal_244 = -1;
	bLocal_249 = true;
	...
	while (true)
	{
			...
			else
			{
				...
				if (iLocal_14 > 3 && iLocal_14 < 47)
				{
					if (func_8(fLocal_155, &iVar1, &iVar2, 1104674816 /* Float: 27f */, 1102053376 /* Float: 22f */))
					{
						...
						TASK::TASK_FLEE_PED(iLocal_163, Global_35, 3, 1, 6000f, -1, 0);
		...
		if (!func_19(iLocal_183, 128) && iLocal_14 > 3)
		{
			...
			else
			{
				...
				if (iLocal_14 > 3 && !func_19(iLocal_183, 128))
				{
					func_25(8, 1, &iLocal_163, &uLocal_149, &uLocal_329, fLocal_156, 1097859072 /* Float: 15f */, 0);
					func_26();
				...
				switch (iLocal_14)
				{
					...
					case 1:
						...
						if (((((((HUD::TEXT_BLOCK_IS_LOADED("SPDEF") && HUD::TEXT_BLOCK_IS_LOADED("SPDWAU")) && STREAMING::HAS_MODEL_LOADED(iLocal_158)) && STREAMING::HAS_MODEL_LOADED(iLocal_159)) && STREAMING::HAS_MODEL_LOADED(iLocal_160)) && STREAMING::HAS_MODEL_LOADED(iLocal_162)) && STREAMING::HAS_MODEL_LOADED(iLocal_161)) && PED::_0x5C16855277819BBF() == 4)
						{
							func_65(2);
						}
						break;
					...
					case 3:
						...
						if (((func_68(&iLocal_168, iLocal_159, 2547.9f, -1215.18f, 52.3135f) && func_71(&(uLocal_164[0]), iLocal_160, &iVar0, func_69(0), func_70(0), 2, 0, 1)) && func_71(&(uLocal_164[1]), iLocal_161, &iVar0, func_69(1), func_70(1), 1, 0, 1)) && func_71(&(uLocal_164[2]), iLocal_162, &iVar0, func_69(2), func_70(2), 2, 0, 1))
						{
							if (((func_5(iLocal_163, 0) && func_5(uLocal_164[0], 0)) && func_5(uLocal_164[1], 0)) && func_5(uLocal_164[2], 0))
							{
								...
								PED::_0x24C82EF607105FAA(iLocal_163, GET_HASH_KEY("TIMID"));
								...
								func_76(0);
								func_77(0, 0, "SPD_UC_GRT", "", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0);
								func_77(0, 1, "SPD_UC_ANT", "", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0);
								func_78(0, 0);
								func_10(&iLocal_183, 2097152);
								PED::_0x7C00CFC48A782DC0(iLocal_173, iLocal_163, 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
								func_79(&iLocal_163, &uLocal_184, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
								if (func_64())
								{
					...
					case 40:
						...
						if (((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_182) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_182, true, false)) && ANIMSCENE::_0x1F0E401031E20146(iLocal_182, func_122())) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_182) >= func_124(40))
						{
							func_85(0);
							func_123();
							func_10(&iLocal_183, 2097152);
					...
					case 41:
						...
						if (((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_182) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_182, true, false)) && ANIMSCENE::_0x1F0E401031E20146(iLocal_182, func_125())) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_182) >= func_124(41))
						{
							func_85(0);
							func_123();
							func_10(&iLocal_183, 2097152);
...
void func_1()
{
	...
	func_128(&uLocal_220);
	func_129(&iLocal_163, &uLocal_184, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
	func_130();
	func_131(8);
	...
	{
		VOLUME::_DELETE_VOLUME(Global_1396257[8 /*638*/][1 /*48*/].f_47);
	}
	func_140(iLocal_176);
...
bool func_8(float fParam0, int iParam1, int iParam2, float fParam3, float fParam4)
{
	...
	if (bVar0)
	{
		if ((((((((((PED::IS_PED_INJURED(iLocal_163) || PED::IS_PED_RAGDOLL(iLocal_163)) || TASK::IS_PED_GETTING_UP(iLocal_163)) || PED::IS_PED_LASSOED(iLocal_163)) || PED::IS_PED_BEING_STEALTH_KILLED(iLocal_163)) || PED::IS_PED_BEING_DRAGGED(iLocal_163)) || PED::IS_PED_BEING_STUNNED(iLocal_163, 0)) || PED::IS_PED_FALLING_OVER(iLocal_163)) || PED::IS_PED_HOGTIED(iLocal_163)) || TASK::IS_PED_IN_HIT_REACT(iLocal_163)) || PED::IS_PED_PRONE(iLocal_163))
		{
			*iParam2 = 0;
		}
		else
...
void func_27(int iParam0, int iParam1, var uParam2, int iParam3)
{
	...
	*uParam2 = { 0f, 0f, 0f };
	...
	uParam2->f_13 = 3;
	uParam2->f_7 = iParam3;
	IK::_0x66F9EB44342BB4C5(*iParam1, uParam2);
}
...
void func_31()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_170))
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_170, 2543.417f, -1213.348f, 52.70186f, 0f, 0f, 0f, 6.149397f, 6.646178f, 5.845132f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_170, 2545.63f, -1218.448f, 52.70186f, 0f, 0f, 0f, 1.699921f, 3.769435f, 5.845132f);
	}
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_171))
	{
	...
	{
		iLocal_176 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), 2542.052f, -1215.467f, 58.01852f, 0f, 0f, 0f, 1.85f, 1.85f, 10f);
...
void func_45(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_197(uParam0, 1073741824 /* Float: 2f */);
	}
	if (!bParam3)
	{
...
void func_77(int iParam0, int iParam1, char[4] cParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	func_209(&(Local_257[iParam0 /*59*/].f_21[iParam1 /*17*/]), cParam2, sParam3, iParam4, iParam5, iParam6, 0, 1, 0);
	if (bParam7)
	{
...
void func_153()
{
	...
	while (iVar3 < iVar4)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iVar2))
		{
			if (((PED::IS_PED_HUMAN(iVar2) && !PED::IS_PED_A_PLAYER(iVar2)) && iVar2 != iLocal_163) && PED::IS_PED_USING_SCENARIO_HASH(iVar2, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING")))
			{
...
bool func_165(int iParam0, int iParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_177()
{
	if (((((func_19(iLocal_183, 262144) && func_19(iLocal_183, 524288)) && iLocal_14 >= 31) && iLocal_14 <= 36) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_254)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_254) >= 0.1f)
	{
		func_80(&iLocal_183, 524288);
		bLocal_243 = true;
		return true;
...
int func_180(int iParam0)
{
	...
	iVar1 = 0;
	iVar0 = func_291(&iLocal_163, &(Local_257[iParam0 /*59*/]), 12f, &(Local_257[iParam0 /*59*/].f_21), 0f, 2, Local_257[iParam0 /*59*/].f_57, iVar1, Local_257[iParam0 /*59*/].f_56, 0, 0, 2, -1082130432 /* Float: -1f */);
	if (func_292())
	{
...
int func_279(int iParam0, var uParam1)
{
	...
	{
		return func_392(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_400(iParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
...
bool func_292()
{
	if (((((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630.f_12) && VOLUME::DOES_VOLUME_EXIST(iLocal_170)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_170, true, 0)) && func_409(Global_35, iLocal_163, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_246 >= 11 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_254)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_254) >= 0.8f) && iLocal_14 != 46) || (iLocal_14 >= 31 && iLocal_14 <= 36))) && !func_19(iLocal_183, 2)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, true)) && !PED::IS_PED_ON_MOUNT(Global_35)) && !func_165(&iLocal_163, &iLocal_325, 1071644672 /* Float: 1.75f */, 1074790400 /* Float: 2.25f */)) && !func_410(&iLocal_163, &iLocal_326, 1071644672 /* Float: 1.75f */, 1074790400 /* Float: 2.25f */)) && !func_411())
	{
		if (func_412(0) != 1)
		{
			func_413(0, 1, 1);
...
void func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_416(func_415(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_417(func_415(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
bool func_364(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_300(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_450(iVar0, 0)))
		{
...
bool func_380(int iParam0, int iParam1)
{
	...
	if (func_455(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
bool func_397(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*iParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_286(iParam4, 268435456))
			{
				iVar8 = func_460(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
void func_488(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_298(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_474(iParam1))
		{
			...
			iParam1->f_6 = func_504(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_298(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_504(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_480(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_508(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
