...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.25f, -5.8f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -8.975f, -7.575f, 0.85f, -65.75f, 4.5975f, 4.1125f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "p_stickFirePoker01x", 0, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	func_158(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_POKE_GROUND_STICK"), "WORLD_CAMP_JACK_POKE_GROUND_STICK_MALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_TREE"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
