...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_COYOTE_01");
	iLocal_10 = GET_HASH_KEY("A_C_DOGBLUETICKCOONHOUND_01");
	iLocal_11 = GET_HASH_KEY("A_C_VULTURE_01");
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "COYOTE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "DOG", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 2, "VULTURE1", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 3, "VULTURE2", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 4, "VULTURE3", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 5, "VULTURE4", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 6, "VULTURE5", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1] && !bLocal_48)
	{
		if (!uParam0->f_469[3])
		{
			if (func_73(uParam0, 1.5f, 40f, 4, GET_HASH_KEY("ACTION"), 1))
			{
				func_68(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
		...
		if (!bLocal_47)
		{
			...
			iLocal_41 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(vVar1, 5f, 1, -1, 0);
			iLocal_42 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(vVar1, 5f, 2, -1, 0);
			bLocal_47 = true;
		}
	}
	return 0;
...
void func_69(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (((uParam0->f_468 == 256 || uParam0->f_468 == 4) || uParam0->f_468 == 2) || uParam0->f_468 == 16)
		{
			...
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[1 /*14*/], Global_35, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
...
void func_96(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_129(iParam1))
		{
			func_130(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_183(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_200(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_198(int iParam0, int iParam1)
{
	...
	if (func_225(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
