...
void func_65(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_128(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_130(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_93(var uParam0)
{
	...
	func_166(uParam0, -2.2375f, -0.5425f, 0f, 18.75f, 1.15f, 1.275f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_CHARLES"), 1, 1, 1);
	iLocal_20 = func_167(uParam0, GET_HASH_KEY("P_CS_ARROW01X"), 0f, 0f, 0f, "P_CS_ARROW01X", 0, 1, 1);
	func_167(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "P_BOTTLEJD01X", 0, 0, 1);
	func_167(uParam0, GET_HASH_KEY("P_CS_MOONSHINERAG01X"), 0f, 0f, 0f, "P_CS_MOONSHINERAG01X", 0, 0, 1);
	iLocal_19 = func_167(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), -1.863f, -0.829f, 0.479f, 0, 1, 0, 1);
	...
	func_172(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", iLocal_19, 0);
	func_173(uParam0, iLocal_14, -1.973365f, -0.825071f, 0.487279f, 103.88f, 1, 1);
	func_174(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_108(var uParam0)
{
	...
	if (!bLocal_42)
	{
		if (PROPSET::DOES_PROP_SET_EXIST(uParam0->f_1976.f_6))
		{
			iVar0 = func_209(uParam0->f_1976.f_6, GET_HASH_KEY("S_INV_MOONSHINE01X"), 0);
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
	...
	if (!bLocal_43)
	{
		iVar1 = func_209(uParam0->f_1976.f_6, GET_HASH_KEY("P_STOOLFOLDING01X"), 0);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
...
int func_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_58(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_236(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
bool func_222(var uParam0)
{
	...
	if (!bLocal_54)
	{
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_10(uParam0, iLocal_14), "", 6f, 0f, 0, 0f, 0f, 0, false, -1);
		bLocal_54 = true;
	}
	iLocal_45 = 0;
	...
	{
		iLocal_44 = func_321("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_10(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_224(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			func_330(iVar0, 1);
			func_331();
			func_333(func_332(GET_HASH_KEY("CAMP_REQUESTS_STARTED")), 1);
			return 1;
		}
		iVar0++;
	}
...
int func_265()
{
	...
	if (func_353(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_266()
{
	...
	if (func_353(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_321(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_242(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_382(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_383(GET_HASH_KEY("CONSUMABLE_MEDICINE"));
...
void func_325(int iParam0)
{
	...
	{
		case 9:
			if (func_384(GET_HASH_KEY("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_385();
				func_386(GET_HASH_KEY("REWARD_PED_SMALL"), 0.68f);
				func_386(GET_HASH_KEY("REWARD_PED_MEDIUM"), 0.68f);
				func_386(GET_HASH_KEY("REWARD_PED_LARGE"), 0.68f);
			}
			break;
	}
}
...
void func_326(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_390(func_25()), 1307979820 /* GXTEntry: "Camp Item Request" */, func_391(*uParam0), 0);
		...
		if (*uParam0 == 21)
		{
			func_392(1, GET_HASH_KEY("CONSUMABLE_WHISKEY"), 0);
			func_392(2, GET_HASH_KEY("CONSUMABLE_PEPPERMINT"), 0);
			func_392(3, GET_HASH_KEY("CONSUMABLE_HERB_MILKWEED"), 0);
			func_392(4, GET_HASH_KEY("CONSUMABLE_HAIR_GREASE"), 0);
			func_392(5, 0, GET_HASH_KEY("AT_SKUNK"));
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_329(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_398(&uVar4, GET_HASH_KEY("COLOR_PURE_WHITE"));
		sVar2 = func_399(uParam0->f_3, 0);
		func_393(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, MISC::VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_393(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, HUD::GET_STRING_FROM_HASH_KEY(iVar0), 0, bParam1, 0);
	}
}
...
void func_393(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_444("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_389(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_399(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_353(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
int func_441(int iParam0, bool bParam1)
{
	...
	if (!func_484(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_485(iVar14);
...
void func_471(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_518(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_518(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_492(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_523(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_353(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_452(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_518(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_537(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_520(GET_HASH_KEY("CHARACTER"), func_541(), -1591664384, bParam0);
}
