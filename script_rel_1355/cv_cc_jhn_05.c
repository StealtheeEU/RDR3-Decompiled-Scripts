...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.225f, -0.0125f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, 7.215f, 7.4175f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "p_cs_book02x", 0, 0, 1);
	if (!func_153(10))
	{
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, 45f, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1, 30f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 3, 0);
	func_159(uParam0, GET_HASH_KEY("COMP_JHNCNV5"), GET_HASH_KEY("PLAYER_JHNCNV5"));
	...
	if (func_153(10))
	{
		...
		func_164(uParam0, iLocal_15, 4, GET_HASH_KEY("STAND"), 0, -1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_401(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_486(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_498(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_490(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_490(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_490(GET_HASH_KEY("CHARACTER"), func_512(), -1591664384, bParam0);
}
