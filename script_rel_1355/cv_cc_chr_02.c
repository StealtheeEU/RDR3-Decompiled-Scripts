...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "cigarette", 0, 1, 1);
	func_152(uParam0, -1.7186f, -1.1304f, 0f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 1.8224f, 2.0627f, 0f, 0f, 3f, 3f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_CHRCNV2"), GET_HASH_KEY("PLAYER_CHRCNV2"));
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	func_157(uParam0, iLocal_14, 2, 3, 0, "Default_Angry", 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_156(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1);
	func_159(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
