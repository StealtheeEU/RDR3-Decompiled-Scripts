...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.25f, 0.75f, 0f, 0f, 3f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CS_CARROTSLICE01X"), 0f, 0f, 0f, "CARROT", 0, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	iLocal_15 = func_152(uParam0, GET_HASH_KEY("P_CS_VEGSACK_UP"), 0f, 0f, 0f, "SACK_1", 0, 0, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CS_VEGSACK_DOWN"), 0f, 0f, 0f, "SACK_2", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_CHOP_CARROT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	if (PED::_0x569F1E1237508DEB(func_48(uParam0, iLocal_14)) == GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW_VEGDROP_CARROT_MALE_B"))
	{
		if (!bLocal_21)
		{
			bLocal_21 = true;
