...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	iLocal_18 = func_151(uParam0, GET_HASH_KEY("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	func_152(uParam0, -7.594311f, 1.704786f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, -1.9018f, 0.9755f, 1.4875f, 42.75f, 2.92f, 1.1025f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_153(uParam0, -2.08831f, 1.13359f, 0.50013f, 0f, 0.8f, 0.8f, 3.2075f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_15, 1, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_15, iLocal_18, "p_cigar02x_PH_R_HAND", 0, 0);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, iLocal_17, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, GET_HASH_KEY("COMP_DNKCNV3"), GET_HASH_KEY("PLAYER_DNKCNV3"));
	return true;
}
