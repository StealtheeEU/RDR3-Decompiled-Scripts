...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, -3.0885f, 0.0336f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_CHARLES"), 1, 1, 1);
	iLocal_16 = func_156(uParam0, GET_HASH_KEY("P_HAMMERCLAW01X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	iLocal_17 = func_156(uParam0, GET_HASH_KEY("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL", 0, 0, 1);
	iLocal_18 = func_156(uParam0, GET_HASH_KEY("SCRIPTEDBALL"), -3.16997f, 0.0431389f, 1.01684f, 0, 0, 1, 1);
	iLocal_15 = func_157(uParam0, "script@vignette@itm@charles_item_3@action", 0, 0, 0, 1);
	func_158(uParam0, "CCHI3");
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_HAMMER_WALL"), "WORLD_HUMAN_HAMMER_WALL_MALE_A", -1, 1);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_HAMMER_WALL"), "WORLD_HUMAN_HAMMER_WALL_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_198(var uParam0)
{
	...
	{
		iLocal_30 = func_304("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_377(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_426("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_373(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
int func_423(int iParam0, bool bParam1)
{
	...
	if (!func_474(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_475(iVar14);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_346(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_434(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_514(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_535(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_516(GET_HASH_KEY("CHARACTER"), func_539(), -1591664384, bParam0);
}
...
struct<5> func_544(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_421(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_516(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_516(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
