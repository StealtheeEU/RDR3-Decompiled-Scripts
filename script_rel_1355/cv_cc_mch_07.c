...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0572f, -0.9616f, 0.7235f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -3.4055f, 3.3682f, 0.1298f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_COIN01X"), 0f, 0f, 0f, "COIN", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_STICK02X"), 0f, 0f, 0f, "STICK", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_14, "GREET_MICAH_MCHCNV7", 60000, 1);
	func_155(uParam0, iLocal_15, 1, GET_HASH_KEY("WORLD_CAMP_JACK_SKY"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, GET_HASH_KEY("COMP_MCHCNV7"), GET_HASH_KEY("PLAYER_MCHCNV7"));
...
void func_344(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_394(iParam1))
		{
			func_395(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_427(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_468(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_468(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_414(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_468(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_485(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_493(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_505(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_497(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("EMOTE"):
			...
			{
				Var0 = { func_497(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_497(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_515(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_497(GET_HASH_KEY("CHARACTER"), func_519(), -1591664384, bParam0);
}
...
bool func_511(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_515(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
