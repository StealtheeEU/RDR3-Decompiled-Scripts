...
bool func_11()
{
	...
	iLocal_333 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(3023.974f, 562.0062f, 46.82927f, 0f, 0f, 79.71242f, 12.599f, 9.960065f, 6.735788f, "Van Horn - m_volFence");
	iLocal_334 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(3027.401f, 562.4042f, 44.687f, 0f, 0f, 80f, 1.736885f, 1f, 2f, "Van Horn - m_volFencePrompt");
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_335, 2986.668f, 572.391f, 44.68746f, 0f, 0f, 80f, 6.513f, 5.709f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_335, 2985.922f, 568.154f, 44.68746f, 0f, 0f, 80f, 2.17f, 2.622f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_335, 2987.423f, 576.661f, 44.68746f, 0f, 0f, 80f, 2.509f, 2.264f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_335, 2982.536f, 570.44f, 44.68746f, 0f, 0f, 80f, 2.957f, 1.909f, 2.553f);
	iLocal_336 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Van Horn - m_volPostOfficePrompt Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_336, 2985.951f, 568.536f, 44.902f, 0f, 0f, 80f, 1.441f, 1.703f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_336, 2987.352f, 576.3314f, 44.90187f, 0f, 0f, -99.75122f, 1.441f, 1.921f, 2.55285f);
	...
	func_46();
	iLocal_341 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2986.621f, 572.416f, 45.094f, 0f, 0f, 80f, 6.15f, 5.5f, 3f, "Van horn - m_volStation");
	iLocal_342 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2986.621f, 572.416f, 45.094f, 0f, 0f, 80f, 6.05f, 5.4f, 3f, "Van horn - m_volStationTheft");
	iLocal_344 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(3673.944f, 1820.37f, 44.866f, 0f, 0f, 137f, 3.805645f, 2.488799f, 1.110669f, "Van horn - m_volBarBlocking");
	iLocal_345 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(3631.745f, 1868.769f, 50.32811f, 0f, 0f, -43.99438f, 11.20539f, 14.45394f, 10.03917f, "Van horn - m_volTailorComp");
	iLocal_346 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2947.408f, 545.9362f, 50.72883f, 0f, 0f, 0f, 17.35913f, 18.45897f, 4.232503f, "Van Horn- Resident Toughts Guard Volume");
	iLocal_350 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Van Horn - m_volHorseShopPen Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_350, 2979.276f, 779.6296f, 52.62945f, 0f, 0f, 0f, 40.47127f, 19.50671f, 7.453903f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_350, 2985.944f, 797.0881f, 52.62945f, 0f, 0f, 0f, 23.67008f, 19.46324f, 7.453903f);
	func_47(GET_HASH_KEY("DOOR_VAN_DEPOT_INT_1"), 1);
	func_48();
	iLocal_348 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Vanhorn Horse Shop - m_volHorseShop Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_348, 2967.159f, 798.5253f, 51.745f, 0f, 0f, 0f, 14.3611f, 10.48136f, 4.225f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_348, 2970.102f, 792.5105f, 51.65219f, 0f, 0f, 0f, 8.344481f, 5.59843f, 2.959558f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2977.085f, 578.2434f, 44.74796f, 0f, 0f, -8.75f, 2f, 1.5f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2976.031f, 570.4984f, 44.87031f, 0f, 0f, -8.75f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2978.329f, 570.0295f, 44.87031f, 0f, 0f, -8.750001f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2974.207f, 572.8066f, 44.57592f, 0f, 0f, -100f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2984.081f, 569.448f, 44.87031f, 0f, 0f, -8.75f, 1.5f, 0.5f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2987.933f, 568.4299f, 44.87031f, 0f, 0f, -8.749999f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2974.849f, 576.4528f, 44.57592f, 0f, 0f, -100f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2990.79f, 573.7715f, 47.80463f, 0f, 0f, -100f, 1.5f, 2f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2990.305f, 573.8566f, 44.57592f, 0f, 0f, -100f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2989.646f, 570.0085f, 44.57592f, 0f, 0f, -100f, 1.5f, 1f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_352, 2978.165f, 570.1346f, 47.59827f, 0f, 0f, -8.750001f, 1.5f, 1f, 4f);
	return true;
}
...
{
	func_60(4, 444, iLocal_333, iParam0, iLocal_334, 0, 44, -1082130432 /* Float: -1f */, 0, 0);
	func_61(4, -919742804, 0, 0);
	func_61(4, -1653762302, 0, 0);
	func_61(4, 877945562, 0, 0);
	func_62(4, 3023.046f, 563.0334f, 43.7167f, 242.849f);
	func_60(2, 470, iLocal_335, iParam0, iLocal_336, iLocal_337, 229376, -1082130432 /* Float: -1f */, 0, 0);
	func_63(2, iLocal_338);
	func_60(9, 459, iLocal_348, iParam0, 0, 0, 2, -1082130432 /* Float: -1f */, 0, 0);
	func_64(9, 1);
	func_64(9, 16384);
	func_65(9, 1);
...
void func_35(int iParam0)
{
	...
	func_70();
	func_71(0, GET_HASH_KEY("VHT_CIVILIANS"));
	func_71(3, GET_HASH_KEY("VHT_LOCAL_TOUGHS"));
	func_71(4, GET_HASH_KEY("VHT_LOCAL_TOUGHS"));
}
...
void func_46()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_339, 2946.662f, 523.323f, 46.02f, 0f, 0f, 180f, 9.627f, 13.43f, 3.143f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_339, 2939.048f, 523.346f, 45.61858f, 0f, 0f, -180f, 6.016271f, 9.883f, 3.143f);
	iLocal_340 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Van horn - m_volSaloonTheft");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_340, 2946.748f, 523.316f, 45.072f, 0f, 0f, 80f, 10.1f, 14f, 3.347f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_340, 2939.048f, 523.346f, 45.61858f, 0f, 0f, -180f, 6.016271f, 9.883f, 3.143f);
	iLocal_343 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(3667.963f, 1819.602f, 46.352f, 0f, 0f, 137f, 18.9791f, 14.3972f, 5.599486f, "Van horn - volSaloonVan");
}
...
void func_73()
{
	...
	{
		if (((!bLocal_351 && AUDIO::_0xBE28DB99556FF8D9(iVar1) != 0) && !func_162(iVar0, 0)) && PED::IS_PED_USING_SCENARIO_HASH(iVar1, GET_HASH_KEY("PROP_HUMAN_PIANO_SKETCHY")))
		{
		...
		else if (bLocal_351 && !PED::IS_PED_USING_SCENARIO_HASH(iVar1, GET_HASH_KEY("PROP_HUMAN_PIANO_SKETCHY")))
		{
			bLocal_351 = false;
		}
	}
...
void func_85(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_184(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_184(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_184(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_184(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_87(int iParam0, bool bParam1)
{
	...
	func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_190(func_189(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_97(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_346))
	{
		...
		VOLUME::_DELETE_VOLUME(iLocal_346);
	}
...
void func_111()
{
	...
	Local_150[0 /*45*/].f_43 = 44642;
	Local_150[0 /*45*/].f_44 = 44744;
	Local_150[0 /*45*/].f_38 = iVar0;
	func_221(&(Local_150[0 /*45*/]), 512);
	uVar7 = 5;
	func_218(&Local_150, 470, &uVar7, 1, 0);
	Local_150[1 /*45*/].f_43 = 44821;
	Local_150[1 /*45*/].f_44 = 44744;
	func_221(&(Local_150[1 /*45*/]), 512);
	uVar13 = 5;
	func_218(&Local_150, 444, &uVar13, 2, 0);
	Local_150[2 /*45*/].f_43 = 45117;
	Local_150[2 /*45*/].f_44 = 44744;
	func_221(&(Local_150[2 /*45*/]), 512);
	uVar19 = 5;
	func_218(&Local_150, 459, &uVar19, 3, 0);
	Local_150[3 /*45*/].f_43 = 45252;
	Local_150[3 /*45*/].f_44 = 44744;
						...
						else
						{
							...
							else
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
								{
									...
									if (!func_273(1))
									{
										iVar1 = TASK::FIND_SCENARIO_OF_TYPE_HASH(func_275(), GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_BAR_CA"), 3f, 1, false);
										TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
void func_212(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 13:
			...
			break;
		case 14:
			func_301(GET_HASH_KEY("DOOR_STR_WHORE_INT_2"), bParam1);
			break;
		case 16:
...
{
	if (iParam1 == GET_HASH_KEY("A_M_M_RKRROUGHTRAVELLERS_01") || iParam1 == GET_HASH_KEY("A_M_M_HTLROUGHTRAVELLERS_01"))
	{
		uParam0->f_3 = iParam1;
		return 1;
	}
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || func_339(iParam0, 0))
	{
		return false;
	}
	if (func_340(iParam0))
...
void func_335(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_389(iParam1))
		{
			func_390(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
{
	if (((func_273(1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iParam0)) || AUDIO::IS_ANY_SPEECH_PLAYING(iParam0))
	{
		return true;
	}
	return false;
...
bool func_359(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	...
	else if (func_395(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		iVar0 = (*uParam0)[0 /*4*/];
		iVar1 = (*uParam0)[1 /*4*/];
		if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && !func_339(iVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(iVar1) && !func_339(iVar1, 0)))
		{
			if (!func_132(vParam4))
			{
