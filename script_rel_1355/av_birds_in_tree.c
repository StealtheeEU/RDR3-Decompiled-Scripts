...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_SONGBIRD_01");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BLS_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, -1f), (0f + vParam4.z), 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 1, "BLS_BIRD_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 0.5f, -1f), (135f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "BLS_BIRD_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 3, "BLS_BIRD_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0f, -1f), (45f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "BLS_BIRD_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0f, -1f), (-100f + vParam4.z), 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 5, "BLS_BIRD_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.45f, -0.5f, -1f), (-135f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "BLS_BIRD_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, -0.25f, -1f), (-145f + vParam4.z), 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 7, "BLS_BIRD_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-15f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 8, "BLS_BIRD_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 9, "BLS_BIRD_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.75f, -1f), (50f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 10, "BLS_BIRD_11", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, -1f), (0f + vParam4.z), 0, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 11, "BLS_BIRD_12", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0.5f, -1f), (35f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_42 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[iLocal_42 /*14*/], GET_HASH_KEY("STAND"), uParam0->f_20[iLocal_42 /*14*/].f_5, uParam0->f_20[iLocal_42 /*14*/].f_8, 0, false, true, 0, -1f, false);
			}
			iLocal_42++;
			if (iLocal_42 >= 12)
			{
...
void func_88(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_123(iParam1))
		{
			func_124(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_196(int iParam0, int iParam1)
{
	...
	if (func_223(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
