...
bool func_72(var uParam0)
{
	...
	iLocal_19 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER", 0, 0, 1);
	iLocal_17 = func_151(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_18 = func_151(uParam0, GET_HASH_KEY("P_WASHBOARD01X"), 0f, 0f, 0f, "WashBoard", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_BASINWATER01X"), 0f, 0f, 0f, "BASIN", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	func_152(uParam0, -0.875f, -3.4125f, 0.9f, 2f, 1.7725f, 1.54f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, 4.3625f, -1.225f, 0.7625f, 2f, 1.7725f, 1.54f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_152(uParam0, 13.3375f, -6.3875f, 1.075f, -24.25f, 1.7725f, 1.54f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_153(uParam0, 3.6f, -2.56f, 1.0889f, 16.2f, 2f, 1.2f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_JAVCNV9"), GET_HASH_KEY("PLAYER_JAVCNV9"));
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_19, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 20f, 1065353216 /* Float: 1f */, 1);
