...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -1.6101f, -1.2696f, 0.4797f, -62.28f, 2f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_152(uParam0, 3.1676f, -2.4034f, 0.4069f, -21.3303f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, -6.8056f, -8.6035f, 1.0723f, 1.44f, 2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, -0.8f, -0.88f, 0.9775f, 0f, 0.84f, 0.84f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_J", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_HSHCNV7"), GET_HASH_KEY("PLAYER_HSHCNV7"));
	return true;
}
