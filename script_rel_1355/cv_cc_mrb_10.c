...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.3875f, 0.8175f, 0.85f, -21.75f, 1.3f, 1.3f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_151(uParam0, -0.0125f, -0.2875f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_24 = func_152(uParam0, GET_HASH_KEY("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_152(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_155(uParam0, iLocal_19, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_21, 0);
	func_156(uParam0, iLocal_19, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_19, iLocal_23, "p_cs_sock01x_PH_L_HAND", 0, 0);
	func_158(uParam0, iLocal_19, 4, 1, 0, 0, 0);
	func_156(uParam0, iLocal_20, 3, GET_HASH_KEY("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216 /* Float: 1f */, 1);
