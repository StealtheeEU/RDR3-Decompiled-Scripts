...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.6318f, -3.0952f, 1.4875f, 0f, 4f, 7f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 10.4607f, 7.138f, 1.4875f, -22.5f, 1.1f, 1.1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("S_CARAVANCOT01X"), 0.821147f, -0.15355f, 0.243698f, 0, 1, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_CIGAR02X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_PEPPERSHAKER02X"), 0f, 0f, 0f, "PEPPERSHAKER", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DTCCNV28"), GET_HASH_KEY("PLAYER_DTCCNV28"));
	func_156(uParam0, iLocal_20, -1, 0.88f);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", iLocal_16, 0);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, iLocal_15, 4, GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_SEASONING_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
