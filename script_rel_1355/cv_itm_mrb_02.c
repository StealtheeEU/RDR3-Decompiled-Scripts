...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_19 = func_156(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "Ledger", 0, 0, 1);
	iLocal_18 = func_156(uParam0, GET_HASH_KEY("P_PENCIL01X"), 0f, 0f, 0f, "PENCIL", 0, 0, 1);
	...
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_WRITE_NOTEBOOK"), "WORLD_HUMAN_WRITE_NOTEBOOK_FEMALE_A", -1, 1);
	func_160(uParam0, iLocal_14, 0f, 0f, 1.0116f, 0f, 1, 1);
	func_161(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_WRITE_NOTEBOOK"), "WORLD_HUMAN_WRITE_NOTEBOOK_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_198(var uParam0)
{
	...
	{
		iLocal_31 = func_302("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_207(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			func_318(iVar0, 1);
			func_319();
			func_321(func_320(GET_HASH_KEY("CAMP_REQUESTS_STARTED")), 1);
			return 1;
		}
		iVar0++;
	}
...
int func_256()
{
	...
	if (func_344(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_257()
{
	...
	if (func_344(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_365(GET_HASH_KEY("CONSUMABLE_MEDICINE"));
...
void func_313(int iParam0)
{
	...
	{
		case 9:
			if (func_366(GET_HASH_KEY("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_367();
				func_368(GET_HASH_KEY("REWARD_PED_SMALL"), 0.68f);
				func_368(GET_HASH_KEY("REWARD_PED_MEDIUM"), 0.68f);
				func_368(GET_HASH_KEY("REWARD_PED_LARGE"), 0.68f);
			}
			break;
	}
}
...
void func_314(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			func_374(1, GET_HASH_KEY("CONSUMABLE_WHISKEY"), 0);
			func_374(2, GET_HASH_KEY("CONSUMABLE_PEPPERMINT"), 0);
			func_374(3, GET_HASH_KEY("CONSUMABLE_HERB_MILKWEED"), 0);
			func_374(4, GET_HASH_KEY("CONSUMABLE_HAIR_GREASE"), 0);
			func_374(5, 0, GET_HASH_KEY("AT_SKUNK"));
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_317(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_380(&uVar4, GET_HASH_KEY("COLOR_PURE_WHITE"));
...
void func_356(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_408(iParam1))
		{
			func_409(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_375(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_424("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_371(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_381(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_344(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
int func_421(int iParam0, bool bParam1)
{
	...
	if (!func_472(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_473(iVar14);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_344(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_432(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_512(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_533(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_514(GET_HASH_KEY("CHARACTER"), func_537(), -1591664384, bParam0);
}
...
struct<4> func_514(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_422(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<5> func_542(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_419(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_514(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_514(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
