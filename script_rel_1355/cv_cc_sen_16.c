...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, -0.8875f, 1.15f, 6.81f, 2.6575f, 2.31f, 2.685f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_151(uParam0, -4.1f, 0.1f, 1.15f, 0f, 1.285f, 1.735f, 2.685f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_KNITTING01X"), 0f, 0f, 0f, "p_cs_knitting01x", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SENCNV16"), GET_HASH_KEY("PLAYER_SENCNV16"));
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_POST_LEFT"), "WORLD_HUMAN_LEAN_POST_LEFT_MALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), 0, -1, 0, 60f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 3, 0);
	func_159(uParam0, iLocal_15, 4, 2, 0, 0, 0);
	func_160(uParam0, iLocal_15, 1, -1);
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), 0, -1, 0, 70f, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_400(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
