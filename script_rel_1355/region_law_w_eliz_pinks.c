...
void __EntryFunction__()
{
	...
	iLocal_14 = 1;
	iLocal_31 = 10;
	iLocal_34 = GET_HASH_KEY("S_M_M_PINLAW_01");
...
void func_7()
{
	...
	switch (iLocal_14)
	{
		case 1:
			func_26(&uLocal_40);
			iLocal_35[0] = GET_HASH_KEY("A_C_HORSE_AMERICANSTANDARDBRED_BLACK");
			iLocal_35[1] = GET_HASH_KEY("A_C_HORSE_MUSTANG_GRULLODUN");
			iLocal_35[2] = GET_HASH_KEY("A_C_HORSE_THOROUGHBRED_BLOODBAY");
		...
		case 3:
			...
			if (func_32(vVar2, &Local_15, &bVar1, 47, 1, fVar5, 1101004800 /* Float: 20f */, fVar6, (fLocal_27 - 10f), 0))
			{
...
bool func_32(vector3 vParam0, int iParam3, bool bParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, int iParam10, float fParam11)
{
	...
	switch (*iParam3)
	{
		case 0:
			...
			func_65(&(iParam3->f_1), iParam3->f_2, vParam0, iParam5, fParam7, iParam8, fParam9, iParam10, fParam11);
...
void func_39(int iParam0)
{
	...
	PED::_0x712B2C2B2471B493(iLocal_43[iParam0], GET_HASH_KEY("DISABLED"));
	WEAPON::SET_PED_DROPS_WEAPONS_WHEN_DEAD(iLocal_43[iParam0], false);
	WEAPON::GIVE_WEAPON_TO_PED(iLocal_43[iParam0], GET_HASH_KEY("GROUP_SNIPER"), 100, true, false, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
}
...
void func_85(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_87(iParam1))
		{
			func_88(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
