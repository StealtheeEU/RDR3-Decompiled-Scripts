...
void __EntryFunction__()
{
	...
	iLocal_38 = -1;
	iLocal_53 = GET_HASH_KEY("A_C_SONGBIRD_01");
	iLocal_54 = GET_HASH_KEY("S_M_M_FUSSARHENCHMAN_01");
	iLocal_55 = GET_HASH_KEY("CS_HERCULE");
...
int func_11(var uParam0)
{
	...
	TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(func_22(2), 0, 1f, 1f, 1);
...
bool func_29(var uParam0)
{
	...
	switch (iLocal_26)
	{
		case 0:
			...
			MISC::SET_WEATHER_TYPE(GET_HASH_KEY("FOG"), true, true, true, 60f, false);
			CLOCK::PAUSE_CLOCK(true, 0);
			iLocal_27 = VOLUME::_CREATE_VOLUME_BOX(984.2063f, -6781.292f, 49.91065f, 0f, 0f, -20f, 5f, 30f, 4f);
			iLocal_28 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLBOX"), 987.4385f, -6772.322f, 49.94096f, 0f, 0f, -20f, 8f, 5f, 2f);
			iLocal_29 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLBOX"), 985.287f, -6785.009f, 49.76819f, 0f, 0f, -19.99999f, 1f, 30f, 4f);
			iLocal_30 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLBOX"), 981.1976f, -6783.522f, 49.76819f, 0f, 0f, -19.99999f, 1f, 30f, 4f);
		...
		case 1:
			...
			break;
		case 2:
			TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(func_22(0), 1, 1f, 1f, 1);
		...
		case 3:
			if (!bLocal_58)
			{
				if (func_61(Global_35, 983.2f, -6785.1f, 49.5f, 2f, 1, 1))
				{
					...
					func_62(Global_35, "COUGH_SICK_SMALL", GET_HASH_KEY("SPEECH_PARAMS_FORCE_NORMAL_CRITICAL"), 0, 1, 0, 0, 1);
					bLocal_58 = true;
				}
			}
			func_63(0);
		...
		case 4:
			...
			PED::FORCE_PED_MOTION_STATE(Global_35, GET_HASH_KEY("MOTIONSTATE_WALK"), false, 0, false);
			...
			CLOCK::PAUSE_CLOCK(true, 0);
			TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(func_22(0), 0, 1f, 1f, 1);
			STREAMING::END_SRL();
...
void func_63(int iParam0)
{
	...
	if (((!PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_LR")) == 0f || !PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_RIGHT_ONLY")) == 0f) || !PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_UP_ONLY")) == 0f) || !PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_DOWN_ONLY")) == 0f)
	{
		bVar0 = true;
	}
	if (!bVar0)
	...
	else if (!func_65(iLocal_52))
	{
		if (func_114(&uLocal_20) >= 5f)
		{
			...
			{
				iLocal_52 = func_115("SMG2_O_HLP_WALK", GET_HASH_KEY("INPUT_MOVE_UD"), GET_HASH_KEY("INPUT_MOVE_LR"), 16);
...
void func_101(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_134(iParam1))
		{
			func_135(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_115(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != 0)
	{
		func_157(iVar1, iParam1, sParam0, 0, 3, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam3, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 0, iParam2, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		return iVar1;
	}
	return 0;
}
