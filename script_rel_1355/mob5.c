...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_14 = GET_HASH_KEY("CS_CREOLECAPTAIN");
	iLocal_15 = GET_HASH_KEY("CS_BRONTE");
	iLocal_16 = GET_HASH_KEY("G_M_M_UNIBRONTEGOONS_01");
	iLocal_17 = GET_HASH_KEY("S_M_M_AMBIENTSDPOLICE_01");
	iLocal_18 = GET_HASH_KEY("SKIFF");
	iLocal_19 = GET_HASH_KEY("P_SKIFF02X");
	iLocal_20 = GET_HASH_KEY("P_TRUNK05X");
	iLocal_21 = GET_HASH_KEY("P_TRAVELTRUNK02X");
	iLocal_22 = GET_HASH_KEY("P_CS_SUITCASE02X");
	iLocal_23 = GET_HASH_KEY("S_DD_LOCK_2");
	iLocal_24 = GET_HASH_KEY("A_C_ALLIGATOR_01");
	iLocal_66 = 1;
	iLocal_67 = 2;
	iLocal_68 = 3;
	iLocal_69 = 4;
	...
	{
		func_1(&uLocal_884, 1073741824 /* Float: 2f */);
		func_2(&uLocal_884, 1);
	...
	func_5(&uLocal_884);
	while (!func_6(&uLocal_884, -2147483648))
	{
		func_7(&uLocal_884);
		BUILTIN::WAIT(0);
	}
...
void func_5(var uParam0)
{
	...
	if (!Global_1935630.f_12)
	{
		...
		TELEMETRY::_TELEMETRY_MISSION_STARTED(&(Global_1835011[uParam0->f_607 /*74*/].f_8), 0, func_131(func_33(uParam0)), func_105());
	}
	func_132(uParam0);
	func_133(uParam0, 0);
	func_134(uParam0, 0);
	...
	func_144(uParam0, PLAYER::PLAYER_PED_ID(), "ARTHUR", 0);
	func_145(uParam0);
	func_146(uParam0);
	func_147(uParam0);
...
void func_7(var uParam0)
{
	...
	switch (func_153(uParam0))
	{
		...
		case 0:
			...
			if (func_157(uParam0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(func_158(uParam0)) && func_127(uParam0, 3))
				{
					ENTITY::FREEZE_ENTITY_POSITION(func_158(uParam0), false);
				}
				func_159(uParam0, 1);
			}
...
bool func_9(var uParam0)
{
	...
	{
		func_163(Local_147[iVar0 /*8*/]);
		func_164(uParam0, Local_147[iVar0 /*8*/], 1);
		func_166(func_165(Local_147[iVar0 /*8*/]), 0);
		iVar0++;
	}
	MISC::CLEAR_WEATHER_TYPE_PERSIST();
	func_167(0, 1103626240 /* Float: 25f */);
	CLOCK::PAUSE_CLOCK(false, 0);
	func_168(uParam0, 0, Local_147[0 /*8*/], 0, 0, 1, 0);
	func_168(uParam0, 1, Local_147[1 /*8*/], 0, 0, 1, 0);
	func_168(uParam0, 3, Local_147[2 /*8*/], 0, 0, 1, 0);
	func_168(uParam0, 9, Local_147[3 /*8*/], 0, 0, 1, 0);
	func_169(&Local_678, 0);
	func_169(&vLocal_670, 0);
	func_170(&iLocal_727);
	func_170(&iLocal_729);
	func_170(&iLocal_730);
	func_170(&iLocal_731);
	...
	{
		func_173(&(iLocal_718[iVar1]), 0, 1, 1);
		iVar1++;
	}
	iVar1 = 0;
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_786[0]))
	{
		TASK::_DELETE_SCENARIO_POINT(iLocal_786[0]);
	}
	if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_786[1]))
	{
		TASK::_DELETE_SCENARIO_POINT(iLocal_786[1]);
	}
	func_174();
	func_175(&(iLocal_725[0]), 2299.886f, -1239.479f, 43.0673f, 2403.525f, -1193.342f, 66.8316f, 0, 0);
	func_176(-777462925, 0, 0, 0, 1, 0, 1, 0);
	func_176(1291327218, 0, 0, 0, 1, 0, 1, 0);
	func_176(1587886668, 0, 0, 0, 1, 0, 1, 0);
	func_176(895866323, 0, 0, 0, 1, 0, 1, 0);
	func_176(1130131904, 0, 0, 0, 1, 0, 1, 0);
	func_176(-3733011, 0, 0, 0, 1, 0, 1, 0);
	func_176(913143609, 0, 0, 0, 1, 0, 1, 0);
	func_176(-1382886115, 0, 0, 0, 1, 0, 1, 0);
	func_176(-1092323392, 0, 0, 0, 1, 0, 1, 0);
	func_176(-516807739, 0, 0, 0, 1, 0, 1, 0);
	func_176(-777091906, 0, 0, 0, 1, 0, 1, 0);
	func_176(-2126919475, 0, 0, 0, 1, 0, 1, 0);
	ENTITY::REMOVE_MODEL_HIDE(2367.458f, -1212.529f, 50.771f, 1f, GET_HASH_KEY("P_FIREGUARD01X"), 0);
	ENTITY::REMOVE_MODEL_HIDE(2375.943f, -1213.643f, 46.1594f, 1f, GET_HASH_KEY("P_POT_FLOWERARNG23X"), 0);
	func_177();
	...
	while (iVar1 < 8)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_875[iVar1]))
		{
			TASK::_DELETE_SCENARIO_POINT(iLocal_875[iVar1]);
		}
		iVar1++;
	}
	...
	func_181(iLocal_796);
	func_181(iLocal_728);
	func_181(iLocal_805[0]);
	func_181(iLocal_805[1]);
	func_181(iLocal_801[0]);
	func_181(iLocal_801[1]);
	func_181(iLocal_741);
	...
	ENTITY::REMOVE_MODEL_HIDE(2323.71f, -1212.88f, 45.28f, 0.5f, GET_HASH_KEY("P_POT_FLOWERARNG06X"), 0);
	ENTITY::REMOVE_MODEL_HIDE(2323.61f, -1219.59f, 45.28f, 0.5f, GET_HASH_KEY("P_POT_FLOWERARNG06X"), 0);
	OBJECT::_0x614D0B4533F842D3(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(func_182(895866323, 0)));
	OBJECT::_0x614D0B4533F842D3(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(func_182(1130131904, 0)));
	func_183();
...
void func_13(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_191(iParam0) == 3 || (func_191(iParam0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_190(iParam0))))
	{
...
void func_17(var uParam0, bool bParam1)
{
	...
	Var0 = func_190(func_12(uParam0->f_607));
	Var0.f_1 = 0;
...
void func_25(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_214(uParam1[iVar0 /*16*/], 1048576))
		{
			switch (iParam0)
			{
				case 0:
...
bool func_28(var uParam0, bool bParam1)
{
	...
	if (func_218(&(uParam0->f_13118)) >= 4000)
	{
		return true;
	}
	if (!func_31(uParam0))
...
struct<4> func_34(int iParam0)
{
	...
	{
		func_220(&Var0, 2296.338f, -1251.399f, 40.6583f, 350.0099f);
	}
	else if (iParam0 == iLocal_66)
	{
		func_220(&Var0, 2301.557f, -1252.213f, 42.4709f, 326.8071f);
	}
	else if (iParam0 == iLocal_67)
	{
		func_220(&Var0, 2305.591f, -1237.071f, 42.985f, 296.5625f);
	}
	else if (iParam0 == iLocal_68)
	{
		func_220(&Var0, 2322.813f, -1212.754f, 43.9999f, 271.2475f);
	}
	else if (iParam0 == iLocal_69)
	{
		func_220(&Var0, 2347.308f, -1216.339f, 43.9857f, 260.5363f);
	}
	else if (iParam0 == iLocal_70)
	{
		func_220(&Var0, 2364.842f, -1216.37f, 46.1669f, 270.3622f);
	}
	else if (iParam0 == iLocal_71)
	{
		func_220(&Var0, 2379.911f, -1216.468f, 46.1568f, 104.7898f);
	}
	else if (iParam0 == iLocal_72)
	{
		func_220(&Var0, 2370.311f, -1209.914f, 50.7733f, 267.4392f);
	}
	else if (iParam0 == iLocal_73)
	{
		func_220(&Var0, 2366.191f, -1216.02f, 46.1772f, 88.1437f);
	}
	else if (iParam0 == iLocal_74)
	{
		func_220(&Var0, 2304.759f, -1216.371f, 42.9793f, 88.2135f);
	}
	else if (iParam0 == iLocal_75)
	{
		func_220(&Var0, 2282.82f, -1217.93f, 41.2288f, 203.2497f);
	}
	return Var0;
}
...
{
	return func_221(uParam0, func_33(uParam0));
}
...
void func_36(var uParam0, struct<4> Param1, struct<4> Param5, int iParam9, int iParam10)
{
	...
	Var4.f_3 = Param5.f_3;
	func_205(0);
	func_222(func_12(uParam0->f_607), Var0, Var4, func_131(iParam9), func_131(iParam10));
}
...
void func_37(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_214(uParam0[iVar0 /*16*/], 1048576) && (uParam0[iVar0 /*16*/])->f_9 == 9)
		{
			func_223(uParam0[iVar0 /*16*/]);
		}
		iVar0++;
	}
}
...
void func_40(bool bParam0)
{
	...
	else
	{
		...
		func_225(&Global_1935630, 4194304);
	}
...
void func_55(bool bParam0, int iParam1)
{
	...
	if (!bParam0)
	{
		if (func_242(Global_1894899.f_2) && func_243(Global_1894899.f_2))
		{
			func_244(Global_1894899.f_2, 0);
			if (iParam1 != 0)
			{
		...
		else if (func_242(Global_1894899.f_2) && !func_246(Global_1894899.f_2, 2))
		{
			bParam0 = true;
		}
	}
...
void func_56(var uParam0)
{
	...
	{
		if (func_249(&(uParam0->f_5423[iVar0 /*65*/])))
		{
	...
	if (func_250(uParam0->f_5421))
	{
		iVar0 = 0;
		while (iVar0 < func_251(uParam0->f_5421))
		{
			iVar1 = func_252(uParam0->f_5421, iVar0);
...
void func_58(var uParam0, bool bParam1)
{
	...
	iVar1 = func_255(bVar0);
	iVar2 = SCRIPTS::GET_ID_OF_THIS_THREAD();
	bVar3 = false;
	if (SCRIPTS::IS_THREAD_ACTIVE(iVar2, false) && func_256(iVar1) == iVar2)
	{
		bVar3 = true;
	}
	if (bVar3)
...
void func_68(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_214(uParam1[iVar0 /*16*/], 1048576) && (uParam1[iVar0 /*16*/])->f_9 == 9)
		{
			func_215(uParam1[iVar0 /*16*/], 1);
		}
		iVar0++;
...
void func_75(var uParam0)
{
	...
	func_277(iVar0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, 752097756);
}
...
void func_78(int iParam0, bool bParam1)
{
	...
	bVar0 = func_246(iParam0, 67108864);
	if (bParam1)
	{
...
void func_83(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (bParam1 && func_191(iParam0) != 0)
				{
					if (iVar0 == 1)
					{
						...
						{
							STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1835011[func_266(iParam0) /*74*/].f_8), true);
						}
					}
					else if ((func_266(iParam0) != 95 && func_266(iParam0) != 82) && !func_295(Global_1347702[func_266(iParam0) /*49*/].f_12, 512))
					{
						STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1347702[func_266(iParam0) /*49*/].f_3), true);
					}
				}
			}
			else
	...
	if (!Global_1879534 && !Global_1879534.f_1)
	{
		switch (iVar0)
		{
			...
			case 8:
				...
				{
					func_308(14, 0, 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
				}
				Global_1899528.f_217 = 1;
				break;
			case 9:
	...
	if (bParam1)
	{
		...
		switch (iVar0)
		{
			...
			case 11:
				...
				break;
			case 8:
				if (func_267(func_266(iParam0)) && func_295(Global_1347702[func_266(iParam0) /*49*/].f_12, 4))
				{
					Global_1898438 = MISC::GET_GAME_TIMER();
				}
				else
	...
	if (bVar13)
	{
			...
			case 1:
				switch (func_266(iParam0))
				{
					...
					case 1:
						...
						break;
					case 4:
						func_312(GET_HASH_KEY("CONSUMABLE_HERB_SAGE"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("CONSUMABLE_HERB_GINSENG"), 4, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("CONSUMABLE_HERB_INDIAN_TOBACCO"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("CONSUMABLE_HERB_YARROW"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("PROVISION_GRITTY_FISH_MEAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("PROVISION_STRINGY_MEAT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("PROVISION_ANIMAL_FAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("PROVISION_BIRD_FEATHER_FLIGHT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("CONSUMABLE_COFFEE_GNDS_REG"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"));
						func_312(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_313(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"));
						func_312(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("KIT_CAMP"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(-1448210800 /* GXTEntry: "Crafting Tools" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_312(GET_HASH_KEY("CLOTHING_ITEM_PZ_LOADOUT_BANDOLIER_01"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_314();
						func_315(GET_HASH_KEY("CLOTHING_SP_COAT_WINTER01_VARIATION_01"));
						func_316();
						func_317();
						break;
					case 5:
					...
					case 14:
						...
						break;
					case 2:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY(func_318(10, 0)));
						break;
					case 8:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, 621714131 /* GXTEntry: "Jamie Gillis" */);
						break;
					case 15:
						func_312(GET_HASH_KEY("DOCUMENT_MAP_LEGENDARY_ANIMALS"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					...
					case 18:
						...
						if (!func_321(Global_1347702[21 /*49*/].f_15, 1))
						{
					...
					case 26:
						...
						break;
					case 17:
						func_324(Global_35, GET_HASH_KEY("CLOTHING_ITEM_BADGE_PZERO_000"), 0, -358215195, 1, 1);
						if (func_325())
						{
							func_326(GET_HASH_KEY("WEAPON_REPEATER_EVANS"));
						}
						break;
					case 19:
						...
						break;
					case 33:
						if (!func_327(GET_HASH_KEY("TP_RMAY_LETTER_1"), -1))
						{
							iVar15 = func_279();
							func_328(&iVar15, 0, 0, 0, 2, 0, 0, 0);
							func_329(GET_HASH_KEY("TP_RMAY_LETTER_1"), iVar15, 0);
						}
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY("DISCOVERABLE_NAME_EVELYN_MILLER"));
						if (func_325())
						{
							func_326(GET_HASH_KEY("WEAPON_REVOLVER_LEMAT"));
						}
						break;
					case 34:
						if (func_325())
						{
							func_326(GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_GAMBLER"));
						}
						break;
					case 28:
					...
					case 43:
						...
						break;
					case 44:
						if (!func_321(Global_1347702[82 /*49*/].f_15, 1))
						{
						...
						if (!func_321(Global_1347702[83 /*49*/].f_15, 1))
						{
					...
					case 67:
						...
						if (!func_339(GET_HASH_KEY("TAXIDERMY_ORDER_05")))
						{
							if (func_339(GET_HASH_KEY("TAXIDERMY_ORDER_04")))
							{
								iVar16 = func_279();
								func_328(&iVar16, 0, 0, 6, 0, 0, 0, 0);
								func_329(GET_HASH_KEY("TP_TAXIDERMY_REWARD_04_ES"), iVar16, 1);
							}
						}
						if (func_340(4))
						{
							if (!func_341(GET_HASH_KEY("DOCUMENT_NOTE_RARE_FISH"), 1, 0))
							{
								iVar17 = func_279();
								func_328(&iVar17, 0, 0, 6, 0, 0, 0, 0);
								func_329(GET_HASH_KEY("TP_RF_INVITATION_01"), iVar17, 1);
							}
						}
					...
					case 76:
						...
						break;
					case 69:
						if (func_321(Global_1347702[9 /*49*/].f_15, 1))
						{
							func_342(-6000);
						}
						break;
			...
			case 8:
				switch (func_266(iParam0))
				{
					...
					case 67:
						...
						if (func_325())
						{
							func_326(GET_HASH_KEY("WEAPON_PISTOL_M1899"));
						}
						break;
					case 68:
					...
					case 147:
						...
						break;
					case 9:
						if (func_321(Global_1835011[69 /*74*/].f_1, 1))
						{
							func_351(0);
							func_342(40500);
						}
		...
		switch (iVar0)
		{
			case 1:
				...
				{
					case 4:
						func_354(iParam0, 1000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 61:
					case 62:
					case 63:
						func_354(iParam0, 300, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 25:
					...
					case 34:
						...
						if (!func_341(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0))
						{
							func_312(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						break;
					case 29:
					...
					case 57:
						...
						break;
					case 76:
						func_354(iParam0, 2042100, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 72:
						if (func_355(iParam0) == 0)
						{
							func_354(iParam0, 20000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						else
						{
							func_354(iParam0, 15000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						break;
				}
				break;
			case 8:
				if (func_295(Global_1347702[func_266(iParam0) /*49*/].f_12, 536870912))
				{
					func_356(11, 1);
				}
				switch (func_266(iParam0))
				{
					case 109:
						func_354(iParam0, 1500, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 55:
						func_356(8, 1);
						break;
				...
				break;
			case 11:
				if (iParam0 == func_357(0, 10, 11, GET_HASH_KEY("CABR01")))
				{
					func_354(iParam0, func_355(iParam0), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_357(0, 7, 11, GET_HASH_KEY("CACR02")))
				{
					func_354(iParam0, func_358(9), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_357(0, 8, 11, GET_HASH_KEY("CACR03")))
				{
					func_354(iParam0, func_358(10), 1, 0.5f, 2, 0, 0, 1);
				}
				else if (iParam0 == func_357(0, 11, 11, GET_HASH_KEY("CACR01")))
				{
					func_354(iParam0, func_358(8), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_357(0, 12, 11, GET_HASH_KEY("CACR04")))
				{
		...
		if (bParam1)
		{
			if (!func_191(iParam0) == 0)
			{
				...
				else if (STATS::STATSTRACKER_IS_INITIALIZED(func_190(iParam0)))
				{
					iVar19 = 0;
					if (bParam3)
					{
			...
			if (bParam2)
			{
				switch (iVar0)
				{
					...
					case 2:
						...
						break;
					case 8:
						if (func_267(func_266(iParam0)) && func_295(Global_1347702[func_266(iParam0) /*49*/].f_12, 1))
						{
							iVar20 = 3;
						}
						else
	...
	func_202(1);
	if ((bVar13 || func_128()) && (func_192(iParam0) == 1 || func_192(iParam0) == 8))
	{
...
void func_84(int iParam0, bool bParam1)
{
	...
	if (STATS::STATSTRACKER_IS_INITIALIZED(func_190(iParam0)))
	{
		iVar0 = 0;
		if (bParam1)
		{
		...
		if (func_82(32768))
		{
			...
			if ((iVar1 == 1 || iVar1 == 8) || (iVar1 == 11 && iParam0 == func_357(0, 10, 11, GET_HASH_KEY("CABR01"))))
			{
				Global_1898438 = MISC::GET_GAME_TIMER();
				Global_1879514.f_1 = iParam0;
...
void func_100(var uParam0)
{
	...
	while (iVar0 < Global_43619)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_43619[iVar0 /*12*/]))
		{
			...
			func_373(&(uParam0->f_10792), Global_43619[iVar0 /*12*/], &(Global_43619[iVar0 /*12*/].f_1), 0);
		}
		iVar0++;
	}
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_43800))
...
{
	if (ENTITY::DOES_ENTITY_EXIST(func_381(uParam0, iLocal_14, 0)))
	{
		vLocal_670.x = func_382(uParam0, iLocal_14, 0);
		func_383(uParam0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(func_381(uParam0, iLocal_18, 0)))
	{
		iLocal_716[0] = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(func_381(uParam0, iLocal_18, 0));
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_716[0]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_716[0], true, true);
		}
		func_384(uParam0, iLocal_716[0], "SKIFF", 0, 0, 0, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(func_381(uParam0, iLocal_19, 0)))
	{
		bLocal_791 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(func_381(uParam0, iLocal_19, 0));
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(bLocal_791))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_791, true, true);
		}
		func_384(uParam0, bLocal_791, "p_skiff02x", 0, 0, 0, 0);
	}
	if (func_273(uParam0) == 0)
	{
		func_385(uParam0, 8192);
	}
}
...
bool func_116(int iParam0)
{
	...
	return func_246(iParam0, 33554432);
}
...
{
	return func_387(uParam0->f_1[func_131(iParam1) /*22*/].f_11, iParam2);
}
...
{
	return uParam0->f_1[func_131(iParam1) /*22*/].f_12;
}
...
{
	func_407(uParam0, iLocal_15, 525248);
	func_407(uParam0, iLocal_16, 127);
	func_407(uParam0, iLocal_14, 67108863);
	func_407(uParam0, iLocal_20, 1008);
	func_407(uParam0, iLocal_21, 1008);
	func_407(uParam0, iLocal_22, 1008);
	func_407(uParam0, iLocal_17, 896);
	func_407(uParam0, iLocal_18, 67108863);
	func_407(uParam0, iLocal_19, 524289);
	func_407(uParam0, iLocal_23, 24);
	func_407(uParam0, iLocal_24, 1);
	func_408(uParam0, sLocal_76, 12, 2, -1);
	func_408(uParam0, sLocal_78, 12, 2, -1);
	func_408(uParam0, sLocal_77, 12, 2, -1);
	func_408(uParam0, sLocal_79, 12, 2, -1);
	func_408(uParam0, sLocal_80, 8, 2, -1);
	func_408(uParam0, sLocal_88, 8, 2, -1);
	func_408(uParam0, sLocal_89, 8, 2, -1);
	func_408(uParam0, sLocal_90, 8, 2, -1);
	func_408(uParam0, sLocal_92, 32, 2, -1);
	func_408(uParam0, sLocal_93, 32, 2, -1);
	func_408(uParam0, sLocal_82, 525056, 2, -1);
	func_408(uParam0, sLocal_83, 525056, 2, -1);
	func_408(uParam0, sLocal_86, 768, 2, -1);
	func_408(uParam0, sLocal_87, 768, 2, -1);
	func_408(uParam0, sLocal_84, 256, 2, -1);
	func_408(uParam0, sLocal_83, 256, 2, -1);
	func_408(uParam0, sLocal_85, 256, 2, -1);
	func_408(uParam0, sLocal_91, 3, 2, -1);
	func_409(uParam0, "script@story@mob5@ig@ig_3_porchconversation@porchconversation", &(uLocal_106[0]), 14, 0, "PBL_BASE", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_4_guardsfountain@guardsfountain", &(uLocal_106[1]), 14, 0, "pblNewLoop", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_5_guardbackyard@guardbackyard", &(uLocal_106[2]), 14, 0, "pblExit", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall", &(uLocal_106[4]), 3, 0, "pl_ENTER_WALL_DUTCH", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall", &(uLocal_106[6]), 3, 0, "pl_ENTER_WALL_JOHN", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall", &(uLocal_106[7]), 3, 0, "pl_ENTER_WALL_BILL", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall", &(uLocal_106[5]), 3, 0, "pl_ENTER_WALL_LENNY", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall", &(uLocal_106[3]), 3, 0, "pl_VAULT_WALL", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall_p2", &(uLocal_106[8]), 2, 0, "pl_TO_CROUCH_DUTCH", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_6_climb_wall@ig_6_climb_wall_p2", &(uLocal_106[9]), 2, 0, "pl_CROUCH_IDLE_JOHN", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_enter_cover_john", &(uLocal_106[10]), 16, 0, 0, 0, 0);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_enter_cover_dutch", &(uLocal_106[11]), 16, 0, 0, 0, 0);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_enter_cover_lenny", &(uLocal_106[13]), 16, 0, 0, 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_enter_cover_bill", &(uLocal_106[12]), 16, 0, 0, 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_gang_enter_cover", &(uLocal_106[14]), 48, 0, "pl_Cover_Idle_John", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_gang_enter_cover", &(uLocal_106[15]), 16, 0, "pl_Cover_Idle_Dutch", 0, 0);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_gang_enter_cover", &(uLocal_106[16]), 16, 0, "pl_Cover_Idle_Lenny_Bill", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_7_gang_enter_cover@ig_7_gang_enter_cover", &(uLocal_106[17]), 16, 0, "pl_Enter_Mansion_John_Dutch", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_9_findbronte@findbronte", &(uLocal_106[22]), 64, 0, "pbl_Main", 0, 0);
	func_409(uParam0, "script@story@mob5@ig@ig_10_copsenterhouse@copsenterhouse", &(uLocal_106[23]), 32, 0, 0, 0, 1);
	func_409(uParam0, "script@story@MOB5@IG@IG_8_BreakDownDoor@BargeLockedDoor_Fail", &(uLocal_106[19]), 64, 0, "pl_BargeLockedDoor_Fail01", 0, 1);
	func_409(uParam0, "script@story@MOB5@IG@IG_8_BreakDownDoor@BargeLockedDoor_Fail", &(uLocal_106[20]), 64, 0, "pl_BargeLockedDoor_Fail02", 0, 1);
	func_409(uParam0, "script@story@MOB5@IG@IG_8_BreakDownDoor@BargeLockedDoor_Fail", &(uLocal_106[21]), 64, 0, "pl_BargeLockedDoor_Fail03", 0, 1);
	func_409(uParam0, "script@story@mob5@ig@ig_12_cops_chase@cops_chase", &(uLocal_106[24]), 128, 0, 0, 0, 1);
	func_409(uParam0, "script@story@mob5@leadin@ext@base_wave_enter_exit", &(uLocal_106[26]), 768, 0, "pl_base", 0, 1);
	func_409(uParam0, "script@timelapse@mob5_ext_timelapse", &(uLocal_106[27]), 524288, 0, "PBL_1", 0, 1);
	func_410(uParam0, uLocal_106[0], "pbl_AlertReact_Fast", 16);
	func_410(uParam0, uLocal_106[1], "pblQuickExit", 16);
	func_410(uParam0, uLocal_106[4], "pl_WALL_IDLE_DUTCH", 3);
	func_410(uParam0, uLocal_106[6], "pl_WALL_IDLE_JOHN", 3);
	func_410(uParam0, uLocal_106[7], "pl_WALL_IDLE_BILL", 3);
	func_410(uParam0, uLocal_106[5], "pl_WALL_IDLE_LENNY", 3);
	func_410(uParam0, uLocal_106[8], "pl_CROUCH_IDLE_DUTCH", 2);
	func_410(uParam0, uLocal_106[8], "pl_ACTION_DUTCH", 2);
	func_410(uParam0, uLocal_106[9], "pl_ACTION_JOHN", 2);
	func_410(uParam0, uLocal_106[22], "TEMP_FIND", 64);
	func_410(uParam0, uLocal_106[14], "pl_JOHN_KICK_DOOR", 16);
	func_410(uParam0, uLocal_106[15], "pl_Arthur_Kick_Door_Arthur_Dutch", 16);
	func_410(uParam0, uLocal_106[15], "pl_Dutch_Callover_01", 16);
	func_410(uParam0, uLocal_106[15], "pl_Dutch_Callover_02", 16);
	func_410(uParam0, uLocal_106[15], "pl_Dutch_Callover_03", 16);
	func_411(uParam0, sLocal_94, 768);
	func_412(uParam0, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN"), 64, -1, 0);
	func_412(uParam0, GET_HASH_KEY("WEAPON_SHOTGUN_DOUBLEBARREL"), 16, -1, 0);
}

void func_139(var uParam0, int iParam1, int iParam2)
{
	func_413(&(uParam0->f_1[func_131(iParam1) /*22*/].f_11), iParam2);
}
...
{
	func_414(&(uParam0->f_638), &(uParam0->f_819), &(uParam0->f_1020), &(uParam0->f_1081), &(uParam0->f_1124), &(uParam0->f_1126), &(uParam0->f_5147), &(uParam0->f_5188), &(uParam0->f_5239), &(uParam0->f_5249), &(uParam0->f_5265), &(uParam0->f_5286), iParam1);
}
...
void func_144(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	func_415(&(uParam0->f_5310), bParam1, sParam2, bParam3);
}
...
{
	func_417(&(uParam0->f_7375), fParam1);
}
...
void func_150(var uParam0, bool bParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	func_384(uParam0, bParam1, sParam2, iParam3, iParam4, bParam5, 0);
	func_373(&(uParam0->f_10792), bParam1, sParam2, bParam6);
}
...
void func_155(var uParam0, bool bParam1)
{
	...
	{
		if (func_419(uParam0, func_35(uParam0), 0))
		{
	...
	if (func_8(uParam0, 8192))
	{
		...
		{
			if (func_420(&(uParam0->f_1126), func_33(uParam0)))
			{
	...
	bVar0 = false;
	if (func_419(uParam0, func_33(uParam0), 1))
	{
		bVar0 = true;
	}
	if (bVar0)
...
bool func_157(var uParam0)
{
	...
	{
		func_422(uParam0, func_127(uParam0, 3), !func_8(uParam0, 2097152), uParam0->f_5410, !func_8(uParam0, 32), 0);
...
{
	return uParam0->f_1[func_131(iParam1) /*22*/].f_10;
}
...
void func_164(var uParam0, bool bParam1, bool bParam2)
{
	...
	bVar0 = (ENTITY::IS_ENTITY_A_PED(bParam1) && func_432(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam1)));
	if (bVar0)
	{
		iVar1 = func_433(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam1));
	}
	if (ENTITY::IS_ENTITY_A_PED(bParam1))
	{
		...
		else if (func_435(uParam0, bParam1) && MAP::DOES_BLIP_EXIST(MAP::GET_BLIP_FROM_ENTITY(bParam1)))
		{
	...
	if (func_435(uParam0, bParam1))
	{
		func_437(uParam0, bParam1, 1024);
		if (bParam2)
		{
			func_438(uParam0, bParam1, 128);
		}
		else
		{
			func_437(uParam0, bParam1, 128);
		}
		if (func_439(uParam0, bParam1, &iVar3))
		{
			func_440(&(uParam0->f_5423[iVar3 /*65*/]));
		}
	}
	if (bVar0)
	{
...
void func_166(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_443(&(Global_1360165[iParam0 /*1157*/].f_12), 16))
		{
			func_444(iParam0, 16, 0);
		}
	}
	func_444(iParam0, 1, bParam1);
}

void func_167(bool bParam0, float fParam1)
{
	MISC::CLEAR_BIT(&(Global_1934765.f_301), 1);
	func_445(bParam0, fParam1);
}
...
void func_168(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		func_447(uParam0, iParam2);
		func_448(iParam2);
	}
	func_434(iParam1);
	func_449(iParam1, 0);
	func_450(iParam1, 0, bParam4, bParam5, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	if (bParam5)
	{
	}
}
...
void func_173(int* iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (bParam1)
	{
		func_452(iParam0, bParam2, bParam3);
	}
	else
	{
		func_453(iParam0);
...
void func_174()
{
	...
	while (iVar0 < 4)
	{
		...
		{
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_147[iVar0 /*8*/], GET_HASH_KEY("REL_GANG_DUTCHS"));
		}
		iVar0++;
	}
...
void func_175(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, bool bParam8)
{
	vector3 vVar0;
	vector3 vVar3;

	PED::CLEAR_PED_NON_CREATION_AREA();
	vVar0 = { func_454(vParam1, vParam4, iParam7) };
	vVar3 = { func_455(vParam1, vParam4, iParam7) };
...
void func_176(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_457(iParam0))
	{
		...
		if (bParam3)
		{
			func_458(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_194(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_266(Global_1898164.f_1[0 /*5*/]);
		if (func_267(iVar0) && func_295(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
{
	return func_485(func_484(iParam0));
}
...
bool func_210()
{
	return func_486(UIFEED::UI_FEED_GET_CURRENT_MESSAGE(3));
}
...
int func_213(int iParam0, int iParam1)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_488(iParam0, &(Global_40.f_11206[iParam0 /*26*/][iVar0 /*5*/]));
		}
		iVar0++;
	}
	return 1;
...
int func_218(var uParam0)
{
	...
	return (func_492() - BUILTIN::ROUND((uParam0->f_1 * 1000f)));
}
...
void func_220(var uParam0, vector3 vParam1, float fParam4)
{
	struct<4> Var0;

	Var0 = { vParam1 };
	Var0.f_3 = fParam4;
	func_494(uParam0, Var0);
}

int func_221(var uParam0, int iParam1)
{
	return uParam0->f_1[func_131(iParam1) /*22*/].f_9;
}

void func_222(int iParam0, struct<4> Param1, struct<4> Param5, int iParam9, int iParam10)
{
	char[] cVar0[8];
	...
	{
		cVar0 = func_110(func_495(iParam0));
		TELEMETRY::_TELEMETRY_MISSION_CHECKPOINT(&cVar0, 0, Global_1572864.f_9);
	}
	else if (func_192(iParam0) == 8)
	{
		cVar0 = func_497(func_496(iParam0));
		TELEMETRY::_TELEMETRY_MISSION_CHECKPOINT(&cVar0, 0, Global_1572864.f_9);
	}
	func_498(1, 1);
	func_499(1, Param1, Param1.f_3);
...
bool func_229()
{
	return func_501(SCRIPTS::GET_ID_OF_THIS_THREAD());
}
...
bool func_241(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_505(&(Global_1109400.f_4), iVar0, 5);
	}
	if (iParam1 == func_506())
	{
		return func_505(&(Global_1109400.f_4), iVar0, 5);
	...
	{
		return func_505(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
{
	if (func_507(uParam0, 1) || func_507(uParam0, 2))
	{
		return true;
	}
	return false;
...
int func_266(int iParam0)
{
	...
	return func_519(func_471(iParam0));
}
...
void func_269(int iParam0, bool bParam1)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(iVar0, func_521(iParam0)))
	{
		UILOG::_UILOG_REMOVE_ENTRY(iVar0, func_521(iParam0));
	}
	if (bParam1)
	{
		if (iVar0 == 1)
		{
			if (UILOG::_UILOG_IS_ENTRY_REGISTERED(2, func_521(iParam0)))
			{
				UILOG::_UILOG_REMOVE_ENTRY(2, func_521(iParam0));
			}
		}
	}
	func_522(iParam0, 4);
...
void func_271(int iParam0, bool bParam1)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(func_520(iParam0), func_521(iParam0)))
	{
		return;
	}
	if (bParam1)
	{
		UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_520(iParam0), func_521(iParam0), 2, "");
		func_523(iParam0, 16);
	}
	else
	{
		...
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_520(iParam0), func_521(iParam0), 1, "");
		}
		else
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_520(iParam0), func_521(iParam0), 0, "");
		}
		func_522(iParam0, 16);
	}
}
...
void func_287(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_533(Global_1310750[iVar0 /*111*/], iParam0))
		{
			if (!func_534(iVar0))
			{
				iVar1 = 1;
...
void func_289(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_538(iParam0, bParam3, BUILTIN::ROUND((fVar0 * fParam2)), BUILTIN::ROUND((fVar1 * fParam2)), BUILTIN::ROUND((fVar2 * fParam2)), BUILTIN::ROUND((fVar3 * fParam2)), bParam4, 1);
}
...
void func_293()
{
	...
	if (func_541(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1))
	{
		func_542(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1, 0);
	}
}
...
void func_294(int iParam0)
{
	...
	func_544(iParam0, (func_543(iParam0) + BUILTIN::SHIFT_LEFT(1, 16)));
}
...
void func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		case 67:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_ABIGAIL2X1_1"), iParam1);
			break;
		case 18:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_4"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_1"), iParam1);
			break;
		case 20:
			func_546(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_2"), iParam1);
			break;
		case 2:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_4"), iParam1);
			break;
		case 23:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_3"), iParam1);
			func_547(1);
			break;
		case 16:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_2_TXT"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_3_TXT"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_4"), iParam1);
			break;
		case 59:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_2"), iParam1);
			if (func_548(146))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_TREASURE2_JN"), iParam1);
			}
			func_547(1);
			break;
		case 76:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_FINALE2_1"), iParam1);
			if (func_549() == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9A"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_10B"), iParam1);
			}
			break;
		case 44:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4B"), iParam1);
			break;
		case 46:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_4"), iParam1);
			break;
		case 17:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_3"), iParam1);
			break;
		case 19:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_GT_GRAYS_2"), iParam1);
			break;
		case 21:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_2"), iParam1);
			func_547(0);
			break;
		case 15:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1B"), iParam1);
			break;
		case 33:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_4"), iParam1);
			break;
		case 34:
			func_546(GET_HASH_KEY("JOURNAL_GT_INDUSTRY_3"), iParam1);
			break;
		case 64:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_LARAMIE1_1"), iParam1);
			break;
		case 60:
			func_546(GET_HASH_KEY("JOURNAL_CHAP8_PRONGHORN"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_MARSTON1_2"), iParam1);
			break;
		case 73:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON6_1"), iParam1);
			break;
		case 74:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON7_1"), iParam1);
			if (func_549() == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_4A"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_5B"), iParam1);
			}
			break;
		case 8:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_3"), iParam1);
			break;
		case 36:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2"), iParam1);
			if (Global_1357515 == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2B"), iParam1);
			}
			break;
		case 27:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_4"), iParam1);
			break;
		case 28:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_4"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_GT_MOB_2"), iParam1);
			break;
		case 29:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_GT_MOB_3"), iParam1);
			break;
		case 31:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_4"), iParam1);
			break;
		case 4:
			func_546(GET_HASH_KEY("JOURNAL_CHAP2_HORSESHOE"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_5"), iParam1);
			func_547(0);
			break;
		case 6:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2"), iParam1);
			if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_A"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_B"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_C"), iParam1);
			}
			break;
		case 25:
			func_546(GET_HASH_KEY("JOURNAL_GT_MUDTOWN_3B"), iParam1);
			break;
		case 24:
			if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_5000"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_7500"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_10000"), iParam1);
			}
			break;
		case 48:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2A"), iParam1);
			}
			if (func_550(51))
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2B"), iParam1);
			}
			break;
		case 49:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_1"), iParam1);
			if (Global_1357515 == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2B"), iParam1);
			}
			else if (Global_1357515 == 2)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2C"), iParam1);
			}
			break;
		case 58:
			func_546(GET_HASH_KEY("JOURNAL_GT_NATIVE_3"), iParam1);
			break;
		case 50:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON1_1"), iParam1);
			break;
		case 52:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2B"), iParam1);
			if (bParam2 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A2"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3B"), iParam1);
			}
			break;
		case 32:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_ODRISCOLL4_1"), iParam1);
			break;
		case 47:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MARY4_1"), iParam1);
			break;
		case 69:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE2_1"), iParam1);
			if (func_321(Global_1347702[9 /*49*/].f_15, 1))
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_2B"), iParam1);
			}
			break;
		case 70:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE3"), iParam1);
			if (func_549() == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_7A"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8B"), iParam1);
			}
			break;
		case 71:
			if (func_549() == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8A"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9B"), iParam1);
			}
			break;
		case 37:
			func_546(GET_HASH_KEY("JOURNAL_GT_SAINT_DENIS_1"), iParam1);
			break;
		case 9:
			if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1B"), iParam1);
			}
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_2"), iParam1);
			break;
		case 13:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_3"), iParam1);
			break;
		case 53:
			func_546(GET_HASH_KEY("JOURNAL_GT_CORNWALL_1"), iParam1);
			break;
		case 54:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY1_1"), iParam1);
			break;
		case 56:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_3"), iParam1);
			break;
		case 57:
			func_546(GET_HASH_KEY("JOURNAL_GT_TRAIN_ROBBERY_4"), iParam1);
			break;
		case 22:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_2"), iParam1);
			break;
		case 12:
			func_546(GET_HASH_KEY("JOURNAL_GT_UTOPIA_2"), iParam1);
			break;
		case 0:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_5"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_6"), iParam1);
			break;
		case 1:
			func_547(1);
			break;
		case 3:
			if (func_332())
			{
				...
				{
					func_546(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE"), iParam1);
				}
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE")))
			{
				func_546(GET_HASH_KEY("JOURNAL_GT_WINTER_4"), iParam1);
			}
			break;
		default:
			break;
...
void func_299(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	{
		case 0:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_4"), iParam1);
			break;
		case 1:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL2X2_1"), iParam1);
			break;
		case 2:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL3_1"), iParam1);
			break;
		case 9:
			func_546(GET_HASH_KEY("JOURNAL_CHAP9_BEECHERSHOPE"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_BEECHERS1X3_1"), iParam1);
			if (func_321(Global_1835011[69 /*74*/].f_1, 1))
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1A"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1B"), iParam1);
			}
			break;
		case 22:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_CALDERON1X1_1"), iParam1);
			break;
		case 26:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_JN"), iParam1);
			}
			break;
		case 29:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_2_AR"), iParam1);
			}
			else if (func_548(26))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B1"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B2"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_A"), iParam1);
			}
			break;
		case 32:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_AR"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_AR"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_AR"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_AR"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_AR"), iParam1);
				}
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2_JN"), iParam1);
				if (Global_1357515 == -1)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_JN"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_JN"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_JN"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_JN"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_JN"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_JN"), iParam1);
				}
			}
			break;
		case 35:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_JN"), iParam1);
			}
			break;
		case 36:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_JN"), iParam1);
			}
			break;
		case 37:
			func_546(GET_HASH_KEY("JOURNAL_GT_COACH_ROB_RSC"), iParam1);
			break;
		case 53:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT1_2_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN_B"), iParam1);
			}
			break;
		case 54:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_JN"), iParam1);
			}
			break;
		case 55:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1_AR"), iParam1);
			}
			else if (func_548(54))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1A_JN"), iParam1);
			}
			break;
		case 38:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CIG1_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_CIG1_1_JN"), iParam1);
			}
			break;
		case 39:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_DINO1_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_DINO1_1_JN"), iParam1);
			}
			break;
		case 40:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_DINO2_1_AR"), iParam1);
			}
			else if (func_548(39))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_DINO2_1_B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_DINO2_1_A_JN"), iParam1);
			}
			break;
		case 43:
			if (bParam3 == 1)
			{
				if (func_355(Global_1835011[33 /*74*/].f_1) == 1)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1B_AR_A"), iParam1);
				}
				else
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1A_AR_A"), iParam1);
				}
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1_JN"), iParam1);
			}
			break;
		case 45:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_AR_A"), iParam1);
			}
			else if (func_548(43))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_B"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_A"), iParam1);
			}
			break;
		case 41:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FISH1_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FISH1_1_JN"), iParam1);
			}
			break;
		case 42:
			if (func_548(41))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_B"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_A"), iParam1);
			}
			break;
		case 49:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_JN"), iParam1);
			}
			break;
		case 50:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_AR"), iParam1);
			}
			else if (func_548(49))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B2"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_A"), iParam1);
			}
			break;
		case 51:
			func_546(GET_HASH_KEY("JOURNAL_RC_TAX1_1_JN"), iParam1);
			break;
		case 58:
			if (func_321(Global_1347702[23 /*49*/].f_15, 1))
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1B"), iParam1);
			}
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_3"), iParam1);
			break;
		case 59:
			func_546(GET_HASH_KEY("JOURNAL_CHAP2_DOWNES1_1"), iParam1);
			break;
		case 62:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DOWNES2_1"), iParam1);
			break;
		case 63:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ODRISCOLL2_2B"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_GT_ODRISCOLL_2"), iParam1);
			break;
		case 65:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_3"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_4"), iParam1);
			break;
		case 66:
			func_546(GET_HASH_KEY("JOURNAL_CHAP3_CLEMENS"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_3"), iParam1);
			func_547(1);
			break;
		case 67:
			func_546(GET_HASH_KEY("JOURNAL_CHAP4_SHADYBELLE"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_2"), iParam1);
			break;
		case 68:
			func_546(GET_HASH_KEY("JOURNAL_CHAP6_BEAVERHOLLOW"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2B"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_3"), iParam1);
			func_547(0);
			break;
		case 70:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_EDITHDOWNE2_1"), iParam1);
			break;
		case 71:
			func_546(GET_HASH_KEY("JOURNAL_RC_MILLER1_JN"), iParam1);
			break;
		case 73:
			func_546(GET_HASH_KEY("JOURNAL_RC_MILLER3_JN"), iParam1);
			break;
		case 75:
			func_546(GET_HASH_KEY("JOURNAL_RC_MILLER4_JN"), iParam1);
			break;
		case 77:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA1_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA1_1_JN"), iParam1);
			}
			break;
		case 79:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA3_1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA3_2_AR"), iParam1);
			}
			else if (func_548(78))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA3_2_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA3_1_JN"), iParam1);
			}
			break;
		case 80:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA4_1_AR"), iParam1);
			}
			else if (func_548(79))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA4_2_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_FMA4_1_JN"), iParam1);
			}
			break;
		case 85:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_JN"), iParam1);
			}
			break;
		case 86:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_JN"), iParam1);
			}
			break;
		case 87:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_JN"), iParam1);
			}
			break;
		case 88:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_JN"), iParam1);
			}
			break;
		case 89:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK1_JN"), iParam1);
			}
			break;
		case 92:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK4_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK4B_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK4_A_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK4_A2_JN"), iParam1);
			}
			break;
		case 93:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK5_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_HKK5_JN"), iParam1);
			}
			break;
		case 94:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2A"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2B"), iParam1);
			}
			func_546(GET_HASH_KEY("JOURNAL_GT_HOME_ROB"), iParam1);
			break;
		case 99:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3X1_1"), iParam1);
			break;
		case 101:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON1_1_AR"), iParam1);
				if (Global_1357515 == -1)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_B"), iParam1);
				}
				else
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_A"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON1_1B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON1_1A_JN"), iParam1);
			}
			break;
		case 102:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON2_1_AR"), iParam1);
			}
			else if (func_548(101))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON2_1B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON2_1A_JN"), iParam1);
			}
			break;
		case 103:
			func_546(GET_HASH_KEY("JOURNAL_RC_MASON3_1_AR"), iParam1);
			break;
		case 104:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON4_1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON4_2_AR"), iParam1);
			}
			else if (func_548(103))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON4_1B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON4_1A_JN"), iParam1);
			}
			break;
		case 105:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON5_1_AR"), iParam1);
			}
			else if (func_548(104))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON5_1B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MASON5_1A_JN"), iParam1);
			}
			break;
		case 108:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MONROE_1"), iParam1);
			break;
		case 109:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR_B"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR1_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR1B_JN"), iParam1);
			}
			break;
		case 110:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR2_AR"), iParam1);
			}
			else if (func_548(109))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR2B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR2A_JN"), iParam1);
			}
			break;
		case 111:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 0)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_AR"), iParam1);
				}
				else
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_AR"), iParam1);
				}
			}
			else if (func_548(110))
			{
				if (Global_1357515 == 0)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3C_JN"), iParam1);
				}
				else
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_JN"), iParam1);
					func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_2_JN"), iParam1);
				}
			}
			else if (Global_1357515 == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_2_JN"), iParam1);
			}
			break;
		case 115:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_1"), iParam1);
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_2"), iParam1);
			break;
		case 143:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ODDF1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ODDF1_JN"), iParam1);
			}
			break;
		case 144:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ODDF2_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_ODDF2_JN"), iParam1);
			}
			break;
		case 117:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO1_2_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_JN"), iParam1);
			}
			break;
		case 118:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1_AR"), iParam1);
			}
			else if (func_548(117))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1A_JN"), iParam1);
			}
			break;
		case 119:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO3_1_AR"), iParam1);
			}
			else if (func_548(118))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2A_JN"), iParam1);
			}
			break;
		case 121:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW1_JN"), iParam1);
			}
			break;
		case 122:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW3_AR"), iParam1);
			}
			else if (func_548(121))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW3B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW3A_JN"), iParam1);
			}
			break;
		case 124:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW4_AR"), iParam1);
			}
			else if (func_548(122))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW4B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW4A_JN"), iParam1);
			}
			break;
		case 125:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW5_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_PW5B_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_PW5_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_PW5B_JN"), iParam1);
			}
			break;
		case 127:
			func_546(GET_HASH_KEY("JOURNAL_RC_RTL1_AR"), iParam1);
			break;
		case 129:
			func_546(GET_HASH_KEY("JOURNAL_RC_RTL3_AR"), iParam1);
			break;
		case 131:
			func_546(GET_HASH_KEY("JOURNAL_RC_RTL5_AR"), iParam1);
			break;
		case 133:
			func_546(GET_HASH_KEY("JOURNAL_RC_RTL7_AR"), iParam1);
			break;
		case 134:
			func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_SADIE1_1"), iParam1);
			break;
		case 135:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_KILLER4A_AR"), iParam1);
				}
				else
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_KILLER4B_AR"), iParam1);
				}
			}
			else if ((HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER1_AR")) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER2_AR"))) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER3_AR")))
			{
				if (Global_1357515 == -1)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_KILLER4A_JN"), iParam1);
				}
				else
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_KILLER4B_JN"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_KILLER4C_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_KILLER4D_JN"), iParam1);
			}
			break;
		case 136:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC1_JN"), iParam1);
			}
			break;
		case 137:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC2_AR"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC3A_AR"), iParam1);
			}
			else if (func_548(136))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC2B_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC3C_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC2A_JN"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_RC_SLVC3A_JN"), iParam1);
			}
			break;
		case 142:
			if (bParam2 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3A"), iParam1);
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3B"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3C"), iParam1);
			}
			break;
		case 146:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 1)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_546(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_AR"), iParam1);
				}
			}
			else if (Global_1357515 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_JN"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_JN"), iParam1);
			}
			break;
		case 147:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET1_AR"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET1_JN"), iParam1);
			}
			break;
		case 148:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET2_AR"), iParam1);
			}
			else if (func_548(147))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET2B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET2A_JN"), iParam1);
			}
			break;
		case 149:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET3_AR"), iParam1);
			}
			else if (func_548(148))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET3B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET3A_JN"), iParam1);
			}
			break;
		case 150:
			if (bParam3 == 1)
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET4_AR"), iParam1);
			}
			else if (func_548(149))
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET4B_JN"), iParam1);
			}
			else
			{
				func_546(GET_HASH_KEY("JOURNAL_RC_WARVET4A_JN"), iParam1);
			}
			break;
		default:
			break;
	...
	switch (iVar0)
	{
		case 1:
			...
			switch (iVar1)
			{
				...
				case 9:
					if (func_355(Global_1835011[9 /*74*/].f_1) == 0)
					{
		...
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == 176656832)
		{
			...
			if (func_554(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_555(&(Global_40.f_4283.f_6[iVar4 /*5*/]), 1, 0);
					}
					iVar4++;
				}
			}
...
int func_309(int iParam0)
{
	...
	return func_563(func_471(iParam0));
}
...
bool func_312(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_569(iParam0, 0, 0) == 0)
	{
		if (func_570(iParam0))
		{
			...
			{
				func_312(func_577(iVar6), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				if (func_391() && func_578(4))
				{
					if (func_391() && (func_579(38) || func_575(38)))
					{
			...
			if (func_391() && func_578(4))
			{
				if (!Global_1914319.f_17376)
				{
					if (func_391() && (func_579(38) || func_575(38)))
					{
						func_583(38, COLLECTION::_0x13AAECDA43318BFE(-2076669067, iVar6), COLLECTION::_0xD52D20B0C76BB26D(-2076669067, iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
						func_583(38, MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_COLLECTABLE_CIGCARD"), iVar7, 12, 0, iVar6);
					}
				}
			}
		}
	}
	if (func_584(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_584(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_584(iParam0) == GET_HASH_KEY("AMMO") && func_597(iParam0))
		{
		...
		{
			func_95(func_601(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_95(func_602(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_585(iParam0, 589988438))
		{
			if (func_604())
			{
				func_605(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		else if (func_585(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_341(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_341(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_341(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_617(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_618(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_617(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_624(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_625(499813453, 0);
				func_626(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_624(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_625(499813453, 0);
				func_626(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_624(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_625(499813453, 0);
				func_626(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_624(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_625(666607663, 0);
				func_627(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_624(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_625(666607663, 0);
				func_627(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_624(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_625(666607663, 0);
				func_627(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_624(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_625(-220219788, 0);
				func_628(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_624(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_625(-220219788, 0);
				func_628(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_624(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_625(-220219788, 0);
				func_628(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_624(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_625(218622660, 0);
				func_629(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_624(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_625(218622660, 0);
				func_629(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_624(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_625(390004462, 0);
				func_630(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_624(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_625(390004462, 0);
				func_630(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_624(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_625(390004462, 0);
				func_630(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_624(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_625(6410548, 0);
				func_631(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_624(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_625(6410548, 0);
				func_631(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_624(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_625(6410548, 0);
				func_631(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_624(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_625(6410548, 0);
				func_631(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_633(242, func_632(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_633(240, func_632(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_633(241, func_632(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
				...
				{
					func_634(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_634(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_634(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_634(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_634(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_634(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    ...
    " Cores." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX"):
				...
				{
					func_312(func_635(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				else
				{
					func_312(func_636(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				break;
...
void func_315(int iParam0)
{
	...
	func_665(GET_HASH_KEY("MPC_SP_DEFAULT_INTER_OUTFIT_TYPES"));
	iVar1 = 0;
	while (iVar1 < 39)
	{
	...
	Global_1946804.f_1616.f_1[8 /*3*/] = { func_668(8, 0) };
	Global_1946804.f_1616.f_1[9 /*3*/] = { func_668(9, 0) };
	Global_1946804.f_1616.f_1[0 /*3*/] = { func_668(0, 0) };
	Global_1946804.f_1616.f_1[2 /*3*/] = { func_668(2, 0) };
	Global_1946804.f_1616.f_1[3 /*3*/] = { func_668(3, 0) };
	Global_1946804.f_1616.f_1[1 /*3*/] = { func_668(1, 0) };
	Global_1946804.f_1616.f_1[5 /*3*/] = { func_668(5, 0) };
	Global_1946804.f_1616.f_1[6 /*3*/] = { func_668(6, 0) };
	Global_1946804.f_1616.f_1[7 /*3*/] = { func_668(7, 0) };
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (bVar7)
		{
			...
			while (iVar8 < 39)
			{
				...
				{
					func_670(&(Global_1946804.f_1616.f_1[iVar8 /*3*/]), iVar8, iVar0);
				}
				else
				{
					iVar8++;
...
char* func_318(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_321(Global_1835011[59 /*74*/].f_1, 1) || func_321(Global_1347702[1 /*49*/].f_15, 1)) || func_188(Global_1347702[1 /*49*/].f_15))
			{
				return "COMP_RUFUS";
			}
			else if (func_541(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
void func_320(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_674(&(Global_1946804.f_1497.f_1[iVar0 /*3*/]), 2, 6);
	func_674(&(Global_1946804.f_1378.f_1[iVar0 /*3*/]), 2, 6);
	if (bParam1)
	{
	...
	if (func_20() == -1)
	{
		...
		while (iVar1 < 5)
		{
			func_674(&(Global_26796.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
	...
	else
	{
		...
		while (iVar1 < 5)
		{
			func_674(&(Global_36638.f_45.f_350.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
...
bool func_327(int iParam0, int iParam1)
{
	...
	return func_682(&(Global_40.f_9910[iParam1 /*6*/]), 4);
}
...
void func_329(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		func_693(&(Global_40.f_9910[iVar0 /*6*/]), 2);
	}
...
void func_342(int iParam0)
{
	...
	if (iParam0 < 0)
	{
		func_695(MISC::VAR_STRING(2, "MISSION_COMPLETE_BANK_FEED", MISC::ABSI(iParam0)), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
		Global_1879514.f_14 = 1;
		Global_1879514.f_15 = 0;
	}
	else
	{
		func_695(MISC::VAR_STRING(2, "MISSION_COMPLETE_LOAN_FEED", iParam0), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Negative", 0, 1);
...
void func_352(int iParam0)
{
	...
	func_225(&Global_1935630, 8192);
	iVar2 = 1;
	switch (func_192(iParam0))
	{
		case 1:
			func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
			iVar0 = func_266(iParam0);
			func_95(func_94(GET_HASH_KEY("MISSIONS_PROGRESSED")), 1);
			switch (func_474(iVar0))
			{
				case 0:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP1")), 1);
					break;
				case 1:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP2")), 1);
					break;
				case 2:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP3")), 1);
					break;
				case 3:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP4")), 1);
					break;
				case 4:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP5")), 1);
					break;
				case 5:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP6")), 1);
					break;
				case 6:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP7")), 1);
					break;
				case 7:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP8")), 1);
					break;
				case 8:
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP9")), 1);
					break;
				default:
					iVar2 = 0;
					break;
			...
			if (iVar0 == 7)
			{
				func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
			}
			if (iVar2 && MISSIONDATA::MISSIONDATA_IS_REQUIRED_STORY_MISSION(MISC::GET_HASH_KEY(&(Global_1835011[iVar0 /*74*/].f_8))))
			{
				func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("REQUIRED_MISSIONS")), 1);
			}
			break;
		case 8:
			iVar1 = func_266(iParam0);
			...
			if (func_295(Global_1347702[iVar1 /*49*/].f_12, 4) || iVar1 == 59)
			{
				if (func_295(Global_1347702[iVar1 /*49*/].f_12, 1))
				{
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
				...
				{
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC")), 1);
				}
			}
			if (func_295(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
			...
			else if (func_295(Global_1347702[iVar1 /*49*/].f_12, 4))
			{
				if (func_295(Global_1347702[iVar1 /*49*/].f_12, 4194304))
				{
				}
				else if (!func_295(Global_1347702[iVar1 /*49*/].f_12, 512))
				{
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS")), 1);
				}
				else
				{
					func_95(func_602(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
...
void func_353()
{
	...
	else if ((func_194(0, 0, 1) || func_700()) || func_128())
	{
		return;
	}
	iVar0 = func_198();
	...
	if (iVar1 == 1)
	{
		func_702(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_SINGLE", 1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	else if (iVar1 > 1)
	{
		func_702(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_PLURAL", iVar1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	if (iVar3 > 0)
	{
		func_703(iVar3, 0, 0);
...
int func_358(int iParam0)
{
	...
	{
		case 0:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 1:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 2:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 2;
		case 4:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 5:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		...
		case 12:
			return 75000;
		case 8:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 9:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 10:
			return func_713(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
...
char[] func_359(int iParam0)
{
	...
	{
		case 1:
			cVar0 = Global_1835011[func_495(iParam0) /*74*/].f_8;
			break;
		case 8:
			cVar0 = Global_1347702[func_266(iParam0) /*49*/].f_3;
			break;
		case 11:
			if (iParam0 == func_357(0, 10, 11, GET_HASH_KEY("CABR01")))
			{
...
void func_360(char[4] cParam0)
{
	...
	if (!Global_1879514.f_11)
	{
		...
		if (MISSIONDATA::MISSIONDATA_GET_RATING(iVar1) != 5 && iVar0 == 5)
		{
			...
			else if (func_192(Global_1879514.f_1) == 8 && (func_295(Global_1347702[func_266(Global_1879514.f_1) /*49*/].f_12, 1) || func_295(Global_1347702[func_266(Global_1879514.f_1) /*49*/].f_12, 33554432)))
			{
				func_356(5, 1);
			}
		}
...
void func_368(struct<16> Param0, int iParam16)
{
	...
	{
		if (SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&(Param0.f_10))) > 0 || func_723(&(Param0.f_10)))
		{
			return;
		}
	}
...
void func_372(bool bParam0)
{
	...
	if (func_486(Global_1935630.f_3))
	{
		return;
	}
	iVar0 = 1;
	...
	Var1.f_3 = func_725();
	Var1.f_3.f_3 = iVar0;
	if ((!func_726(Global_1347343.f_2) && !func_369(Global_1347343.f_11, 64)) || func_82(32768))
	{
		Var1.f_7 = func_727();
		Var1.f_7.f_3 = iVar0;
	}
	...
	func_370(&(Global_1347343.f_11), 1073741824 /* Float: 2f */);
	if (bParam0)
	{
...
void func_373(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	int iVar0;
	struct<11> Var1;
	...
	func_732(uParam0);
	iVar0 = func_733(uParam0, bParam1);
	if (bParam3)
	{
		if (MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			sParam2 = func_734(bParam1);
		}
...
{
	func_738(&(uParam0->f_7375), iParam1);
}
...
{
	func_746(uParam0, iLocal_65, iLocal_66, 111104, 111651, 111821, 111966, 112006, "MOB5_INT", 66, -1);
	func_746(uParam0, iLocal_66, iLocal_67, 112157, 112916, 112943, 113092, 115202, "", 64, -1);
	func_746(uParam0, iLocal_67, iLocal_68, 115232, 116171, 116198, 116222, 117214, "", 64, -1);
	func_746(uParam0, iLocal_68, iLocal_69, 117348, 118353, 118406, 118838, 120034, "", 64, -1);
	func_746(uParam0, iLocal_69, iLocal_70, 120153, 120542, 121641, 121770, 126804, "", 64, 35);
	func_746(uParam0, iLocal_70, iLocal_71, 126827, 127575, 127625, 128049, 129858, "", 64, 35);
	func_746(uParam0, iLocal_71, iLocal_72, 129926, 130595, 130929, 131425, 134635, "", 64, -1);
	func_746(uParam0, iLocal_72, iLocal_73, 134841, 135584, 135957, 136139, 137785, "", 8, -1);
	func_746(uParam0, iLocal_73, iLocal_74, 137903, 138543, 138562, 139511, 141435, "", 8, -1);
	func_746(uParam0, iLocal_74, iLocal_75, 141503, 142200, 142219, 142271, 143229, "", 8, -1);
	func_746(uParam0, iLocal_75, 26, 143348, 143724, 143836, 143924, 143999, "MOB5_EXT", 82, -1);
}
...
bool func_381(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < ITEMSET::GET_ITEMSET_SIZE(Global_43616))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(bVar1))
		{
			if (!DECORATOR::DECOR_EXIST_ON(ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar0, Global_43616), func_797()) && ENTITY::GET_ENTITY_MODEL(bVar1) == iParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(bVar1))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar1, true, true);
...
int func_382(var uParam0, int iParam1, bool bParam2)
{
	...
	bVar0 = func_381(uParam0, iParam1, bParam2);
	if (ENTITY::DOES_ENTITY_EXIST(bVar0) && ENTITY::IS_ENTITY_A_PED(bVar0))
	{
		return ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bVar0);
	}
	return 0;
}
...
{
	func_150(uParam0, vLocal_670.x, "CreoleCaptain", 0, 0, 0, 0);
	func_144(uParam0, vLocal_670.x, "SKIFF_CAPTN", 0);
	PED::SET_PED_NAME_DEBUG(vLocal_670.x, "CAPTAIN");
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(vLocal_670.x, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(vLocal_670.x, GET_HASH_KEY("REL_PLAYER_ALLY"));
	PED::_0xD05AD61F242C626B(vLocal_670.x, 0f);
	vLocal_670.f_2 = -1;
}

void func_384(var uParam0, bool bParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	func_798(&(uParam0->f_7375), bParam1, sParam2, iParam3, iParam4, bParam5);
	func_373(&(uParam0->f_10792), bParam1, sParam2, bParam6);
}

void func_385(var uParam0, int iParam1)
{
	func_799(&(uParam0->f_7375.f_860), iParam1);
}
...
void func_407(var uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_828(&(uParam0->f_638), iParam1);
	if (iVar0 == -1)
	{
		iVar0 = func_829(&(uParam0->f_638));
	}
	if (iVar0 == -1)
	{
		return;
...
void func_408(var uParam0, char[4] cParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	...
	iVar0 = func_830(&(uParam0->f_819), cParam1);
	if (iVar0 == -1)
	{
		iVar0 = func_831(&(uParam0->f_819));
	}
	if (iVar0 == -1)
	{
		return;
...
void func_409(var uParam0, char[4] cParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, bool bParam7)
{
	int iVar0;

	if (!func_832(iParam3, func_33(uParam0)) && !func_832(iParam3, func_35(uParam0)))
	{
		return;
	}
	...
	iVar0 = func_833(&(uParam0->f_1126), cParam1, *uParam2);
	if (iVar0 == -1)
	{
		iVar0 = func_834(&(uParam0->f_1126));
	}
	if (iVar0 == -1)
	{
		return;
	...
	if (!bParam7)
	{
		func_835(&(uParam0->f_1126[iVar0 /*67*/].f_2), 4);
	}
}

void func_410(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	...
	iVar0 = func_836(&(uParam0->f_1126), iParam1);
	if (iVar0 == -1)
	{
		return;
	}
...
void func_411(var uParam0, char[4] cParam1, int iParam2)
{
	...
	iVar0 = func_837(&(uParam0->f_1020), cParam1);
	if (iVar0 == -1)
	{
		iVar0 = func_838(&(uParam0->f_1020));
	}
	if (iVar0 == -1)
	{
		return;
...
void func_412(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_839(&(uParam0->f_5188), iParam1);
	if (iVar0 == -1)
	{
		iVar0 = func_840(&(uParam0->f_5188));
	}
	if (iVar0 == -1)
	{
		return;
...
void func_414(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam0)
	{
		if (func_842(uParam0[iVar0 /*3*/]))
		{
			if (func_832((uParam0[iVar0 /*3*/])->f_2, iParam12))
			{
	...
	while (iVar0 < *uParam1)
	{
		if (func_844(uParam1[iVar0 /*5*/]))
		{
			if (func_832((uParam1[iVar0 /*5*/])->f_4, iParam12))
			{
				func_845(uParam1[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_846(uParam2[iVar0 /*3*/]))
		{
			if (func_832((uParam2[iVar0 /*3*/])->f_2, iParam12))
			{
				func_847(uParam2[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_848(uParam3[iVar0 /*3*/]))
		{
			if (func_832((uParam3[iVar0 /*3*/])->f_2, iParam12))
			{
				func_849(uParam3[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_851(uParam5[iVar0 /*67*/]))
		{
			if (func_832((uParam5[iVar0 /*67*/])->f_3, iParam12))
			{
				func_852(uParam5[iVar0 /*67*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_851(uParam5[iVar0 /*67*/]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_853(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/])))
				{
					if (func_832((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/].f_2, iParam12))
					{
						func_854(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/]), (uParam5[iVar0 /*67*/])->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_855(uParam6[iVar0 /*4*/]))
		{
			if (func_832((uParam6[iVar0 /*4*/])->f_3, iParam12))
			{
				func_856(uParam6[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_857(uParam7[iVar0 /*5*/]))
		{
			if (func_832((uParam7[iVar0 /*5*/])->f_4, iParam12))
			{
				func_858(uParam7[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_859(uParam8[iVar0 /*3*/]))
		{
			if (func_832((uParam8[iVar0 /*3*/])->f_2, iParam12))
			{
				func_860(uParam8[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_861(uParam9[iVar0 /*3*/]))
		{
			if (func_832((uParam9[iVar0 /*3*/])->f_2, iParam12))
			{
				func_862(uParam9[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_863(uParam10[iVar0 /*4*/]))
		{
			if (func_832((uParam10[iVar0 /*4*/])->f_3, iParam12))
			{
				func_864(uParam10[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_865(uParam11[iVar0 /*3*/]))
		{
			if (func_832((uParam11[iVar0 /*3*/])->f_2, iParam12))
			{
				func_866(uParam11[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
...
void func_415(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam1))
	{
		return;
	...
	if (func_867(uParam0, bParam1, sParam2))
	{
...
bool func_419(var uParam0, int iParam1, bool bParam2)
{
	int iVar0;
	char[] cVar1[8];
	...
	if (bParam2 && func_23(&(uParam0->f_8269)))
	{
		...
		{
			MemCopy(&cVar1, {func_868(uParam0->f_607)}, 3);
			if (func_869(&(uParam0->f_8269), &cVar1, 0, func_131(iParam1), 1, 0))
			{
				if (func_24(&(uParam0->f_8269)))
				{
					func_870(&(uParam0->f_8269));
				}
	...
	if (!func_871(&(uParam0->f_638), &(uParam0->f_819), &(uParam0->f_1020), &(uParam0->f_1081), &(uParam0->f_1124), &(uParam0->f_1126), &(uParam0->f_5147), &(uParam0->f_5188), &(uParam0->f_5239), &(uParam0->f_5249), &(uParam0->f_5265), &(uParam0->f_5286), iParam1))
	{
		iVar0 = 0;
	}
	return iVar0;
...
bool func_420(var uParam0, int iParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_851(uParam0[iVar0 /*67*/]))
		{
			if (func_832((uParam0[iVar0 /*67*/])->f_3, iParam1))
			{
				if ((uParam0[iVar0 /*67*/])->f_65 > 0f || func_872((uParam0[iVar0 /*67*/])->f_2, 4))
				{
					if (!func_873(uParam0[iVar0 /*67*/]))
					{
						iVar1 = 0;
					}
				}
...
bool func_422(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = func_874(func_61(uParam0));
	if (!func_29())
	{
...
bool func_423(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8)
{
			...
			else
			{
				...
				if (iVar11 != 0)
				{
					...
					if (iVar11 == 2 && !ENTITY::IS_ENTITY_DEAD(bVar12))
					{
						...
						else if (func_878(bVar12, uParam0->f_5411, 5f, 1))
						{
							if (func_879(bVar12))
							{
							...
							ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bVar12, uParam0->f_5417, uParam0->f_5420, true, false, true);
						}
					}
				}
			}
	...
	if (func_20() == 0)
	{
		STREAMING::REQUEST_MODEL(func_880(uParam0), false);
		if (!STREAMING::HAS_MODEL_LOADED(func_880(uParam0)))
		{
			return false;
		}
		if (func_881(&iVar17, func_880(uParam0), vVar14, 0f, 0, 0, 1, 1, 1))
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar13))
	{
		...
		if (!func_120(uParam0, 256))
		{
			if (!func_120(uParam0, 32768))
			{
				...
				vVar14.f_1 = uParam3;
				vVar14.f_2 = uParam4;
				if ((!func_879(bVar13) || func_883(Global_35, bVar13, 1, 1) > 200f) && !func_392(vVar14))
				{
					if (!func_29())
					{
						ENTITY::FREEZE_ENTITY_POSITION(bVar13, false);
						func_884(bVar13, vVar14, fParam5, 2, 1073741824 /* Float: 2f */);
					}
				}
			}
		}
...
void func_424(var uParam0)
{
	...
	{
		if (func_885(uParam0->f_607, &iVar0, &uVar1))
		{
...
bool func_427(var uParam0)
{
	...
	if (!func_422(uParam0, func_127(uParam0, 3), !func_8(uParam0, 2097152), uParam0->f_5410, !func_8(uParam0, 32), 0))
	{
		iVar0 = 0;
	}
	...
	{
		MemCopy(&cVar1, {func_868(uParam0->f_607)}, 3);
		if (func_892(&(uParam0->f_8269), &cVar1, 0, 1, 1))
		{
		}
		else
		{
	...
	if (func_127(uParam0, 1))
	{
		...
		if (func_893(&(uParam0->f_13115)) < 30f)
		{
...
bool func_428(var uParam0)
{
	...
	if (func_893(&(uParam0->f_603)) >= uParam0->f_13144)
	{
		bVar0 = true;
	}
	if (bVar0)
	{
		...
		if ((func_82(32768) && func_894()) && func_893(&(uParam0->f_603)) < (uParam0->f_13144 + 10f))
		{
			return false;
		}
		if (func_120(uParam0, 8) && INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_AT_COORDS(func_125(uParam0->f_607))))
		{
			INTERIOR::UNPIN_INTERIOR(INTERIOR::GET_INTERIOR_AT_COORDS(func_125(uParam0->f_607)));
			func_259(uParam0, 8);
		}
		CLOCK::_SET_MILLISECONDS_PER_GAME_MINUTE(2000);
		func_895(0, 0);
...
bool func_429(var uParam0)
{
	...
	Local_147[0 /*8*/] = func_158(uParam0);
	if (!func_896(uParam0))
	{
		return false;
	}
	func_897(uParam0);
	if (func_33(uParam0) == iLocal_65)
	{
		func_898();
	}
	func_144(uParam0, Global_35, "ARTHUR", 0);
	func_144(uParam0, Local_147[0 /*8*/], "DUTCH", 0);
	func_144(uParam0, Local_147[1 /*8*/], "JOHN", 0);
	func_144(uParam0, Local_147[2 /*8*/], "BILL", 0);
	func_144(uParam0, Local_147[3 /*8*/], "LENNY", 0);
	func_900(uParam0, 157840);
	func_902(uParam0, 158646);
	func_904(uParam0, 160323);
	func_905();
	iLocal_725[0] = func_906(2299.886f, -1239.479f, 43.0673f, 2403.525f, -1193.342f, 66.8316f, 2352.407f, -1216.493f, 44.99017f, 50f, 0, 0);
	func_176(-777462925, 1, 0f, 0, 0, 0, 1, 0);
	func_176(1291327218, 1, 0f, 0, 0, 0, 1, 0);
	func_176(1587886668, 1, 0f, 0, 0, 0, 1, 0);
	func_176(-3733011, 1, 0f, 0, 0, 0, 1, 0);
	func_176(913143609, 1, 0f, 0, 0, 0, 1, 0);
	func_176(-1382886115, 1, 0f, 0, 0, 0, 1, 0);
	func_176(-1092323392, 1, 0f, 0, 0, 0, 1, 0);
	func_176(-516807739, 1, 0f, 0, 0, 0, 1, 0);
	func_176(-777091906, 1, 0f, 0, 0, 0, 1, 0);
	func_176(-2126919475, 1, 0f, 0, 0, 0, 1, 0);
	func_907();
	func_908();
	if (func_33(uParam0) == iLocal_65)
	{
		MISC::SET_WEATHER_TYPE(GET_HASH_KEY("FOG"), false, true, true, 5f, false);
	}
	else if (func_33(uParam0) < iLocal_71)
	{
		MISC::SET_WEATHER_TYPE(GET_HASH_KEY("FOG"), false, true, true, 0f, false);
		CLOCK::SET_CLOCK_TIME(3, 0, 0);
		CLOCK::PAUSE_CLOCK(true, 0);
		func_413(&iLocal_105, 8);
	}
	else
	{
	...
	ENTITY::CREATE_MODEL_HIDE(2367.458f, -1212.529f, 50.771f, 1f, GET_HASH_KEY("P_FIREGUARD01X"), false);
	ENTITY::CREATE_MODEL_HIDE(2375.943f, -1213.643f, 46.1594f, 1f, GET_HASH_KEY("P_POT_FLOWERARNG23X"), false);
	func_178(945612176, 1, 0);
	iLocal_819 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(2379.172f, -1215.674f, 50.7572f, GET_HASH_KEY("NEW_MAN_BRONTE"));
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_809, 2343.826f, -1216.345f, 43.49457f, 0f, 0f, 0f, 34f, 28f, 10f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_809, 2350.338f, -1230.956f, 43.49457f, 0f, 0f, 0f, 21f, 5f, 10f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_809, 2350.338f, -1201.394f, 43.49457f, 0f, 0f, 0f, 21f, 5f, 10f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_810[0], 2325.555f, -1211.195f, 43.49457f, 0f, 0f, 0f, 11f, 2.5f, 5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_810[0], 2326.659f, -1211.818f, 43.49457f, 0f, 0f, 0f, 5f, 3.5f, 5f);
	iLocal_810[1] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("DANGER ZONE 2");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_810[1], 2325.555f, -1221.491f, 43.49457f, 0f, 0f, 0f, 11f, 2.5f, 5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_810[1], 2326.659f, -1220.792f, 43.49457f, 0f, 0f, 0f, 5f, 3.5f, 5f);
	POPULATION::_0xB56D41A694E42E86(iLocal_804, 57344, 0, 0, -1, -1, 0);
	TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(426813831, false);
	ENTITY::CREATE_MODEL_HIDE(2323.71f, -1212.88f, 45.28f, 0.5f, GET_HASH_KEY("P_POT_FLOWERARNG06X"), true);
	ENTITY::CREATE_MODEL_HIDE(2323.61f, -1219.59f, 45.28f, 0.5f, GET_HASH_KEY("P_POT_FLOWERARNG06X"), true);
	func_909(0.5f);
	iLocal_140 = func_910(2);
	return true;
}
...
bool func_431(var uParam0)
{
	...
	{
		case 0:
			if (func_920(uParam0, iVar0, 0))
			{
				if (func_921(uParam0, func_33(uParam0)) != -1 && PED::_0x62DE46F061CAA468() < func_921(uParam0, func_33(uParam0)))
				{
					PED::_0xF008E0BA1FE1D644((func_921(uParam0, func_33(uParam0)) - PED::_0x62DE46F061CAA468()));
				}
		...
		case 1:
			if (func_891(uParam0))
			{
				if (func_925(uParam0))
				{
					...
					func_924(uParam0, iVar0, 2);
				}
			}
			else if (func_926(uParam0) >= uParam0->f_13144)
			{
				if (func_8(uParam0, 4))
				{
					func_889(uParam0, 4);
			...
			break;
		case 2:
			if (func_920(uParam0, iVar0, 2))
			{
				if (!func_927(uParam0))
				{
					func_924(uParam0, iVar0, 4);
					if (func_928(uParam0, iVar0, iVar1))
					{
						func_924(uParam0, iVar0, 5);
					}
				}
				else
				{
					func_929(uParam0);
					func_924(uParam0, iVar0, 3);
		...
		case 5:
			if (!func_20() == 0)
			{
				...
				{
					if (func_936(uParam0, iVar1))
					{
						func_937(uParam0, iVar1);
					}
				}
			}
			if (func_920(uParam0, iVar0, 5))
			{
				if (func_920(uParam0, iVar0, 7))
				{
					if (!func_121(uParam0, func_33(uParam0), 67108864))
					{
						func_938(uParam0, func_33(uParam0));
					}
					func_939(uParam0, iVar1);
					func_912(uParam0);
					return true;
				}
				else
				{
					func_924(uParam0, iVar0, 7);
				}
			}
			else
			{
				...
				if ((func_941(PLAYER::GET_PLAYER_INDEX(), 0, 0, 1) && !func_120(uParam0, 8192)) && !func_121(uParam0, func_33(uParam0), 8))
				{
					func_47(1, 0);
					func_942("MISSION_WANTED", 7500, 0, 1, 0, 0, -1, -1, 0);
					if (func_943(uParam0))
					{
						func_924(uParam0, iVar0, 6);
					}
				}
		...
		case 6:
			if (!func_20() == 0)
			{
				...
				{
					if (func_936(uParam0, func_35(uParam0)))
					{
						func_937(uParam0, func_35(uParam0));
					}
				}
			}
			if ((!func_941(PLAYER::GET_PLAYER_INDEX(), 0, 0, 1) || func_120(uParam0, 8192)) || func_121(uParam0, func_33(uParam0), 8))
...
{
	func_444(iParam0, 8, 0);
}

bool func_435(var uParam0, bool bParam1)
{
	var uVar0;

	return func_439(uParam0, bParam1, &uVar0);
}
...
void func_437(var uParam0, bool bParam1, int iParam2)
{
	...
	if (!func_439(uParam0, bParam1, &iVar0))
	{
		return;
	}
	func_946(&(uParam0->f_5423[iVar0 /*65*/]), iParam2);
}
...
void func_438(var uParam0, bool bParam1, int iParam2)
{
	...
	func_947(&(uParam0->f_5423[iVar0 /*65*/]), iParam2);
}

bool func_439(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
void func_440(var uParam0)
{
	...
	if (func_507(uParam0, 32768))
	{
		return;
	}
	bVar0 = func_507(uParam0, 1024);
	if (func_507(uParam0, 128) || bVar0)
	{
		if (func_507(uParam0, 4096))
		{
			if (!func_507(uParam0, 2048))
			{
				...
				func_947(uParam0, 2048);
				return;
			}
		}
		else if (func_507(uParam0, 2048))
		{
			...
			func_946(uParam0, 2048);
		}
		if (func_507(uParam0, 512))
		{
			if (func_446(uParam0->f_10))
			{
				if (func_878(Global_35, *uParam0, 150f, 1) || bVar0)
				{
					if (!func_948(uParam0->f_10))
					{
						func_449(uParam0->f_10, 1);
						func_166(uParam0->f_10, 0);
					}
				}
				else if ((func_948(uParam0->f_10) && !bVar0) && !func_507(uParam0, 16384))
				{
					func_449(uParam0->f_10, 0);
					func_166(uParam0->f_10, 1);
				}
			}
		}
		...
		else if ((MAP::DOES_BLIP_EXIST(MAP::GET_BLIP_FROM_ENTITY(*uParam0)) && uParam0->f_8 != MAP::GET_BLIP_FROM_ENTITY(*uParam0)) || !func_878(Global_35, *uParam0, 150f, 1))
		{
			MAP::REMOVE_BLIP(&(uParam0->f_8));
		}
	}
	else if (func_507(uParam0, 512))
	{
		if (func_446(uParam0->f_10))
		{
			if (func_948(uParam0->f_10))
...
void func_441(int iParam0)
{
	...
	if (Global_1360165[iParam0 /*1157*/].f_12 != Global_1360165[iParam0 /*1157*/].f_13 || func_949(iParam0, 36, 1))
	{
		func_950(iParam0, 36, 1);
		Global_1360165[iParam0 /*1157*/].f_12 = Global_1360165[iParam0 /*1157*/].f_13;
		func_951(iParam0, &(Global_1360165[iParam0 /*1157*/].f_2));
	}
}
...
void func_445(bool bParam0, float fParam1)
{
	int iVar0;
	...
	if (func_954(Global_1934765.f_318[iVar0 /*3*/], bParam0, fParam1))
	{
...
void func_447(var uParam0, bool bParam1)
{
	...
	if (ENTITY::IS_ENTITY_AN_OBJECT(bParam1) && func_955(uParam0, ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(bParam1)))
	{
...
void func_449(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_443(&(Global_1360165[iParam0 /*1157*/].f_12), 1))
		{
			func_444(iParam0, 1, 0);
		}
	}
	func_444(iParam0, 16, bParam1);
}

void func_450(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	func_434(iParam0);
	func_957(iParam0);
	func_950(iParam0, 37, 1);
	bVar0 = func_958(Global_1360165[iParam0 /*1157*/], 0);
	iVar1 = func_959(iParam0, 0);
	bVar2 = PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar1);
	if (PED::GET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 503, true) && Global_1359489.f_16 & 8388608 == 0)
	{
		PED::SET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 503, false);
	}
	if (func_949(iParam0, 64, 1))
	{
		func_950(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_950(iParam0, 33, 1);
		func_950(iParam0, 34, 1);
		func_960(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
		func_961(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_956(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_956(iParam0, 35, 1);
			if (bParam8)
			{
				func_956(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		{
			func_540(&(Global_1360165[iParam0 /*1157*/].f_130));
		}
		if (bParam9)
		{
			func_956(iParam0, 34, 1);
		}
	}
	if (bParam1 || bParam2)
	{
	...
	if (func_949(iParam0, 45, 1))
	{
		func_950(iParam0, 45, 1);
	}
	...
	if (bParam5)
	{
		if (func_958(func_965(iParam0), 0))
		{
...
void func_458(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_457(iParam0))
	{
...
void func_468()
{
	...
	STREAMING::SET_POPULATION_BUDGET_MULTIPLIER(func_970());
}

bool func_469(int iParam0)
{
	return func_971(iParam0, 2);
}
...
int func_485(int iParam0)
{
	...
	func_979(iParam0, Global_1898164.f_162);
	return 1;
}
...
void func_490(var uParam0, float fParam1)
{
...
void func_493(bool bParam0)
{
	...
	if (func_985(GET_HASH_KEY("CAMERA_ITEM")))
	{
	}
...
void func_494(var uParam0, struct<4> Param1)
{
	*uParam0 = { Param1 };
...
void func_498(int iParam0, bool bParam1)
{
	...
	if (func_82(32768))
	{
		Global_2621440[iParam0 /*12066*/].f_9.f_14 = func_279();
	}
}

void func_499(int iParam0, vector3 vParam1, var uParam4)
{
	...
	Global_2621440[iParam0 /*12066*/].f_9.f_15 = func_366(vParam1, 1);
}
...
void func_518(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (bVar0 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()) && bVar3)
		{
			if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_27))
			{
				...
				func_991(&(Global_1900383[iParam0 /*45*/].f_27));
			}
		}
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		...
		Global_1900383[iParam0 /*45*/].f_25 = 0;
		func_993(&(Global_1900383[iParam0 /*45*/].f_26), bVar6);
	}
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		return;
	...
	bVar8 = false;
	if (func_990(iParam0, 32))
	{
		bVar8 = true;
	}
	bVar9 = TASK::IS_PED_IN_WRITHE(bVar0);
	bVar10 = false;
	iVar11 = func_994(iParam0);
	...
	fVar15 = func_995(vVar12, Global_36);
	bVar16 = false;
	if (fVar15 > func_996(iParam0))
	{
		bVar16 = true;
	}
	iVar17 = 0;
	...
	if (iVar17 != 0)
	{
		...
		func_998(Global_1900383[iParam0 /*45*/].f_26);
...
void func_526(int iParam0, char* sParam1, int iParam2)
{
	...
	func_695(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_527(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_695(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_695(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
bool func_528(int iParam0)
{
	...
	return func_246(iParam0, 67108864);
}
...
void func_529(int iParam0)
{
	...
	StringCopy(&cVar0, func_1002(iParam0), 64);
	StringConCat(&cVar0, "_OUTLINE", 64);
	sVar8 = func_1003(cVar0);
...
void func_538(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (func_1004(iParam0) == 1 && bParam7)
	{
		return;
	}
	if (bParam6)
...
int func_542(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 60)
	{
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == iParam0)
		{
			func_555(&(Global_40.f_4283.f_6[iVar0 /*5*/]), bParam1, bParam2);
			return 1;
		}
		iVar0++;
	}
...
int func_549()
{
	...
	iVar0 = func_1008(Global_1347702[9 /*49*/].f_15);
	iVar1 = func_1008(Global_1835011[69 /*74*/].f_1);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_695(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_695(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_695(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_695(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
int func_569(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_975(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_573(int iParam0)
{
	...
	while (iVar1 < func_1034())
	{
		...
		{
			if (func_341(func_1035(iVar0), 1, 0))
			{
				iVar2++;
			}
		}
...
bool func_579(int iParam0)
{
	...
	return func_188(Global_1347702[iParam0 /*49*/].f_15);
}
...
int func_580()
{
	...
	while (iVar1 < 12)
	{
		if (func_341(func_1037(iVar1), 1, 0))
		{
			iVar0++;
		}
		iVar1++;
...
void func_581(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	switch (iParam0)
	{
		case 38:
			...
			break;
		case 39:
			if (func_391() && (func_579(39) || func_575(39)))
			{
		...
		case 43:
			...
			break;
		case 41:
			if (func_391() && (func_579(41) || func_575(41)))
			{
			...
			break;
		case 49:
			if (func_391() && (func_579(49) || func_575(49)))
			{
...
void func_583(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1046(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1046(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_702(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, func_1047(func_577(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1046(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
bool func_593(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_975(bParam0));
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_1054(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_593(0))
				{
					...
					func_595(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
bool func_596(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_1031(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_1018())
				{
					return false;
				}
				...
				{
					func_594(iVar0, WEAPON::GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
bool func_598(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_341(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
	...
	{
		func_633(func_1063(iParam0), func_632(iParam0), 1);
		return false;
	}
...
void func_599(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_332()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
		if (func_1064(Global_35, iParam0, &uVar0))
		{
			func_617(PLAYER::PLAYER_PED_ID(), iParam0, 0, -358215195, 1, 1, 1, 0, 1, 1);
		}
	}
	switch (iParam0)
	{
...
void func_603(int iParam0)
{
	...
	if (func_1067() < 3)
	{
		if (bVar0)
		{
			...
			{
				func_633(79, func_632(func_1068(iParam0)), 1);
			}
			else
			{
				func_633(78, func_632(func_1068(iParam0)), 1);
			}
		}
		else
		{
			func_633(80, func_632(func_1070(iParam0)), 1);
		}
	}
}
...
bool func_604()
{
	if (((((func_1071(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_1071(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_1071(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_1071(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_1071(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_1071(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_606(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_583(51, 0, 0, 0, 0, -1, 0);
			func_1072(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_583(51, 0, 0, 0, 0, -1, 0);
			func_1072(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_581(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_1076(1), 0, -1, 0);
			func_1077(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_581(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_1076(2), 0, -1, 0);
			func_1077(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_581(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_1076(4), 0, -1, 0);
			func_1077(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_581(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_1076(8), 0, -1, 0);
			func_1077(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_581(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_1076(16), 0, -1, 0);
			func_1077(16);
			break;
	}
}
...
void func_607(int iParam0)
{
	...
	func_581(39, 0, 0, 0, 0, 0, -1, 0);
	func_583(39, 0, 0, func_1078(), 30, 1, 0);
}
...
void func_608(int iParam0)
{
	...
	func_581(49, 0, 0, 0, 0, 0, -1, 0);
	func_583(49, 0, 0, func_1079(), 10, 1, 0);
}
...
void func_609(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_319(437, 0);
			func_319(440, 0);
			func_1080(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_583(51, 0, 0, sVar0, func_1038(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_1072(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_1080(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_583(51, 0, 0, sVar0, func_1038(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_1072(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_1080(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_583(51, 0, 0, sVar0, func_1038(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_1072(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_1080(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_583(51, 0, 0, sVar0, func_1038(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_1072(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_319(438, 0);
			func_1080(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_581(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_583(51, 0, 0, sVar0, func_1038(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_1072(32768);
			break;
		default:
			func_319(439, 0);
...
void func_611(int iParam0, int iParam1)
{
	...
	if (func_20() == -1)
	{
		...
		{
			func_1081(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_1082() == 0)
			{
				func_361(0, 10);
				iVar1 = func_1083(iParam0, iParam1, 1);
				...
				{
					if (func_1084(iParam0) < func_1085(iParam0))
					{
						func_581(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_1081(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_1082() == 1)
			{
				func_361(0, 10);
				iVar1 = func_1083(iParam0, iParam1, 2);
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_1084(iParam0) < func_1085(iParam0))
					{
						func_581(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_1081(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_1082() == 2)
			{
				func_361(0, 10);
				iVar1 = func_1083(iParam0, iParam1, 4);
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_1086(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_E