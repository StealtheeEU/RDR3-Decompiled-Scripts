...
void func_46()
{
	...
	func_93(&iLocal_222, -2547.255f, 405.9721f, 160.379f, 0f, 0f, -6f, 130f, 214f, 60f, GET_HASH_KEY("VOLBOX"));
	func_93(&iLocal_222, -2600.745f, 471.1957f, 160.0371f, 0f, 0f, -6f, 19f, 52f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2548.949f, 325.763f, 160f, 0f, 0f, 9.000001f, 55f, 13f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2579.138f, 330.9276f, 160f, 0f, 0f, -30f, 19f, 16f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2518.681f, 397.0634f, 160f, 0f, 0f, -4.5f, 25f, 127f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2534.318f, 495.423f, 160f, 0f, 0f, -9.000002f, 13f, 10f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2600.49f, 392.029f, 160f, 0f, 0f, -3f, 10f, 34f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2518.894f, 334.922f, 160f, 0f, 0f, -12f, 7f, 11f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2505.076f, 442.9265f, 160f, 0f, 0f, -6f, 4f, 22f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2552.524f, 396.2589f, 160f, 0f, 0f, 0f, 64f, 145f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2505.803f, 461.1734f, 160f, 0f, 0f, 2.000002f, 10f, 13f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2522.517f, 477.1015f, 160f, 0f, 0f, 42f, 19f, 25f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2610.8f, 450.1638f, 160f, 0f, 0f, 13f, 4f, 16f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2589.791f, 359.6104f, 160f, 0f, 0f, 6f, 16f, 43f, 60f, GET_HASH_KEY("VOLCYLINDER"));
	func_94(&iLocal_223, -2568.966f, 463.1732f, 160f, 0f, 0f, 25f, 86f, 43f, 60f, GET_HASH_KEY("VOLBOX"));
	func_94(&iLocal_223, -2593.714f, 423.6152f, 160f, 0f, 0f, 9.000002f, 28f, 76f, 60f, GET_HASH_KEY("VOLBOX"));
	iVar0 = iLocal_223;
...
int func_51(vector3 vParam0, float fParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_63(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(func_112(iParam3)))
	{
		return 0;
	}
...
void func_64()
{
	...
	{
		case 0:
			HUD::TEXT_BLOCK_REQUEST("CAPROAU");
			if (HUD::TEXT_BLOCK_IS_LOADED("CAPROAU"))
			{
				iLocal_224 = 1;
			}
			break;
...
bool func_66()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_223) && VOLUME::IS_POINT_IN_VOLUME(iLocal_223, Global_36))
	{
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_140(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_140(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_140(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_140(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_146(func_145(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_86(int iParam0)
{
	...
	if (HUD::_DOES_TEXT_BLOCK_EXIST("CAPROAU"))
	{
		if (HUD::TEXT_BLOCK_IS_LOADED("CAPROAU"))
		{
			HUD::_TEXT_BLOCK_DELETE("CAPROAU");
		}
	}
	func_157();
}
...
void func_93(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10)
{
	...
	if (*iParam0 != 0 && VOLUME::DOES_VOLUME_EXIST(*iParam0))
	{
...
bool func_124()
{
	...
	Local_116[0 /*45*/].f_43 = 27465;
	Local_116[0 /*45*/].f_44 = 27765;
...
char* func_140(char* sParam0, int iParam1)
{
	...
	return func_199(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_274(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319.f_17371 || func_303(func_243(*uParam0), 1, 1, 1, 0)) || PED::IS_PED_HOGTIED(func_243(*uParam0)))
	{
		func_299(uParam0);
		return uParam0->f_30;
	}
	if ((((func_116(PLAYER::PLAYER_ID(), 1, 0, 1) || func_304()) || LAW::_0xF46108C50A22B029()) || LAW::ARE_WITNESSES_ACTIVE(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return false;
	}
...
int func_303(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_304()
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) || func_333(Global_35))
	{
		return 1;
	}
	return 0;
