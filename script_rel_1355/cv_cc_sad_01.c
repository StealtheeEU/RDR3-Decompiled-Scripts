...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_WOODWHITTLE01X"), 0f, 0f, 0f, "WOOD", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_CRATE15X"), 0f, 0f, 0f, "CRATE", 0, 0, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_SADCNV1"), GET_HASH_KEY("PLAYER_SADCNV1"));
