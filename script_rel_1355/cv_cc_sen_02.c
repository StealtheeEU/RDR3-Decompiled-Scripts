...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.5459f, 1.3948f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_15 = func_152(uParam0, GET_HASH_KEY("P_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SENCNV2"), GET_HASH_KEY("PLAYER_SENCNV2"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1);
