...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.6625f, 1.275f, 1f, -22f, 1.1f, 1.1f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -0.5473f, -1.0901f, 1f, -21f, 1f, 1f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, vLocal_22, 0f, 1f, 1f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 0, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON1", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL0", 0, 0, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON0", 0, 0, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, "BARREL", 1, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), func_153(uParam0, vLocal_22), 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_FEMALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_FEMALE_B", iLocal_20, 0);
	func_157(uParam0, iLocal_15, 3, 0);
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", -1, 0, 120f, 1065353216 /* Float: 1f */, 1);
...
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), false);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_388(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
