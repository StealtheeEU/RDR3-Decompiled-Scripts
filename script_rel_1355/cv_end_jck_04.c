...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, GET_HASH_KEY("P_PITCHFORK01X"), 0f, 0f, 0f, "PITCHFORK", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_WHEELBARROW01X"), 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_HAYPILEWHEELBARREL01X"), 0f, 0f, 0f, "BarrowHay", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_HAYPILEPITCHFORK01X"), 0f, 0f, 0f, "HAYPILE", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_HAYPILEPITCHFORK01X"), 0f, 0f, 0f, "HayPile02", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_HAYPILEPITCHFORK01X"), 0f, 0f, 0f, "HayPile03", 0, 0, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_BCJCKCNV4"), GET_HASH_KEY("PLAYER_BCJCKCNV4"));
	func_155(uParam0, iLocal_14, -1, 0.77f);
	func_156(uParam0, iLocal_16, 1, -1);
	func_157(uParam0, "BJCK4AU");
	iLocal_17 = func_158(uParam0, -2.5f, 2.5f, 2f, 0f, 0f, 0f, 5.5f, 5.5f, 2.5f, "volTrigger", GET_HASH_KEY("VOLCYLINDER"));
	func_159(uParam0, 1);
