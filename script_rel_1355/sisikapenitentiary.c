...
bool func_11()
{
	...
	POPULATION::SET_POPZONE_POPULATION_SET(iVar0, GET_HASH_KEY("SIS_GUARD"));
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 3321.868f, -610.395f, 48.57418f, 0f, 0f, 40f, 15f, 75f, 20f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 3319.213f, -584.038f, 47.83653f, 0f, 0f, 40f, 15f, 29f, 20f);
	iVar1 = POPULATION::_CREATE_POPZONE_FROM_VOLUME(iLocal_18);
	POPULATION::SET_POPZONE_POPULATION_SET(iVar1, GET_HASH_KEY("SIS_GUARD"));
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3353.973f, -672.1495f, 63.768f, 0f, 0f, 14.62307f, 68.21951f, 54.663f, 50f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3315.974f, -656.2813f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3382.837f, -665.3976f, 63.76801f, 0f, 0f, -59.89402f, 51.37444f, 37.32103f, 50f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3381f, -693.5285f, 48.96563f, 0f, 0f, 50.13634f, 11.37222f, 36.9617f, 50f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3364.015f, -686.8185f, 63.76801f, 0f, 0f, 60.3014f, 66.63422f, 46.65413f, 50f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3376.356f, -691.6537f, 63.76801f, 0f, 0f, 50.13634f, 65.99199f, 37.71349f, 50f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3328.904f, -704.5117f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 5.205996f, 25.19653f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3368.851f, -726.5292f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3410.578f, -679.0173f, 75.25407f, 0f, 0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3386.604f, -637.0076f, 75.25407f, 0f, 0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3187.881f, -392.378f, 59.70001f, 0f, 0f, -60.2991f, 106.109f, 89.50376f, 100f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3203.627f, -637.6728f, 59.70001f, 0f, 0f, -63.6916f, 207.2567f, 107.2578f, 100f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3186.952f, -695.6421f, 59.70001f, 0f, 0f, -63.6916f, 129.2146f, 107.2578f, 100f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3297.383f, -592.1081f, 59.70001f, 0f, 0f, -63.6916f, 173.9582f, 92.46152f, 100f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3375.808f, -710.6785f, 59.7f, 0f, 0f, -61.08491f, 129.6087f, 116.591f, 100f);
...
void func_54()
{
	...
	{
		bLocal_25 = true;
		LAW::_0x75CBF20BA47E4F89(Global_36, GET_HASH_KEY("LAW_LOCAL_SISIKA"));
	}
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_110(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_110(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_110(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_110(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_66(int iParam0, bool bParam1)
{
	...
	func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_116(func_115(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_147(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
