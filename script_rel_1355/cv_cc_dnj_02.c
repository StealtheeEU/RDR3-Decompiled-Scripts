...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.3087f, -0.0568f, 1.08f, 0f, 4f, 5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, -1.3087f, 0.4832f, 1.08f, 0f, 4f, 2.6f, 3f, GET_HASH_KEY("VOLBOX"), 1);
	iLocal_15 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_LOGHALF01X"), 0f, 0f, 0f, "FIREWOOD", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_WOODPILECHOPPED01X"), 0f, 0f, 0f, "WOODPILE", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_FURNACE01X"), -2.797484f, 1.318717f, -0.002501f, "FURNACE", 1, 0, 1);
