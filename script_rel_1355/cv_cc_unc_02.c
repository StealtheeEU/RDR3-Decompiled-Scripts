...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.25767f, -1.88347f, 0.494652f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -1.26148f, -1.69011f, 0.479202f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 0f, -1.8f, 0f, -9f, 1.75f, 0.89f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_UNCCNV2"), GET_HASH_KEY("PLAYER_UNCCNV2"));
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
