...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -5.2375f, -15.9001f, 2.56f, -5.76f, 6.48f, 8.135f, 3.885f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -0.55f, -2.7625f, 2.8f, -32.04f, 4.155f, 7.955f, 2.585f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "p_cigarette_cs02x", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_ABICNV20"), GET_HASH_KEY("PLAYER_ABICNV20"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_INSPECT"), "WORLD_HUMAN_INSPECT_FEMALE_D", -1, 0, 40f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 3, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_14, 1, 4, 0, 0, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 0, 20f, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_396(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
