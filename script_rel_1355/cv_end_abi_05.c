...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, GET_HASH_KEY("A_C_HORSE_MORGAN_FLAXENCHESTNUT"), "HORSE");
	func_153(uParam0, -3.1201f, 0.72f, 1.1079f, -6.33f, 2.5f, 2.5f, 2.5f, GET_HASH_KEY("VOLCYLINDER"), -1, 1, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_BRUSHHORSE02X"), 0f, 0f, 0f, "BRUSH", 0, 0, 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_BCABICNV5"), GET_HASH_KEY("PLAYER_BCABICNV5"));
	func_158(uParam0, iLocal_14, 1, -1);
	iLocal_15 = func_159(uParam0, -2.19f, 3.84f, 0f, 0f, 0f, -32.72f, 8f, 8f, 5f, "volTrigger", GET_HASH_KEY("VOLBOX"));
	func_160(uParam0, 1);
