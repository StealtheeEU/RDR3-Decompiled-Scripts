...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CS_PLATESTEW01X"), 0f, 0f, 0f, "PLATE", 0, 0, 1);
	func_152(uParam0, iLocal_14, GET_HASH_KEY("WEAPON_SHOTGUN_DOUBLEBARREL"), "SHOTGUN");
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SENCNV7"), GET_HASH_KEY("PLAYER_SENCNV7"));
