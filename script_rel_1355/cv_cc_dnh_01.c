...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.2356f, 0.9457f, 0.9668f, 4.75f, 4.2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, 1.0625f, 1.0873f, 1.15f, 38.56f, 1f, 1f, 2.685f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_BOOK02X"), 0f, 0f, 0f, "BIBLE", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CHAIR04X"), 0f, 0f, 0f, "p_chair04x", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_CRATE14X"), 0f, 0f, 0f, "p_crate14x", 0, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_DNHCNV1"), GET_HASH_KEY("PLAYER_DNHCNV1"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_380(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
