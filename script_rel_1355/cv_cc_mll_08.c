...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -10.695f, 2.2941f, 1.1367f, -29f, 5f, 5f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	func_151(uParam0, -14.0653f, -8.1077f, 1.3223f, -29f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE^1", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCHSTICK", 0, 1, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_MLLCNV8"), GET_HASH_KEY("PLAYER_MLLCNV8"));
	func_157(uParam0, iLocal_17, -1, 0.87f);
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
