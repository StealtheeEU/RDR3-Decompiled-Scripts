...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -0.75f, -0.1725f, 0f, 0f, 2.38f, 1.3975f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_14 = func_151(uParam0, 0, "IG_Dutch");
	iLocal_15 = func_151(uParam0, 9, "IG_Lenny");
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "P_CS_BOOKEVELYNMILLER", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "P_MUGCOFFEE01X", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_154(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_HUMAN_GLASS_PUT_DOWN_CRATE_TABLE"), "WORLD_HUMAN_GLASS_PUT_DOWN_CRATE_TABLE_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_15, 4, 0);
	func_156(uParam0, iLocal_15, iLocal_17, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0);
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), 1, 0, 0);
	return true;
}
...
void func_335(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_367(iParam1))
		{
			func_368(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
				...
				case 16:
					...
					switch (iParam0)
					{
						...
						case 14:
							...
							break;
						case 4:
							if (func_322(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
