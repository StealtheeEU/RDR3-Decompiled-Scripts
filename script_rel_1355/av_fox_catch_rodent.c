...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "FOX", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[5])
			{
				if (func_69(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_67(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
			{
				if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
				{
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], GET_HASH_KEY("ENDSINWALK")))
							{
								ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1, uParam0->f_20[0 /*14*/]);
								PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], GET_HASH_KEY("MOTIONSTATE_WALK"), false, 0, false);
...
void func_89(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_125(iParam1))
		{
			func_126(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_199(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_197(int iParam0, int iParam1)
{
	...
	if (func_224(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
