...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 0.0763f, -1.44f, 0.1559f, -176.4356f, 2.56f, 3.53f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_153(uParam0, 4.4707f, -1.4952f, 0.8447f, -17.4529f, 2.8f, 1.96f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 1, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_AT_POSITION(func_48(uParam0, iLocal_16), GET_HASH_KEY("WORLD_ANIMAL_HORSE_GRAZING_CAMP"), vLocal_17, fLocal_20, 15000, true, false, 0, -1f, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_383(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
