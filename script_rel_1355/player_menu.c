...
void func_2(var uParam0)
{
	...
	func_13(uParam0);
	func_14();
	if (UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(GET_HASH_KEY("PLAYER_MENU")))
	{
		UIAPPS::_CLOSE_UIAPP_BY_HASH(GET_HASH_KEY("PLAYER_MENU"));
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
}
...
bool func_6(int iParam0, var uParam1)
{
	...
	TXD::REQUEST_STREAMED_TXD(GET_HASH_KEY("MINIGAMES_HUD"), false);
	TXD::REQUEST_STREAMED_TXD(1997120069, false);
	TXD::REQUEST_STREAMED_TXD(GET_HASH_KEY("HUD_TOASTS"), false);
	return bVar0;
}
...
void func_10()
{
	...
	PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_MELEE_ATTACK"), false);
	PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_PHONE"), false);
	PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_RADIAL_MENU_SLOT_NAV_NEXT"), false);
	PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_RADIAL_MENU_SLOT_NAV_PREV"), false);
	PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_COVER"), false);
	PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_OPEN_WHEEL_MENU"), false);
}
...
void func_21()
{
	...
	{
		iVar9 = DATABINDING::DATABINDING_READ_INT(Global_1935689.f_1225.f_5[iVar0 /*30*/].f_18);
		if (iVar9 != 1)
		{
		}
		else
...
void func_32()
{
	...
	iVar4 = GET_HASH_KEY("PLAYER_MENU");
...
int func_53(int iParam0)
{
	...
	else
	{
		...
		{
			iVar0 = func_77(0, 10, 11, GET_HASH_KEY("CABR01"));
		}
	}
	return iVar0;
}
...
struct<5> func_68(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_89(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_90(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_90(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_72(int iParam0, var uParam1)
{
	...
	while (iVar1 < iVar0)
	{
		...
		func_109(iVar2, iVar3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		iVar1++;
	}
}
...
{
	return func_90(GET_HASH_KEY("CHARACTER"), func_123(), -1591664384, bParam0);
}
...
{
	if (func_126(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_104(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_109(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_130(iParam0, 0, 0) == 0)
	{
		if (func_131(iParam0))
		{
			...
			{
				func_109(func_139(iVar6), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
	...
	if (func_89(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_89(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_89(iParam0) == GET_HASH_KEY("AMMO") && func_155(iParam0))
		{
		...
		{
			func_160(func_161(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_146(iParam0, 589988438))
		{
			if (func_163())
			{
				func_164(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		else if (func_146(iParam0, 1248798204))
		{
			...
			if (iVar8 != 0)
			{
				func_109(iVar8, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
			}
		}
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_177(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_178(&iVar9, 0))
				{
					func_152(iVar9, 0, 0, bParam4, 3, 0, 752097756, 0);
				}
				break;
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				if (func_1() == -1 && Global_1946804.f_1497.f_1[25 /*3*/] == Global_1946804.f_57[25 /*11*/])
				{
					func_177(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_184(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_185(499813453, 0);
				func_186(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_184(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_185(499813453, 0);
				func_186(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_184(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_185(499813453, 0);
				func_186(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_184(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_185(666607663, 0);
				func_187(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_184(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_185(666607663, 0);
				func_187(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_184(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_185(666607663, 0);
				func_187(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_184(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_185(-220219788, 0);
				func_188(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_184(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_185(-220219788, 0);
				func_188(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_184(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_185(-220219788, 0);
				func_188(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_184(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_185(218622660, 0);
				func_189(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_184(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_185(218622660, 0);
				func_189(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_184(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_185(390004462, 0);
				func_190(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_184(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_185(390004462, 0);
				func_190(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_184(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_185(390004462, 0);
				func_190(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_184(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_185(6410548, 0);
				func_191(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_184(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_185(6410548, 0);
				func_191(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_184(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_185(6410548, 0);
				func_191(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_184(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_185(6410548, 0);
				func_191(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_193(242, func_192(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_193(240, func_192(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_193(241, func_192(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
				...
				{
					func_194(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_194(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_194(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_194(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_194(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_194(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    ...
    " Cores." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX"):
				...
				{
					func_109(func_195(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				else
				{
					func_109(func_196(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				break;
	...
	else if (iVar2 != 0)
	{
		if (func_101(0))
		{
			...
			while (iVar34 < Var11)
			{
				func_109(Var11.f_1[iVar34], Var11.f_12[iVar34], 0, 0, 0, -897553835, 0, 0, 0, 0);
				iVar34++;
			}
		}
		else
...
{
	func_216(&(Global_1572887.f_164.f_61), iParam0);
}
...
bool func_154(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_224(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_257())
				{
					return false;
				}
...
bool func_156(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_174(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_157(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_261()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_163()
{
	if (((((func_269(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_269(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_269(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_269(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_269(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_269(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_165(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_145(51, 0, 0, 0, 0, -1, 0);
			func_273(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_145(51, 0, 0, 0, 0, -1, 0);
			func_273(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_143(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_277(1), 0, -1, 0);
			func_278(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_143(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_277(2), 0, -1, 0);
			func_278(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_143(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_277(4), 0, -1, 0);
			func_278(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_143(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_277(8), 0, -1, 0);
			func_278(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_143(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_277(16), 0, -1, 0);
			func_278(16);
			break;
	}
}
...
void func_168(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_137(437, 0);
			func_137(440, 0);
			func_281(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_145(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_273(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_281(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_145(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_273(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_281(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_145(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_273(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_281(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_145(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_273(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_137(438, 0);
			func_281(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_143(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_145(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_273(32768);
			break;
		default:
			func_137(439, 0);
...
void func_170(int iParam0, int iParam1)
{
	...
	if (func_1() == -1)
	{
		...
		{
			func_283(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_284() == 0)
			{
				func_23(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_143(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_283(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_284() == 1)
			{
				func_23(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_286(iParam0) < func_287(iParam0))
					{
						func_143(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_283(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_284() == 2)
			{
				func_23(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_288(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_289(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_230(48);
					}
					if (func_286(iParam0) < func_287(iParam0))
					{
						func_143(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_283(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_284() == 3)
			{
				func_23(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_286(iParam0) < func_287(iParam0))
					{
						func_143(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_283(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_284() == 4)
			{
				func_23(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_286(iParam0) < func_287(iParam0))
					{
						func_143(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_173(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_1() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_164(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_164(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_164(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_164(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_164(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_164(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_164(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_164(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_164(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_164(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_164(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_164(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_164(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_293())
			{
				func_164(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_164(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_164(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_164(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_164(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_164(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_164(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_164(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_164(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_164(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_164(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_164(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_164(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_164(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_175(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_23(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_295(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_296(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_297(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
int func_177(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946804.f_57[func_300(iParam3, 1) /*11*/])
			{
				func_303(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_304(32768) && iParam1 != Global_1946804.f_57[func_300(iParam3, 1) /*11*/])
			{
				func_305();
...
void func_199(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_318(81053684, 0) <= 0)
			{
	...
	{
		if (!func_325(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_177(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_148(24);
		if (func_178(&iVar2, 0))
		{
			func_152(iVar2, 0, 0, 1, 3, 0, 752097756, 0);
		}
	}
}
...
int func_201(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_327(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_202(int iParam0)
{
	...
	if (func_146(iParam0, -305066475))
	{
		if (func_1() == -1)
		{
			...
			{
				return func_329(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_329(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_146(iParam0, -537818634))
	{
		return func_329(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_146(iParam0, 2084895747))
	{
		return func_329(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_204(int iParam0, char* sParam1)
{
	...
	func_333(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_332(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_205(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_337(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_146(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
{
	return func_89(iParam0) == GET_HASH_KEY("WEAPON");
}
...
void func_221(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_89(iParam0) != GET_HASH_KEY("WEAPON"))
	{
		return;
	}
	iVar0 = func_150(iParam0, 0);
...
int func_227(int iParam0, bool bParam1)
{
	...
	if (!func_346(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_311(iVar14);
...
void func_230(int iParam0)
{
	...
	func_333(MISC::VAR_STRING(6, func_352(iParam0), fVar1), "itemtype_textures", func_353(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_248(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_1() == -1)
			{
				if (!func_325(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_387(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_257())
					{
					...
					{
						func_198(iVar0, 1, 752097756);
					}
					func_177(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
bool func_262(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_89(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_1() != -1;
	...
	if (func_146(iParam1, 866047851))
	{
		...
		if (func_395(&(Global_1946804.f_1497)) >= 2 && Global_1946804.f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
	...
	switch (iVar4)
	{
		...
		case -1944638739:
			iVar5 = 35;
			if (Global_1946804.f_1497.f_1[iVar5 /*3*/] != Global_1946804.f_57[iVar5 /*11*/] && func_146(iParam1, -1638171711))
			{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_397(Global_1946804.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				iVar5 = 36;
				iVar6 = 35;
				if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_146(Global_1946804.f_1497.f_1[iVar5 /*3*/], -1638171711))
				{
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_398(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_270(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_174(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_271(int iParam0, char* sParam1, int iParam2)
{
	...
	func_333(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_272(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_333(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_333(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_160(func_329(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_279()
{
	...
	while (iVar1 < 30)
	{
		if (func_405(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_301(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_146(iParam0, 866047851) && func_395(&(Global_1946804.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_304(32768) && iParam2 == 10) && iParam0 != Global_1946804.f_57[iParam2 /*11*/])
	{
	...
	{
		func_420(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_420(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	func_421(&(Global_1946804.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946804.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_422(iParam0, iParam2, iParam1, func_1() != -1);
	if (bParam4)
	{
		func_423(&(Global_1946804.f_1378), 1, 3);
	}
	else
	{
		func_423(&(Global_1946804.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_424(func_415(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_425(&(Global_1946804.f_2589), bParam0, bParam1, bParam2);
}
...
void func_305()
{
	func_428(&(Global_1946804.f_2776));
	func_429(32768);
...
bool func_325(int iParam0)
{
	...
	return Global_1946804.f_1497.f_1[func_300(iParam0, 1) /*3*/] != Global_1946804.f_57[func_300(iParam0, 1) /*11*/];
}
...
int func_332(int iParam0)
{
	...
	if (!func_458(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
struct<14> func_344(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
void func_345(var uParam0, struct<4> Param1)
{
...
int func_362()
{
	...
	while (iVar1 < 30)
	{
		if (func_473(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_387(int iParam0)
{
	...
	return Global_1946804.f_1497.f_1[func_300(iParam0, 1) /*3*/];
}
...
void func_388()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_151(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_198(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_151(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_198(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
int func_395(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/] && func_146(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
int func_397(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946804.f_57[func_300(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_404(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_402())
	{
		func_333(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_333(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_491(&(Global_1946804.f_2589), iParam0);
}

void func_419(int iParam0, int iParam1)
{
	func_492(&(Global_1946804.f_2589), iParam0, iParam1);
}
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_398(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_96(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && func_146(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711))
				{
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_398(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_146(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_423(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_498(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
{
	Global_1946804.f_57[func_300(iParam0, 1) /*11*/].f_10 = (Global_1946804.f_57[func_300(iParam0, 1) /*11*/].f_10 - (Global_1946804.f_57[func_300(iParam0, 1) /*11*/].f_10 && iParam1));
}
...
void func_425(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_1() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_501(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_448(0))
		{
			if (Global_40.f_7157[Global_40.f_7729 /*3*/] & 512 != 0)
			{
				...
				Global_1946804.f_1497 = func_448(Global_40.f_7729);
				Global_1946804.f_1378 = func_448(Global_40.f_7729);
...
{
	func_327(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_327(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_327(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}

void func_457(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
void func_469(int iParam0, int iParam1, int iParam2)
{
	...
	func_244(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_530(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_477()
{
	...
	func_534(0);
	func_535(7);
	func_536(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_322() == 1160113249)
	{
		func_536(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
...
void func_489(int iParam0)
{
	...
	Var0 = { func_329(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
{
	return (Global_1946804.f_57[func_300(iParam0, 1) /*11*/].f_10 && iParam1) != 0;
}
...
void func_500(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_1() == -1)
	{
		func_550(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_551(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_552(&(Global_1946804.f_1378), iParam0);
...
void func_515()
{
	...
	func_198(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_350(1);
	func_469(1, iVar0, 0);
}
...
void func_517()
{
	...
	func_198(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_350(2);
	func_469(2, iVar0, 0);
}
...
void func_518()
{
	...
	func_198(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_350(0);
	func_469(0, iVar0, 0);
}
...
int func_523(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_105(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_105(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_105(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}
