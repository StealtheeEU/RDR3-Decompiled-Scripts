...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0874f, 0.9197f, 1.0429f, 0f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, 0.0089f, -0.9555f, 1.0423f, 0f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	if (func_152(10))
	{
		iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.00632575f, -0.96194f, 0.0307617f, "CHAIR", 1, 0, 1);
	}
	else
	{
		iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0322266f, "CHAIR", 1, 0, 1);
	}
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0276031f, 0, 1, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL0", 0, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON0", 0, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON1", 0, 0, 1);
	if (!func_152(10))
	{
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_17, 0);
	if (func_152(10))
	{
		func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_17, 0, -1f, 1065353216 /* Float: 1f */, 1);
	}
	else
	{
		func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	...
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_16, 0);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	{
		func_161(uParam0);
		func_156(uParam0, iLocal_14, 0, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_LAZY_MALE_A", -1, 0);
		func_162(uParam0, iLocal_14, 1);
		func_156(uParam0, iLocal_15, 0, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_LAZY_MALE_B", -1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_389(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
