...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.4407f, -0.9511f, 0.5101f, 0f, 3f, 2.5f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, 0.572576f, -1.05075f, 1.00132f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_CRATE03X"), -0.0359887f, -1.2f, 0f, 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_BOOK04X"), -0.0494653f, -1.12035f, 0.452904f, 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_BOOK04X"), -0.0967619f, -1.131f, 0.483903f, 0, 0, 0, 1);
	...
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_161(uParam0, iLocal_15, 1, -1);
	func_162(uParam0, GET_HASH_KEY("COMP_DNLCNV1"), GET_HASH_KEY("PLAYER_DNLCNV1"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
