...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.2125f, -3.875f, 1.4875f, 0f, 2f, 2f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ADLERS"), 1, 1, 1);
	if (!func_152(10))
	{
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SADCNV2"), GET_HASH_KEY("PLAYER_SADCNV2"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
	...
	if (func_152(10))
	{
		...
		func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
		func_156(uParam0, iLocal_15, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
