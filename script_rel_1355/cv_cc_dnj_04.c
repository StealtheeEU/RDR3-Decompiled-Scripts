...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.4f, -8.9625f, 0f, 0f, 1.2f, 1.2f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 0.9625f, -0.5f, 0f, 0f, 1.87f, 1.87f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 0.56f, -0.96f, 1.0325f, 0f, 0.8f, 0.8f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_51 = func_153(uParam0, GET_HASH_KEY("P_CS_LEDGER01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_52 = func_153(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_53 = func_153(uParam0, GET_HASH_KEY("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	...
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_52, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_53, "", 1, "p_pen01x_PH_R_HAND");
	func_160(uParam0, iLocal_14, iLocal_51, "", 1, "p_cs_ledger01x_PH_L_HAND");
	func_161(uParam0, GET_HASH_KEY("COMP_DNJCNV4"), GET_HASH_KEY("PLAYER_DNJCNV4"));
