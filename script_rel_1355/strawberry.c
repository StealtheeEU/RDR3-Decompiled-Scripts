...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_390, -1791.951f, -386.005f, 161.147f, 0f, 0f, -34.984f, 9.1f, 6.4f, 3.7f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_390, -1793.558f, -394.3542f, 160.6098f, 0f, 0f, -34.79824f, 2f, 4.25f, 2.559283f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_401, -1763.516f, -378.3214f, 158.2782f, 0f, 0f, -34.984f, 4.345877f, 2.597463f, 3.059408f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_401, -1766.218f, -379.3755f, 158.2782f, 0f, 0f, -34.984f, 3.121531f, 2.179444f, 3.059408f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_401, -1762.194f, -384.4291f, 158.2782f, 0f, 0f, -34.984f, 3.429085f, 5.790822f, 3.059408f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_394, func_46(26), 0f, 0f, 65.016f, 12f, 7f, 7.256f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_394, -1815.8f, -346.5f, 162.9f, 0f, 0f, 65.016f, 12f, 4f, 12f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_395, -1812.852f, -352.8134f, 163.3997f, 0f, 0f, 65.01599f, 6.286466f, 5.825926f, 7.256f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_395, -1810.468f, -349.3962f, 163.3997f, 0f, 0f, 65.01599f, 6.286466f, 7.111871f, 7.151284f);
...
void func_14(int iParam0)
{
	...
	iParam0 = iParam0;
	iVar0[0] = GET_HASH_KEY("DOOR_STR_JAILPOST_INT_1");
	iVar0[1] = 902070893;
	func_50(26, &iVar0, 2);
	if (func_20() == -1)
	{
	...
	{
		func_53();
		func_54(&uLocal_419, 943, 5, "", GET_HASH_KEY("CART05"), -1747.267f, -393.2463f, 155.9854f, 155.78f, 0, 0);
	}
}
...
void func_27(int iParam0)
{
	...
	if (func_68(61))
	{
		func_69(GET_HASH_KEY("STR_03_P_MILLWINDOW_A"));
		func_69(1525054056);
		func_69(749968899);
		func_70(GET_HASH_KEY("STR_03_P_MILLWINDOW_D"));
	}
	else
	{
		func_69(1525054056);
		func_69(749968899);
		func_69(GET_HASH_KEY("STR_03_P_MILLWINDOW_D"));
		func_70(GET_HASH_KEY("STR_03_P_MILLWINDOW_A"));
	}
	...
	func_65(2, GET_HASH_KEY("DOOR_STR_FRT_INT_02"), 0, 0);
	...
	if (!func_78(45))
	{
		ENTITY::CREATE_MODEL_HIDE(vLocal_443, 5f, GET_HASH_KEY("STR_01_PRONGHORNSIGN"), false);
	}
	else
	{
		ENTITY::REMOVE_MODEL_HIDE(vLocal_443, 5f, GET_HASH_KEY("STR_01_PRONGHORNSIGN"), 0);
	}
...
void func_31(int iParam0)
{
	func_81(1f, 0f, 0f, 0f);
	func_82(iParam0, 0);
	iLocal_442 = VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(-1809.28f, -396.9163f, 153.0447f, 85f, 2f, 2f, 0, 6f, 10f, 25f, 7.5f);
}
...
void func_35(int iParam0)
{
	...
	func_85();
	func_86(0, GET_HASH_KEY("STR_CIVILIANS"));
	func_86(2, GET_HASH_KEY("STR_LAW_DEPUTIES"));
}
...
void func_49()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_393, -1796.973f, -382.4901f, 160.8563f, 0f, 0f, -34.984f, 3.075656f, 10.30693f, 3.256194f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_393, -1789.325f, -382.7872f, 160.8563f, 0f, 0f, -124.786f, 1.84945f, 10.30693f, 3.256194f);
	iVar0 = 0;
	func_129(&iVar0, 5);
	func_129(&iVar0, 0);
	func_129(&iVar0, 8);
...
void func_110(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_279(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), sVar9, func_279(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_279(&cVar6, GET_HASH_KEY("COLOR_PURE_WHITE")), func_279(&cVar10, GET_HASH_KEY("COLOR_PURE_WHITE")));
		}
...
void func_112(int iParam0, bool bParam1)
{
	...
	func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_285(func_284(GET_HASH_KEY("DISCOVERED"), GET_HASH_KEY("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_140()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(Local_117[1 /*45*/].f_38))
	{
...
void func_238(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_388(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_388(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_302(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 13:
			...
			break;
		case 14:
			func_423(GET_HASH_KEY("DOOR_STR_WHORE_INT_2"), bParam1);
			break;
		case 16:
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_462(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_316(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_388(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_477(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
bool func_397(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
void func_532(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_578(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_528(GET_HASH_KEY("CHARACTER"), func_587(), -1591664384, bParam0);
}
