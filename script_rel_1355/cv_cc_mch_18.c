...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1484f, -1.8598f, 0.9909f, 38.16f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -1.1415f, -1.4343f, 0.991f, 50.04f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, 0.295826f, -1.10821f, 0.980011f, 0f, 1.3f, 1.3f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_29 = func_153(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_MCHCNV18"), GET_HASH_KEY("PLAYER_MCHCNV18"));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_337(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_418(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
