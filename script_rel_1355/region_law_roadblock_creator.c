...
void __EntryFunction__()
{
	...
	fLocal_8 = 1f;
	iLocal_14 = 1;
	iLocal_24 = GET_HASH_KEY("WORLD_HUMAN_PEE");
	iLocal_29 = GET_HASH_KEY("POLICEWAGON01X");
	iLocal_30 = GET_HASH_KEY("S_CAMPFIRE02_AMB");
			...
			else
			{
				...
				while (iVar2 < iLocal_37)
				{
					if (func_9(iLocal_37[iVar2], 0))
					{
						...
						TASK::TASK_USE_SCENARIO_POINT(iLocal_37[iVar2], iVar3, 0, 0, false, true, 0, false, -1f, false);
					}
					iVar2++;
				}
				iLocal_14 = 5;
...
void func_26()
{
	...
	Local_78[0 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_SMOKE");
	Local_78[0 /*4*/].f_1 = { 1.5f, 0f, 0f };
	Local_78[1 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL");
	Local_78[1 /*4*/].f_1 = { -1.35f, 0f, 0f };
	Local_78[2 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING");
	Local_78[2 /*4*/].f_1 = { 1f, -2.5f, 0f };
	Local_78[3 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING");
	Local_78[3 /*4*/].f_1 = { 1f, 6f, 0f };
	Local_78[4 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_WRITE_NOTEBOOK");
	Local_78[4 /*4*/].f_1 = { 2f, -2.5f, 0f };
	Local_78[5 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_BADASS");
	Local_78[5 /*4*/].f_1 = { 2f, 2.5f, 0f };
	Local_78[6 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_GUARD_SCOUT");
	Local_78[6 /*4*/].f_1 = { -2f, 2.5f, 0f };
	Local_78[7 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_SMOKE");
	Local_78[7 /*4*/].f_1 = { -2f, -2.5f, 0f };
	Local_45[0 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_SMOKE");
	Local_45[1 /*4*/] = GET_HASH_KEY("WORLD_CAMP_FIRE_COOKING");
	Local_45[2 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_FIRE_TEND_KNEEL");
	Local_45[3 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING");
	Local_45[4 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_SMOKE_NERVOUS_STRESSED");
	Local_45[5 /*4*/] = GET_HASH_KEY("WORLD_CAMP_FIRE_SIT_GROUND");
	Local_45[6 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_GUARD_SCOUT");
	Local_45[7 /*4*/] = GET_HASH_KEY("WORLD_HUMAN_BADASS");
}
...
void func_28(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	if (!func_37(iParam0))
	{
...
void func_31()
{
	...
	while (iVar11 < iLocal_25)
	{
		...
		iLocal_117[iVar11] = TASK::CREATE_SCENARIO_POINT_HASH(Var7, vVar3, fVar6, 0f, 0, 0);
		iVar11++;
	}
	...
	while (iVar15 < iLocal_25)
	{
		...
		func_59(&vVar3, 50, 10, 0);
		iLocal_111[iVar15] = TASK::CREATE_SCENARIO_POINT_HASH(Var7, vVar3, fVar6, 0f, 0, 0);
		iVar15++;
	}
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_74(iParam1))
		{
			func_75(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
