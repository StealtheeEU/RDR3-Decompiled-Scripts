...
{
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_CS_FISHBAG01X"), false);
	STREAMING::_REQUEST_SCENARIO_TYPE(GET_HASH_KEY("WORLD_HUMAN_STERNGUY_IDLES"), 15, 0, 0);
	...
	if (STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_CS_FISHBAG01X")))
	{
...
int func_23(var uParam0)
{
	...
	if (func_46(&iLocal_9, &uLocal_12, 1, 1, 0, 0, 0, 0))
	{
		...
		{
			func_39(0, 1, 1, 0);
			if (!PED::IS_PED_USING_SCENARIO_HASH(uLocal_12[0], GET_HASH_KEY("WORLD_HUMAN_STERNGUY_IDLES")))
			{
				...
				func_47(uLocal_12[0], GET_HASH_KEY("WORLD_HUMAN_STERNGUY_IDLES"), 0, 0, 0, -1082130432 /* Float: -1f */);
			}
		}
...
int func_59(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_35(bVar0, 0))
	{
		if (func_35(PED::_GET_RIDER_OF_MOUNT(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_97(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_127(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_127(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_131(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_70(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_127(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_146(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_154(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_165(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_158(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_158(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_158(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_175(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_158(GET_HASH_KEY("CHARACTER"), func_180(), -1591664384, bParam0);
}
