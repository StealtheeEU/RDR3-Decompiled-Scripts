...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, 0f, 1.1367f, -12.5f, 1f, 1f, 3.395f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 4.3f, -7.2f, 1.0599f, -29f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 1, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_DNACNV1"), GET_HASH_KEY("PLAYER_DNACNV1"));
	func_157(uParam0, iLocal_17, -1, 0.87f);
	func_158(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	func_159(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL_NO_PROPS"), "WORLD_HUMAN_LEAN_BACK_WALL_FEMALE_B", -1, 1);
