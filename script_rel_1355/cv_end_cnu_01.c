...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5001f, 1.2125f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.0251f, -1.175f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_CHARLES"), 1, 1, 1);
	func_152(uParam0, -0.15f, 0f, 0f, 12f, 0.94f, 1.57f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "S_INV_WHISKEY01X", 0, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "w_melee_knife06", 0, 0, 1);
	iLocal_18 = func_153(uParam0, GET_HASH_KEY("P_WOODWHITTLE01X"), 0f, 0f, 0f, "p_woodWhittle01x", 0, 0, 1);
	iLocal_19 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_BARREL04B"), -0.434831f, 1.30266f, -0.00206757f, "p_chair_barrel04b", 1, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "p_chair_crate15x", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_C", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, iLocal_15, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_19, 0);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
