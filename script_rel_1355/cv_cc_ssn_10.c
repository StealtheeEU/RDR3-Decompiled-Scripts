...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 7.823f, 1.9801f, 1.07673f, 0f, 1.1f, 1.1f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_150(uParam0, -1.788f, -2.72449f, 1.06299f, 0f, 1.2f, 1.2f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_20 = func_151(uParam0, GET_HASH_KEY("P_CRATE03B"), 0f, 0f, 0f, "p_crate03x", 0, 0, 1);
	iLocal_21 = func_151(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, iLocal_21, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_158(uParam0, iLocal_14);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_BOX_PUT_DOWN_1"), "WORLD_HUMAN_BOX_PUT_DOWN_1_MALE_A", -1, 0, 45f, 1065353216 /* Float: 1f */, 1);
...
{
	func_175(GET_HASH_KEY("DOOR_LAK_DOCKHOUSE_PROPS_20"), 0, 1f, 1, 1, 0, 0, 0);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (func_204(uParam0, iLocal_16))
	{
		...
		if (bVar0)
		{
			func_206(uParam0, GET_HASH_KEY("COMP_SSNCNV10"), GET_HASH_KEY("PLAYER_SSNCNV10"));
...
int func_254()
{
	...
	if (func_345(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_255()
{
	...
	if (func_345(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_345(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_420(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
