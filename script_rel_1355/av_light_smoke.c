...
int func_2(int iParam0)
{
	...
	iVar0 = GET_HASH_KEY("A_M_M_VALLABORER_01");
	switch (iParam0)
	{
		case 9:
			iVar0 = GET_HASH_KEY("A_M_M_VALLABORER_01");
			break;
		case 11:
			iVar0 = GET_HASH_KEY("A_M_M_RHDUPPERCLASS_01");
			break;
		case 1:
			iVar0 = GET_HASH_KEY("A_M_M_STRTOWNFOLK_01");
			break;
		case 0:
			iVar0 = GET_HASH_KEY("A_M_M_MIDDLESDTOWNFOLK_01");
			break;
		case 15:
			iVar0 = GET_HASH_KEY("A_M_M_ARMTOWNFOLK_01");
			break;
		case 10:
			switch (func_6())
			{
				case 92:
					...
					{
						case 0:
							iVar0 = GET_HASH_KEY("A_M_M_VHTTOWNFOLK_01");
							break;
						case 1:
							iVar0 = GET_HASH_KEY("A_M_M_VHTTOWNFOLK_01");
							break;
					...
					break;
				case 78:
					iVar0 = GET_HASH_KEY("A_M_M_ASBTOWNFOLK_01");
					break;
				case 82:
					iVar0 = GET_HASH_KEY("A_M_M_BTCHILLBILLY_01");
					break;
			}
			break;
		case 13:
			iVar0 = GET_HASH_KEY("A_M_M_TUMTOWNFOLK_01");
			break;
		case 6:
			iVar0 = GET_HASH_KEY("A_M_O_WAPTOWNFOLK_01");
			break;
	}
	return iVar0;
}
...
void func_17(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	if (func_6() == 78)
	{
		switch ((uParam0->f_482 - Global_1415419.f_19[*uParam0 /*12*/].f_8))
		{
			...
			case 5:
			case 6:
				iLocal_37 = GET_HASH_KEY("A_M_M_JAMESONGUARD_01");
				break;
		}
	}
	else if (func_6() == 5)
	{
		...
		{
			case 12:
				iLocal_37 = GET_HASH_KEY("A_M_M_LOWERSDTOWNFOLK_01");
				break;
		}
	}
	else
	...
	func_51(uParam0, 0, "MALE_A", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MALE_B", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_52(uParam0, 0, "CIGARETTE_A", GET_HASH_KEY("P_CIGARETTE01X"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, 1, "CIGARETTE_B", GET_HASH_KEY("P_CIGARETTE01X"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, 3, "MATCHES", GET_HASH_KEY("P_MATCHES01X"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, 2, "MATCH", GET_HASH_KEY("P_MATCHSTICK01X"), 0f, 0f, 0f, 0f, 1);
}
...
int func_34(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						...
						if (!uParam0->f_469[5])
						{
							if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
							{
								...
								func_72(uParam0->f_20[1 /*14*/], GET_HASH_KEY("WORLD_HUMAN_SMOKE"), 60000, 0, GET_HASH_KEY("WORLD_HUMAN_SMOKE_MALE_C"), 0.7f);
...
void func_91(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_128(iParam1))
		{
			func_129(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_203(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_201(int iParam0, int iParam1)
{
	...
	if (func_228(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
