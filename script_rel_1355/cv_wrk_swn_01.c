...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, GET_HASH_KEY("P_CIGARLIT01X"), 0f, 0f, 0f, "p_cigarlit01x", 0, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CIGARLIT01X"), 0f, 0f, 0f, "p_cigarlit01x^1", 0, 1, 1);
	iLocal_14 = func_153(uParam0, GET_HASH_KEY("S_LOOTABLECAMPCASE"), 0f, 0f, 0f, "s_lootablecampcase", 1, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_COIN01X"), 0f, 0f, 0f, "p_coin01x", 0, 1, 1);
	func_154(uParam0, 0.8625f, -0.325f, 0f, -13.5f, 1.665f, 2.31f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_154(uParam0, -1.7625f, 2.9f, 0f, -13.5f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_155(uParam0, GET_HASH_KEY("COMP_SWNWRKCNV1"), GET_HASH_KEY("PLAYER_SWNWRKCNV1"));
	func_156(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	func_157(uParam0, iLocal_16, 1, -1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE_NERVOUS_STRESSED"), "WORLD_HUMAN_SMOKE_NERVOUS_STRESSED_MALE_B", -1, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_384(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
