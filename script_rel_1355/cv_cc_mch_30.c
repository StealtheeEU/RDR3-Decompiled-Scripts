...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.3564f, 5.0196f, 1f, 0f, 1f, 1f, 2.75f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 0.6975f, -2.325f, 0f, -9f, 2.765f, 1.745f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	func_155(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_BADASS"), "WORLD_HUMAN_BADASS_MALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 3, -1);
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
