...
bool func_77(var uParam0)
{
	...
	func_162(uParam0, 0.2625f, -1.4f, 1.15f, -24.94f, 2.7875f, 3.5725f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	func_162(uParam0, 1.2375f, 4.9625f, 1.15f, 6.81f, 1.1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
	iLocal_99 = func_163(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	func_166(uParam0, GET_HASH_KEY("COMP_MLLCNV5"), GET_HASH_KEY("PLAYER_MLLCNV5"));
	func_167(uParam0, iLocal_92, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	func_169(uParam0, iLocal_92, 1, GET_HASH_KEY("WORLD_HUMAN_WAITING_IMPATIENT"), 0, -1, 0, func_168(100f, 140f), 1065353216 /* Float: 1f */, 1);
	...
	func_167(uParam0, iLocal_93, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_169(uParam0, iLocal_93, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_368(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_427(iParam1))
		{
			func_428(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_395(var uParam0, var uParam1)
{
	...
	if (!func_400(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_441("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_358(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_457(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_545(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_557(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_549(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_549(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_549(GET_HASH_KEY("CHARACTER"), func_571(), -1591664384, bParam0);
}
