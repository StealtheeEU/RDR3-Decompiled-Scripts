...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_HITCH_ANIMAL"), false);
		...
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_HORSE_EXIT"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_HORSE_JUMP"), false);
		switch (iLocal_14)
		{
			case 0:
					...
					if (!TASK::PED_HAS_USE_SCENARIO_TASK(Global_35))
					{
						...
						else if (!PED::IS_PED_ON_MOUNT(Global_35) && PED::IS_PED_ON_FOOT(Global_35))
						{
							...
							else if (!func_7(Global_35, 993674639))
							{
								...
								if (bVar1)
								{
									PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("DYNAMIC_KNEEL_QUICK_ENTER"), 2f);
								}
								TASK::TASK_START_SCENARIO_IN_PLACE_HASH(Global_35, GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL"), 0, true, GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_ARTHUR"), -1f, false);
							}
						}
					}
				}
	...
	switch (func_10(uParam0))
	{
		...
		case 10:
			...
			if (func_28(uParam0))
			{
				func_27(uParam0);
				func_46(uParam0, 1);
				(*uParam0)[2] = func_47("CAMP_REC_QUIT", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), 3, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				if (func_48(32))
				{
				...
				(*uParam0)[1] = func_47("CAMP_REC_MAKE", GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				...
				(*uParam0)[3] = func_47(func_54(uParam0), GET_HASH_KEY("INPUT_GAME_MENU_EXTRA_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				(*uParam0)[5] = func_55("RECIPE", GET_HASH_KEY("INPUT_GAME_MENU_LEFT"), GET_HASH_KEY("INPUT_GAME_MENU_RIGHT"), 0);
				func_56((*uParam0)[5], GET_HASH_KEY("INPUT_GAME_MENU_LEFT"));
				func_56((*uParam0)[5], GET_HASH_KEY("INPUT_GAME_MENU_RIGHT"));
				...
				(*uParam0)[6] = func_47("INFO", GET_HASH_KEY("INPUT_GAME_MENU_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				if (!uParam0->f_82)
				{
		...
		case 12:
			...
			if (func_28(uParam0))
			{
				...
				{
					uParam0->f_53 = 250;
					(*uParam0)[1] = func_47("CAMP_REC_MAKE", GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, uParam0->f_53, uParam0->f_53 + 1, 1, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					func_58(uParam0, uParam0->f_77, uParam0->f_78);
				...
				{
					(*uParam0)[1] = func_47("CAMP_REC_MAKE", GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, 250, 251, 1, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					func_73((*uParam0)[1], -1067771379, 0, 1);
			...
			if (func_72(iVar9))
			{
				if (!uParam0->f_36)
				{
					if (func_26((*uParam0)[1], 0))
					{
						if (func_76((*uParam0)[1], 1) || PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT")))
						{
							uParam0->f_36 = 1;
							func_49((*uParam0)[1], 0, 1);
				...
				if (!uParam0->f_36)
				{
					if (!(func_26((*uParam0)[1], 0) && PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"))))
					{
...
{
	if (func_127(iParam0) == GET_HASH_KEY("CONSUMABLE") && INVENTORY::_0x245D07651B1D183B(iParam0, 16777216))
	{
		return true;
	}
	return false;
...
int func_55(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != 0)
	{
		func_116(iVar1, iParam1, sParam0, 0, 3, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam3, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 0, iParam2, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		return iVar1;
	}
	return 0;
}
...
void func_58(var uParam0, int iParam1, int iParam2)
{
	...
	if (bVar3)
	{
		if (((func_89(iParam1, 1, 0) || ((!uParam0->f_83 || uParam0->f_84 > 0) && func_53(iParam1, -1636519629) == -701492487)) || (!uParam0->f_31 && ((uParam0->f_80 || iParam2 == -214678071) || iParam2 == GET_HASH_KEY("COST_CRAFTING_GRILL")))) || (!uParam0->f_32 && iParam2 == GET_HASH_KEY("COST_CRAFTING_GRILL")))
		{
			bVar3 = false;
		}
...
void func_62(var uParam0)
{
	...
	if (!uParam0->f_80 && !func_51(uParam0->f_77))
	{
		...
		func_49((*uParam0)[2], 0, 1);
		func_75((*uParam0)[2], 0, 1);
		(*uParam0)[4] = func_47("CAMP_REC_BACK", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), 1, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
...
void func_64(var uParam0, bool bParam1)
{
	...
	if (DATABINDING::DATABINDING_IS_ENTRY_VALID(uParam0->f_73))
	{
		...
		if (uParam0->f_78 == -214678071 || uParam0->f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
		{
			...
			{
				Var5 = { func_136(-1591664384, -1591664384, 0, 0, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, -1, func_53(uParam0->f_77, 1697966752), 0) };
				if (func_137(Var5, &iVar3, &iVar4, 0))
				{
					if (iVar4 > 0)
					{
		...
		else
		{
			...
			Var19.f_4 = 15;
			Var19.f_36 = 10;
			while (((Var19.f_2 != GET_HASH_KEY("COST_TYPE_CRAFT") || Var19 == -489628648) || (!Global_1911914.f_1579 && func_124(uParam0->f_77, Var19, 1))) && iVar66 < iVar18)
			{
				iVar66++;
				if (bParam1)
				{
...
void func_86(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	func_160(func_159(GET_HASH_KEY("ITEMS_CRAFTED")), iParam1);
	if (bParam3 && iParam0 != GET_HASH_KEY("CONSUMABLE_COFFEE"))
	{
		...
		if (iParam4 == 0)
		{
			if (func_127(iParam0) == GET_HASH_KEY("HORSE_EQUIPMENT"))
			{
	...
	{
		Var1 = { func_167(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("FOOD")) };
	}
	else if (func_121(iParam0, 2))
	{
		Var1 = { func_167(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("AMMO")) };
	}
	else if (func_121(iParam0, 5))
	{
		Var1 = { func_167(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("HORSE_CARE")) };
	}
	else if (func_121(iParam0, 1))
	{
		Var1 = { func_167(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("REMEDIES")) };
	}
	else if (func_121(iParam0, 3))
	{
		Var1 = { func_167(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("WEAPONS")) };
	}
	else if (func_121(iParam0, 4))
	{
		Var1 = { func_167(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("HUNTING")) };
	}
	...
	iVar10 = 0;
	if ((ITEMDATABASE::ITEMDATABASE_FILLOUT_ITEM_INFO(iParam0, &vVar3) && vVar3.z == GET_HASH_KEY("CLOTHING")) && func_169(Global_35, iParam0, &iVar10))
	{
...
void func_114(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		iVar9 = func_184(((iVar7 > 0 && iVar5 > 0) && iVar3 == GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT")), 1, 0);
	}
	else
	{
	...
	if (bParam5)
	{
		if (func_187(iVar3, &Var15, GET_HASH_KEY("INVENTORY"), 0, 0, 0))
		{
		...
		while (iVar33 < iVar32)
		{
			...
			else
			{
				...
				if (func_21(iVar31, 0))
				{
					...
					if (func_187(iVar31, &Var36, GET_HASH_KEY("INVENTORY"), 0, 0, 0))
					{
...
struct<5> func_148(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_127(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_202(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_202(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_167(GET_HASH_KEY("MADE"), iParam0);
}
		...
		while (iVar36 < iVar34)
		{
			...
			if (func_21(iVar33, 0))
			{
				...
				if (func_230(iVar38))
				{
					...
					func_160(func_167(GET_HASH_KEY("USED_IN_RECIPE"), iVar39), Var0[iVar36 /*2*/].f_1);
				}
			}
			iVar36++;
		}
...
void func_164(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_187(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_77(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
int func_165(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_127(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_127(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_127(iParam0) == GET_HASH_KEY("AMMO") && func_271(iParam0))
		{
		...
		{
			func_160(func_159(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_160(func_167(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_77(iParam0, 589988438))
		{
			if (func_277())
			{
				func_278(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_170(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_290(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_170(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_296(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_297(499813453, 0);
				func_298(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_296(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_297(499813453, 0);
				func_298(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_296(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_297(499813453, 0);
				func_298(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_296(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_297(666607663, 0);
				func_299(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_296(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_297(666607663, 0);
				func_299(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_296(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_297(666607663, 0);
				func_299(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_296(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_297(-220219788, 0);
				func_300(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_296(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_297(-220219788, 0);
				func_300(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_296(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_297(-220219788, 0);
				func_300(4);
				Jump @4453; //curOff = 3664
				func_296(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_297(218622660, 0);
				func_301(1);
				Jump @4453; //curOff = 3697
				func_296(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_297(218622660, 0);
				func_301(2);
				Jump @4453; //curOff = 3730
				func_296(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_297(390004462, 0);
				func_302(1);
				Jump @4453; //curOff = 3763
				func_296(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_297(390004462, 0);
				func_302(2);
				Jump @4453; //curOff = 3796
				func_296(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_297(390004462, 0);
				func_302(4);
				Jump @4453; //curOff = 3829
				func_296(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_297(6410548, 0);
				func_303(1);
				Jump @4453; //curOff = 3860
				func_296(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_297(6410548, 0);
				func_303(2);
				Jump @4453; //curOff = 3891
				func_296(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_297(6410548, 0);
				func_303(4);
				Jump @4453; //curOff = 3922
				func_296(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_297(6410548, 0);
				func_303(8);
				Jump @4453; //curOff = 3954
				func_304(242, func_244(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				Jump @4453; //curOff = 3973
				func_304(240, func_244(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				Jump @4453; //curOff = 3992
				func_304(241, func_244(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
...
void func_168(int iParam0)
{
	...
	func_246(MISC::VAR_STRING(6, func_326(iParam0), fVar1), "itemtype_textures", func_327(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_169(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_127(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_23() != -1;
...
void func_183(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (func_187(iVar0, &Var10, GET_HASH_KEY("INVENTORY"), 0, 0, 0))
	{
	...
	{
		iVar15 = func_184(((iVar9 > 0 && iVar7 > 0) && iVar0 == GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT")), 1, 0);
	}
	else
	{
...
bool func_186(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iParam1 == -214678071 || iParam1 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
	{
		...
		if (uParam2->f_32)
		{
			Var2 = { func_136(-1591664384, -1591664384, 0, 0, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, -1, iVar12, 0) };
			if (func_137(Var2, &iVar0, &iVar1, 0))
			{
				...
				while (iVar13 < iVar1)
				{
					...
					else if (!Global_1911914.f_1579 && func_124(iVar14, GET_HASH_KEY("COST_CRAFTING_GRILL"), 1))
					{
					}
					else if (func_88(iVar14, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, bParam3, 0, 0) && !func_89(iVar14, 1, 0))
					{
						func_139(iVar0);
						*iParam4 = iVar14;
...
bool func_189(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	while (iVar34 < iVar31)
	{
		...
		else
		{
			...
			if (Var0[iVar34 /*2*/] == GET_HASH_KEY("CURRENCY_CASH") && func_359(iVar32))
			{
				Jump @390; //curOff = 134
			}
			else if (Var0[iVar34 /*2*/] == GET_HASH_KEY("CURRENCY_GOLD_BAR") && func_360(iVar32))
			{
			}
			else
			{
...
bool func_194(int iParam0)
{
	...
	if (func_77(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")))
	{
		return true;
	}
...
{
	return func_202(GET_HASH_KEY("CHARACTER"), func_373(), -1591664384, bParam0);
}
...
{
	return func_127(iParam0) == GET_HASH_KEY("WEAPON");
}
...
{
	if (func_376(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
bool func_225(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (func_127(iParam0) == GET_HASH_KEY("WEAPON"))
	{
...
bool func_236(int iParam0, int iParam1)
{
	...
	if (func_395(Var14, iParam1))
	{
		if (func_396(iParam0))
		{
			if (func_397(GET_HASH_KEY("SLOTID_HORSE_HORN"), &iVar18))
			{
		...
		{
			if (func_397(GET_HASH_KEY("SLOTID_HORSE_HORN"), &iVar19))
			{
				if (func_236(iVar19, 0))
				{
				}
			}
			if (func_397(GET_HASH_KEY("SLOTID_HORSE_STIRRUP"), &iVar20))
			{
...
int func_239()
{
	...
	{
		iVar14 = func_398(Var5, GET_HASH_KEY("SLOTID_HORSE_SADDLE"), 0);
	}
	if (!func_21(iVar14, 0))
	{
		return 0;
...
void func_265(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_423(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_423(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_270(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_149(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_433())
				{
					return false;
				}
...
bool func_272(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_221(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_273(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_437()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_277()
{
	if (((((func_445(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_445(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_445(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_445(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_445(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_445(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_279(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_265(51, 0, 0, 0, 0, -1, 0);
			func_449(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_265(51, 0, 0, 0, 0, -1, 0);
			func_449(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_263(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_453(1), 0, -1, 0);
			func_454(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_263(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_453(2), 0, -1, 0);
			func_454(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_263(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_453(4), 0, -1, 0);
			func_454(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_263(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_453(8), 0, -1, 0);
			func_454(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_263(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_453(16), 0, -1, 0);
			func_454(16);
			break;
	}
}
...
void func_282(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_256(437, 0);
			func_256(440, 0);
			func_457(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_265(51, 0, 0, sVar0, func_415(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_449(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_457(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_265(51, 0, 0, sVar0, func_415(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_449(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_457(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_265(51, 0, 0, sVar0, func_415(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_449(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_457(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_265(51, 0, 0, sVar0, func_415(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_449(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_256(438, 0);
			func_457(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_263(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_265(51, 0, 0, sVar0, func_415(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_449(32768);
			break;
		default:
			func_256(439, 0);
...
void func_284(int iParam0, int iParam1)
{
	...
	if (func_23() == -1)
	{
		...
		{
			func_459(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_460() == 0)
			{
				func_409(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_459(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_460() == 1)
			{
				func_409(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_462(iParam0) < func_463(iParam0))
					{
						func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_459(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_460() == 2)
			{
				func_409(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_464(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_465(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_168(48);
					}
					if (func_462(iParam0) < func_463(iParam0))
					{
						func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_459(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_460() == 3)
			{
				func_409(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_462(iParam0) < func_463(iParam0))
					{
						func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_459(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_460() == 4)
			{
				func_409(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_462(iParam0) < func_463(iParam0))
					{
						func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_287(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_278(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_278(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_278(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_278(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_278(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_278(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_278(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_278(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_278(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_278(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_278(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_278(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_469())
			{
				func_278(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_278(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_278(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_278(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_278(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_278(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_278(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_278(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_278(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_278(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_278(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_278(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_278(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_278(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_288(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_409(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_470(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_471(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_472(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_297(int iParam0, bool bParam1)
{
	...
	func_423(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_310(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_480(81053684, 0) <= 0)
			{
	...
	{
		if (!func_487(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_170(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_267(24);
		if (func_290(&iVar2, 0))
		{
...
int func_312(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_489(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_313(int iParam0)
{
	...
	if (func_77(iParam0, -305066475))
	{
		if (func_23() == -1)
		{
			...
			{
				return func_491(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_491(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_77(iParam0, -537818634))
	{
		return func_491(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_77(iParam0, 2084895747))
	{
		return func_491(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_315(int iParam0, char* sParam1)
{
	...
	func_246(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_494(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_357(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar48 < iVar0)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_ACQUIRE_COST(iParam1, iVar48, &Var1))
		{
			if (Var1 != iParam2)
			{
				if ((Var1.f_2 == GET_HASH_KEY("COST_TYPE_CRAFT") && Var1 != -489628648) && (Global_1911914.f_1579 || !func_124(iParam1, Var1, 1)))
				{
...
void func_358(var uParam0, int iParam1)
{
	...
	Var3 = { func_136(-1591664384, -1591664384, 0, 0, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, -1, iVar2, 0) };
	if (func_137(Var3, &iVar0, &iVar1, 0))
	{
		iVar13 = 0;
		while (iVar13 < iVar1)
		{
			...
			if (func_21(iVar14, 0))
			{
				if (Global_1911914.f_1579 || !func_124(iVar14, GET_HASH_KEY("COST_CRAFTING_GRILL"), 1))
				{
					Global_1911914[(uParam0->f_55 - 1) /*9*/].f_7++;
				}
			}
...
void func_378(int iParam0)
{
	...
	Var0 = { func_491(GET_HASH_KEY("CAREER_CASH")) };
...
void func_379(int iParam0, char* sParam1, int iParam2)
{
	...
	func_246(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 1, GET_HASH_KEY("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_429(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_23() == -1)
			{
				if (!func_487(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_573(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_433())
					{
					...
					func_170(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
int func_446(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_221(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_447(int iParam0, char* sParam1, int iParam2)
{
	...
	func_246(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_448(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_246(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_246(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_160(func_491(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_455()
{
	...
	while (iVar1 < 30)
	{
		if (func_584(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_494(int iParam0)
{
	...
	if (!func_620(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
void func_503(int iParam0, int iParam1, int iParam2)
{
	...
	func_423(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_632(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
			...
			if (func_77(iParam0, 412399755))
			{
				...
				if (func_460() == 0)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_462(iParam0) < func_463(iParam0))
						{
							func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_77(iParam0, 709057512))
			{
				...
				if (func_460() == 1)
				{
					...
					if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_462(iParam0) < func_463(iParam0))
						{
							func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_77(iParam0, -1478961327))
			{
				...
				if (func_460() == 2)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_ACUNAS_STAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CIGAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_462(iParam0) < func_463(iParam0))
						{
							func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_77(iParam0, -1238404098))
			{
				...
				if (func_460() == 3)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_462(iParam0) < func_463(iParam0))
						{
							func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_77(iParam0, 1160548794))
			{
				...
				if (func_460() == 4)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_462(iParam0) < func_463(iParam0))
						{
							func_263(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
int func_536(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == GET_HASH_KEY("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_663(GET_HASH_KEY("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == GET_HASH_KEY("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_665(GET_HASH_KEY("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_666(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_151(GET_HASH_KEY("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_548()
{
	...
	while (iVar1 < 30)
	{
		if (func_669(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_574()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_162(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_309(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_162(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_309(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_583(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_581())
	{
		func_246(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_246(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_489(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_489(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_489(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}
...
int func_625(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_147(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_147(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_147(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}
...
void func_673()
{
	...
	func_726(0);
	func_727(7);
	func_728(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_484() == 1160113249)
	{
		func_728(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
...
void func_685(int iParam0)
{
	...
	Var0 = { func_491(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_696()
{
	...
	func_309(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_324(1);
	func_503(1, iVar0, 0);
}
...
void func_698()
{
	...
	func_309(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_324(2);
	func_503(2, iVar0, 0);
}
...
void func_699()
{
	...
	func_309(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_324(0);
	func_503(0, iVar0, 0);
}
...
{
	if ((func_77(iParam0, -839724752) || func_77(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL"))) || func_77(iParam0, 1286414894))
	{
		return true;
	}
	return false;
...
struct<5> func_748(int iParam0)
{
	...
	Var0 = { func_749(iParam0, GET_HASH_KEY("CHARACTER"), func_373(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
