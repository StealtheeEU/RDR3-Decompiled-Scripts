...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 37.025f, -10.025f, -2.675f, -2.75f, 3.005f, 5.265f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_FEATHER01X"), 3f, 3f, 0f, "Feather", 0, 0, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_BCUNJCNV1"), GET_HASH_KEY("PLAYER_BCUNJCNV1"));
	func_157(uParam0, iLocal_16, -1, 0.59f);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 0);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
