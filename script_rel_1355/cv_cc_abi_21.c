...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -0.0125f, 0.5375f, 1.4875f, 0f, 2.1875f, 2.18f, 2.7575f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_ABICNV21"), GET_HASH_KEY("PLAYER_ABICNV21"));
	func_156(uParam0, iLocal_17, -1, 0.9f);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 1, 45f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_14, 1, 24, 0, 0, 0);
	func_160(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1);
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1, 35f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	iLocal_16 = func_161(uParam0, -2.6625f, -3f, 2.6125f, 0f, 0f, 0f, 17.2325f, 16.44f, 3.575f, "Trigger", GET_HASH_KEY("VOLBOX"));
	func_162(uParam0, 1);
	return true;
}
