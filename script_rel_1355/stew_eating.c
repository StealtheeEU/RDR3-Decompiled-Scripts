...
void __EntryFunction__()
{
	...
	if (!func_2(iVar180, 0))
	{
		iVar180 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW");
	}
	if (func_3())
	{
		if (Global_1357549.f_1492 != GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE"))
		{
		...
		else
		{
			...
			if (func_5(iVar181, 1))
			{
				...
				{
					Global_1357549.f_1492 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE_EGGS");
				}
				else
				{
					Global_1357549.f_1492 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE");
				}
				iVar180 = Global_1357549.f_1492;
			}
			else
	...
	STREAMING::_REQUEST_CLIP_SET_BY_HASH(GET_HASH_KEY("MECH_DYNAMIC@PROP_PLAYER_DYNAMIC_SEAT_CHAIR_TABLE@ARTHUR@TRANS@A_STEW_TRANS_GENERIC_A"));
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_SPOON01X_FOOD"), false);
	Var0.f_1 = iVar180;
	if (!ScriptParam_0.f_3)
	{
		func_1(1);
	...
	while (!SCRIPTS::IS_THREAD_EXIT_REQUESTED() && !ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		if (!ScriptParam_0.f_3)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(Var0.f_179))
			{
				if (STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_SPOON01X_FOOD")))
				{
					Var0.f_179 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("P_SPOON01X_FOOD"), Global_36, false, true, false, false, true);
		...
		switch (Var0)
		{
			...
			case 1:
				...
				if (iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_BASE"))
				{
					if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1))
					{
						iVar183 = TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_35);
						if (iVar183 == GET_HASH_KEY("PROP_PLAYER_DYNAMIC_SEAT_CHAIR_TABLE"))
						{
							TASK::_0xB35370D5353995CB(Global_35, GET_HASH_KEY("EAT_STEW_BOWL_TABLE_BASE"), 1f);
						}
						else if (iVar183 == GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_DYNAMIC"))
						{
							TASK::_0xB35370D5353995CB(Global_35, GET_HASH_KEY("EAT_STEW_BOWL_CHAIR_BASE"), 1f);
						}
					}
				}
				else if (iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_TABLE_BASE") || iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_CHAIR_BASE"))
				{
					if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1) || TASK::IS_PED_EXITING_SCENARIO(Global_35, false))
					{
						TASK::_0xB35370D5353995CB(Global_35, GET_HASH_KEY("EAT_STEW_BOWL_BASE"), 1f);
					}
				}
			...
			case 2:
				...
				if (iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_BASE") || iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_CHAIR_BASE"))
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_35, "HIDE_STEW_EAT_PROMPT", true, 1);
					if (!func_9(-1))
					{
						if (iVar182 != GET_HASH_KEY("EAT_STEW_BOWL_CHAIR_BASE"))
						{
							TASK::_0xB35370D5353995CB(Global_35, GET_HASH_KEY("EAT_STEW_BOWL_EAT_FINISH_DISCARD_AUTO"), 0.25f);
						}
						else
						{
							TASK::_0xB35370D5353995CB(Global_35, GET_HASH_KEY("EAT_STEW_BOWL_CHAIR_EAT_FINISH_DISCARD_AUTO"), 0.25f);
						}
						func_8(&Var0, 3);
					}
				}
				else if (iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_TABLE_BASE") || (iVar182 == GET_HASH_KEY("EAT_STEW_BOWL_TABLE_EAT_FINISH_HOLD") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 1160706425)))
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_35, "HIDE_STEW_EAT_PROMPT", true, 1);
					if (!func_9(-1))
					{
						PED::_0x6D07B371E9439019(Global_35);
						PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("A_STEW_TRANS_GENERIC_A"), 1.5f);
					}
				}
				break;
			case 3:
...
void func_34(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_70(func_69(GET_HASH_KEY("MEDICINE_ITEMS_USED")), 1);
	}
	if (func_20(iParam0, -1457797660))
	{
		func_70(func_69(GET_HASH_KEY("PROVISION_ITEMS_USED")), 1);
	}
	...
	{
		func_70(func_73(GET_HASH_KEY("USED"), GET_HASH_KEY("TONIC")), 1);
	}
	switch (iParam0)
	{
		...
		case GET_HASH_KEY("CONSUMABLE_HAYCUBE"):
			func_70(func_73(GET_HASH_KEY("USED"), GET_HASH_KEY("FEED_BAG")), 1);
			break;
	}
	switch (iParam0)
	{
		case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
			func_70(func_73(GET_HASH_KEY("USED"), GET_HASH_KEY("MOONSHINE")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_WHISKEY_USED"):
		case GET_HASH_KEY("CONSUMABLE_WHISKEY"):
			func_70(func_73(GET_HASH_KEY("USED"), GET_HASH_KEY("WHISKEY")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case GET_HASH_KEY("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_70(func_73(GET_HASH_KEY("USED"), GET_HASH_KEY("COCAINE_GUM")), 1);
			break;
	...
	if (func_45() == -1)
	{
		...
		{
			func_70(func_73(GET_HASH_KEY("USED"), GET_HASH_KEY("SPECIAL_TONIC")), 1);
		}
	}
	if (bParam2)
	{
		func_70(func_69(GET_HASH_KEY("DEADEYE_ITEMS_USED")), 1);
	}
}
...
void func_72(int iParam0, int iParam1)
{
	...
	Var0 = { func_73(GET_HASH_KEY("EATEN"), func_108(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_70(func_109(GET_HASH_KEY("HERBS_EATEN")), iParam1);
}
