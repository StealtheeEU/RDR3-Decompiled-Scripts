...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			iLocal_42 = GET_HASH_KEY("P_CHAIR_BARREL04B");
			break;
		case 2:
			func_149(uParam0, 86, 0, 0, 0);
			iLocal_42 = GET_HASH_KEY("P_CHAIR_CRATE15X");
			break;
		case 3:
	...
	func_151(uParam0, -9.1875f, 4f, 0f, 18.5f, 1.8875f, 1.0825f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 0f, 0f, 0f, 0f, 1.2f, 1.2f, 4f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 0.382276f, 0.59386f, 1.00287f, 0f, 1.1f, 1.1f, 4f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_19, 3, GET_HASH_KEY("PROP_HUMAN_CAMP_FIRE_SEAT_BOX"), "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", iLocal_20, 0);
	func_157(uParam0, iLocal_19, 3, GET_HASH_KEY("PROP_HUMAN_CAMP_FIRE_SEAT_BOX"), "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
