...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.846151f, 0.412679f, 1.05988f, 3f, 0.9f, 0.9f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, -0.0243275f, 0.117172f, 0.549988f, 3f, 0.8f, 2f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_STOOL03X"), 0f, 0f, 0f, "p_stool03x", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SSNCNV2"), GET_HASH_KEY("PLAYER_SSNCNV2"));
	...
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_19, 0, 20f, 0f, 1);
	func_158(uParam0, iLocal_14, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 0f, 1);
	func_160(uParam0, iLocal_15, 4, 1);
	func_159(uParam0, iLocal_15, 1, -1);
	iLocal_40 = func_161(uParam0, 5.1001f, 1.0375f, 0f, 0f, 0f, 0f, 11.6375f, 3.7475f, 3f, "InitialTrigger", GET_HASH_KEY("VOLBOX"));
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (bLocal_41)
	{
		...
		{
			iLocal_42 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(uParam0->f_1711[iLocal_19 /*15*/].f_10, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), 0f, 0f, 0.5f, 160f, 0, 0, 0);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(func_48(uParam0, iLocal_14), false, true);
			TASK::TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_14), iLocal_42, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", 0, false, true, 0, false, -1f, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_402(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
