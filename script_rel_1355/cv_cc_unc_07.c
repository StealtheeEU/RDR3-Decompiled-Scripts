...
bool func_74(var uParam0)
{
	...
	func_153(uParam0, 0.0125f, -0.25f, 1.15f, 1.81f, 3.1925f, 3.055f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_153(uParam0, 3.4249f, 8.675f, 1.15f, 10.25f, 1.285f, 2.97f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	iLocal_17 = func_154(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.172f, -1.185f, 0.004f, 0, 1, 0, 1);
	func_154(uParam0, GET_HASH_KEY("P_CS_ROLLUPCIG01X"), 0f, 0f, 0f, "p_cs_rollupcig01x", 0, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STERNGUY_IDLES"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 3, 0);
	func_159(uParam0, iLocal_15, 2, 2, 0, "Default_Angry", 0);
	func_160(uParam0, iLocal_15, 1, -1);
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL"), "PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL_MALE_A", iLocal_17, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_160(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, GET_HASH_KEY("COMP_UNCCNV7"), GET_HASH_KEY("PLAYER_UNCCNV7"));
