...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, GET_HASH_KEY("P_CS_BOOK03X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLEBEER", 0, 0, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CHAIR02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	func_153(uParam0, 0f, 0f, 0f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_UNCLE"), 1, 1, 1);
	func_153(uParam0, 0f, 0f, 0f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BCUNCCNV6"), GET_HASH_KEY("PLAYER_BCUNCCNV6"));
	func_156(uParam0, iLocal_19, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", -1, 0);
	func_157(uParam0, iLocal_19, 3, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_20, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
