...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, 0.87499f, 0.291573f, 0.481659f, 3f, 0.9f, 0.9f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -0.00493374f, -0.044972f, 0.582031f, 3f, 0.8f, 2f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	if (!func_154(1) && !func_154(2))
	{
		func_153(uParam0, GET_HASH_KEY("P_STOOL03X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	}
	if (!func_154(1) && !func_154(2))
	{
	...
	iLocal_21 = func_157(uParam0, 2.82f, -0.137f, 1f, 0f, 0f, 90f, 5f, 6f, 3f, "TRIGGER", GET_HASH_KEY("VOLBOX"));
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
	func_159(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	func_158(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	func_159(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_162(uParam0, iLocal_15, 4, 1);
	func_160(uParam0, iLocal_15, 1, -1);
	func_163(uParam0, 1);
	func_164(uParam0, GET_HASH_KEY("COMP_MRBCNV2"), GET_HASH_KEY("PLAYER_MRBCNV2"));
	if (func_154(1) || func_154(2))
	{
		func_165(uParam0);
		func_166(uParam0);
