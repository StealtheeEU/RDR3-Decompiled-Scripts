	...
	switch (iLocal_3)
	{
		case 0:
			...
			if (ENTITY::DOES_ENTITY_EXIST(PED::GET_MOUNT(Global_35)))
			{
				if (!PED::IS_PED_INJURED(PED::GET_MOUNT(Global_35)))
				{
					bLocal_5 = PED::GET_MOUNT(Global_35);
					if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("native3_outro_horse_ride"))
					{
						...
						Var0.f_12 = 1.501f;
						Var0.f_14 = -1f;
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_5, true);
						TASK::TASK_FOLLOW_WAYPOINT_RECORDING_ADVANCED(bLocal_5, &Var0);
						func_46(&uLocal_6);
						iLocal_3++;
					}
				}
				...
				if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_2, true, false))
				{
					if (ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_2, "pbl_ig19_coughing_exitlt") && ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_2, "pbl_ig19_coughing_exitrt"))
					{
						if (func_47(&uLocal_6) && func_48(&uLocal_6) >= 3000)
						{
							...
							ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_2, ENTITY::GET_ENTITY_COORDS(bLocal_5, true, false), ENTITY::GET_ENTITY_ROTATION(bLocal_5, 2), 2);
							ANIMSCENE::ATTACH_ANIM_SCENE_TO_ENTITY(uParam0->f_2, PED::GET_MOUNT(Global_35), PED::GET_PED_BONE_INDEX(bLocal_5, 29245));
		...
		case 2:
			...
			if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_2))
			{
				...
				{
					if (ENTITY::DOES_ENTITY_EXIST(bLocal_5))
					{
						if (!PED::IS_PED_INJURED(bLocal_5))
						{
							if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_5, "native3_outro_horse_ride"))
							{
								if (ANIMSCENE::GET_ANIM_SCENE_PHASE(uParam0->f_2) >= 0.17f)
								{
									TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(bLocal_5, 0f, 0, 0.4f, 0);
								}
							}
							if (!func_26(iLocal_4, 256))
							{
								...
								{
									TASK::TASK_LOOK_AT_COORD(bLocal_5, ENTITY::GET_ENTITY_COORDS(Global_35, true, false), 7500, 2048, 51, 0);
		...
		case 6:
			...
			func_50(GET_HASH_KEY("MPC_HIDE_ACTION_HAT"), Global_35, 0, 1);
		...
		case 7:
			...
			if (func_54(&Local_13, &cLocal_9, 1, 1))
			{
				if (STREAMING::IS_IPL_ACTIVE_HASH(1798244378))
				{
					...
					{
						if (STREAMING::IS_LOAD_SCENE_LOADED() || (func_47(&uLocal_6) && func_55(&uLocal_6) >= 15f))
						{
							STREAMING::_0x5A8B01199C3E79C3();
							func_49(&iLocal_4, 32);
							if (!PED::IS_PED_INJURED(bLocal_5))
							{
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_5, false, true);
								ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bLocal_5, 2920.626f, 1324.657f, 43.1178f, 67.9963f, true, false, true);
								ENTITY::PLACE_ENTITY_ON_GROUND_PROPERLY(bLocal_5, false);
								FLOCK::SET_ANIMAL_TUNING_BOOL_PARAM(bLocal_5, 48, true);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_5, true);
								TASK::TASK_STAND_STILL(bLocal_5, -1);
							}
		...
		case 8:
			...
			if (!func_26(iLocal_4, 128))
			{
				if (func_56(&Local_13))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_13.f_156, false) && ANIMSCENE::GET_ANIM_SCENE_PHASE(Local_13.f_156) >= 0.55f)
					{
						func_52(&Local_13, 1);
						MISC::SET_WEATHER_TYPE(GET_HASH_KEY("MISTY"), true, true, false, 0f, false);
						GRAPHICS::SET_TIMECYCLE_MODIFIER("sicksun");
						PED::SET_PED_CONFIG_FLAG(Global_35, 336, true);
						func_57(Global_35, GET_HASH_KEY("MPC_HIDE_ACTION_HAT"), 0);
		...
		case 10:
			...
			{
				func_60(Global_35, "COUGH_SICK_SMALL", GET_HASH_KEY("SPEECH_PARAMS_FORCE_NORMAL_CRITICAL"), 0, 1, 0, 0, 1);
				MISC::CLEAR_WEATHER_TYPE_PERSIST();
...
void func_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_68(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_50(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	return func_79(iParam0, bParam1, bParam2, bParam3);
}
...
{
	func_104(bParam0, iParam1, bParam2, 1);
}
...
bool func_58(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_105(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, false)) && (ANIMSCENE::_0xEF324E9550A394D5(uParam4->f_156) || func_83(uParam4, 512)))
			{
...
int func_73(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_33(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_135(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
int func_79(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	...
	return func_145(bParam1, iVar0, bParam2, 1);
}
...
void func_98(var uParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_4) && !func_158(uParam0->f_5, 0f, 0f, 0f))
	{
...
{
	if ((!func_83(uParam0, 32768) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156)) && ANIMSCENE::IS_ANIM_SCENE_METADATA_LOADED(uParam0->f_156, false))
	{
		func_161(uParam0);
		func_162(uParam0, 0);
...
int func_104(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	...
	return func_167(bParam0, iVar0, bParam2, bParam2);
}
...
void func_106(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, false)) || ANIMSCENE::_0xEF324E9550A394D5(uParam0->f_156)) || func_83(uParam0, 512))
	{
		if (!func_128(uParam0->f_213, 128))
		{
			func_130();
...
bool func_119(var uParam0)
{
	...
	if (ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(uParam0->f_156) && func_83(uParam0, 1048576))
	{
		return true;
	}
	return false;
...
void func_121(var uParam0, int iParam1)
{
	...
	{
		func_198(Global_35, GET_HASH_KEY("CLOTHING_ITEM_NECKWEAR_NONE"), 0, 1742327865, 0, 1, 0, 0, 1, 0);
		func_199(GET_HASH_KEY("KIT_BANDANA"), 0);
	}
...
float func_135(int iParam0, bool bParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
	...
	return func_181(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_145(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (iParam1 == 0)
	{
		iParam1 = -1;
	...
	if (!bParam2)
	{
		...
		{
			func_212(13, iParam1, 1, bParam0, 0);
		}
		return 1;
	}
	if (!func_213(0))
	...
	func_193(&(Global_1946804.f_1497), bParam0, 1, iParam1, 1, bParam3, 1);
	return 1;
}
...
int func_167(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (iParam1 == 0)
	{
		iParam1 = -1;
	...
	if (!bParam2)
	{
		...
		{
			func_212(14, iParam1, 1, bParam0, 0);
		}
		return 1;
	}
	if (!func_225(0))
...
bool func_170(bool bParam0, bool bParam1)
{
	if (!func_202(Global_43801))
	{
		Global_43801 = func_228("CUTSCENE_SKIP", GET_HASH_KEY("INPUT_SKIP_CUTSCENE"), 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("LONG_TIMED_EVENT"), 0);
...
void func_177(bool bParam0)
{
	...
	if (func_236(GET_HASH_KEY("CAMERA_ITEM")))
	{
	}
	...
	if (func_238(&iVar0))
	{
		if (func_239(iVar0, 0))
		{
			if (func_240(iVar0) == -525676072)
			{
				...
				func_198(Global_35, GET_HASH_KEY("CLOTHING_ITEM_HAT_NONE"), 0, 1108822547, 0, 1, 0, 0, 0, 0);
			}
			else
			{
...
void func_189(var uParam0)
{
	...
	if (func_83(uParam0, 2048) && !func_86(func_254(uParam0)))
	{
		...
		if ((!ENTITY::IS_ENTITY_DEAD(bVar1) && ((bVar0 && ENTITY::IS_ENTITY_IN_VOLUME(bVar1, uParam0->f_4, true, 0)) || func_83(uParam0, -2147483648))) && PED::GET_MOUNT(Global_35) != bVar1)
		{
			...
			func_256(bVar1, func_254(uParam0), func_255(uParam0), iVar2, 1073741824 /* Float: 2f */);
		}
		...
		{
			func_256(bVar3, func_254(uParam0), func_255(uParam0), 2, 1073741824 /* Float: 2f */);
		}
	}
}
...
void func_190(var uParam0)
{
	...
	if ((func_83(uParam0, 268435456) && !func_86(func_254(uParam0))) && PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(bVar0))
		{
			...
			func_256(bVar0, vVar1, func_257(vVar1, Global_36, 1), 2, 1073741824 /* Float: 2f */);
...
void func_193(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		{
			func_261(bParam1, 29, bVar4, 1, 0);
			func_261(bParam1, 31, bVar4, 1, 0);
			func_261(bParam1, 30, bVar4, 1, 0);
			func_261(bParam1, 22, bVar4, 1, 0);
			func_261(bParam1, 37, bVar4, 1, 0);
		}
	}
	if ((func_262(32768) && func_263(1108822547, 8)) && func_264(10, iParam3))
	{
		func_265(bParam1, 0, 1);
	}
	iVar0 = 0;
	while (iVar0 < 39)
	{
			...
			else
			{
				...
				else if ((func_263(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946804.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
					if (!func_263(iVar3, 1) || bParam2)
					{
						...
						if (!bParam6)
						{
							func_261(bParam1, iVar1, bVar4, 1, 0);
						}
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_261(bParam1, iVar1, bVar4, 1, uParam0->f_1[iVar1 /*3*/]);
							}
...
int func_198(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	struct<5> Var0;
	int iVar5;
...
void func_199(int iParam0, bool bParam1)
{
	...
	INVENTORY::_0x65A5F70F4A292EBE(func_281(0), &Var5, bParam1);
}
...
void func_256(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam0 == func_308(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_309(bParam0))
	{
		if (func_310(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(bParam0);
		}
	}
	if (func_26(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_256(bVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_256(bVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_26(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_26(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_26(iParam5, 32), true);
	...
	else if (func_26(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_26(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_26(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
void func_261(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_265(bool bParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	...
	if (func_263(1108822547, 6))
	{
		if (bParam2)
		{
			func_261(bParam0, iVar0, func_207() != -1, 0, 0);
...
struct<5> func_271(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_313(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_279(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_279(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_279(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_281(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_301(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_336(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
	...
	if (iParam0 == Global_35)
	{
		func_337(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
{
	return func_279(GET_HASH_KEY("CHARACTER"), func_342(), -1591664384, bParam0);
}
...
int func_337(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
int func_340(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_367("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if ((((((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) || func_369(Var4.f_4)) && (!WEAPON::IS_WEAPON_SHOTGUN(Var4.f_4) || func_366(iParam1, 16))) && (!WEAPON::_IS_WEAPON_SNIPER(Var4.f_4) || func_366(iParam1, 4))) && (!func_369(Var4.f_4) || func_366(iParam1, 8))) && (!WEAPON::IS_WEAPON_REPEATER(Var4.f_4) || !func_366(iParam1, 8388608))) && (!WEAPON::IS_WEAPON_RIFLE(Var4.f_4) || !func_366(iParam1, 1048576)))
				{
...
void func_341(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		sVar2 = func_371(fParam1 < 0f, "rpg_cold", "rpg_hot");
