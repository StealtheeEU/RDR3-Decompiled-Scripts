...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.6427f, 1.1787f, 1.0095f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_151(uParam0, -6.53f, -0.9429f, 0.9891f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGAR", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_PRSCNV1"), GET_HASH_KEY("PLAYER_PRSCNV1"));
	func_156(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_GRAB_CARROT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
