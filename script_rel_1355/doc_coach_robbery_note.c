		...
		else if (func_31(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_60(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_60(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_60(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
...
void func_88(var uParam0, int iParam1)
{
	...
	else if (func_68(iParam1, 1224357681) == GET_HASH_KEY("CI_TAG_FOLDER_BOUNTY_POSTERS"))
	{
...
void func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_244(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_244(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_121(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_224(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_262())
				{
					return false;
				}
...
bool func_123(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_60(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_124(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_266()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_131()
{
	if (((((func_275(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_275(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_275(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_275(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_275(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_275(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_133(int iParam0)
{
	switch (iParam0)
	{
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_106(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_283(1), 0, -1, 0);
			func_284(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_106(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_283(2), 0, -1, 0);
			func_284(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_106(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_283(4), 0, -1, 0);
			func_284(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_106(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_283(8), 0, -1, 0);
			func_284(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_106(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_283(16), 0, -1, 0);
			func_284(16);
			break;
	}
}
...
void func_136(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_99(437, 0);
			func_99(440, 0);
			func_287(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_106(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_108(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_279(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_287(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_106(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_108(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_279(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_287(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_106(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_108(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_279(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_287(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_106(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_108(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_279(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_99(438, 0);
			func_287(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_106(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_108(51, 0, 0, sVar0, func_236(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_279(32768);
			break;
		default:
			func_99(439, 0);
...
void func_138(int iParam0, int iParam1)
{
	...
	if (func_116() == -1)
	{
		...
		{
			func_289(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_290() == 0)
			{
				func_231(0, 10);
		...
		{
			func_289(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_290() == 1)
			{
				func_231(0, 10);
		...
		{
			func_289(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_290() == 2)
			{
				func_231(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_294(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_295(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_230(48);
					}
					if (func_292(iParam0) < func_293(iParam0))
					{
		...
		{
			func_289(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_290() == 3)
			{
				func_231(0, 10);
		...
		{
			func_289(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_290() == 4)
			{
				func_231(0, 10);
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946804.f_57[func_305(iParam3, 1) /*11*/])
			{
				func_308(31, 0, 0, 0, 0);
			}
			break;
...
void func_152(int iParam0, bool bParam1)
{
	...
	func_244(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_166(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_322(81053684, 0) <= 0)
			{
	...
	{
		if (!func_329(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
...
int func_168(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_331(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_169(int iParam0)
{
	...
	if (func_31(iParam0, -305066475))
	{
		if (func_116() == -1)
		{
			...
			{
				return func_333(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_333(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_31(iParam0, -537818634))
	{
		return func_333(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_31(iParam0, 2084895747))
	{
		return func_333(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_171(int iParam0, char* sParam1)
{
	...
	func_337(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_336(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_172(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_341(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
...
struct<5> func_220(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_109(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_257(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("WEAPON"):
			...
			if (bParam2 && func_369(iParam0, 1))
			{
				...
				else if (func_256(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_257(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_224(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_216(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_256(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_369(iParam0, 1))
			{
				...
				else if (func_256(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
void func_230(int iParam0)
{
	...
	func_337(MISC::VAR_STRING(6, func_385(iParam0), fVar1), "itemtype_textures", func_386(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_250(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_116() == -1)
			{
				if (!func_329(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_421(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_262())
					{
...
int func_276(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_60(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_277(int iParam0, char* sParam1, int iParam2)
{
	...
	func_337(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_278(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_337(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_337(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_127(func_333(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
void func_353(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & 1 == 0)
	{
		...
		if (((!func_516(iParam0) || func_183(Global_1347702[iParam0 /*49*/].f_12, 1)) || func_183(Global_1347702[iParam0 /*49*/].f_12, 512)) || func_527(Global_1347702[iParam0 /*49*/].f_13, 2048))
		{
...
void func_364(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	uVar0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, func_532(iParam0));
...
{
	return func_257(GET_HASH_KEY("CHARACTER"), func_535(), -1591664384, bParam0);
}
...
{
	if (func_536(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
void func_384(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_539(iParam0) && func_540(iParam0))
	{
		if (!bParam2)
		{
			...
			if (fParam1 > IntToFloat(func_542(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
...
int func_396()
{
	...
	while (iVar1 < 30)
	{
		if (func_548(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_440(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_438())
	{
		func_337(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_337(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_567(&(Global_1946804.f_2589), iParam0);
}

void func_455(int iParam0, int iParam1)
{
	func_568(&(Global_1946804.f_2589), iParam0, iParam1);
}
...
void func_457(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_569(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
...
void func_459(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_574(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_461(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_116() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_577(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_484(0))
		{
...
{
	func_331(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_331(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_331(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}
...
bool func_496(int iParam0, int iParam1, bool bParam2)
{
	...
	switch (iParam1)
	{
		...
		case -2074770370:
			...
			else if (func_68(iParam0, -949239683) == -1337515701 && iParam0 != GET_HASH_KEY("KIT_PLAYER_POCKETWATCH"))
			{
				return true;
			}
			else
...
void func_512(int iParam0, int iParam1)
{
	...
	func_611(&(Global_1347702[iParam0 /*49*/].f_12), 16384);
...
void func_544(int iParam0, int iParam1, int iParam2)
{
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_632(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_244(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_633(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_551(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_634(&iVar0, 0, iVar95, &Var1) && !func_634(&iVar0, 1, iVar95, &Var1))
		{
		}
...
void func_552()
{
	...
	func_637(0);
	func_638(7);
	func_639(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_326() == 1160113249)
	{
		func_639(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_639(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_640(Global_35, &uVar0);
}
...
void func_565(int iParam0)
{
	...
	Var0 = { func_333(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_576(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_116() == -1)
	{
		func_653(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_654(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_655(&(Global_1946804.f_1378), iParam0);
...
bool func_600(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_110(iParam0, 8388608))
		{
			...
			{
				if (func_60(GET_HASH_KEY("DOCUMENT_RARE_ORCHID_ORDER_1"), 1, 0))
				{
					if (!func_48(48))
					{
						return false;
...
struct<4> func_627(int iParam0, int iParam1)
{
	char cVar0[32];
...
void func_688(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4)
{
...
int func_732(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar31 = func_740(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar31) && func_741(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar31), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
...
struct<5> func_768(int iParam0)
{
	...
	Var0 = { func_769(iParam0, GET_HASH_KEY("CHARACTER"), func_535(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
