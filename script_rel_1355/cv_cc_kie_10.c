...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.56f, -0.42f, 1f, 95.04f, 4f, 6f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KIERAN"), 1, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_HORSEGELDING01X"), 0f, 0f, 0f, "CLAMP", 0, 1, 1);
