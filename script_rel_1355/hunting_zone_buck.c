...
bool func_42(var uParam0)
{
	*uParam0 = 5;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = GET_HASH_KEY("P_BUCKTUFTS01X");
	uParam0->f_572[1] = GET_HASH_KEY("P_BUCKSCAT01X");
	uParam0->f_572[2] = GET_HASH_KEY("P_BUCKSCAT01X");
	uParam0->f_580[0] = 1;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 0;
	uParam0->f_588[0] = 4;
	...
	uParam0->f_596[1] = 1;
	uParam0->f_596[2] = 1;
	uParam0->f_12.f_1 = GET_HASH_KEY("A_C_BUCK_01");
	uParam0->f_12.f_3 = 0.65f;
	uParam0->f_671 = { -0.422618f, 0.906308f, 1.35f };
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = GET_HASH_KEY("META_OUTFIT_ANIMAL_ALBINO_BUCK");
	return true;
}
