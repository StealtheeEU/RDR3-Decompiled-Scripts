...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7875f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_24 = func_152(uParam0, 0.192943f, -2.19054f, 1.00161f, 0f, 1.3f, 1.3f, 3.2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_23, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", -1, 0);
