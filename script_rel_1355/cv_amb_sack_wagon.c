...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, -1.4f, 1f, 0f, 6f, 10f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("WAGON02X"), 0f, 0f, 0f, "WAGON", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_SACKCORN01X"), 0f, 0f, 0f, "SACK_A", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_SACKCORN01X"), 0f, 0f, 0f, "SACK_B", 0, 1, 1);
...
bool func_83(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_16))
	{
		iLocal_16 = VEHICLE::CREATE_VEHICLE(GET_HASH_KEY("WAGON02X"), uParam0->f_23, 0f, true, true, true, false);
	}
	else
	{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_201(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_203(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_204(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_202(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
int func_238()
{
	...
	if (func_313(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_239()
{
	...
	if (func_313(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_324(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_357(iParam1))
		{
			func_358(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_349(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_234(iParam0, 1073741824 /* Float: 2f */))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_202(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_199(vVar0)) && !func_200(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
...
void func_390(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_435(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_435(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_406(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_202(iParam0, 1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_313(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_377(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_435(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_454(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<4> func_466(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_484(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_466(GET_HASH_KEY("CHARACTER"), func_488(), -1591664384, bParam0);
}
