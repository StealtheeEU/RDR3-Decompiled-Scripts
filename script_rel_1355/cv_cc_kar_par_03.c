...
bool func_72(var uParam0)
{
	...
	func_152(uParam0);
	func_153(uParam0);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE0", 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE1", 0, 0, 1);
	func_154(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE2", 0, 1, 1);
	func_155(uParam0, "script@vignette@party@karen_3@base", 1, 1, 0, 0);
	func_155(uParam0, "script@vignette@party@karen_3@action", 0, 0, 1, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_B", -1, 1);
	func_157(uParam0, iLocal_14, 4, 6, 0, 0, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("STAND"), 0, -1, 1);
	if (!func_151(11))
	{
		func_158(uParam0, iLocal_16, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	func_158(uParam0, iLocal_17, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_18, 2, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
