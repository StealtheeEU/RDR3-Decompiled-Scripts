...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.06f, -1.82f, 0f, 0f, 3.8f, 2.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -5.9402f, 3.1623f, 0.7783f, -165.5995f, 1.5f, 1.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_152(uParam0, iLocal_14, 1.1f);
	func_152(uParam0, iLocal_15, 1.1f);
	func_153(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CIGAR02X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_DNHCNV7"), GET_HASH_KEY("PLAYER_DNHCNV7"));
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
