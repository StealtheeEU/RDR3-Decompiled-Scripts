...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 3.975f, -3.15f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_153(uParam0, -1.475f, -3.4875f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	func_153(uParam0, -0.2875f, 0.025f, 0.85f, 0f, 3.285f, 1.9625f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
	iLocal_16 = func_154(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_CS_FISHBAG01X"), 0f, 0f, 0f, "FISHBAG", 0, 1, 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_BLLWRKCNV1"), GET_HASH_KEY("PLAYER_BLLWRKCNV1"));
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1);
	func_160(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
