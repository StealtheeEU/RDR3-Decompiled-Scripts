...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_74 = GET_HASH_KEY("A_C_DOGHOUND_01");
...
void func_4()
{
	...
	switch (iLocal_73)
	{
		case 1:
			...
			{
				iLocal_75 = GET_HASH_KEY("S_M_M_AMBIENTLAWRURAL_01");
			}
			iLocal_73 = 2;
			break;
		case 2:
...
void func_17(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_5(Local_41[iParam0 /*10*/].f_1[iVar0], 0))
		{
			...
			func_6(Local_41[iParam0 /*10*/].f_1[iVar0]);
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_41[iParam0 /*10*/].f_1[iVar0], Local_41[iParam0 /*10*/].f_6, vVar1, 2f, -1, 0.1f, 1, 1, 0, 0, 1, 0);
		}
		iVar0++;
	}
}
...
void func_18(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_5(Local_41[iParam0 /*10*/].f_1[iVar0], 0))
		{
			...
			MAP::BLIP_ADD_FOR_ENTITY(GET_HASH_KEY("BLIP_STYLE_ENEMY"), Local_41[iParam0 /*10*/].f_1[iVar0]);
			MAP::REMOVE_BLIP(&(Local_41[iParam0 /*10*/].f_8));
		}
		iVar0++;
	}
...
bool func_25(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, float fParam9, int iParam10, float fParam11)
{
	int iVar0;
	...
	switch (*iParam3)
	{
		case 0:
			...
			func_30(&(iParam3->f_1), iParam3->f_2, vParam0, iParam5, iParam7, iParam8, fParam9, iParam10, fParam11);
...
void func_35(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_37(iParam1))
		{
			func_38(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
