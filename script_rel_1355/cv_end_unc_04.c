...
bool func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, GET_HASH_KEY("P_PITCHFORK01X"), 0f, 0f, 0f, "PITCHFORK", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP01X"), 0f, 0f, 0f, "POOP_01", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "POOP_02", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP02X"), 0f, 0f, 0f, "POOP_02^1", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("S_HORSEPOOP03X"), 0f, 0f, 0f, "POOP_03", 0, 0, 1);
	...
	iLocal_18 = func_154(uParam0, -0.18f, 3.03f, 1.9f, 0f, 0f, 136.28f, 10.12f, 9.24f, 4f, "volTriggerBeecherUncle4", GET_HASH_KEY("VOLBOX"));
	func_155(uParam0, 1);
	func_156(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_PITCH_FORK_PUT_DOWN"), "WORLD_HUMAN_PITCH_FORK_PUT_DOWN_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
