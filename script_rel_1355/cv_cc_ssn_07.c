...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -5.3825f, 0.085f, 1.15f, 6.81f, 1.1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.875f, -1.25f, 1.15f, -38.44f, 3.51f, 4.1475f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_21 = func_152(uParam0, GET_HASH_KEY("P_CS_KNITTING01X"), 0f, 0f, 0f, "KNITING", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_POCKETMIRROR01X"), 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_154(uParam0, iLocal_20, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_155(uParam0, iLocal_20, 2, 0, 30, 0, 0);
	func_154(uParam0, iLocal_19, 3, GET_HASH_KEY("WORLD_HUMAN_POCKET_MIRROR"), "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_19, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 0.3f, 1);
