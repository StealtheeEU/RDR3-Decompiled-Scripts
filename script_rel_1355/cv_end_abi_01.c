...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_151(uParam0, GET_HASH_KEY("A_C_COW"), "COW");
	func_152(uParam0, 1.3527f, 1.6955f, 1.0578f, -94.52f, 2.8f, 2.8f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, 1.35f, 1.65f, 0f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_154(uParam0, GET_HASH_KEY("P_CS_BUCKET01BX"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	func_154(uParam0, GET_HASH_KEY("P_STOOL02X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	...
	func_157(uParam0, GET_HASH_KEY("COMP_BCABICNV1"), GET_HASH_KEY("PLAYER_BCABICNV1"));
	func_158(uParam0, iLocal_14, 1, -1);
	iLocal_18 = func_159(uParam0, -2.25f, 2.1f, 1.95f, 0f, 0f, -4f, 10.75f, 7.48f, 4f, "volTrigger", GET_HASH_KEY("VOLBOX"));
	func_160(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_17), GET_HASH_KEY("STAND"), 0, false, 0, -1f, false);
