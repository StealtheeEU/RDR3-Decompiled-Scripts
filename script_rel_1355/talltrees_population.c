...
void __EntryFunction__()
{
	...
	func_1();
	func_2();
	PERSCHAR::_0x187D65F3AEC5D679(GET_HASH_KEY("GLO_WILDERNESS_TRAPPER"), "TallTrees/Tal_Trapper_1");
...
void func_2()
{
	...
	if (func_5() == 8)
	{
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -1628.978f, -1384.765f, 87.31792f, 0f, 0f, 1.805961f, 117.1854f, 142.6396f, 34.00172f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -1583.582f, -1286.059f, 83.24481f, 0f, 0f, 1.805961f, 65.34718f, 62.69049f, 35.94681f);
