...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -3.55f, -5.1475f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_150(uParam0, -0.5375f, 0.3275f, 0f, -25f, 2.1825f, 4.2175f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	func_152(uParam0, "script@vignette@dog_6@base", 1, 1, 0, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@dog_6@action", 0, 0, 1, 0);
	func_153(uParam0, GET_HASH_KEY("COMP_DOGCNV6"), GET_HASH_KEY("PLAYER_DOGCNV6"));
	func_154(uParam0, iLocal_17, -1, 0.88f);
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1);
	func_156(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
