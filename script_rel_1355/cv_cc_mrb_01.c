...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.95049f, 0.327781f, 1.00836f, 3f, 0.9f, 0.9f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 0.048638f, 0.0721679f, 0.778168f, 3f, 0.8f, 2f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	if (!func_153(1) && !func_153(2))
	{
		func_152(uParam0, GET_HASH_KEY("P_STOOL03X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	}
	...
	func_156(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1f, 0f, 1);
	func_156(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	func_157(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_40 = func_159(uParam0, 5.9125f, 1.0375f, 0f, 0f, 0f, 0f, 13.625f, 7.3375f, 3f, "InitialTrigger", GET_HASH_KEY("VOLBOX"));
	iLocal_41 = func_159(uParam0, 5.5249f, -0.05f, 0f, 0f, 0f, 3.75f, 10.345f, 5.505f, 3f, "ActionTrigger", GET_HASH_KEY("VOLBOX"));
	func_160(uParam0, 1);
	if (func_153(1) || func_153(2))
	{
		func_161(uParam0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
