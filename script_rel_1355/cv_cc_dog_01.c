...
bool func_1(var uParam0)
{
	...
	{
		func_10(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), -2060316038, 1120952528, -1, 1, 1, 0);
	}
	else
	{
		func_11(12, 1, 1, 1, 1);
...
bool func_89(var uParam0)
{
	...
	func_171(uParam0, 0.45f, -3.3475f, 0f, 0f, 2.23f, 2.09f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	func_171(uParam0, -0.7f, -0.0975f, 0f, 0f, 1.1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_172(uParam0, 0.850932f, -3.3277f, 1.03721f, 0f, 1.1f, 1.1f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_23 = func_173(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_24 = func_173(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.570846f, 0.213419f, -0.438812f, 0, 1, 0, 1);
	...
	func_177(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_24, 0);
	func_178(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_179(uParam0, iLocal_16, iLocal_23, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_176(uParam0, iLocal_16, 1, -1);
	func_180(uParam0, GET_HASH_KEY("COMP_DOGCNV1"), GET_HASH_KEY("PLAYER_DOGCNV1"));
...
int func_270()
{
	...
	if (func_350(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_271()
{
	...
	if (func_350(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_362(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_412(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_412(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_350(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_440(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
{
	return func_480(GET_HASH_KEY("CHARACTER"), func_514(), -1591664384, bParam0);
}
