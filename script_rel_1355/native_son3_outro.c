...
bool func_6(var uParam0)
{
	...
	switch (iLocal_4)
	{
		case 0:
			...
			else if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_8))
			{
				iLocal_8 = ANIMSCENE::_CREATE_ANIM_SCENE("script@story@NTS3@leadout@ext@leadout", 0, 0, false, true);
				bVar0 = false;
			}
			else if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_8, true, false))
			{
			...
			if (!ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_8, "pbl_Cough_A"))
			{
				...
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Cough_A");
				}
				bVar0 = false;
			}
			if (!ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_8, "pbl_Cough_B"))
			{
				...
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Cough_B");
				}
				bVar0 = false;
			}
			if (!ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_8, "pbl_Labored_Breath"))
			{
				...
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Labored_Breath");
				}
				bVar0 = false;
			}
			if (!ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_8, "pbl_Wipe_Face"))
			{
				...
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Wipe_Face");
				}
				bVar0 = false;
			}
			if (bVar0)
...
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_8))
	{
...
bool func_24(var uParam0)
{
	...
	{
		case 0:
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_8, false))
			{
				func_44(&uLocal_15);
				iLocal_3 = 1;
			}
		...
		case 1:
			...
			break;
		case 2:
			if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_8, false))
			{
				iLocal_3 = 3;
			}
			break;
...
void func_45(bool bParam0)
{
	...
	PAD::ENABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_FEED_INTERACT"), true);
...
bool func_46()
{
	...
	if (bLocal_11 == 1)
	{
		fVar1 = PAD::GET_CONTROL_NORMAL(0, GET_HASH_KEY("INPUT_MOVE_UD"));
		if (((fVar1 >= 0.5f || fVar1 <= -0.5f) || PAD::IS_CONTROL_JUST_PRESSED(0, GET_HASH_KEY("INPUT_SPRINT"))) || bLocal_10)
		{
			if (!bLocal_10)
			{
				bLocal_10 = true;
...
bool func_65()
{
	...
	if (ANIMSCENE::IS_ANIM_SCENE_IN_SECTION(iLocal_8, "Idle", true))
	{
		return true;
	}
	return false;
...
bool func_67(char* sParam0, int iParam1)
{
	if (!ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_8, sParam0))
	{
		...
		{
			ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, sParam0);
		}
	}
	else if (func_84() || iParam1)
	{
		ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(iLocal_8, sParam0, true);
		if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_8, false))
		{
...
int func_84()
{
	...
	if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_8) >= 0.98f)
	{
		return 1;
	}
	return 0;
