...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	iLocal_18 = func_156(uParam0, GET_HASH_KEY("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE1", 0, 1, 1);
	func_156(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	iLocal_17 = func_156(uParam0, GET_HASH_KEY("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_160(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", iLocal_17, 0);
	func_161(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_97(var uParam0)
{
	...
	{
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), func_209(uParam0, iLocal_18), "p_Javierknife_temp_PH_R_HAND", GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), iLocal_34, "p_cs_rag01x_PH_L_HAND", GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
	}
	return true;
}
...
bool func_197(var uParam0)
{
	...
	{
		iLocal_31 = func_304("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_207(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			func_320(iVar0, 1);
			func_321();
			func_323(func_322(GET_HASH_KEY("CAMP_REQUESTS_STARTED")), 1);
			return 1;
		}
		iVar0++;
	}
...
int func_257()
{
	...
	if (func_347(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_258()
{
	...
	if (func_347(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_367(GET_HASH_KEY("CONSUMABLE_MEDICINE"));
...
void func_315(int iParam0)
{
	...
	{
		case 9:
			if (func_368(GET_HASH_KEY("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_369();
				func_370(GET_HASH_KEY("REWARD_PED_SMALL"), 0.68f);
				func_370(GET_HASH_KEY("REWARD_PED_MEDIUM"), 0.68f);
				func_370(GET_HASH_KEY("REWARD_PED_LARGE"), 0.68f);
			}
			break;
	}
}
...
void func_316(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			func_376(1, GET_HASH_KEY("CONSUMABLE_WHISKEY"), 0);
			func_376(2, GET_HASH_KEY("CONSUMABLE_PEPPERMINT"), 0);
			func_376(3, GET_HASH_KEY("CONSUMABLE_HERB_MILKWEED"), 0);
			func_376(4, GET_HASH_KEY("CONSUMABLE_HAIR_GREASE"), 0);
			func_376(5, 0, GET_HASH_KEY("AT_SKUNK"));
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_319(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_382(&uVar4, GET_HASH_KEY("COLOR_PURE_WHITE"));
...
void func_358(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_409(iParam1))
		{
			func_410(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_377(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_425("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_373(uParam0->f_3)), GET_HASH_KEY("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", GET_HASH_KEY("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_383(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_347(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
int func_422(int iParam0, bool bParam1)
{
	...
	if (!func_473(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_474(iVar14);
...
void func_462(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_513(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_513(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_347(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_433(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_513(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_534(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_515(GET_HASH_KEY("CHARACTER"), func_538(), -1591664384, bParam0);
}
...
struct<5> func_543(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_420(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_515(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_515(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
