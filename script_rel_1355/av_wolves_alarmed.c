...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_WOLF_MEDIUM");
	iLocal_10 = GET_HASH_KEY("A_C_WOLF_SMALL");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "WAP_WOLF_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "WAP_WOLF_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.75f, 0.5f, 0f), (20f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WAP_WOLF_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "WAP_WOLF_4", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3.5f, -2.5f, 0f), (-110f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], GET_HASH_KEY("WORLD_ANIMAL_WOLF_SLEEPING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1f, false);
				func_65(&(uParam0->f_20[0 /*14*/]), 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_64(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], GET_HASH_KEY("WORLD_ANIMAL_WOLF_SITTING"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1f, false);
			...
			while (iVar0 <= 3)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[iVar0 /*14*/], GET_HASH_KEY("WORLD_ANIMAL_WOLF_RESTING"), uParam0->f_20[iVar0 /*14*/].f_5, uParam0->f_20[iVar0 /*14*/].f_8, 0, false, true, 0, -1f, false);
		...
		case 3:
			...
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_20[0 /*14*/], Global_35, 0, -1f, -1f, -1f);
			}
...
void func_62(var uParam0)
{
	...
	while (iVar0 <= 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			...
			TASK::TASK_FLEE_PED(0, Global_35, 2, 256, -1082130432 /* Float: -1f */, -1, 0);
