...
bool func_78(var uParam0)
{
	...
	func_163(uParam0, -1.5876f, 0.8444f, 0.9953f, -90.72f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_103 = func_164(uParam0, GET_HASH_KEY("P_CRATE03X"), 0f, 0f, 0f, "CRATE", 0, 0, 1);
	iLocal_104 = func_164(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	...
	iLocal_119 = func_167(uParam0, -1.36f, 0.24f, 0.703f, 0f, 0f, -90f, 2.5f, 2.5f, 2f, "volAntiGrief", GET_HASH_KEY("VOLCYLINDER"));
	func_168(uParam0, iLocal_92, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_103, 0, 15f, 1065353216 /* Float: 1f */, 1);
	func_169(uParam0, iLocal_92, 1);
	func_170(uParam0, iLocal_92, 4, 3, 0, 0, 0);
	func_171(uParam0, iLocal_92, 1, -1);
	func_172(uParam0, GET_HASH_KEY("COMP_DNMCNV2"), GET_HASH_KEY("PLAYER_DNMCNV2"));
	func_168(uParam0, iLocal_93, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", iLocal_104, 0, 10f, 1065353216 /* Float: 1f */, 1);
...
int func_277()
{
	...
	if (func_363(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_278()
{
	...
	if (func_363(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_373(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_432(iParam1))
		{
			func_433(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_390(var uParam0, var uParam1)
{
	...
	if (!func_395(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_440("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_475(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_524(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_524(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_363(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_462(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
