...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_80 = GET_HASH_KEY("DEAD_CARRIABLE_RABBIT");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	iLocal_24 = func_152(uParam0, GET_HASH_KEY("A_C_RABBIT_01"), "RABBIT");
	func_153(uParam0, 4.5375f, 3.1625f, 1f, 80f, 2.5f, 2.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_154(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "Stick", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_INSPECT"), "WORLD_HUMAN_INSPECT_MALE_B", -1, 1);
	func_158(uParam0, iLocal_14, 1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_CAMP_JACK_POKE_GROUND_STICK"), "WORLD_CAMP_JACK_POKE_GROUND_STICK_MALE_A", -1, 1);
	...
	iLocal_79 = PED::_REQUEST_METAPED_OUTFIT(GET_HASH_KEY("A_C_RABBIT_01"), -1153495004);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_395(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
