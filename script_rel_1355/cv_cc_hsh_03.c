...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.0193f, 0.0081f, 0.5071f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, GET_HASH_KEY("COMP_HSHCNV3"), GET_HASH_KEY("PLAYER_HSHCNV3"));
