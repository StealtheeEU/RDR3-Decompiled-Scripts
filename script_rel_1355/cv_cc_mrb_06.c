...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.85f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, 0.2f, 4.525f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, 0.614285f, -1.53936f, 1.00907f, 0f, 1.2f, 1.2f, 3.2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_BROOM02X"), 0f, 0f, 0f, "BROOM", 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_BROOM_WORKING"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_BROOM_WORKING"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1, 45f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_WAITING_IMPATIENT"), "WORLD_HUMAN_WAITING_IMPATIENT_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_WAITING_IMPATIENT"), "WORLD_HUMAN_WAITING_IMPATIENT_FEMALE_A", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
