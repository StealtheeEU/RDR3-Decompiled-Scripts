...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_ELK_01");
	iLocal_10 = GET_HASH_KEY("A_C_CARDINAL_01");
	iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_ELK_GRAZING");
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 116:
			...
			iLocal_9 = GET_HASH_KEY("A_C_ALLIGATOR_01");
			break;
		case 117:
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_DEER_GRAZING");
			iLocal_9 = GET_HASH_KEY("A_C_BUCK_01");
			break;
		case 118:
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_BUFFALO_GRAZING");
			iLocal_9 = GET_HASH_KEY("A_C_BUFFALO_01");
			break;
		case 119:
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_COW_GRAZING");
			iLocal_9 = GET_HASH_KEY("A_C_COW");
			break;
		case 120:
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_ELK_GRAZING");
			iLocal_9 = GET_HASH_KEY("A_C_ELK_01");
			...
			{
				iVar0 = 0;
				iLocal_12 = GET_HASH_KEY("META_OUTFIT_ANIMAL_ELK_M_001");
			}
			break;
		case 121:
			iLocal_9 = GET_HASH_KEY("A_C_MOOSE_01");
			iLocal_11 = GET_HASH_KEY("WORLD_ANIMAL_MOOSE_GRAZING");
			if (bVar1)
			{
				iVar0 = 0;
				iLocal_12 = GET_HASH_KEY("META_OUTFIT_ANIMAL_MOOSE_M_001");
			}
			break;
	}
	if (*uParam0 == 116)
	{
		iLocal_10 = GET_HASH_KEY("A_C_HERON_01");
	}
	else
	{
		...
		switch (iVar2)
		{
			case 0:
				...
				break;
			case 1:
				iLocal_10 = GET_HASH_KEY("A_C_BLUEJAY_01");
				break;
			case 2:
				iLocal_10 = GET_HASH_KEY("A_C_CROW_01");
				break;
		}
	}
	func_48(uParam0, 1, "BOA_BIRD_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	...
	switch (iLocal_13)
	{
		...
		case 2:
			if (func_73(uParam0->f_20[0 /*14*/], 0))
			{
				if (*uParam0 != 119)
				{
					TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
				}
				else
				{
...
Vector3 func_67(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 117:
			return 0f, -0.22f, 0f;
		case 118:
			if (iLocal_10 == GET_HASH_KEY("A_C_CROW_01"))
			{
				return 0f, -0.41f, 0f;
			}
			else
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_157(iParam1))
		{
			func_158(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_190(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
