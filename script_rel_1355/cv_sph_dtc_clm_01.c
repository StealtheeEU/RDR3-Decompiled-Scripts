...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3f, -2.0004f, 0f, 0f, 4.5f, 3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, vLocal_22, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 0, 1, 1);
	func_151(uParam0, vLocal_26, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 0, 1, 1);
	func_151(uParam0, vLocal_30, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 0, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_20 = func_152(uParam0, GET_HASH_KEY("P_CIGAR02X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("S_CARAVANCOT01X"), 0.822632f, -0.14147f, 0.238159f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, GET_HASH_KEY("COMP_DTCSPEECHCLMCNV1"), GET_HASH_KEY("PLAYER_DTCSPEECHCLMCNV1"));
	func_159(uParam0, iLocal_21, -1, 0.85f);
	func_160(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, iLocal_14, 4, 3, 0, 0, 0);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0);
	...
	func_153(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), 0, -1, 0);
	...
	func_153(uParam0, iLocal_17, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0);
...
void func_412(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_453(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_453(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_402(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_453(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_470(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_478(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_490(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_482(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_482(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_482(GET_HASH_KEY("CHARACTER"), func_504(), -1591664384, bParam0);
}
