...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.7624f, -8.755f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 0.891524f, -2.01747f, 1.00526f, 0f, 1.2f, 1.2f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_POTATOHALF01X"), 0f, 0f, 0f, "POTATO01", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_POTATOHALF01X"), 0f, 0f, 0f, "POTATO02", 0, 1, 1);
	...
	func_155(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_GRAB_POTATO_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_401(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
