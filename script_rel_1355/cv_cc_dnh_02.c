...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, GET_HASH_KEY("P_CHAIR24X"), 0f, 0f, 0f, "p_chair04x", 0, 0, 1);
	func_152(uParam0, 1.73738f, -1.67007f, -1.92981f, 0f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, 1.5599f, 1.30484f, -1.93771f, 0f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DNHCNV2"), GET_HASH_KEY("PLAYER_DNHCNV2"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_CAMP_FIRE_STANDING"), "WORLD_CAMP_FIRE_STANDING_MALE_E", -1, 1);
	...
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_K", -1, 0);
	func_161(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_K", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
