...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3991f, 0.23f, 0f, 0f, 2.5f, 2.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_SKETCHBOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_PENCIL01X"), 0f, 0f, 0f, "PENCIL", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_DNHCNV6"), GET_HASH_KEY("PLAYER_DNHCNV6"));
	func_156(uParam0, iLocal_23, -1, 0.9f);
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SKETCHING"), "PROP_HUMAN_SEAT_CHAIR_SKETCHING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
