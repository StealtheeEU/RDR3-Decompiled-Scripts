...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -1.26f, -1.2004f, 0f, 0f, 4f, 4f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, vLocal_32, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 0, 1, 1);
	func_152(uParam0, vLocal_36, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 0, 1, 1);
	func_152(uParam0, vLocal_40, 0f, 1.2f, 1.2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 0, 1, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_DTCCNV4"), GET_HASH_KEY("PLAYER_DTCCNV4"));
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, iLocal_21, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_160(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0);
	...
	func_157(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), 0, -1, 0);
	...
	func_157(uParam0, iLocal_17, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0);
...
void func_348(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_388(iParam1))
		{
			func_389(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_404(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
