...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.45f, 1.21f, 0f, 0f, 2.5f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_15 = func_153(uParam0, GET_HASH_KEY("P_CIGAR02X"), 0f, 0f, 0f, "p_cigar01x_PH_R_HAND", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_PHONOGRAPH01X"), 0f, 0f, 0f, "p_phonograph01x", 1, 0, 1);
	if (bVar0)
	{
		func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 0);
	}
	else
	{
		func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
