...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 2:
			...
			if (VOLUME::DOES_VOLUME_EXIST(Local_14.f_2[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_14.f_2[0], true, 0))
			{
				if (!func_39(Local_14.f_7, 2) && AUDIO::PREPARE_SOUND("LIGHTENING_STRIKE", "DSLIT_Sounds", -2))
				{
...
{
	if (VOLUME::DOES_VOLUME_EXIST(Local_14.f_2[0]))
	{
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_49(*uParam0))
			{
				uParam0->f_6.f_8 = func_75("DISCO_FOCUS", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_75("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_75("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_75("DISCO_EXAMINE", GET_HASH_KEY("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("PLAYER_FOCUS_TIMING"), 0, 0);
		}
		...
		if (bParam1)
		{
			...
			if (*uParam0 == -890175011)
			{
				if (func_90() == (5 - 1))
				{
					if (func_86())
					{
						func_89(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR"), 0);
						iVar0 = GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_AR");
					}
					else
					{
						func_89(GET_HASH_KEY("JOURNAL_TOWN_SECRET_VAMPMAP_JN"), 0);
...
bool func_54(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, char* sParam11)
{
	if (!VOLUME::DOES_VOLUME_EXIST(*uParam0))
	{
...
bool func_91()
{
	...
	if (!func_127(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
void func_100(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_141(func_140(GET_HASH_KEY("HONOR_POSITIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_141(func_140(GET_HASH_KEY("HONOR_NEGATIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_143(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_140(GET_HASH_KEY("HONOR_CURRENT")) };
...
bool func_119(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_114(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::GET_DRIVER_OF_VEHICLE(iVar0) == Global_35)
		{
			return false;
		}
	}
			...
			if (func_175(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_163(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_131() <= -160;
...
void func_146(int iParam0)
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_181(iParam0))
		{
			func_141(func_140(GET_HASH_KEY("DISCOVERABLE_FOUND")), 1);
		}
	}
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_129(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_192(int iParam0, bool bParam1)
{
	...
	if (!func_201(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_191(iVar14);
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_129(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return true;
	}
...
{
	return func_205(GET_HASH_KEY("CHARACTER"), func_206(), -1591664384, bParam0);
}
...
struct<4> func_205(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_129(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
