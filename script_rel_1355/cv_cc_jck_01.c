...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -4.6948f, -6.0379f, 0.5953f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, -0.6181f, -4.9017f, 1.0264f, 0f, 2f, 2.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_153(uParam0, GET_HASH_KEY("P_HAMMER02X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_NAILBOX01X"), 0f, 0f, 0f, "NAILBOX", 0, 0, 1);
	func_153(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "STICK", 0, 0, 1);
	if (func_148(uParam0) == 1)
	{
		func_153(uParam0, GET_HASH_KEY("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL1", 0, 0, 1);
		func_153(uParam0, GET_HASH_KEY("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL2", 0, 0, 1);
