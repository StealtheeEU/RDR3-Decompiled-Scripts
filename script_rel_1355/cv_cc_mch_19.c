...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.62f, -1.09f, 1f, 0f, 3f, 4f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_15 = func_152(uParam0, GET_HASH_KEY("P_HAMMER03X"), 0f, 0f, 0f, "HAMMER", 0, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARTHIN01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (iVar0 == 1)
	{
		iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CRATE03C"), 0.335795f, 0.233134f, 0.478706f, 0, 1, 0, 1);
	}
	...
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
