...
bool func_78(var uParam0)
{
	...
	func_158(uParam0, -0.45f, -0.92f, 0f, -96.48f, 3.955f, 4.8675f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	Local_41 = { func_159(uParam0, 0.0157f, 0.3739f, 1f, -180f, 6f, 0.967f, 0.939f) };
	iLocal_39 = func_160(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0.8f, 0.491f, -0.004f, "crate02", 0, 0, 1);
	iLocal_38 = func_160(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 1.314f, 1.778f, -0.062f, "crate15", 0, 0, 1);
	iLocal_40 = func_160(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	func_165(uParam0, iLocal_18, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", -1, 0);
	func_166(uParam0, iLocal_18, 3, -1);
	func_167(uParam0, iLocal_18, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_38, 0, 110f, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (!MAP::DOES_BLIP_EXIST(iLocal_52))
	{
		...
		{
			iLocal_52 = MAP::BLIP_ADD_FOR_COORDS(-678244495, ENTITY::GET_ENTITY_COORDS(func_8(uParam0, iLocal_18), true, false));
			MAP::SET_BLIP_SPRITE(iLocal_52, GET_HASH_KEY("BLIP_AMBIENT_SECRET"), true);
		}
	}
	if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_96))
	{
		...
		{
			iLocal_96 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_49(uParam0, iLocal_39), GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_GENERIC"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
		...
		if ((bParam1 || !func_112(iParam0)) || func_57(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_215(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_251(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_252(iParam0, 0));
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_297(uParam0->f_33[iVar0], 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_313(uParam0->f_107[iVar12 /*113*/].f_1));
				}
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_250(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
void func_212(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_50(*iParam0))
	{
		*iParam0 = func_338("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		func_339(*iParam0, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_50(*iParam1))
	{
		*iParam1 = func_338("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_231()
{
	TASK::TASK_USE_SCENARIO_POINT(Global_35, iLocal_96, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, true, false, 0, false, -1f, false);
}
...
void func_233(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(func_8(uParam0, iLocal_18)) && !bLocal_59)
	{
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_8(uParam0, iLocal_18), "", 6f, 0f, 0, 0f, 0f, 0, false, -1);
		bLocal_59 = true;
	}
	...
	if (bLocal_62)
	{
		if (func_359(Global_35, 0, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED") || func_359(Global_35, 1, 1, 0) != GET_HASH_KEY("WEAPON_UNARMED"))
		{
...
void func_237(var uParam0)
{
	...
	{
		iLocal_55 = func_338("VIG_LEAVE_CONVERSATION", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
	}
...
int func_286()
{
	...
	if (func_392(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_287()
{
	...
	if (func_392(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_292(int iParam0)
{
	...
	Var7 = { func_393(GET_HASH_KEY("KILLS"), GET_HASH_KEY("ANIMAL")) };
	STATS::STAT_ID_GET_INT(&Var7, &iVar0);
	Var7 = { func_394(GET_HASH_KEY("ANIMALS_LONG_LOOTED")) };
	STATS::STAT_ID_GET_INT(&Var7, &iVar1);
	Var7 = GET_HASH_KEY("SKINNED");
	Var7.f_1 = GET_HASH_KEY("SMALL_ANIMALS");
	STATS::STAT_ID_GET_INT(&Var7, &iVar2);
	Var7.f_1 = GET_HASH_KEY("MEDIUM_ANIMALS");
	STATS::STAT_ID_GET_INT(&Var7, &iVar3);
	Var7.f_1 = GET_HASH_KEY("LARGE_ANIMALS");
...
bool func_293(int iParam0)
{
	...
	iVar0 = func_395(GET_HASH_KEY("NUM_INNOCENT_PEDS_PUNCHED"));
	if (iVar0 == 0)
	{
		return false;
	}
...
bool func_294(int iParam0)
{
	...
	iVar0 = func_395(GET_HASH_KEY("NUM_PEDS_ANTAGONIZED"));
	if (iVar0 == 0)
	{
		return false;
	}
...
bool func_295(int iParam0)
{
	...
	iVar0 = func_396();
	iVar1 = func_395(GET_HASH_KEY("KILLS"));
	if (iVar1 == 0)
	{
		return false;
	}
...
int func_338(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_247(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_409(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_407(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_454(iParam1))
		{
			func_455(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_423(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_464(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
bool func_446(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_282(iParam0, 1073741824 /* Float: 2f */))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_479(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_250(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_248(vVar0)) && !func_249(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_479(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(Global_1360165[iParam0 /*1157*/].f_124))
...
bool func_477(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_511(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_109(iParam0, 44, 1);
			}
...
bool func_496(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_250(iParam0, 1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_392(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_471(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_525(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_542(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_550(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_562(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_554(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_554(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_554(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_572(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_554(GET_HASH_KEY("CHARACTER"), func_576(), -1591664384, bParam0);
}
