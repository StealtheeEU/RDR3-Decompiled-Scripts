...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -0.225f, -1.15f, 0.782f, 93.5f, 1.055f, 1.05f, 1.925f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	func_150(uParam0, -4.6375f, -7.4f, 0.907f, 80f, 1.7975f, 3.355f, 2.025f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_17 = func_151(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), -0.258237f, -1.19728f, 0f, "Chair", 1, 0, 1);
	...
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, GET_HASH_KEY("COMP_DOGCNV8"), GET_HASH_KEY("PLAYER_DOGCNV8"));
...
bool func_93(var uParam0)
{
	...
	{
		iLocal_18 = TASK::FIND_SCENARIO_OF_TYPE_HASH(2315.74f, 1295.19f, 94.66f, GET_HASH_KEY("WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL"), 1.5f, 0, false);
	}
	if (func_200(uParam0, iLocal_14))
	{
		PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_14), GET_HASH_KEY("MOTIONSTATE_RUN"), false, 1, false);
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_18))
		{
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2315.863f, 1300.093f, 94.8669f, 1.7f, -1, 0.25f, 8193, 40000f);
			TASK::TASK_USE_SCENARIO_POINT(0, iLocal_18, 0, 250000, true, false, 0, false, -1f, false);
...
int func_202(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_308("INTERACT_INSULT", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			func_309(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_308("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
int func_250()
{
	...
	if (func_335(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_251()
{
	...
	if (func_335(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_345(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_392(iParam1))
		{
			func_393(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_425(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_466(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_466(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_335(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_412(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
