...
bool func_72(var uParam0)
{
	...
	func_161(uParam0, GET_HASH_KEY("COMP_KIECNV5"), GET_HASH_KEY("PLAYER_KIECNV5"));
	func_162(uParam0, iLocal_16, -1, 0.76f);
	iLocal_17 = func_163(uParam0, -2.6375f, -2.2877f, 1f, 0f, 0f, 0f, 4f, 9.9f, 5f, "TRIGGER", GET_HASH_KEY("VOLBOX"));
	func_164(uParam0, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
