...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 5f, 5f, 10f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	if (func_153(10))
	{
		func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
		func_155(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	else
	{
		func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_155(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	func_156(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	...
	func_160(uParam0, GET_HASH_KEY("COMP_JHNCNV4"), GET_HASH_KEY("PLAYER_JHNCNV4"));
	if (!func_153(10))
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_392(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
