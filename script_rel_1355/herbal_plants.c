...
int func_22(int iParam0, bool bParam1)
{
	...
	if (!func_33(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_27(iVar14);
...
{
	return func_35(GET_HASH_KEY("CHARACTER"), func_36(), -1591664384, bParam0);
}
...
struct<4> func_35(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_23(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
