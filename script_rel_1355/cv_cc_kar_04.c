...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.6f, 0f, 2f, 2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_KAREN"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_77(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (PED::HAS_MOTION_TYPE_ASSET_LOADED(585448480, iVar0))
		{
			return true;
		}
	}
