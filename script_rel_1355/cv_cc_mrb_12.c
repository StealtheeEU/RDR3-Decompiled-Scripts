...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1.4424f, -0.6369f, 0.6758f, 0f, 1.1f, 1.1f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -0.053f, -0.2284f, 0.5413f, 0f, 1.1f, 1.1f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_153(uParam0, 0.759933f, -0.612731f, 1.00159f, 0f, 1.1f, 1.1f, 2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_19 = func_154(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL0", 0, 1, 1);
	iLocal_17 = func_154(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	iLocal_20 = func_154(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON0", 0, 0, 1);
	iLocal_18 = func_154(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON1", 0, 0, 1);
	iLocal_16 = func_154(uParam0, GET_HASH_KEY("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(GET_HASH_KEY("PROP_CAMP_FIRE_SEATED"), false);
}
...
void func_341(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_381(iParam1))
		{
			func_382(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_410(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_451(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_451(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 1:
			...
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
