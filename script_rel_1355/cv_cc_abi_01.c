...
bool func_89(var uParam0)
{
	...
	func_161(uParam0, 0f, -1.6f, 0f, -2.75f, 3.9f, 6.5f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_162(uParam0, GET_HASH_KEY("P_MATTRESS04X"), 1.17084f, -0.0235534f, 0.7491f, 0, 1, 0, 1);
	...
	func_165(uParam0, GET_HASH_KEY("COMP_ABICNV1"), GET_HASH_KEY("PLAYER_ABICNV1"));
	func_166(uParam0, iLocal_16, -1, 0.8f);
	func_167(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_168(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	func_169(uParam0, iLocal_14, 1, -1);
	func_167(uParam0, iLocal_15, 1, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
