...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -6.4125f, 0.55f, 0.782f, 80f, 1f, 1f, 2.2325f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, 1.99f, 1.61f, 1.1875f, -23.75f, 1.0175f, 0.9225f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 1.59f, 0.8225f, 1.1875f, -28f, 1.12f, 0.9225f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_154(uParam0, iLocal_16, 4, 2, 0, 0, 0);
	func_153(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1);
	func_155(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_155(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
