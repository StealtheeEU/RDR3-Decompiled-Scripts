...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.33949f, 0.232226f, 1.00873f, 3f, 0.9f, 0.9f, 2.5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.476543f, -0.0842055f, 0.549286f, 3f, 0.8f, 2f, 2f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_16 = func_152(uParam0, GET_HASH_KEY("P_STOOL03X"), 0f, 0f, 0f, "stool", 0, 0, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_SSNCNV1"), GET_HASH_KEY("PLAYER_SSNCNV1"));
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 0f, 1);
	...
	func_156(uParam0, iLocal_15, 4, GET_HASH_KEY("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 0f, 1);
