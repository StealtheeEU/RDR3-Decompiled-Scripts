...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.245f, -6.2275f, 1.15f, -33.44f, 1.1f, 1f, 2.685f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	...
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	iLocal_20 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, GET_HASH_KEY("COMP_MRBCNV4"), GET_HASH_KEY("PLAYER_MRBCNV4"));
	return true;
}
