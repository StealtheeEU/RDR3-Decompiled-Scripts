...
void __EntryFunction__()
{
	...
	iLocal_17 = GET_HASH_KEY("CS_GRIZZLEDJON");
	iLocal_18 = GET_HASH_KEY("P_BOTTLEJD01X");
	iLocal_19 = GET_HASH_KEY("P_WHISKEYGLASS01X");
	iLocal_20 = GET_HASH_KEY("P_WINDSORCHAIR03X");
	iLocal_176 = 1;
	iLocal_186 = -1;
	...
	while (true)
	{
		...
		func_4();
		func_5();
		if (func_6(13, 0, &iLocal_255, &uLocal_265, &uLocal_179, 0, 1097859072 /* Float: 15f */, 0))
		{
		...
		if (iLocal_175 > 2)
		{
			...
			{
				iVar0 = 0;
				iLocal_186 = func_10(&iLocal_255, &iLocal_119, 8f, &Local_140, &iVar0, 0f, 2, 0, 0, func_9(3, 0, 0), 0, 0, 2, 1, -1082130432 /* Float: -1f */, 0);
			}
			func_11();
			if (!PED::IS_PED_USING_ANY_SCENARIO(iLocal_255) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(iLocal_255, -1))
			{
		...
		if ((iLocal_175 >= 3 && iLocal_175 <= 7) && !func_15(iLocal_255, 0))
		{
			...
			{
				func_16(&iLocal_255, &uLocal_195, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 5f, 5f);
			}
		}
...
void func_11()
{
	...
	else if (!func_8(iLocal_182, 4194304))
	{
		if (func_8(iLocal_182, 8388608))
		{
			if (MISC::GET_GAME_TIMER() >= iLocal_191 + 1800)
			{
				...
				{
					if (func_58(iLocal_255, "CHALLENGE_THREATEN", GET_HASH_KEY("SPEECH_PARAMS_SHOUTED"), 0, 1, 0, 0, 1))
					{
	...
	if (!func_8(iLocal_182, 256))
	{
		if (iLocal_175 < 8 && iLocal_175 > 2)
		{
			if (func_59(iLocal_255, 0, &uLocal_205, &iLocal_233, 0, 0))
			{
				...
				switch (iLocal_233)
				{
					...
					case 2048:
						...
						break;
					case 32:
						if (fVar0 < 14f && func_60(Global_35, 1, 0, 0) == GET_HASH_KEY("WEAPON_UNARMED"))
						{
							func_47(13);
							func_7(&iLocal_182, 256);
			...
			else if ((iLocal_175 == 6 && func_8(iLocal_182, 65536)) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(iLocal_255, iLocal_189))
			{
				func_7(&iLocal_182, 256);
			}
		}
	...
	if (func_8(iLocal_182, 128))
	{
		if (!func_8(iLocal_182, 16384))
		{
			if (PED::IS_PED_IN_COMBAT(iLocal_255, 0))
			{
				...
				if (!MAP::DOES_BLIP_EXIST(iLocal_256))
				{
					iLocal_256 = func_64(iLocal_255, GET_HASH_KEY("BLIP_STYLE_ENEMY"), 1, 1);
				}
...
bool func_13()
{
	...
	if (func_68(Global_35, GET_HASH_KEY("HATS"), 0))
	{
		if (func_69(-2061583405, &iVar0))
		{
			if (iVar0 == GET_HASH_KEY("CLOTHING_HAT_GRIZZLED_JON"))
			{
				return true;
			}
		}
...
void func_18()
{
	...
	func_79();
	func_80(iLocal_260, "SP_GrizzledJon1_Block", 1, 0, 0, 0, -1082130432 /* Float: -1f */);
...
void func_19()
{
	...
	if ((((((HUD::TEXT_BLOCK_IS_LOADED("SPGJAU") && HUD::TEXT_BLOCK_IS_LOADED("SPGJ")) && STREAMING::HAS_MODEL_LOADED(iLocal_17)) && STREAMING::HAS_MODEL_LOADED(iLocal_18)) && STREAMING::HAS_MODEL_LOADED(iLocal_19)) && (iLocal_176 != 1 || STREAMING::HAS_MODEL_LOADED(iLocal_20))) && PED::_0x5C16855277819BBF() == 1)
	{
		if (iLocal_176 == 1)
		{
			if (iLocal_279 == 0)
			{
				iLocal_279 = ENTITY::PIN_CLOSEST_MAP_ENTITY(GET_HASH_KEY("P_WINDSORCHAIR03X"), vLocal_14, 5);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_259))
			{
		...
		if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_277))
		{
			switch (iLocal_176)
			{
				case 1:
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_259))
					{
						iVar1 = GET_HASH_KEY("SPECIAL_PED_GJ01_SEAT_CHAIR_TABLE_DRINKING");
				...
				case 0:
					if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_277))
					{
						iLocal_277 = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("SPECIAL_PED_GJ02_STAND_BAR_DRINKING"), -313.1921f, 809.0455f, 117.978f, -170f, 0, 0, 1);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 16, true);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 18, true);
						bVar0 = true;
					}
	...
	if ((func_104(&iLocal_255, iLocal_17, func_103(), 119.5846f, 1, 0, 1) && func_106(&iLocal_257, iLocal_18, func_105(iLocal_18))) && func_106(&iLocal_258, iLocal_19, func_105(iLocal_19)))
	{
		if (func_36(iLocal_255, 0))
		{
			if (!func_8(iLocal_182, 16777216))
			{
				...
				ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iLocal_255, func_103(), 197.2573f, true, false, true);
			...
			{
				case 1:
					TASK::TASK_USE_SCENARIO_POINT(iLocal_255, iLocal_277, "SP_GJ01_SEAT_CHAIR_TABLE_DRINKING", 0, true, true, 0, false, -1f, false);
					break;
				case 0:
					TASK::TASK_USE_SCENARIO_POINT(iLocal_255, iLocal_277, "SP_GJ02_STAND_BAR_DRINKING", 0, true, true, 0, false, -1f, false);
					break;
			}
			iLocal_177 = 0;
			iLocal_184 = MISC::GET_GAME_TIMER() + 4000;
			if (PED::IS_PED_USING_THIS_SCENARIO(iLocal_255, iLocal_277))
			{
				func_57(3);
			}
		}
...
void func_24()
{
	...
	{
		if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_189, true, false) && func_119(&uLocal_274, 4f))
		{
			func_120();
	...
	if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_189, false))
	{
		...
		if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_189) < fVar1)
		{
			...
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_258, iLocal_255, PED::GET_PED_BONE_INDEX(iLocal_255, 7966), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, false, false);
			}
		}
...
void func_25()
{
	...
	PED::_0x406CCF555B04FAD3(iLocal_255, 1, 1065353216 /* Float: 1f */);
	if (!func_8(iLocal_182, 131072))
	{
		PED::_0xD65FDC686A031C83(iLocal_255, MISC::GET_HASH_KEY("P21_Exit02_JON"), 1f);
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_255, -316.4402f, 805.7891f, 116.855f, 1f, -1, 0.25f, 0, 40000f);
		iLocal_278 = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_HUMAN_DRUNK_PASSED_OUT_FLOOR"), -316.4402f, 805.7891f, 116.855f, -170f, 0, 0, 0);
	...
	else if (!func_8(iLocal_182, 524288))
	{
		...
		if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_255, 713668775, true) == 8 && MISC::GET_GAME_TIMER() >= iLocal_184)
		{
			func_120();
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_255, true);
			TASK::TASK_USE_SCENARIO_POINT(iLocal_255, iLocal_278, 0, -1, true, false, 0, false, -1f, false);
	...
	if (ENTITY::_GET_ENTITY_ANIM_CURRENT_TIME(iLocal_255, "SCRIPT_COMMON@SHARED_SCENARIOS@STAND@STAND_DRUNK@MALE_A@STAND_EXIT", "p_21_exit01_ig_grizzledjon") >= 0.22f)
	{
...
void func_26()
{
	if (!func_8(iLocal_182, 16384))
	{
		if (MISC::GET_GAME_TIMER() >= iLocal_188)
		{
			if ((PED::IS_PED_USING_ANY_SCENARIO(iLocal_255) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_255)) && !AUDIO::_0x54B187F111D9C6F8(iLocal_255, 0))
			{
				...
				func_56(0, 1, 1);
				PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_255, false, false);
	...
	if (PED::IS_PED_IN_COMBAT(iLocal_255, 0))
	{
		...
		if (!func_8(iLocal_182, 33554432))
		{
			...
			{
				LAW::_0xFFEBE5AA96BC2E4E(iLocal_255, GET_HASH_KEY("CRIME_ASSAULT"), 1);
				LAW::_0xFFEBE5AA96BC2E4E(iLocal_255, GET_HASH_KEY("CRIME_UNARMED_ASSAULT"), 1);
	...
	if (!func_8(iLocal_182, 1024))
	{
		...
		{
			WEAPON::_0xD53846B9C931C181(iLocal_255, GET_HASH_KEY("WEAPON_UNARMED"), 20f);
			func_7(&iLocal_182, 1024);
...
void func_27()
{
	...
	{
		TASK::CLEAR_PED_TASKS(iLocal_255, true, false);
		TASK::TASK_FLEE_PED(iLocal_255, Global_35, 6, 128, -1f, -1, 0);
	}
	else if (!func_8(iLocal_182, 1073741824 /* Float: 2f */))
	{
		if (func_128(iLocal_255, "IGNORING_YOU", GET_HASH_KEY("SPEECH_PARAMS_FORCE_SHOUTED"), 0, "GRIZZLED_JON", 0))
		{
			func_7(&iLocal_182, 1073741824 /* Float: 2f */);
		}
	}
}
...
void func_40(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_255, iParam1) || bVar0)
		{
			...
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0, iLocal_255, PED::GET_PED_BONE_INDEX(iLocal_255, iParam3), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, false, false);
				if (bVar0)
				{
		...
		if (((ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_255, iParam2) || ((bParam4 && TASK::IS_PED_SCENARIO_REACT_LOOKING(iLocal_255, true)) && MISC::GET_GAME_TIMER() >= iLocal_197)) || (!TASK::IS_PED_ACTIVE_IN_SCENARIO(iLocal_255, 0) && !TASK::IS_PED_EXITING_SCENARIO(iLocal_255, false))) || iLocal_175 == 7)
		{
			if (ENTITY::IS_ENTITY_ATTACHED(iParam0))
			{
				if (TASK::IS_PED_SCENARIO_REACT_LOOKING(iLocal_255, true) && iParam0 == iLocal_258)
				{
					bLocal_181 = true;
...
int func_52(int iParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		fVar8 = func_154(fParam12 >= 0f, fParam12, BUILTIN::VDIST(Global_36, ENTITY::GET_ENTITY_COORDS(*iParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_159(iParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
...
void func_53(int* iParam0, var uParam1, int iParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_171(Global_35, *iParam2, sVar1, "", -1082130432 /* Float: -1f */, uVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
void func_56(bool bParam0, bool bParam1, bool bParam2)
{
	if (bParam0)
	{
		PED::SET_PED_SHOULD_PLAY_COMBAT_SCENARIO_EXIT(iLocal_255, ENTITY::GET_ENTITY_COORDS(Global_35, true, false), 3);
	}
	if (bParam2)
	{
		func_63();
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_211(func_210(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_212(func_210(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
void func_79()
{
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_260))
	{
		iLocal_260 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(-307.8825f, 806.9466f, 117.9845f, 0f, 0f, 10.8212f, 11f, 11f, 11f, "RandomEventBlock");
	}
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_261))
	{
		if (iLocal_176 == 1)
...
void func_90(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (!bParam2)
	{
		func_70(uParam0, 1073741824 /* Float: 2f */);
	}
	else
	{
		func_71(uParam0, 1073741824 /* Float: 2f */);
	}
	if (!bParam3)
	{
...
void func_109(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iParam0, BUILTIN::ROUND((((fVar0 / 100f) * (BUILTIN::TO_FLOAT(PED::GET_PED_MAX_HEALTH(iParam0)) - 100f)) + 100f)), 0);
	}
}
...
void func_113()
{
	...
	func_231(&(Local_140[0 /*17*/]), "INTERACT_GREET", func_230(), GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, 1, 0);
	func_231(&(Local_140[1 /*17*/]), "INTERACT_INSULT", sVar0, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 1, iVar1);
...
bool func_118(int iParam0)
{
	switch (iLocal_177)
	{
		...
		case 2:
			...
			if (TASK::IS_PED_SCENARIO_REACT_LOOKING(iLocal_255, true))
			{
				func_63();
				return true;
			}
...
int func_144(int iParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	...
	else
	{
		...
		if (!func_255(iVar1, 0))
		{
			func_256(&iVar1, vVar8, 1083179008 /* Float: 4.5f */);
		}
		return 1;
	}
	return 0;
...
bool func_156(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		if (MISC::REGISTER_INTERACTION_LOCKON_PROMPT(*iParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, false, iParam1->f_6))
		{
			...
			if (func_51(iParam4, 268435456))
			{
				iVar8 = func_261(uParam2, GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
...
int func_207(int iParam0, var uParam1)
{
	...
	{
		return func_329(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_232(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_346(iParam0, uParam1[iVar0 /*17*/], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
int func_281(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_373(func_58(iParam0, sParam2, iParam11, iParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_302(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_37(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_379(iVar0, 0)))
		{
...
bool func_318(int iParam0, int iParam1)
{
	...
	if (func_60(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
void func_340(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_390(iParam1))
		{
			func_108(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_346(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_268(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_275(iParam1))
		{
			...
			iParam1->f_6 = func_398(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_268(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_398(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_402(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_408(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
