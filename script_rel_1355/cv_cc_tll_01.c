...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -7.0439f, 3.4541f, -0.7266f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	...
	func_154(uParam0, GET_HASH_KEY("COMP_TLLCNV1"), GET_HASH_KEY("PLAYER_TLLCNV1"));
	func_155(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, "CTLL1AU");
	func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_158(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
