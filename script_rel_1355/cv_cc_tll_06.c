...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, -3.025f, 0.275f, 0.85f, -17f, 3.8275f, 2.9425f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, -3.15f, 0f, 0f, 24f, 1.5f, 0.76f, 3f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_153(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_22 = func_153(uParam0, GET_HASH_KEY("P_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_21 = func_153(uParam0, GET_HASH_KEY("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_153(uParam0, GET_HASH_KEY("P_BASINWATER01X"), 2356.782f, 1345.284f, 104.8737f, 0, 0, 1, 0);
	...
	func_156(uParam0, GET_HASH_KEY("COMP_TLLCNV6"), GET_HASH_KEY("PLAYER_TLLCNV6"));
	func_157(uParam0, iLocal_20, -1, 0.81f);
	func_158(uParam0, iLocal_14, 1, 4, 0, 0, 0);
	func_158(uParam0, iLocal_15, 1, 8, 0, 0, 0);
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 15f, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
