...
bool func_77(var uParam0)
{
	...
	func_162(uParam0, -0.32f, -0.16f, 0.95f, 0f, 0.8f, 0.8f, 1f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
	func_162(uParam0, 1.34f, -9.37f, 0.52f, 0f, 0.8f, 0.8f, 1f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_96 = func_163(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), -0.53f, -0.29f, 0.7f, "BOOK", 0, 0, 1);
	...
	func_167(uParam0, iLocal_92, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_168(uParam0, iLocal_92, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_169(uParam0, iLocal_92, iLocal_96, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_167(uParam0, iLocal_93, 3, GET_HASH_KEY("WORLD_HUMAN_LEAN_WALL_RIGHT"), "WORLD_HUMAN_LEAN_WALL_RIGHT_MALE_B", -1, 0);
	return true;
}
...
bool func_389(var uParam0, var uParam1)
{
	...
	if (!func_395(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_442("INTERACT_WNT_DISMISS", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_359(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_460(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
