...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1084f, -1.7496f, 0.5579f, 34.7662f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -1.3f, 1.5f, 0.558f, 35.28f, 3f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, -1.37f, -1.14f, 0.558f, 34.2f, 1.5f, 2.3f, 3f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	func_153(uParam0, iLocal_14, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), "REVOLVER");
	...
	func_156(uParam0, iLocal_16, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_17, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_BENCH_PORCH"), "PROP_HUMAN_SEAT_BENCH_PORCH_DRINKING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_17, iLocal_18, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_156(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0);
	func_157(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	if (func_197(uParam0, iLocal_19))
	{
		...
		else
		{
			...
			func_157(uParam0, iLocal_15, 1, 0, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		}
	}
	return true;
}
...
{
	func_157(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
