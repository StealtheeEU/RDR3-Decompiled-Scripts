...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("P_TABLE_COL01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_152(uParam0, -0.0375f, 0.3498f, 0.85f, -89.64f, 0.885f, 1.985f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ADLERS"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, -1);
	func_155(uParam0, iLocal_15, 4, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", iLocal_16, 0);
	func_156(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_41 = func_159(uParam0, -2.24f, 3.2f, 1.8f, 0f, 0f, 0f, 14.64f, 8.24f, 5f, "TRIGGER", GET_HASH_KEY("VOLBOX"));
	func_160(uParam0, 1);
	func_161(uParam0, GET_HASH_KEY("COMP_MRBCNV5"), GET_HASH_KEY("PLAYER_MRBCNV5"));
...
void func_338(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_372(iParam1))
		{
			func_373(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_392(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
