...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, GET_HASH_KEY("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	...
	func_155(uParam0, GET_HASH_KEY("COMP_BCCHRCNV3"), GET_HASH_KEY("PLAYER_BCCHRCNV3"));
	func_156(uParam0, "BCHR3AU");
	func_157(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 38f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	iLocal_18 = func_159(uParam0, -0.31f, 9.12f, 0f, 0f, 0f, 0f, 10f, 10f, 5f, "volTrigger", GET_HASH_KEY("VOLBOX"));
	func_160(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	if (func_204(uParam0, iLocal_17))
	{
		...
		{
			TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_15), GET_HASH_KEY("STAND"), 45000, false, 0, 1f, false);
		}
	}
	return true;
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_395(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
