...
bool func_72(var uParam0)
{
	...
	iLocal_29 = func_151(uParam0, GET_HASH_KEY("P_GUITAR01X"), 0f, 0f, 0f, "GUITAR", 0, 0, 1);
	iLocal_30 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE3", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE5", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE6", 0, 1, 1);
	iLocal_31 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER", 0, 0, 1);
	iLocal_32 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER1", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER2", 0, 1, 1);
	iLocal_33 = func_151(uParam0, GET_HASH_KEY("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER3", 0, 0, 1);
	iLocal_34 = func_151(uParam0, GET_HASH_KEY("P_CIGAR02X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_BOTTLECRATE02X"), 0f, 0f, 0f, "CRATE", 0, 0, 1);
	func_151(uParam0, GET_HASH_KEY("P_WOODWHITTLE01X"), 0f, 0f, 0f, "WHITTLE", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_KNIFE02X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE1", 0, 1, 1);
	func_151(uParam0, GET_HASH_KEY("P_CS_POTATOSLICE01X"), 0f, 0f, 0f, "POTATOSLICE", 0, 1, 1);
	...
	func_153(uParam0, iLocal_16, 2, GET_HASH_KEY("WORLD_HUMAN_SIT_GUITAR"), "WORLD_HUMAN_SIT_GUITAR_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_16, iLocal_29, "p_guitar01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_17, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_18, 2, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_19, 2, GET_HASH_KEY("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_19, iLocal_32, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_23, 2, GET_HASH_KEY("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_24, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_24, iLocal_33, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_25, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_25, iLocal_31, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_26, 2, GET_HASH_KEY("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_252()
{
	...
	if (func_327(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_253()
{
	...
	if (func_327(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_403(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_448(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_448(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_448(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_467(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
{
	return func_479(GET_HASH_KEY("CHARACTER"), func_501(), -1591664384, bParam0);
}
