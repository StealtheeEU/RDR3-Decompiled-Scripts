...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.8601f, -0.8196f, 0.4797f, 14.4f, 1.2f, 1.2f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_STRAUSS"), 1, 1, 1);
	func_151(uParam0, 1.1969f, -1.8503f, 0.9725f, 30.6f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, GET_HASH_KEY("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_18 = func_152(uParam0, GET_HASH_KEY("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	func_152(uParam0, GET_HASH_KEY("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_19 = func_152(uParam0, GET_HASH_KEY("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	func_153(uParam0, iLocal_15, GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION"), "GUN");
	...
	func_156(uParam0, GET_HASH_KEY("COMP_STRCNV3"), GET_HASH_KEY("PLAYER_STRCNV3"));
	...
	func_159(uParam0, iLocal_15, 2, GET_HASH_KEY("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", -1, 0, 120f, 1065353216 /* Float: 1f */, 1);
...
void func_352(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_399(iParam1))
		{
			func_400(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_432(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_473(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_473(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_419(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_498(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_510(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_502(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_502(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_502(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_520(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_502(GET_HASH_KEY("CHARACTER"), func_524(), -1591664384, bParam0);
}
