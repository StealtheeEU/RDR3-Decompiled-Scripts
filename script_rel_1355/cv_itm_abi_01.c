...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_25 = GET_HASH_KEY("WORLD_HUMAN_CROUCH_INSPECT");
	iLocal_26 = GET_HASH_KEY("WORLD_CAMP_JACK_POKE_GROUND_STICK");
...
bool func_76(var uParam0)
{
	...
	func_154(uParam0, -0.48f, -3.06f, 0f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	func_155(uParam0, 0.335f, -1.85f, 0f, -23.72f, 1.1175f, 1.7375f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, -0.67f, -2.95f, 0f, 0f, 1.3f, 1.3f, 5f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_JACK"), 1, 1, 1);
	func_156(uParam0, -0.2575f, -2.62f, 0f, -33.5f, 1f, 1f, 5f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_14 = func_157(uParam0, 13, 0);
	iLocal_15 = func_157(uParam0, 14, 0);
	func_158(uParam0, GET_HASH_KEY("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "STICK", 0, 0, 1);
	iLocal_22 = func_158(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0.5815f, -1.35439f, 0.0295715f, 0, 1, 0, 1);
	...
	func_163(uParam0, iLocal_15, 2, GET_HASH_KEY("WORLD_CAMP_JACK_POKE_GROUND_STICK"), "WORLD_CAMP_JACK_POKE_GROUND_STICK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_164(uParam0, iLocal_15, 1);
	func_163(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	switch (iLocal_59)
	{
		case 0:
			if (func_207(uParam0, iLocal_17))
			{
				...
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_9(uParam0, iLocal_15), iLocal_26, 0, false, 0, 1f, true);
			}
			else
			{
				return true;
		...
		case 4:
			...
			{
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_9(uParam0, iLocal_14), GET_HASH_KEY("STAND"), 0, false, 0, 0.8f, true);
				...
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_9(uParam0, iLocal_15), iLocal_26, 0, false, 0, -1f, false);
		...
		case 5:
			...
			{
				iLocal_28 = func_211("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
				func_212(iLocal_28, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_9(uParam0, iLocal_14)), 0, 1);
			}
			if (!func_48(iLocal_29))
			{
				iLocal_29 = func_211("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
bool func_209(var uParam0)
{
	...
	{
		iLocal_27 = func_211("INTERACT_GREET", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_219(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !MISC::IS_BIT_SET(Global_40.f_6563.f_271, iVar0))
	{
		...
		func_340(func_339(GET_HASH_KEY("CAMP_REQUESTS_COMPLETED")), 1);
...
int func_268()
{
	...
	if (func_362(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_269()
{
	...
	if (func_362(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_333(int iParam0)
{
	...
	Var0 = { func_391(GET_HASH_KEY("CAREER_CASH")) };
...
void func_334(int iParam0, char* sParam1, int iParam2)
{
	...
	func_392(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 1, GET_HASH_KEY("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_337(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			func_340(func_391(GET_HASH_KEY("HONOR_POSITIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_392(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_392(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_340(func_391(GET_HASH_KEY("HONOR_NEGATIVE_TOTAL")), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_392(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_392(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_391(GET_HASH_KEY("HONOR_CURRENT")) };
...
void func_373(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_429(iParam1))
		{
			func_430(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
			...
			if (func_451(iVar5, &iVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_454(iVar2) == GET_HASH_KEY("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_393() <= -160;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_362(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_464(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_520(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_539(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
struct<5> func_546(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_454(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_550(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_550(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_550(GET_HASH_KEY("CHARACTER"), func_568(), -1591664384, bParam0);
}
