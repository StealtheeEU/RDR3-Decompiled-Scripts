...
bool func_6(var uParam0)
{
	...
	if (((STREAMING::IS_LOAD_SCENE_ACTIVE() && STREAMING::IS_LOAD_SCENE_LOADED()) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_4, true, false)) || func_23(&uLocal_8) > 15f)
	{
		func_22(&uLocal_5, 0);
		return true;
	}
...
int func_11(var uParam0)
{
	...
	bVar1 = (DLC::IS_DLC_PRESENT(GET_HASH_KEY("DLC_PHYSPREORDERCONTENT")) || DLC::IS_DLC_PRESENT(GET_HASH_KEY("DLC_PREORDERCONTENT")));
	if (DLC::IS_DLC_PRESENT(GET_HASH_KEY("DLC_ULTIMATEEDITION")))
	{
		if (!bVar1)
		{
			if (DLC::IS_DLC_PRESENT(GET_HASH_KEY("DLC_SPECIALEDITION")))
			{
				func_32(626, 0);
			}
		}
	...
	else if (DLC::IS_DLC_PRESENT(GET_HASH_KEY("DLC_SPECIALEDITION")))
	{
		if (!bVar1)
		{
			func_32(625, 0);
...
void func_19(var uParam0)
{
	...
	func_50(GET_HASH_KEY("CSTAG_FLOW_FIRST_VISIT_WNT2_POST"), GET_HASH_KEY("CSTP_NEXT_VISIT"), GET_HASH_KEY("CSTAG_PRIORITY_CRITICAL"), 8, 1, 1, 0);
...
void func_30(var uParam0, int iParam1)
{
	...
	{
		func_70(Global_35, GET_HASH_KEY("CLOTHING_ITEM_NECKWEAR_NONE"), 0, 1742327865, 0, 1, 0, 0, 1, 0);
		func_71(GET_HASH_KEY("KIT_BANDANA"), 0);
	}
...
void func_46(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_79(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_81(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_71(int iParam0, bool bParam1)
{
	...
	INVENTORY::_0x65A5F70F4A292EBE(func_133(0), &Var5, bParam1);
}
...
int func_86(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_39(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_151(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
struct<5> func_119(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_190(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_131(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_131(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_131(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_133(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
float func_151(int iParam0, bool bParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
int func_176(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_229(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
bool func_186(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	float fVar0;
	...
	{
		fVar0 = func_236(bParam0, Global_36, 1);
	}
	if (fParam2 > 0f)
	{
		if (fVar0 < fParam2)
...
{
	return func_131(GET_HASH_KEY("CHARACTER"), func_237(), -1591664384, bParam0);
}
...
int func_233(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_263("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if ((((((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) || func_265(Var4.f_4)) && (!WEAPON::IS_WEAPON_SHOTGUN(Var4.f_4) || func_262(iParam1, 16))) && (!WEAPON::_IS_WEAPON_SNIPER(Var4.f_4) || func_262(iParam1, 4))) && (!func_265(Var4.f_4) || func_262(iParam1, 8))) && (!WEAPON::IS_WEAPON_REPEATER(Var4.f_4) || !func_262(iParam1, 8388608))) && (!WEAPON::IS_WEAPON_RIFLE(Var4.f_4) || !func_262(iParam1, 1048576)))
				{
...
void func_234(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		sVar2 = func_267(fParam1 < 0f, "rpg_cold", "rpg_hot");
...
float func_236(bool bParam0, vector3 vParam1, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return 0f;
