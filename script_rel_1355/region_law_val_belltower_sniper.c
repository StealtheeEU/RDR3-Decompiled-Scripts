...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_44 = GET_HASH_KEY("S_M_M_AMBIENTLAWRURAL_01");
...
void func_5()
{
	switch (iLocal_41)
	{
		...
		case 4:
			...
			break;
		case 5:
			func_18(iLocal_42, GET_HASH_KEY("INPUT_FOCUS_CAM"));
			if (!func_6(iLocal_42, 0))
			{
				iLocal_41 = 6;
			}
...
void func_16()
{
	...
	WEAPON::GIVE_WEAPON_TO_PED(iLocal_42, GET_HASH_KEY("WEAPON_SNIPERRIFLE_CARCANO"), 999, true, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
	PED::SET_PED_DEFENSIVE_AREA_VOLUME(iLocal_42, iLocal_43, 0, false, 0);
...
void func_29(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_33(iParam1))
		{
			func_34(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
