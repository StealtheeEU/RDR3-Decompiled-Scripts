	...
	while (bVar158)
	{
		...
		switch (func_5())
		{
			...
			case 10:
				...
				break;
			case 14:
				if ((Global_1310720.f_7 && !CAM::IS_SCREEN_FADED_IN()) && UISTICKYFEED::_0x07954320D77F6A3D(Global_1935630.f_3) >= 3)
				{
...
var func_15(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	...
	Var0 = iParam2;
	Var0.f_1 = sParam1;
	uVar3 = UISTICKYFEED::_0x815C4065AE6E6071(sParam0, &Var0, iParam3);
	return uVar3;
}
...
bool func_23(int iParam0)
{
	...
	if (SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("GENERIC_GHOSTTOWN")) > 0)
	{
		return true;
	}
...
bool func_220(int iParam0, int iParam1)
{
	...
	Var29 = { func_315(iParam1, Var0, GET_HASH_KEY("SLOTID_HORSE_MANE"), 0) };
...
bool func_221(int iParam0, int iParam1)
{
	...
	Var29 = { func_315(iParam1, Var0, GET_HASH_KEY("SLOTID_HORSE_TAIL"), 0) };
	return func_304(Var29, 1);
}
...
bool func_246()
{
	...
	return (PED::_IS_METAPED_USING_COMPONENT(Global_35, GET_HASH_KEY("HATS")) || func_329(-2061583405, &uVar0));
}
...
{
	return func_315(GET_HASH_KEY("CHARACTER"), func_352(), -1591664384, bParam0);
}
...
void func_307(var uParam0)
{
	...
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_360(func_359(255), GET_HASH_KEY("COLOR_PURE_WHITE")));
	}
	else if (func_361())
	{
...
struct<17> func_354(var uParam0)
{
	struct<17> Var0;
...
int func_356(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == GET_HASH_KEY("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_384(GET_HASH_KEY("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == GET_HASH_KEY("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_386(GET_HASH_KEY("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_354(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_355(GET_HASH_KEY("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<29> func_383(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> Var0;
	struct<29> Var29;
...
struct<18> func_385(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> Var0;
	struct<15> Var18;
...
bool func_388(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_422(&(Global_1109400.f_4), iVar0, 5);
	}
	if (iParam1 == func_423())
	{
		return func_422(&(Global_1109400.f_4), iVar0, 5);
	...
	{
		return func_422(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
int func_415(int iParam0, bool bParam1)
{
	...
	if (!func_429(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_414(iVar14);
...
struct<14> func_426(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
void func_428(var uParam0, struct<4> Param1)
{
