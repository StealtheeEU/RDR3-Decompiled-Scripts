...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_9 = GET_HASH_KEY("A_C_BEAVER_01");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "beaver", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 0, "STICK", GET_HASH_KEY("P_STICKFIREPOKER01X"), vParam1, vParam4.z, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[4])
			{
				if (func_74(uParam0, 0.5f, 40f, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[4] = 1;
				}
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		TASK::TASK_FLEE_PED(0, Global_35, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
