...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.175f, -7.0875f, 0.85f, -65.75f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 0.85f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -0.207769f, -1.05733f, 1.00032f, 0f, 1.1f, 1.1f, 3.2f, GET_HASH_KEY("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, GET_HASH_KEY("P_CS_KNITTING01X"), 0f, 0f, 0f, "KNITTING", 0, 0, 1);
	iLocal_17 = func_153(uParam0, GET_HASH_KEY("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_17, 0);
	func_155(uParam0, iLocal_14, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, iLocal_16, "p_cs_knitting01x_PH_R_HAND", 0, 0);
	func_154(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, GET_HASH_KEY("COMP_MRBCNV7"), GET_HASH_KEY("PLAYER_MRBCNV7"));
