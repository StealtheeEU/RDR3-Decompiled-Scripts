...
bool func_73(var uParam0)
{
	...
	func_154(uParam0, 3.975f, -3.15f, 0.85f, 0f, 1f, 1f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_154(uParam0, 0.0375f, -0.425f, 0.85f, 0f, 3.345f, 3.345f, 3.2075f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_PEARSON"), 1, 1, 1);
	func_155(uParam0, GET_HASH_KEY("P_FILLETKNIFE01X"), 0f, 0f, 0f, "p_filletKnife01x", 0, 1, 1);
	func_155(uParam0, GET_HASH_KEY("P_KNIFESHARPENER01X"), 0f, 0f, 0f, "p_knifesharpener01x", 0, 1, 1);
	if (!func_156(16))
	{
		func_155(uParam0, GET_HASH_KEY("P_CS_FISHBAG01X"), 0f, 0f, 0f, "p_cs_fishbag01x", 0, 1, 1);
	}
	...
	func_159(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
