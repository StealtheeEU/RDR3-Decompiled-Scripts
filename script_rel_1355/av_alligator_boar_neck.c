...
void __EntryFunction__()
{
	...
	iLocal_10 = GET_HASH_KEY("A_C_BOAR_01");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "alligator", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 1, "BOAR", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, GET_HASH_KEY("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (func_73(uParam0, 2f, 1116471296 /* Float: 70f */, 4, GET_HASH_KEY("ACTION"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
...
void func_70(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], GET_HASH_KEY("KILL_BOAR")))
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		{
			TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 2, 256, -1082130432 /* Float: -1f */, -1, 0);
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_133(iParam1))
		{
			func_134(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_204(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_202(int iParam0, int iParam1)
{
	...
	if (func_229(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
