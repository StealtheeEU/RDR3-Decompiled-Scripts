...
void func_21(var uParam0, var uParam1)
{
	...
	{
		case GET_HASH_KEY("DOCUMENT_MARY_BETH_JOURNAL"):
			if (func_71() == 2)
			{
				iLocal_20 = GET_HASH_KEY("UI_DOC_MB_DIARY2");
			}
			else if (func_71() == 6 || func_71() == 3)
			{
				iLocal_20 = GET_HASH_KEY("UI_DOC_MB_DIARY3");
			}
			else
			{
				iLocal_20 = GET_HASH_KEY("UI_DOC_MB_DIARY1");
			}
			TXD::REQUEST_STREAMED_TXD(iLocal_20, false);
			break;
		case GET_HASH_KEY("DOCUMENT_LEDGER_VALENTINE_JAIL"):
			iLocal_20 = GET_HASH_KEY("UI_BOOK_VALENTINE_JAIL_LEDGER");
			TXD::REQUEST_STREAMED_TXD(iLocal_20, false);
			break;
		case GET_HASH_KEY("DOCUMENT_RCM_SLAVE_LEDGER"):
			iLocal_20 = GET_HASH_KEY("UI_DOC_SC_DIARY");
			TXD::REQUEST_STREAMED_TXD(iLocal_20, false);
			break;
		case GET_HASH_KEY("PROVISION_RCM_BLACK_BOOK"):
			iLocal_20 = GET_HASH_KEY("UI_DOC_SC_LEDGER");
			TXD::REQUEST_STREAMED_TXD(iLocal_20, false);
			break;
	}
}
...
void func_29(var uParam0, var uParam1)
{
	...
	if (!UIAPPS::IS_UIAPP_RUNNING_BY_HASH(GET_HASH_KEY("TRANSLATION_OVERLAY")) && uParam0->f_131 > 0)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(0, GET_HASH_KEY("INPUT_CONTEXT_X")))
		{
	...
	if (!bLocal_17 && iLocal_20 != 0)
	{
		...
		{
			OBJECT::SET_CUSTOM_TEXTURES_ON_OBJECT(TASK::_0x05A0100EA714DB68(Global_35, 0), iLocal_20, 0, 0);
			bLocal_17 = true;
		}
	}
}
...
int func_35(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_106(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_106(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_106(iParam0) == GET_HASH_KEY("AMMO") && func_119(iParam0))
		{
		...
		{
			func_124(func_123(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_124(func_125(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_31(iParam0, 589988438))
		{
			if (func_128())
			{
				func_129(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_141(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_142(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_141(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_148(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_149(499813453, 0);
				func_150(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_148(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_149(499813453, 0);
				func_150(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_148(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_149(499813453, 0);
				func_150(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_148(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_149(666607663, 0);
				func_151(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_148(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_149(666607663, 0);
				func_151(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_148(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_149(666607663, 0);
				func_151(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_148(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_149(-220219788, 0);
				func_152(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_148(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_149(-220219788, 0);
				func_152(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_148(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_149(-220219788, 0);
				func_152(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_148(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_149(218622660, 0);
				func_153(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_148(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_149(218622660, 0);
				func_153(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_148(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_149(390004462, 0);
				func_154(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_148(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_149(390004462, 0);
				func_154(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_148(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_149(390004462, 0);
				func_154(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_148(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_149(6410548, 0);
				func_155(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_148(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_149(6410548, 0);
				func_155(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_148(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_149(6410548, 0);
				func_155(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_148(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_149(6410548, 0);
				func_155(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_157(242, func_156(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_157(240, func_156(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_157(241, func_156(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
...
int func_39(var uParam0, int iParam1)
{
	...
	else if (func_176(*uParam0, &iVar0, GET_HASH_KEY("INVENTORY"), GET_HASH_KEY("UI_ITEMVIEWER"), 0, 0))
	{
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_233(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_233(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_118(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_212(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_251())
				{
					return false;
				}
...
void func_121(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_255()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_128()
{
	if (((((func_264(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_264(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_264(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_264(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_264(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_264(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_130(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_105(51, 0, 0, 0, 0, -1, 0);
			func_268(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_105(51, 0, 0, 0, 0, -1, 0);
			func_268(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_103(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_272(1), 0, -1, 0);
			func_273(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_103(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_272(2), 0, -1, 0);
			func_273(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_103(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_272(4), 0, -1, 0);
			func_273(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_103(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_272(8), 0, -1, 0);
			func_273(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_103(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_272(16), 0, -1, 0);
			func_273(16);
			break;
	}
}
...
void func_133(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_96(437, 0);
			func_96(440, 0);
			func_276(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_105(51, 0, 0, sVar0, func_225(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_268(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_276(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_105(51, 0, 0, sVar0, func_225(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_268(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_276(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_105(51, 0, 0, sVar0, func_225(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_268(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_276(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_105(51, 0, 0, sVar0, func_225(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_268(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_96(438, 0);
			func_276(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_103(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_105(51, 0, 0, sVar0, func_225(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_268(32768);
			break;
		default:
			func_96(439, 0);
...
void func_135(int iParam0, int iParam1)
{
	...
	if (func_113() == -1)
	{
		...
		{
			func_278(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_279() == 0)
			{
				func_219(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_278(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_279() == 1)
			{
				func_219(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_281(iParam0) < func_282(iParam0))
					{
						func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_278(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_279() == 2)
			{
				func_219(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_283(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_284(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_218(48);
					}
					if (func_281(iParam0) < func_282(iParam0))
					{
						func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_278(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_279() == 3)
			{
				func_219(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_281(iParam0) < func_282(iParam0))
					{
						func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_278(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_279() == 4)
			{
				func_219(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_281(iParam0) < func_282(iParam0))
					{
						func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_138(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_129(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_129(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_129(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_129(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_129(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_129(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_129(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_129(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_129(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_129(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_129(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_129(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_288())
			{
				func_129(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_129(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_129(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_129(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_129(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_129(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_129(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_129(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_129(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_129(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_129(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_129(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_129(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_129(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_139(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_219(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_289(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_290(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_291(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_149(int iParam0, bool bParam1)
{
	...
	func_233(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_163(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_311(81053684, 0) <= 0)
			{
	...
	{
		if (!func_318(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_141(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_109(24);
		if (func_142(&iVar2, 0))
		{
...
int func_165(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_320(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
struct<2> func_166(int iParam0)
{
	...
	if (func_31(iParam0, -305066475))
	{
		if (func_113() == -1)
		{
			...
			{
				return func_322(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_322(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_31(iParam0, -537818634))
	{
		return func_322(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_31(iParam0, 2084895747))
	{
		return func_322(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_168(int iParam0, char* sParam1)
{
	...
	func_326(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_325(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_169(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_330(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
...
{
	return func_106(iParam0) == GET_HASH_KEY("WEAPON");
}
...
void func_206(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_106(iParam0) != GET_HASH_KEY("WEAPON"))
	{
		return;
	}
	iVar0 = func_112(iParam0, 0);
...
struct<5> func_208(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_106(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_246(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_246(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
int func_214(int iParam0, bool bParam1)
{
	...
	Var0 = { func_358(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_359(&Var0, func_349(0));
	}
	if (!func_360(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_9(iVar14);
...
void func_218(int iParam0)
{
	...
	func_326(MISC::VAR_STRING(6, func_366(iParam0), fVar1), "itemtype_textures", func_367(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_230(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_387(COLLECTION::_0x126CBEBBA46693CF(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_388(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_388(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
...
void func_239(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_235("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_235("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_235("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_235("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_113() == -1)
			{
				if (!func_318(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_402(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_251())
					{
					...
					func_141(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
struct<4> func_246(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_215(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_256(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_106(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_113() != -1;
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_414(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
void func_266(int iParam0, char* sParam1, int iParam2)
{
	...
	func_326(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_267(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_326(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_326(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_124(func_322(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_274()
{
	...
	while (iVar1 < 30)
	{
		if (func_422(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_279()
{
	...
	while (iVar1 < 5)
	{
		if (func_428(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_295(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_31(iParam0, 866047851) && func_411(&(Global_1946804.f_1378)) >= 2)
	{
		return false;
	}
	...
	{
		func_437(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_437(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	func_438(&(Global_1946804.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946804.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_439(iParam0, iParam2, iParam1, func_113() != -1);
	if (bParam4)
	{
		func_440(&(Global_1946804.f_1378), 1, 3);
	}
	else
	{
		func_440(&(Global_1946804.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_441(func_432(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_442(&(Global_1946804.f_2589), bParam0, bParam1, bParam2);
}
...
void func_299()
{
	func_445(&(Global_1946804.f_2776));
	func_446(32768);
...
int func_325(int iParam0)
{
	...
	if (!func_176(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
bool func_332(var uParam0, int iParam1, bool bParam2)
{
	...
	if (Global_1935689.f_10190 == 0 && !func_481())
	{
...
void func_339(int iParam0, bool bParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(Global_1347702[iParam0 /*49*/].f_37))
	{
		...
		if ((!func_492(PLAYER::PLAYER_ID(), 1, 0, 1) || Global_43891) || bParam1)
		{
			...
			func_490(&(Global_1347702[iParam0 /*49*/].f_13), 4096);
			func_493(&(Global_1347702[iParam0 /*49*/].f_37));
		}
		else
		{
			func_494(iParam0, 16384);
...
void func_341(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & 1 == 0)
	{
		...
		if (((!func_498(iParam0) || func_179(Global_1347702[iParam0 /*49*/].f_12, 1)) || func_179(Global_1347702[iParam0 /*49*/].f_12, 512)) || func_509(Global_1347702[iParam0 /*49*/].f_13, 2048))
		{
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & 32768 == 0)
	{
		...
		{
			func_486(&(Global_1347702[iParam0 /*49*/].f_13), 32768);
		}
	}
...
void func_345(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	uVar0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, func_512(iParam0));
	DATABINDING::_DATABINDING_ADD_DATA_HASH(uVar0, "style", func_513(iParam0));
...
{
	return func_246(GET_HASH_KEY("CHARACTER"), func_515(), -1591664384, bParam0);
}
...
{
	if (func_516(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_357(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
struct<14> func_358(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
void func_359(var uParam0, struct<4> Param1)
{
...
void func_365(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_519(iParam0) && func_520(iParam0))
	{
		if (!bParam2)
		{
			...
			if (fParam1 > IntToFloat(func_522(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
...
int func_377()
{
	...
	while (iVar1 < 30)
	{
		if (func_528(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_378()
{
	...
	while (iVar1 < 14)
	{
		if (func_387(COLLECTION::_0x126CBEBBA46693CF(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_403()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_114(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_162(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_114(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_162(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_421(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_419())
	{
		func_326(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_326(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_547(&(Global_1946804.f_2589), iParam0);
}

void func_436(int iParam0, int iParam1)
{
	func_548(&(Global_1946804.f_2589), iParam0, iParam1);
}
...
void func_438(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_549(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_414(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_110(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_414(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_31(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_440(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_554(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_442(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_113() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_557(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_465(0))
		{
			if (Global_40.f_7157[Global_40.f_7729 /*3*/] & 512 != 0)
			{
				...
				Global_1946804.f_1497 = func_465(Global_40.f_7729);
				Global_1946804.f_1378 = func_465(Global_40.f_7729);
...
void func_448(struct<4> Param0)
{
	...
	if (func_560(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_560(20))
			{
				return;
			}
			iVar0++;
...
{
	func_320(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_320(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_320(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}

void func_474(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
bool func_478(int iParam0, int iParam1, bool bParam2)
{
	...
	bVar0 = false;
	if (((iParam1 == 0 || iParam1 == -2074770370) || bParam2) || func_480(0))
	{
		bVar0 = true;
	}
	if (!bParam2)
	{
		if ((!func_73(iParam0, 0) || iParam0 == GET_HASH_KEY("CUSTOM_SATCHEL")) || iParam0 == GET_HASH_KEY("KIT_WARDROBE"))
		{
			return false;
		}
	}
	...
	switch (iParam1)
	{
		...
		case 0:
			if (!func_480(0))
			{
				...
				if ((((((((((func_478(iParam0, -1559802791, 1) || func_478(iParam0, -1268291907, 1)) || func_478(iParam0, -96974025, 1)) || func_478(iParam0, -1666604090, 1)) || func_478(iParam0, 1561961676, 1)) || func_478(iParam0, -156634416, 1)) || func_478(iParam0, 1061777683, 1)) || func_478(iParam0, -2074770370, 1)) || func_478(iParam0, -693134279, 1)) || func_478(iParam0, -182626652, 1)) || func_577(iParam0))
				{
					return true;
				}
			}
...
bool func_479(int iParam0)
{
	...
	if (func_106(iParam0) == GET_HASH_KEY("UPGRADE") && !(func_31(iParam0, -1540973036) || func_31(iParam0, 1192444843)))
	{
		return false;
	}
	return true;
...
bool func_488(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	while (iVar0 < 27)
	{
		if (func_582(iVar0, &iParam0))
		{
			...
			if (iParam3 == iParam4)
			{
				func_583(iVar0, 512, 1);
			}
			else
			{
				func_584(iVar0, 512, 1);
			}
		}
		iVar0++;
	}
...
void func_494(int iParam0, int iParam1)
{
	...
	func_591(&(Global_1347702[iParam0 /*49*/].f_12), 16384);
...
void func_495(int iParam0, bool bParam1, vector3 vParam2)
{
	...
	func_486(&(Global_1347702[iParam0 /*49*/].f_13), 4096);
}
...
void func_524(int iParam0, int iParam1, int iParam2)
{
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_612(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_233(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_613(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_531(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_614(&iVar0, 0, iVar95, &Var1) && !func_614(&iVar0, 1, iVar95, &Var1))
		{
		}
...
void func_532()
{
	...
	func_617(0);
	func_618(7);
	func_619(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_315() == 1160113249)
	{
		func_619(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_619(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_620(Global_35, &uVar0);
}
...
void func_545(int iParam0)
{
	...
	Var0 = { func_322(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_556(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_113() == -1)
	{
		func_633(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_634(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_635(&(Global_1946804.f_1378), iParam0);
...
void func_571()
{
	...
	func_162(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_364(1);
	func_524(1, iVar0, 0);
}
...
void func_573()
{
	...
	func_162(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_364(2);
	func_524(2, iVar0, 0);
}
...
void func_574()
{
	...
	func_162(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_364(0);
	func_524(0, iVar0, 0);
}
...
int func_606(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_215(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_215(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_215(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}

struct<4> func_607(int iParam0, int iParam1)
{
	char cVar0[32];
...
void func_618(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		{
			func_673(&(Global_1946804.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_674(iVar2, 0))
		{
			func_675(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_619(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_677(iParam0, &(Global_1946804.f_2657.f_21), Global_1946804.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_677(iParam0, &(Global_1946804.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_677(iParam0, &(Global_1946804.f_2657.f_20), Global_1946804.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_677(iParam0, &(Global_1946804.f_2657.f_22), Global_1946804.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_677(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_677(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_678(0))
	{
		...
		if (func_315() == 1160113249)
		{
			func_679(func_678(-2125499975), 0);
		}
		else
		{
			func_679(func_678(1160113249), 0);
		}
	}
	func_680();
	if (func_681(iVar0))
...
int func_654(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((((((((((((((((((((iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RAT_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_WOODPECKER_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ORIOLE_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ROBIN_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SPARROW_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TOAD_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CROW_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BAT_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BLUEJAY_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BULLFROG_PERFECT")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY")) || iVar0 == GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"))
	{
		if (func_61(iVar0, 1, 0))
		{
			...
			{
				Global_1901328.f_94 = 1;
				func_697(iVar0, 1, 0, -142743235, 0);
			}
			return 1;
		}
	}
...
void func_669(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4)
{
...
void func_671(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_701(iParam0, &(Global_1946804.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_701(iParam0, &(Global_1946804.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_701(iParam0, &(Global_1946804.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_701(iParam0, &(Global_1946804.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_701(iParam0, &(Global_1946804.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_701(iParam0, &(Global_1946804.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_672(int iParam0)
{
	...
	Var2.f_8 = -1;
	Var2.f_13 = -1;
	Var2 = { func_358(0, -1591664384, -1591664384, -1591664384, 0, iParam0) };
	if (func_360(&Var2, &iVar0, &iVar1, 0))
	{
		if (iVar1 > 0)
		{
			switch (iParam0)
...
bool func_674(int iParam0, int iParam1)
{
	...
	Var5 = { func_246(iParam0, Var0, Var0.f_4, 0) };
	if (func_357(iParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return false;
	}
...
int func_677(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		func_673(&(Global_1946804.f_2657.f_26.f_26), iParam0, Global_1946804.f_2657.f_19);
	}
...
int func_701(int iParam0, var uParam1)
{
	...
	if (Global_1946804.f_2657.f_19 == 1)
	{
		...
		*uParam1 = 0;
		if (func_110(iParam0) != -999503751)
		{
			func_716(&(Global_1946804.f_2657.f_26), 0, Global_1946804.f_2657.f_19);
		}
	...
	*uParam1 = (*uParam1 - 1);
	...
	if (func_110(iParam0) != -999503751)
	{
		func_716(&(Global_1946804.f_2657.f_26), iVar0, Global_1946804.f_2657.f_19);
	}
	func_674(iParam0, 1);
	return 1;
}
...
int func_711(int iParam0, var uParam1)
{
	...
	func_669(iParam0, &uVar1, &uVar2, &uVar0, &uVar3);
...
int func_713(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar31 = func_721(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar31) && func_722(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar31), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_304(&Var17, iVar2, iVar0, iVar1))
			{
				if (iParam0 == Var17.f_4)
				{
					...
					{
						iVar32 = 1;
						func_723(&iVar31, iParam0, &iVar32, 1, -142743235);
					}
					func_9(iVar0);
					return 1;
				}
			...
			if (func_31(iParam0, 412399755))
			{
				...
				if (func_279() == 0)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_281(iParam0) < func_282(iParam0))
						{
							func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, 709057512))
			{
				...
				if (func_279() == 1)
				{
					...
					if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_281(iParam0) < func_282(iParam0))
						{
							func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, -1478961327))
			{
				...
				if (func_279() == 2)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_ACUNAS_STAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CIGAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_281(iParam0) < func_282(iParam0))
						{
							func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, -1238404098))
			{
				...
				if (func_279() == 3)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_281(iParam0) < func_282(iParam0))
						{
							func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_31(iParam0, 1160548794))
			{
				...
				if (func_279() == 4)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_281(iParam0) < func_282(iParam0))
						{
							func_103(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
struct<4> func_740(int iParam0, int iParam1)
{
	struct<5> Var0;

	Var0 = { func_749(iParam0) };
	return func_750(iParam0, iParam1, Var0, Var0.f_4);
}
...
struct<5> func_749(int iParam0)
{
	struct<5> Var0;

	Var0 = { func_750(iParam0, GET_HASH_KEY("CHARACTER"), func_515(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_750(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_755(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	Var0 = { func_749(iParam0) };
	Var5 = { func_750(iParam0, iParam1, Var0, Var0.f_4) };
	return func_762(iParam0, iParam1, &Var5, iParam2, iParam3, bParam4);
}
...
int func_762(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	Var0.f_9 = -1591664384;
	if (!func_764(iParam0, *uParam2, &Var0, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
