			...
			else
			{
				...
				switch (iLocal_14)
				{
					...
					case 2:
						if (((func_65(&iLocal_253, iLocal_249, 2636.429f, -1229.537f, 52.3795f, 358.7895f, 2, bLocal_383, !bLocal_383) && func_66(&iLocal_256, iLocal_251, 2636.611f, -1230.318f, 52.8894f)) && func_66(&iLocal_257, iLocal_252, 2637.884f, -1230.344f, 53.1922f)) && func_66(&iLocal_255, iLocal_250, 2637.932f, -1230.235f, 53.2323f))
						{
							if (func_4(iLocal_253, 0))
							{
								...
								func_69(&iLocal_253, &uLocal_273, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
								...
								func_71(0);
								func_72(0, 0, "SPD_UC_GRT", "", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0);
								func_72(0, 1, "SPD_UC_ANT", "", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0);
					...
					case 75:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_152()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_154(75))
						{
							func_102(0);
							func_153();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 76:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_155()) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_271) >= func_154(76))
						{
							func_102(0);
							func_153();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
...
void func_1()
{
	...
	func_170(&iLocal_253, &uLocal_273, GET_HASH_KEY("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
...
bool func_327()
{
	if (((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630.f_12) && VOLUME::DOES_VOLUME_EXIST(iLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_260, true, 0)) && func_176(Global_35, iLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_316)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_316) >= func_451(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_253)) || func_452())) && iLocal_14 != 80) && iLocal_14 != 6) && !func_5(iLocal_272, 2)) && !func_453())
	{
		func_454(0, 1);
		return true;
	}
...
void func_329(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (Global_40.f_11623[iParam0 /*8*/].f_6 == 1 && func_456(func_455(GET_HASH_KEY("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_457(func_455(GET_HASH_KEY("SPECIAL_PED_INTERACTION")), 1);
	}
...
bool func_406(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_177(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_422(int iParam0, int iParam1)
{
	...
	if (func_500(iParam0, 1, 0, 0) != GET_HASH_KEY("WEAPON_LASSO"))
	{
		return false;
	}
...
void func_532(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_334(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_519(iParam1))
		{
			...
			iParam1->f_6 = func_545(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_334(iParam1->f_6))
			{
				if (!bParam6)
				{
