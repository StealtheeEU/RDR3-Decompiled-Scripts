...
int func_11(var uParam0)
{
	...
	func_29(bLocal_11, 1);
	func_30(&uLocal_42);
	func_15(13, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	func_31(&iLocal_58);
...
void func_19(var uParam0)
{
	...
	iLocal_58[0] = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), -1555.683f, -1417.174f, 90.1822f, 0f, 0f, -19.67098f, 2.626542f, 18.71136f, 3.681293f);
	iLocal_58[1] = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), -1558.386f, -1430.378f, 93.68977f, 0f, 0f, -29.25712f, 1.25935f, 3.725714f, 1.587422f);
	iLocal_58[2] = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), -1560.36f, -1436.362f, 93.68977f, 0f, 0f, -2.146133f, 1f, 3.464732f, 1.587422f);
	iLocal_58[3] = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), -1572.138f, -1442.667f, 90.88407f, 0f, 0f, 126.3318f, 3.18645f, 15.24051f, 4.382712f);
	...
	switch (iLocal_41)
	{
		case 0:
			if (CAM::IS_SCREEN_FADING_IN() || CAM::IS_SCREEN_FADED_IN())
			{
				...
				func_67(Global_35, bLocal_11, &Var0, 0f, 0f, 0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
				func_68(bLocal_11, Global_35, &Var0, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 8, 0, 0, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */, 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
				iLocal_41++;
			}
			break;
		case 1:
			...
			if (bLocal_63)
			{
				func_71(&uLocal_42, bLocal_11);
			}
			else if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_10, false) && CAM::_0xA2B1C7EF759A63CE() == 0f)
			{
				func_72(&uLocal_42);
				bLocal_63 = true;
			}
			...
			if ((!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_9, false) && !ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_9, false)) && func_73(&uLocal_64) >= 2f)
			{
...
void func_45(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_81(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_83(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_51(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_94(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_37(iParam0, 44, 1);
			}
...
void func_54(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam0 == func_99(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_100(bParam0))
	{
		if (func_101(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
	...
	if (func_79(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_54(bVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_54(bVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
...
void func_61(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_112(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_112(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_67(bool bParam0, bool bParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> Var0;
	struct<10> Var11;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam6))
	{
		...
		Var0.f_7 = iParam16;
		Var0.f_9 = iParam17;
		TASK::TASK_LEAD_AND_CONVERSE(bParam0, bParam1, &Var0, iParam8, iParam9, iParam10, iParam11, iParam13, iParam12);
	}
	else if (!func_117(vParam3, 0f, 0f, 0f))
	{
		...
		Var11.f_9 = iParam17;
		Var11.f_8 = iParam18;
		TASK::TASK_LEAD_AND_CONVERSE(bParam0, bParam1, &Var11, iParam8, iParam9, iParam10, iParam11, iParam13, iParam12);
	}
	if (bParam15)
	{
	...
	if (bParam19)
	{
		func_118(bParam0, bParam1, iParam14);
	}
}

void func_68(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> Var0;
...
int func_88(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_38(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_124(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_126(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_127(iParam0, 0));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_132(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_130(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_109(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4096 > 0 && func_105(bParam1, 879715242))
	{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 512 > 0 && func_105(bParam1, 1064646155))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1024 > 0 && func_105(bParam1, -536694793))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2048 > 0 && func_105(bParam1, -1304053509))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & -2147483648 > 0 && func_105(bParam1, 718939204))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 65536 > 0 && func_105(bParam1, -972364774))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16384 > 0 && func_105(bParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 262144 > 0 && func_105(bParam1, 1153596794))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 524288 > 0 && func_105(bParam1, 1016389820))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1048576 > 0 && func_105(bParam1, -726966617))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2097152 > 0 && func_105(bParam1, 1365901568))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 32768 > 0 && func_105(bParam1, -1658942149))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 131072 > 0 && func_105(bParam1, -1980913856))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4194304 > 0 && func_105(bParam1, 491764525))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8388608 > 0 && func_105(bParam1, -76015264))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16777216 > 0 && func_105(bParam1, 622113465))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 33554432 > 0 && func_105(bParam1, 781533162))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 67108864 > 0 && func_105(bParam1, -271415321))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 134217728 > 0 && func_105(bParam1, -1683207356))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 268435456 > 0 && func_105(bParam1, -254794762))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 536870912 > 0 && func_105(bParam1, 609066278))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1073741824 > 0 && func_105(bParam1, -1712783565))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8192 > 0 && func_105(bParam1, 1544915253))
	{
...
int func_112(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case GET_HASH_KEY("GROUP_SHOTGUN"):
			case GET_HASH_KEY("GROUP_RIFLE"):
				if (func_150(GET_HASH_KEY("WEAPON_REPEATER_CARBINE")))
				{
...
float func_124(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_158(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
struct<4> func_169(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_187(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
{
	return func_169(GET_HASH_KEY("CHARACTER"), func_192(), -1591664384, bParam0);
}
