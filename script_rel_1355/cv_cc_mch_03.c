...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0.15f, -0.72f, 1f, 38.88f, 2.5f, 2.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_BILL"), 1, 1, 1);
...
bool func_75(var uParam0)
{
	if (func_148(uParam0) == 3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_70))
		{
			STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_CRATE02X"), false);
			if (STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_CRATE02X")))
			{
				iLocal_70 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("P_CRATE02X"), func_165(uParam0, 0.778003f, -0.256235f, -0.0359992f), true, true, false, false, true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_69))
		{
			STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_BARREL05X"), false);
			if (STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_BARREL05X")))
			{
				iLocal_69 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("P_BARREL05X"), func_165(uParam0, -0.0861425f, 0.136672f, -0.00999832f), true, true, false, false, true);
...
bool func_86(var uParam0)
{
	...
	{
		if (WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iLocal_14), GET_HASH_KEY("WEAPON_REVOLVER_SCHOFIELD_BILL"), 0, false))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_14), GET_HASH_KEY("WEAPON_REVOLVER_SCHOFIELD_BILL"), true, 0, false, false);
		}
	}
	return true;
}
...
{
	return (((PED::CAN_PED_SEE_ENTITY(Global_35, func_48(uParam0, iLocal_14), false, false) == 1 || PED::CAN_PED_SEE_ENTITY(Global_35, func_48(uParam0, iLocal_15), false, false) == 1) || func_191(Global_35, func_48(uParam0, iLocal_14), 8f, 1)) && ((!func_192(uParam0, Local_39, 1, 0) && !func_192(uParam0, Local_49, 1, 0)) && !func_192(uParam0, Local_59, 1, 0)));
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
