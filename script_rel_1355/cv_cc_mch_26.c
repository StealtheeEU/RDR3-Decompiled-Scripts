...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.773f, -2.753f, 0f, 0f, 2.5f, 2.5f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	iLocal_22 = func_152(uParam0, GET_HASH_KEY("P_CHAIRFOLDING02X"), 1.83629f, -3.58281f, 0.0174561f, "CHAIR", 1, 0, 1);
	...
	func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, iLocal_15, 2, 0, 30, 0, 0);
	func_159(uParam0, GET_HASH_KEY("COMP_MCHCNV26"), GET_HASH_KEY("PLAYER_MCHCNV26"));
...
bool func_93(var uParam0)
{
	...
	if (func_198(uParam0, iLocal_21) && func_202(uParam0, iLocal_21, 0.98f))
	{
		if (func_199(uParam0, Local_23, 1, 0))
		{
			if (func_109(&uLocal_33) > 3f)
			{
				func_157(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_FIRE_TEND_KNEEL"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
				func_203(uParam0, iLocal_14, 3, 0);
				func_204(uParam0, iLocal_14, 1.2f, 1065353216 /* Float: 1f */, 30f);
				func_157(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_SMOKE_CIGAR"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_253()
{
	...
	if (func_339(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_254()
{
	...
	if (func_339(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_339(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_421(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
