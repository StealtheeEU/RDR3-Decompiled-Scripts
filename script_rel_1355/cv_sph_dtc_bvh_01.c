...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -1.5312f, -2.9055f, 0f, 0f, 2f, 2f, 5f, GET_HASH_KEY("VOLBOX"), -1, 1, 1, 1);
	iLocal_15 = func_151(uParam0, GET_HASH_KEY("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_16 = func_151(uParam0, GET_HASH_KEY("S_CARAVANCOT01X"), 0.821093f, -0.152114f, 0.244499f, 0, 1, 0, 1);
	func_152(uParam0, iLocal_14, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_MALE_B", -1, 1);
	func_153(uParam0, GET_HASH_KEY("COMP_DTCSPEECHBVHCNV1"), GET_HASH_KEY("PLAYER_DTCSPEECHBVHCNV1"));
	func_154(uParam0, iLocal_14, 2, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_14, 3, GET_HASH_KEY("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
