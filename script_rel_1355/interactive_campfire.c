...
void __EntryFunction__()
{
	...
	Var0.f_186 = 6;
	Var0.f_187 = -1;
	Var0.f_191 = GET_HASH_KEY("PROP_PLAYER_SLEEP_TENT_A_FRAME");
	Var0.f_197 = -1;
	Var0.f_207 = -1;
	Var0.f_208 = 1;
	Var0.f_210 = GET_HASH_KEY("P_CAMPFIRE02X_COMBO");
	...
	while (!func_3(1) && !bVar255)
	{
		switch (Var0.f_211)
		{
			...
			case 2:
				...
				Var0.f_248 = VOLUME::_0x0EB78C2B156635B1(GET_HASH_KEY("VOLCYLINDER"), Var0.f_249, 0f, 0f, 0f, 0.3f, 0.3f, 2f);
				func_8(&(Var0.f_211), 3);
				break;
			case 3:
				if (func_2(&Var0))
...
void func_7(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case GET_HASH_KEY("WB_INTERACTIVE_CAMPFIRE_CARAVAN"):
			func_6(&(uParam0->f_150), 6402);
			if (func_25(GET_HASH_KEY("UPGRADE_UPG_COFFEE_KIT"), 1, 0))
			{
				func_17(&(uParam0->f_150), 1);
			}
			break;
		case GET_HASH_KEY("WB_INTERACTIVE_CAMPFIRE_DFLT"):
			...
			break;
		case GET_HASH_KEY("WB_INTERACTIVE_CAMPFIRE_FIREPLACE"):
			...
			break;
		case GET_HASH_KEY("WB_INTERACTIVE_CAMPFIRE_FIREPLACE_IN_TOWNS"):
			func_6(&(uParam0->f_150), 7435);
			if (func_25(GET_HASH_KEY("UPGRADE_UPG_COFFEE_KIT"), 1, 0))
			{
				func_17(&(uParam0->f_150), 1);
			...
			break;
		case GET_HASH_KEY("WB_INTERACTIVE_CAMPFIRE_TWOPOINT"):
			func_6(&(uParam0->f_150), 6402);
			if (func_25(GET_HASH_KEY("UPGRADE_UPG_COFFEE_KIT"), 1, 0))
			{
				func_17(&(uParam0->f_150), 1);
			...
			break;
		case GET_HASH_KEY("WB_NON_INTERACTIVE_CAMPFIRE"):
			func_6(&(uParam0->f_150), 8075);
			func_17(&(uParam0->f_150), 64);
			uParam0->f_254 = 1;
			break;
		case GET_HASH_KEY("WB_NON_INTERACTIVE_CAMPFIRE_IN_TOWNS"):
			func_6(&(uParam0->f_150), 8075);
			func_17(&(uParam0->f_150), 64);
			uParam0->f_254 = 1;
			break;
		case GET_HASH_KEY("WB_NON_INTERACTIVE_CAMPFIRE_UNDERPOT"):
			func_6(&(uParam0->f_150), 8075);
			func_17(&(uParam0->f_150), 64);
			uParam0->f_212.f_4 = 1;
			uParam0->f_254 = 1;
			break;
		case GET_HASH_KEY("WB_NON_INTERACTIVE_CAMPFIRE_UNDERPOT_IN_TOWNS"):
			func_6(&(uParam0->f_150), 8075);
			func_17(&(uParam0->f_150), 64);
			uParam0->f_212.f_4 = 1;
			uParam0->f_254 = 1;
...
int func_13(var uParam0, bool bParam1)
{
	...
	{
		if (func_37(Global_35, 1, 0, 0) != GET_HASH_KEY("WEAPON_UNARMED"))
		{
			if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, GET_HASH_KEY("HOLSTERWEAPON")))
			{
	...
	switch (uParam0->f_153)
	{
		...
		case 3:
			...
			else
			{
				...
				PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_PLAYER_MENU"), false);
				PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_OPEN_JOURNAL"), false);
				PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_MULTIPLAYER_INFO"), false);
				...
				if ((func_80(uParam0) || !TASK::PED_HAS_USE_SCENARIO_TASK(Global_35)) || func_16(uParam0->f_151, 1))
				{
					...
					else if ((uParam0->f_154 == uParam0->f_156 || uParam0->f_156 == -1) || uParam0->f_157 == 1)
					{
						...
						if (uParam0->f_157 == 1)
						{
							uParam0->f_157 = 6;
							uParam0->f_155 = 6;
							uParam0->f_162[8] = func_81("DRINK", GET_HASH_KEY("INPUT_CRAFTING_EAT"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				...
				{
					if ((iVar4 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_CAMP_FIRE_KNEEL_ARTHUR") || iVar4 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SQUAT_MALE_A")) || iVar4 == GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_GENERIC"))
					{
						if (uParam0->f_157 == 12)
						{
							if (INVENTORY::_0x3D10D7179D7034AF(func_86(0), GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 0))
							{
								INVENTORY::_0x6A564540FAC12211(func_86(0), GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"));
							}
							func_87(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 0, 0, 0, 1, 0, 0);
							uParam0->f_196 = MISC::GET_GAME_TIMER();
							uParam0->f_157 = 0;
						}
						else if (uParam0->f_157 == 11)
						{
							func_87(GET_HASH_KEY("CUSTOM_SATCHEL"), 0, 0, 0, 1, 0, 0);
							uParam0->f_196 = MISC::GET_GAME_TIMER();
							uParam0->f_157 = 0;
						}
						else
					...
					else if (iVar4 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SIT_MALE_A"))
					{
						func_88(GET_HASH_KEY("SIT_TRANS_KNEEL"), 0.5f);
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
					else if (iVar4 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
					{
						func_88(GET_HASH_KEY("KNIFE1_TRANS_KNEEL1"), 2f);
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
					else if (iVar4 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
					{
						func_88(GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 2f);
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
				if (!TASK::PED_HAS_USE_SCENARIO_TASK(Global_35))
				...
				HUD::_UIPROMPT_SET_ACTIVE_GROUP_THIS_FRAME(-1067771379, MISC::VAR_STRING(0, GET_HASH_KEY("CONSUMABLE_COFFEE")), 1, 0, 0, 0);
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 442509369))
				{
					...
					func_93(GET_HASH_KEY("CONSUMABLE_COFFEE"), 1f, 1);
				}
				if ((func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 500) && iVar4 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
				{
					func_41(uParam0, 5);
				}
				if (!TASK::PED_HAS_USE_SCENARIO_TASK(Global_35))
				...
				if (func_38(uParam0))
				{
					...
					{
						case 8:
							func_88(GET_HASH_KEY("SQUAT_TRANS_KNEEL"), 0.5f);
							break;
						case 7:
							func_88(GET_HASH_KEY("SIT_TRANS_KNEEL"), 0.5f);
							break;
				...
				if ((func_16(uParam0->f_151, 1) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(uParam0->f_195, false)) || CAM::IS_SCREEN_FADED_OUT())
				{
					...
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_193))
					{
						...
						else
						{
							...
							if (uParam0->f_191 == GET_HASH_KEY("PROP_PLAYER_SLEEP_TENT_A_FRAME"))
							{
...
bool func_43(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_152))
	{
		if (func_16(uParam0->f_150, 512))
		{
			...
			(*uParam0)[0] = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL1"), vVar0, fVar3, 0, 0, 0);
		}
		if (func_16(uParam0->f_150, 1024))
		{
			...
			(*uParam0)[1] = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL2"), vVar0, fVar3, 0, 0, 0);
		}
		if (func_16(uParam0->f_150, 2048))
		{
			...
			(*uParam0)[2] = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL3"), vVar0, fVar3, 0, 0, 0);
		}
		if (func_16(uParam0->f_150, 4096))
		{
			...
			(*uParam0)[3] = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_KNEEL4"), vVar0, fVar3, 0, 0, 0);
		}
		if (func_16(uParam0->f_150, 2))
		{
			...
			(*uParam0)[4] = TASK::CREATE_SCENARIO_POINT_HASH(GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_PLAYER_CAMP"), vVar0, fVar3, 0, 0, 0);
...
void func_58(var uParam0)
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_193))
	{
		...
		{
			PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("SLEEP_TRANS_RESTING_W_HAT"), 3f);
			...
			func_145(1);
			func_146();
			if (TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_35) == GET_HASH_KEY("WORLD_PLAYER_SLEEP_BEDROLL"))
			{
...
int func_61()
{
	...
	switch (iVar0)
	{
		case GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_GENERIC"):
			return 9;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT"):
			return 3;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_CAMP_FIRE_KNEEL_ARTHUR"):
			return 6;
		case GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SQUAT_MALE_A"):
			return 8;
		case GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SIT_MALE_A"):
			return 7;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COFFEE_ARTHUR"):
			return 1;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_POST_FIRE_CRAFT"):
			return 4;
		default:
			break;
	}
...
void func_64(var uParam0)
{
	if (((!TASK::PED_HAS_USE_SCENARIO_TASK(Global_35) && func_16(uParam0->f_151, 4194304)) && !PED::IS_PED_CARRYING_SOMETHING(Global_35)) && !func_56(4))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_152))
		{
			...
			{
				uParam0->f_181 = func_151("REST_BY_FIRE", GET_HASH_KEY("INPUT_CONTEXT_Y"), uParam0->f_152, 1, 1, 1, 0, 5, 9f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0, 0);
			}
			...
			if (uParam0->f_57.f_84 > 0 && (func_21(Global_36, TASK::_GET_SCENARIO_POINT_COORDS((*uParam0)[0], true)) < 0.5625f || func_21(Global_36, TASK::_GET_SCENARIO_POINT_COORDS((*uParam0)[1], true)) < 0.5625f))
			{
				...
				{
					uParam0->f_183 = func_151("POUR_COFFEE", GET_HASH_KEY("INPUT_CONTEXT_A"), uParam0->f_152, 1, 1, 1, 0, 5, 9f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0, 0);
...
void func_65(var uParam0)
{
	if (func_16(uParam0->f_151, 4194304))
	{
		if (!func_70(uParam0->f_182))
		{
			...
			{
				uParam0->f_182 = func_151("CRAFT_COOK", GET_HASH_KEY("INPUT_CONTEXT_X"), uParam0->f_152, 0, 1, 1, 0, 5, 7f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0, 0);
		...
		switch (iVar1)
		{
			...
			case 3:
				if (func_56(16777216) || func_16(uParam0->f_151, 524288))
				{
					...
					if (bVar5)
					{
						PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("DYNAMIC_KNEEL_QUICK_ENTER"), 3f);
					}
...
void func_69()
{
	if (func_121(GET_HASH_KEY("WEAPON_KIT_BINOCULARS"), 0))
	{
		func_162(32);
	}
	if (func_121(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 0))
	{
		func_162(64);
	}
}
...
bool func_72()
{
	return (((!UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(GET_HASH_KEY("PLAYER_MENU")) && !Global_1898068.f_4) && !func_164()) && UIAPPS::CAN_LAUNCH_UIAPP_BY_HASH(GET_HASH_KEY("FAST_TRAVEL_MENU")));
}
...
void func_76()
{
	if (UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(GET_HASH_KEY("FAST_TRAVEL_MENU")) && func_77() != 0)
	{
...
void func_78(var uParam0)
{
	...
	iVar0 = PED::_0xC22AA08A8ADB87D4(Global_35);
	if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SIT_MALE_A"))
	{
	...
	if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_CAMP_FIRE_KNEEL_ARTHUR"))
	{
		...
		{
			func_31(&(uParam0->f_204));
			func_88(GET_HASH_KEY("KNEEL_TRANS_SQUAT"), 0.5f);
			uParam0->f_196 = MISC::GET_GAME_TIMER();
		}
	}
	else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SQUAT_MALE_A"))
	{
		if (func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 500)
		{
			...
			if (func_29(&(uParam0->f_204), 180f))
			{
				...
				if (!func_161())
				{
					func_88(GET_HASH_KEY("SQUAT_TRANS_SIT"), 0.5f);
					uParam0->f_196 = MISC::GET_GAME_TIMER();
				}
			}
		}
	}
	else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SIT_MALE_A"))
	{
		if (func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 500)
		{
			if (!func_125(&(uParam0->f_204)))
			...
			if (func_29(&(uParam0->f_204), 10f))
			{
				if (func_161())
				{
					func_31(&(uParam0->f_204));
					uParam0->f_196 = MISC::GET_GAME_TIMER();
					func_88(GET_HASH_KEY("SIT_TRANS_SQUAT"), 0.5f);
				}
			}
		}
	}
	else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
	{
		if (func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 500)
		{
			func_88(GET_HASH_KEY("KNIFE1_TRANS_KNEEL1"), 2f);
	...
	else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
	{
		if (func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 500)
		{
			func_88(GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 2f);
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_122(iParam0) == GET_HASH_KEY("EMOTE"))
	{
		Var0.f_3 = 0;
		Var0.f_1 = iParam0;
		Var0.f_2 = 0;
	...
	else if (func_122(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
		...
		else
		{
			switch (func_199(iParam0))
			{
				...
				case -1719060085:
					...
					{
						func_210(Global_35, GET_HASH_KEY("CLOTHING_ITEM_GLOVES_NONE"), 0, -358215195, 1, 1, 1, 0, 1, 0);
				...
				else
				{
					...
					else
					{
						...
						if (!func_16(Global_1392040.f_1, 1) || func_16(Global_1392040.f_1, 512))
						{
							...
							else if (func_200(GET_HASH_KEY("KIT_CAMP")))
							{
								if (func_218(1))
								{
									func_219(2);
						...
						if (func_37(Global_35, 1, 0, 0) != GET_HASH_KEY("WEAPON_KIT_BINOCULARS"))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_KIT_BINOCULARS"), true, 0, false, false);
						}
						return 1;
						Jump @2541; //curOff = 2248
						if (func_37(Global_35, 1, 0, 0) != GET_HASH_KEY("WEAPON_KIT_CAMERA"))
						{
						...
						func_226(iParam0, 1, 0, 562618531, 0);
						func_228(GET_HASH_KEY("PROVISION_BEAUS_GIFT_2"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
...
int func_89(var uParam0, int iParam1)
{
	...
	if (!func_165(uParam0->f_162[8], 0) && iParam1 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_POST_FIRE_CRAFT"))
	{
		func_84(uParam0->f_162[8], 1, 1);
	}
	if (func_229(uParam0->f_162[8], 1))
	{
		func_88(GET_HASH_KEY("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736 /* Float: 6f */);
...
void func_99(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	func_251(func_250(GET_HASH_KEY("ITEMS_CRAFTED")), iParam1);
	if (bParam3 && iParam0 != GET_HASH_KEY("CONSUMABLE_COFFEE"))
	{
		if (func_23() == -1)
		{
		...
		if (iParam4 == 0)
		{
			if (func_122(iParam0) == GET_HASH_KEY("HORSE_EQUIPMENT"))
			{
	...
	{
		Var1 = { func_260(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("FOOD")) };
	}
	else if (func_259(iParam0, 2))
	{
		Var1 = { func_260(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("AMMO")) };
	}
	else if (func_259(iParam0, 5))
	{
		Var1 = { func_260(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("HORSE_CARE")) };
	}
	else if (func_259(iParam0, 1))
	{
		Var1 = { func_260(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("REMEDIES")) };
	}
	else if (func_259(iParam0, 3))
	{
		Var1 = { func_260(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("WEAPONS")) };
	}
	else if (func_259(iParam0, 4))
	{
		Var1 = { func_260(GET_HASH_KEY("MADE_RECIPE_TYPE"), GET_HASH_KEY("HUNTING")) };
	}
	...
	iVar10 = 0;
	if ((ITEMDATABASE::ITEMDATABASE_FILLOUT_ITEM_INFO(iParam0, &vVar3) && vVar3.z == GET_HASH_KEY("CLOTHING")) && func_262(Global_35, iParam0, &iVar10))
	{
...
void func_110(var uParam0)
{
	...
	{
		iVar0 = PED::_0xC22AA08A8ADB87D4(Global_35);
		if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
		{
			func_88(GET_HASH_KEY("KNIFE1_TRANS_KNEEL1"), 1086324736 /* Float: 6f */);
			uParam0->f_196 = MISC::GET_GAME_TIMER();
		}
		else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
		{
			func_88(GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 1086324736 /* Float: 6f */);
			uParam0->f_196 = MISC::GET_GAME_TIMER();
		}
...
void func_131(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (UISTATEMACHINE::UI_STATE_MACHINE_REQUEST_TRANSITION(GET_HASH_KEY("CRAFTING"), 1383188602))
		{
		}
		else
		{
			UIAPPS::_CLOSE_UIAPP_BY_HASH(GET_HASH_KEY("CRAFTING"));
		}
	}
	else
	{
...
void func_159(int iParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (func_25(GET_HASH_KEY("PROVISION_TRINKET_BUCK_ANTLER"), 1, 0))
		{
...
bool func_161()
{
	...
	if (((((iVar0 == GET_HASH_KEY("RAIN") || iVar0 == GET_HASH_KEY("SHOWER")) || iVar0 == GET_HASH_KEY("SLEET")) || iVar0 == GET_HASH_KEY("HURRICANE")) || iVar0 == GET_HASH_KEY("THUNDERSTORM")) || iVar0 == GET_HASH_KEY("THUNDER"))
	{
		return true;
	}
	iVar1 = MISC::_GET_NEXT_WEATHER_TYPE_HASH_NAME();
	if (((((iVar1 == GET_HASH_KEY("RAIN") || iVar1 == GET_HASH_KEY("SHOWER")) || iVar1 == GET_HASH_KEY("SLEET")) || iVar1 == GET_HASH_KEY("HURRICANE")) || iVar1 == GET_HASH_KEY("THUNDERSTORM")) || iVar1 == GET_HASH_KEY("THUNDER"))
	{
		return true;
	}
	iVar2 = func_329();
...
void func_168(var uParam0, int iParam1)
{
	...
	if (func_16(iParam1, 1))
	{
		...
		{
			uParam0->f_162[0] = func_81("KNEEL_FIRE", GET_HASH_KEY("INPUT_CONTEXT_B"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	...
	if (((func_16(iParam1, 4096) && func_16(uParam0->f_150, 16)) && !func_56(536870912)) && uParam0->f_157 != 2)
	{
		...
		{
			uParam0->f_162[5] = func_81("CRAFT_COOK", GET_HASH_KEY("INPUT_CONTEXT_X"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	...
	if (func_16(iParam1, 64) && func_16(uParam0->f_150, 16384))
	{
		...
		{
			uParam0->f_162[17] = func_81("CAMP_FT_PROMPT", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 2, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	...
	{
		if (!func_70(uParam0->f_162[9]) && func_25(GET_HASH_KEY("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
		{
			uParam0->f_162[9] = func_81("JOURNAL", GET_HASH_KEY("INPUT_OPEN_JOURNAL"), 3, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
		...
		if (!func_70(uParam0->f_162[10]))
		{
			uParam0->f_162[10] = func_81("CAMP_SATCHEL", GET_HASH_KEY("INPUT_OPEN_SATCHEL_MENU"), 3, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
	...
	if ((func_16(iParam1, 2) && func_16(uParam0->f_150, 1)) && uParam0->f_57.f_84 > 0)
	{
		...
		{
			uParam0->f_162[2] = func_81("POUR_COFFEE", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	...
	if (func_16(iParam1, 8) && func_16(uParam0->f_150, 2))
	{
		if (!func_70(uParam0->f_162[1]))
		{
			if (uParam0->f_154 == 4)
			{
				uParam0->f_162[1] = func_81("PLAYER_SIT", GET_HASH_KEY("INPUT_CONTEXT_B"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			}
			else if (func_16(iParam1, 32))
			{
				uParam0->f_162[1] = func_81("PLAYER_SIT", GET_HASH_KEY("INPUT_CONTEXT_X"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			}
			else
			{
				uParam0->f_162[1] = func_81("PLAYER_SIT", GET_HASH_KEY("INPUT_CONTEXT_Y"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
			}
	...
	if ((func_16(iParam1, 16) && !func_56(536870912)) && uParam0->f_157 != 2)
	{
		...
		{
			uParam0->f_162[3] = func_81("LEAVE", GET_HASH_KEY("INPUT_CONTEXT_B"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		...
		if (func_16(iParam1, 524288) && func_16(uParam0->f_151, 131072))
		{
			...
			{
				uParam0->f_162[16] = func_81("LEAVE", GET_HASH_KEY("INPUT_CONTEXT_B"), 2, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
	...
	if (func_23() != 0 && func_16(uParam0->f_150, 256))
	{
		if (!func_56(2048) || func_16(uParam0->f_151, 2))
		{
			if (((func_16(iParam1, 32) && !func_56(536870912)) && uParam0->f_157 != 2) && func_333(uParam0))
			{
				...
				{
					uParam0->f_162[4] = func_81("SLEEP", GET_HASH_KEY("INPUT_CONTEXT_Y"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		...
		case 1:
			switch (uParam0->f_155)
			{
				...
				case 6:
					...
					{
						if (func_88(GET_HASH_KEY("KNEEL1_TRANS_COFFEE1"), 1f))
						{
							return 1;
						}
					}
		...
		case 1:
			switch (uParam0->f_155)
			{
				...
				case 6:
					...
					{
						func_88(GET_HASH_KEY("KNEEL2_TRANS_COFFEE2"), 1f);
						return 1;
					}
					break;
				default:
...
{
	if (func_122(iParam0) == GET_HASH_KEY("EMOTE"))
	{
		return false;
	}
...
void func_191(int iParam0, struct<11> Param1, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, struct<2> Param17, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, int iParam27, bool bParam28, int iParam29)
{
	switch (iParam0)
	{
		...
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_REWARD2"):
			if (func_270())
			{
				func_353(GET_HASH_KEY("JOURNAL_RC_MAYOR4_AR"), 0);
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_MAYOR4_AR")))
			{
				func_353(GET_HASH_KEY("JOURNAL_RC_MAYOR4B_JN"), 0);
			}
			break;
		case GET_HASH_KEY("DOCUMENT_LETTER_MAYOR_REWARD2_JN"):
			func_353(GET_HASH_KEY("JOURNAL_RC_MAYOR4A_JN"), 0);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_RCM_FMA_LETTER"):
			...
			if (func_270() == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_RC_FMA5_1_AR"), 0);
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_FMA5_1_AR")))
			{
				if (func_355(77))
				{
					func_353(GET_HASH_KEY("JOURNAL_RC_FMA5_2_JN"), 0);
				}
				else
				{
					func_353(GET_HASH_KEY("JOURNAL_RC_FMA5_1_JN"), 0);
				}
			}
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			if ((func_264() && !func_356(51)) && !func_357(1048576))
			{
				...
				func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 2, 0);
				func_361(1048576);
			}
			break;
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			if ((func_264() && !func_356(51)) && !func_357(16384))
			{
				func_358(1);
				func_359(51, 0, 0, 0, 0, -1, 0);
				func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 5, 0);
				func_361(16384);
			}
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_ROCK_CARVINGS"):
			if ((func_264() && !func_356(50)) && !func_368(32))
			{
				...
				if (!func_120(Global_1347702[50 /*49*/].f_15, 1))
				{
					if (func_270() == 1)
					{
						func_353(GET_HASH_KEY("JOURNAL_RC_ROCKCARV15_AR"), 0);
					}
					else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_ROCKCARV15_AR")))
					{
						func_353(GET_HASH_KEY("JOURNAL_RC_ROCKCARV15_JN"), 0);
					}
				}
			}
			break;
...
bool func_200(int iParam0)
{
	...
	if (func_122(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
		if (func_199(iParam0) == -999503751)
		{
...
void func_209(int iParam0)
{
	...
	if (iVar1 == iParam0)
	{
		...
		func_210(Global_35, GET_HASH_KEY("CLOTHING_ITEM_HAT_NONE"), 0, -358215195, 1, 1, 1, 0, 1, 0);
		func_211(iParam0, 0);
		return;
	}
...
bool func_226(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (func_122(iParam0) == GET_HASH_KEY("WEAPON"))
	{
...
int func_228(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_122(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_122(iParam0) == GET_HASH_KEY("AMMO") && func_460(iParam0))
		{
		...
		{
			func_251(func_250(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_251(func_260(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_190(iParam0, 589988438))
		{
			if (func_465())
			{
				func_466(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_210(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_478(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_210(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_484(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_485(499813453, 0);
				func_486(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_484(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_485(499813453, 0);
				func_486(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_484(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_485(499813453, 0);
				func_486(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_484(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_485(666607663, 0);
				func_487(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_484(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_485(666607663, 0);
				func_487(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_484(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_485(666607663, 0);
				func_487(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_484(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_485(-220219788, 0);
				func_488(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_484(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_485(-220219788, 0);
				func_488(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_484(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_485(-220219788, 0);
				func_488(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_484(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_485(218622660, 0);
				func_489(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_484(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_485(218622660, 0);
				func_489(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_484(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_485(390004462, 0);
				func_490(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_484(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_485(390004462, 0);
				func_490(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_484(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_485(390004462, 0);
				func_490(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_484(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_485(6410548, 0);
				func_491(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_484(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_485(6410548, 0);
				func_491(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_484(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_485(6410548, 0);
				func_491(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_484(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_485(6410548, 0);
				func_491(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_493(242, func_492(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_493(240, func_492(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_493(241, func_492(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
...
void func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_251(func_523(GET_HASH_KEY("MEDICINE_ITEMS_USED")), 1);
	}
	if (func_190(iParam0, -1457797660))
	{
		func_251(func_523(GET_HASH_KEY("PROVISION_ITEMS_USED")), 1);
	}
	...
	{
		func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("TONIC")), 1);
	}
	switch (iParam0)
	{
		...
		case GET_HASH_KEY("CONSUMABLE_HAYCUBE"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("FEED_BAG")), 1);
			break;
	}
	switch (iParam0)
	{
		case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("MOONSHINE")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_WHISKEY_USED"):
		case GET_HASH_KEY("CONSUMABLE_WHISKEY"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("WHISKEY")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case GET_HASH_KEY("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("COCAINE_GUM")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_SNAKE_OIL"):
		case GET_HASH_KEY("CONSUMABLE_POTENT_SNAKE_OIL"):
		case GET_HASH_KEY("CONSUMABLE_SNAKE_OIL_USED"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("SNAKE_OIL")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO"):
		case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("CHEWING_TOBACCO")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_HORSE_MEDICINE"):
		case GET_HASH_KEY("CONSUMABLE_HORSE_MEDICINE_USED"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("HORSE_PILLS")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_COVER_SCENT_USED"):
		case GET_HASH_KEY("CONSUMABLE_COVER_SCENT"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("COVER_SCENT")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_HERBIVORE_BAIT"):
		case GET_HASH_KEY("CONSUMABLE_POTENT_HERBIVORE_BAIT"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("POTENT_HERBIVORE_BAIT")), 1);
			break;
		case GET_HASH_KEY("CONSUMABLE_PREDATOR_BAIT"):
		case GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT"):
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("POTENT_PREDATOR_BAIT")), 1);
			break;
	}
	if (func_23() == -1)
	{
		...
		{
			func_251(func_260(GET_HASH_KEY("USED"), GET_HASH_KEY("SPECIAL_TONIC")), 1);
		}
	}
	if (bParam2)
	{
		func_251(func_523(GET_HASH_KEY("DEADEYE_ITEMS_USED")), 1);
	}
}
...
bool func_249(var uParam0)
{
	...
	if (func_56(268435456) && uParam0->f_149 < 13)
	{
		...
		if ((MISC::GET_GAME_TIMER() - uParam0->f_197) > 1000 && func_541(&(uParam0->f_57)))
		{
			...
			if (func_85(uParam0))
			{
				if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SQUAT_MALE_A"))
				{
					func_88(GET_HASH_KEY("SQUAT_TRANS_KNEEL"), 0.5f);
					return false;
				}
			...
			func_130(&(uParam0->f_57));
			func_45(&(uParam0->f_57), 2);
			uParam0->f_162[6] = func_81("CRAFT_FASTER", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 6, 7000, 10000, 25, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	...
	switch (uParam0->f_149)
	{
		case 0:
			...
			if (((func_85(uParam0) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336)) && (((((iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP") || iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_CAMP_FIRE_KNEEL_ARTHUR")) || iVar0 == GET_HASH_KEY("PROP_PLAYER_SEAT_CHAIR_GENERIC")) || iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE")) || iVar0 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SQUAT_MALE_A")) || iVar0 == GET_HASH_KEY("WORLD_PLAYER_CAMP_FIRE_SIT_MALE_A"))) || func_547(&(uParam0->f_57)) == 12)
			{
				...
				if (func_547(&(uParam0->f_57)) == 11)
				{
					...
					else if (uParam0->f_57.f_80)
					{
						...
						{
							uParam0->f_162[8] = func_81("POUR_COFFEE", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 0, 6000, 10000, 25, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
							func_84(uParam0->f_162[8], 0, 1);
							func_82(uParam0->f_162[8], -1067771379, 0, 1);
							func_552(uParam0, 0);
						}
						...
						{
							uParam0->f_162[6] = func_81("CRAFT_FASTER", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 6, 6000, 10000, 25, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
							func_545(uParam0, 6, 0, 0);
							func_84(uParam0->f_162[6], 0, 1);
							func_82(uParam0->f_162[6], -1067771379, 0, 1);
						}
		...
		case 1:
			if (func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 250)
			{
				...
				{
					if (func_88(GET_HASH_KEY("KNIFE1_TRANS_KNEEL1"), 1086324736 /* Float: 6f */))
					{
					}
				}
				else if (func_372(uParam0->f_57.f_77, -1636519629) == -701492487)
				{
					if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
					{
						if (func_88(GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 1086324736 /* Float: 6f */))
						{
							func_62(uParam0, 2);
						}
					}
					else if (uParam0->f_154 == 0)
					{
						if (func_340(uParam0, 0))
						{
							func_88(GET_HASH_KEY("KNEEL1_TRANS_BREWCOFFEE_KNEEL1"), 1f);
							func_62(uParam0, 9);
						}
					}
					else if (uParam0->f_154 == 1)
					{
						if (func_340(uParam0, 1))
						{
							func_88(GET_HASH_KEY("KNEEL2_TRANS_BREWCOFFEE_KNEEL2"), 1f);
							func_62(uParam0, 9);
						}
					}
				...
				{
					func_88(GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEELFIRECRAFT"), 1086324736 /* Float: 6f */);
					func_62(uParam0, 2);
				}
				else
				{
					func_88(GET_HASH_KEY("KNEEL1_TRANS_KNEELFIRECRAFT"), 1086324736 /* Float: 6f */);
					func_62(uParam0, 2);
				}
				uParam0->f_196 = MISC::GET_GAME_TIMER();
			}
		...
		case 2:
			...
			if (func_152(uParam0->f_162[6], 1) || func_372(uParam0->f_57.f_77, -1636519629) == -701492487)
			{
				...
				func_144(&(uParam0->f_162[6]), 1, 1);
				if (((func_122(uParam0->f_57.f_77) == GET_HASH_KEY("CONSUMABLE") && !func_190(uParam0->f_57.f_77, -1242251796)) && !func_190(uParam0->f_57.f_77, 1919582297)) && !func_190(uParam0->f_57.f_77, -651046900))
				{
					uParam0->f_162[8] = func_81("USE_ITEM", GET_HASH_KEY("INPUT_CRAFTING_EAT"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					func_82(uParam0->f_162[8], -1067771379, 0, 1);
					func_83(uParam0->f_162[8], 10, 1, 1);
					uParam0->f_162[7] = func_81("STOW_ITEM", GET_HASH_KEY("INPUT_CONTEXT_X"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		...
		case 3:
			if (func_85(uParam0))
			{
				...
				{
					if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE"))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
						func_88(GET_HASH_KEY("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFT"), 1f);
						func_31(&(uParam0->f_201));
					}
					else
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
						func_88(GET_HASH_KEY("KNEELFIRECRAFT_TRANS_KNEELPOSTFIRECRAFT"), 1086324736 /* Float: 6f */);
					}
				}
			}
			if (func_70(uParam0->f_162[8]))
			{
				...
				func_232(2, 7000);
				func_232(1, 7000);
				if (func_165(uParam0->f_162[8], 0) && (func_229(uParam0->f_162[8], 1) || PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_CRAFTING_EAT"))))
				{
					if (!func_98(0))
					{
			...
			if ((!func_70(uParam0->f_162[8]) || (func_165(uParam0->f_162[7], 0) && (func_555(uParam0->f_162[7], 1) || PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_CONTEXT_X"))))) || func_138(Global_35, 0))
			{
				func_144(&(uParam0->f_162[8]), 1, 1);
				func_144(&(uParam0->f_162[7]), 1, 1);
				ATTRIBUTE::STOP_ITEM_PREVIEW();
		...
		case 4:
			if (func_85(uParam0) && ((MISC::GET_GAME_TIMER() - uParam0->f_196) > 100 || func_125(&(uParam0->f_201))))
			{
				if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE"))
				{
					func_88(GET_HASH_KEY("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736 /* Float: 6f */);
				}
				else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT"))
				{
					func_88(GET_HASH_KEY("KNEELFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736 /* Float: 6f */);
					func_88(GET_HASH_KEY("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736 /* Float: 6f */);
				}
				else
				{
					func_88(GET_HASH_KEY("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736 /* Float: 6f */);
		...
		case 5:
			if (func_85(uParam0) && ((MISC::GET_GAME_TIMER() - uParam0->f_196) > 100 || func_125(&(uParam0->f_201))))
			{
				if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE"))
				{
					func_88(GET_HASH_KEY("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736 /* Float: 6f */);
				}
				else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT"))
				{
					func_88(GET_HASH_KEY("KNEELFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736 /* Float: 6f */);
					func_88(GET_HASH_KEY("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736 /* Float: 6f */);
				}
				else
				{
		...
		case 12:
			...
			if ((func_85(uParam0) && (MISC::GET_GAME_TIMER() - uParam0->f_196) > 500) && iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
			{
				func_62(uParam0, 0);
			}
			break;
		case 13:
			if (func_85(uParam0))
			{
				...
				func_55(268435456);
				uParam0->f_196 = MISC::GET_GAME_TIMER();
				if (func_16(uParam0->f_150, 8) && uParam0->f_57.f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
				{
					switch (uParam0->f_154)
					{
						case 0:
							if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
							{
								if (func_88(GET_HASH_KEY("KNIFE1_TRANS_COOKGRILL_A"), 1086324736 /* Float: 6f */))
								{
									func_47(16384);
									func_62(uParam0, 14);
								}
							}
							else if (func_88(GET_HASH_KEY("KNEEL1_TRANS_COOKGRILL1_A"), 1086324736 /* Float: 6f */))
							{
								func_47(16384);
								func_62(uParam0, 14);
							}
						...
						case 1:
							if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
							{
								if (func_88(GET_HASH_KEY("KNIFE2_TRANS_COOKGRILL2_B"), 1086324736 /* Float: 6f */))
								{
									func_47(16384);
									func_62(uParam0, 14);
								}
							}
							else if (func_88(GET_HASH_KEY("KNEEL2_TRANS_COOKGRILL2_B"), 1086324736 /* Float: 6f */))
							{
								func_47(16384);
								func_62(uParam0, 14);
							}
						...
						case 3:
							...
							break;
						case 4:
							if (func_88(GET_HASH_KEY("STOOL1_TRANS_STOOLCOOKGRILL1_A"), 1086324736 /* Float: 6f */))
							{
								func_47(16384);
								func_62(uParam0, 14);
							}
				...
				{
					func_88(GET_HASH_KEY("KNIFE1_TRANS_COOKKNIFE"), 1086324736 /* Float: 6f */);
					func_47(16384);
					func_62(uParam0, 14);
				}
				else
				{
					func_88(GET_HASH_KEY("KNEEL1_TRANS_COOKKNIFE"), 1086324736 /* Float: 6f */);
					func_47(16384);
					func_62(uParam0, 14);
				}
			}
		...
		case 14:
			...
			if (func_152(uParam0->f_162[6], 1))
			{
				...
				uParam0->f_162[7] = func_81("STOW_ITEM", GET_HASH_KEY("INPUT_CONTEXT_X"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				uParam0->f_162[8] = func_81("EAT_MEAT", GET_HASH_KEY("INPUT_CRAFTING_EAT"), 1, 0, 0, 0, 570, 4000, 1, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				func_83(uParam0->f_162[8], 10, 1, 1);
				func_83(uParam0->f_162[7], 10, 1, 1);
				func_82(uParam0->f_162[7], -1067771379, 0, 1);
				func_82(uParam0->f_162[8], -1067771379, 0, 1);
		...
		case 15:
			...
			if (func_85(uParam0))
			{
				if (func_336(&(uParam0->f_201), 0.1f))
				{
					...
					if (func_16(uParam0->f_150, 8) && uParam0->f_57.f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
					{
						...
						{
							case 0:
								if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_SEARGRILL1"))
								{
									func_88(GET_HASH_KEY("SEARGRILL1_TRANS_BETWEEN_BITES"), 1f);
								}
								else
								{
									func_88(GET_HASH_KEY("COOKGRILL1_TRANS_BETWEEN_BITES"), 1f);
								}
								break;
							case 1:
								if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2_SEARGRILL2"))
								{
									func_88(GET_HASH_KEY("SEARGRILL2_TRANS_BETWEEN_BITES"), 1f);
								}
								else
								{
									func_88(GET_HASH_KEY("COOKGRILL2_TRANS_BETWEEN_BITES"), 1f);
								}
								break;
						}
					}
					else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR"))
					{
						func_88(GET_HASH_KEY("COOKKNIFE_SEAR_TRANS_BETWEEN_BITES"), 2f);
					}
					else
					{
						func_88(GET_HASH_KEY("COOKKNIFE_TRANS_BETWEEN_BITES"), 2f);
					}
				}
			}
			if (func_70(uParam0->f_162[8]))
			...
			{
				if ((((func_165(uParam0->f_162[7], 0) && (func_229(uParam0->f_162[7], 1) || PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_CONTEXT_X")))) || func_16(uParam0->f_151, 256)) || func_138(Global_35, 0)) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_35, true))
				{
					func_48(16);
		...
		case 20:
			if (func_85(uParam0) && ((MISC::GET_GAME_TIMER() - uParam0->f_196) > 250 || func_125(&(uParam0->f_201))))
			{
				if (!func_16(uParam0->f_150, 8) || uParam0->f_57.f_78 != GET_HASH_KEY("COST_CRAFTING_GRILL"))
				{
					if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR"))
					{
						func_88(GET_HASH_KEY("COOKKNIFE_SEAR_TRANS_KNIFE1_STOW"), 1f);
					}
					else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ARTHUR"))
					{
						func_88(GET_HASH_KEY("COOKKNIFE_TRANS_KNIFE1_STOW"), 1f);
					}
					else
					{
						func_88(GET_HASH_KEY("BETWEEN_BITES_TRANS_KNIFE1_STOW"), 1f);
					}
				}
				else
				{
					switch (uParam0->f_154)
					{
						case 0:
							if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_SEARGRILL1"))
							{
								func_88(GET_HASH_KEY("SEARGRILL1_TRANS_KNIFE1_STOW"), 1f);
							}
							else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL1"))
							{
								func_88(GET_HASH_KEY("COOKGRILL_TRANS_KNIFE1_STOW"), 1f);
							}
							else
							{
								func_88(GET_HASH_KEY("BETWEEN_BITES_TRANS_KNIFE1_STOW"), 1f);
						...
						case 1:
							if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2_SEARGRILL2"))
							{
								func_88(GET_HASH_KEY("SEARGRILL2_TRANS_KNIFE2_STOW"), 1f);
							}
							else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2"))
							{
								func_88(GET_HASH_KEY("COOKGRILL2_TRANS_KNIFE2_STOW"), 1f);
							}
							else
							{
								func_88(GET_HASH_KEY("BETWEEN_BITES_TRANS_KNIFE1_STOW"), 1f);
		...
		case 17:
			if (func_85(uParam0) && ((MISC::GET_GAME_TIMER() - uParam0->f_196) > 250 || func_125(&(uParam0->f_201))))
			{
				if (uParam0->f_57.f_32 && uParam0->f_57.f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
				{
					switch (uParam0->f_154)
					{
						case 0:
							if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_SEARGRILL1"))
							{
								func_88(GET_HASH_KEY("SEARGRILL_TRANS_KNIFE1_EAT"), 1f);
							}
							else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL1"))
							{
								func_88(GET_HASH_KEY("COOKGRILL1_TRANS_KNIFE1_EAT"), 1f);
							}
							else
							{
								func_88(GET_HASH_KEY("BETWEEN_BITES_TRANS_KNIFE1_EAT"), 2f);
							}
							break;
						case 1:
							if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2_SEARGRILL2"))
							{
								func_88(GET_HASH_KEY("SEARGRILL2_TRANS_KNIFE2_EAT"), 1f);
							}
							else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2"))
							{
								func_88(GET_HASH_KEY("COOKGRILL2_TRANS_KNIFE2_EAT"), 1f);
							}
							else
							{
								func_88(GET_HASH_KEY("BETWEEN_BITES_TRANS_KNIFE1_EAT"), 2f);
				...
				{
					func_88(GET_HASH_KEY("COOKKNIFE_SEAR_TRANS_KNIFE1_EAT"), 1f);
				}
				else if (iVar0 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ARTHUR"))
				{
					func_88(GET_HASH_KEY("COOKKNIFE_TRANS_KNIFE1_EAT"), 1f);
				}
				else
				{
					func_88(GET_HASH_KEY("BETWEEN_BITES_TRANS_KNIFE1_EAT"), 2f);
...
void func_256(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_575(iParam0, &Var7, iVar11, iVar10, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_190(iParam0, 1443104131)) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == GET_HASH_KEY("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
{
	return func_260(GET_HASH_KEY("MADE"), iParam0);
}
...
void func_261(int iParam0)
{
	...
	func_577(MISC::VAR_STRING(6, func_589(iParam0), fVar1), "itemtype_textures", func_590(iVar0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_262(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_122(iParam1) != GET_HASH_KEY("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_23() != -1;
...
struct<5> func_296(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_122(iParam0))
	{
		case GET_HASH_KEY("CLOTHING"):
			...
			{
				Var0 = { func_346(GET_HASH_KEY("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case GET_HASH_KEY("UPGRADE"):
			...
			{
				Var0 = { func_346(GET_HASH_KEY("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
int func_301(int iParam0, bool bParam1, int iParam2)
{
	...
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("FEATURE_XP")))
	{
		return 0;
	}
	if (!func_626(iParam0))
...
int func_316(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("A_C_HAWK_01"):
		case GET_HASH_KEY("A_C_CORMORANT_01"):
		case GET_HASH_KEY("A_C_SONGBIRD_01"):
		case GET_HASH_KEY("A_C_ORIOLE_01"):
		case GET_HASH_KEY("A_C_ROBIN_01"):
		case GET_HASH_KEY("A_C_ROSEATESPOONBILL_01"):
		case GET_HASH_KEY("A_C_SPARROW_01"):
		case GET_HASH_KEY("A_C_OWL_01"):
		case GET_HASH_KEY("A_C_RAVEN_01"):
		case GET_HASH_KEY("A_C_CRANEWHOOPING_01"):
		case GET_HASH_KEY("A_C_REDFOOTEDBOOBY_01"):
		case GET_HASH_KEY("A_C_CEDARWAXWING_01"):
		case GET_HASH_KEY("A_C_SEAGULL_01"):
		case GET_HASH_KEY("A_C_CROW_01"):
		case GET_HASH_KEY("A_C_PIGEON"):
		case GET_HASH_KEY("A_C_LOON_01"):
		case GET_HASH_KEY("A_C_WOODPECKER_01"):
		case GET_HASH_KEY("A_C_WOODPECKER_02"):
		case GET_HASH_KEY("A_C_EGRET_01"):
		case GET_HASH_KEY("A_C_HERON_01"):
		case GET_HASH_KEY("A_C_VULTURE_01"):
		case GET_HASH_KEY("A_C_CALIFORNIACONDOR_01"):
		case GET_HASH_KEY("A_C_EAGLE_01"):
		case GET_HASH_KEY("A_C_BLUEJAY_01"):
		case GET_HASH_KEY("A_C_CARDINAL_01"):
			return GET_HASH_KEY("CONSUMABLE_GAMEY_BIRD_COOKED");
		case GET_HASH_KEY("A_C_ARMADILLO_01"):
		case GET_HASH_KEY("A_C_SNAKEREDBOA_01"):
		case GET_HASH_KEY("A_C_CHIPMUNK_01"):
		case GET_HASH_KEY("A_C_POSSUM_01"):
		case GET_HASH_KEY("A_C_SKUNK_01"):
		case GET_HASH_KEY("A_C_BADGER_01"):
		case GET_HASH_KEY("A_C_MUSKRAT_01"):
		case GET_HASH_KEY("A_C_SNAKEWATER_01"):
		case GET_HASH_KEY("A_C_FOX_01"):
		case GET_HASH_KEY("A_C_COYOTE_01"):
		case GET_HASH_KEY("A_C_SNAKE_01"):
		case GET_HASH_KEY("A_C_BEAVER_01"):
		case GET_HASH_KEY("A_C_SNAKEBLACKTAILRATTLE_01"):
		case GET_HASH_KEY("A_C_RAT_01"):
		case GET_HASH_KEY("A_C_RACCOON_01"):
		case GET_HASH_KEY("A_C_SNAKEFERDELANCE_01"):
		case GET_HASH_KEY("A_C_SQUIRREL_01"):
			return GET_HASH_KEY("CONSUMABLE_STRING_MEAT_COOKED");
		case GET_HASH_KEY("A_C_IGUANA_01"):
		case GET_HASH_KEY("A_C_TURTLESEA_01"):
		case GET_HASH_KEY("A_C_FROGBULL_01"):
		case GET_HASH_KEY("A_C_IGUANADESERT_01"):
		case GET_HASH_KEY("A_C_TURTLESNAPPING_01"):
		case GET_HASH_KEY("A_C_TOAD_01"):
			return GET_HASH_KEY("CONSUMABLE_HERPTILE_MEAT_COOKED");
		case GET_HASH_KEY("A_C_FISHBLUEGIL_01_SM"):
		case GET_HASH_KEY("A_C_FISHCHANNELCATFISH_01_XL"):
		case GET_HASH_KEY("A_C_FISHLONGNOSEGAR_01_LG"):
		case GET_HASH_KEY("A_C_FISHBULLHEADCAT_01_MS"):
		case GET_HASH_KEY("A_C_FISHBULLHEADCAT_01_SM"):
		case GET_HASH_KEY("A_C_FISHCHANNELCATFISH_01_LG"):
		case GET_HASH_KEY("A_C_FISHBLUEGIL_01_MS"):
			return GET_HASH_KEY("CONSUMABLE_GRITTY_FISH_MEAT_COOKED");
		case GET_HASH_KEY("A_C_BIGHORNRAM_01"):
		case GET_HASH_KEY("A_C_GOAT_01"):
		case GET_HASH_KEY("A_C_SHEEP_01"):
			return GET_HASH_KEY("CONSUMABLE_GRISTLY_MUTTON_COOKED");
		case GET_HASH_KEY("A_C_FISHROCKBASS_01_MS"):
		case GET_HASH_KEY("A_C_FISHSMALLMOUTHBASS_01_LG"):
		case GET_HASH_KEY("A_C_FISHMUSKIE_01_LG"):
		case GET_HASH_KEY("A_C_FISHCHAINPICKEREL_01_MS"):
		case GET_HASH_KEY("A_C_FISHPERCH_01_MS"):
		case GET_HASH_KEY("A_C_FISHLAKESTURGEON_01_LG"):
		case GET_HASH_KEY("A_C_FISHREDFINPICKEREL_01_MS"):
		case GET_HASH_KEY("A_C_FISHROCKBASS_01_SM"):
		case GET_HASH_KEY("A_C_FISHLARGEMOUTHBASS_01_MS"):
		case GET_HASH_KEY("A_C_FISHCHAINPICKEREL_01_SM"):
		case GET_HASH_KEY("A_C_FISHLARGEMOUTHBASS_01_LG"):
		case GET_HASH_KEY("A_C_FISHREDFINPICKEREL_01_SM"):
		case GET_HASH_KEY("A_C_FISHNORTHERNPIKE_01_LG"):
		case GET_HASH_KEY("A_C_FISHPERCH_01_SM"):
		case GET_HASH_KEY("A_C_FISHSMALLMOUTHBASS_01_MS"):
			return GET_HASH_KEY("CONSUMABLE_FLAKEY_FISH_COOKED");
		case GET_HASH_KEY("A_C_CHICKEN_01"):
		case GET_HASH_KEY("A_C_TURKEYWILD_01"):
		case GET_HASH_KEY("A_C_TURKEY_01"):
		case GET_HASH_KEY("A_C_TURKEY_02"):
		case GET_HASH_KEY("A_C_GOOSECANADA_01"):
		case GET_HASH_KEY("A_C_ROOSTER_01"):
		case GET_HASH_KEY("A_C_PRAIRIECHICKEN_01"):
			return GET_HASH_KEY("CONSUMABLE_PLUMP_BIRD_COOKED");
		case GET_HASH_KEY("A_C_COW"):
		case GET_HASH_KEY("A_C_BULL_01"):
		case GET_HASH_KEY("A_C_OX_01"):
		case GET_HASH_KEY("A_C_BUFFALO_01"):
			return GET_HASH_KEY("CONSUMABLE_PRIME_BEEF_COOKED");
		case GET_HASH_KEY("A_C_ELK_01"):
		case GET_HASH_KEY("A_C_BUCK_01"):
		case GET_HASH_KEY("A_C_MOOSE_01"):
		case GET_HASH_KEY("A_C_DEER_01"):
		case GET_HASH_KEY("A_C_PRONGHORN_01"):
			return GET_HASH_KEY("CONSUMABLE_MATURE_VENISON_COOKED");
		case GET_HASH_KEY("A_C_PIG_01"):
		case GET_HASH_KEY("A_C_JAVELINA_01"):
		case GET_HASH_KEY("A_C_BOAR_01"):
			return GET_HASH_KEY("CONSUMABLE_TENDER_PORK_COOKED");
		case GET_HASH_KEY("A_C_DUCK_01"):
		case GET_HASH_KEY("A_C_RABBIT_01"):
		case GET_HASH_KEY("A_C_PHEASANT_01"):
		case GET_HASH_KEY("A_C_QUAIL_01"):
			return GET_HASH_KEY("CONSUMABLE_GAME_MEAT_COOKED");
		case GET_HASH_KEY("A_C_FISHSALMONSOCKEYE_01_MS"):
		case GET_HASH_KEY("A_C_FISHRAINBOWTROUT_01_LG"):
		case GET_HASH_KEY("A_C_FISHRAINBOWTROUT_01_MS"):
		case GET_HASH_KEY("A_C_FISHSALMONSOCKEYE_01_LG"):
			return GET_HASH_KEY("CONSUMABLE_SUCCULENT_FISH_COOKED");
		case GET_HASH_KEY("A_C_PARROT_01"):
		case GET_HASH_KEY("A_C_PELICAN_01"):
		case GET_HASH_KEY("A_C_CAROLINAPARAKEET_01"):
			return GET_HASH_KEY("CONSUMABLE_EXOTIC_BIRD_COOKED");
		case GET_HASH_KEY("A_C_ALLIGATOR_01"):
		case GET_HASH_KEY("A_C_ALLIGATOR_02"):
		case GET_HASH_KEY("A_C_ALLIGATOR_03"):
		case GET_HASH_KEY("A_C_WOLF"):
		case GET_HASH_KEY("A_C_BEAR_01"):
		case GET_HASH_KEY("A_C_WOLF_MEDIUM"):
		case GET_HASH_KEY("A_C_WOLF_SMALL"):
		case GET_HASH_KEY("A_C_COUGAR_01"):
		case GET_HASH_KEY("A_C_BEARBLACK_01"):
		case GET_HASH_KEY("A_C_PANTHER_01"):
			return GET_HASH_KEY("CONSUMABLE_BIG_GAME_MEAT_COOKED");
		case GET_HASH_KEY("A_C_CRAB_01"):
			return GET_HASH_KEY("CONSUMABLE_CRUSTACEAN_MEAT_COOKED");
	}
	return 0;
}
...
{
	if (func_122(iParam0) == GET_HASH_KEY("CONSUMABLE") && INVENTORY::_0x245D07651B1D183B(iParam0, 16777216))
	{
		return true;
	}
	return false;
...
int func_320(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_640(&Var4, GET_HASH_KEY("LOOT_TYPE_NORMAL"));
...
bool func_321(int iParam0)
{
	...
	if (func_190(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL")))
	{
		return true;
	}
...
bool func_342(var uParam0)
{
	...
	else
	{
		...
		{
			case 1:
				func_88(GET_HASH_KEY("COFFEE_TRANS_KNEEL"), 1086324736 /* Float: 6f */);
				break;
		}
	}
	return false;
...
bool func_352(bool bParam0, bool bParam1)
{
	...
	if (func_678(GET_HASH_KEY("SIMPLE_CRAFTING")) || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("SIMPLE_CRAFTING")) > 0)
	{
		if (bParam0)
		{
			func_201("CAMP_UNUSABLE_ACTIVITY", 10000, 0, 0, 0, 1);
...
void func_359(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_690(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_690(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_375(var uParam0)
{
	...
	if (func_704(*uParam0, GET_HASH_KEY("HATS"), 0))
	{
		return true;
	}
	return false;
...
{
	return func_751(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, GET_HASH_KEY("VOLCYLINDER"), iParam0, iParam1);
}
...
struct<2> func_436(int iParam0)
{
	...
	if (func_190(iParam0, -305066475))
	{
		if (func_23() == -1)
		{
			...
			{
				return func_523(GET_HASH_KEY("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_523(GET_HASH_KEY("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_190(iParam0, -537818634))
	{
		return func_523(GET_HASH_KEY("MEDICINE_ITEMS"));
	}
	if (func_190(iParam0, 2084895747))
	{
		return func_523(GET_HASH_KEY("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
bool func_459(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_297(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_770())
				{
					return false;
				}
...
bool func_461(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_25(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_462(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_774()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_465()
{
	if (((((func_781(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_781(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_781(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_781(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_781(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_781(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_467(int iParam0)
{
	...
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_359(51, 0, 0, 0, 0, -1, 0);
			func_361(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_359(51, 0, 0, 0, 0, -1, 0);
			func_361(524288);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_DINO_BONES"):
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_360(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_785(1), 0, -1, 0);
			func_786(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_360(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_785(2), 0, -1, 0);
			func_786(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_360(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_785(4), 0, -1, 0);
			func_786(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_360(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_785(8), 0, -1, 0);
			func_786(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_360(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_785(16), 0, -1, 0);
			func_786(16);
			break;
	}
}
...
void func_470(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_63(437, 0);
			func_63(440, 0);
			func_789(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_359(51, 0, 0, sVar0, func_693(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_361(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_789(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_359(51, 0, 0, sVar0, func_693(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_361(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_789(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_359(51, 0, 0, sVar0, func_693(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_361(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_789(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_359(51, 0, 0, sVar0, func_693(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_361(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_63(438, 0);
			func_789(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_360(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_359(51, 0, 0, sVar0, func_693(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_361(32768);
			break;
		default:
			func_63(439, 0);
...
void func_472(int iParam0, int iParam1)
{
	...
	if (func_23() == -1)
	{
		...
		{
			func_791(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_792() == 0)
			{
				func_101(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_791(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_792() == 1)
			{
				func_101(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_794(iParam0) < func_795(iParam0))
					{
						func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_791(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_792() == 2)
			{
				func_101(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_796(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_797(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_261(48);
					}
					if (func_794(iParam0) < func_795(iParam0))
					{
						func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_791(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_792() == 3)
			{
				func_101(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_794(iParam0) < func_795(iParam0))
					{
						func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_791(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_792() == 4)
			{
				func_101(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_794(iParam0) < func_795(iParam0))
					{
						func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_475(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_466(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_466(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_466(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_466(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_466(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_466(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_466(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_466(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_466(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_466(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_466(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_466(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_801())
			{
				func_466(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_466(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_466(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_466(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_466(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_466(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_466(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_466(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_466(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_466(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_466(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_466(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_466(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_466(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_476(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_101(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_802(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_803(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_804(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
void func_485(int iParam0, bool bParam1)
{
	...
	func_690(MISC::VAR_STRING(2, sVar1), MISC::VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar3), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_499(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == GET_HASH_KEY("KIT_BANDANA") && func_725(81053684, 0) <= 0)
			{
	...
	{
		if (!func_811(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_210(Global_35, iParam0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_456(24);
		if (func_478(&iVar2, 0))
		{
...
void func_502(int iParam0, char* sParam1)
{
	...
	func_577(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_815(iParam0), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_525(int iParam0, int iParam1)
{
	...
	Var0 = { func_260(GET_HASH_KEY("EATEN"), func_841(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_251(func_250(GET_HASH_KEY("HERBS_EATEN")), iParam1);
}
...
bool func_526(var uParam0)
{
	...
	if (!func_70(uParam0->f_162[3]))
	{
		uParam0->f_162[3] = func_81("CAMP_REC_BACK", GET_HASH_KEY("INPUT_CONTEXT_B"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		func_82(uParam0->f_162[3], 1323335645, 0, 1);
	}
	if (func_56(524288))
	{
		uParam0->f_162[12] = func_81("CMP_SLP_MRN", GET_HASH_KEY("INPUT_CONTEXT_A"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	else if (uParam0->f_187 > 3 && uParam0->f_187 <= 9)
	{
		uParam0->f_162[13] = func_81("CMP_SLP_NOON", GET_HASH_KEY("INPUT_CONTEXT_Y"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[14] = func_81("CMP_SLP_EVE", GET_HASH_KEY("INPUT_CONTEXT_X"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[15] = func_81("CMP_SLP_MDN", GET_HASH_KEY("INPUT_CONTEXT_A"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	else if (uParam0->f_187 > 9 && uParam0->f_187 <= 15)
	{
		uParam0->f_162[14] = func_81("CMP_SLP_EVE", GET_HASH_KEY("INPUT_CONTEXT_Y"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[15] = func_81("CMP_SLP_MDN", GET_HASH_KEY("INPUT_CONTEXT_X"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[12] = func_81("CMP_SLP_MRN", GET_HASH_KEY("INPUT_CONTEXT_A"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	else if (uParam0->f_187 > 15 && uParam0->f_187 <= 21)
	{
		uParam0->f_162[15] = func_81("CMP_SLP_MDN", GET_HASH_KEY("INPUT_CONTEXT_Y"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[12] = func_81("CMP_SLP_MRN", GET_HASH_KEY("INPUT_CONTEXT_X"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[13] = func_81("CMP_SLP_NOON", GET_HASH_KEY("INPUT_CONTEXT_A"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	else if (uParam0->f_187 > 21 || uParam0->f_187 <= 3)
	{
		uParam0->f_162[12] = func_81("CMP_SLP_MRN", GET_HASH_KEY("INPUT_CONTEXT_Y"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[13] = func_81("CMP_SLP_NOON", GET_HASH_KEY("INPUT_CONTEXT_X"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		uParam0->f_162[14] = func_81("CMP_SLP_EVE", GET_HASH_KEY("INPUT_CONTEXT_A"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	bVar1 = true;
	if (func_56(524288))
	{
...
void func_540(var uParam0)
{
	...
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_AMMO_RIFLE"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_AMMO_REPEATER"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_AMMO_45MM"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_AMMO_9MM"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_AMMO_SHOTGUN"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_CFT_ARROW"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("W_MELEE_TOMAHAWK01"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("W_MELEE_KNIFE05"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_CS_RAG01X"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_CFT_MOLOTOV01"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("S_CFT_MOLOTOV02"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_MOLOTOVEMPTY01X"), false);
	STREAMING::REQUEST_MODEL(GET_HASH_KEY("W_STICK_DYNAMITE01"), false);
	func_853(uParam0);
	TXD::REQUEST_STREAMED_TEXTURE_DICT("satchel_textures", false);
	if (uParam0->f_31)
	{
		STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_WHITEFISHFILET01XB"), false);
		STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_REDFISHFILET01XB"), false);
		STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_WHITEFLESHYMEAT01XB"), false);
		STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_REDBIRDBREAST01XB"), false);
		STREAMING::REQUEST_MODEL(GET_HASH_KEY("P_REDEFLESHYMEAT01XB"), false);
	}
}
...
bool func_541(var uParam0)
{
	...
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_AMMO_RIFLE")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_AMMO_REPEATER")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_AMMO_45MM")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_AMMO_9MM")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_CFT_ARROW")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("W_MELEE_TOMAHAWK01")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("W_MELEE_KNIFE05")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_AMMO_SHOTGUN")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_MOLOTOVEMPTY01X")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_CFT_MOLOTOV01")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("S_CFT_MOLOTOV02")))
	{
		return false;
	}
	if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("W_STICK_DYNAMITE01")))
	{
		return false;
	}
	if (uParam0->f_31)
	{
		if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_WHITEFISHFILET01XB")))
		{
			return false;
		}
		if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_REDFISHFILET01XB")))
		{
			return false;
		}
		if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_WHITEFLESHYMEAT01XB")))
		{
			return false;
		}
		if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_REDBIRDBREAST01XB")))
		{
			return false;
		}
		if (!STREAMING::HAS_MODEL_LOADED(GET_HASH_KEY("P_REDEFLESHYMEAT01XB")))
		{
			return false;
		}
	}
...
int func_544(int iParam0)
{
	...
	return GET_HASH_KEY("P_REDEFLESHYMEAT01XB");
}
...
void func_549(var uParam0, int iParam1)
{
	...
	switch (func_547(uParam0))
	{
		...
		case 8:
			PAD::DISABLE_ALL_CONTROL_ACTIONS(0);
			if (UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(GET_HASH_KEY("CRAFTING")))
			{
				if (UISTATEMACHINE::UI_STATE_MACHINE_CAN_REQUEST_TRANSITION(GET_HASH_KEY("CRAFTING")))
				{
		...
		case 10:
			...
			if (func_864(uParam0))
			{
				func_130(uParam0);
				func_875(uParam0, 1);
				(*uParam0)[2] = func_81("CAMP_REC_QUIT", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), 3, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				if (func_66(32))
				{
				...
				(*uParam0)[1] = func_81("CAMP_REC_MAKE", GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				...
				(*uParam0)[3] = func_81(func_877(uParam0), GET_HASH_KEY("INPUT_GAME_MENU_EXTRA_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				(*uParam0)[5] = func_878("RECIPE", GET_HASH_KEY("INPUT_GAME_MENU_LEFT"), GET_HASH_KEY("INPUT_GAME_MENU_RIGHT"), 0);
				func_879((*uParam0)[5], GET_HASH_KEY("INPUT_GAME_MENU_LEFT"));
				func_879((*uParam0)[5], GET_HASH_KEY("INPUT_GAME_MENU_RIGHT"));
				...
				(*uParam0)[6] = func_81("INFO", GET_HASH_KEY("INPUT_GAME_MENU_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
				if (!uParam0->f_82)
				{
		...
		case 12:
			...
			if (iVar8 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP"))
			{
				if (!PED::_0x68821369A2CEADD5(Global_35, GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEEL1")))
				{
					PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 6f);
					PED::_0x6D07B371E9439019(Global_35);
				}
				return;
			}
			if (iVar9 != -715814988)
			{
				if (iVar8 == GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
				{
					if (!PED::_0x68821369A2CEADD5(Global_35, GET_HASH_KEY("KNIFE1_TRANS_KNEEL1")))
					{
						PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("KNIFE1_TRANS_KNEEL1"), 6f);
						PED::_0x6D07B371E9439019(Global_35);
					}
					return;
				}
			...
			else
			{
				...
				if (iVar8 != GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
				{
					if (uParam0->f_31)
					{
						if (!PED::_0x68821369A2CEADD5(Global_35, GET_HASH_KEY("KNEEL1_TRANS_KNIFE1")))
						{
							PED::_0xD65FDC686A031C83(Global_35, GET_HASH_KEY("KNEEL1_TRANS_KNIFE1"), 2f);
							PED::_0x6D07B371E9439019(Global_35);
						}
						return;
					}
			...
			if (func_864(uParam0))
			{
				...
				{
					uParam0->f_53 = 250;
					(*uParam0)[1] = func_81("CAMP_REC_MAKE", GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, uParam0->f_53, uParam0->f_53 + 1, 1, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					func_881(uParam0, uParam0->f_77, uParam0->f_78);
				...
				{
					(*uParam0)[1] = func_81("CAMP_REC_MAKE", GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, 250, 251, 1, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
					func_82((*uParam0)[1], -1067771379, 0, 1);
			...
			if (func_891(iVar9))
			{
				if (!uParam0->f_36)
				{
					if (func_165((*uParam0)[1], 0))
					{
						if (func_555((*uParam0)[1], 1) || PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT")))
						{
							uParam0->f_36 = 1;
							func_84((*uParam0)[1], 0, 1);
				...
				if ((((((iVar9 == -1136843638 || iVar9 == -732326901) || iVar9 == 786205940) || iVar9 == -1141771998) || iVar9 == 364689687) || iVar9 == -842117252) || iVar9 == -1610298873)
				{
					if (uParam0->f_88 != 0)
					{
						if ((uParam0->f_88 == GET_HASH_KEY("S_CFT_ARROW_SMALLGAME") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1011038463)) || (uParam0->f_88 != GET_HASH_KEY("S_CFT_ARROW_SMALLGAME") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 2024314131)))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_86))
							{
								OBJECT::DELETE_OBJECT(&(uParam0->f_86));
					...
					if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 966057053))
					{
						...
						{
							uParam0->f_86 = WEAPON::_CREATE_WEAPON_OBJECT(GET_HASH_KEY("WEAPON_THROWN_THROWING_KNIVES"), 1, Global_36, true, 1f);
						}
						else if (iVar9 == -1141771998)
						{
							uParam0->f_86 = WEAPON::_CREATE_WEAPON_OBJECT(GET_HASH_KEY("WEAPON_THROWN_TOMAHAWK"), 1, Global_36, true, 1f);
						}
						else if (iVar9 == -842117252)
						{
							uParam0->f_86 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("P_MOLOTOVEMPTY01X"), Global_36, true, true, false, false, true);
						}
						else if (iVar9 == -1610298873)
						{
							uParam0->f_86 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("W_STICK_DYNAMITE01"), Global_36, true, true, false, false, true);
							if (iVar9 == -1610298873)
							{
								ANIMSCENE::SET_ANIM_SCENE_ENTITY(func_892(uParam0, iVar9), "DYNAMITE", uParam0->f_86, 0);
							}
						...
						{
							uParam0->f_86 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("S_CFT_ARROW"), Global_36, true, true, false, false, false);
						}
						ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(uParam0->f_86, false, false);
						if (iVar9 == 786205940)
						{
				...
				if (!uParam0->f_36)
				{
					if (!(func_165((*uParam0)[1], 0) && PAD::IS_CONTROL_PRESSED(0, GET_HASH_KEY("INPUT_GAME_MENU_ACCEPT"))))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, GET_HASH_KEY("SAFETOBREAKOUT")))
						{
		...
		case 13:
			...
			else if (func_152((*uParam0)[4], 1))
			{
				...
				if (iVar11 != GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
				{
					WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_UNARMED"), true, 0, false, false);
				}
				iVar9 = func_372(uParam0->f_77, -1636519629);
		...
		case 14:
			...
			if ((iVar14 == 0 || (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iVar14) || ANIMSCENE::HAS_ANIM_SCENE_EXITED(iVar14, false))) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336))
			{
				...
				if (iVar15 != GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE"))
				{
					WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_UNARMED"), true, 0, false, false);
				}
...
void func_550(var uParam0)
{
	...
	if (uParam0->f_57.f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
	{
		bVar0 = true;
	}
	else
	...
	if (bVar0)
	{
		func_251(func_250(GET_HASH_KEY("FOOD_SEASONED")), 1);
	}
	STATS::_0x378D3B1B11D9385B(uParam0->f_57.f_77);
	func_47(16384);
	func_55(65536);
	...
	if (bVar0)
	{
		uParam0->f_162[6] = func_81("CRAFT_FASTER", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 6, 7000, 10000, 35, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	}
	else
	{
		uParam0->f_162[6] = func_81("CRAFT_FASTER", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 6, 7000, 10000, 25, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
...
void func_552(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		uParam0->f_162[6] = func_81("CRAFT_FASTER", GET_HASH_KEY("INPUT_CONTEXT_A"), 2, 0, 0, 0, 7000, 10000, 25, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		func_545(uParam0, 6, 0, 1);
		func_84(uParam0->f_162[6], 0, 1);
		func_82(uParam0->f_162[6], -1067771379, 0, 1);
	}
	uParam0->f_162[11] = func_81("CAMP_REC_BACK", GET_HASH_KEY("INPUT_CONTEXT_B"), 1, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
	uParam0->f_162[3] = func_81("CAMP_REC_BACK", GET_HASH_KEY("INPUT_CONTEXT_B"), 1, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
...
void func_554(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ARTHUR"):
			if (bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("COOKKNIFE_TRANS_COOKKNIFE_ACTIVE"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
			...
			break;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL1"):
			if (bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("COOKGRILL1_TRANS_SEARGRILL1"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
			...
			break;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2"):
			if (bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("COOKGRILL2_TRANS_SEARGRILL2"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
			...
			break;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR"):
			if (!bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("COOKKNIFE_ACTIVE_TRANS_COOKKNIFE"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
			...
			break;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_SEARGRILL1"):
			if (!bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("SEARGRILL1_TRANS_COOKGRILL1"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
			...
			break;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_COOKGRILL2_SEARGRILL2"):
			if (!bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("SEARGRILL2_TRANS_COOKGRILL2"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT"):
			if (bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("KNEELFIRECRAFT_TRANS_KNEELFIRECRAFTACTIVE"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
			...
			break;
		case GET_HASH_KEY("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE"):
			if (!bVar0)
			{
				if (func_85(uParam0))
				{
					if (func_88(GET_HASH_KEY("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFT"), 0.5f))
					{
						uParam0->f_196 = MISC::GET_GAME_TIMER();
					}
				}
...
bool func_558(var uParam0)
{
	...
	if (uParam0->f_154 == 0)
	{
		func_88(GET_HASH_KEY("KNEEL1_TRANS_COFFEE1"), 6f);
		uParam0->f_196 = MISC::GET_GAME_TIMER();
		return true;
	}
	else if (uParam0->f_154 == 1)
	{
		func_88(GET_HASH_KEY("KNEEL2_TRANS_COFFEE2"), 6f);
		uParam0->f_196 = MISC::GET_GAME_TIMER();
		return true;
	}
	else if (uParam0->f_154 == 2)
...
bool func_568(int iParam0, int iParam1)
{
	...
	if (func_896(Var14, iParam1))
	{
		if (func_897(iParam0))
		{
			if (func_898(GET_HASH_KEY("SLOTID_HORSE_HORN"), &iVar18))
			{
		...
		{
			if (func_898(GET_HASH_KEY("SLOTID_HORSE_HORN"), &iVar19))
			{
				if (func_568(iVar19, 0))
				{
				}
			}
			if (func_898(GET_HASH_KEY("SLOTID_HORSE_STIRRUP"), &iVar20))
			{
...
int func_571()
{
	...
	{
		iVar14 = func_899(Var5, GET_HASH_KEY("SLOTID_HORSE_SADDLE"), 0);
	}
...
{
	return func_346(GET_HASH_KEY("CHARACTER"), func_906(), -1591664384, bParam0);
}
...
{
	return func_122(iParam0) == GET_HASH_KEY("WEAPON");
}
...
{
	if (func_923(iParam0, GET_HASH_KEY("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_645(int iParam0)
{
	...
	{
		case 2:
			return GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PERFECT");
		case 1:
			return GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_HIGH_QUALITY");
		case 0:
			return GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_POOR");
		default:
			break;
	}
	return GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_POOR");
...
void func_667(int iParam0)
{
	...
	if (Global_1900073.f_17 && func_37(Global_35, 1, 0, 0) == GET_HASH_KEY("WEAPON_FISHINGROD"))
	{
...
int func_701()
{
	...
	if (iVar1 == GET_HASH_KEY("WEAPON_UNARMED"))
	{
		...
		else if ((WEAPON::IS_WEAPON_VALID(iVar0) && func_328(iVar0)) || iVar0 == GET_HASH_KEY("WEAPON_LASSO"))
		{
			return 1;
		}
		else
...
void func_703(int iParam0, bool bParam1)
{
	...
	if (func_122(iParam0) == GET_HASH_KEY("CONSUMABLE"))
	{
			...
			if (func_190(iParam0, 412399755))
			{
				...
				if (func_792() == 0)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_794(iParam0) < func_795(iParam0))
						{
							func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_190(iParam0, 709057512))
			{
				...
				if (func_792() == 1)
				{
					...
					if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_794(iParam0) < func_795(iParam0))
						{
							func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_190(iParam0, -1478961327))
			{
				...
				if (func_792() == 2)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_ACUNAS_STAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CIGAR")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_794(iParam0) < func_795(iParam0))
						{
							func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_190(iParam0, -1238404098))
			{
				...
				if (func_792() == 3)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_794(iParam0) < func_795(iParam0))
						{
							func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_190(iParam0, 1160548794))
			{
				...
				if (func_792() == 4)
				{
					...
					if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_794(iParam0) < func_795(iParam0))
						{
							func_360(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
void func_765(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_692("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_692("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_692("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_692("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", GET_HASH_KEY("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_23() == -1)
			{
				if (!func_811(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) || func_1045(GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_770())
					{
					...
					func_210(Global_35, iVar0, 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
int func_782(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_25(GET_HASH_KEY("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_783(int iParam0, char* sParam1, int iParam2)
{
	...
	func_577(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_784(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_577(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_577(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_251(func_523(GET_HASH_KEY("CAREER_CASH")), iVar1);
	}
}
...
int func_787()
{
	...
	while (iVar1 < 30)
	{
		if (func_1052(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_815(int iParam0)
{
	...
	if (!func_1078(iParam0, &uVar0, GET_HASH_KEY("INVENTORY"), 0, 0, GET_HASH_KEY("UI_ITEMVIEWER")))
	{
...
int func_857(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_905(iParam0, iParam1, &Var0, &iVar34, 1, 0))
	{
		...
		while (iVar36 < iVar34)
		{
			...
			{
				if (iVar33 == GET_HASH_KEY("CURRENCY_CASH"))
				{
				...
				if (func_1001(iVar38))
				{
					...
					func_251(func_260(GET_HASH_KEY("USED_IN_RECIPE"), iVar39), Var0[iVar36 /*2*/].f_1);
				}
			}
			iVar36++;
		}
...
bool func_872(var uParam0, bool bParam1)
{
	...
	uParam0->f_58 = 1;
	if (bParam1 && UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(GET_HASH_KEY("CRAFTING")))
	{
		if (UISTATEMACHINE::UI_STATE_MACHINE_REQUEST_TRANSITION(GET_HASH_KEY("CRAFTING"), 1014850361))
		{
			func_294(1);
			func_47(8);
			return true;
	...
	{
		iVar0 = UIAPPS::LAUNCH_UIAPP_BY_HASH(GET_HASH_KEY("CRAFTING"));
		if (iVar0 == 0)
		{
			func_47(8);
			func_294(1);
...
void func_874(bool bParam0)
{
	...
	if (bParam0)
	{
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_UP"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_DOWN"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_LS"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_STICK_DOWN"), false);
		PAD::DISABLE_CONTROL_ACTION(0, GET_HASH_KEY("INPUT_GAME_MENU_STICK_UP"), false);
	}
}
...
int func_878(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != 0)
	{
		func_177(iVar1, iParam1, sParam0, 0, 3, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam3, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 0, iParam2, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0);
		return iVar1;
	}
	return 0;
}
...
void func_881(var uParam0, int iParam1, int iParam2)
{
	...
	else if (func_23() == -1)
	{
		...
		{
			if (iParam1 != GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT"))
			{
				bVar3 = false;
			}
		}
	...
	if (bVar3)
	{
		if (((func_560(iParam1, 1, 0) || ((!uParam0->f_83 || uParam0->f_84 > 0) && func_372(iParam1, -1636519629) == -701492487)) || (!uParam0->f_31 && ((uParam0->f_80 || iParam2 == -214678071) || iParam2 == GET_HASH_KEY("COST_CRAFTING_GRILL")))) || (!uParam0->f_32 && iParam2 == GET_HASH_KEY("COST_CRAFTING_GRILL")))
		{
			bVar3 = false;
		}
	...
	if (!uParam0->f_80 && !func_317(uParam0->f_77))
	{
		...
		if (iVar1 != 0)
		{
			...
			if (iVar0 != -1610298873)
			{
				if (iVar0 == -842117252)
				{
					uParam0->f_88 = GET_HASH_KEY("S_CFT_MOLOTOV01");
				}
				...
				{
					uParam0->f_88 = GET_HASH_KEY("S_CFT_ARROW_DYNAMITE");
				}
				else if (func_190(uParam0->f_77, -1846429632))
				{
					uParam0->f_88 = GET_HASH_KEY("S_CFT_ARROW_FIRE");
				}
				else if (func_190(uParam0->f_77, -1067199465))
				{
					uParam0->f_88 = GET_HASH_KEY("S_CFT_ARROW_SMALLGAME");
				}
				else
				{
		...
		func_84((*uParam0)[2], 0, 1);
		func_331((*uParam0)[2], 0, 1);
		(*uParam0)[4] = func_81("CAMP_REC_BACK", GET_HASH_KEY("INPUT_GAME_MENU_CANCEL"), 1, 0, 0, 5, 570, 4000, 10, 1073741824 /* Float: 2f */, GET_HASH_KEY("MEDIUM_TIMED_EVENT"), 0);
...
void func_885(var uParam0, bool bParam1)
{
	...
	if (DATABINDING::DATABINDING_IS_ENTRY_VALID(uParam0->f_73))
	{
		...
		bVar2 = false;
		if (uParam0->f_78 == -214678071 || uParam0->f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
		{
			if (bParam1)
			{
				iVar0++;
			...
			{
				Var5 = { func_904(-1591664384, -1591664384, 0, 0, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, -1, func_372(uParam0->f_77, 1697966752), 0) };
				if (func_1111(Var5, &iVar3, &iVar4, 0))
				{
					if (iVar4 > 0)
					{
						...
						while (iVar16 < iVar4)
						{
							...
							{
								uParam0->f_78 = GET_HASH_KEY("COST_CRAFTING_GRILL");
								uParam0->f_77 = iVar17;
								bVar2 = true;
							}
							else
		...
		else
		{
			...
			Var19.f_4 = 15;
			Var19.f_36 = 10;
			while (((Var19.f_2 != GET_HASH_KEY("COST_TYPE_CRAFT") || Var19 == -489628648) || (!Global_1911914.f_1579 && func_920(uParam0->f_77, Var19, 1))) && iVar66 < iVar18)
			{
				iVar66++;
				if (bParam1)
				{
...
void func_889(var uParam0)
{
	...
	else if (iVar0 == 364689687)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_87))
		{
			uParam0->f_87 = OBJECT::CREATE_OBJECT(GET_HASH_KEY("P_CS_RAG01X"), Global_36, true, true, false, false, false);
...
void func_914(int iParam0, int iParam1, int iParam2)
{
	...
	func_690(sVar7, sVar1, iVar8, iVar9, GET_HASH_KEY("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_1132(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
bool func_921(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	while (iVar34 < iVar31)
	{
		...
		else
		{
			...
			if (Var0[iVar34 /*2*/] == GET_HASH_KEY("CURRENCY_CASH") && func_1134(iVar32))
			{
				Jump @390; //curOff = 134
			}
			else if (Var0[iVar34 /*2*/] == GET_HASH_KEY("CURRENCY_GOLD_BAR") && func_1135(iVar32))
			{
			}
			else
			{
...
{
	func_640(uParam0, GET_HASH_KEY("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == GET_HASH_KEY("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_640(uParam0, GET_HASH_KEY("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_640(uParam0, GET_HASH_KEY("LOOTER_PED_IS_FEMALE"));
	}
}
...
int func_978()
{
	...
	while (iVar1 < 30)
	{
		if (func_1168(COLLECTION::_0x126CBEBBA46693CF(iVar1, GET_HASH_KEY("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_1046()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(GET_HASH_KEY("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_254(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_498(GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_254(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"));
		func_498(GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN"), 1, 752097756);
...
void func_1051(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_1049())
	{
		func_577(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_577(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_GANG_SAVINGS"), 0, GET_HASH_KEY("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
void func_1104(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		iVar9 = func_846(((iVar7 > 0 && iVar5 > 0) && iVar3 == GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT")), 1, 0);
	}
	else
	{
	...
	if (!uParam0->f_31)
	{
		if ((iVar4 == -214678071 || iVar4 == GET_HASH_KEY("COST_CRAFTING_GRILL")) || DATABINDING::_DATABINDING_READ_DATA_BOOL_FROM_PARENT(iVar0, "bFireCrafting"))
		{
			iVar9 = 0;
		}
	}
	else if (!uParam0->f_32 && iVar4 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
	{
		iVar9 = 0;
	}
	...
	if (bParam5)
	{
		if (func_575(iVar3, &Var15, GET_HASH_KEY("INVENTORY"), 0, 0, 0))
		{
...
bool func_1110(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
		...
		while (iVar33 < iVar32)
		{
			...
			else
			{
				...
				if (func_121(iVar31, 0))
				{
					...
					if (func_575(iVar31, &Var36, GET_HASH_KEY("INVENTORY"), 0, 0, 0))
					{
	...
	if (bVar34)
	{
		if (!uParam2->f_31 && ((uParam2->f_80 || uParam2->f_78 == -214678071) || uParam2->f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL")))
		{
			bVar34 = false;
			if (func_317(iParam0))
			{
		...
		else if (!uParam2->f_32 && uParam2->f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
		{
			bVar34 = false;
		...
		else
		{
			...
			if ((iVar46 - iVar45) > 0 || iVar46 == -1)
			{
				...
				else
				{
					...
					else if (uParam2->f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
					{
						DATABINDING::DATABINDING_WRITE_STRING_FROM_PARENT(uParam2->f_39, "tipText", MISC::VAR_STRING(2, "COOK_ING_HAVE", iVar49));
					}
	...
	else if (!uParam2->f_31 && ((uParam2->f_80 || uParam2->f_78 == -214678071) || uParam2->f_78 == GET_HASH_KEY("COST_CRAFTING_GRILL")))
	{
		bVar34 = false;
		if (func_317(iParam0))
		{
...
int func_1116(int iParam0)
{
	...
	{
		return GET_HASH_KEY("S_AMMO_9MM");
	}
	else if (WEAPON::IS_WEAPON_REVOLVER(iVar0))
	{
		return GET_HASH_KEY("S_AMMO_45MM");
	}
	else if (WEAPON::IS_WEAPON_RIFLE(iVar0))
	{
		return GET_HASH_KEY("S_AMMO_RIFLE");
	}
	else if (WEAPON::IS_WEAPON_REPEATER(iVar0))
	{
		return GET_HASH_KEY("S_AMMO_REPEATER");
	}
	else if (WEAPON::IS_WEAPON_SHOTGUN(iVar0))
	{
		return GET_HASH_KEY("S_AMMO_SHOTGUN");
	}
	return 0;
}
...
int func_1118(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == GET_HASH_KEY("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_1225(GET_HASH_KEY("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == GET_HASH_KEY("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_1227(GET_HASH_KEY("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		...
		Var63.f_10 = iParam4;
		iVar0 = func_299(GET_HASH_KEY("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_1125(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_86(0), GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_86(0), GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_86(0), GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}
...
void func_1151(int iParam0)
{
	...
	iVar0 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	iVar1 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE");
	iVar2 = Global_40.f_4283;
	if (func_1235(ENTITY::GET_ENTITY_MODEL(iVar0), iVar2))
	{
		iVar1 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL");
	}
	else
	{
...
int func_1156(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (!bParam3 && iParam1 != GET_HASH_KEY("UPGRADE_FSH_BAIT_NONE"))
	{
...
int func_1157(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return GET_HASH_KEY("PROVISION_BEAVER_FUR");
		case 1:
			return GET_HASH_KEY("PROVISION_BEAVER_FUR_POOR");
		case 2:
			return GET_HASH_KEY("PROVISION_BEAVER_FUR_PRISTINE");
		case 3:
			return GET_HASH_KEY("PROVISION_BEAVER_LEGENDARY_FUR_PRISTINE");
		case 4:
			return GET_HASH_KEY("PROVISION_BOAR_LEGENDARY_SKIN_PRISTINE");
		case 5:
			return GET_HASH_KEY("PROVISION_BOAR_SKIN");
		case 6:
			return GET_HASH_KEY("PROVISION_BOAR_SKIN_POOR");
		case 7:
			return GET_HASH_KEY("PROVISION_BOAR_SKIN_PRISTINE");
		case 8:
			return GET_HASH_KEY("PROVISION_BUCK_FUR");
		case 9:
			return GET_HASH_KEY("PROVISION_BUCK_FUR_POOR");
		case 10:
			return GET_HASH_KEY("PROVISION_BUCK_FUR_PRISTINE");
		case 11:
			return GET_HASH_KEY("PROVISION_BUCK_LEGENDARY_FUR_PRISTINE");
		case 12:
			return GET_HASH_KEY("PROVISION_COUGAR_FUR");
		case 13:
			return GET_HASH_KEY("PROVISION_COUGAR_FUR_POOR");
		case 14:
			return GET_HASH_KEY("PROVISION_COUGAR_FUR_PRISTINE");
		case 15:
			return GET_HASH_KEY("PROVISION_COUGAR_LEGENDARY_FUR_PRISTINE");
		case 16:
			return GET_HASH_KEY("PROVISION_COYOTE_FUR");
		case 17:
			return GET_HASH_KEY("PROVISION_COYOTE_FUR_POOR");
		case 18:
			return GET_HASH_KEY("PROVISION_COYOTE_FUR_PRISTINE");
		case 19:
			return GET_HASH_KEY("PROVISION_COYOTE_LEGENDARY_FUR_PRISTINE");
		case 20:
			return GET_HASH_KEY("PROVISION_DEER_HIDE");
		case 21:
			return GET_HASH_KEY("PROVISION_DEER_HIDE_POOR");
		case 22:
			return GET_HASH_KEY("PROVISION_DEER_HIDE_PRISTINE");
		case 23:
			return GET_HASH_KEY("PROVISION_FOX_FUR");
		case 24:
			return GET_HASH_KEY("PROVISION_FOX_FUR_POOR");
		case 25:
			return GET_HASH_KEY("PROVISION_FOX_FUR_PRISTINE");
		case 26:
			return GET_HASH_KEY("PROVISION_FOX_LEGENDARY_FUR_PRISTINE");
		case 27:
			return GET_HASH_KEY("PROVISION_GOAT_HAIR");
		case 28:
			return GET_HASH_KEY("PROVISION_GOAT_HAIR_POOR");
		case 29:
			return GET_HASH_KEY("PROVISION_GOAT_HAIR_PRISTINE");
		case 30:
			return GET_HASH_KEY("PROVISION_JAVELINA_SKIN");
		case 31:
			return GET_HASH_KEY("PROVISION_JAVELINA_SKIN_POOR");
		case 32:
			return GET_HASH_KEY("PROVISION_JAVELINA_SKIN_PRISTINE");
		case 33:
			return GET_HASH_KEY("PROVISION_LOANSHARK_SKINS");
		case 34:
			return GET_HASH_KEY("PROVISION_PANTHER_FUR");
		case 35:
			return GET_HASH_KEY("PROVISION_PANTHER_FUR_POOR");
		case 36:
			return GET_HASH_KEY("PROVISION_PANTHER_FUR_PRISTINE");
		case 37:
			return GET_HASH_KEY("PROVISION_PANTHER_LEGENDARY_FUR_PRISTINE");
		case 38:
			return GET_HASH_KEY("PROVISION_PIG_SKIN");
		case 39:
			return GET_HASH_KEY("PROVISION_PIG_SKIN_POOR");
		case 40:
			return GET_HASH_KEY("PROVISION_PIG_SKIN_PRISTINE");
		case 41:
			return GET_HASH_KEY("PROVISION_PRONGHORN_FUR");
		case 42:
			return GET_HASH_KEY("PROVISION_PRONGHORN_FUR_POOR");
		case 43:
			return GET_HASH_KEY("PROVISION_PRONGHORN_FUR_PRISTINE");
		case 44:
			return GET_HASH_KEY("PROVISION_PRONGHORN_LEGENDARY_FUR_PRISTINE");
		case 45:
			return GET_HASH_KEY("PROVISION_RAM_HIDE");
		case 46:
			return GET_HASH_KEY("PROVISION_RAM_HIDE_POOR");
		case 47:
			return GET_HASH_KEY("PROVISION_RAM_HIDE_PRISTINE");
		case 48:
			return GET_HASH_KEY("PROVISION_RAM_LEGENDARY_HIDE_PRISTINE");
		case 49:
			return GET_HASH_KEY("PROVISION_SHEEP_WOOL");
		case 50:
			return GET_HASH_KEY("PROVISION_SHEEP_WOOL_POOR");
		case 51:
			return GET_HASH_KEY("PROVISION_SHEEP_WOOL_PRISTINE");
		case 52:
			return GET_HASH_KEY("PROVISION_WOLF_FUR");
		case 53:
			return GET_HASH_KEY("PROVISION_WOLF_FUR_POOR");
		case 54:
			return GET_HASH_KEY("PROVISION_WOLF_FUR_PRISTINE");
		case 55:
			return GET_HASH_KEY("PROVISION_WOLF_LEGENDARY_FUR_PRISTINE");
		case 56:
			return 0;
		default:
			break;
...
void func_1176(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 1:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_ACUNAS_STAR_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_ACUNAS_STAR_ORCHID_JN"), 0);
			}
			break;
		case 2:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_ALASKAN_GINSENG_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_ALASKAN_GINSENG_JN"), 0);
			}
			break;
		case 3:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_AMERICAN_GINSENG_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_AMERICAN_GINSENG_JN"), 0);
			}
			break;
		case 4:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BAY_BOLETE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BAY_BOLETE_JN"), 0);
			}
			break;
		case 5:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BLACKBERRY_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BLACKBERRY_JN"), 0);
			}
			break;
		case 6:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BLACK_CURRANT_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BLACK_CURRANT_JN"), 0);
			}
			break;
		case 11:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BULRUSH_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BULRUSH_JN"), 0);
			}
			break;
		case 7:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BURDOCK_ROOT_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_BURDOCK_ROOT_JN"), 0);
			}
			break;
		case 39:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CARROT_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CARROT_JN"), 0);
			}
			break;
		case 8:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CHANTERELLE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CHANTERELLE_JN"), 0);
			}
			break;
		case 9:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CIGAR_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CIGAR_ORCHID_JN"), 0);
			}
			break;
		case 10:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CLAMSHELL_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CLAMSHELL_ORCHID_JN"), 0);
			}
			break;
		case 12:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CREEPING_THYME_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_CREEPING_THYME_JN"), 0);
			}
			break;
		case 13:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_DESERT_SAGE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_DESERT_SAGE_JN"), 0);
			}
			break;
		case 14:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_DRAGONS_MOUTH_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_DRAGONS_MOUTH_ORCHID_JN"), 0);
			}
			break;
		case 15:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_ENGLISH_MACE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_ENGLISH_MACE_JN"), 0);
			}
			break;
		case 40:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_FEVERFEW_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_FEVERFEW_JN"), 0);
			}
			break;
		case 17:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_GHOST_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_GHOST_ORCHID_JN"), 0);
			}
			break;
		case 18:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_GOLDEN_CURRANT_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_GOLDEN_CURRANT_JN"), 0);
			}
			break;
		case 16:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_HUCKLEBERRY_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_HUCKLEBERRY_JN"), 0);
			}
			break;
		case 19:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_HUMMINGBIRD_SAGE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_HUMMINGBIRD_SAGE_JN"), 0);
			}
			break;
		case 20:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_INDIAN_TOBACCO_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_INDIAN_TOBACCO_JN"), 0);
			}
			break;
		case 21:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_LADY_OF_THE_NIGHT_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_LADY_OF_THE_NIGHT_ORCHID_JN"), 0);
			}
			break;
		case 22:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_LADY_SLIPPER_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_LADY_SLIPPER_ORCHID_JN"), 0);
			}
			break;
		case 23:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_MILKWEED_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_MILKWEED_JN"), 0);
			}
			break;
		case 41:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_MINT_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_MINT_JN"), 0);
			}
			break;
		case 24:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_MOCCASIN_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_MOCCASIN_ORCHID_JN"), 0);
			}
			break;
		case 25:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_NIGHT_SCENTED_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_NIGHT_SCENTED_ORCHID_JN"), 0);
			}
			break;
		case 26:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_OLEANDER_SAGE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_OLEANDER_SAGE_JN"), 0);
			}
			break;
		case 27:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_OREGANO_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_OREGANO_JN"), 0);
			}
			break;
		case 28:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_PARASOL_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_PARASOL_JN"), 0);
			}
			break;
		case 29:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_PRAIRIE_POPPY_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_PRAIRIE_POPPY_JN"), 0);
			}
			break;
		case 30:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_QUEENS_ORCHIDS_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_QUEENS_ORCHIDS_JN"), 0);
			}
			break;
		case 31:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RAMSHEAD_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RAMSHEAD_ORCHID_JN"), 0);
			}
			break;
		case 33:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RASPBERRY_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RASPBERRY_JN"), 0);
			}
			break;
		case 32:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RAT_TAIL_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RAT_TAIL_ORCHID_JN"), 0);
			}
			break;
		case 34:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RED_SAGE_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_RED_SAGE_JN"), 0);
			}
			break;
		case 35:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_SPARROWS_EGG_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_SPARROWS_EGG_ORCHID_JN"), 0);
			}
			break;
		case 36:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_SPIDER_ORCHID_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_SPIDER_ORCHID_JN"), 0);
			}
			break;
		case 37:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_VANILLA_FLOWER_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_VANILLA_FLOWER_JN"), 0);
			}
			break;
		case 38:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_VIOLET_SNOWDROP_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_VIOLET_SNOWDROP_JN"), 0);
			}
			break;
		case 42:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_WINTERBERRY_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_WINTERBERRY_JN"), 0);
			}
			break;
		case 43:
			if (bParam1 == 1)
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_YARROW_AR"), 0);
			}
			else
			{
				func_353(GET_HASH_KEY("JOURNAL_HERB_YARROW_JN"), 0);
			}
			break;
		default:
			break;
...
void func_1191()
{
	...
	func_1260(0);
	func_1261(7);
	func_409(GET_HASH_KEY("KIT_BANDANA"), 1, 1, 0);
	if (func_731() == 1160113249)
	{
		func_409(GET_HASH_KEY("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
...
void func_1193(int iParam0)
{
	...
	Var0 = { func_523(GET_HASH_KEY("GANG_SAVINGS_CASH")) };
...
void func_1200()
{
	...
	func_498(GET_HASH_KEY("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_587(1);
	func_914(1, iVar0, 0);
}
...
void func_1202()
{
	...
	func_498(GET_HASH_KEY("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_587(2);
	func_914(2, iVar0, 0);
}
...
void func_1203()
{
	...
	func_498(GET_HASH_KEY("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_587(0);
	func_914(0, iVar0, 0);
}
...
void func_1207(int iParam0)
{
	...
	Var0 = { func_523(GET_HASH_KEY("CAREER_CASH")) };
...
void func_1208(int iParam0, char* sParam1, int iParam2)
{
	...
	func_577(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 1, GET_HASH_KEY("COLOR_RED"), 0, 0, 0, 1);
}
...
int func_1213(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL"):
			iVar0 = GET_HASH_KEY("A_C_FISHBLUEGIL_01_SM");
			break;
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH"):
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_POOR"):
			iVar0 = GET_HASH_KEY("A_C_FISHBULLHEADCAT_01_SM");
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL"):
			iVar0 = GET_HASH_KEY("A_C_FISHCHAINPICKEREL_01_SM");
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHANNEL_CATFISH_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_CHANNEL_CATFISH"):
			iVar0 = GET_HASH_KEY("A_C_FISHCHANNELCATFISH_01_LG");
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON"):
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_POOR"):
			iVar0 = GET_HASH_KEY("A_C_FISHLAKESTURGEON_01_LG");
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS"):
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_POOR"):
			iVar0 = GET_HASH_KEY("A_C_FISHLARGEMOUTHBASS_01_MS");
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR"):
			iVar0 = GET_HASH_KEY("A_C_FISHLONGNOSEGAR_01_LG");
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE"):
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_POOR"):
			iVar0 = GET_HASH_KEY("A_C_FISHMUSKIE_01_LG");
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE"):
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_POOR"):
			iVar0 = GET_HASH_KEY("A_C_FISHNORTHERNPIKE_01_LG");
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_PERCH"):
			iVar0 = GET_HASH_KEY("A_C_FISHPERCH_01_SM");
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL"):
			iVar0 = GET_HASH_KEY("A_C_FISHREDFINPICKEREL_01_SM");
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS"):
			iVar0 = GET_HASH_KEY("A_C_FISHROCKBASS_01_SM");
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS"):
			iVar0 = GET_HASH_KEY("A_C_FISHSMALLMOUTHBASS_01_MS");
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON"):
			iVar0 = GET_HASH_KEY("A_C_FISHSALMONSOCKEYE_01_MS");
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_POOR"):
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT"):
			iVar0 = GET_HASH_KEY("A_C_FISHRAINBOWTROUT_01_MS");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BAT_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BAT_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BAT_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_BAT_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BLUEJAY_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BLUEJAY_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BLUEJAY_HIGH_QUALITY"):
			iVar0 = GET_HASH_KEY("A_C_BLUEJAY_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BULLFROG_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BULLFROG_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BULLFROG_POOR"):
			iVar0 = GET_HASH_KEY("A_C_FROGBULL_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_POOR"):
			iVar0 = GET_HASH_KEY("A_C_CARDINAL_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_CEDARWAXWING_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_HIGH_QUALITY"):
			iVar0 = GET_HASH_KEY("A_C_CHIPMUNK_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRAB_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRAB_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRAB_POOR"):
			iVar0 = GET_HASH_KEY("A_C_CRAB_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CROW_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CROW_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CROW_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_CROW_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ORIOLE_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ORIOLE_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ORIOLE_HIGH_QUALITY"):
			iVar0 = GET_HASH_KEY("A_C_ORIOLE_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRLNAPARKET_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRLNAPARKET_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRLNAPARKET_HIGH_QUALITY"):
			iVar0 = GET_HASH_KEY("A_C_CAROLINAPARAKEET_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PIGEON_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PIGEON_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PIGEON_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_PIGEON");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_QUAIL_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_QUAIL_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_QUAIL_POOR"):
			iVar0 = GET_HASH_KEY("A_C_QUAIL_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RAT_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RAT_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RAT_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_RAT_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ROBIN_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ROBIN_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ROBIN_HIGH_QUALITY"):
			iVar0 = GET_HASH_KEY("A_C_ROBIN_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_POOR"):
			iVar0 = GET_HASH_KEY("A_C_SONGBIRD_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SPARROW_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SPARROW_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SPARROW_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_SPARROW_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_HIGH_QUALITY"):
			iVar0 = GET_HASH_KEY("A_C_SQUIRREL_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TOAD_POOR"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TOAD_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TOAD_PERFECT"):
			iVar0 = GET_HASH_KEY("A_C_TOAD_01");
			break;
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_WOODPECKER_HIGH_QUALITY"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_WOODPECKER_PERFECT"):
		case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_WOODPECKER_POOR"):
			iVar0 = GET_HASH_KEY("A_C_WOODPECKER_01");
			break;
	}
	return iVar0;
}
...
void func_1221(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (func_575(iVar0, &Var10, GET_HASH_KEY("INVENTORY"), 0, 0, 0))
	{
	...
	{
		iVar15 = func_846(((iVar9 > 0 && iVar7 > 0) && iVar0 == GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT")), 1, 0);
	}
	else
	{
	...
	if (!uParam0->f_31)
	{
		if ((iVar6 == -214678071 || iVar6 == GET_HASH_KEY("COST_CRAFTING_GRILL")) || iVar6 == -257768755)
		{
			iVar15 = 0;
		}
	}
	else if (!uParam0->f_32 && iVar6 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
	{
		iVar15 = 0;
	}
	if (iVar15 == 1)
...
bool func_1222(int iParam0)
{
	...
	{
		if (iParam0 != GET_HASH_KEY("CONSUMABLE_POTENT_PREDATOR_BAIT"))
		{
			return false;
		}
	}
...
bool func_1223(int iParam0, int iParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iParam1 == -214678071 || iParam1 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
	{
		Var2 = -1;
		Var2.f_1 = -1;
		Var2.f_2 = -1;
		...
		if (uParam2->f_32)
		{
			Var2 = { func_904(-1591664384, -1591664384, 0, 0, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, -1, iVar12, 0) };
			if (func_1111(Var2, &iVar0, &iVar1, 0))
			{
				iVar13 = 0;
				while (iVar13 < iVar1)
				{
					...
					else if (!Global_1911914.f_1579 && func_920(iVar14, GET_HASH_KEY("COST_CRAFTING_GRILL"), 1))
					{
					}
					else if (func_295(iVar14, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, bParam3, 0, 0) && !func_560(iVar14, 1, 0))
					{
						func_1113(iVar0);
						*iParam4 = iVar14;
						*iParam5 = GET_HASH_KEY("COST_CRAFTING_GRILL");
						*iParam6 = iVar13;
						return true;
					}
					iVar13++;
		...
		if (iParam1 == GET_HASH_KEY("COST_CRAFTING_GRILL"))
		{
	...
	else
	{
		...
		while (iVar65 < iVar17)
		{
			...
			{
				if (Var18.f_2 == GET_HASH_KEY("COST_TYPE_CRAFT"))
				{
	...
	switch (iParam1)
	{
		...
		case 6:
			switch (iParam0)
			{
				...
				case GET_HASH_KEY("A_C_FISHSALMONSOCKEYE_01_MS"):
				case GET_HASH_KEY("A_C_FISHSALMONSOCKEYE_01_LG"):
				case GET_HASH_KEY("A_C_FISHSALMONSOCKEYE_01_ML"):
				case GET_HASH_KEY("A_C_QUAIL_01"):
					return true;
				default:
					break;
...
{
	if ((func_190(iParam0, -839724752) || func_190(iParam0, GET_HASH_KEY("CI_TAG_ITEM_MEAT_ANIMAL"))) || func_190(iParam0, 1286414894))
	{
		return true;
	}
	return false;
...
int func_1237(int iParam0, int iParam1)
{
	if (!func_121(iParam0, 0))
	{
		return GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE");
	}
	...
	{
		return GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL");
	}
	else if (func_190(iParam0, -1690954218))
	{
		return GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_HIGH");
	}
	...
	{
		return GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_MED");
	}
	else if (func_190(iParam0, 43251425))
	{
		return GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_LOW");
	}
	return GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_LOW");
}
...
bool func_1238(int iParam0, int iParam1)
{
	...
	iVar0[0] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE");
	iVar0[1] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE_EGGS");
	iVar0[2] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_LOW");
	iVar0[3] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_LOW_EGGS");
	iVar0[4] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_MED");
	iVar0[5] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_MED_EGGS");
	iVar0[6] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_HIGH");
	iVar0[7] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_HIGH_EGGS");
	iVar0[8] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL");
	iVar0[9] = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS");
	iVar11 = -1;
	iVar12 = -1;
	iVar13 = 0;
	while (iVar13 <= 9)
...
void func_1239(int iParam0)
{
	if (Global_40.f_4283.f_313 > 1)
	{
		switch (*iParam0)
		{
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE"):
				*iParam0 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_BASE_EGGS");
				break;
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_LOW"):
				*iParam0 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_LOW_EGGS");
				break;
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_MED"):
				*iParam0 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_MED_EGGS");
				break;
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_HIGH"):
				*iParam0 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_HIGH_EGGS");
				break;
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL"):
				*iParam0 = GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS");
				break;
		}
	}
}
...
struct<5> func_1240(int iParam0)
{
	...
	Var0 = { func_1241(iParam0, GET_HASH_KEY("CHARACTER"), func_906(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
...
int func_1243(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_BEAVER_FUR"):
			return 0;
		case GET_HASH_KEY("PROVISION_BOAR_SKIN_PRISTINE"):
			return 7;
		case GET_HASH_KEY("PROVISION_DEER_HIDE"):
			return 20;
		case GET_HASH_KEY("PROVISION_COUGAR_FUR_PRISTINE"):
			return 14;
		case GET_HASH_KEY("PROVISION_GOAT_HAIR_PRISTINE"):
			return 29;
		case GET_HASH_KEY("PROVISION_BEAVER_FUR_POOR"):
			return 1;
		case GET_HASH_KEY("PROVISION_COYOTE_FUR_POOR"):
			return 17;
		case GET_HASH_KEY("PROVISION_PRONGHORN_FUR_PRISTINE"):
			return 43;
		case GET_HASH_KEY("PROVISION_COYOTE_LEGENDARY_FUR_PRISTINE"):
			return 19;
		case GET_HASH_KEY("PROVISION_JAVELINA_SKIN"):
			return 30;
		case GET_HASH_KEY("PROVISION_SHEEP_WOOL"):
			return 49;
		case GET_HASH_KEY("PROVISION_PIG_SKIN_PRISTINE"):
			return 40;
		case GET_HASH_KEY("PROVISION_DEER_HIDE_PRISTINE"):
			return 22;
		case GET_HASH_KEY("PROVISION_PRONGHORN_FUR_POOR"):
			return 42;
		case GET_HASH_KEY("PROVISION_BUCK_LEGENDARY_FUR_PRISTINE"):
			return 11;
		case GET_HASH_KEY("PROVISION_BUCK_FUR"):
			return 8;
		case GET_HASH_KEY("PROVISION_COYOTE_FUR_PRISTINE"):
			return 18;
		case GET_HASH_KEY("PROVISION_RAM_LEGENDARY_HIDE_PRISTINE"):
			return 48;
		case GET_HASH_KEY("PROVISION_BUCK_FUR_PRISTINE"):
			return 10;
		case GET_HASH_KEY("PROVISION_DEER_HIDE_POOR"):
			return 21;
		case GET_HASH_KEY("PROVISION_RAM_HIDE"):
			return 45;
		case GET_HASH_KEY("PROVISION_PANTHER_FUR"):
			return 34;
		case GET_HASH_KEY("PROVISION_PIG_SKIN_POOR"):
			return 39;
		case GET_HASH_KEY("PROVISION_BEAVER_LEGENDARY_FUR_PRISTINE"):
			return 3;
		case GET_HASH_KEY("PROVISION_PRONGHORN_LEGENDARY_FUR_PRISTINE"):
			return 44;
		case GET_HASH_KEY("PROVISION_JAVELINA_SKIN_POOR"):
			return 31;
		case GET_HASH_KEY("PROVISION_PIG_SKIN"):
			return 38;
		case 0:
			return 56;
		case GET_HASH_KEY("PROVISION_WOLF_FUR_POOR"):
			return 53;
		case GET_HASH_KEY("PROVISION_FOX_FUR"):
			return 23;
		case GET_HASH_KEY("PROVISION_COUGAR_FUR"):
			return 12;
		case GET_HASH_KEY("PROVISION_FOX_FUR_PRISTINE"):
			return 25;
		case GET_HASH_KEY("PROVISION_WOLF_LEGENDARY_FUR_PRISTINE"):
			return 55;
		case GET_HASH_KEY("PROVISION_PRONGHORN_FUR"):
			return 41;
		case GET_HASH_KEY("PROVISION_WOLF_FUR_PRISTINE"):
			return 54;
		case GET_HASH_KEY("PROVISION_PANTHER_LEGENDARY_FUR_PRISTINE"):
			return 37;
		case GET_HASH_KEY("PROVISION_GOAT_HAIR_POOR"):
			return 28;
		case GET_HASH_KEY("PROVISION_BEAVER_FUR_PRISTINE"):
			return 2;
		case GET_HASH_KEY("PROVISION_WOLF_FUR"):
			return 52;
		case GET_HASH_KEY("PROVISION_COYOTE_FUR"):
			return 16;
		case GET_HASH_KEY("PROVISION_BOAR_SKIN_POOR"):
			return 6;
		case GET_HASH_KEY("PROVISION_SHEEP_WOOL_PRISTINE"):
			return 51;
		case GET_HASH_KEY("PROVISION_COUGAR_LEGENDARY_FUR_PRISTINE"):
			return 15;
		case GET_HASH_KEY("PROVISION_PANTHER_FUR_POOR"):
			return 35;
		case GET_HASH_KEY("PROVISION_BUCK_FUR_POOR"):
			return 9;
		case GET_HASH_KEY("PROVISION_FOX_LEGENDARY_FUR_PRISTINE"):
			return 26;
		case GET_HASH_KEY("PROVISION_FOX_FUR_POOR"):
			return 24;
		case GET_HASH_KEY("PROVISION_GOAT_HAIR"):
			return 27;
		case GET_HASH_KEY("PROVISION_SHEEP_WOOL_POOR"):
			return 50;
		case GET_HASH_KEY("PROVISION_RAM_HIDE_PRISTINE"):
			return 47;
		case GET_HASH_KEY("PROVISION_RAM_HIDE_POOR"):
			return 46;
		case GET_HASH_KEY("PROVISION_COUGAR_FUR_POOR"):
			return 13;
		case GET_HASH_KEY("PROVISION_JAVELINA_SKIN_PRISTINE"):
			return 32;
		case GET_HASH_KEY("PROVISION_PANTHER_FUR_PRISTINE"):
			return 36;
		case GET_HASH_KEY("PROVISION_LOANSHARK_SKINS"):
			return 33;
		case GET_HASH_KEY("PROVISION_BOAR_LEGENDARY_SKIN_PRISTINE"):
			return 4;
		case GET_HASH_KEY("PROVISION_BOAR_SKIN"):
			return 5;
		default:
			break;
	}
...
void func_1270(var uParam0, int iParam1, int iParam2)
{
	...
	while (iVar48 < iVar0)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_ACQUIRE_COST(iParam1, iVar48, &Var1))
		{
			if (Var1 != iParam2)
			{
				if ((Var1.f_2 == GET_HASH_KEY("COST_TYPE_CRAFT") && Var1 != -489628648) && (Global_1911914.f_1579 || !func_920(iParam1, Var1, 1)))
				{
...
void func_1271(var uParam0, int iParam1)
{
	...
	Var3 = { func_904(-1591664384, -1591664384, 0, 0, GET_HASH_KEY("COST_CRAFTING_GRILL"), 0, -1, iVar2, 0) };
	if (func_1111(Var3, &iVar0, &iVar1, 0))
	{
		iVar13 = 0;
		while (iVar13 < iVar1)
		{
			...
			if (func_121(iVar14, 0))
			{
				if (Global_1911914.f_1579 || !func_920(iVar14, GET_HASH_KEY("COST_CRAFTING_GRILL"), 1))
				{
					Global_1911914[(uParam0->f_55 - 1) /*9*/].f_7++;
				}
			}
...
bool func_1275(int iParam0, int iParam1)
{
	switch (iParam1)
	{
		case 1:
			switch (iParam0)
			{
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PRONGHORN_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RABBIT_PERFECT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PRONGHORN_POOR"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RABBIT_POOR"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_DUCK_PERFECT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_DUCK_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_RABBIT_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_DUCK_POOR"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_PRONGHORN_PERFECT"):
					return true;
				default:
					break;
			}
		...
		case 2:
			switch (iParam0)
			{
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_DEER_PERFECT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TURKEY_PERFECT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TURKEY_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BUCK_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BUCK_POOR"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_DEER_POOR"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_DEER_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_TURKEY_POOR"):
				case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_POOR"):
				case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_BUCK_PERFECT"):
					return true;
				default:
					break;
			}
			...
			{
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRLNAPARKET_PERFECT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ALLIGATOR_POOR"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ALLIGATOR_PERFECT"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRLNAPARKET_POOR"):
				case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CRLNAPARKET_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_ALLIGATOR_HIGH_QUALITY"):
				case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_POOR"):
					return true;
				default:
					break;
			...
			switch (iParam0)
			{
				...
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_QUAIL_PERFECT"):
				case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_POOR"):
				case GET_HASH_KEY("PROVISION_MATURE_VENISON"):
				case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON"):
				case GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_QUAIL_POOR"):
					return true;
				default:
