...
bool func_79(var uParam0)
{
	...
	{
		func_162(uParam0, 0.4883f, 0.0735f, 0.9362f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_DUTCH"), 1, 1, 1);
		func_162(uParam0, 3.2121f, -1.0102f, 1.1642f, 0f, 1.5f, 1.5f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MOLLY"), 1, 1, 1);
		func_162(uParam0, 2.723f, -3.706f, 1.1388f, 0f, 1f, 1f, 3f, GET_HASH_KEY("VOLBOX"), GET_HASH_KEY("APMS_COMP_MARYBETH"), 1, 1, 1);
	}
	func_163(uParam0, GET_HASH_KEY("P_CS_BOOK04X"), 0f, 0f, 0f, "p_cs_book04x", 0, 1, 1);
	func_163(uParam0, GET_HASH_KEY("P_POCKETMIRROR01X"), 0f, 0f, 0f, "p_pocketMirror01x", 0, 1, 1);
	if (!func_159(14))
	{
	...
	func_167(uParam0, iLocal_14, 2, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_168(uParam0, iLocal_15, 3, GET_HASH_KEY("WORLD_HUMAN_POCKET_MIRROR"), "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_169(uParam0, iLocal_15);
	if (!func_159(14))
	{
		func_168(uParam0, iLocal_16, 3, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 0);
	...
	if (func_159(14))
	{
		func_168(uParam0, iLocal_14, 0, GET_HASH_KEY("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0);
		func_174(uParam0, iLocal_14, 1);
		func_175(uParam0, iLocal_14, -1f);
		func_176(uParam0, iLocal_15, 4);
		func_174(uParam0, iLocal_15, 1);
		func_168(uParam0, iLocal_16, 4, GET_HASH_KEY("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
...
bool func_97(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(iLocal_57))
	{
		iLocal_57 = MAP::BLIP_ADD_FOR_COORDS(-678244495, func_212(uParam0, vLocal_47));
		MAP::SET_BLIP_SPRITE(iLocal_57, GET_HASH_KEY("BLIP_AMBIENT_SECRET"), true);
	}
...
void func_221(var uParam0)
{
	...
	{
		iLocal_43 = func_336("GREET_ACC", GET_HASH_KEY("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
	...
	{
		iLocal_44 = func_336("GREET_REJ", GET_HASH_KEY("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
void func_222(var uParam0)
{
	...
	if (func_342(iLocal_43, 1))
	{
		...
		func_344(uParam0, GET_HASH_KEY("COMP_DTCCNV32"), GET_HASH_KEY("PLAYER_DTCCNV32"));
...
void func_224(var uParam0)
{
	...
	{
		iLocal_46 = func_336("VIG_FLARE", GET_HASH_KEY("INPUT_CONTEXT_X"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
		func_349(iLocal_46, 6f, 1);
		func_338(iLocal_46, 0, 1);
	}
	if (!func_49(iLocal_45))
	{
		iLocal_45 = func_336("LEAVE", GET_HASH_KEY("INPUT_CONTEXT_B"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, GET_HASH_KEY("SHORT_TIMED_EVENT"), 0, 0);
...
int func_275()
{
	...
	if (func_378(GET_HASH_KEY("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_276()
{
	...
	if (func_378(GET_HASH_KEY("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
void func_389(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_442(iParam1))
		{
			func_443(iParam0, GET_HASH_KEY("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_478(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_523(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_523(iParam1, GET_HASH_KEY("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_378(GET_HASH_KEY("CSTAG_FLOW_MAR8_POST"), 1) && !func_465(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
