...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_16 = GET_HASH_KEY("CS_CREOLECAPTAIN");
	iLocal_17 = GET_HASH_KEY("CS_JULES");
	iLocal_18 = GET_HASH_KEY("A_C_ALLIGATOR_01");
	iLocal_19 = GET_HASH_KEY("A_C_ALLIGATOR_02");
	iLocal_20 = GET_HASH_KEY("SKIFF");
	iLocal_21 = GET_HASH_KEY("P_SKIFF02X");
	iLocal_22 = GET_HASH_KEY("P_LANTERN04X");
	iLocal_23 = GET_HASH_KEY("S_INTERACT_LANTERN02X");
	iLocal_24 = GET_HASH_KEY("P_CRATE15X");
	iLocal_25 = GET_HASH_KEY("P_CS_FISHBAG01X");
	iLocal_26 = GET_HASH_KEY("P_TRAP05X");
	iLocal_27 = GET_HASH_KEY("P_TRAP01X_DAMAGED");
	iLocal_28 = GET_HASH_KEY("P_CRAYFISH01X");
	iLocal_29 = GET_HASH_KEY("BRANCH01_SCRIPT");
	iLocal_30 = GET_HASH_KEY("BRANCH02_SCRIPT");
	iLocal_31 = GET_HASH_KEY("P_CS_BANDAGE01X");
	iLocal_32 = GET_HASH_KEY("P_CS_TOURNIQUET02X");
	iLocal_33 = GET_HASH_KEY("P_CS_V2_ROPE04X");
	...
	iLocal_292 = GET_HASH_KEY("WEAPON_MELEE_DAVY_LANTERN");
	fLocal_301 = 0f;
	...
	{
		func_1(&uLocal_1132, 1073741824 /* Float: 2f */);
...
void func_13(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_183(iParam0) == 3 || (func_183(iParam0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_182(iParam0))))
	{
...
void func_25(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_206(uParam1[iVar0 /*16*/], 1048576))
		{
			switch (iParam0)
			{
				case 0:
...
void func_37(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_206(uParam0[iVar0 /*16*/], 1048576) && (uParam0[iVar0 /*16*/])->f_9 == 9)
		{
			func_216(uParam0[iVar0 /*16*/]);
		}
		iVar0++;
	}
}
...
void func_56(char[4] cParam0)
{
	...
	{
		if (func_243(&(cParam0->f_5423[iVar0 /*65*/])))
		{
...
void func_57(char[4] cParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < 27)
	{
		...
		if (func_247(iVar1))
		{
			...
			func_248(cParam0, iVar1, bVar2, iParam1, bParam2, bParam3, 0);
		}
		iVar0++;
	}
}
...
void func_58(char[4] cParam0, bool bParam1)
{
	...
	iVar1 = func_250(bVar0);
	iVar2 = SCRIPTS::GET_ID_OF_THIS_THREAD();
	bVar3 = false;
	if (SCRIPTS::IS_THREAD_ACTIVE(iVar2, false) && func_251(iVar1) == iVar2)
	{
		bVar3 = true;
	}
	if (bVar3)
...
void func_68(int iParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (func_206(uParam1[iVar0 /*16*/], 1048576) && (uParam1[iVar0 /*16*/])->f_9 == 9)
		{
			func_207(uParam1[iVar0 /*16*/], 1);
		}
		iVar0++;
...
void func_75(char[4] cParam0)
{
	...
	func_272(iVar0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, 752097756);
}
			...
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (bParam1 && func_183(iParam0) != 0)
				{
					if (iVar0 == 1)
					{
						...
						{
							STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1835011[func_261(iParam0) /*74*/].f_8), true);
						}
					}
					else if ((func_261(iParam0) != 95 && func_261(iParam0) != 82) && !func_290(Global_1347702[func_261(iParam0) /*49*/].f_12, 512))
					{
						STATS::STAT_ID_SET_GXT_LABEL(&Var4, &(Global_1347702[func_261(iParam0) /*49*/].f_3), true);
					}
				}
			}
			else
	...
	if (!Global_1879534 && !Global_1879534.f_1)
	{
		switch (iVar0)
		{
			...
			case 8:
				...
				{
					func_303(14, 0, 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
				}
				Global_1899528.f_217 = 1;
				break;
			case 9:
	...
	if (bParam1)
	{
		...
		switch (iVar0)
		{
			...
			case 11:
				...
				break;
			case 8:
				if (func_262(func_261(iParam0)) && func_290(Global_1347702[func_261(iParam0) /*49*/].f_12, 4))
				{
					Global_1898438 = MISC::GET_GAME_TIMER();
				}
				else
	...
	if (bVar13)
	{
			...
			case 1:
				switch (func_261(iParam0))
				{
					...
					case 1:
						...
						break;
					case 4:
						func_307(GET_HASH_KEY("CONSUMABLE_HERB_SAGE"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("CONSUMABLE_HERB_GINSENG"), 4, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("CONSUMABLE_HERB_INDIAN_TOBACCO"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("CONSUMABLE_HERB_YARROW"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("PROVISION_GRITTY_FISH_MEAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("PROVISION_STRINGY_MEAT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("PROVISION_ANIMAL_FAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("PROVISION_BIRD_FEATHER_FLIGHT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("CONSUMABLE_COFFEE_GNDS_REG"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_HORSE_OINTMENT"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_FIRE_ARROW"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_ARROW"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_SML_GM_ARROW"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_MOLOTOV"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"));
						func_307(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_308(GET_HASH_KEY("DOCUMENT_PAMPHLET_COVER_SCENT"));
						func_307(GET_HASH_KEY("WEAPON_KIT_CAMERA"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("KIT_CAMP"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(-1448210800 /* GXTEntry: "Crafting Tools" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_307(GET_HASH_KEY("CLOTHING_ITEM_PZ_LOADOUT_BANDOLIER_01"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_309();
						func_310(GET_HASH_KEY("CLOTHING_SP_COAT_WINTER01_VARIATION_01"));
						func_311();
						func_312();
						break;
					case 5:
					...
					case 14:
						...
						break;
					case 2:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY(func_313(10, 0)));
						break;
					case 8:
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, 621714131 /* GXTEntry: "Jamie Gillis" */);
						break;
					case 15:
						func_307(GET_HASH_KEY("DOCUMENT_MAP_LEGENDARY_ANIMALS"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					...
					case 18:
						...
						if (!func_316(Global_1347702[21 /*49*/].f_15, 1))
						{
					...
					case 26:
						...
						break;
					case 17:
						func_319(Global_35, GET_HASH_KEY("CLOTHING_ITEM_BADGE_PZERO_000"), 0, -358215195, 1, 1);
						if (func_320())
						{
							func_321(GET_HASH_KEY("WEAPON_REPEATER_EVANS"));
						}
						break;
					case 19:
						...
						break;
					case 33:
						if (!func_322(GET_HASH_KEY("TP_RMAY_LETTER_1"), -1))
						{
							iVar15 = func_274();
							func_323(&iVar15, 0, 0, 0, 2, 0, 0, 0);
							func_324(GET_HASH_KEY("TP_RMAY_LETTER_1"), iVar15, 0);
						}
						PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY("DISCOVERABLE_NAME_EVELYN_MILLER"));
						if (func_320())
						{
							func_321(GET_HASH_KEY("WEAPON_REVOLVER_LEMAT"));
						}
						break;
					case 34:
						if (func_320())
						{
							func_321(GET_HASH_KEY("WEAPON_REVOLVER_DOUBLEACTION_GAMBLER"));
						}
						break;
					case 28:
					...
					case 43:
						...
						break;
					case 44:
						if (!func_316(Global_1347702[82 /*49*/].f_15, 1))
						{
						...
						if (!func_316(Global_1347702[83 /*49*/].f_15, 1))
						{
					...
					case 67:
						...
						if (!func_334(GET_HASH_KEY("TAXIDERMY_ORDER_05")))
						{
							if (func_334(GET_HASH_KEY("TAXIDERMY_ORDER_04")))
							{
								iVar16 = func_274();
								func_323(&iVar16, 0, 0, 6, 0, 0, 0, 0);
								func_324(GET_HASH_KEY("TP_TAXIDERMY_REWARD_04_ES"), iVar16, 1);
							}
						}
						if (func_335(4))
						{
							if (!func_336(GET_HASH_KEY("DOCUMENT_NOTE_RARE_FISH"), 1, 0))
							{
								iVar17 = func_274();
								func_323(&iVar17, 0, 0, 6, 0, 0, 0, 0);
								func_324(GET_HASH_KEY("TP_RF_INVITATION_01"), iVar17, 1);
							}
						}
					...
					case 76:
						...
						break;
					case 69:
						if (func_316(Global_1347702[9 /*49*/].f_15, 1))
						{
							func_337(-6000);
						}
						break;
			...
			case 8:
				switch (func_261(iParam0))
				{
					...
					case 67:
						...
						if (func_320())
						{
							func_321(GET_HASH_KEY("WEAPON_PISTOL_M1899"));
						}
						break;
					case 68:
					...
					case 147:
						...
						break;
					case 9:
						if (func_316(Global_1835011[69 /*74*/].f_1, 1))
						{
							func_346(0);
							func_337(40500);
						}
		...
		switch (iVar0)
		{
			case 1:
				...
				{
					case 4:
						func_349(iParam0, 1000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 61:
					case 62:
					case 63:
						func_349(iParam0, 300, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 25:
					...
					case 34:
						...
						if (!func_336(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0))
						{
							func_307(GET_HASH_KEY("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						break;
					case 29:
					...
					case 57:
						...
						break;
					case 76:
						func_349(iParam0, 2042100, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 72:
						if (func_350(iParam0) == 0)
						{
							func_349(iParam0, 20000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						else
						{
							func_349(iParam0, 15000, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						}
						break;
				}
				break;
			case 8:
				if (func_290(Global_1347702[func_261(iParam0) /*49*/].f_12, 536870912))
				{
					func_351(11, 1);
				}
				switch (func_261(iParam0))
				{
					case 109:
						func_349(iParam0, 1500, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1);
						break;
					case 55:
						func_351(8, 1);
						break;
				...
				break;
			case 11:
				if (iParam0 == func_352(0, 10, 11, GET_HASH_KEY("CABR01")))
				{
					func_349(iParam0, func_350(iParam0), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_352(0, 7, 11, GET_HASH_KEY("CACR02")))
				{
					func_349(iParam0, func_353(9), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_352(0, 8, 11, GET_HASH_KEY("CACR03")))
				{
					func_349(iParam0, func_353(10), 1, 0.5f, 2, 0, 0, 1);
				}
				else if (iParam0 == func_352(0, 11, 11, GET_HASH_KEY("CACR01")))
				{
					func_349(iParam0, func_353(8), 1, 0.5f, 3, 0, 0, 1);
				}
				else if (iParam0 == func_352(0, 12, 11, GET_HASH_KEY("CACR04")))
				{
		...
		if (bParam1)
		{
			if (!func_183(iParam0) == 0)
			{
				...
				else if (STATS::STATSTRACKER_IS_INITIALIZED(func_182(iParam0)))
				{
					iVar19 = 0;
					if (bParam3)
					{
			...
			if (bParam2)
			{
				switch (iVar0)
				{
					...
					case 2:
						...
						break;
					case 8:
						if (func_262(func_261(iParam0)) && func_290(Global_1347702[func_261(iParam0) /*49*/].f_12, 1))
						{
							iVar20 = 3;
						}
						else
...
void func_84(int iParam0, bool bParam1)
{
	...
	if (STATS::STATSTRACKER_IS_INITIALIZED(func_182(iParam0)))
	{
		iVar0 = 0;
		if (bParam1)
		{
		...
		if (func_82(32768))
		{
			...
			if ((iVar1 == 1 || iVar1 == 8) || (iVar1 == 11 && iParam0 == func_352(0, 10, 11, GET_HASH_KEY("CABR01"))))
			{
				Global_1898438 = MISC::GET_GAME_TIMER();
				Global_1879514.f_1 = iParam0;
...
void func_100(char[4] cParam0)
{
	...
	while (iVar0 < Global_43619)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_43619[iVar0 /*12*/]))
		{
			...
			func_368(&(cParam0->f_10792), Global_43619[iVar0 /*12*/], &(Global_43619[iVar0 /*12*/].f_1), 0);
		}
		iVar0++;
	}
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_43800))
...
void func_108(char[4] cParam0, var uParam1)
{
	cParam0->f_607 = -1;
	func_372(cParam0);
	cParam0->f_634[0] = 56693;
	cParam0->f_634[1] = 56693;
	cParam0->f_637 = 0;
...
void func_109(char[4] cParam0)
{
	...
	bLocal_108 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_378(cParam0, GET_HASH_KEY("CS_DUTCH"), 0));
	bLocal_109 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_378(cParam0, GET_HASH_KEY("CS_HOSEAMATTHEWS"), 0));
	bLocal_117 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(func_378(cParam0, iLocal_24, 0));
}
...
{
	return func_380(cParam0->f_1[func_132(iParam1) /*22*/].f_11, iParam2);
}
...
bool func_129()
{
	...
	if (!func_316(Global_1835011[1 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_316(Global_1835011[2 /*74*/].f_1, 1) && func_316(Global_1347702[120 /*49*/].f_15, 1)) && !func_316(Global_1835011[4 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_316(Global_1835011[37 /*74*/].f_1, 1) && !func_316(Global_1835011[39 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_316(Global_1835011[57 /*74*/].f_1, 1) && !func_316(Global_1835011[60 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_316(Global_1835011[26 /*74*/].f_1, 1) && !func_316(Global_1347702[67 /*49*/].f_15, 1))
	{
		return true;
	}
	if ((func_316(Global_1835011[62 /*74*/].f_1, 1) && func_316(Global_1835011[63 /*74*/].f_1, 1)) && !func_316(Global_1835011[64 /*74*/].f_1, 1))
	{
		return true;
	}
	if (func_316(Global_1835011[75 /*74*/].f_1, 1) && !func_316(Global_1347702[1 /*49*/].f_15, 1))
	{
		return true;
	}
	if (func_316(Global_1835011[76 /*74*/].f_1, 1) && !func_316(Global_1835011[77 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_316(Global_1835011[40 /*74*/].f_1, 1) && func_316(Global_1835011[41 /*74*/].f_1, 1)) && !func_316(Global_1835011[44 /*74*/].f_1, 1))
	{
		return true;
	}
	if ((func_316(Global_1835011[62 /*74*/].f_1, 1) && func_316(Global_1835011[63 /*74*/].f_1, 1)) && !func_316(Global_1835011[64 /*74*/].f_1, 1))
	...
	if ((func_316(Global_1835011[65 /*74*/].f_1, 1) && func_316(Global_1835011[66 /*74*/].f_1, 1)) && !func_316(Global_1835011[67 /*74*/].f_1, 1))
	{
		return true;
	}
	return false;
...
void func_139(char[4] cParam0)
{
	...
	func_405(cParam0, iLocal_291, 67108863);
	func_406(cParam0, 192);
	func_407(cParam0, "script@story@MOB4@LEADOUT@INT@Leadout_Hosea", &iLocal_302, 1, 0, 0, 0, 1);
	func_407(cParam0, "script@story@MOB4@LEADIN@MCS1@leadin", &iLocal_303, 6, 0, 0, 100f, 1);
	func_407(cParam0, "script@story@MOB4@LEADIN@MCS2@base_props_placement", &iLocal_304, 24, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_1@ig1_walk_to_trap", &iLocal_305, 4, 16, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_2@ig2_loot_trap", &iLocal_306, 4, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_2@ig2_loot_trap_arthur", &iLocal_307, 4, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_3@ig3_investigate_trap", &iLocal_308, 4, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_3@ig3_investigate_trap_leadin", &iLocal_309, 4, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_4@ig4_scared", &iLocal_310, 24, 16, "IG4_SCARED_THERES_A_MONSTER", 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_4@ig4_scared_joules_base", &iLocal_311, 24, 0, 0, 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_5@ig5_skiff_stuck_pull", &iLocal_312, 28, 2, "IG5_SKIFF_ROPE", 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_5@ig5_skiff_stuck_pull", &iLocal_313, 32, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_7@ig7_taken", &iLocal_314, 96, 0, "IG7_TAKEN", 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_7@ig7_taken_exit", &iLocal_315, 64, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_8@ig8_panic", &iLocal_316, 64, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_9@ig9_carry", &iLocal_318, 64, 0, "IG9_CARRY_PICKUP_JULES", 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_9@ig9_carry", &iLocal_319, 64, 0, "IG9_CARRY_CARRY", 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_9@ig9_carry_jules", &iLocal_320, 64, 0, 0, 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_10@ig10_boat_react_dutch", &iLocal_321, 64, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_10@ig10_boat_react_thomas", &iLocal_322, 64, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_11@ig11_into_boat_dutch", &iLocal_324, 64, 0, 0, 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_11@ig11_into_boat", &iLocal_323, 192, 0, 0, 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_11@ig11_into_boat_joules", &iLocal_325, 192, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_11@ig11_bull_gator_attack", &iLocal_326, 192, 0, 0, 0, 1);
	func_407(cParam0, "script@story@mob4@ig@ig_12@ig12_tend_wound_int", &iLocal_327, 128, 0, 0, 0, 0);
	func_407(cParam0, "script@story@mob4@ig@ig_16@ig16_tend_wound_ext", &iLocal_328, 524416, 0, 0, 0, 0);
	func_407(cParam0, "script@timelapse@sad3_ext_timelapse", &iLocal_329, 524288, 0, 0, 0, 1);
	func_408(cParam0, iLocal_313, "IG5_SKIFF_STUCK_PULL", 32);
	func_408(cParam0, iLocal_314, "IG7_TAKEN", 32);
	func_408(cParam0, iLocal_318, "IG9_CARRY_PICKUP_JULES", 64);
	func_408(cParam0, iLocal_319, "IG9_CARRY_CARRY", 64);
	func_408(cParam0, iLocal_320, "IG9_CARRY_BARELY_MOVING", 64);
	func_408(cParam0, iLocal_326, "pl_action_left", 128);
	func_408(cParam0, iLocal_326, "pl_action_right", 128);
}

void func_140(char[4] cParam0, int iParam1, int iParam2)
{
	func_409(&(cParam0->f_1[func_132(iParam1) /*22*/].f_11), iParam2);
}
...
{
	func_411(&(cParam0->f_5310), bParam1, sParam2, bParam3);
}
...
{
	func_415(cParam0, bParam1, sParam2, iParam3, iParam4, bParam5, 0);
	func_368(&(cParam0->f_10792), bParam1, sParam2, bParam6);
}
...
void func_163()
{
	...
	PED::_SET_PED_BLACKBOARD_FLOAT(bLocal_108, sLocal_40, 0f, -1);
	PED::_0x58F7DB5BD8FA2288(bLocal_108);
	PED::SET_PED_LEG_IK_MODE(bLocal_108, 1);
	PED::_SET_PED_BLACKBOARD_FLOAT(bLocal_110, sLocal_40, 0f, -1);
	PED::_0x58F7DB5BD8FA2288(bLocal_110);
	PED::SET_PED_LEG_IK_MODE(bLocal_110, 1);
}
...
void func_165()
{
	if (func_429(bLocal_108, 0))
	{
		func_430(bLocal_108, 0);
		ENTITY::SET_ENTITY_VISIBLE(bLocal_108, true);
		ENTITY::FREEZE_ENTITY_POSITION(bLocal_108, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_108, 27, false);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_108, false);
	}
}

void func_166()
{
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_114))
	{
		ENTITY::SET_ENTITY_INVINCIBLE(bLocal_114, false);
		ENTITY::FREEZE_ENTITY_POSITION(bLocal_114, false);
		ENTITY::SET_ENTITY_PROOFS(bLocal_114, 0, false);
	}
	if (func_429(bLocal_110, 0))
	{
		func_434(bLocal_110, 0);
		func_430(bLocal_110, 0);
		ENTITY::FREEZE_ENTITY_POSITION(bLocal_110, false);
		PED::SET_PED_CONFIG_FLAG(bLocal_110, 265, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_110, false);
	}
}
...
{
	func_248(cParam0, 5, bLocal_109, 0, 0, 1, 0);
	...
	func_440();
	func_441();
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_112))
	{
		PED::SET_PED_CONFIG_FLAG(bLocal_112, 301, false);
	}
	ENTITY::REMOVE_MODEL_HIDE(2123.506f, -612.6181f, 40.58901f, 2.5f, GET_HASH_KEY("P_TARGETFRAME01X"), 0);
	ENTITY::REMOVE_MODEL_HIDE(2123.506f, -612.6181f, 40.58901f, 2.5f, GET_HASH_KEY("P_DRYINGMEAT01X"), 0);
	ENTITY::REMOVE_MODEL_HIDE(2144.28f, -630.9673f, 42.565f, 1f, GET_HASH_KEY("S_BISCUITS01X"), 0);
}
...
bool func_186(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_261(Global_1898164.f_1[0 /*5*/]);
		if (func_262(iVar0) && func_290(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
int func_188(int iParam0)
{
	...
	switch (func_184(iParam0))
	{
		...
		case 8:
			...
			if (func_290(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
...
int func_210(float fParam0)
{
	...
	return (func_485() - BUILTIN::ROUND((fParam0->f_1 * 1000f)));
}
...
bool func_223()
{
	return func_494(SCRIPTS::GET_ID_OF_THIS_THREAD());
}
...
bool func_235(int iParam0, int iParam1)
{
	...
	{
		return func_498(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
void func_248(char[4] cParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (!func_501(iParam1))
	{
		return;
	...
	{
		func_503(cParam0, bParam2);
		func_504(bParam2);
	}
	func_505(iParam1);
	func_506(iParam1, 0);
	func_507(iParam1, 0, bParam4, bParam5, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	if (bParam5)
	{
	}
}

bool func_249(char[4] cParam0)
{
...
void func_264(int iParam0, bool bParam1)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(iVar0, func_520(iParam0)))
	{
		UILOG::_UILOG_REMOVE_ENTRY(iVar0, func_520(iParam0));
	}
	if (bParam1)
	{
		if (iVar0 == 1)
		{
			if (UILOG::_UILOG_IS_ENTRY_REGISTERED(2, func_520(iParam0)))
			{
				UILOG::_UILOG_REMOVE_ENTRY(2, func_520(iParam0));
			}
		}
	}
	func_521(iParam0, 4);
...
void func_266(int iParam0, bool bParam1)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(func_519(iParam0), func_520(iParam0)))
	{
		return;
	}
	if (bParam1)
	{
		UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_519(iParam0), func_520(iParam0), 2, "");
		func_522(iParam0, 16);
	}
	else
	{
		...
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_519(iParam0), func_520(iParam0), 1, "");
		}
		else
		{
			UILOG::_UILOG_MARK_ENTRY_AVAILABILITY(func_519(iParam0), func_520(iParam0), 0, "");
		}
		func_521(iParam0, 16);
	}
}
...
void func_282(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar1 = 0;
		if (func_532(Global_1310750[iVar0 /*111*/], iParam0))
		{
			if (!func_533(iVar0))
			{
				iVar1 = 1;
...
void func_284(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	func_537(iParam0, bParam3, BUILTIN::ROUND((fVar0 * fParam2)), BUILTIN::ROUND((fVar1 * fParam2)), BUILTIN::ROUND((fVar2 * fParam2)), BUILTIN::ROUND((fVar3 * fParam2)), bParam4, 1);
}
...
void func_288()
{
	...
	if (func_540(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1))
	{
		func_541(GET_HASH_KEY("CSTAG_PLAYER_AWAY"), 1, 0);
	}
}
...
void func_289(int iParam0)
{
	...
	func_543(iParam0, (func_542(iParam0) + BUILTIN::SHIFT_LEFT(1, 16)));
}
...
void func_292(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		case 67:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_ABIGAIL2X1_1"), iParam1);
			break;
		case 18:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_BRAITHWAITE1_4"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_1"), iParam1);
			break;
		case 20:
			func_545(GET_HASH_KEY("JOURNAL_GT_BRAITHWAITES_2"), iParam1);
			break;
		case 2:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_ODRISCOLL1_4"), iParam1);
			break;
		case 23:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_ODRISCOLL3_3"), iParam1);
			func_546(1);
			break;
		case 16:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_2_TXT"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_3_TXT"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_FEUD1_4"), iParam1);
			break;
		case 59:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_ENDLESS_SUMMER_2"), iParam1);
			if (func_547(146))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_TREASURE2_JN"), iParam1);
			}
			func_546(1);
			break;
		case 76:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_FINALE2_1"), iParam1);
			if (func_548() == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9A"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_10B"), iParam1);
			}
			break;
		case 44:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG1_4B"), iParam1);
			break;
		case 46:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_GANG3_4"), iParam1);
			break;
		case 17:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS1_3"), iParam1);
			break;
		case 19:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS2_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_GT_GRAYS_2"), iParam1);
			break;
		case 21:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_GRAYS3_2"), iParam1);
			func_546(0);
			break;
		case 15:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HUNTING1_1B"), iParam1);
			break;
		case 33:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_INDUSTRY1_4"), iParam1);
			break;
		case 34:
			func_545(GET_HASH_KEY("JOURNAL_GT_INDUSTRY_3"), iParam1);
			break;
		case 64:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_LARAMIE1_1"), iParam1);
			break;
		case 60:
			func_545(GET_HASH_KEY("JOURNAL_CHAP8_PRONGHORN"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP8_MARSTON1_2"), iParam1);
			break;
		case 73:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON6_1"), iParam1);
			break;
		case 74:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_MARSTON7_1"), iParam1);
			if (func_548() == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_4A"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_5B"), iParam1);
			}
			break;
		case 8:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MARY1_3"), iParam1);
			break;
		case 36:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2"), iParam1);
			if (Global_1357515 == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3_2B"), iParam1);
			}
			break;
		case 27:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB1_4"), iParam1);
			break;
		case 28:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB2_4"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_GT_MOB_2"), iParam1);
			break;
		case 29:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB3_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_GT_MOB_3"), iParam1);
			break;
		case 31:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MOB5_4"), iParam1);
			break;
		case 4:
			func_545(GET_HASH_KEY("JOURNAL_CHAP2_HORSESHOE"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN1_5"), iParam1);
			func_546(0);
			break;
		case 6:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2"), iParam1);
			if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_A"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_B"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_MUDTOWN3_2_C"), iParam1);
			}
			break;
		case 25:
			func_545(GET_HASH_KEY("JOURNAL_GT_MUDTOWN_3B"), iParam1);
			break;
		case 24:
			if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_5000"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_7500"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_GT_MUDTWON_5_10000"), iParam1);
			}
			break;
		case 48:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2A"), iParam1);
			}
			if (func_549(51))
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE1_2B"), iParam1);
			}
			break;
		case 49:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_1"), iParam1);
			if (Global_1357515 == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2A"), iParam1);
			}
			else if (Global_1357515 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2B"), iParam1);
			}
			else if (Global_1357515 == 2)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVE2_2C"), iParam1);
			}
			break;
		case 58:
			func_545(GET_HASH_KEY("JOURNAL_GT_NATIVE_3"), iParam1);
			break;
		case 50:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON1_1"), iParam1);
			break;
		case 52:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_2B"), iParam1);
			if (bParam2 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3A2"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_NATIVESON3_3B"), iParam1);
			}
			break;
		case 32:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_ODRISCOLL4_1"), iParam1);
			break;
		case 47:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MARY4_1"), iParam1);
			break;
		case 69:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE2_1"), iParam1);
			if (func_316(Global_1347702[9 /*49*/].f_15, 1))
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_2B"), iParam1);
			}
			break;
		case 70:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_SADIE3"), iParam1);
			if (func_548() == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_7A"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8B"), iParam1);
			}
			break;
		case 71:
			if (func_548() == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_8A"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_9B"), iParam1);
			}
			break;
		case 37:
			func_545(GET_HASH_KEY("JOURNAL_GT_SAINT_DENIS_1"), iParam1);
			break;
		case 9:
			if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_1B"), iParam1);
			}
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SALOON1_2"), iParam1);
			break;
		case 13:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_SEAN1_3"), iParam1);
			break;
		case 53:
			func_545(GET_HASH_KEY("JOURNAL_GT_CORNWALL_1"), iParam1);
			break;
		case 54:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY1_1"), iParam1);
			break;
		case 56:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_TRAINROBBERY3_3"), iParam1);
			break;
		case 57:
			func_545(GET_HASH_KEY("JOURNAL_GT_TRAIN_ROBBERY_4"), iParam1);
			break;
		case 22:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_TRELAWNY1_2"), iParam1);
			break;
		case 12:
			func_545(GET_HASH_KEY("JOURNAL_GT_UTOPIA_2"), iParam1);
			break;
		case 0:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_5"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP1_WINTER1_6"), iParam1);
			break;
		case 1:
			func_546(1);
			break;
		case 3:
			if (func_327())
			{
				...
				{
					func_545(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE"), iParam1);
				}
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_GT_WINTER_4_SE")))
			{
				func_545(GET_HASH_KEY("JOURNAL_GT_WINTER_4"), iParam1);
			}
			break;
		default:
			break;
...
void func_294(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	{
		case 0:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ABIGAIL1_4"), iParam1);
			break;
		case 1:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL2X2_1"), iParam1);
			break;
		case 2:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_ABIGAIL3_1"), iParam1);
			break;
		case 9:
			func_545(GET_HASH_KEY("JOURNAL_CHAP9_BEECHERSHOPE"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP9_BEECHERS1X3_1"), iParam1);
			if (func_316(Global_1835011[69 /*74*/].f_1, 1))
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1A"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_BEECHERS_DEBT_1B"), iParam1);
			}
			break;
		case 22:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_CALDERON1X1_1"), iParam1);
			break;
		case 26:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_1_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_2_JN"), iParam1);
			}
			break;
		case 29:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_2_AR"), iParam1);
			}
			else if (func_547(26))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B1"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_B2"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CALLOWAY_3_JN_A"), iParam1);
			}
			break;
		case 32:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_AR"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_AR"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_AR"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_AR"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_AR"), iParam1);
				}
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2_JN"), iParam1);
				if (Global_1357515 == -1)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2E_JN"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2A_JN"), iParam1);
				}
				else if (Global_1357515 == 1)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2B_JN"), iParam1);
				}
				else if (Global_1357515 == 2)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2C_JN"), iParam1);
				}
				else if (Global_1357515 == 3)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2D_JN"), iParam1);
				}
				else if (Global_1357515 == 4)
				{
					func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_2F_JN"), iParam1);
				}
			}
			break;
		case 35:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_3_JN"), iParam1);
			}
			break;
		case 36:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_CHAP3_RCCHAINGANG_4_JN"), iParam1);
			}
			break;
		case 37:
			func_545(GET_HASH_KEY("JOURNAL_GT_COACH_ROB_RSC"), iParam1);
			break;
		case 53:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT1_2_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT1_1_JN_B"), iParam1);
			}
			break;
		case 54:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT2_1_JN"), iParam1);
			}
			break;
		case 55:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1_AR"), iParam1);
			}
			else if (func_547(54))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CRKPT3_1A_JN"), iParam1);
			}
			break;
		case 38:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CIG1_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_CIG1_1_JN"), iParam1);
			}
			break;
		case 39:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_DINO1_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_DINO1_1_JN"), iParam1);
			}
			break;
		case 40:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_DINO2_1_AR"), iParam1);
			}
			else if (func_547(39))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_DINO2_1_B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_DINO2_1_A_JN"), iParam1);
			}
			break;
		case 43:
			if (bParam3 == 1)
			{
				if (func_350(Global_1835011[33 /*74*/].f_1) == 1)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1B_AR_A"), iParam1);
				}
				else
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1A_AR_A"), iParam1);
				}
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_EXOTIC1_1_JN"), iParam1);
			}
			break;
		case 45:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_AR_A"), iParam1);
			}
			else if (func_547(43))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_B"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_EXOTIC3_1_JN_A"), iParam1);
			}
			break;
		case 41:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FISH1_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FISH1_1_JN"), iParam1);
			}
			break;
		case 42:
			if (func_547(41))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_B"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FISH2_1_JN_A"), iParam1);
			}
			break;
		case 49:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ROCKCARV1_JN"), iParam1);
			}
			break;
		case 50:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_AR"), iParam1);
			}
			else if (func_547(49))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_B2"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ROCKCARV2_JN_A"), iParam1);
			}
			break;
		case 51:
			func_545(GET_HASH_KEY("JOURNAL_RC_TAX1_1_JN"), iParam1);
			break;
		case 58:
			if (func_316(Global_1347702[23 /*49*/].f_15, 1))
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_1B"), iParam1);
			}
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DOCTORS_3"), iParam1);
			break;
		case 59:
			func_545(GET_HASH_KEY("JOURNAL_CHAP2_DOWNES1_1"), iParam1);
			break;
		case 62:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DOWNES2_1"), iParam1);
			break;
		case 63:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_ODRISCOLL2_2B"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_GT_ODRISCOLL_2"), iParam1);
			break;
		case 65:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_3"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_ODRISCOLL6_4"), iParam1);
			break;
		case 66:
			func_545(GET_HASH_KEY("JOURNAL_CHAP3_CLEMENS"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_DUTCH1_3"), iParam1);
			func_546(1);
			break;
		case 67:
			func_545(GET_HASH_KEY("JOURNAL_CHAP4_SHADYBELLE"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_DUTCH2_2"), iParam1);
			break;
		case 68:
			func_545(GET_HASH_KEY("JOURNAL_CHAP6_BEAVERHOLLOW"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_2B"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_DUTCH3_3"), iParam1);
			func_546(0);
			break;
		case 70:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_EDITHDOWNE2_1"), iParam1);
			break;
		case 71:
			func_545(GET_HASH_KEY("JOURNAL_RC_MILLER1_JN"), iParam1);
			break;
		case 73:
			func_545(GET_HASH_KEY("JOURNAL_RC_MILLER3_JN"), iParam1);
			break;
		case 75:
			func_545(GET_HASH_KEY("JOURNAL_RC_MILLER4_JN"), iParam1);
			break;
		case 77:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA1_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA1_1_JN"), iParam1);
			}
			break;
		case 79:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA3_1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA3_2_AR"), iParam1);
			}
			else if (func_547(78))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA3_2_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA3_1_JN"), iParam1);
			}
			break;
		case 80:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA4_1_AR"), iParam1);
			}
			else if (func_547(79))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA4_2_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_FMA4_1_JN"), iParam1);
			}
			break;
		case 85:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER1_1_JN"), iParam1);
			}
			break;
		case 86:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER2_1_JN"), iParam1);
			}
			break;
		case 87:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER3_1_JN"), iParam1);
			}
			break;
		case 88:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_GUNSLINGER5_1_JN"), iParam1);
			}
			break;
		case 89:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK1_JN"), iParam1);
			}
			break;
		case 92:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK4_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK4B_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK4_A_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK4_A2_JN"), iParam1);
			}
			break;
		case 93:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK5_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_HKK5_JN"), iParam1);
			}
			break;
		case 94:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_1"), iParam1);
			if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2A"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP2_HOMEROBBERY0_2B"), iParam1);
			}
			func_545(GET_HASH_KEY("JOURNAL_GT_HOME_ROB"), iParam1);
			break;
		case 99:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_MARY3X1_1"), iParam1);
			break;
		case 101:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON1_1_AR"), iParam1);
				if (Global_1357515 == -1)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_B"), iParam1);
				}
				else
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_MASON1_2_AR_A"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON1_1B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON1_1A_JN"), iParam1);
			}
			break;
		case 102:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON2_1_AR"), iParam1);
			}
			else if (func_547(101))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON2_1B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON2_1A_JN"), iParam1);
			}
			break;
		case 103:
			func_545(GET_HASH_KEY("JOURNAL_RC_MASON3_1_AR"), iParam1);
			break;
		case 104:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON4_1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON4_2_AR"), iParam1);
			}
			else if (func_547(103))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON4_1B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON4_1A_JN"), iParam1);
			}
			break;
		case 105:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON5_1_AR"), iParam1);
			}
			else if (func_547(104))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON5_1B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MASON5_1A_JN"), iParam1);
			}
			break;
		case 108:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_MONROE_1"), iParam1);
			break;
		case 109:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR1_AR_B"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR1_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR1B_JN"), iParam1);
			}
			break;
		case 110:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR2_AR"), iParam1);
			}
			else if (func_547(109))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR2B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR2A_JN"), iParam1);
			}
			break;
		case 111:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 0)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_AR"), iParam1);
				}
				else
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_AR"), iParam1);
				}
			}
			else if (func_547(110))
			{
				if (Global_1357515 == 0)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3C_JN"), iParam1);
				}
				else
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_JN"), iParam1);
					func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3D_2_JN"), iParam1);
				}
			}
			else if (Global_1357515 == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3A_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_MAYOR3B_2_JN"), iParam1);
			}
			break;
		case 115:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_1"), iParam1);
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP4_NATIVERSC1_2"), iParam1);
			break;
		case 143:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ODDF1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ODDF1_JN"), iParam1);
			}
			break;
		case 144:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ODDF2_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_ODDF2_JN"), iParam1);
			}
			break;
		case 117:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO1_2_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO1_1_JN"), iParam1);
			}
			break;
		case 118:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1_AR"), iParam1);
			}
			else if (func_547(117))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO2_1A_JN"), iParam1);
			}
			break;
		case 119:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO3_1_AR"), iParam1);
			}
			else if (func_547(118))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_OHBRO3_2A_JN"), iParam1);
			}
			break;
		case 121:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW1_JN"), iParam1);
			}
			break;
		case 122:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW3_AR"), iParam1);
			}
			else if (func_547(121))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW3B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW3A_JN"), iParam1);
			}
			break;
		case 124:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW4_AR"), iParam1);
			}
			else if (func_547(122))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW4B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW4A_JN"), iParam1);
			}
			break;
		case 125:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW5_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_PW5B_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_PW5_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_PW5B_JN"), iParam1);
			}
			break;
		case 127:
			func_545(GET_HASH_KEY("JOURNAL_RC_RTL1_AR"), iParam1);
			break;
		case 129:
			func_545(GET_HASH_KEY("JOURNAL_RC_RTL3_AR"), iParam1);
			break;
		case 131:
			func_545(GET_HASH_KEY("JOURNAL_RC_RTL5_AR"), iParam1);
			break;
		case 133:
			func_545(GET_HASH_KEY("JOURNAL_RC_RTL7_AR"), iParam1);
			break;
		case 134:
			func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP3_SADIE1_1"), iParam1);
			break;
		case 135:
			if (bParam3 == 1)
			{
				if (Global_1357515 == -1)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_KILLER4A_AR"), iParam1);
				}
				else
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_KILLER4B_AR"), iParam1);
				}
			}
			else if ((HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER1_AR")) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER2_AR"))) && HUD::_JOURNAL_CAN_WRITE_ENTRY(GET_HASH_KEY("JOURNAL_RC_KILLER3_AR")))
			{
				if (Global_1357515 == -1)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_KILLER4A_JN"), iParam1);
				}
				else
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_KILLER4B_JN"), iParam1);
				}
			}
			else if (Global_1357515 == -1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_KILLER4C_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_KILLER4D_JN"), iParam1);
			}
			break;
		case 136:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC1_JN"), iParam1);
			}
			break;
		case 137:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC2_AR"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC3A_AR"), iParam1);
			}
			else if (func_547(136))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC2B_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC3C_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC2A_JN"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_RC_SLVC3A_JN"), iParam1);
			}
			break;
		case 142:
			if (bParam2 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3A"), iParam1);
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3B"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_ENTRY_CHAP6_STRAUSS3_3C"), iParam1);
			}
			break;
		case 146:
			if (bParam3 == 1)
			{
				if (Global_1357515 == 1)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_AR"), iParam1);
				}
				else if (Global_1357515 == 0)
				{
					func_545(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_AR"), iParam1);
				}
			}
			else if (Global_1357515 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_TREASURE1A_JN"), iParam1);
			}
			else if (Global_1357515 == 0)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_TREASURE1B_JN"), iParam1);
			}
			break;
		case 147:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET1_AR"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET1_JN"), iParam1);
			}
			break;
		case 148:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET2_AR"), iParam1);
			}
			else if (func_547(147))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET2B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET2A_JN"), iParam1);
			}
			break;
		case 149:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET3_AR"), iParam1);
			}
			else if (func_547(148))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET3B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET3A_JN"), iParam1);
			}
			break;
		case 150:
			if (bParam3 == 1)
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET4_AR"), iParam1);
			}
			else if (func_547(149))
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET4B_JN"), iParam1);
			}
			else
			{
				func_545(GET_HASH_KEY("JOURNAL_RC_WARVET4A_JN"), iParam1);
			}
			break;
		default:
			break;
	...
	switch (iVar0)
	{
		case 1:
			...
			switch (iVar1)
			{
				...
				case 9:
					if (func_350(Global_1835011[9 /*74*/].f_1) == 0)
					{
		...
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == 176656832)
		{
			...
			if (func_553(iVar2))
			{
				...
				while (iVar4 < 60)
				{
					...
					{
						func_554(&(Global_40.f_4283.f_6[iVar4 /*5*/]), 1, 0);
					}
					iVar4++;
				}
			}
...
bool func_307(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
		...
		if (func_569(iParam0))
		{
			...
			if (func_384() && func_577(4))
			{
				if (!Global_1914319.f_17376)
				{
					if (func_384() && (func_578(38) || func_574(38)))
					{
						func_582(38, COLLECTION::_0x13AAECDA43318BFE(-2076669067, iVar6), COLLECTION::_0xD52D20B0C76BB26D(-2076669067, iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
						func_582(38, MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_COLLECTABLE_CIGCARD"), iVar7, 12, 0, iVar6);
					}
				}
			}
		}
	}
	if (func_583(iParam0) == GET_HASH_KEY("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_583(iParam0) == GET_HASH_KEY("WEAPON"))
		{
		...
		else if (func_583(iParam0) == GET_HASH_KEY("AMMO") && func_596(iParam0))
		{
		...
		{
			func_95(func_600(GET_HASH_KEY("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == GET_HASH_KEY("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_95(func_601(GET_HASH_KEY("COLLECTED"), GET_HASH_KEY("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_584(iParam0, 589988438))
		{
			if (func_603())
			{
				func_604(GET_HASH_KEY("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		else if (func_584(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_336(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_336(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
				...
				case GET_HASH_KEY("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_336(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
		...
		switch (iParam0)
		{
			...
			case GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_616(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_OFFHAND_HOLSTER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_617(&iVar9, 0))
				{
			...
			case GET_HASH_KEY("UPGRADE_BANDOLIER"):
				...
				{
					func_616(PLAYER::PLAYER_PED_ID(), GET_HASH_KEY("UPGRADE_BANDOLIER"), 0, GET_HASH_KEY("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_01"):
				func_623(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_01"), 0);
				func_624(499813453, 0);
				func_625(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_02"):
				func_623(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_02"), 0);
				func_624(499813453, 0);
				func_625(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_03"):
				func_623(499813453, GET_HASH_KEY("TREASURE_HUNT_LOOT_03"), 0);
				func_624(499813453, 0);
				func_625(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_04"):
				func_623(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_05"), 0);
				func_624(666607663, 0);
				func_626(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_05"):
				func_623(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_06"), 0);
				func_624(666607663, 0);
				func_626(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_06"):
				func_623(666607663, GET_HASH_KEY("TREASURE_HUNT_LOOT_07"), 0);
				func_624(666607663, 0);
				func_626(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_07"):
				func_623(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_09"), 0);
				func_624(-220219788, 0);
				func_627(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_08"):
				func_623(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_10"), 0);
				func_624(-220219788, 0);
				func_627(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_09"):
				func_623(-220219788, GET_HASH_KEY("TREASURE_HUNT_LOOT_11"), 0);
				func_624(-220219788, 0);
				func_627(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_10"):
				func_623(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_13"), 0);
				func_624(218622660, 0);
				func_628(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_11"):
				func_623(218622660, GET_HASH_KEY("TREASURE_HUNT_LOOT_14"), 0);
				func_624(218622660, 0);
				func_628(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_13"):
				func_623(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_16"), 0);
				func_624(390004462, 0);
				func_629(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_14"):
				func_623(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_17"), 0);
				func_624(390004462, 0);
				func_629(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_15"):
				func_623(390004462, GET_HASH_KEY("TREASURE_HUNT_LOOT_18"), 0);
				func_624(390004462, 0);
				func_629(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_16"):
				func_623(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_20"), 0);
				func_624(6410548, 0);
				func_630(1);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_17"):
				func_623(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_21"), 0);
				func_624(6410548, 0);
				func_630(2);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_18"):
				func_623(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_22"), 0);
				func_624(6410548, 0);
				func_630(4);
				break;
			case GET_HASH_KEY("DOCUMENT_TREASURE_MAP_19"):
				func_623(6410548, GET_HASH_KEY("TREASURE_HUNT_LOOT_23"), 0);
				func_624(6410548, 0);
				func_630(8);
				break;
			case GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM"):
				func_632(242, func_631(GET_HASH_KEY("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER"):
				func_632(240, func_631(GET_HASH_KEY("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT"):
				func_632(241, func_631(GET_HASH_KEY("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case GET_HASH_KEY("CONSUMABLE_MOONSHINE"):
				...
				{
					func_633(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_633(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_633(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_633(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_633(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case GET_HASH_KEY("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_10197 + 60000))
				{
					func_633(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
void func_310(int iParam0)
{
	...
	func_664(GET_HASH_KEY("MPC_SP_DEFAULT_INTER_OUTFIT_TYPES"));
	iVar1 = 0;
	while (iVar1 < 39)
	{
	...
	Global_1946804.f_1616.f_1[8 /*3*/] = { func_667(8, 0) };
	Global_1946804.f_1616.f_1[9 /*3*/] = { func_667(9, 0) };
	Global_1946804.f_1616.f_1[0 /*3*/] = { func_667(0, 0) };
	Global_1946804.f_1616.f_1[2 /*3*/] = { func_667(2, 0) };
	Global_1946804.f_1616.f_1[3 /*3*/] = { func_667(3, 0) };
	Global_1946804.f_1616.f_1[1 /*3*/] = { func_667(1, 0) };
	Global_1946804.f_1616.f_1[5 /*3*/] = { func_667(5, 0) };
	Global_1946804.f_1616.f_1[6 /*3*/] = { func_667(6, 0) };
	Global_1946804.f_1616.f_1[7 /*3*/] = { func_667(7, 0) };
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (bVar7)
		{
			...
			while (iVar8 < 39)
			{
				...
				{
					func_669(&(Global_1946804.f_1616.f_1[iVar8 /*3*/]), iVar8, iVar0);
				}
				else
				{
					iVar8++;
...
char* func_313(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			if ((func_316(Global_1835011[59 /*74*/].f_1, 1) || func_316(Global_1347702[1 /*49*/].f_15, 1)) || func_180(Global_1347702[1 /*49*/].f_15))
			{
				return "COMP_RUFUS";
			}
			else if (func_540(GET_HASH_KEY("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
void func_315(int iParam0, bool bParam1, bool bParam2)
{
	...
	func_673(&(Global_1946804.f_1497.f_1[iVar0 /*3*/]), 2, 6);
	func_673(&(Global_1946804.f_1378.f_1[iVar0 /*3*/]), 2, 6);
	if (bParam1)
	{
	...
	if (func_20() == -1)
	{
		...
		while (iVar1 < 5)
		{
			func_673(&(Global_26796.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
	...
	else
	{
		...
		while (iVar1 < 5)
		{
			func_673(&(Global_36638.f_45.f_350.f_26[iVar1 /*120*/].f_1.f_1[iVar0 /*3*/]), 2, 6);
			if (bParam1)
			{
...
bool func_322(int iParam0, int iParam1)
{
	...
	return func_681(&(Global_40.f_9910[iParam1 /*6*/]), 4);
}
...
void func_324(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		func_692(&(Global_40.f_9910[iVar0 /*6*/]), 2);
	}
...
void func_337(int iParam0)
{
	...
	if (iParam0 < 0)
	{
		func_694(MISC::VAR_STRING(2, "MISSION_COMPLETE_BANK_FEED", MISC::ABSI(iParam0)), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
		Global_1879514.f_14 = 1;
		Global_1879514.f_15 = 0;
	}
	else
	{
		func_694(MISC::VAR_STRING(2, "MISSION_COMPLETE_LOAN_FEED", iParam0), "itemtype_textures", MISC::GET_HASH_KEY("ITEMTYPE_BANK_DEBT"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Negative", 0, 1);
...
void func_347(int iParam0)
{
	...
	{
		case 1:
			func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
			iVar0 = func_261(iParam0);
			func_95(func_94(GET_HASH_KEY("MISSIONS_PROGRESSED")), 1);
			switch (func_466(iVar0))
			{
				case 0:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP1")), 1);
					break;
				case 1:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP2")), 1);
					break;
				case 2:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP3")), 1);
					break;
				case 3:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP4")), 1);
					break;
				case 4:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP5")), 1);
					break;
				case 5:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP6")), 1);
					break;
				case 6:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP7")), 1);
					break;
				case 7:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP8")), 1);
					break;
				case 8:
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS_CHP9")), 1);
					break;
				default:
					iVar2 = 0;
					break;
			...
			if (iVar0 == 7)
			{
				func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
			}
			if (iVar2 && MISSIONDATA::MISSIONDATA_IS_REQUIRED_STORY_MISSION(MISC::GET_HASH_KEY(&(Global_1835011[iVar0 /*74*/].f_8))))
			{
				func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("REQUIRED_MISSIONS")), 1);
			}
			break;
		case 8:
			iVar1 = func_261(iParam0);
			...
			if (func_290(Global_1347702[iVar1 /*49*/].f_12, 4) || iVar1 == 59)
			{
				if (func_290(Global_1347702[iVar1 /*49*/].f_12, 1))
				{
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("MISSIONS")), 1);
				...
				{
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC")), 1);
				}
			}
			if (func_290(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
			...
			else if (func_290(Global_1347702[iVar1 /*49*/].f_12, 4))
			{
				if (func_290(Global_1347702[iVar1 /*49*/].f_12, 4194304))
				{
				}
				else if (!func_290(Global_1347702[iVar1 /*49*/].f_12, 512))
				{
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS")), 1);
				}
				else
				{
					func_95(func_601(GET_HASH_KEY("COMPLETED"), GET_HASH_KEY("RC_STRANDS_BOUNTY")), 1);
...
void func_348()
{
	...
	if (iVar1 == 1)
	{
		func_701(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_SINGLE", 1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	else if (iVar1 > 1)
	{
		func_701(MISC::VAR_STRING(2, "SHOP_CATALOGUE_DELIVERY"), MISC::VAR_STRING(2, "SHOP_CATALOGUE_PURCHASE_RECEIVED_PLURAL", iVar1), GET_HASH_KEY("HUD_TOASTS"), -576888982, -2, 0, 0, 0, 0, 1, 1);
	}
	if (iVar3 > 0)
	{
		func_702(iVar3, 0, 0);
...
int func_353(int iParam0)
{
	...
	{
		case 0:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 1:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 2:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 2;
		case 4:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		case 5:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1);
		...
		case 12:
			return 75000;
		case 8:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 9:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
		case 10:
			return func_712(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, -1) * 3;
...
char[] func_354(int iParam0)
{
	...
	{
		case 1:
			cVar0 = Global_1835011[func_488(iParam0) /*74*/].f_8;
			break;
		case 8:
			cVar0 = Global_1347702[func_261(iParam0) /*49*/].f_3;
			break;
		case 11:
			if (iParam0 == func_352(0, 10, 11, GET_HASH_KEY("CABR01")))
			{
...
void func_355(char[4] cParam0)
{
	...
	if (!Global_1879514.f_11)
	{
		...
		if (MISSIONDATA::MISSIONDATA_GET_RATING(iVar1) != 5 && iVar0 == 5)
		{
			...
			else if (func_184(Global_1879514.f_1) == 8 && (func_290(Global_1347702[func_261(Global_1879514.f_1) /*49*/].f_12, 1) || func_290(Global_1347702[func_261(Global_1879514.f_1) /*49*/].f_12, 33554432)))
			{
				func_351(5, 1);
			}
		}
...
Vector3 func_358(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	vVar0 = { func_716(vParam0, iParam3, iParam4, iParam5, iParam6, 1, iParam7, bParam8, bParam9, bParam10, -1, 1103626240 /* Float: 25f */) };
	if (func_385(vVar0))
	{
		vVar0 = { func_716(vParam0, iParam3, iParam4, 0, 1, 1, iParam7, bParam8, 0, 0, -1, 1103626240 /* Float: 25f */) };
	}
	return vVar0;
}
...
void func_363(struct<16> Param0, int iParam16)
{
	...
	{
		if (SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&(Param0.f_10))) > 0 || func_722(&(Param0.f_10)))
		{
			return;
		}
	}
...
void func_367(bool bParam0)
{
	...
	func_365(&(Global_1347343.f_11), 1073741824 /* Float: 2f */);
	if (bParam0)
	{
...
void func_368(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	int iVar0;
	struct<11> Var1;
	...
	func_731(uParam0);
	iVar0 = func_732(uParam0, bParam1);
	if (bParam3)
	{
		if (MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			sParam2 = func_733(bParam1);
		}
...
{
	func_745(cParam0, 0, 1, 106886, 106948, 107003, 107188, 107618, "MOB4_INT", 4098, -1);
	func_745(cParam0, 1, 2, 107791, 108274, 108385, 108510, 109002, "", 0, -1);
	func_745(cParam0, 2, 3, 109156, 109454, 109815, 110374, 110492, "MOB4_MCS1", 4162, -1);
	func_745(cParam0, 3, 4, 110567, 110671, 110828, 111102, 112325, "", 64, -1);
	func_745(cParam0, 4, 5, 112461, 112480, 112644, 112832, 112936, "MOB4_MCS2", 4162, -1);
	func_745(cParam0, 5, 6, 112967, 113105, 113166, 113263, 113791, "", 64, -1);
	func_745(cParam0, 6, 7, 113830, 113940, 114353, 114485, 114653, "", 64, -1);
	func_745(cParam0, 7, 25, 114773, 114895, 115125, 115275, 115605, "", 64, -1);
	func_745(cParam0, 25, 26, 115672, 115788, 115924, 115958, 116177, "MOB4_EXT", 4162, -1);
}
...
bool func_378(char[4] cParam0, int iParam1, bool bParam2)
{
	int iVar0;
	bool bVar1;
	...
	while (iVar0 < ITEMSET::GET_ITEMSET_SIZE(Global_43616))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(bVar1))
		{
			if (!DECORATOR::DECOR_EXIST_ON(ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar0, Global_43616), func_787()) && ENTITY::GET_ENTITY_MODEL(bVar1) == iParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(bVar1))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bVar1, true, true);
...
void func_405(char[4] cParam0, int iParam1, int iParam2)
{
	...
	cParam0->f_5249[iVar0 /*3*/] = iParam1;
	cParam0->f_5249[iVar0 /*3*/].f_2 = (cParam0->f_5249[iVar0 /*3*/].f_2 || iParam2);
}
...
void func_407(char[4] cParam0, char[4] cParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, bool bParam7)
{
	int iVar0;
	...
	iVar0 = func_829(&(cParam0->f_1126), cParam1, *iParam2);
	if (iVar0 == -1)
	{
	...
	if (!bParam7)
	{
		func_831(&(cParam0->f_1126[iVar0 /*67*/].f_2), 4);
	}
}
...
void func_410(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_834(uParam0[iVar0 /*3*/]))
		{
			if (func_828((uParam0[iVar0 /*3*/])->f_2, iParam12))
			{
				func_835(uParam0[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam1)
	{
		if (func_836(uParam1[iVar0 /*5*/]))
		{
			if (func_828((uParam1[iVar0 /*5*/])->f_4, iParam12))
			{
				func_837(uParam1[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam2)
	{
		if (func_838(uParam2[iVar0 /*3*/]))
		{
			if (func_828((uParam2[iVar0 /*3*/])->f_2, iParam12))
			{
				func_839(uParam2[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam3)
	{
		if (func_840(uParam3[iVar0 /*3*/]))
		{
			if (func_828((uParam3[iVar0 /*3*/])->f_2, iParam12))
			{
				func_841(uParam3[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_843(uParam5[iVar0 /*67*/]))
		{
			if (func_828((uParam5[iVar0 /*67*/])->f_3, iParam12))
			{
				func_844(uParam5[iVar0 /*67*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam5)
	{
		if (func_843(uParam5[iVar0 /*67*/]))
		{
			...
			while (iVar1 < 20)
			{
				if (func_845(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/])))
				{
					if (func_828((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/].f_2, iParam12))
					{
						func_846(&((uParam5[iVar0 /*67*/])->f_4[iVar1 /*3*/]), (uParam5[iVar0 /*67*/])->f_1);
					}
				}
				iVar1++;
			}
	...
	while (iVar0 < *uParam6)
	{
		if (func_847(uParam6[iVar0 /*4*/]))
		{
			if (func_828((uParam6[iVar0 /*4*/])->f_3, iParam12))
			{
				func_848(uParam6[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam7)
	{
		if (func_849(uParam7[iVar0 /*5*/]))
		{
			if (func_828((uParam7[iVar0 /*5*/])->f_4, iParam12))
			{
				func_850(uParam7[iVar0 /*5*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam8)
	{
		if (func_851(uParam8[iVar0 /*3*/]))
		{
			if (func_828((uParam8[iVar0 /*3*/])->f_2, iParam12))
			{
				func_852(uParam8[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < *uParam9)
	{
		if (func_853(uParam9[iVar0 /*3*/]))
		{
			if (func_828((uParam9[iVar0 /*3*/])->f_2, iParam12))
			{
				func_854(uParam9[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_855(uParam10[iVar0 /*4*/]))
		{
			if (func_828((uParam10[iVar0 /*4*/])->f_3, iParam12))
			{
				func_856(uParam10[iVar0 /*4*/]);
			}
		}
		iVar0++;
	}
	...
	{
		if (func_857(uParam11[iVar0 /*3*/]))
		{
			if (func_828((uParam11[iVar0 /*3*/])->f_2, iParam12))
			{
				func_858(uParam11[iVar0 /*3*/]);
			}
		}
		iVar0++;
	}
...
void func_411(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam1))
	{
		return;
	...
	if (func_859(uParam0, bParam1, sParam2))
	{
...
void func_415(char[4] cParam0, bool bParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	func_860(&(cParam0->f_7375), bParam1, sParam2, iParam3, iParam4, bParam5);
	func_368(&(cParam0->f_10792), bParam1, sParam2, bParam6);
}
...
bool func_417(var uParam0, int iParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_843(uParam0[iVar0 /*67*/]))
		{
			if (func_828((uParam0[iVar0 /*67*/])->f_3, iParam1))
			{
				if ((uParam0[iVar0 /*67*/])->f_65 > 0f || func_865((uParam0[iVar0 /*67*/])->f_2, 4))
				{
					if (!func_866(uParam0[iVar0 /*67*/]))
					{
						iVar1 = 0;
					}
				}
			...
			else
			{
				...
				if (iVar11 != 0)
				{
					...
					if (iVar11 == 2 && !ENTITY::IS_ENTITY_DEAD(bVar12))
					{
						...
						else if (func_871(bVar12, cParam0->f_5411, 5f, 1))
						{
							if (func_872(bVar12))
							{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar13))
	{
		...
		if (!func_120(cParam0, 256))
		{
			if (!func_120(cParam0, 32768))
			{
				...
				vVar14.f_1 = uParam3;
				vVar14.f_2 = uParam4;
				if ((!func_872(bVar13) || func_875(Global_35, bVar13, 1, 1) > 200f) && !func_385(vVar14))
				{
					if (!func_29())
					{
						ENTITY::FREEZE_ENTITY_POSITION(bVar13, false);
						func_876(bVar13, vVar14, fParam5, 2, 1073741824 /* Float: 2f */);
					}
				}
			}
		}
...
bool func_428(char[4] cParam0)
{
	...
	switch (iVar2)
	{
		case 0:
			...
			{
				if (func_903(cParam0, func_33(cParam0)) != -1 && PED::_0x62DE46F061CAA468() < func_903(cParam0, func_33(cParam0)))
				{
					PED::_0xF008E0BA1FE1D644((func_903(cParam0, func_33(cParam0)) - PED::_0x62DE46F061CAA468()));
				}
		...
		case 5:
			...
			else
			{
				...
				if ((func_923(PLAYER::GET_PLAYER_INDEX(), 0, 0, 1) && !func_120(cParam0, 8192)) && !func_121(cParam0, func_33(cParam0), 8))
				{
					func_47(1, 0);
...
{
	TASK::SET_PED_PATH_MAY_ENTER_WATER(bParam0, bParam1);
	TASK::_SET_PED_PATH_MAY_ENTER_DEEP_WATER(bParam0, bParam1);
	if (bParam1)
	{
		TASK::_0x8BB283A7888AD1AD(bParam0, 0, 0f);
		TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(bParam0, false, 0f);
		TASK::_0x12990818C1D35886(bParam0, 0, 0f);
	}
	else
	{
		TASK::_0x8BB283A7888AD1AD(bParam0, 1, 1f);
		TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(bParam0, true, 1f);
		TASK::_0x12990818C1D35886(bParam0, 1, 1f);
	}
}

void func_431(bool bParam0)
{
	PED::SET_PED_CONFIG_FLAG(bLocal_112, 301, bParam0);
...
void func_432(bool bParam0)
{
	...
	if (func_429(Global_35, 0))
	{
		...
		while (bVar1 <= 3)
		{
			iVar0 = func_802(Global_35, 1, bVar1, 0);
			if (func_678(iVar0))
			{
...
void func_434(bool bParam0, bool bParam1)
{
	...
	PED::SET_PED_CONFIG_FLAG(bParam0, 297, bParam1);
...
void func_441()
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(iLocal_291))
	{
		STREAMING::REMOVE_IPL_HASH(iLocal_291);
	}
}
...
void func_446(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_935(iParam0))
	{
		...
		if (bParam3)
		{
			func_936(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_447(int iParam0, bool bParam1)
{
	...
	func_942(Global_1914319.f_3[iParam0 /*446*/].f_10, bParam1);
}
...
void func_452(int iParam0)
{
	...
	{
		GRAPHICS::REMOVE_PARTICLE_FX(iParam0, false);
	}
}
...
void func_486(bool bParam0)
{
	...
	if (func_960(GET_HASH_KEY("CAMERA_ITEM")))
	{
	}
...
void func_491(int iParam0, bool bParam1)
{
	...
	if (func_82(32768))
	{
		Global_2621440[iParam0 /*12066*/].f_9.f_14 = func_274();
	}
}
...
void func_492(int iParam0, vector3 vParam1, var uParam4)
{
	...
	Global_2621440[iParam0 /*12066*/].f_9.f_15 = func_361(vParam1, 1);
}
...
void func_503(char[4] cParam0, bool bParam1)
{
	int iVar0;
	struct<24> Var1;
	...
	if (!func_963(cParam0, bParam1, &iVar0))
	{
		return;
	}
	if (ENTITY::IS_ENTITY_AN_OBJECT(bParam1) && func_964(cParam0, ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(bParam1)))
	{
...
void func_506(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_967(&(Global_1360165[iParam0 /*1157*/].f_12), 1))
		{
...
void func_507(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	bVar0 = func_429(Global_1360165[iParam0 /*1157*/], 0);
	...
	if (bParam3)
	{
		...
		func_973(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
	...
	else
	{
		...
		{
			func_539(&(Global_1360165[iParam0 /*1157*/].f_130));
		}
		if (bParam9)
		{
...
void func_517(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (bVar0 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()) && bVar3)
		{
			if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_27))
			{
				...
				func_984(&(Global_1900383[iParam0 /*45*/].f_27));
			}
		}
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		...
		Global_1900383[iParam0 /*45*/].f_25 = 0;
		func_986(&(Global_1900383[iParam0 /*45*/].f_26), bVar6);
	}
	if (!MAP::DOES_BLIP_EXIST(Global_1900383[iParam0 /*45*/].f_26))
	{
		return;
	...
	if (iVar17 != 0)
	{
		func_990(Global_1900383[iParam0 /*45*/].f_26);
		func_991(Global_1900383[iParam0 /*45*/].f_26);
...
void func_525(int iParam0, char* sParam1, int iParam2)
{
	...
	func_694(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_526(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_694(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_TOTAL_TAKE"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_694(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", GET_HASH_KEY("ITEMTYPE_CASH"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_541(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 60)
	{
		if (Global_40.f_4283.f_6[iVar0 /*5*/] == iParam0)
		{
			func_554(&(Global_40.f_4283.f_6[iVar0 /*5*/]), bParam1, bParam2);
			return 1;
		}
		iVar0++;
	}
...
int func_548()
{
	...
	iVar0 = func_1001(Global_1347702[9 /*49*/].f_15);
	iVar1 = func_1001(Global_1835011[69 /*74*/].f_1);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_694(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_694(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, GET_HASH_KEY("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_694(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_694(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, GET_HASH_KEY("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
int func_568(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_950(bParam2), iParam0, 0);
	return iVar2;
}
...
void func_582(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1039(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar1), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1039(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_701(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, func_1040(func_576(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1039(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, GET_HASH_KEY("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), GET_HASH_KEY("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
bool func_592(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_950(bParam0));
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_1047(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_592(0))
				{
					...
					func_594(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
bool func_595(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_1024(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == GET_HASH_KEY("WEAPON_MELEE_KNIFE_JOHN") && !func_1011())
				{
					return false;
				}
				...
				{
					func_593(iVar0, WEAPON::GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
bool func_597(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_336(GET_HASH_KEY("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_598(int iParam0)
{
	...
	if ((iParam0 == GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON") && !func_327()) || iParam0 != GET_HASH_KEY("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
bool func_603()
{
	if (((((func_1064(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_1064(GET_HASH_KEY("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_1064(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_1064(GET_HASH_KEY("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_1064(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_1064(GET_HASH_KEY("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_605(int iParam0)
{
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_LETTER_TAXIDERMY"):
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_582(51, 0, 0, 0, 0, -1, 0);
			func_1065(8192);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_TAXIDERMY"):
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_582(51, 0, 0, 0, 0, -1, 0);
			func_1065(524288);
			break;
		...
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_580(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_01"), func_1069(1), 0, -1, 0);
			func_1070(1);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_580(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_02"), func_1069(2), 0, -1, 0);
			func_1070(2);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_580(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_03"), func_1069(4), 0, -1, 0);
			func_1070(4);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_580(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_04"), func_1069(8), 0, -1, 0);
			func_1070(8);
			break;
		case GET_HASH_KEY("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_580(43, 0, 0, GET_HASH_KEY("EXOTIC_STAGE_05"), func_1069(16), 0, -1, 0);
			func_1070(16);
			break;
	}
}
...
void func_608(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_314(437, 0);
			func_314(440, 0);
			func_1073(GET_HASH_KEY("TAXIDERMY_ORDER_01"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_582(51, 0, 0, sVar0, func_1031(GET_HASH_KEY("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_1065(1);
		...
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_1073(GET_HASH_KEY("TAXIDERMY_ORDER_02"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_582(51, 0, 0, sVar0, func_1031(GET_HASH_KEY("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_1065(8);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 1);
			func_1073(GET_HASH_KEY("TAXIDERMY_ORDER_03"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_582(51, 0, 0, sVar0, func_1031(GET_HASH_KEY("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_1065(64);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 1);
			func_1073(GET_HASH_KEY("TAXIDERMY_ORDER_04"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_582(51, 0, 0, sVar0, func_1031(GET_HASH_KEY("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_1065(512);
			break;
		case GET_HASH_KEY("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 1);
			func_314(438, 0);
			func_1073(GET_HASH_KEY("TAXIDERMY_ORDER_05"), GET_HASH_KEY("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_580(51, 0, 0, GET_HASH_KEY("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_582(51, 0, 0, sVar0, func_1031(GET_HASH_KEY("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_1065(32768);
			break;
		default:
			func_314(439, 0);
...
void func_610(int iParam0, int iParam1)
{
	...
	if (func_20() == -1)
	{
		...
		{
			func_1075(GET_HASH_KEY("EXOTIC_STAGE_01"));
			if (func_1076() == 0)
			{
				func_356(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == GET_HASH_KEY("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_580(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		{
			func_1075(GET_HASH_KEY("EXOTIC_STAGE_02"));
			if (func_1076() == 1)
			{
				func_356(0, 10);
				...
				if ((iParam0 == GET_HASH_KEY("PROVISION_HERON_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_580(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		{
			func_1075(GET_HASH_KEY("EXOTIC_STAGE_03"));
			if (func_1076() == 2)
			{
				func_356(0, 10);
				...
				if (iParam0 == GET_HASH_KEY("PROVISION_GATOR_EGG"))
				{
					if (!func_1080(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0)) >= 25)
					{
						func_1081(COLLECTION::_0x126CBEBBA46693CF(iVar0, GET_HASH_KEY("GATOR_EGGS"), 0), 1);
						func_1029(48);
					}
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_580(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		{
			func_1075(GET_HASH_KEY("EXOTIC_STAGE_04"));
			if (func_1076() == 3)
			{
				func_356(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_SPOONBILL_FEATHER") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_580(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		{
			func_1075(GET_HASH_KEY("EXOTIC_STAGE_05"));
			if (func_1076() == 4)
			{
				func_356(0, 10);
				...
				if (((iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == GET_HASH_KEY("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_1078(iParam0) < func_1079(iParam0))
					{
						func_580(43, iParam0, iParam1, GET_HASH_KEY("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_613(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_20() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_604(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case GET_HASH_KEY("MONEY_ONE_DOLLAR"):
			func_604(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_FIVE_DOLLARS"):
			func_604(GET_HASH_KEY("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_TEN_DOLLARS"):
			func_604(GET_HASH_KEY("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD"):
			func_604(GET_HASH_KEY("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLFOLD_SML"):
			func_604(GET_HASH_KEY("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_BILLSTACK"):
			func_604(GET_HASH_KEY("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COIN"):
			func_604(GET_HASH_KEY("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINPURSE"):
			func_604(GET_HASH_KEY("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSACK"):
			func_604(GET_HASH_KEY("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINSTACK"):
			func_604(GET_HASH_KEY("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYCLIP"):
			func_604(GET_HASH_KEY("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK"):
			func_604(GET_HASH_KEY("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_MONEYSTACK_LARGE"):
			if (!func_1085())
			{
				func_604(GET_HASH_KEY("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case GET_HASH_KEY("MONEY_COINCUP_SM"):
			func_604(GET_HASH_KEY("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_COINCUP_LG"):
			func_604(GET_HASH_KEY("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("CURRENCY_CASH"):
			func_604(GET_HASH_KEY("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_COMMON"):
			func_604(GET_HASH_KEY("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_RARE"):
			func_604(GET_HASH_KEY("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CARD_SET_ALL"):
			func_604(GET_HASH_KEY("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_RARE_FISH"):
			func_604(GET_HASH_KEY("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_1"):
			func_604(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_2"):
			func_604(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_3"):
			func_604(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_4"):
			func_604(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_TAXIDERMY_STAGE_5"):
			func_604(GET_HASH_KEY("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case GET_HASH_KEY("MONEY_CALLOWAY_LETTER"):
			func_604(GET_HASH_KEY("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_614(int iParam0)
{
	...
	switch (iParam0)
	{
		case GET_HASH_KEY("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_01"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_01"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_02"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_02"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_03"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_03"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_04"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_04"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_05"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_05"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_06"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_06"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_PERCH_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_07"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_07"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_08"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_08"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_09"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_09"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_10"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_10"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_11"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_11"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_12"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_12"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_13"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_13"));
			func_356(0, 10);
			break;
		case GET_HASH_KEY("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_1086(GET_HASH_KEY("LEGENDARY_FISH_14"));
			func_1087(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			func_1088(GET_HASH_KEY("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
int func_616(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	struct<5> Var0;
	int iVar5;
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946804.f_57[func_663(iParam3, 1) /*11*/])
			{
				func_674(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_1092(32768) && iParam1 != Global_1946804.f_57[func_663(iParam3, 1) /*11*/])
			{
				func_1093();
...
bool func_617(int iParam0, bool bParam1)
{
	...
	bVar17 = false;
	*iParam0 = 0;
	iVar18 = func_1055(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 2, 1, 0);
	iVar19 = func_1055(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 3, 1, 0);
